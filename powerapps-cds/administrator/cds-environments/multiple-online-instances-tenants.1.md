---
title:  About multiple online instances or tenants | Microsoft Docs
...
## Add an instance to your subscription  
 For information about how to add an instance to your [!INCLUDE[pn_crm_online_shortest](../../includes/pn-crm-online-shortest.md)] subscription, see [Add an instance to your subscription](add-instance-subscription.md).  
