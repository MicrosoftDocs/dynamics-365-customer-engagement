---
title: "Create and edit global option sets using solution explorer | MicrosoftDocs"
ms.custom: ""
ms.date: 05/26/2018
ms.reviewer: ""
...
manager: "brycho"
---
# Create and edit global option sets using solution explorer

Solution explorer provides one way to create and edit global option sets using Common Data Service for Apps.

The [PowerApps portal](https://web.powerapps.com) enables configuring the most common options, but certain options can only be set using solution explorer. More information: [Create and edit global option sets (picklists)](create-edit-global-option-sets.md) and [Create and edit global option sets using PowerApps portal](create-edit-global-option-sets-portal.md)
...
[Create and edit global option sets](create-edit-global-option-sets.md)<br />
