...
|--|--|
|[PowerApps portal](https://web.powerapps.com)|Provides an easy streamlined experience, but some special settings are not available. More information: [Create and edit fields using PowerApps portal](create-edit-field-portal.md)|
|Solution explorer|Not as easy, but provides for more flexibility for less common requirements. More information: [Create and edit fields using PowerApps solution explorer](create-edit-field-solution-explorer.md) |
...
- Create a Lookup or Customer field
