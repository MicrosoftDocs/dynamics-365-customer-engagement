---
title: "Create and edit 1:N (one-to-many) or N:1 (many-to-one) entity relationships in PowerApps solution explorer | MicrosoftDocs"
...
# Create and edit 1:N (one-to-many) or N:1 (many-to-one) entity relationships in PowerApps solution explorer 
...
While [viewing entity relationships](#view-entity-relationships), select the entity you want to delete and click the ![Delete command](media/delete.gif) command.
