---
title: "Create and edit fields using PowerApps solution explorer | MicrosoftDocs"
ms.custom: ""
ms.date: 05/18/2018
ms.reviewer: ""
...
manager: "brycho"
---
# Create and edit fields using PowerApps solution explorer

Solution explorer provides one way to create and edit fields using Common Data Service for Apps.

The [PowerApps portal](https://web.powerapps.com) enables configuring the most common options, but certain options can only be set using solution explorer. More information: [Create and edit fields (attributes)](create-edit-fields.md) and [Create and edit fields using PowerApps portal](create-edit-field-portal.md)
...
You can also configure global option sets separately. More information: [Create and edit global option sets (picklists)](create-edit-global-option-sets.md)
...
While viewing fields, click the field you want to edit. Some standard fields or custom fields that are included in a managed solution might not allow you to edit them.
