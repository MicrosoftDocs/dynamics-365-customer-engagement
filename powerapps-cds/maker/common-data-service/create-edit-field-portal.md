---
title: "Create and edit fields using PowerApps portal | MicrosoftDocs"
ms.custom: ""
ms.date: 05/18/2018
ms.reviewer: ""
...
manager: "brycho"
---
# Create and edit fields using PowerApps portal
...
The portal enables configuring the most common options, but certain options can only be set using solution explorer. More information: [Create and edit fields (attributes)](create-edit-fields.md) and [Create and edit fields using PowerApps solution explorer](create-edit-field-solution-explorer.md)
