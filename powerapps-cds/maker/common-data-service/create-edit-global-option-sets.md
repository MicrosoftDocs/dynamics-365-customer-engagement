...
|--|--|
|[PowerApps portal](https://web.powerapps.com)|Provides an easy streamlined experience, but some special settings are not available. More information: [Create and edit global option sets using PowerApps portal](create-edit-global-option-sets-portal.md)|
|Solution explorer|Not as easy, but provides for more flexibility for less common requirements. More information: [Create and edit global option sets using solution explorer](create-edit-global-option-sets-solution-explorer.md) |
...
> - A developer can write a program to create them. More information: [Developer documentation: Customize global option sets](/dynamics365/customer-engagement/developer/org-service/customize-global-option-sets).
...
[Create and edit global option sets using PowerApps portal](create-edit-global-option-sets-portal.md)<br />
[Create and edit global option sets using solution explorer](create-edit-global-option-sets-solution-explorer.md)<br />
