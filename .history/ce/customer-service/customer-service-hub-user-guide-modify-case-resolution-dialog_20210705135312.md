...
description: "Learn to customize the case resolution dialog box in Customer Service Hub to expand the case entity and case resolution entity to support varied business needs."
ms.date: 06/30/2021
ms.topic: article
author: mh-jaya
ms.author: v-jmh
