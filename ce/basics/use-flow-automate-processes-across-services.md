...
2. The following options appear:  
   ...
   -   Select a flow to run. See [Run an embedded flow from Dynamics 365 for Customer Engagement appsapps](#Flow_run).  
...
2. On the Actions toolbar, select **Flows**, and then under **Run** select the flow that you want to run.  
   ...
   ![Run a flow from Dynamics 365 for Customer Engagement appsapps](../basics/media/embedflow-run.png "Run a flow from Dynamics 365 for Customer Engagement appsapps")  
