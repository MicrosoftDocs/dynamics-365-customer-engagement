...
With the July 2017 update for Dynamics 365 (online), you can use the advanced find option to build a “Not In” query records using **Does not contain data** option.
