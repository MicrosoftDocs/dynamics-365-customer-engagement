...
# Preview feature: Let Cortana help you track your Dynamics 365 for Customer Engagement appsapps deals and activities 

[!INCLUDE[cc-applies-to-update-9-0-0](../includes/cc_applies_to_update_9_0_0.md)]

> [!IMPORTANT]
> We are working to deliver a robust and scalable digital assistant experience across all of our Dynamics 365 for Customer Engagement appsapplications offerings. This includes natural language integration for customers and partners across multiple channels including [!INCLUDE[pn_cortana](../includes/pn-cortana.md)]. To that end, we are discontinuing the current [!INCLUDE[pn_cortana](../includes/pn-cortana.md)] integration preview feature that was made available for Dynamics 365 for Customer Engagement appsapps and we are focusing on building a new long term intelligent solution experience, which will include [!INCLUDE[pn_cortana](../includes/pn-cortana.md)] digital assistant integration.
...
## Enable Cortana integration with Dynamics 365 for Customer Engagement appsapps on your device  
 ...
 **Dynamics 365 for Customer Engagement apps** now appears in Cortana’s notebook, and [!INCLUDE[pn_cortana](../includes/pn-cortana.md)] will prompt you with relevant information about your sales activities, accounts, opportunities, and meetings.  
...
[Supplemental Terms of Use for Dynamics 365 for Customer Engagement appsapps Previews](http://go.microsoft.com/fwlink/p/?LinkId=511446)
