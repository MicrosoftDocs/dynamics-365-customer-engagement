...
From a team channel, you can connect a Dynamics 365 (online) record to collaborate on a customer account, an opportunity, and so on as follows.
...
> [!div class="mx-imgBorder"] 
> ![Open a record in Dynamics 365 (online)](media/teams-open-record-d365.png "Open a record in Dynamics 365 (online)")
...
> [!div class="mx-imgBorder"] 
> ![From Dynamics 365, open a conversation in Teams](media/teams-select-collaborate.png "From Dynamics 365, open a conversation in Teams")
...
> [!div class="mx-imgBorder"] 
> ![Dynamics 365 document management in Teams](media/teams-documents-d365.png "Dynamics 365 document management in Teams")
...
When there is more than one Microsoft Teams channel connected to a Dynamics 365 (online) record, each of the channels appears as a separate document location in Dynamics. You can switch to a different location by selecting **Document Location** to specify the location of the file.
