...
1. On the global nav bar, click the **Recently Viewed Items** button ![Recently Viewed Items button in Dynamics 365 for Customer Engagement](../basics/media/recently-viewed-items-icon.PNG "Recently Viewed Items button in Dynamics 365 for Customer Engagement").  
...
2. Do one of the following:  
   ...
   - Under **Recent Views**, choose the view you want to go back to. To pin the view to the top of the **Recent Views** list, point at the view, and then click the **Pin** button ![Pin button](../basics/media/pin-icon.gif "Pin button").  
     ...
     ![Recently Viewed Items in Dynamics 365 for Customer Engagement](../basics/media/search-records.png "Recently Viewed Items in Dynamics 365 for Customer Engagement")  
     -->  
     > [!NOTE]
