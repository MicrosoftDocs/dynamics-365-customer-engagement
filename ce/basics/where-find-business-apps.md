---
title: "Where to find your business apps | MicrosoftDocs"
ms.custom: ""
ms.date: 09/15/2017
ms.reviewer: ""
...
2.  Click the App Launcher button ![App launcher](../basics/media/app-chooser.png "App launcher") in the upper-left corner, and then click [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)].  
  
     The [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] home page opens, which is the where you'll find all your [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] apps. You'll see all published business apps based on your organization's licensing options, and your security role.  
...
2.  Go to **Settings** > **My Apps**.  
     ...
     The page shows all published business apps of [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] based on your organization's licensing options, and your security role.  
