...
## Use Relevance Search  
 When Relevance Search is enabled for your organization, it becomes the default search experience. When you enter a search term in **Search Dynamics 365 for Customer Engagement appsapps data** on the navigation bar, and then select the Enter key or select the search button, the **Relevance Search** search results page appears. Search results are shown in a single list ordered by relevance. To learn how to change your default search experience, see [Select a default search experience](#BKMK_DefaultOption).  
...
### See also  
 ...
 [Search and Find in Dynamics 365 for Customer Engagement appsapps](../basics/search-and-find-header.md)
