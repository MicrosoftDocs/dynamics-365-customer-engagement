...
search.app: 
  - D365CE
---
# OneNote in Dynamics 365 for Customer Engagement appsapps FAQs
...
I get this error message:
    ...
    We can’t find the notebook. The [!INCLUDE[pn_onenote](../includes/pn-onenote.md)] notebook might have been removed or moved to another location. Check the notebook location or contact your administrator to update the location record stored in Dynamics 365 for Customer Engagement appsapps. (Error: 0x80060729)  
...
## Can I edit a OneNote file from with Dynamics 365 for Customer Engagement appsapps?  
 No. This can be done only from the OneNote app that opens when you click the OneNote link.  
  
## I can’t access my Dynamics 365 for Customer Engagement appsapps OneNote notebook.  
 Don’t delete any [!INCLUDE[pn_onenote](../includes/pn-onenote.md)].onetoc2 or .one file types in the [!INCLUDE[pn_onenote](../includes/pn-onenote.md)] section in Dynamics 365 for Customer Engagement appsapps. If you do, you won’t be able to access your Dynamics 365 for Customer Engagement appsapps OneNote notebook.  
  
## Are section groups supported in Dynamics 365 for Customer Engagement appsapps?  
 Sections groups that keep related sections together in OneNote aren’t supported in Dynamics 365 for Customer Engagement appsapps.  
...
User A opens a OneNote note in Dynamics 365 for Customer Engagement appsapps and adds content (For example: **Sales** > **Accounts** > <account> > **Summary** > Timeline section > **+** > OneNote). User A, or a second user, User B, changes the name of the OneNote file in a document grid (For example: **Sales** > **Accounts** > <account> > **Related** > **Documents**). User A opens the note using Timeline (For example: **Sales** > **Accounts** > <account> > **Summary** > Timeline section > **+** > **OneNote**). User A should see the renamed note with the existing content. Instead, a new note is opened.
