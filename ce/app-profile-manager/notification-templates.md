...
3. Specify the following in the **New Notification** page.
    ...
    | General | Countdown (seconds) | Provide a duration in seconds; after this duration, the notification disappears. | 120. <br><br> **Note:** This is the default value. You can change the duration as per your requirement.|
