...
- The agent is working on another tab of the browser.
 ...
 > ![Desktop notification](../customer-service/media/oceh/desktop-notification.png "Desktop notification")
...
Also, as an administrator, you can set the browser notification permission by using group policy.
 ...
 > [!div class=mx-imgBorder]
 > ![Allow desktop notifications](../customer-service/media/oceh/allow-desktop-notification.png "Allow desktop notifications")
