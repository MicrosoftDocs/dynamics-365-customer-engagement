...
In [!INCLUDE[pn-ms-dyn-365-for-sales](../includes/pn-ms-dyn-365-for-sales.md)], quotes and invoices are the same item in different states of transition. You can use tools and templates to create and print quotes and invoices.
