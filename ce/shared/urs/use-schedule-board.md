...
On each resource pin associated with a user, there is an indicator icon in the lower-right corner that represents how long ago a resource's location has been detected. Green indicates that the user has logged on and been detected since the start of the current day, while a grey question mark indicates that the location was last detected yesterday or earlier. 
