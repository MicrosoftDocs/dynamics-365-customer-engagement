...
- When there are no Search Start and Search End Dates are used on the resource requirement, requirement group, or the schedulable entity, then search window is defaulted to 60 days from today, and resource availability is shown for the next 60 days. 
