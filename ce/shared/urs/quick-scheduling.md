...
- When quick scheduling an entity that does not have a related requirement, the time zones of search results appear in GMT (UTC) timezone. As an example, if you enable the Leads entity for scheduling you will see a Book button at the top of the Leads form. The Leads record will not have a related requirement record by default but you can still book it with quick scheduling in which case the timezone of recommended timeslots will be in GMT (UTC). If you create a requirement for the Leads record and then quick book, the search results will appear in the timezone noted on the requirement based on the requirement calendar. If there is no timezone on the requirement calendar, quick book will use the timezone of the User who created the requirement. If the User does not have a timezone then GMT (UTC) timezone will be used.
