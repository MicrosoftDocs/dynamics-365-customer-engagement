The schedule board can display the **Service Account** field from a parent schedulable entity in the booking template when you use aggregated view, such as daily, weekly, or monthly. When you enable this feature, the app setting respects security settings such as field-level security on the account-related fields.
