...
- Fixed an issue where **Universal Resource Scheduling** is used as the Scheduling engine, Users who are not System Administrators were unable to complete the Appointment records. With the fix, any user with right privileges to complete the Appointment record, would be able to mark the appointment as complete.
