...
- This release also includes all fixes included in the [3.12.9.76 EA package](https://docs.microsoft.com/en-us/dynamics365/field-service/field-service-version-history-resource-scheduling#312976---april-2020-wave-1-early-access).
...
- Fixed an issue where a custom JavaScript is used in the Schedule Board Client extensions to set the default filter values, but the pre-populated default values are only displayed, when the respective filter control is selected. 
