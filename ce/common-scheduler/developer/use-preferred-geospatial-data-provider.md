...
description: Learn how to use the geospatial data provider of your choice instead of the default by creating a custom plug-in.
ms.date: 07/31/2026
searchScope: 
  - Field Service
  - Project Service
...
The Field Service and Project Operations solutions contain a plug-in registered on these two actions that, *by default*, uses the data provided by the default API to perform geospatial operations.
