...
> For a step-by-step guide with code samples for each step, go to [Extending Universal Resource Scheduling: Find resources by language - a step by step guide](extending-urs-step-by-step.md).
...
Based on the [resource matching flows](#resource-matching-flows-summary), modify these extensibility points for your custom constraints to work:
