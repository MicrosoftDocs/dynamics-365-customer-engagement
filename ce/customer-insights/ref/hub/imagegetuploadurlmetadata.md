---
title: Get Image Upload URL for a Type (Hub)
description: Creates an image association to a specific type.
...
ms.assetid: 98986c28-da82-42e6-86d4-fcc8f3920007
---

Get Image Upload URL for a Type (Hub)
=======================================

[!include[pre release disclaimer](../../../includes/cc-beta-prerelease-disclaimer.md)]

Creates an image association to a [Profile](../types/profile.md) or [Interaction](../types/interaction.md) type and returns a SAS-based URL that enables you to 
...
|-------------|---------------|  
|POST|`<hub-endpoint>/manage/model/media/GetEntityTypeImageUploadUrl?api-version=2017-04-26&locale=<locale-code>`|  
