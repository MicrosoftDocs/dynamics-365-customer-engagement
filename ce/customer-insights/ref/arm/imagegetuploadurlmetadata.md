...
Get Image Upload URL for a Type (ARM)
=======================================

[!include[pre release disclaimer](../../../includes/cc-beta-prerelease-disclaimer.md)]

Gets an image association to a [Profile](../types/profile.md) or [Interaction](../types/interaction.md) type and returns a SAS-based URL that enables you to 
...
### Request Body  
The body contains a [GetImageUploadUrlRequest](../types/images.md) that specifies the type to which an image will be associated.  
