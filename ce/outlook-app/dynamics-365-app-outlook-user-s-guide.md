...
> 
> For a prior release that works with earlier versions of [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)], see [Deploy Dynamics 365 App for Outlook](https://technet.microsoft.com/library/dn946901.aspx).
...
1. Click the **Settings** button ![Dynamics 365 apps web client Settings button](../outlook-app/media/mp-ua-r16-settings.png "Dynamics 365 apps web client Settings button"), and then click **Apps for [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)]**.  
...
Create an email message and then follow the steps in [Link an email message or meeting to a specific Dynamics 365 apps record](#link-an-email-message-or-meeting-to-a-specific-dynamics-365-for-customer-engagement-apps-record).
