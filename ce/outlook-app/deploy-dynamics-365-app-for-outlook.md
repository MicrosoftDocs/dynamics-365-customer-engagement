...
> - App for Outlook uses Microsoft Edge (Spartan or Legacy version) on Windows 10 version 1903 or later with Outlook C2R build Current Channel/Monthly Enterprise Channel/Semi-Annual Enterprise Channel (16.0.13127.20508 +). For all other combinations of Windows and Outlook, App for Outlook will use Microsoft Internet Explorer.
>
