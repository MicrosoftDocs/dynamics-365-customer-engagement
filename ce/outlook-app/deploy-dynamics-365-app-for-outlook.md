...
> - Browser used by App for Outlook: Outlook will use Edge(Spartan/ Legacy) browser when Windows 10 ver. >= 1903 and Outlook C2R build is either the Current Channel/ Monthly Enterprise Channel/Semi-Annual Enterprise Channel (16.0.13127.20508 +). For all other combination of Windows and Outlook, Outlook will use MS IE browser.
>
