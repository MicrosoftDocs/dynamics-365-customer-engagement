...
This feature will not be available for configuration, if not already available. The users who are already using the feature, will receive a communication about the deprecation of the feature.
