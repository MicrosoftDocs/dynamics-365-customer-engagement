...
An app maker can enable a table or custom table that you create to appear in the create **New** menu also know as thequick create menu in Dynamics 365 App for Outlook. 
