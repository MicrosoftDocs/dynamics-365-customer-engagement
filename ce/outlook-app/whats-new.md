...
3. With this OrgDBOrgSetting, the option to track all emails via server-side synchronization can be hidden. For more information, see [OrgDBOrgSettings tool for Microsoft Dynamics CRM](https://support.microsoft.com/en-us/help/2691237/orgdborgsettings-tool-for-microsoft-dynamics-crm). 
4. Fixed performance and reliability issues.

## Oct 2018 
1. Performance and reliability improvements to App for Outlook and Server-Side Synchronization 

## Sep 2018 
1. Dynamics 365 App for Outlook immediately tracks appointments in read mode. 

## Aug 2018 
1. Track meetings using Dynamics 365 App for Outlook when the organizer is from the same organization as the user. 
...
5. Performance improvements to App for Outlook and addressed other bug fixes.
