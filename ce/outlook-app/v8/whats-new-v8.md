...
### June 14, 2018 
1. Fix for appointment attachments not synchronizing from Outlook to Dynamics 365 for Customer Engagement. 
...
2. Fixed the issue of server-side synchronization promoting some emails to Dynamics 365 for Customer Engagement multiple times.

### April 28, 2018

1. Appointment date is updated in Dynamics 365 for Customer Engagement when it is changed on a tracked meeting in Outlook Web App (OWA).
...
6. Server-side synchronization can sync Dynamics 365 for Customer Engagement emails that have information rights property.
