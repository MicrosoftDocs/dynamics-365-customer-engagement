...
**DisplayName**: Report Link<br />
**DisplayCollectionName**: Report Links<br />
**SchemaName**: ReportLink<br />
**CollectionSchemaName**: ReportLinks<br />
**LogicalName**: reportlink<br />
**LogicalCollectionName**: reportlinks<br />
**EntitySetName**: reportlinks<br />
**PrimaryIdAttribute**: reportlinkid<br />
...
**Description**: Unique identifier of the linked report.<br />
**DisplayName**: Linked Report<br />
**LogicalName**: linkedreportid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Lookup<br />
...
**Description**: Name of the linked report.<br />
**DisplayName**: Linked Report Name<br />
**LogicalName**: linkedreportname<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Link type of the report.<br />
**DisplayName**: Link Type<br />
**LogicalName**: linktypecode<br />
...
- **Value**: 1 **Label**: Drill-through
- **Value**: 2 **Label**: Sub-report
- **Value**: 3 **Label**: Drill-through and sub-report



### <a name="BKMK_ReportId"></a> ReportId

**Description**: Unique identifier of the main report.<br />
**DisplayName**: Main Report<br />
...
**Description**: Unique identifier of the report link.<br />
**DisplayName**: Report Link<br />
**LogicalName**: reportlinkid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Unique identifier of the user who created the report link.<br />
...
**Description**: Date and time when the report link record was created.<br />
...
**Description**: Unique identifier of the delegate user who created the reportlink.<br />
...
**Description**: Unique identifier of the user who last modified the report link.<br />
...
**Description**: Date and time when the report link was last modified.<br />
...
**Description**: Unique identifier of the delegate user who last modified the reportlink.<br />
...
**Description**: Unique identifier of the user or team who owns the report link.<br />
...
**Description**: Unique identifier of the business unit that owns the report link.<br />
...
**Description**: Unique identifier of the user who owns the report link.<br />
...
**DisplayName**: <br />
**LogicalName**: reportlinkidunique<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Uniqueidentifier<br />
...
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_reportlink<br />
