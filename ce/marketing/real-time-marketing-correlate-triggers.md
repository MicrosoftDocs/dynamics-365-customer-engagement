---
title: "Correlating across multiple custom triggers (Dynamics 365 Marketing) | Microsoft Docs"
...
# Correlating across custom triggers
...
When the trigger that starts a journey contains a *bindingid*, that ID is used to identify the journey instance. To identify the journey instance, any other event should also use the same *bindingid*. For example, if your start event is *Appointment Confirmed* and it has a binding ID of “123,” your exit event *Appointment Canceled* should also use the same ID (“123”) to uniquely identify the journey instance.

If you're only using custom events in the journey, you can rely on unique strings to identify the journey instances.
...
## Correlating across custom events and out-of-the-box events or custom business events
