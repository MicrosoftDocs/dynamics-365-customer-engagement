...
3. When you drop the **Marketing Page** element in place, it is automatically selected and the **Properties** tab opens to show its settings.
...
10. The **Properties** for the **If/then** tile will automatically appear on the right side of the canvas.
...
11. With the **If/then** tile still selected and the **Properties** tab still open, set **Wait up to** to establish how long contacts will wait on this tile before being sent down the false (bottom) path if they don't submit the registration form. Three days is a typical timeout value, but the best choice depends on your circumstances.
...
12. Add two more **Send an email** tiles after the if/then condition, one on the top path and one on the bottom path.  
...
13. Save your customer journey. Then, as you've done before, go to the **General** tab to give the journey a name and schedule. Finally, **Check for Errors** and **Go Live**. More information: [Create a simple customer journey with email messaging](create-simple-customer-journey.md)
