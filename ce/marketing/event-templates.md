...
1. The **Create from template** dialog opens. Use it to find the template you want to use and then select **OK**.
...
> [!IMPORTANT]
> If your template includes sessions, then each session will keep the schedule they had when the template was saved. You'll need to adjust the schedule of each individual session to ensure that they all fit into the new event dates and times.
