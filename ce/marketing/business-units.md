...
For complete details about how business units work in model-driven apps in Dynamics 365, see [Create or edit business units](https://docs.microsoft.com/en-us/power-platform/admin/create-edit-business-units). Here is a quick summary of concepts that are relevant to the features discussed in this topic:
