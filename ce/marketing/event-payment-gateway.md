...
Your back-end service must authenticate against your Dynamics 365 Marketing instance to enable the service to execute the custom actions needed to finalize the workflow. More information: [Authenticate to Dynamics 365 with the Web API](../developer/webapi/authenticate-web-api.md)
