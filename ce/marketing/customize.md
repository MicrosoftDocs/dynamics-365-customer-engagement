...
For more information about writing code and developing for [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)], see the [Developer Guide for Dynamics 365 for Customer Engagement](../developer/developer-guide.md).
