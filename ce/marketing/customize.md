...
[//]: # (@Karl, please note capital "Customer Engagement", via the Tokenizer. Also you'll notice that there is indeed a token for "Dynamics 365 - custom" that we added recently.)
...
More information about writing code and developing for [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)]: [Dynamics 365 Developer's Center](https://msdn.microsoft.com/en-us/dynamics365)
...
[//]: # (The wording in the first step--"every next custom action" and "from as"--is confusing to me. Is it saying something like "The next step in a custom action must accept the results of previous validation from **ValidationContext**, and set cumulative results to the **ValidationResults** output variable."?)
