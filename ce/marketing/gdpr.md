...
1. Select the **Outbound consent** tab.

1. Configure the **Outbound marketing consent** settings.

    > [!div class="mx-imgBorder"]
    > ![The GDPR configuration form.](media/gdpr-config3.png)

    Make the following settings:
    - **Enable minimum consent level selection drop down for customer journeys**: Set to **Yes** to enable use of the minimum consent level attribute for customer journeys.
    - **Log Consent changes**: Set to **Yes** to audit the **Consent given** field.

1. Select **Save** at the top-left corner of the window.
