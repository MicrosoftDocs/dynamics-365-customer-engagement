...
For more information about how to work with the security groups and other security features in Dynamics 365, see [Manage security, users, and teams](../admin/manage-security-users-and-teams.md).
