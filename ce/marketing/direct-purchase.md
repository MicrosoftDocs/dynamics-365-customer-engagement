...
You can now purchase a Marketing license directly from a Marketing trial. Both tenant admin and non-tenant admins, like marketing department heads, can now directly purchase the Marketing environment SKUs (Dynamics 365 Marketing App, Attach, Additional Production Environment, and Additional Non-Production Environment) and convert the trial environment to a paid, production environment in one streamlined workflow.
...
## Who can purchase a license from trial?

From a trial, tenant admins can enter the direct purchase flow. If tenant admins haven't disabled self-service purchase for non-tenant admins, non-tenant admins (also called departmental purchasers) can also enter the purchase flow and sign-up for a subscription with a credit card.

### Roles & responsibilities for tenant admin vs. non-tenant admin (departmental purchasers)
...
- **Dynamics 365 Marketing license**: Includes one production environment, 10,000 contacts and 100,000 interactions, if your company’s tenant has no pre-existing Dynamics 365 licenses, you'll see the base,
- **Dynamics 365 Marketing Attach**: A discounted version of the Dynamics 365 Marketing license, if your company’s tenant has a pre-existing Dynamics 365 license (Dynamics 365 Sales, Dynamics 365 Customer Service, Dynamics 365 Field Service, Dynamics 365 Supply Chain Management, Dynamics 365 Finance, Dynamics 365 Commerce)
- **Dynamics 365 Marketing Additional Production or Non-production Environments**: These don't have additional quota and will appear if your tenant already has a Dynamics 365 Marketing or Attach license.
