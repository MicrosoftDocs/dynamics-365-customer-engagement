...
[!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] is licensed per instance, with each instance priced according to the number of *marketable contacts* stored in your database. Marketable contacts are those that you engage with marketing activities, such as emails, landing pages, forms, LinkedIn integration, events, and surveys.
