...
> [!NOTE]
> When you sign up for [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)], you'll choose a licensing option that defines your contract period (typically 3 - 12 months). All of the contacts that you engage through marketing activities during that period count towards your total contact quota, even if you delete, or otherwise stop marketing to, an existing marketing contact during the contract period. Your marketing contact quota resets at the start of your next contract period, so at that time any contact that you've deleted or stopped marketing to will no longer count towards your quota.

Unlike most other [!INCLUDE[pn-dynamics-365](../includes/pn-dynamics-365.md)] apps, [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] isn't priced per user, so users already licensed to access any [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] Customer Engagement app on an instance where [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] is installed will also be able to access [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] without requiring you to purchase any additional licenses. You can even request any number of free (&quot;zero dollar&quot;) [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] licenses to assign to users that don't have a [!INCLUDE[pn-dynamics-365](../includes/pn-dynamics-365.md)] license, but these aren't valid for apps other than [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)].
