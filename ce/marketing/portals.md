...
- **Marketing pages**: To publish your content, consult your CMS team. The Dynamics 365 Marketing page designer only supports publishing to Power Apps portals.
- **Marketing forms**: You can either embed forms generated by Dynamics 365 Marketing onto an external page, or create your forms using native tools and then capture them for use in Dynamics 365 Marketing. More information: [Embed forms on external websites](embed-forms.md).
