...
- **Waitlist**: This section only appears if you enable the waitlist in the **Venue constraints** section. Use it to configure options regarding how to [invite waiting contacts](event-waitlist.md) when space becomes available.
