...
Read this topic to learn how to run interactive marketing features for Dynamics 365 for Marketing by using an integrated Dynamics 365 portal or by using your own website or CMS system.
...
To remove portal integration from an existing Marketing instance, simply reset it as described in [Reset a portal](../portals/reset-portal.md).

After removing the portal, you should recreate your landing pages and subscription centers on your external website as needed, and design your customer journeys, [content settings](dynamic-email-content.md#content-settings), and email messages to link to them there. If you're using event management, then you should also install the event management website on your external server.

> [!NOTE]
> If you initially installed Marketing with portal integration enabled, then you did not receive a [default subscription center](set-up-subscription-center.md#default-center) (which otherwise would be running on the service fabric of your Marketing instance). You still won't have one after you remove the portal integration, and you can't create one here. You must therefore create at least one subscription center on your external website and configure your [content settings](dynamic-email-content.md#content-settings) to link to it.
...
1. Launch the [Dynamics 365 for Marketing setup wizard](purchase-setup.md#step-1-launch-the-setup-wizard).
...
1. Continue to work through the wizard following the instructions on your screen.
