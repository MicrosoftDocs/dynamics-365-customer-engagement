---
title: "Create branded, customized preference centers to manage customer consent (Dynamics 365 Marketing) | Microsoft Docs"
...
The default preference center includes options for users to opt-in or opt-out of the **Commercial** and **Tracking** purposes, as well as the default contact point of the user’s email address. You can update how the purposes capture consent in a variety of ways to ensure you capture consent appropriately:
