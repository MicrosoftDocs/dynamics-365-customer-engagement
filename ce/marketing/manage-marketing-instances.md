...
[Manage instances](../admin/new-instance-management.md)  
[Import data (all record types) from multiple sources](https://docs.microsoft.com/en-us/power-platform/admin/import-data-all-record-types)  
[Move configuration data across instances and organizations](https://docs.microsoft.com/en-us/power-platform/admin/manage-configuration-data)  
