...
Some [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] licenses include a free [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] license. If you only recently qualified for the free [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] license, then you should already have the free app available on your tenant. But if you've had a qualifying [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] license for some time, you may need to submit a support request to get the free [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] app added to it.
