...
- Please refrain from deleting fields and creating them again with the same name but different field type. This causes issues in the syncing of the fields with Customer Insights. Instead, create fields with new names (can have the same display name as before). <!--- 1424524 -->
