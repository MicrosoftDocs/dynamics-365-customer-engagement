...
- **Start date and time**: Customers can start the journey only if they perform the event trigger after this start date and time. Select a today's date if you want the journey to start listening to the abandoned cart event trigger immediately after it has been published.  

> [!div class="mx-imgBorder"]
> ![Create an event-based journey screenshot](media/event-based-journey.png)

Additional configuration for starting the journey can be found in the journey taskpane. See [Real-time marketing journey tile reference](real-time-marketing-tile-reference.md). 

## Set the journey goal

The goal for this journey is to *drive a purchase*. You can use the *Purcase completed* event trigger to track and capture when users meet this goal. The **Amount of people needed for this goal** can be set to 50% to indicate that you want at least 50% of customers who abandon carts and are targeted by this journey to go on to complete the purchase.

> [!div class="mx-imgBorder"]
> ![Set the journey goal screenshot](media/event-based-journey-goal.png)
...
> [!div class="mx-imgBorder"]
> ![Set journey exit screenshot](media/event-based-journey-exit.png)
...
> [!div class="mx-imgBorder"]
> !Abandoned cart journey screenshot](media/event-based-abandoned-cart-journey.png)

## Publish the journey

After adding all the steps to the journey canvas, the journey is ready to go live and message real customers. Before publishing the journey, make sure all related content (email, text messages, or push notifications) is in the **Ready to send** state. Any event triggers must also be published and and their code integrated. The journey cannot be modified after its published, so it's a good idea to verify that all the steps in the journey are exactly how you want them before publishing.

Once the journey is published and live, you can look at the journey [analytics](real-time-marketing-analytics.md) to understand how it is performing.
