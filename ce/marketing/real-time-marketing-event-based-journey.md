...
- The *Abandoned cart* event trigger should be raised whenever a customer adds products to the cart but doesn’t complete the purchase.  
- The *Purchase completed* event trigger should be raised whenever a customer completes their purchase.
