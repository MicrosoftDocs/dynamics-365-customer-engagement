...
1. Use the **Enter** key on your keyboard and choose the type of tile you want to add from the drop-down list using your mouse or using the arrow keys. After you have selected the tile, use the **Enter** key.
