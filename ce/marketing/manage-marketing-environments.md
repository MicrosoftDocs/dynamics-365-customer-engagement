...
- After backup, if you restore data in real-time marketing, all interaction & analytics data, Customer Voice data, Asset Library connection and Customer Insights connections will not be restored and all existing data will remain.
