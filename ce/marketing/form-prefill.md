---
title: "Enable prefilling for marketing forms (Dynamics 365 for Customer Engagement for Marketing) | Microsoft Docs"
description: "How to set up your marketing forms to support prefilling of form fields for returning contacts in Dynamics 365 for Customer Engagement for Marketing"
...
- If a contact opens a subscription center page directly, rather than selecting a link from an email, then the ID won't be present in the URL. Instead, [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] requests the cookie as backup to identify the contact. If the cookie isn't found, then the subscription center won't work because it won't know who it's talking to.
