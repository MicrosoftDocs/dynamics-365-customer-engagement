...
You can preview your personalized content in the **Preview and test** view. Preview and test view: [Preview and test send your email](email-preview.md)
...
| ------------------------------------------------ | -------------------------------------------------------------------------------------------------------------- |
| Dynamic text                                     |
| ·       Using Audience                           | Select an audience record(can also enter test data manually)                                                                                      |
| ·       Using trigger                            | Manually provide test dataManually provide test data (can select Dataverse record where appropriate) *Custom triggers are not supported at this time                                                                                     |
| ·       Using specific record                    | Select a record(can also enter test data manually)                                                                                                |
