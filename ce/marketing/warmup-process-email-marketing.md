...
## Warm-up definition
Domain warming is the process of methodically adding email volume to a new domain, gradually, over several days or weeks. Gradually “warming” up the domain establishes a positive sending reputation with mailbox providers.

It doesn't matter if you use shared or dedicated IP addresses, the warmup process is initial and crucial for every sender. It's especially important to warm up your domain in combination with your ESP’s IP addresses, no matter if you use brand new (with 0 reputation) or already used domain (with good reputation) for your email campaigns.

Warmup is incredibly important for senders who plan to use brand new domains and will send large volumes of emails in their Customer Journeys (up to 500k emails per day/CJ).
...
- During the first six weeks, do NOT send subscribers who haven't opened or clicked in the past 90 days.

### What to Expect
Once you begin the warm process, you can expect some bulking (mailbox providers identifying marketing emails as spam) and blocking to occur. The key is to stick with the plan. Below are details of what you can expect and actions to take.
...
- **Delays** at AOL, Microsoft, and Comcast. The delays (421 bounces) will retry for 72 hours, and, if not delivered, will bounce as a 5XX with the original 421 error in the bounce record. Delays are normal and will lessen each day as the IP (Internet Protocol) or domain’s reputation develops. So long as the emails are ultimately delivered, there's no concern. However, if emails are timing out in large quantities, you should back down your volumes to the mailbox provider by tightening your engagement window (the time since a recipient last interacted with one of your emails).
...
Some senders might require sending emails through a dedicated IP address. Whether a dedicated IP address is best for your Marketing setup depends on many factors. 

Warming up a dedicated IP address in combination with your domain would require additional effort as the entire process becomes even more delicate and complex. In addition to the domain warmup, you would need to keep a close look at the dedicated IP reputation as well.

Additionally, dedicated IP requires a stable email flow to keep it “warmed” and maintain its reputation at acceptable levels. It would require you to re-warm your IP if you haven't sent any emails in the last 30 days.

IP warming is similar to domain warmup and is the practice of gradually increasing the volume of mail sent through a dedicated IP address according to a predetermined schedule. This gradual process establishes a reputation with ISPs (Internet Service Providers) as legitimate email sender.

When an ISP observes email suddenly coming from a new or "cold" IP address, they'll take notice, and immediately begin evaluating the traffic coming from that IP. Because ISPs treat email volume as a key determining factor when detecting spam, it's best to begin sending a low to moderate volume, eventually working your way up to larger volumes. This gives the receiving email providers a chance to closely observe your sending habits and record how your recipients engage with your email.
...
There's no general rule, numbers or standard warmup schedule that will suit every sender. Every warmup plan is individual and may require additional analysis done by Deliverability expert to make the process smooth and effective. It depends on several factors like overall planned daily/monthly volume of emails, target recipient IPS’s frequency of the email campaigns, type of emails(marketing/transactional) etc.
...
To sustain a dedicated IP, you'll need to send enough volume to maintain it. We recommend that you send a minimum of 50,000 messages, three times per week (150,000 messages per week total).
### List quality
