---
title: "Open and use the Dynamics 365 for Customer Engagement admin center (Dynamics 365 for Customer Engagement for Marketing) | Microsoft Docs  "
description: "How to open and use the Dynamics 365 for Customer Engagement admin center to manage your Dynamics 365 for Customer Engagement for Marketing instances"
...
# Open the Dynamics 365 for Customer Engagement admin center
...
3. The **Home** dashboard for [!INCLUDE[pn-ms-office-365](../includes/pn-ms-office-365.md)] opens. In the navigation column on the left, expand **Admin centers**, and then select **[!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)]**.  
    ![Open the Dynamics 365 for Customer Engagement admin center](media/update-open-d365-admin.png "Open the Dynamics 365 for Customer Engagement admin center")

4. The [!INCLUDE[pn-dyn-365-admin-center](../includes/pn-dyn-365-admin-center.md)] opens.  
     ![The Dynamics 365 for Customer Engagement admin center](media/update-d365-admin-center.png "The Dynamics 365 for Customer Engagement admin center")
