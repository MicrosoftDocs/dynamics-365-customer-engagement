...
1. Choose **+New** from the command bar. The **New Task Activity Marketing Template** page opens.  
...
1. Choose **Save** from the command bar to save your template.

1. Go to **Marketing** &gt; **Marketing Execution** &gt; **Customer Journeys**.

1. Choose **+New** from the command bar to create a new journey.

1. The **Select a Customer Journey Template** dialog opens. Choose the **Blank Template** and then **Select**.  
...
1. Choose **Go Live** from the command bar to activate the journey.

1. Go to **Marketing** &gt; **My Work** &gt; **Tasks**. Choose **All Tasks** from the view menu to make sure you can see all tasks in the system.  
