...
- **Dynamics 365&mdash;custom**: This app combines features from many of the various Dynamics 365 for Customer Engagement apps you have licensed into a single navigation structure (but most Dynamics 365 Marketing end-user features *aren't* included here). It uses an interface similar to the Surveys app. Administrators, and especially customizers, may prefer to work here rather than in Dynamics 365 Marketing because more settings are available, and the user interface is the one described in the customizer and portals documentation. More information: [Engage with customers online with portals](portals.md), [Customize Dynamics 365 Marketing](customize.md), and [Administrator Guide for Dynamics 365 Customer Engagement](../admin/admin-guide.md)
