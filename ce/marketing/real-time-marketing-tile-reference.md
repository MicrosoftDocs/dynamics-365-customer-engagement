...
## Activate a custom event trigger
...
To learn more about triggering a custom event, see [Use custom events as actions in real-time marketing journeys](real-time-marketing-custom-event-actions.md).
