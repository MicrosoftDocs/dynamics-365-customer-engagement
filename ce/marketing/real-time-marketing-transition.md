...
1. **How do I start with real-time marketing?**
    ...
    > ![Graphic showing a gradual transition from outbound to real-time.](media/outbound-to-real-time.png "Graphic showing a gradual transition from outbound to real-time")
