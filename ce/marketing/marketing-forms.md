...
The form designer is similar to other types of digital content designers in Dynamics 365, but only provides design elements and settings that are appropriate for marketing forms.
...
When creating or editing a form, you'll be in the form designer, which is an example of the Dynamics 365 digital-content designer that offers design elements for working with forms.
...
- **Timeline**: Shows a history of notes and other activities related to the current form. Most types of entities in Dynamics 365 for Customer Engagement include this type of display.
