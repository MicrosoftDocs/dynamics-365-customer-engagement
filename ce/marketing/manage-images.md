...
1. Choose **New** from the command bar to create a new keyword. Its only setting is a **Name**.  
...
1. Choose **New** from the command bar to upload a new file. The **Upload Files** dialog opens.

1. Either drag a file from a [!INCLUDE[pn-ms-windows-short](../includes/pn-ms-windows-short.md)] Explorer window to this dialog, or choose **browse** to locate and choose an image using a file browser window.  
...
1. Choose **Save** to upload your images to [!INCLUDE[pn-crm-2016-shortest](../includes/pn-crm-2016-shortest.md)].

1. If needed, go back to **Marketing** &gt; **Internet Marketing** &gt; **Files**, where you can open any listed image and edit its display name.
