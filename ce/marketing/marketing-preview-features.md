...
- **Total used by this organization**: Shows the total number of each quota that you've used for the current [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] organization (also known as an *instance*).
