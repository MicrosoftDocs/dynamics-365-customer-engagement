...
Adding the Commercial communications and Tracking consent elements will create Contact point consent records for the chosen channels, email and text. In addition, these fields will update the Contact's Bulk email and Tracking consent values based on the preferences submitted as a part of this form.
