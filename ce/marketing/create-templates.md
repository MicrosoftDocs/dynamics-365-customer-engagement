---
title: "Work with templates in Dynamics 365 for Marketing | Microsoft Docs"
...
As you've seen, each time you create a new email message, customer journey, marketing page, or marketing form, you start by choosing a template to get started. [!INCLUDE[pn-crm-2016-shortest](../includes/pn-crm-2016-shortest.md)] includes sample templates to get you started, but you'll probably want to build your own to match your own organization's requirements and graphical identity.
