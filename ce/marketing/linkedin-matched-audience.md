...
> [!IMPORTANT]
> To make use of a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] Matched Audience to run a campaign on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)], you must already have a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] account obtained from [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] to enable marketing on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] with that account. This can result in additional costs associated with marketing and advertising on the [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] platform.

> [!IMPORTANT]
> [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] always hash-encodes each email address before sending it to [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)], so [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] will be able to match these addresses to existing [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] members but does not decode the email addresses themselves. This important technique helps protect the privacy of your [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] contacts.

> [!IMPORTANT]
> [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] members can opt-out of having their data shared with external apps in their [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] settings. [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] members that have enabled this opt-out option won't be matched to incoming [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] audiences and therefore won't be included in your [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] Matched Audiences even if they do match your [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] segment.
