...
[LinkedIn Matched Audiences](https://www.linkedin.com/help/lms/answer/86492/linkedin-matched-audiences-overview?lang=en) is a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] feature that lets you match a collection of contacts stored on an external system, like [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)], to an audience of [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] users with matching email addresses. [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] comes ready to take advantage of this capability, so you can leverage your [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] static segments to create a matching audiences of [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] profiles. Then, when you run a campaign on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)], you can target the same segments that you set up in [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] and also turn any leads generated on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] into [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] leads through the [LinkedIn Lead Gen Forms integration](linkedin-lead-gen-integration.md) feature also offered by [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)].

> [!IMPORTANT]
> To make use of a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] Matched Audience to run a campaign on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)], you must already have a [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] account and make a separate agreement with [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] to enable marketing on [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] with that account. This can result in additional costs associated with marketing and advertising on the [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] platform.

> [!IMPORTANT]
> [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] always hash-encodes each email address before sending it to [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)], so [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] will be able to match these addresses to exiting [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] profiles but won't be able to decode the email addresses themselves. This important technique helps protect the privacy of your [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] contacts.

> [!IMPORTANT]
> [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] users can opt-out of having their data shared with external apps. All [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] users that have enabled this option won't be matched to incoming [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] audiences and therefore won't be included in your [!INCLUDE[pn-linkedin](../includes/pn-linkedin.md)] Matched Audiences even if they do match your [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] segment.
