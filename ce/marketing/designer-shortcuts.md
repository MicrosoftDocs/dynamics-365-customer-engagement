...
Dynamics 365 Marketing supports most (but not all) of the same keyboard shortcuts and accessibility features provided for other Dynamics 365 for Customer Engagement applications. For details, see the following help topics:
