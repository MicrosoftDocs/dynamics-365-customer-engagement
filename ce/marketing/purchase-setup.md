...
>   - In most cases, you must have a [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)] license assigned to you on your tenant. However, if you have purchased a stand-alone license for Dynamics 365 for Marketing, there is no legal requirement to have the Customer Engagement license if you don't have one. A known issue currently prevents you from running the setup wizard without the license, but a workaround is available; see [Configuration, installation, and first-run experience](readme.md#configuration-installation-and-first-run-experience) in the readme for details.
