...
> [!IMPORTANT]
> A setup form is provided to help you set up [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] for the first time. Before opening the form, you must meet all of the following requirements:
...
> - You must run the setup form as a [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] user with admin privileges on the [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] org where you are installing [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)].> - Close all other browser windows and tabs before starting
...
> - For trial and previews, please download the [Dynamics 365 for Marketing limits for trials and previews](https://go.microsoft.com/fwlink/p/?linkid=864735) document.
> 
...
The remaining sections of this topic provide details about each step of the setup form.

### Step 1: Choose an organization and name your portal

A [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] organization (org) is the foundation on which all [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] customer engagement apps are built. All the various [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] apps installed on a given org can potentially be integrated with one another and share data in various ways. If you aren't already using any other [!INCLUDE[pn-microsoftcrm](../includes/pn-dynamics-365.md)] apps, you'll set up a new org now. If you already have one or more orgs, you'll be able to select an existing one that you want to integrate with the [!INCLUDE[pn-marketing-app-module](../includes/pn-marketing-app-module.md)] app, or create a new one.
...
### Step 2: Provide consent and enter your postal address
...
1. Read the consent text shown for for each check box carefully, and follow the links to make sure you understand all of the relevant issues. If you agree with the terms, then mark each checkbox as you go to indicate your consent. Some of these are optional, so you can still use the product without them (the related features will be disabled), but others features are required, so you won't be able to to use  [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] without agreeing to them.
