...
> [!IMPORTANT]
> If are using DMARC and fail to integrate [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] into your DMARC configuration, your marketing emails are very likely to be labelled as junk and removed from inboxes by large email providers including Gmail and Outlook.com. 
...
1. Set up email accounts that you can read on each service.
