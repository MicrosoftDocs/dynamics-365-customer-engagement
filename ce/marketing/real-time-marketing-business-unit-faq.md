...
Areas that support business units but don't yet support modernized business units (that is, allowing users to modify the business unit of a record) –
1. Consent Center
2. Settings > Customer engagement > Compliance
3. Settings > Customer engagement > SMS providers
4. Settings > Customer engagement > Custom channels
5. Settings > Customer engagement > Push notifications
6. Settings > Customer engagement > SMS keywords

Areas that don't yet support business units at all (that is, all records are created at the organization level) –
1. Domains 
