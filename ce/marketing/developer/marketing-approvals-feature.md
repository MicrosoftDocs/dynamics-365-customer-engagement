...
Dynamics 365 Marketing now provides an infrastructure with expanded extendability features that offer new possibilities for developers, and one way to take advantage of this new extendibility is to create an approvals feature, possibly including integration with Microsoft Flow.
