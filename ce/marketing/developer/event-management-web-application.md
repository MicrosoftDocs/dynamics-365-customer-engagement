...
- **isAuthenticationEnabled** - Used by event management to turn on support user authentication. If false login/logout dropdown will not be shown on the navigation bar.
