...
|--|--|--|--|
|Sample Event Website| 1.24.0 (June release)| - Updated deployment script to allow deploying files individually for Portals. <br/>- Minor improvements and bug fixes.| [Download](https://download.microsoft.com/download/1/5/0/150757D0-2600-493B-8C9A-3213AD873A73/200605-EventWebsite.zip)
