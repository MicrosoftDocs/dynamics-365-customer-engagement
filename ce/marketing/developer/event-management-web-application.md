...
|--|--|--|--|
|Sample Event Website| 1.19.0 (December release)| - Fixed some accesibility issues. <br/>- Updated website languages. <br/>- Improved speaker page. <br/>- Other minor improvements and bug fixes. | [Download](https://download.microsoft.com/download/1/5/0/150757D0-2600-493B-8C9A-3213AD873A73/191201-EventWebsite.zip)
