...
For example if you want to use **SpecialTile** as the name for your XML file then the file name will be the following assuming the [solution publisher prefix](../../customize/change-solution-publisher-prefix.md) in your Dynamics 365 instance is "sample": **sample_SpecialTileCustomerJourneyDesignerTileConfig.xml** 
