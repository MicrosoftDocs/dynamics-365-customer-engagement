...
description: "Learn how to create a custom channel to use in Dynamics 365 Marketing customer journeys."
ms.date: 02/09/2022
...
[Publish a custom channel on AppSource](publish-custom-channel-appsource.md)

[Configure and use a custom channel](configure-use-custom-channel.md)  
