...
> [!TIP]
> You can also generate request and response classes for this action to include in your application code. More information: [Generate early-bound types for an action](../../customerengagement/on-premises/developer/create-own-actions.md#generate-early-bound-types-for-an-action)
