...
Installing a custom channel installs a [managed solution](../../customerengagement/on-premises/developer/introduction-solutions.md#unmanaged-and-managed-solutions) for the custom channel in your instance. After the custom channel is installed in your instance, users will see the new custom channel tile in their customer journey designer when they create a customer journey.
