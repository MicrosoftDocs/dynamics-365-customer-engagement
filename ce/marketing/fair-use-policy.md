...
| Data synchronization  | Overall total volume of rows [synchronized to Marketing](./mkt-settings-sync.md)| 100,000,000 rows                                        |
| Data synchronization  | Volume of one record type [synchronized to Marketing](./mkt-settings-sync.md)| 20,000,000 rows                                        |
