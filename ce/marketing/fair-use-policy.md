...
| Data synchronization  | Overall total volume of rows [synchronized to Marketing](https://docs.microsoft.com/dynamics365/marketing/mkt-settings-sync)| 100,000,000 rows                                        |
| Data synchronization  | Volume of one record type [synchronized to Marketing](https://docs.microsoft.com/dynamics365/marketing/mkt-settings-sync)| 20,000,000 rows                                        |
