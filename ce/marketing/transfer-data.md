...
> 
> - You can use the metadata browser tool to explore and understand your database structure. For details about how to install and use it, see the [Dynamics 365 for Marketing entity reference](developer/marketing-entity-reference.md).
