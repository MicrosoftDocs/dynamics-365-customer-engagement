...
2. For the next step of the configuration, an app developer will have to help you get the iOS APNs certificate or tokens or Android FCM key for your mobile application. Learn more: [Push notification setup for application developers]().
...
3. Review and save your app configuration and then find and click on your newly created mobile app configuration in **Settings > Customer engagement > Push notification**. Go to the **Developer information** tab, copy these details, and share them with your app developer as they will need them to connect your app.
