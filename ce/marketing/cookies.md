...
- **Event website**: The event website uses a session cookie to enable contacts to sign in and register for events. Additionally, it uses cookies to store the users language.
