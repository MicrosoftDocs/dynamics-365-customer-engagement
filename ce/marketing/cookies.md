...
| msd365mkttr | No | Behavior tracking | First party | Persistent, client-side | This is being used for the same   purpose as the first cookie(79f08280-5c63-4331-b04d-fb6f39afda51).  | Set by the form loader or website tracking   script |
|  |  |  |  |  | Only   difference is that this cookie is set on the customer domain. 
|  |  |  |  |  | In   some cases, we are unable to access 3rd party cookies (ex: safari OOB blocks) therefore we set this 1st party cookie to keep   functionality. |
