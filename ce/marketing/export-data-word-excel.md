...
You can export Dynamics 365 data to a Word or Excel template to create standardized documents that you can share with people who don't use Dynamics 365.

> [!TIP]
> You can export the templates that are included in [!INCLUDEDynamics 365 Sales, modify them, and then reimport them as new templates. This can give you a running start on creating your own custom Excel templates.

## Generate a Word document with Dynamics 365 data
...
To export Dynamics 365 data by using a Word template, do the following:
...
2. On the command bar, select **Word Templates**, and then under **Word Templates**, choose the template want to use. If you don't see the template you are looking for, consider the following:
   ...
   - If you are looking for a brand-new template, you might need to refresh the page to see it. Either refresh your browser or close and reopen Dynamics 365.
...
## Generate an Excel workbook with Dynamics 365
...
In Dynamics 365, select a record type (entity) to export to an Excel workbook.

For example, go to **Marketing** &gt; **Lead management** &gt; **Leads**.

### Step 2: Export Dynamics 365 data by using an Excel template
...
Dynamics 365 generates your Excel workbook and downloads it to your computer.
