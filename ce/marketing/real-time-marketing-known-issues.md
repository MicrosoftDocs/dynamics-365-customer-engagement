...
- Customer Insights segments used in customer journeys can’t currently exceed 10 million profiles. A segment of larger size may get truncated to the first 10 million profiles only.
