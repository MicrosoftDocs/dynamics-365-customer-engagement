...
> [!TIP]
> The event website typically lists the sponsors of each event, where they are shown using a name and logo. For details about how to add logos to your event sponsors, see [Configure website graphics and registration options](#website-graphics-options).
