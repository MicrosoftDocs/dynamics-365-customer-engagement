...
> [!TIP]
> Each marketing page that you publish from Dynamics 365 Marketing automatically includes its own unique JavaScript tracking code and therefore appears on the **Websites** list page as a discrete website. To view analytics of any of these pages, go to the **Websites** list view and open its **Marketing Pages Websites** view.
> 
