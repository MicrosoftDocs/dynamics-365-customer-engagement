...
[!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] can collect information about how your website is used by its individual visitors. To enable the feature, the system generates [!INCLUDE[pn-jscript](../includes/pn-jscript.md)] code that you must add to each page that you want to monitor (usually an admin would do this site-wide by using your CMS system). The [!INCLUDE[pn-jscript](../includes/pn-jscript.md)] uses cookies to record each page that an individual browser requests from your website. Visitors will remain anonymous until they register by using a [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] landing page. <!-- , at which time [!INCLUDE[pn-marketing-business-app-module-name](../includes/pn-marketing-business-app-module-name.md)] will be able to link both new and historic browsing records to an actual contact in the system.-->
