...
Natural language input enables you to use common words and phrases to describe a simple condition you want to include in your customer journey. The data model is built on top of Common Data Model.
