...
- **Stop**: Select this button to take down the live version of the content block. The content then become editable to you, but you won't be able to use the content block in any new designs until you publish it again. When stopped, you can save your work without going live, but the block will remain unavailable for use until you select **Go Live**.
...
4. Continue working with your design and eventually go live when you are ready to start using it in other designs.