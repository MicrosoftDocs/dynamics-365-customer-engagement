...
- In the Members view, users can sort by "Full name" and "Email" columns. Sorting by related entities and on custom columns/views is not supported at the moment. <!--- 215415458 -->
