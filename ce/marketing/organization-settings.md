...
- **Excel and Word Templates**: Create templates that you can use to export, format, and share data from Dynamics 365. [!INCLUDE [proc-more-information](../includes/proc-more-information.md)] [Manage Excel templates](manage-excel-templates.md) and [Manage Word templates](manage-word-templates.md)
