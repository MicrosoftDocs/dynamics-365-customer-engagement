...
- When migrating a Marketing environment between tenants, interaction data (e.g. email clicks), analytics data (e.g. Journey analytics) and Customer Voice data will not be migrated.
