...
> [!Note]
> - Users with the omnichannel access (license) can only use the Omnichannel for Customer Service app.
> 
> - Chat for Dynamics 365 provides out-of-the-box channel that agents use to communicate with the customers in the Omnichannel for Customer Service app.
>
> - Administrators or system cutomizers can't integrate third-party channels with Omnichannel for Customer Service app.
