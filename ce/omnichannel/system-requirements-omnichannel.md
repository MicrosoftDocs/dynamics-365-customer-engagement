...
| Web browsers | Supported browsers:<li> Microsoft Edge ([Chromium-based Edge](https://support.microsoft.com/en-us/help/4501095/download-the-new-microsoft-edge-based-on-chromium)) <br> **Note:** Version 79.0.309.65 or later is required for desktop notifications</li> <li> Google Chrome </li> |
