...
5. Edit the **Identify** field, and in the **Choose information to identify** dialog box, select an option that will match the context variable data type. For information on the data type mapping, see [Data type mappings for context variables](context-variables-for-bot.md#data-type-mappings-for-context-variables).
