...
>
> - We recommend that you remove the smart-assist control if you've customized a form to add smart-assist. If you don't remove the smart-assist control, agents wouldn't be able to see the smart-assist control in the form and also in the productivity pane.
