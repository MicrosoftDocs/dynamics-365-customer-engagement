---
title: "Configure a custom chat message| MicrosoftDocs"
description: "Instructions to add configure custom messages in a chat widget in Omnichannel for Customer Service."
author: lalexms
ms.author: laalexan
manager: shujoshi
ms.date: 04/03/2020
...
4. On the **Custom Messages** page, select **Add**.
    ...
    > ![Add a custom message in a chat widget](../media/oc-custom-messages-add.png "Add a custom message")


5. On the **New system message** page, select the **Event type** drop-down menu, choose the event type, and then select **Save**.

    > [!div class=mx-imgBorder]
    > ![Select the message event type](../media/oc-custom-new-system-message.png "Select the message event type")

6. Select **Edit** to change the message.   

    > [!div class=mx-imgBorder]
    > ![Select Edit to change the message](../media/oc-edit-custom-message.png "Select Edit to change the message")
    
7. In the **Edit system message** box, type the message you want to display, and then select **Save**.   

    > [!div class=mx-imgBorder]
    > ![Select Edit to change the message](../media/oc-custom-edit-system-message.png "Select Edit to change the message")
