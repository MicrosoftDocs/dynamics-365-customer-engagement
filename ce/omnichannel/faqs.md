...
-	If multiple agents have the same remaining capacity, the agent who is waiting for a work item for a longer duration will receive the new conversation request.
