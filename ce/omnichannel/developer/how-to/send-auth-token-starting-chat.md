...
> [!NOTE]
> The [authTokenProvider](../reference/methods/setAuthTokenProvider.md#parameters) function in the [setAuthTokenProvider](../reference/methods/setAuthTokenProvider.md) method must respond within 10s. After 10s the `authTokenProvider` function timesout.
