...
|`data-render-mobile`| Enables you to open the chat widget in mobile mode. The chat widget does not have a header when used on a mobile device.|Use this script to enable rendering of your chat widget on mobile devices.<br />`<script id="Microsoft_Omnichannel_LCWidget" src="<valid-src>" data-app-id="<valid-app-id>" data-org-id="<valid-org-id>" data-org-url="<valid-org-url>" data-render-mobile="true" data-hide-chat-button="true"></script>` |
