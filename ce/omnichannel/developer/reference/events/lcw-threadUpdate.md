...
This event is raised by live chat when an agent ends a conversation.<!--Isn't this next sentence purely redundant? Suggest deleting: It indicates that the agent has ended the conversation.-->
