...
> [!IMPORTANT]
> This entity has been deprecated. It will still be visible in the [$metadata](/powerapps/developer/common-data-service/web-api-types-operations#csdl-metadata-document) document of your Dynamics 365 environment but using it to access Common Data Service data is not supported.
