...
The Formatting API sample control explores the various methods available as part of the PowerApps Control Framework’s Formatting API.  
 
In this sample we create a series of input elements which call into the respective methods of the PowerApps Control Framework's formatting API that matches with the value displayed. 
