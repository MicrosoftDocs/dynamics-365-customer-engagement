...
> [!NOTE]
> In the [!INCLUDE[pn_sdk](../includes/pn-sdk.md)] documentation, the term “entity attribute” is used interchangeably with the term “attribute” and the term “property” (class property).
  
<a name="bkmk_EntityMetadata"></a>

## Entity metadata

 The metadata for a [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] organization contains the definitions for the entities, attributes, and the relationships between the entities. For more information, see [The Metadata and Data Models in Dynamics 365](metadata-data-models.md). As a developer there are many cases where it is useful to be able to find all the metadata for an organization. There are a number of ways you can find and reference the metadata:  
...
### See also  
 ...
 [Use Metadata to Generate Entity Diagrams in Dynamics 365 Customer Engagement](use-metadata-generate-entity-diagrams.md)   
