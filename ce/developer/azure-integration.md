---
title: "Azure integration with Dynamics 365 for Customer Engagement (Developer Guide for Dynamics 365 for Customer Engagement)| MicrosoftDocs"
description: "Learn about connecting Dynamics 365 for Customer Engagement (online) Customer Engagement with the Azure platform by coupling the Dynamics 365 for Customer Engagement event execution pipeline to the Azure Service Bus."
ms.custom: ""
ms.date: 09/19/2018
ms.reviewer: ""
 ...
 **Microsoft Azure Solution**  
 ...
 [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] supports sending event data to an [!INCLUDE[pn_azure_event_hubs](../includes/pn-azure-event-hubs.md)] solution. [!INCLUDE[cc_feature_included_with_update_8_1_0_admins](../includes/cc-feature-included-with-update-8-1-0-admins.md)]. [!INCLUDE[sdk_for_more_info_about](../includes/sdk-for-more-info-about.md)] event hubs see [Work with Dynamics 365 for Customer Engagement event data in your Azure Event Hub solution](work-event-data-azure-event-hub-solution.md).  
...
## A [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)]-to-service bus scenario  
 ...
 ![Dynamics 365 for Customer Engagement to Service Bus scenario](media/crm-v5s-az.png "Dynamics 365 for Customer Engagement to Service Bus scenario")  
...
### See also  
 ...
 [Configure Azure integration with Dynamics 365 for Customer Engagement](configure-azure-integration.md)   
