---
title: "Run a simple program using web services (Developer Guide for Dynamics 365 for Customer Engagement) | MicrosoftDocs"
...
- Download the [Sample: Quick start for Microsoft Dynamics 365 for Customer Engagement](https://code.msdn.microsoft.com/Sample-Quick-start-for-650dbcaa)
...
### See also  
 ...
 [Sample: Simplified Connection Quick Start using Dynamics 365 for Customer Engagement](xrm-tooling/sample-simplified-connection-quick-start.md)   
 [Write Code for Dynamics 365 for Customer Engagement](extend-dynamics-365-server.md)   
 [Sample Code Directory for Dynamics 365 for Customer Engagement](sample-code-directory.md)   
