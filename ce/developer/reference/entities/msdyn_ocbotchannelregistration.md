---
title: "Bot Channel Registration (msdyn_ocbotchannelregistration) table/entity reference (Microsoft Dynamics 365)"
description: "Includes schema information and supported messages for the Bot Channel Registration (msdyn_ocbotchannelregistration) table/entity with Microsoft Dynamics 365."
...
The following table lists the messages for the Bot Channel Registration (msdyn_ocbotchannelregistration) table.
...
The following table lists selected properties for the Bot Channel Registration (msdyn_ocbotchannelregistration) table.

|Property|Value|
| --- | --- |
| **DisplayName** | **Bot Channel Registration** |
| **DisplayCollectionName** | **Bot Channel Registrations** |
