---
title: "intententity (msdyn_intententity) table/entity reference (Microsoft Dynamics 365)"
description: "Includes schema information and supported messages for the intententity (msdyn_intententity) table/entity with Microsoft Dynamics 365."
...
# intententity (msdyn_intententity) table/entity reference (Microsoft Dynamics 365)

Associates an intent to any entity such as case, conversation to capture evolving intent.

## Messages

The following table lists the messages for the intententity (msdyn_intententity) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_intententities(*msdyn_intententityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `BulkRetain`<br />Event: True |<xref:Microsoft.Dynamics.CRM.BulkRetain?displayProperty=nameWithType /> |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `Create`<br />Event: True |`POST` /msdyn_intententities<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_intententities(*msdyn_intententityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `SetState`<br />Event: True |`PATCH` /msdyn_intententities(*msdyn_intententityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_intententities(*msdyn_intententityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_intententities(*msdyn_intententityid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
...
### <a name="BKMK_lk_msdyn_intententity_createdby"></a> lk_msdyn_intententity_createdby
...
### <a name="BKMK_lk_msdyn_intententity_modifiedonbehalfby"></a> lk_msdyn_intententity_modifiedonbehalfby
...
Many-To-One Relationship: [duplicaterecord msdyn_intententity_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_intententity_DuplicateBaseRecord)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_intententity_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_intententity_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [msdyn_intentattribute_entity msdyn_msdyn_intententity_msdyn_intentattribute_entity_intent_entityid](msdyn_intentattribute_entity.md#BKMK_msdyn_msdyn_intententity_msdyn_intentattribute_entity_intent_entityid)
