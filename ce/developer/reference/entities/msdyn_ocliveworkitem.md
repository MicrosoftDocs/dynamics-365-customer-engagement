...
| `CCaaS_AddChannelToConversation`<br />Event: False |**CCaaS_AddChannelToConversation action** |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `CCaaS_CancelConsult`<br />Event: False |**CCaaS_CancelConsult action** |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `CCaaS_GuidedAgentGroupTransferConsult`<br />Event: False |**CCaaS_GuidedAgentGroupTransferConsult function** |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `CCaaS_InitiateAgentGroupAssignment`<br />Event: False |**CCaaS_InitiateAgentGroupAssignment action** |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
...
- [msdyn_lastactiveownerid](#BKMK_msdyn_lastactiveownerid)
...
### <a name="BKMK_msdyn_conversationactivechattimeinseconds"></a> msdyn_conversationactivechattimeinseconds

|Property|Value|
|---|---|
|Description|**Conversation active chat time in seconds**|
|DisplayName|**Conversation Active Chat Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Property|Value|
|---|---|
|Description|**Conversation active wrap up time in seconds**|
|DisplayName|**Conversation Active Wrap Up Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|DisplayName|**Conversation First Wait Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Property|Value|
|---|---|
|Description|**Conversation Handle Time In Seconds**|
|DisplayName|**Conversation Handle Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Property|Value|
|---|---|
|Description|**Conversation hold time in seconds**|
|DisplayName|**Conversation Hold Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Property|Value|
|---|---|
|Description|**Conversation talk time in seconds**|
|DisplayName|**Conversation Talk Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
### <a name="BKMK_msdyn_conversationtype"></a> msdyn_conversationtype

|Property|Value|
|---|---|
|Description|**Conversation type to indicate if liveworkitem is inbound or outbound**|
|DisplayName|**Conversation type**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_conversationtype`|
|RequiredLevel|None|
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_ocliveworkitem_msdyn_conversationtype`|

#### msdyn_conversationtype Choices/Options
...
|1|**Inbound\_DID**|
|2|**Inbound\_Callback**|
|3|**Outbound\_AgentInitiated**|
|4|**Outbound\_PESInitiated**|

### <a name="BKMK_msdyn_conversationwrapuptimeinseconds"></a> msdyn_conversationwrapuptimeinseconds

|Property|Value|
|---|---|
|Description|**Conversation Wrap Up Time In Seconds**|
|DisplayName|**Conversation Wrap Up Time**|
|IsValidForForm|True|
|IsValidForRead|True|
...
|---|---|
|Description||
|DisplayName|**Disposition Code Control Field**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_dispositioncodecontroldata`|
|RequiredLevel|None|
|Type|String|
|Format|Text|
|FormatName|Text|
...
### <a name="BKMK_msdyn_lastactiveownerid"></a> msdyn_lastactiveownerid

|Property|Value|
|---|---|
|Description|**Last active owner id**|
|DisplayName|**LastActiveOwnerID**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_lastactiveownerid`|
|RequiredLevel|None|
|Type|Lookup|
|Targets|systemuser|
...
|Property|Value|
|---|---|
|Description|**Conversation Extension details**|
|DisplayName|**Conversation Extension**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_ocliveworkitemextensionid`|
|RequiredLevel|None|
|Type|Lookup|
|Targets|msdyn_ocliveworkitemextension|
...
|DisplayName|**(Deprecated) State Reason**|
|IsValidForForm|True|
|IsValidForRead|True|
...
One-To-Many Relationship: [msdyn_language msdyn_msdyn_language_msdyn_ocliveworkitem_msdyn_languageid](msdyn_language.md#BKMK_msdyn_msdyn_language_msdyn_ocliveworkitem_msdyn_languageid)
...
One-To-Many Relationship: [msdyn_agentgroup msdyn_msdyn_ocliveworkitem_msdyn_agentgroup_activeagentgroupid](msdyn_agentgroup.md#BKMK_msdyn_msdyn_ocliveworkitem_msdyn_agentgroup_activeagentgroupid)
...
### <a name="BKMK_msdyn_ocliveworkitem_msdyn_lastactiveownerid_systemuser"></a> msdyn_ocliveworkitem_msdyn_lastactiveownerid_systemuser

One-To-Many Relationship: [systemuser msdyn_ocliveworkitem_msdyn_lastactiveownerid_systemuser](systemuser.md#BKMK_msdyn_ocliveworkitem_msdyn_lastactiveownerid_systemuser)

|Property|Value|
|---|---|
|ReferencedEntity|`systemuser`|
|ReferencedAttribute|`systemuserid`|
|ReferencingAttribute|`msdyn_lastactiveownerid`|
...
One-To-Many Relationship: [msdyn_ocliveworkitemextension msdyn_ocliveworkitem_ocliveworkitemextensionid_msdyn_ocliveworkitemextension](msdyn_ocliveworkitemextension.md#BKMK_msdyn_ocliveworkitem_ocliveworkitemextensionid_msdyn_ocliveworkitemextension)
...
One-To-Many Relationship: [msdyn_region msdyn_ocliveworkitem_regionid_msdyn_region](msdyn_region.md#BKMK_msdyn_ocliveworkitem_regionid_msdyn_region)
...
Many-To-One Relationship: [msdyn_evaluationplanontriggerbacklog msdyn_evaluationplanontriggerbacklog_ObjectId_msdyn_ocliveworkitem](msdyn_evaluationplanontriggerbacklog.md#BKMK_msdyn_evaluationplanontriggerbacklog_ObjectId_msdyn_ocliveworkitem)
...
Many-To-One Relationship: [msdyn_intentcontexthistory msdyn_intentcontexthistory_poly_msdyn_ocliveworkitem](msdyn_intentcontexthistory.md#BKMK_msdyn_intentcontexthistory_poly_msdyn_ocliveworkitem)
...
Many-To-One Relationship: [msdyn_evaluation msdyn_msdyn_evaluation_msdyn_ocliveworkitem_msdyn_RegardingObjectId](msdyn_evaluation.md#BKMK_msdyn_msdyn_evaluation_msdyn_ocliveworkitem_msdyn_RegardingObjectId)
...
Many-To-One Relationship: [msdyn_productmap msdyn_msdyn_ocliveworkitem_msdyn_productmap_msdyn_recordid](msdyn_productmap.md#BKMK_msdyn_msdyn_ocliveworkitem_msdyn_productmap_msdyn_recordid)
...
Many-To-One Relationship: [msdyn_ocliveworkitemcontextitemelastic msdyn_ocliveworkitemcontextitemelastic_msdyn_ocliveworkitemid_msdyn_ocliveworkitem](msdyn_ocliveworkitemcontextitemelastic.md#BKMK_msdyn_ocliveworkitemcontextitemelastic_msdyn_ocliveworkitemid_msdyn_ocliveworkitem)
...
Many-To-One Relationship: [msdyn_ocliveworkitemmatchingcriteria msdyn_ocliveworkitemmatchingcriteria_ocliveworkitemid_msdyn_ocliveworkitem](msdyn_ocliveworkitemmatchingcriteria.md#BKMK_msdyn_ocliveworkitemmatchingcriteria_ocliveworkitemid_msdyn_ocliveworkitem)
...
Many-To-One Relationship: [msdyn_sessionextension msdyn_sessionextension_ocliveworkitemid_msdyn_ocliveworkitem](msdyn_sessionextension.md#BKMK_msdyn_sessionextension_ocliveworkitemid_msdyn_ocliveworkitem)
