...
- [msdyn_accountresearchsummarytrigger_SyncErrors](#BKMK_msdyn_accountresearchsummarytrigger_SyncErrors)
...
- [msdyn_agentassistbotconfig_SyncErrors](#BKMK_msdyn_agentassistbotconfig_SyncErrors)
...
- [msdyn_aiconnectormapping_SyncErrors](#BKMK_msdyn_aiconnectormapping_SyncErrors)
...
- [msdyn_aidescriptionvalue_SyncErrors](#BKMK_msdyn_aidescriptionvalue_SyncErrors)
...
- [msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors](#BKMK_msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors)
...
- [msdyn_cceventingscenario_SyncErrors](#BKMK_msdyn_cceventingscenario_SyncErrors)
- [msdyn_ccplaybookpolicy_SyncErrors](#BKMK_msdyn_ccplaybookpolicy_SyncErrors)
- [msdyn_ccrtakpidefinition_SyncErrors](#BKMK_msdyn_ccrtakpidefinition_SyncErrors)
- [msdyn_ccrtalivebanner_SyncErrors](#BKMK_msdyn_ccrtalivebanner_SyncErrors)
- [msdyn_ccrtapreference_SyncErrors](#BKMK_msdyn_ccrtapreference_SyncErrors)
- [msdyn_ccrtareport_SyncErrors](#BKMK_msdyn_ccrtareport_SyncErrors)
...
- [msdyn_channelprofilenotificationtemplate_SyncErrors](#BKMK_msdyn_channelprofilenotificationtemplate_SyncErrors)
- [msdyn_channelprofilesurveyconfig_SyncErrors](#BKMK_msdyn_channelprofilesurveyconfig_SyncErrors)
...
- [msdyn_contactcenterworkstreamskill_SyncErrors](#BKMK_msdyn_contactcenterworkstreamskill_SyncErrors)
...
- [msdyn_conversationprofile_SyncErrors](#BKMK_msdyn_conversationprofile_SyncErrors)
...
- [msdyn_copilotscenariosetting_SyncErrors](#BKMK_msdyn_copilotscenariosetting_SyncErrors)
- [msdyn_copilotskill_SyncErrors](#BKMK_msdyn_copilotskill_SyncErrors)
- [msdyn_copilotskillmapping_SyncErrors](#BKMK_msdyn_copilotskillmapping_SyncErrors)
...
- [msdyn_copilottool_SyncErrors](#BKMK_msdyn_copilottool_SyncErrors)
...
- [msdyn_dataanalyticsreport_ocmodern_SyncErrors](#BKMK_msdyn_dataanalyticsreport_ocmodern_SyncErrors)
- [msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors](#BKMK_msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors)
...
- [msdyn_dataclassification_SyncErrors](#BKMK_msdyn_dataclassification_SyncErrors)
...
- [msdyn_dataqualitylog_SyncErrors](#BKMK_msdyn_dataqualitylog_SyncErrors)
- [msdyn_dataqualityreassignment_SyncErrors](#BKMK_msdyn_dataqualityreassignment_SyncErrors)
- [msdyn_dataqualitysource_SyncErrors](#BKMK_msdyn_dataqualitysource_SyncErrors)
...
- [msdyn_dqarankertrigger_SyncErrors](#BKMK_msdyn_dqarankertrigger_SyncErrors)
...
- [msdyn_evaluationentityconfig_SyncErrors](#BKMK_msdyn_evaluationentityconfig_SyncErrors)
...
- [msdyn_evaluationtriggerconfig_SyncErrors](#BKMK_msdyn_evaluationtriggerconfig_SyncErrors)
...
- [msdyn_governanceagent_status_SyncErrors](#BKMK_msdyn_governanceagent_status_SyncErrors)
- [msdyn_guardrail_consumer_mapping_SyncErrors](#BKMK_msdyn_guardrail_consumer_mapping_SyncErrors)
...
- [msdyn_guardrail_scenariotype_SyncErrors](#BKMK_msdyn_guardrail_scenariotype_SyncErrors)
- [msdyn_guardrail_SyncErrors](#BKMK_msdyn_guardrail_SyncErrors)
- [msdyn_guardrailversion_SyncErrors](#BKMK_msdyn_guardrailversion_SyncErrors)
- [msdyn_hierarchyconfiguration_SyncErrors](#BKMK_msdyn_hierarchyconfiguration_SyncErrors)
- [msdyn_historicalqea_SyncErrors](#BKMK_msdyn_historicalqea_SyncErrors)
...
- [msdyn_indicatorquestion_SyncErrors](#BKMK_msdyn_indicatorquestion_SyncErrors)
...
- [msdyn_monitor_SyncErrors](#BKMK_msdyn_monitor_SyncErrors)
- [msdyn_monitoraction_SyncErrors](#BKMK_msdyn_monitoraction_SyncErrors)
- [msdyn_monitornotificationconfig_SyncErrors](#BKMK_msdyn_monitornotificationconfig_SyncErrors)
...
- [msdyn_nextbestactionsconfig_SyncErrors](#BKMK_msdyn_nextbestactionsconfig_SyncErrors)
...
- [msdyn_profilepicker_SyncErrors](#BKMK_msdyn_profilepicker_SyncErrors)
- [msdyn_promptmessagelocale_SyncErrors](#BKMK_msdyn_promptmessagelocale_SyncErrors)
- [msdyn_promptmessagetemplate_SyncErrors](#BKMK_msdyn_promptmessagetemplate_SyncErrors)
...
- [msdyn_qinotificationconfig_SyncErrors](#BKMK_msdyn_qinotificationconfig_SyncErrors)
...
- [msdyn_salescompanyresolverleadtrigger_SyncErrors](#BKMK_msdyn_salescompanyresolverleadtrigger_SyncErrors)
...
- [msdyn_screenrecordinglink_SyncErrors](#BKMK_msdyn_screenrecordinglink_SyncErrors)
...
- [msdyn_sessionparticipantextension_SyncErrors](#BKMK_msdyn_sessionparticipantextension_SyncErrors)
...
- [msdyn_simulatedconversation_SyncErrors](#BKMK_msdyn_simulatedconversation_SyncErrors)
...
- [msdyn_soa_similaropportunities_SyncErrors](#BKMK_msdyn_soa_similaropportunities_SyncErrors)
...
- [msdyn_transformationtranscript_SyncErrors](#BKMK_msdyn_transformationtranscript_SyncErrors)
...
- [msdynmkt_consentsystemconfiguration_SyncErrors](#BKMK_msdynmkt_consentsystemconfiguration_SyncErrors)
...
One-To-Many Relationship: [entitystorageprofile entitystorageprofile_SyncErrors](entitystorageprofile.md#BKMK_entitystorageprofile_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_entitystorageprofile`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_accountresearchagenttrigger msdyn_accountresearchagenttrigger_SyncErrors](msdyn_accountresearchagenttrigger.md#BKMK_msdyn_accountresearchagenttrigger_SyncErrors)
...
One-To-Many Relationship: [msdyn_accountresearchresult msdyn_accountresearchresult_SyncErrors](msdyn_accountresearchresult.md#BKMK_msdyn_accountresearchresult_SyncErrors)
...
### <a name="BKMK_msdyn_accountresearchsummarytrigger_SyncErrors"></a> msdyn_accountresearchsummarytrigger_SyncErrors

One-To-Many Relationship: [msdyn_accountresearchsummarytrigger msdyn_accountresearchsummarytrigger_SyncErrors](msdyn_accountresearchsummarytrigger.md#BKMK_msdyn_accountresearchsummarytrigger_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_accountresearchsummarytrigger`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_action_SyncErrors"></a> msdyn_action_SyncErrors

One-To-Many Relationship: [msdyn_action msdyn_action_SyncErrors](msdyn_action.md#BKMK_msdyn_action_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_action`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_activitymapping msdyn_activitymapping_SyncErrors](msdyn_activitymapping.md#BKMK_msdyn_activitymapping_SyncErrors)
...
### <a name="BKMK_msdyn_agentassistbotconfig_SyncErrors"></a> msdyn_agentassistbotconfig_SyncErrors

One-To-Many Relationship: [msdyn_agentassistbotconfig msdyn_agentassistbotconfig_SyncErrors](msdyn_agentassistbotconfig.md#BKMK_msdyn_agentassistbotconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentassistbotconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_agentassistconfiguration_SyncErrors"></a> msdyn_agentassistconfiguration_SyncErrors

One-To-Many Relationship: [msdyn_agentassistconfiguration msdyn_agentassistconfiguration_SyncErrors](msdyn_agentassistconfiguration.md#BKMK_msdyn_agentassistconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentassistconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_agentcoachadminsettings msdyn_agentcoachadminsettings_SyncErrors](msdyn_agentcoachadminsettings.md#BKMK_msdyn_agentcoachadminsettings_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentcoachadminsettings`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_agentcoachplaybook_SyncErrors"></a> msdyn_agentcoachplaybook_SyncErrors

One-To-Many Relationship: [msdyn_agentcoachplaybook msdyn_agentcoachplaybook_SyncErrors](msdyn_agentcoachplaybook.md#BKMK_msdyn_agentcoachplaybook_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentcoachplaybook`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_agentcoachplaybookinstructions_SyncErrors"></a> msdyn_agentcoachplaybookinstructions_SyncErrors

One-To-Many Relationship: [msdyn_agentcoachplaybookinstructions msdyn_agentcoachplaybookinstructions_SyncErrors](msdyn_agentcoachplaybookinstructions.md#BKMK_msdyn_agentcoachplaybookinstructions_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentcoachplaybookinstructions`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_agentcoachpolicysettings_SyncErrors"></a> msdyn_agentcoachpolicysettings_SyncErrors

One-To-Many Relationship: [msdyn_agentcoachpolicysettings msdyn_agentcoachpolicysettings_SyncErrors](msdyn_agentcoachpolicysettings.md#BKMK_msdyn_agentcoachpolicysettings_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentcoachpolicysettings`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_agentconfiguration_SyncErrors"></a> msdyn_agentconfiguration_SyncErrors

One-To-Many Relationship: [msdyn_agentconfiguration msdyn_agentconfiguration_SyncErrors](msdyn_agentconfiguration.md#BKMK_msdyn_agentconfiguration_SyncErrors)
...
One-To-Many Relationship: [msdyn_agentcopilotterm msdyn_agentcopilotterm_SyncErrors](msdyn_agentcopilotterm.md#BKMK_msdyn_agentcopilotterm_SyncErrors)
...
One-To-Many Relationship: [msdyn_agentgroupmatchingcriteria msdyn_agentgroupmatchingcriteria_SyncErrors](msdyn_agentgroupmatchingcriteria.md#BKMK_msdyn_agentgroupmatchingcriteria_SyncErrors)
...
### <a name="BKMK_msdyn_agentmatchingcriteria_SyncErrors"></a> msdyn_agentmatchingcriteria_SyncErrors

One-To-Many Relationship: [msdyn_agentmatchingcriteria msdyn_agentmatchingcriteria_SyncErrors](msdyn_agentmatchingcriteria.md#BKMK_msdyn_agentmatchingcriteria_SyncErrors)
...
One-To-Many Relationship: [msdyn_agentnudgetemplate msdyn_agentnudgetemplate_SyncErrors](msdyn_agentnudgetemplate.md#BKMK_msdyn_agentnudgetemplate_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentnudgetemplate`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_agentsetting_SyncErrors"></a> msdyn_agentsetting_SyncErrors

One-To-Many Relationship: [msdyn_agentsetting msdyn_agentsetting_SyncErrors](msdyn_agentsetting.md#BKMK_msdyn_agentsetting_SyncErrors)
...
One-To-Many Relationship: [msdyn_agentsourceinfo msdyn_agentsourceinfo_SyncErrors](msdyn_agentsourceinfo.md#BKMK_msdyn_agentsourceinfo_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_agentsourceinfo`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_aiagentstatus msdyn_aiagentstatus_SyncErrors](msdyn_aiagentstatus.md#BKMK_msdyn_aiagentstatus_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aiagentstatus`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aiconnectormapping_SyncErrors"></a> msdyn_aiconnectormapping_SyncErrors

One-To-Many Relationship: [msdyn_aiconnectormapping msdyn_aiconnectormapping_SyncErrors](msdyn_aiconnectormapping.md#BKMK_msdyn_aiconnectormapping_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aiconnectormapping`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_aidescoptimizationrun msdyn_aidescoptimizationrun_SyncErrors](msdyn_aidescoptimizationrun.md#BKMK_msdyn_aidescoptimizationrun_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescoptimizationrun`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aidescriptioncandidate_SyncErrors"></a> msdyn_aidescriptioncandidate_SyncErrors

One-To-Many Relationship: [msdyn_aidescriptioncandidate msdyn_aidescriptioncandidate_SyncErrors](msdyn_aidescriptioncandidate.md#BKMK_msdyn_aidescriptioncandidate_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescriptioncandidate`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aidescriptionpublishjob_SyncErrors"></a> msdyn_aidescriptionpublishjob_SyncErrors

One-To-Many Relationship: [msdyn_aidescriptionpublishjob msdyn_aidescriptionpublishjob_SyncErrors](msdyn_aidescriptionpublishjob.md#BKMK_msdyn_aidescriptionpublishjob_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescriptionpublishjob`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aidescriptionrun_SyncErrors"></a> msdyn_aidescriptionrun_SyncErrors

One-To-Many Relationship: [msdyn_aidescriptionrun msdyn_aidescriptionrun_SyncErrors](msdyn_aidescriptionrun.md#BKMK_msdyn_aidescriptionrun_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescriptionrun`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aidescriptionsettings_SyncErrors"></a> msdyn_aidescriptionsettings_SyncErrors

One-To-Many Relationship: [msdyn_aidescriptionsettings msdyn_aidescriptionsettings_SyncErrors](msdyn_aidescriptionsettings.md#BKMK_msdyn_aidescriptionsettings_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescriptionsettings`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aidescriptionvalue_SyncErrors"></a> msdyn_aidescriptionvalue_SyncErrors

One-To-Many Relationship: [msdyn_aidescriptionvalue msdyn_aidescriptionvalue_SyncErrors](msdyn_aidescriptionvalue.md#BKMK_msdyn_aidescriptionvalue_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aidescriptionvalue`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_aisimulationrun_SyncErrors"></a> msdyn_aisimulationrun_SyncErrors

One-To-Many Relationship: [msdyn_aisimulationrun msdyn_aisimulationrun_SyncErrors](msdyn_aisimulationrun.md#BKMK_msdyn_aisimulationrun_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_aisimulationrun`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_alwaysrunsqasegment_SyncErrors"></a> msdyn_alwaysrunsqasegment_SyncErrors

One-To-Many Relationship: [msdyn_alwaysrunsqasegment msdyn_alwaysrunsqasegment_SyncErrors](msdyn_alwaysrunsqasegment.md#BKMK_msdyn_alwaysrunsqasegment_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_alwaysrunsqasegment`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_autocaseclosureagentactivity msdyn_autocaseclosureagentactivity_SyncErrors](msdyn_autocaseclosureagentactivity.md#BKMK_msdyn_autocaseclosureagentactivity_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_autocaseclosureagentactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_autocaseclosureagentmonitoring_SyncErrors"></a> msdyn_autocaseclosureagentmonitoring_SyncErrors

One-To-Many Relationship: [msdyn_autocaseclosureagentmonitoring msdyn_autocaseclosureagentmonitoring_SyncErrors](msdyn_autocaseclosureagentmonitoring.md#BKMK_msdyn_autocaseclosureagentmonitoring_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_autocaseclosureagentmonitoring`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_autonomousagentmapping_SyncErrors"></a> msdyn_autonomousagentmapping_SyncErrors

One-To-Many Relationship: [msdyn_autonomousagentmapping msdyn_autonomousagentmapping_SyncErrors](msdyn_autonomousagentmapping.md#BKMK_msdyn_autonomousagentmapping_SyncErrors)
...
One-To-Many Relationship: [msdyn_autonomousprofile msdyn_autonomousprofile_SyncErrors](msdyn_autonomousprofile.md#BKMK_msdyn_autonomousprofile_SyncErrors)
...
One-To-Many Relationship: [msdyn_bot_variable msdyn_bot_variable_SyncErrors](msdyn_bot_variable.md#BKMK_msdyn_bot_variable_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_bot_variable`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_botusermapping msdyn_botusermapping_SyncErrors](msdyn_botusermapping.md#BKMK_msdyn_botusermapping_SyncErrors)
...
### <a name="BKMK_msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors"></a> msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors

One-To-Many Relationship: [msdyn_broadcastmessagebulkactionapiprivilege msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors](msdyn_broadcastmessagebulkactionapiprivilege.md#BKMK_msdyn_broadcastmessagebulkactionapiprivilege_SyncErrors)
...
### <a name="BKMK_msdyn_bulkassigntoqueueapiprivilege_SyncErrors"></a> msdyn_bulkassigntoqueueapiprivilege_SyncErrors

One-To-Many Relationship: [msdyn_bulkassigntoqueueapiprivilege msdyn_bulkassigntoqueueapiprivilege_SyncErrors](msdyn_bulkassigntoqueueapiprivilege.md#BKMK_msdyn_bulkassigntoqueueapiprivilege_SyncErrors)
...
### <a name="BKMK_msdyn_bulkforcecloseapiprivilege_SyncErrors"></a> msdyn_bulkforcecloseapiprivilege_SyncErrors

One-To-Many Relationship: [msdyn_bulkforcecloseapiprivilege msdyn_bulkforcecloseapiprivilege_SyncErrors](msdyn_bulkforcecloseapiprivilege.md#BKMK_msdyn_bulkforcecloseapiprivilege_SyncErrors)
...
One-To-Many Relationship: [msdyn_businessprofile msdyn_businessprofile_SyncErrors](msdyn_businessprofile.md#BKMK_msdyn_businessprofile_SyncErrors)
...
One-To-Many Relationship: [msdyn_capacitywrapuptime msdyn_capacitywrapuptime_SyncErrors](msdyn_capacitywrapuptime.md#BKMK_msdyn_capacitywrapuptime_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_capacitywrapuptime`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_casesentimentsetting msdyn_casesentimentsetting_SyncErrors](msdyn_casesentimentsetting.md#BKMK_msdyn_casesentimentsetting_SyncErrors)
...
### <a name="BKMK_msdyn_cceventingscenario_SyncErrors"></a> msdyn_cceventingscenario_SyncErrors

One-To-Many Relationship: [msdyn_cceventingscenario msdyn_cceventingscenario_SyncErrors](msdyn_cceventingscenario.md#BKMK_msdyn_cceventingscenario_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_cceventingscenario`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccplaybookpolicy_SyncErrors"></a> msdyn_ccplaybookpolicy_SyncErrors

One-To-Many Relationship: [msdyn_ccplaybookpolicy msdyn_ccplaybookpolicy_SyncErrors](msdyn_ccplaybookpolicy.md#BKMK_msdyn_ccplaybookpolicy_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccplaybookpolicy`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtakpidefinition_SyncErrors"></a> msdyn_ccrtakpidefinition_SyncErrors

One-To-Many Relationship: [msdyn_ccrtakpidefinition msdyn_ccrtakpidefinition_SyncErrors](msdyn_ccrtakpidefinition.md#BKMK_msdyn_ccrtakpidefinition_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtakpidefinition`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtalivebanner_SyncErrors"></a> msdyn_ccrtalivebanner_SyncErrors

One-To-Many Relationship: [msdyn_ccrtalivebanner msdyn_ccrtalivebanner_SyncErrors](msdyn_ccrtalivebanner.md#BKMK_msdyn_ccrtalivebanner_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtalivebanner`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtapreference_SyncErrors"></a> msdyn_ccrtapreference_SyncErrors

One-To-Many Relationship: [msdyn_ccrtapreference msdyn_ccrtapreference_SyncErrors](msdyn_ccrtapreference.md#BKMK_msdyn_ccrtapreference_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtapreference`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtareport_SyncErrors"></a> msdyn_ccrtareport_SyncErrors

One-To-Many Relationship: [msdyn_ccrtareport msdyn_ccrtareport_SyncErrors](msdyn_ccrtareport.md#BKMK_msdyn_ccrtareport_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtareport`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtareportpage_SyncErrors"></a> msdyn_ccrtareportpage_SyncErrors

One-To-Many Relationship: [msdyn_ccrtareportpage msdyn_ccrtareportpage_SyncErrors](msdyn_ccrtareportpage.md#BKMK_msdyn_ccrtareportpage_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtareportpage`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccrtathreshold_SyncErrors"></a> msdyn_ccrtathreshold_SyncErrors

One-To-Many Relationship: [msdyn_ccrtathreshold msdyn_ccrtathreshold_SyncErrors](msdyn_ccrtathreshold.md#BKMK_msdyn_ccrtathreshold_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccrtathreshold`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_ccuserprompt_SyncErrors"></a> msdyn_ccuserprompt_SyncErrors

One-To-Many Relationship: [msdyn_ccuserprompt msdyn_ccuserprompt_SyncErrors](msdyn_ccuserprompt.md#BKMK_msdyn_ccuserprompt_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ccuserprompt`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_channelinstancecontextvariable msdyn_channelinstancecontextvariable_SyncErrors](msdyn_channelinstancecontextvariable.md#BKMK_msdyn_channelinstancecontextvariable_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_channelinstancecontextvariable`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_channelprofile msdyn_channelprofile_SyncErrors](msdyn_channelprofile.md#BKMK_msdyn_channelprofile_SyncErrors)
...
### <a name="BKMK_msdyn_channelprofilenotificationtemplate_SyncErrors"></a> msdyn_channelprofilenotificationtemplate_SyncErrors

One-To-Many Relationship: [msdyn_channelprofilenotificationtemplate msdyn_channelprofilenotificationtemplate_SyncErrors](msdyn_channelprofilenotificationtemplate.md#BKMK_msdyn_channelprofilenotificationtemplate_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_channelprofilenotificationtemplate`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_channelprofilesurveyconfig_SyncErrors"></a> msdyn_channelprofilesurveyconfig_SyncErrors

One-To-Many Relationship: [msdyn_channelprofilesurveyconfig msdyn_channelprofilesurveyconfig_SyncErrors](msdyn_channelprofilesurveyconfig.md#BKMK_msdyn_channelprofilesurveyconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_channelprofilesurveyconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_chtprofileconfiguration msdyn_chtprofileconfiguration_SyncErrors](msdyn_chtprofileconfiguration.md#BKMK_msdyn_chtprofileconfiguration_SyncErrors)
...
One-To-Many Relationship: [msdyn_commonchannelconfig msdyn_commonchannelconfig_SyncErrors](msdyn_commonchannelconfig.md#BKMK_msdyn_commonchannelconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_commonchannelconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_competitorresearchagenttrigger_SyncErrors"></a> msdyn_competitorresearchagenttrigger_SyncErrors

One-To-Many Relationship: [msdyn_competitorresearchagenttrigger msdyn_competitorresearchagenttrigger_SyncErrors](msdyn_competitorresearchagenttrigger.md#BKMK_msdyn_competitorresearchagenttrigger_SyncErrors)
...
One-To-Many Relationship: [msdyn_competitorwebresearchagenttrigger msdyn_competitorwebresearchagenttrigger_SyncErrors](msdyn_competitorwebresearchagenttrigger.md#BKMK_msdyn_competitorwebresearchagenttrigger_SyncErrors)
...
One-To-Many Relationship: [msdyn_compliancerule msdyn_compliancerule_SyncErrors](msdyn_compliancerule.md#BKMK_msdyn_compliancerule_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_compliancerule`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_contactcenteragentskill msdyn_contactcenteragentskill_SyncErrors](msdyn_contactcenteragentskill.md#BKMK_msdyn_contactcenteragentskill_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_contactcenteragentskill`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_contactcenteragentskillsetting_SyncErrors"></a> msdyn_contactcenteragentskillsetting_SyncErrors

One-To-Many Relationship: [msdyn_contactcenteragentskillsetting msdyn_contactcenteragentskillsetting_SyncErrors](msdyn_contactcenteragentskillsetting.md#BKMK_msdyn_contactcenteragentskillsetting_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_contactcenteragentskillsetting`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_contactcenterworkstreamskill_SyncErrors"></a> msdyn_contactcenterworkstreamskill_SyncErrors

One-To-Many Relationship: [msdyn_contactcenterworkstreamskill msdyn_contactcenterworkstreamskill_SyncErrors](msdyn_contactcenterworkstreamskill.md#BKMK_msdyn_contactcenterworkstreamskill_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_contactcenterworkstreamskill`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_contactprofilerdetail msdyn_contactprofilerdetail_SyncErrors](msdyn_contactprofilerdetail.md#BKMK_msdyn_contactprofilerdetail_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_contactprofilerdetail`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_contactprofilerresult_SyncErrors"></a> msdyn_contactprofilerresult_SyncErrors

One-To-Many Relationship: [msdyn_contactprofilerresult msdyn_contactprofilerresult_SyncErrors](msdyn_contactprofilerresult.md#BKMK_msdyn_contactprofilerresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_contactprofilerresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_conversationdispositioncodemap_SyncErrors"></a> msdyn_conversationdispositioncodemap_SyncErrors

One-To-Many Relationship: [msdyn_conversationdispositioncodemap msdyn_conversationdispositioncodemap_SyncErrors](msdyn_conversationdispositioncodemap.md#BKMK_msdyn_conversationdispositioncodemap_SyncErrors)
...
### <a name="BKMK_msdyn_conversationprofile_SyncErrors"></a> msdyn_conversationprofile_SyncErrors

One-To-Many Relationship: [msdyn_conversationprofile msdyn_conversationprofile_SyncErrors](msdyn_conversationprofile.md#BKMK_msdyn_conversationprofile_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_conversationprofile`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_copilotorganizationworkload msdyn_copilotorganizationworkload_SyncErrors](msdyn_copilotorganizationworkload.md#BKMK_msdyn_copilotorganizationworkload_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotorganizationworkload`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_copilotscenariosetting_SyncErrors"></a> msdyn_copilotscenariosetting_SyncErrors

One-To-Many Relationship: [msdyn_copilotscenariosetting msdyn_copilotscenariosetting_SyncErrors](msdyn_copilotscenariosetting.md#BKMK_msdyn_copilotscenariosetting_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotscenariosetting`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_copilotskill_SyncErrors"></a> msdyn_copilotskill_SyncErrors

One-To-Many Relationship: [msdyn_copilotskill msdyn_copilotskill_SyncErrors](msdyn_copilotskill.md#BKMK_msdyn_copilotskill_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotskill`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_copilotskillmapping_SyncErrors"></a> msdyn_copilotskillmapping_SyncErrors

One-To-Many Relationship: [msdyn_copilotskillmapping msdyn_copilotskillmapping_SyncErrors](msdyn_copilotskillmapping.md#BKMK_msdyn_copilotskillmapping_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotskillmapping`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_copilotskillrole_SyncErrors"></a> msdyn_copilotskillrole_SyncErrors

One-To-Many Relationship: [msdyn_copilotskillrole msdyn_copilotskillrole_SyncErrors](msdyn_copilotskillrole.md#BKMK_msdyn_copilotskillrole_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotskillrole`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_copilotstarterprompt_SyncErrors"></a> msdyn_copilotstarterprompt_SyncErrors

One-To-Many Relationship: [msdyn_copilotstarterprompt msdyn_copilotstarterprompt_SyncErrors](msdyn_copilotstarterprompt.md#BKMK_msdyn_copilotstarterprompt_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotstarterprompt`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_copilottool_SyncErrors"></a> msdyn_copilottool_SyncErrors

One-To-Many Relationship: [msdyn_copilottool msdyn_copilottool_SyncErrors](msdyn_copilottool.md#BKMK_msdyn_copilottool_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilottool`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_copilotuserworkload msdyn_copilotuserworkload_SyncErrors](msdyn_copilotuserworkload.md#BKMK_msdyn_copilotuserworkload_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_copilotuserworkload`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_crmactivitymapping_SyncErrors"></a> msdyn_crmactivitymapping_SyncErrors

One-To-Many Relationship: [msdyn_crmactivitymapping msdyn_crmactivitymapping_SyncErrors](msdyn_crmactivitymapping.md#BKMK_msdyn_crmactivitymapping_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_crmactivitymapping`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_customaccountinsightsresult msdyn_customaccountinsightsresult_SyncErrors](msdyn_customaccountinsightsresult.md#BKMK_msdyn_customaccountinsightsresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_customaccountinsightsresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_customizationagenttrigger msdyn_customizationagenttrigger_SyncErrors](msdyn_customizationagenttrigger.md#BKMK_msdyn_customizationagenttrigger_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_customizationagenttrigger`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_customoobresearchresult_SyncErrors"></a> msdyn_customoobresearchresult_SyncErrors

One-To-Many Relationship: [msdyn_customoobresearchresult msdyn_customoobresearchresult_SyncErrors](msdyn_customoobresearchresult.md#BKMK_msdyn_customoobresearchresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_customoobresearchresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_dataanalyticsreport_caseprocessingagent msdyn_dataanalyticsreport_caseprocessingagent_SyncErrors](msdyn_dataanalyticsreport_caseprocessingagent.md#BKMK_msdyn_dataanalyticsreport_caseprocessingagent_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataanalyticsreport_caseprocessingagent`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_dataanalyticsreport_ocmodern_SyncErrors"></a> msdyn_dataanalyticsreport_ocmodern_SyncErrors

One-To-Many Relationship: [msdyn_dataanalyticsreport_ocmodern msdyn_dataanalyticsreport_ocmodern_SyncErrors](msdyn_dataanalyticsreport_ocmodern.md#BKMK_msdyn_dataanalyticsreport_ocmodern_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataanalyticsreport_ocmodern`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors"></a> msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors

One-To-Many Relationship: [msdyn_dataanalyticsreport_qualityevaluationagent msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors](msdyn_dataanalyticsreport_qualityevaluationagent.md#BKMK_msdyn_dataanalyticsreport_qualityevaluationagent_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataanalyticsreport_qualityevaluationagent`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_dataclassification_SyncErrors"></a> msdyn_dataclassification_SyncErrors

One-To-Many Relationship: [msdyn_dataclassification msdyn_dataclassification_SyncErrors](msdyn_dataclassification.md#BKMK_msdyn_dataclassification_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataclassification`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_dataqualitylog_SyncErrors"></a> msdyn_dataqualitylog_SyncErrors

One-To-Many Relationship: [msdyn_dataqualitylog msdyn_dataqualitylog_SyncErrors](msdyn_dataqualitylog.md#BKMK_msdyn_dataqualitylog_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataqualitylog`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_dataqualityreassignment_SyncErrors"></a> msdyn_dataqualityreassignment_SyncErrors

One-To-Many Relationship: [msdyn_dataqualityreassignment msdyn_dataqualityreassignment_SyncErrors](msdyn_dataqualityreassignment.md#BKMK_msdyn_dataqualityreassignment_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataqualityreassignment`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_dataqualitysource_SyncErrors"></a> msdyn_dataqualitysource_SyncErrors

One-To-Many Relationship: [msdyn_dataqualitysource msdyn_dataqualitysource_SyncErrors](msdyn_dataqualitysource.md#BKMK_msdyn_dataqualitysource_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataqualitysource`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_dataqualitysuggestion_SyncErrors"></a> msdyn_dataqualitysuggestion_SyncErrors

One-To-Many Relationship: [msdyn_dataqualitysuggestion msdyn_dataqualitysuggestion_SyncErrors](msdyn_dataqualitysuggestion.md#BKMK_msdyn_dataqualitysuggestion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dataqualitysuggestion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_dcaengageagentresult_SyncErrors"></a> msdyn_dcaengageagentresult_SyncErrors

One-To-Many Relationship: [msdyn_dcaengageagentresult msdyn_dcaengageagentresult_SyncErrors](msdyn_dcaengageagentresult.md#BKMK_msdyn_dcaengageagentresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dcaengageagentresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_dispositioncodecategory msdyn_dispositioncodecategory_SyncErrors](msdyn_dispositioncodecategory.md#BKMK_msdyn_dispositioncodecategory_SyncErrors)
...
### <a name="BKMK_msdyn_dqarankertrigger_SyncErrors"></a> msdyn_dqarankertrigger_SyncErrors

One-To-Many Relationship: [msdyn_dqarankertrigger msdyn_dqarankertrigger_SyncErrors](msdyn_dqarankertrigger.md#BKMK_msdyn_dqarankertrigger_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_dqarankertrigger`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_emailclassificationcategory msdyn_emailclassificationcategory_SyncErrors](msdyn_emailclassificationcategory.md#BKMK_msdyn_emailclassificationcategory_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_emailclassificationcategory`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_emailclassificationcategoryscoperule msdyn_emailclassificationcategoryscoperule_SyncErrors](msdyn_emailclassificationcategoryscoperule.md#BKMK_msdyn_emailclassificationcategoryscoperule_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_emailclassificationcategoryscoperule`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_emailclassificationcategoryversion_SyncErrors"></a> msdyn_emailclassificationcategoryversion_SyncErrors

One-To-Many Relationship: [msdyn_emailclassificationcategoryversion msdyn_emailclassificationcategoryversion_SyncErrors](msdyn_emailclassificationcategoryversion.md#BKMK_msdyn_emailclassificationcategoryversion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_emailclassificationcategoryversion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_emailtemplatelanguagegroup msdyn_emailtemplatelanguagegroup_SyncErrors](msdyn_emailtemplatelanguagegroup.md#BKMK_msdyn_emailtemplatelanguagegroup_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_emailtemplatelanguagegroup`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_emailtemplatelanguagegroupitem_SyncErrors"></a> msdyn_emailtemplatelanguagegroupitem_SyncErrors

One-To-Many Relationship: [msdyn_emailtemplatelanguagegroupitem msdyn_emailtemplatelanguagegroupitem_SyncErrors](msdyn_emailtemplatelanguagegroupitem.md#BKMK_msdyn_emailtemplatelanguagegroupitem_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_emailtemplatelanguagegroupitem`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_emailthread_SyncErrors"></a> msdyn_emailthread_SyncErrors

One-To-Many Relationship: [msdyn_emailthread msdyn_emailthread_SyncErrors](msdyn_emailthread.md#BKMK_msdyn_emailthread_SyncErrors)
...
One-To-Many Relationship: [msdyn_engageandreadinessagentresult msdyn_engageandreadinessagentresult_SyncErrors](msdyn_engageandreadinessagentresult.md#BKMK_msdyn_engageandreadinessagentresult_SyncErrors)
...
One-To-Many Relationship: [msdyn_engagereadinessagentresult msdyn_engagereadinessagentresult_SyncErrors](msdyn_engagereadinessagentresult.md#BKMK_msdyn_engagereadinessagentresult_SyncErrors)
...
One-To-Many Relationship: [msdyn_entitycopilotconfiguration msdyn_entitycopilotconfiguration_SyncErrors](msdyn_entitycopilotconfiguration.md#BKMK_msdyn_entitycopilotconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_entitycopilotconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_evaluation msdyn_evaluation_SyncErrors](msdyn_evaluation.md#BKMK_msdyn_evaluation_SyncErrors)
...
### <a name="BKMK_msdyn_evaluationcategory_SyncErrors"></a> msdyn_evaluationcategory_SyncErrors

One-To-Many Relationship: [msdyn_evaluationcategory msdyn_evaluationcategory_SyncErrors](msdyn_evaluationcategory.md#BKMK_msdyn_evaluationcategory_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationcriteria msdyn_evaluationcriteria_SyncErrors](msdyn_evaluationcriteria.md#BKMK_msdyn_evaluationcriteria_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationcriteriaversion msdyn_evaluationcriteriaversion_SyncErrors](msdyn_evaluationcriteriaversion.md#BKMK_msdyn_evaluationcriteriaversion_SyncErrors)
...
### <a name="BKMK_msdyn_evaluationentityconfig_SyncErrors"></a> msdyn_evaluationentityconfig_SyncErrors

One-To-Many Relationship: [msdyn_evaluationentityconfig msdyn_evaluationentityconfig_SyncErrors](msdyn_evaluationentityconfig.md#BKMK_msdyn_evaluationentityconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_evaluationentityconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_evaluationglobalconfig_SyncErrors"></a> msdyn_evaluationglobalconfig_SyncErrors

One-To-Many Relationship: [msdyn_evaluationglobalconfig msdyn_evaluationglobalconfig_SyncErrors](msdyn_evaluationglobalconfig.md#BKMK_msdyn_evaluationglobalconfig_SyncErrors)
...
### <a name="BKMK_msdyn_evaluationinputconfig_SyncErrors"></a> msdyn_evaluationinputconfig_SyncErrors

One-To-Many Relationship: [msdyn_evaluationinputconfig msdyn_evaluationinputconfig_SyncErrors](msdyn_evaluationinputconfig.md#BKMK_msdyn_evaluationinputconfig_SyncErrors)
...
### <a name="BKMK_msdyn_evaluationlocalizedcontent_SyncErrors"></a> msdyn_evaluationlocalizedcontent_SyncErrors

One-To-Many Relationship: [msdyn_evaluationlocalizedcontent msdyn_evaluationlocalizedcontent_SyncErrors](msdyn_evaluationlocalizedcontent.md#BKMK_msdyn_evaluationlocalizedcontent_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationnotificationconfiguration msdyn_evaluationnotificationconfiguration_SyncErrors](msdyn_evaluationnotificationconfiguration.md#BKMK_msdyn_evaluationnotificationconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_evaluationnotificationconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_evaluationplan_SyncErrors"></a> msdyn_evaluationplan_SyncErrors

One-To-Many Relationship: [msdyn_evaluationplan msdyn_evaluationplan_SyncErrors](msdyn_evaluationplan.md#BKMK_msdyn_evaluationplan_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationplanbatch msdyn_evaluationplanbatch_SyncErrors](msdyn_evaluationplanbatch.md#BKMK_msdyn_evaluationplanbatch_SyncErrors)
...
### <a name="BKMK_msdyn_evaluationplanontriggerbacklog_SyncErrors"></a> msdyn_evaluationplanontriggerbacklog_SyncErrors

One-To-Many Relationship: [msdyn_evaluationplanontriggerbacklog msdyn_evaluationplanontriggerbacklog_SyncErrors](msdyn_evaluationplanontriggerbacklog.md#BKMK_msdyn_evaluationplanontriggerbacklog_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationplanrun msdyn_evaluationplanrun_SyncErrors](msdyn_evaluationplanrun.md#BKMK_msdyn_evaluationplanrun_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationquestion msdyn_evaluationquestion_SyncErrors](msdyn_evaluationquestion.md#BKMK_msdyn_evaluationquestion_SyncErrors)
...
One-To-Many Relationship: [msdyn_evaluationrunconfig msdyn_evaluationrunconfig_SyncErrors](msdyn_evaluationrunconfig.md#BKMK_msdyn_evaluationrunconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_evaluationrunconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_evaluationsimulationrun_SyncErrors"></a> msdyn_evaluationsimulationrun_SyncErrors

One-To-Many Relationship: [msdyn_evaluationsimulationrun msdyn_evaluationsimulationrun_SyncErrors](msdyn_evaluationsimulationrun.md#BKMK_msdyn_evaluationsimulationrun_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_evaluationsimulationrun`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_evaluationtriggerconfig_SyncErrors"></a> msdyn_evaluationtriggerconfig_SyncErrors

One-To-Many Relationship: [msdyn_evaluationtriggerconfig msdyn_evaluationtriggerconfig_SyncErrors](msdyn_evaluationtriggerconfig.md#BKMK_msdyn_evaluationtriggerconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_evaluationtriggerconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_globalrulesetconfiguration msdyn_globalrulesetconfiguration_SyncErrors](msdyn_globalrulesetconfiguration.md#BKMK_msdyn_globalrulesetconfiguration_SyncErrors)
...
### <a name="BKMK_msdyn_governanceagent_status_SyncErrors"></a> msdyn_governanceagent_status_SyncErrors

One-To-Many Relationship: [msdyn_governanceagent_status msdyn_governanceagent_status_SyncErrors](msdyn_governanceagent_status.md#BKMK_msdyn_governanceagent_status_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_governanceagent_status`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_consumer_mapping_SyncErrors"></a> msdyn_guardrail_consumer_mapping_SyncErrors

One-To-Many Relationship: [msdyn_guardrail_consumer_mapping msdyn_guardrail_consumer_mapping_SyncErrors](msdyn_guardrail_consumer_mapping.md#BKMK_msdyn_guardrail_consumer_mapping_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail_consumer_mapping`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_execution_info_SyncErrors"></a> msdyn_guardrail_execution_info_SyncErrors

One-To-Many Relationship: [msdyn_guardrail_execution_info msdyn_guardrail_execution_info_SyncErrors](msdyn_guardrail_execution_info.md#BKMK_msdyn_guardrail_execution_info_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail_execution_info`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_rule_SyncErrors"></a> msdyn_guardrail_rule_SyncErrors

One-To-Many Relationship: [msdyn_guardrail_rule msdyn_guardrail_rule_SyncErrors](msdyn_guardrail_rule.md#BKMK_msdyn_guardrail_rule_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail_rule`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_rule_version_SyncErrors"></a> msdyn_guardrail_rule_version_SyncErrors

One-To-Many Relationship: [msdyn_guardrail_rule_version msdyn_guardrail_rule_version_SyncErrors](msdyn_guardrail_rule_version.md#BKMK_msdyn_guardrail_rule_version_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail_rule_version`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_scenariotype_SyncErrors"></a> msdyn_guardrail_scenariotype_SyncErrors

One-To-Many Relationship: [msdyn_guardrail_scenariotype msdyn_guardrail_scenariotype_SyncErrors](msdyn_guardrail_scenariotype.md#BKMK_msdyn_guardrail_scenariotype_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail_scenariotype`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrail_SyncErrors"></a> msdyn_guardrail_SyncErrors

One-To-Many Relationship: [msdyn_guardrail msdyn_guardrail_SyncErrors](msdyn_guardrail.md#BKMK_msdyn_guardrail_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrail`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_guardrailversion_SyncErrors"></a> msdyn_guardrailversion_SyncErrors

One-To-Many Relationship: [msdyn_guardrailversion msdyn_guardrailversion_SyncErrors](msdyn_guardrailversion.md#BKMK_msdyn_guardrailversion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_guardrailversion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_hierarchyconfiguration_SyncErrors"></a> msdyn_hierarchyconfiguration_SyncErrors

One-To-Many Relationship: [msdyn_hierarchyconfiguration msdyn_hierarchyconfiguration_SyncErrors](msdyn_hierarchyconfiguration.md#BKMK_msdyn_hierarchyconfiguration_SyncErrors)
...
### <a name="BKMK_msdyn_historicalqea_SyncErrors"></a> msdyn_historicalqea_SyncErrors

One-To-Many Relationship: [msdyn_historicalqea msdyn_historicalqea_SyncErrors](msdyn_historicalqea.md#BKMK_msdyn_historicalqea_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_historicalqea`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_historicalqeabacklog_SyncErrors"></a> msdyn_historicalqeabacklog_SyncErrors

One-To-Many Relationship: [msdyn_historicalqeabacklog msdyn_historicalqeabacklog_SyncErrors](msdyn_historicalqeabacklog.md#BKMK_msdyn_historicalqeabacklog_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_historicalqeabacklog`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_inboxpersonalizedconfiguration_SyncErrors"></a> msdyn_inboxpersonalizedconfiguration_SyncErrors

One-To-Many Relationship: [msdyn_inboxpersonalizedconfiguration msdyn_inboxpersonalizedconfiguration_SyncErrors](msdyn_inboxpersonalizedconfiguration.md#BKMK_msdyn_inboxpersonalizedconfiguration_SyncErrors)
...
### <a name="BKMK_msdyn_indicatorquestion_SyncErrors"></a> msdyn_indicatorquestion_SyncErrors

One-To-Many Relationship: [msdyn_indicatorquestion msdyn_indicatorquestion_SyncErrors](msdyn_indicatorquestion.md#BKMK_msdyn_indicatorquestion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_indicatorquestion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_intentcoreevaluationjob msdyn_intentcoreevaluationjob_SyncErrors](msdyn_intentcoreevaluationjob.md#BKMK_msdyn_intentcoreevaluationjob_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_intentcoreevaluationjob`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_intentfamily_adminassignment msdyn_intentfamily_adminassignment_SyncErrors](msdyn_intentfamily_adminassignment.md#BKMK_msdyn_intentfamily_adminassignment_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_intentfamily_adminassignment`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_intentfamily_emailtemplateconfig_SyncErrors"></a> msdyn_intentfamily_emailtemplateconfig_SyncErrors

One-To-Many Relationship: [msdyn_intentfamily_emailtemplateconfig msdyn_intentfamily_emailtemplateconfig_SyncErrors](msdyn_intentfamily_emailtemplateconfig.md#BKMK_msdyn_intentfamily_emailtemplateconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_intentfamily_emailtemplateconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_intentfamilysolutionmap msdyn_intentfamilysolutionmap_SyncErrors](msdyn_intentfamilysolutionmap.md#BKMK_msdyn_intentfamilysolutionmap_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_intentfamilysolutionmap`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_intentmetrics_jobdata_SyncErrors"></a> msdyn_intentmetrics_jobdata_SyncErrors

One-To-Many Relationship: [msdyn_intentmetrics_jobdata msdyn_intentmetrics_jobdata_SyncErrors](msdyn_intentmetrics_jobdata.md#BKMK_msdyn_intentmetrics_jobdata_SyncErrors)
...
One-To-Many Relationship: [msdyn_intentmetrics msdyn_intentmetrics_SyncErrors](msdyn_intentmetrics.md#BKMK_msdyn_intentmetrics_SyncErrors)
...
### <a name="BKMK_msdyn_intentplaybook_SyncErrors"></a> msdyn_intentplaybook_SyncErrors

One-To-Many Relationship: [msdyn_intentplaybook msdyn_intentplaybook_SyncErrors](msdyn_intentplaybook.md#BKMK_msdyn_intentplaybook_SyncErrors)
...
### <a name="BKMK_msdyn_intentplaybookmap_SyncErrors"></a> msdyn_intentplaybookmap_SyncErrors

One-To-Many Relationship: [msdyn_intentplaybookmap msdyn_intentplaybookmap_SyncErrors](msdyn_intentplaybookmap.md#BKMK_msdyn_intentplaybookmap_SyncErrors)
...
One-To-Many Relationship: [msdyn_lastagent msdyn_lastagent_SyncErrors](msdyn_lastagent.md#BKMK_msdyn_lastagent_SyncErrors)
...
One-To-Many Relationship: [msdyn_leadagentresult msdyn_leadagentresult_SyncErrors](msdyn_leadagentresult.md#BKMK_msdyn_leadagentresult_SyncErrors)
...
One-To-Many Relationship: [msdyn_leaddelinkresult msdyn_leaddelinkresult_SyncErrors](msdyn_leaddelinkresult.md#BKMK_msdyn_leaddelinkresult_SyncErrors)
...
### <a name="BKMK_msdyn_leademailextension_SyncErrors"></a> msdyn_leademailextension_SyncErrors

One-To-Many Relationship: [msdyn_leademailextension msdyn_leademailextension_SyncErrors](msdyn_leademailextension.md#BKMK_msdyn_leademailextension_SyncErrors)
...
### <a name="BKMK_msdyn_leadintelligenceinsight_SyncErrors"></a> msdyn_leadintelligenceinsight_SyncErrors

One-To-Many Relationship: [msdyn_leadintelligenceinsight msdyn_leadintelligenceinsight_SyncErrors](msdyn_leadintelligenceinsight.md#BKMK_msdyn_leadintelligenceinsight_SyncErrors)
...
One-To-Many Relationship: [msdyn_leadintelligenceinsightentitylink msdyn_leadintelligenceinsightentitylink_SyncErrors](msdyn_leadintelligenceinsightentitylink.md#BKMK_msdyn_leadintelligenceinsightentitylink_SyncErrors)
...
### <a name="BKMK_msdyn_liveconversationcountercondition_SyncErrors"></a> msdyn_liveconversationcountercondition_SyncErrors

One-To-Many Relationship: [msdyn_liveconversationcountercondition msdyn_liveconversationcountercondition_SyncErrors](msdyn_liveconversationcountercondition.md#BKMK_msdyn_liveconversationcountercondition_SyncErrors)
...
### <a name="BKMK_msdyn_matchingcriteria_SyncErrors"></a> msdyn_matchingcriteria_SyncErrors

One-To-Many Relationship: [msdyn_matchingcriteria msdyn_matchingcriteria_SyncErrors](msdyn_matchingcriteria.md#BKMK_msdyn_matchingcriteria_SyncErrors)
...
### <a name="BKMK_msdyn_monitor_SyncErrors"></a> msdyn_monitor_SyncErrors

One-To-Many Relationship: [msdyn_monitor msdyn_monitor_SyncErrors](msdyn_monitor.md#BKMK_msdyn_monitor_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_monitor`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_monitoraction_SyncErrors"></a> msdyn_monitoraction_SyncErrors

One-To-Many Relationship: [msdyn_monitoraction msdyn_monitoraction_SyncErrors](msdyn_monitoraction.md#BKMK_msdyn_monitoraction_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_monitoraction`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_monitornotificationconfig_SyncErrors"></a> msdyn_monitornotificationconfig_SyncErrors

One-To-Many Relationship: [msdyn_monitornotificationconfig msdyn_monitornotificationconfig_SyncErrors](msdyn_monitornotificationconfig.md#BKMK_msdyn_monitornotificationconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_monitornotificationconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_nextbestactionsconfig_SyncErrors"></a> msdyn_nextbestactionsconfig_SyncErrors

One-To-Many Relationship: [msdyn_nextbestactionsconfig msdyn_nextbestactionsconfig_SyncErrors](msdyn_nextbestactionsconfig.md#BKMK_msdyn_nextbestactionsconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_nextbestactionsconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_notifyagentbulkactionapiprivilege msdyn_notifyagentbulkactionapiprivilege_SyncErrors](msdyn_notifyagentbulkactionapiprivilege.md#BKMK_msdyn_notifyagentbulkactionapiprivilege_SyncErrors)
...
One-To-Many Relationship: [msdyn_ocdispositioncode msdyn_ocdispositioncode_SyncErrors](msdyn_ocdispositioncode.md#BKMK_msdyn_ocdispositioncode_SyncErrors)
...
### <a name="BKMK_msdyn_ocencryptedmessagesetting_SyncErrors"></a> msdyn_ocencryptedmessagesetting_SyncErrors

One-To-Many Relationship: [msdyn_ocencryptedmessagesetting msdyn_ocencryptedmessagesetting_SyncErrors](msdyn_ocencryptedmessagesetting.md#BKMK_msdyn_ocencryptedmessagesetting_SyncErrors)
...
One-To-Many Relationship: [msdyn_ocliveworkitemextension msdyn_ocliveworkitemextension_SyncErrors](msdyn_ocliveworkitemextension.md#BKMK_msdyn_ocliveworkitemextension_SyncErrors)
...
One-To-Many Relationship: [msdyn_ocliveworkitemmatchingcriteria msdyn_ocliveworkitemmatchingcriteria_SyncErrors](msdyn_ocliveworkitemmatchingcriteria.md#BKMK_msdyn_ocliveworkitemmatchingcriteria_SyncErrors)
...
One-To-Many Relationship: [msdyn_ocmessagemaskingrule msdyn_ocmessagemaskingrule_SyncErrors](msdyn_ocmessagemaskingrule.md#BKMK_msdyn_ocmessagemaskingrule_SyncErrors)
...
One-To-Many Relationship: [msdyn_ocmldatamaskingrule msdyn_ocmldatamaskingrule_SyncErrors](msdyn_ocmldatamaskingrule.md#BKMK_msdyn_ocmldatamaskingrule_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ocmldatamaskingrule`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_ocunredactedannotation msdyn_ocunredactedannotation_SyncErrors](msdyn_ocunredactedannotation.md#BKMK_msdyn_ocunredactedannotation_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_ocunredactedannotation`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_oobaccountresearchresult msdyn_oobaccountresearchresult_SyncErrors](msdyn_oobaccountresearchresult.md#BKMK_msdyn_oobaccountresearchresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_oobaccountresearchresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_opportunityaccountresearchresult msdyn_opportunityaccountresearchresult_SyncErrors](msdyn_opportunityaccountresearchresult.md#BKMK_msdyn_opportunityaccountresearchresult_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_opportunityaccountresearchresult`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_opportunitycompetitorresearchresultcache msdyn_opportunitycompetitorresearchresultcache_SyncErrors](msdyn_opportunitycompetitorresearchresultcache.md#BKMK_msdyn_opportunitycompetitorresearchresultcache_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_opportunitycompetitorresearchresultcache`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_opportunityrankermapping msdyn_opportunityrankermapping_SyncErrors](msdyn_opportunityrankermapping.md#BKMK_msdyn_opportunityrankermapping_SyncErrors)
...
One-To-Many Relationship: [msdyn_opportunityresearchagenttrigger msdyn_opportunityresearchagenttrigger_SyncErrors](msdyn_opportunityresearchagenttrigger.md#BKMK_msdyn_opportunityresearchagenttrigger_SyncErrors)
...
### <a name="BKMK_msdyn_opportunityresearchindicator_SyncErrors"></a> msdyn_opportunityresearchindicator_SyncErrors

One-To-Many Relationship: [msdyn_opportunityresearchindicator msdyn_opportunityresearchindicator_SyncErrors](msdyn_opportunityresearchindicator.md#BKMK_msdyn_opportunityresearchindicator_SyncErrors)
...
One-To-Many Relationship: [msdyn_opportunityresearchresult msdyn_opportunityresearchresult_SyncErrors](msdyn_opportunityresearchresult.md#BKMK_msdyn_opportunityresearchresult_SyncErrors)
...
One-To-Many Relationship: [msdyn_opportunityresearchuserinteractions msdyn_opportunityresearchuserinteractions_SyncErrors](msdyn_opportunityresearchuserinteractions.md#BKMK_msdyn_opportunityresearchuserinteractions_SyncErrors)
...
One-To-Many Relationship: [msdyn_organizationprompt msdyn_organizationprompt_SyncErrors](msdyn_organizationprompt.md#BKMK_msdyn_organizationprompt_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_organizationprompt`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_organizationsolutionmap_SyncErrors"></a> msdyn_organizationsolutionmap_SyncErrors

One-To-Many Relationship: [msdyn_organizationsolutionmap msdyn_organizationsolutionmap_SyncErrors](msdyn_organizationsolutionmap.md#BKMK_msdyn_organizationsolutionmap_SyncErrors)
...
### <a name="BKMK_msdyn_outreachagentresult_SyncErrors"></a> msdyn_outreachagentresult_SyncErrors

One-To-Many Relationship: [msdyn_outreachagentresult msdyn_outreachagentresult_SyncErrors](msdyn_outreachagentresult.md#BKMK_msdyn_outreachagentresult_SyncErrors)
...
### <a name="BKMK_msdyn_outreachtriggeragent_SyncErrors"></a> msdyn_outreachtriggeragent_SyncErrors

One-To-Many Relationship: [msdyn_outreachtriggeragent msdyn_outreachtriggeragent_SyncErrors](msdyn_outreachtriggeragent.md#BKMK_msdyn_outreachtriggeragent_SyncErrors)
...
### <a name="BKMK_msdyn_paflowruntracker_SyncErrors"></a> msdyn_paflowruntracker_SyncErrors

One-To-Many Relationship: [msdyn_paflowruntracker msdyn_paflowruntracker_SyncErrors](msdyn_paflowruntracker.md#BKMK_msdyn_paflowruntracker_SyncErrors)
...
One-To-Many Relationship: [msdyn_prioritizedactioncatalogue msdyn_prioritizedactioncatalogue_SyncErrors](msdyn_prioritizedactioncatalogue.md#BKMK_msdyn_prioritizedactioncatalogue_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_prioritizedactioncatalogue`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_productmap_SyncErrors"></a> msdyn_productmap_SyncErrors

One-To-Many Relationship: [msdyn_productmap msdyn_productmap_SyncErrors](msdyn_productmap.md#BKMK_msdyn_productmap_SyncErrors)
...
### <a name="BKMK_msdyn_profilepicker_SyncErrors"></a> msdyn_profilepicker_SyncErrors

One-To-Many Relationship: [msdyn_profilepicker msdyn_profilepicker_SyncErrors](msdyn_profilepicker.md#BKMK_msdyn_profilepicker_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_profilepicker`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_promptmessagelocale_SyncErrors"></a> msdyn_promptmessagelocale_SyncErrors

One-To-Many Relationship: [msdyn_promptmessagelocale msdyn_promptmessagelocale_SyncErrors](msdyn_promptmessagelocale.md#BKMK_msdyn_promptmessagelocale_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_promptmessagelocale`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_promptmessagetemplate_SyncErrors"></a> msdyn_promptmessagetemplate_SyncErrors

One-To-Many Relationship: [msdyn_promptmessagetemplate msdyn_promptmessagetemplate_SyncErrors](msdyn_promptmessagetemplate.md#BKMK_msdyn_promptmessagetemplate_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_promptmessagetemplate`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_qinotificationconfig_SyncErrors"></a> msdyn_qinotificationconfig_SyncErrors

One-To-Many Relationship: [msdyn_qinotificationconfig msdyn_qinotificationconfig_SyncErrors](msdyn_qinotificationconfig.md#BKMK_msdyn_qinotificationconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_qinotificationconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_qinotificationconfigitem_SyncErrors"></a> msdyn_qinotificationconfigitem_SyncErrors

One-To-Many Relationship: [msdyn_qinotificationconfigitem msdyn_qinotificationconfigitem_SyncErrors](msdyn_qinotificationconfigitem.md#BKMK_msdyn_qinotificationconfigitem_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_qinotificationconfigitem`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_qualificationagenttrigger_SyncErrors"></a> msdyn_qualificationagenttrigger_SyncErrors

One-To-Many Relationship: [msdyn_qualificationagenttrigger msdyn_qualificationagenttrigger_SyncErrors](msdyn_qualificationagenttrigger.md#BKMK_msdyn_qualificationagenttrigger_SyncErrors)
...
One-To-Many Relationship: [msdyn_qualityindicator msdyn_qualityindicator_SyncErrors](msdyn_qualityindicator.md#BKMK_msdyn_qualityindicator_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_qualityindicator`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_qualityindicatorversion_SyncErrors"></a> msdyn_qualityindicatorversion_SyncErrors

One-To-Many Relationship: [msdyn_qualityindicatorversion msdyn_qualityindicatorversion_SyncErrors](msdyn_qualityindicatorversion.md#BKMK_msdyn_qualityindicatorversion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_qualityindicatorversion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_queueextension_SyncErrors"></a> msdyn_queueextension_SyncErrors

One-To-Many Relationship: [msdyn_queueextension msdyn_queueextension_SyncErrors](msdyn_queueextension.md#BKMK_msdyn_queueextension_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_queueextension`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_queueusergroupmembership_SyncErrors"></a> msdyn_queueusergroupmembership_SyncErrors

One-To-Many Relationship: [msdyn_queueusergroupmembership msdyn_queueusergroupmembership_SyncErrors](msdyn_queueusergroupmembership.md#BKMK_msdyn_queueusergroupmembership_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_queueusergroupmembership`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_rawactioncatalogue_SyncErrors"></a> msdyn_rawactioncatalogue_SyncErrors

One-To-Many Relationship: [msdyn_rawactioncatalogue msdyn_rawactioncatalogue_SyncErrors](msdyn_rawactioncatalogue.md#BKMK_msdyn_rawactioncatalogue_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_rawactioncatalogue`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_rcswatermark msdyn_rcswatermark_SyncErrors](msdyn_rcswatermark.md#BKMK_msdyn_rcswatermark_SyncErrors)
...
One-To-Many Relationship: [msdyn_recommendedactionderivedinsight msdyn_recommendedactionderivedinsight_SyncErrors](msdyn_recommendedactionderivedinsight.md#BKMK_msdyn_recommendedactionderivedinsight_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_recommendedactionderivedinsight`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_recommendedactionpullwatermark_SyncErrors"></a> msdyn_recommendedactionpullwatermark_SyncErrors

One-To-Many Relationship: [msdyn_recommendedactionpullwatermark msdyn_recommendedactionpullwatermark_SyncErrors](msdyn_recommendedactionpullwatermark.md#BKMK_msdyn_recommendedactionpullwatermark_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_recommendedactionpullwatermark`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_recommendedactionrundetails_SyncErrors"></a> msdyn_recommendedactionrundetails_SyncErrors

One-To-Many Relationship: [msdyn_recommendedactionrundetails msdyn_recommendedactionrundetails_SyncErrors](msdyn_recommendedactionrundetails.md#BKMK_msdyn_recommendedactionrundetails_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_recommendedactionrundetails`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_recommendedactionsourceagentconfig_SyncErrors"></a> msdyn_recommendedactionsourceagentconfig_SyncErrors

One-To-Many Relationship: [msdyn_recommendedactionsourceagentconfig msdyn_recommendedactionsourceagentconfig_SyncErrors](msdyn_recommendedactionsourceagentconfig.md#BKMK_msdyn_recommendedactionsourceagentconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_recommendedactionsourceagentconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_relatedconversationtriggertable msdyn_relatedconversationtriggertable_SyncErrors](msdyn_relatedconversationtriggertable.md#BKMK_msdyn_relatedconversationtriggertable_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_relatedconversationtriggertable`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_rolloutplan_SyncErrors"></a> msdyn_rolloutplan_SyncErrors

One-To-Many Relationship: [msdyn_rolloutplan msdyn_rolloutplan_SyncErrors](msdyn_rolloutplan.md#BKMK_msdyn_rolloutplan_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesagentconfiguration msdyn_salesagentconfiguration_SyncErrors](msdyn_salesagentconfiguration.md#BKMK_msdyn_salesagentconfiguration_SyncErrors)
...
### <a name="BKMK_msdyn_salesagentconfigurationv2_SyncErrors"></a> msdyn_salesagentconfigurationv2_SyncErrors

One-To-Many Relationship: [msdyn_salesagentconfigurationv2 msdyn_salesagentconfigurationv2_SyncErrors](msdyn_salesagentconfigurationv2.md#BKMK_msdyn_salesagentconfigurationv2_SyncErrors)
...
### <a name="BKMK_msdyn_salesagentexecutionconfig_SyncErrors"></a> msdyn_salesagentexecutionconfig_SyncErrors

One-To-Many Relationship: [msdyn_salesagentexecutionconfig msdyn_salesagentexecutionconfig_SyncErrors](msdyn_salesagentexecutionconfig.md#BKMK_msdyn_salesagentexecutionconfig_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesagenthandover msdyn_salesagenthandover_SyncErrors](msdyn_salesagenthandover.md#BKMK_msdyn_salesagenthandover_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesagentprocessingstate msdyn_salesagentprocessingstate_SyncErrors](msdyn_salesagentprocessingstate.md#BKMK_msdyn_salesagentprocessingstate_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_salesagentprocessingstate`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_salesagentprofile_SyncErrors"></a> msdyn_salesagentprofile_SyncErrors

One-To-Many Relationship: [msdyn_salesagentprofile msdyn_salesagentprofile_SyncErrors](msdyn_salesagentprofile.md#BKMK_msdyn_salesagentprofile_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesagentrun msdyn_salesagentrun_SyncErrors](msdyn_salesagentrun.md#BKMK_msdyn_salesagentrun_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesagentusage msdyn_salesagentusage_SyncErrors](msdyn_salesagentusage.md#BKMK_msdyn_salesagentusage_SyncErrors)
...
### <a name="BKMK_msdyn_salescompanyresolverleadtrigger_SyncErrors"></a> msdyn_salescompanyresolverleadtrigger_SyncErrors

One-To-Many Relationship: [msdyn_salescompanyresolverleadtrigger msdyn_salescompanyresolverleadtrigger_SyncErrors](msdyn_salescompanyresolverleadtrigger.md#BKMK_msdyn_salescompanyresolverleadtrigger_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_salescompanyresolverleadtrigger`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_salescopilotjobstatus_SyncErrors"></a> msdyn_salescopilotjobstatus_SyncErrors

One-To-Many Relationship: [msdyn_salescopilotjobstatus msdyn_salescopilotjobstatus_SyncErrors](msdyn_salescopilotjobstatus.md#BKMK_msdyn_salescopilotjobstatus_SyncErrors)
...
One-To-Many Relationship: [msdyn_salescopilotknowledgebase msdyn_salescopilotknowledgebase_SyncErrors](msdyn_salescopilotknowledgebase.md#BKMK_msdyn_salescopilotknowledgebase_SyncErrors)
...
One-To-Many Relationship: [msdyn_salesresearchmanager msdyn_salesresearchmanager_SyncErrors](msdyn_salesresearchmanager.md#BKMK_msdyn_salesresearchmanager_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_salesresearchmanager`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_screenrecording msdyn_screenrecording_SyncErrors](msdyn_screenrecording.md#BKMK_msdyn_screenrecording_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_screenrecording`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_screenrecordingconfig_SyncErrors"></a> msdyn_screenrecordingconfig_SyncErrors

One-To-Many Relationship: [msdyn_screenrecordingconfig msdyn_screenrecordingconfig_SyncErrors](msdyn_screenrecordingconfig.md#BKMK_msdyn_screenrecordingconfig_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_screenrecordingconfig`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_screenrecordinglink_SyncErrors"></a> msdyn_screenrecordinglink_SyncErrors

One-To-Many Relationship: [msdyn_screenrecordinglink msdyn_screenrecordinglink_SyncErrors](msdyn_screenrecordinglink.md#BKMK_msdyn_screenrecordinglink_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_screenrecordinglink`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_sessionextension msdyn_sessionextension_SyncErrors](msdyn_sessionextension.md#BKMK_msdyn_sessionextension_SyncErrors)
...
### <a name="BKMK_msdyn_sessionparticipantextension_SyncErrors"></a> msdyn_sessionparticipantextension_SyncErrors

One-To-Many Relationship: [msdyn_sessionparticipantextension msdyn_sessionparticipantextension_SyncErrors](msdyn_sessionparticipantextension.md#BKMK_msdyn_sessionparticipantextension_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_sessionparticipantextension`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_simulatedconversation_SyncErrors"></a> msdyn_simulatedconversation_SyncErrors

One-To-Many Relationship: [msdyn_simulatedconversation msdyn_simulatedconversation_SyncErrors](msdyn_simulatedconversation.md#BKMK_msdyn_simulatedconversation_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_simulatedconversation`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_simulationrun_SyncErrors"></a> msdyn_simulationrun_SyncErrors

One-To-Many Relationship: [msdyn_simulationrun msdyn_simulationrun_SyncErrors](msdyn_simulationrun.md#BKMK_msdyn_simulationrun_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_simulationrun`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
### <a name="BKMK_msdyn_soa_similaropportunities_SyncErrors"></a> msdyn_soa_similaropportunities_SyncErrors

One-To-Many Relationship: [msdyn_soa_similaropportunities msdyn_soa_similaropportunities_SyncErrors](msdyn_soa_similaropportunities.md#BKMK_msdyn_soa_similaropportunities_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_soa_similaropportunities`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyn_stakeholderresearchoutput msdyn_stakeholderresearchoutput_SyncErrors](msdyn_stakeholderresearchoutput.md#BKMK_msdyn_stakeholderresearchoutput_SyncErrors)
...
One-To-Many Relationship: [msdyn_summarysynthesizerinput msdyn_summarysynthesizerinput_SyncErrors](msdyn_summarysynthesizerinput.md#BKMK_msdyn_summarysynthesizerinput_SyncErrors)
...
One-To-Many Relationship: [msdyn_summarysynthesizeroutput msdyn_summarysynthesizeroutput_SyncErrors](msdyn_summarysynthesizeroutput.md#BKMK_msdyn_summarysynthesizeroutput_SyncErrors)
...
### <a name="BKMK_msdyn_summarysynthesizertrigger_SyncErrors"></a> msdyn_summarysynthesizertrigger_SyncErrors

One-To-Many Relationship: [msdyn_summarysynthesizertrigger msdyn_summarysynthesizertrigger_SyncErrors](msdyn_summarysynthesizertrigger.md#BKMK_msdyn_summarysynthesizertrigger_SyncErrors)
...
### <a name="BKMK_msdyn_targetcustomerprofileprefillagenttrigger_SyncErrors"></a> msdyn_targetcustomerprofileprefillagenttrigger_SyncErrors

One-To-Many Relationship: [msdyn_targetcustomerprofileprefillagenttrigger msdyn_targetcustomerprofileprefillagenttrigger_SyncErrors](msdyn_targetcustomerprofileprefillagenttrigger.md#BKMK_msdyn_targetcustomerprofileprefillagenttrigger_SyncErrors)
...
### <a name="BKMK_msdyn_tcpprefillagentresult_SyncErrors"></a> msdyn_tcpprefillagentresult_SyncErrors

One-To-Many Relationship: [msdyn_tcpprefillagentresult msdyn_tcpprefillagentresult_SyncErrors](msdyn_tcpprefillagentresult.md#BKMK_msdyn_tcpprefillagentresult_SyncErrors)
...
### <a name="BKMK_msdyn_templatecontextvariable_SyncErrors"></a> msdyn_templatecontextvariable_SyncErrors

One-To-Many Relationship: [msdyn_templatecontextvariable msdyn_templatecontextvariable_SyncErrors](msdyn_templatecontextvariable.md#BKMK_msdyn_templatecontextvariable_SyncErrors)
...
One-To-Many Relationship: [msdyn_templatevariablebatchoperation msdyn_templatevariablebatchoperation_SyncErrors](msdyn_templatevariablebatchoperation.md#BKMK_msdyn_templatevariablebatchoperation_SyncErrors)
...
One-To-Many Relationship: [msdyn_transformationjob msdyn_transformationjob_SyncErrors](msdyn_transformationjob.md#BKMK_msdyn_transformationjob_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_transformationjob`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_transformationjobdefinition_SyncErrors"></a> msdyn_transformationjobdefinition_SyncErrors

One-To-Many Relationship: [msdyn_transformationjobdefinition msdyn_transformationjobdefinition_SyncErrors](msdyn_transformationjobdefinition.md#BKMK_msdyn_transformationjobdefinition_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_transformationjobdefinition`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_transformationjobtracker_SyncErrors"></a> msdyn_transformationjobtracker_SyncErrors

One-To-Many Relationship: [msdyn_transformationjobtracker msdyn_transformationjobtracker_SyncErrors](msdyn_transformationjobtracker.md#BKMK_msdyn_transformationjobtracker_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_transformationjobtracker`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_transformationtranscript_SyncErrors"></a> msdyn_transformationtranscript_SyncErrors

One-To-Many Relationship: [msdyn_transformationtranscript msdyn_transformationtranscript_SyncErrors](msdyn_transformationtranscript.md#BKMK_msdyn_transformationtranscript_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyn_transformationtranscript`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_triggersalesagent_SyncErrors"></a> msdyn_triggersalesagent_SyncErrors

One-To-Many Relationship: [msdyn_triggersalesagent msdyn_triggersalesagent_SyncErrors](msdyn_triggersalesagent.md#BKMK_msdyn_triggersalesagent_SyncErrors)
...
### <a name="BKMK_msdyn_workstream_bot_mapping_SyncErrors"></a> msdyn_workstream_bot_mapping_SyncErrors

One-To-Many Relationship: [msdyn_workstream_bot_mapping msdyn_workstream_bot_mapping_SyncErrors](msdyn_workstream_bot_mapping.md#BKMK_msdyn_workstream_bot_mapping_SyncErrors)
...
One-To-Many Relationship: [msdyncrm_digitalassetsconfiguration msdyncrm_digitalassetsconfiguration_SyncErrors](msdyncrm_digitalassetsconfiguration.md#BKMK_msdyncrm_digitalassetsconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_digitalassetsconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyncrm_file msdyncrm_file_SyncErrors](msdyncrm_file.md#BKMK_msdyncrm_file_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_file`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyncrm_keyword msdyncrm_keyword_SyncErrors](msdyncrm_keyword.md#BKMK_msdyncrm_keyword_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_keyword`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdyncrm_video msdyncrm_video_SyncErrors](msdyncrm_video.md#BKMK_msdyncrm_video_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_video`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdynmkt_compliancesettings4 msdynmkt_compliancesettings4_SyncErrors](msdynmkt_compliancesettings4.md#BKMK_msdynmkt_compliancesettings4_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_compliancesettings4`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdynmkt_consent msdynmkt_consent_SyncErrors](msdynmkt_consent.md#BKMK_msdynmkt_consent_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consent`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentcenterconfiguration_SyncErrors"></a> msdynmkt_consentcenterconfiguration_SyncErrors

One-To-Many Relationship: [msdynmkt_consentcenterconfiguration msdynmkt_consentcenterconfiguration_SyncErrors](msdynmkt_consentcenterconfiguration.md#BKMK_msdynmkt_consentcenterconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentcenterconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentprovider_SyncErrors"></a> msdynmkt_consentprovider_SyncErrors

One-To-Many Relationship: [msdynmkt_consentprovider msdynmkt_consentprovider_SyncErrors](msdynmkt_consentprovider.md#BKMK_msdynmkt_consentprovider_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentprovider`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdynmkt_consentproviderdefaultconfiguration msdynmkt_consentproviderdefaultconfiguration_SyncErrors](msdynmkt_consentproviderdefaultconfiguration.md#BKMK_msdynmkt_consentproviderdefaultconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentproviderdefaultconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentproviderdefaultpurpose_SyncErrors"></a> msdynmkt_consentproviderdefaultpurpose_SyncErrors

One-To-Many Relationship: [msdynmkt_consentproviderdefaultpurpose msdynmkt_consentproviderdefaultpurpose_SyncErrors](msdynmkt_consentproviderdefaultpurpose.md#BKMK_msdynmkt_consentproviderdefaultpurpose_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentproviderdefaultpurpose`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentproviderlocalization_SyncErrors"></a> msdynmkt_consentproviderlocalization_SyncErrors

One-To-Many Relationship: [msdynmkt_consentproviderlocalization msdynmkt_consentproviderlocalization_SyncErrors](msdynmkt_consentproviderlocalization.md#BKMK_msdynmkt_consentproviderlocalization_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentproviderlocalization`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentsubmitbutton_SyncErrors"></a> msdynmkt_consentsubmitbutton_SyncErrors

One-To-Many Relationship: [msdynmkt_consentsubmitbutton msdynmkt_consentsubmitbutton_SyncErrors](msdynmkt_consentsubmitbutton.md#BKMK_msdynmkt_consentsubmitbutton_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentsubmitbutton`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_consentsystemconfiguration_SyncErrors"></a> msdynmkt_consentsystemconfiguration_SyncErrors

One-To-Many Relationship: [msdynmkt_consentsystemconfiguration msdynmkt_consentsystemconfiguration_SyncErrors](msdynmkt_consentsystemconfiguration.md#BKMK_msdynmkt_consentsystemconfiguration_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_consentsystemconfiguration`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_contactpointconsent4_SyncErrors"></a> msdynmkt_contactpointconsent4_SyncErrors

One-To-Many Relationship: [msdynmkt_contactpointconsent4 msdynmkt_contactpointconsent4_SyncErrors](msdynmkt_contactpointconsent4.md#BKMK_msdynmkt_contactpointconsent4_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_contactpointconsent4`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_contactpointsettings_SyncErrors"></a> msdynmkt_contactpointsettings_SyncErrors

One-To-Many Relationship: [msdynmkt_contactpointsettings msdynmkt_contactpointsettings_SyncErrors](msdynmkt_contactpointsettings.md#BKMK_msdynmkt_contactpointsettings_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_contactpointsettings`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_customerdatamapping_SyncErrors"></a> msdynmkt_customerdatamapping_SyncErrors

One-To-Many Relationship: [msdynmkt_customerdatamapping msdynmkt_customerdatamapping_SyncErrors](msdynmkt_customerdatamapping.md#BKMK_msdynmkt_customerdatamapping_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_customerdatamapping`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_customerdataselection_SyncErrors"></a> msdynmkt_customerdataselection_SyncErrors

One-To-Many Relationship: [msdynmkt_customerdataselection msdynmkt_customerdataselection_SyncErrors](msdynmkt_customerdataselection.md#BKMK_msdynmkt_customerdataselection_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_customerdataselection`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdynmkt_preferencecenter msdynmkt_preferencecenter_SyncErrors](msdynmkt_preferencecenter.md#BKMK_msdynmkt_preferencecenter_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_preferencecenter`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_preferencecenterlink_SyncErrors"></a> msdynmkt_preferencecenterlink_SyncErrors

One-To-Many Relationship: [msdynmkt_preferencecenterlink msdynmkt_preferencecenterlink_SyncErrors](msdynmkt_preferencecenterlink.md#BKMK_msdynmkt_preferencecenterlink_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_preferencecenterlink`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdynmkt_purpose_SyncErrors"></a> msdynmkt_purpose_SyncErrors

One-To-Many Relationship: [msdynmkt_purpose msdynmkt_purpose_SyncErrors](msdynmkt_purpose.md#BKMK_msdynmkt_purpose_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_purpose`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msdynmkt_topic msdynmkt_topic_SyncErrors](msdynmkt_topic.md#BKMK_msdynmkt_topic_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdynmkt_topic`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [msfp_customervoiceuseractivity msfp_customervoiceuseractivity_SyncErrors](msfp_customervoiceuseractivity.md#BKMK_msfp_customervoiceuseractivity_SyncErrors)
...
One-To-Many Relationship: [msfp_log msfp_log_SyncErrors](msfp_log.md#BKMK_msfp_log_SyncErrors)
...
One-To-Many Relationship: [msfp_satisfactionmetricaggregate msfp_satisfactionmetricaggregate_SyncErrors](msfp_satisfactionmetricaggregate.md#BKMK_msfp_satisfactionmetricaggregate_SyncErrors)
...
One-To-Many Relationship: [msfp_satisfactionmetricsurveymapping msfp_satisfactionmetricsurveymapping_SyncErrors](msfp_satisfactionmetricsurveymapping.md#BKMK_msfp_satisfactionmetricsurveymapping_SyncErrors)
...
One-To-Many Relationship: [msfp_shorturl msfp_shorturl_SyncErrors](msfp_shorturl.md#BKMK_msfp_shorturl_SyncErrors)
...
One-To-Many Relationship: [msfp_surveyinvitesummary msfp_surveyinvitesummary_SyncErrors](msfp_surveyinvitesummary.md#BKMK_msfp_surveyinvitesummary_SyncErrors)
...
One-To-Many Relationship: [policycriterion policycriterion_SyncErrors](policycriterion.md#BKMK_policycriterion_SyncErrors)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_policycriterion`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
