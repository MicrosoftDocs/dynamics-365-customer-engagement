---
title: "Opportunity Research Agent Trigger (msdyn_OpportunityResearchAgentTrigger) table/entity reference (Microsoft Dynamics 365)"
description: "Includes schema information and supported messages for the Opportunity Research Agent Trigger (msdyn_OpportunityResearchAgentTrigger) table/entity with Microsoft Dynamics 365."
...
# Opportunity Research Agent Trigger (msdyn_OpportunityResearchAgentTrigger) table/entity reference (Microsoft Dynamics 365)

Opportunity Research Agent Trigger

## Messages

The following table lists the messages for the Opportunity Research Agent Trigger (msdyn_OpportunityResearchAgentTrigger) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_opportunityresearchagenttriggers(*msdyn_opportunityresearchagenttriggerid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Associate`<br />Event: True |[Associate records](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api) |[Associate records](/power-apps/developer/data-platform/org-service/entity-operations-associate-disassociate#use-the-associate-method-or-associaterequest)|
| `BulkRetain`<br />Event: True |<xref:Microsoft.Dynamics.CRM.BulkRetain?displayProperty=nameWithType /> |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `Create`<br />Event: True |`POST` /msdyn_opportunityresearchagenttriggers<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_opportunityresearchagenttriggers(*msdyn_opportunityresearchagenttriggerid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `SetState`<br />Event: True |`PATCH` /msdyn_opportunityresearchagenttriggers(*msdyn_opportunityresearchagenttriggerid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_opportunityresearchagenttriggers(*msdyn_opportunityresearchagenttriggerid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_opportunityresearchagenttrigger_statuscode`|
...
### <a name="BKMK_lk_msdyn_opportunityresearchagenttrigger_createdby"></a> lk_msdyn_opportunityresearchagenttrigger_createdby
...
### <a name="BKMK_lk_msdyn_opportunityresearchagenttrigger_modifiedonbehalfby"></a> lk_msdyn_opportunityresearchagenttrigger_modifiedonbehalfby
...
### <a name="BKMK_user_msdyn_opportunityresearchagenttrigger"></a> user_msdyn_opportunityresearchagenttrigger
...
### <a name="BKMK_msdyn_opportunityresearchagenttrigger_BulkDeleteFailures"></a> msdyn_opportunityresearchagenttrigger_BulkDeleteFailures
...
### <a name="BKMK_msdyn_opportunityresearchagenttrigger_ProcessSession"></a> msdyn_opportunityresearchagenttrigger_ProcessSession
