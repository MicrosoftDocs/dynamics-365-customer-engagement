...
Testing a connection is read-only. It fetches metadata and verifies reachability but doesn't modify any configuration.
...
This tool is exclusively called by the `manage_copilot_studio_registration` widget. Don't invoke it directly.
