...
| Input | Description | Required |
|---|---|---|
| `kpiName` | `kpiName` (string, optional). Filters to a single KPI by name (for example, "Resolve By"). Omit to see all linked KPIs. | No |
...
- The user asks about a specific KPI (for example, "First Response By", "Resolve By") on a case.
