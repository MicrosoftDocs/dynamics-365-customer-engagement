...
**No, summarizing a case in text doesn't change data.**
...
|---|---|---|
| `incidentId`, `caseNumber` | `incidentId` (GUID) or `caseNumber` (for example, CAS-01010-A0A0A0). At least one is required. | Yes |
