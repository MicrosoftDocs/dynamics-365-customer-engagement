...
| Input | Description | Required |
|---|---|---|
| `kpiName` | `kpiName` (string). Filters to a specific KPI (for example, "First Response By", "Resolve By"). | No |
...
The grid displays cases with SLA KPI status, breach time, time remaining, and case priority. Supports pagination through cursor.
