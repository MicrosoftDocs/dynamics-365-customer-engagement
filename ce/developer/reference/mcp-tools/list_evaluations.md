...
**No, listing evaluations doesn't change data.**

The evaluation list is read-only and doesn't modify any records.
...
- Continue with coaching workflows through follow-up prompts.
...
- Score-threshold filtering (for example, "evaluations below 90").
...
This tool doesn't change data. It reads evaluation records for a specified case.
