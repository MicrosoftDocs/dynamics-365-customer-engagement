...
**No, viewing escalated cases doesn't change data.**
...
|---|---|---|
| `top` | `top` (integer, max 50, optional). Maximum number of escalated cases to return. Defaults to the organization page-size setting (typically 10). | No |
