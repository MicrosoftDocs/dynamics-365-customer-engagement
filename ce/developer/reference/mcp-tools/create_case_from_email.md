...
The assistant shows a text confirmation with the new case number, case ID, and contact information. If a new contact was created for the sender, that's noted in the response.

## Helpful tips

- If you're not sure whether a case already exists for this email, say "match this email to existing cases" first. That way you avoid creating a duplicate case.
