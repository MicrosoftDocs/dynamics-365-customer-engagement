...
This tool updates an existing annotation record in Dataverse. Microsoft 365 Copilot prompts the user for confirmation before it runs. The operation is idempotent—retrying with the same inputs produces the same result.
