...
- Bots that are already registered don't appear twice, but you can still select a new bot and register it.
...
This tool is exclusively called by the `manage_copilot_studio_registration` widget's bot picker. Don't invoke it directly.
