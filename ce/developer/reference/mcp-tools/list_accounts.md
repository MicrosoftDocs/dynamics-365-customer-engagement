...
**No, listing accounts doesn't change data.**
...
The grid displays account name, industry, city, phone, and email. Users can select a row to drill into account detail or take follow-up actions through chat.
