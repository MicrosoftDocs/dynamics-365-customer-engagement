...
- Include detailed steps. Complete content makes the article more useful.
- Add keywords to make the article easier to find in searches (for example, "password", "reset", "MFA", "authentication").
...
| `destructiveHint` | `false` | Creates a draft; doesn't delete or overwrite existing articles. |
