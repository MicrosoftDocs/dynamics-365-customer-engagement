...
This tool updates the email's regarding object reference in Dataverse. Microsoft 365 Copilot prompts the user for confirmation. The operation is idempotent—re-linking the same email to the same case produces the same result.
