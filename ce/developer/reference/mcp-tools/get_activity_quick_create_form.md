...
**No, viewing form fields doesn't change data.**
...
|---|---|---|
| `activityType` | `activityType` (required—activity type logical name, for example, `phonecall`, `task`, `appointment`, or any tenant-provisioned activity type). | Yes |
