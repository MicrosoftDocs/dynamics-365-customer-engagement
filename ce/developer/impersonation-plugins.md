...
General information about using impersonation with plug-ins can be found in the Common Data Service (CDS) for Apps topic [Impersonate a user](/powerapps/developer/common-data-service/impersonate-a-user). The information that follows below is specific to on-premises plug-in development.
