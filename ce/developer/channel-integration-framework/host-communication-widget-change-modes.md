...
<a name="bkmk_helloworldwidget"></a>

## Step 1: Build a simple *Hello World!* widget

Read how you can get started with building your own communication widget on Channel Integration Framework(CIF) and host the widget on Azure. More information: [Getting started with building a simple communication widget](getting-started-simple-widget.md).
