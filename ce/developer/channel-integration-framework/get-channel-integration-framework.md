...
description: "Learn how to get/download, install and setup Channel Integration Framework (CIF) for Microsoft Dynamics 365 for Customer Engagement."
keywords: ""
ms.date: 10/01/2018
ms.service:
...
You can get the solution from within the Dynamics 365 for Customer Engagement or directly from Microsoft AppSource.

## Prerequisites

- Identify the Dynamics 365 for Customer Engagement instance for which you want to use the Channel Integration Framework application.
...
To get the Channel Integration Framework solution from within Dynamics 365 for Customer Engagement:
...
2. Select **GET IT NOW**.<br>
    ![Dynamics 365 for Customer Engagement for Channel Integration Framework in Microsoft AppSource](media/cif-app-source.png "Dynamics 365 for Customer Engagement for Channel Integration Framework in Microsoft AppSource")
...
3. Read and select the checkbox to agree for the following:
    ...
    - Privacy Statement and Legal Terms for importing the solution into Dynamics 365 for Customer Engagement.
...
## View Channel Integration Framework in Dynamics 365 for Customer Engagement
...
> Alternatively, you can use the `https://<orgURL>.dynamics.com/apps` to navigate to the channel Integration Framework.<br>
 ![Dynamics 365 for Customer Engagement org URL and apps to go to Channel Integration Framework](media/cif-alternative-app-navigation.png "Dynamics 365 for Customer Engagement org URL and apps to go to Channel Integration Framework")


> [!div class="nextstepaction"]
> [Configure channel provider for your Dynamics 365 for Customer Engagement organization](configure-channel-provider-channel-integration-framework.md)
