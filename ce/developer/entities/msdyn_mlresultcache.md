...
**DisplayName**: Result Cache<br />
**DisplayCollectionName**: Result Caches<br />
**SchemaName**: msdyn_mlresultcache<br />
**CollectionSchemaName**: msdyn_mlresultcaches<br />
**LogicalName**: msdyn_mlresultcache<br />
**LogicalCollectionName**: msdyn_mlresultcaches<br />
**EntitySetName**: msdyn_mlresultcaches<br />
**PrimaryIdAttribute**: msdyn_mlresultcacheid<br />
...
**Description**: <br />
**DisplayName**: Entity description<br />
**LogicalName**: msdyn_entitydescription<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: <br />
**DisplayName**: Expiration<br />
**LogicalName**: msdyn_expiration<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**DisplayName**: Result Cache<br />
**LogicalName**: msdyn_mlresultcacheid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: If cache is large, then this will have a numeric value corresponding to the part of the cache.<br />
**DisplayName**: Part Number<br />
**LogicalName**: msdyn_partnumber<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Integer<br />
...
**Description**: Status of the Result Cache<br />
...
**Description**: Reason for the status of the Result Cache<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_mlresultcache_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
