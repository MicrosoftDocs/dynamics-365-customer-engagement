...
**DisplayName**: Find Work Event<br />
**DisplayCollectionName**: Find Work Events<br />
**SchemaName**: msdyn_findworkevent<br />
**CollectionSchemaName**: msdyn_findworkevents<br />
**LogicalName**: msdyn_findworkevent<br />
**LogicalCollectionName**: msdyn_findworkevents<br />
**EntitySetName**: msdyn_findworkevents<br />
**PrimaryIdAttribute**: msdyn_findworkeventid<br />
...
**DisplayName**: Find Work Event<br />
**LogicalName**: msdyn_findworkeventid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: <br />
**DisplayName**: Timestamp<br />
**LogicalName**: msdyn_timestamp<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**Type**: DateTime<br />
...
- **Value**: 192350000 **Label**: WorkOpen
- **Value**: 192350001 **Label**: WorkViewDuration
- **Value**: 192350002 **Label**: WorkApply
...
**Description**: Status of the Find Work Event<br />
...
**Description**: Reason for the status of the Find Work Event<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_findworkevent_Annotations<br />
**AssociatedMenuConfiguration**:
