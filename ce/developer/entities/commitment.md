...
**SchemaName**: Commitment<br />
**CollectionSchemaName**: Commitments<br />
**LogicalName**: commitment<br />
**LogicalCollectionName**: commitments<br />
**EntitySetName**: commitments<br />
**PrimaryIdAttribute**: commitmentid<br />
...
**ReferencedEntityNavigationPropertyName**: commitment_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: commitment_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: commitment_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_commitment<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: commitment_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: commitment_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: Commitment_Annotation<br />
**AssociatedMenuConfiguration**:
