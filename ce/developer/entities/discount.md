...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/discounts<br />See [Create](../webapi/create-entity-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/discounts(*discountid*)<br />See [Delete](../webapi/update-delete-entities-using-web-api.md#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/discounts(*discountid*)<br />See [Retrieve](../webapi/retrieve-entity-using-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/discounts<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/discounts(*discountid*)<br />See [Update](../webapi/update-delete-entities-using-web-api.md#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|

## Entity Properties

**DisplayName**: Discount<br />
**DisplayCollectionName**: Discounts<br />
**SchemaName**: Discount<br />
**CollectionSchemaName**: Discounts<br />
**LogicalName**: discount<br />
**LogicalCollectionName**: discounts<br />
**EntitySetName**: discounts<br />
**PrimaryIdAttribute**: discountid<br />
...
**Description**: Amount of the discount, specified either as a percentage or as a monetary amount.<br />
...
**Description**: Unique identifier of the discount.<br />
**DisplayName**: Discount<br />
**LogicalName**: discountid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Unique identifier of the discount list associated with the discount.<br />
**DisplayName**: Discount Type<br />
...
**Description**: Upper boundary for the quantity range to which a particular discount can be applied.<br />
**DisplayName**: End Quantity<br />
**LogicalName**: highquantity<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Decimal<br />
...
**Description**: Lower boundary for the quantity range to which a particular discount is applied.<br />
**DisplayName**: Begin Quantity<br />
**LogicalName**: lowquantity<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Decimal<br />
...
**Description**: Percentage discount value.<br />
...
**Description**: Select the discount's status.<br />
...
**Description**: Unique identifier of the user who created the discount.<br />
...
**Description**: Date and time when the discount was created.<br />
...
**Description**: Unique identifier of the delegate user who created the discount.<br />
...
**Description**: Specifies whether the discount is specified as a monetary amount or a percentage.<br />
**DisplayName**: Amount Type<br />
...
**Description**: Unique identifier of the user who last modified the discount.<br />
...
**Description**: Date and time when the discount was last modified.<br />
...
**Description**: Unique identifier of the delegate user who last modified the discount.<br />
...
**Description**: Unique identifier of the organization associated with the discount.<br />
...
**ReferencedEntityNavigationPropertyName**: Discount_SyncErrors<br />
...
**ReferencedEntityNavigationPropertyName**: Discount_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: discount_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_discount<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: Discount_ProcessSessions<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: Discount_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: discount_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
