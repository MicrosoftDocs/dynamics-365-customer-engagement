...
**DisplayName**: Integration Job<br />
**DisplayCollectionName**: Integration Jobs<br />
**SchemaName**: msdyn_integrationjob<br />
**CollectionSchemaName**: msdyn_integrationjobs<br />
**LogicalName**: msdyn_integrationjob<br />
**LogicalCollectionName**: msdyn_integrationjobs<br />
**EntitySetName**: msdyn_integrationjobs<br />
**PrimaryIdAttribute**: msdyn_integrationjobid<br />
...
**DisplayName**: Integration Job<br />
**LogicalName**: msdyn_integrationjobid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: The expected number of packets to be received.<br />
**DisplayName**: Number of packets<br />
**LogicalName**: msdyn_numberofpackets<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**Description**: The logical name of entity related to the integration job<br />
**DisplayName**: Regarding Entity<br />
**LogicalName**: msdyn_regardingentity<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**Type**: String<br />
...
**Description**: The primary id of entity related to the integration job<br />
**DisplayName**: Regarding Entity Id<br />
**LogicalName**: msdyn_regardingentityid<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**Type**: String<br />
...
**Description**: The response of the integration job in JSON format<br />
**DisplayName**: ResponseJSON<br />
**LogicalName**: msdyn_responsejson<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Memo<br />
...
**Description**: The status of the integration job.<br />
...
- **Value**: 192350000 **Label**: Waiting
- **Value**: 192350001 **Label**: Ready
- **Value**: 192350002 **Label**: Skipped
- **Value**: 192350003 **Label**: Processing
- **Value**: 192350004 **Label**: Succeeded
- **Value**: 192350005 **Label**: Failed



### <a name="BKMK_msdyn_Type"></a> msdyn_Type

**Description**: The type of integration job<br />
**DisplayName**: Type<br />
...
- **Value**: 192350000 **Label**: MS Project Client
...
**Description**: Status of the Integration Job<br />
**DisplayName**: Status<br />
...
**Description**: Reason for the status of the Integration Job<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjob_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: msdyn_integrationjobheader<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_integrationjob_msdyn_integrationjob<br />
**AssociatedMenuConfiguration**:
