---
title: "ContactInvoices Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/contactinvoicescollection<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|

## Properties

**DisplayName**: ContactInvoices<br />
**DisplayCollectionName**: ContactInvoices<br />
**SchemaName**: ContactInvoices<br />
**CollectionSchemaName**: <br />
**LogicalName**: contactinvoices<br />
**LogicalCollectionName**: <br />
**EntitySetName**: contactinvoicescollection<br />
**PrimaryIdAttribute**: contactinvoiceid<br />
...
**Description**: Unique identifier of the invoices for the contact.<br />
**DisplayName**: <br />
**LogicalName**: contactinvoiceid<br />
...
**ReferencedEntityNavigationPropertyName**: contactinvoices_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactinvoices_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactinvoices_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactinvoices_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactinvoices_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
