...
**DisplayName**: ContactLeads<br />
**DisplayCollectionName**: ContactLeads<br />
**SchemaName**: ContactLeads<br />
**CollectionSchemaName**: <br />
**LogicalName**: contactleads<br />
**LogicalCollectionName**: <br />
**EntitySetName**: contactleadscollection<br />
**PrimaryIdAttribute**: contactleadid<br />
...
**Description**: Unique identifier of the leads for the contact.<br />
**DisplayName**: <br />
**LogicalName**: contactleadid<br />
...
**ReferencedEntityNavigationPropertyName**: contactleads_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactleads_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactleads_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactleads_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactleads_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
