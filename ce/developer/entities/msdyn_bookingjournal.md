...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/msdyn_bookingjournals(*msdyn_bookingjournalid*)<br />[Update](../webapi/update-delete-entities-using-web-api.md#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/msdyn_bookingjournals<br />See [Create](../webapi/create-entity-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/msdyn_bookingjournals(*msdyn_bookingjournalid*)<br />See [Delete](../webapi/update-delete-entities-using-web-api.md#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|IsValidStateTransition|<xref href="Microsoft.Dynamics.CRM.IsValidStateTransition?text=IsValidStateTransition Function" />|<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/msdyn_bookingjournals(*msdyn_bookingjournalid*)<br />See [Retrieve](../webapi/retrieve-entity-using-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/msdyn_bookingjournals<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
**SchemaName**: msdyn_bookingjournal<br />
**CollectionSchemaName**: msdyn_bookingjournals<br />
**LogicalName**: msdyn_bookingjournal<br />
**LogicalCollectionName**: msdyn_bookingjournals<br />
**EntitySetName**: msdyn_bookingjournals<br />
**PrimaryIdAttribute**: msdyn_bookingjournalid<br />
...
**Description**: Shows the additional cost associated with this journal, if any. (This amount is not multiplied by quantity)<br />
...
**Description**: Shows if this journal is billable.<br />
**DisplayName**: Billable<br />
**LogicalName**: msdyn_billable<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Boolean<br />
...
**Description**: This Resource Booking this journal pertains to<br />
...
**DisplayName**: Booking Journal<br />
**LogicalName**: msdyn_bookingjournalid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Enter the total duration of this journal record.<br />
...
**Description**: Enter the end time of this journal record.<br />
...
**Description**: Enter the type of journal.<br />
...
**Description**: Unique identifier for Resource Pay Type associated with Booking Journal.<br />
**DisplayName**: Pay Type<br />
**LogicalName**: msdyn_paytype<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Lookup<br />
...
**Description**: Enter the start time of this journal record.<br />
...
**Description**: Shows the total cost company pays to resource.<br />
...
**Description**: Enter the hourly cost that company pays to the resource.<br />
...
**Description**: Status of the Booking Journal<br />
...
**Description**: Reason for the status of the Booking Journal<br />
...
**Description**: <br />
**DisplayName**: <br />
**LogicalName**: msdyn_paytypename<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_bookingjournal_Annotations<br />
**AssociatedMenuConfiguration**:
