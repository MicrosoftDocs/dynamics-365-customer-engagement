...
**DisplayName**: Entitlement Product<br />
**DisplayCollectionName**: Entitlement Products<br />
**SchemaName**: EntitlementProducts<br />
**CollectionSchemaName**: <br />
**LogicalName**: entitlementproducts<br />
**LogicalCollectionName**: <br />
**EntitySetName**: entitlementproductscollection<br />
**PrimaryIdAttribute**: entitlementproductid<br />
...
**DisplayName**: <br />
**LogicalName**: entitlementproductid<br />
...
**ReferencedEntityNavigationPropertyName**: entitlementproducts_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementproducts_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementproducts_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementproducts_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementproducts_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
