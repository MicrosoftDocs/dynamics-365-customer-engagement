...
One-To-Many Relationship: [msdyn_analyticsadminsettings msdyn_analyticsadminsettings_BulkDeleteFailures](msdyn_analyticsadminsettings.md#BKMK_msdyn_analyticsadminsettings_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_bgjobledger msdyn_bgjobledger_BulkDeleteFailures](msdyn_bgjobledger.md#BKMK_msdyn_bgjobledger_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_callablecontext msdyn_callablecontext_BulkDeleteFailures](msdyn_callablecontext.md#BKMK_msdyn_callablecontext_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_consoleapplicationnotificationfield msdyn_consoleapplicationnotificationfield_BulkDeleteFailures](msdyn_consoleapplicationnotificationfield.md#BKMK_msdyn_consoleapplicationnotificationfield_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_consoleapplicationnotificationtemplate msdyn_consoleapplicationnotificationtemplate_BulkDeleteFailures](msdyn_consoleapplicationnotificationtemplate.md#BKMK_msdyn_consoleapplicationnotificationtemplate_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_consoleappparameterdefinition msdyn_consoleappparameterdefinition_BulkDeleteFailures](msdyn_consoleappparameterdefinition.md#BKMK_msdyn_consoleappparameterdefinition_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_conversationdata msdyn_conversationdata_BulkDeleteFailures](msdyn_conversationdata.md#BKMK_msdyn_conversationdata_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_conversationsuggestionrequestpayload msdyn_conversationsuggestionrequestpayload_BulkDeleteFailures](msdyn_conversationsuggestionrequestpayload.md#BKMK_msdyn_conversationsuggestionrequestpayload_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_dataanalyticsreport_ocvoice msdyn_dataanalyticsreport_ocvoice_BulkDeleteFailures](msdyn_dataanalyticsreport_ocvoice.md#BKMK_msdyn_dataanalyticsreport_ocvoice_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_defextendedchannelinstance msdyn_defextendedchannelinstance_BulkDeleteFailures](msdyn_defextendedchannelinstance.md#BKMK_msdyn_defextendedchannelinstance_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_defextendedchannelinstanceaccount msdyn_defextendedchannelinstanceaccount_BulkDeleteFailures](msdyn_defextendedchannelinstanceaccount.md#BKMK_msdyn_defextendedchannelinstanceaccount_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_entityconfig msdyn_entityconfig_BulkDeleteFailures](msdyn_entityconfig.md#BKMK_msdyn_entityconfig_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_jobsstate msdyn_jobsstate_BulkDeleteFailures](msdyn_jobsstate.md#BKMK_msdyn_jobsstate_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_liveconversation msdyn_liveconversation_BulkDeleteFailures](msdyn_liveconversation.md#BKMK_msdyn_liveconversation_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_msteamssetting msdyn_msteamssetting_BulkDeleteFailures](msdyn_msteamssetting.md#BKMK_msdyn_msteamssetting_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_msteamssettingsv2 msdyn_msteamssettingsv2_BulkDeleteFailures](msdyn_msteamssettingsv2.md#BKMK_msdyn_msteamssettingsv2_BulkDeleteFailures)
...
### <a name="BKMK_msdyn_ocliveworkitemparticipant_BulkDeleteFailures"></a> msdyn_ocliveworkitemparticipant_BulkDeleteFailures

One-To-Many Relationship: [msdyn_ocliveworkitemparticipant msdyn_ocliveworkitemparticipant_BulkDeleteFailures](msdyn_ocliveworkitemparticipant.md#BKMK_msdyn_ocliveworkitemparticipant_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_omnichannelqueue msdyn_omnichannelqueue_BulkDeleteFailures](msdyn_omnichannelqueue.md#BKMK_msdyn_omnichannelqueue_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_playbookactivity msdyn_playbookactivity_BulkDeleteFailures](msdyn_playbookactivity.md#BKMK_msdyn_playbookactivity_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_playbookactivityattribute msdyn_playbookactivityattribute_BulkDeleteFailures](msdyn_playbookactivityattribute.md#BKMK_msdyn_playbookactivityattribute_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_playbookinstance msdyn_playbookinstance_BulkDeleteFailures](msdyn_playbookinstance.md#BKMK_msdyn_playbookinstance_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_recording msdyn_recording_BulkDeleteFailures](msdyn_recording.md#BKMK_msdyn_recording_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_relationshipinsightsunifiedconfig msdyn_relationshipinsightsunifiedconfig_BulkDeleteFailures](msdyn_relationshipinsightsunifiedconfig.md#BKMK_msdyn_relationshipinsightsunifiedconfig_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_rulesetdependencymapping msdyn_rulesetdependencymapping_BulkDeleteFailures](msdyn_rulesetdependencymapping.md#BKMK_msdyn_rulesetdependencymapping_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_vivaentitysetting msdyn_vivaentitysetting_BulkDeleteFailures](msdyn_vivaentitysetting.md#BKMK_msdyn_vivaentitysetting_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_vivaorgextensioncred msdyn_vivaorgextensioncred_BulkDeleteFailures](msdyn_vivaorgextensioncred.md#BKMK_msdyn_vivaorgextensioncred_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_vivaorgsetting msdyn_vivaorgsetting_BulkDeleteFailures](msdyn_vivaorgsetting.md#BKMK_msdyn_vivaorgsetting_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_vivausersetting msdyn_vivausersetting_BulkDeleteFailures](msdyn_vivausersetting.md#BKMK_msdyn_vivausersetting_BulkDeleteFailures)
...
One-To-Many Relationship: [msdyn_worklistviewconfiguration msdyn_worklistviewconfiguration_BulkDeleteFailures](msdyn_worklistviewconfiguration.md#BKMK_msdyn_worklistviewconfiguration_BulkDeleteFailures)
...
One-To-Many Relationship: [msdynmkt_experimentv2 msdynmkt_experimentv2_BulkDeleteFailures](msdynmkt_experimentv2.md#BKMK_msdynmkt_experimentv2_BulkDeleteFailures)
...
One-To-Many Relationship: [serviceplancustomcontrol serviceplancustomcontrol_BulkDeleteFailures](serviceplancustomcontrol.md#BKMK_serviceplancustomcontrol_BulkDeleteFailures)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_serviceplancustomcontrol`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
