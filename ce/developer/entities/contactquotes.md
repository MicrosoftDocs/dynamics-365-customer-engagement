---
title: "ContactQuotes Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/contactquotescollection<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|

## Entity Properties

**DisplayName**: ContactQuotes<br />
**DisplayCollectionName**: ContactQuotes<br />
**SchemaName**: ContactQuotes<br />
**CollectionSchemaName**: <br />
**LogicalName**: contactquotes<br />
**LogicalCollectionName**: <br />
**EntitySetName**: contactquotescollection<br />
**PrimaryIdAttribute**: contactquoteid<br />
...
**Description**: Unique identifier of the quotes for the contact.<br />
**DisplayName**: <br />
**LogicalName**: contactquoteid<br />
...
**ReferencedEntityNavigationPropertyName**: contactquotes_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactquotes_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactquotes_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactquotes_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactquotes_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
