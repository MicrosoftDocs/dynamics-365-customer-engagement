...
**DisplayName**: Phone To Case Process<br />
**DisplayCollectionName**: Phone To Case Process<br />
**SchemaName**: PhoneToCaseProcess<br />
**CollectionSchemaName**: PhoneToCaseProcesses<br />
**LogicalName**: phonetocaseprocess<br />
**LogicalCollectionName**: phonetocaseprocesses<br />
**EntitySetName**: phonetocaseprocesses<br />
...
**Description**: Unique identifier for Phone To Case Process bpf entity instances<br />
**DisplayName**: Phone To Case Process Instance Id<br />
...
**ReferencedEntityNavigationPropertyName**: PhoneToCaseProcess_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: workflowlogs_phonetocaseprocess<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: phonetocaseprocess_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
