...
**DisplayName**: Agreement Sub-Status<br />
**DisplayCollectionName**: Agreement Sub-Statuses<br />
**SchemaName**: msdyn_agreementsubstatus<br />
**CollectionSchemaName**: msdyn_agreementsubstatuses<br />
**LogicalName**: msdyn_agreementsubstatus<br />
**LogicalCollectionName**: msdyn_agreementsubstatuses<br />
**EntitySetName**: msdyn_agreementsubstatuses<br />
**PrimaryIdAttribute**: msdyn_agreementsubstatusid<br />
...
**DisplayName**: Agreement Sub-Status<br />
**LogicalName**: msdyn_agreementsubstatusid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Shows the agreement sub-status name.<br />
**DisplayName**: Name<br />
...
**Description**: Status of the Agreement Sub-Status<br />
...
**Description**: Reason for the status of the Agreement Sub-Status<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_agreementsubstatus_Annotations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_agreementsubstatus_msdyn_agreement_SubStatus<br />
**AssociatedMenuConfiguration**:
