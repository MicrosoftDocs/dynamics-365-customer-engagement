...
**DisplayName**: Text Analytics Topic<br />
**DisplayCollectionName**: Text Analytics Topics<br />
**SchemaName**: Topic<br />
**CollectionSchemaName**: Topics<br />
**LogicalName**: topic<br />
**LogicalCollectionName**: topics<br />
**EntitySetName**: topics<br />
**PrimaryIdAttribute**: topicid<br />
...
**Description**: Unique identifier for Topic associated with Incident<br />
**DisplayName**: Incident Id<br />
...
**Description**: Shows the topic word or phrase.<br />
...
**Description**: Shows the relevance of the topic.<br />
**DisplayName**: Relevance Score<br />
**LogicalName**: score<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**Type**: Integer<br />
...
**ReferencedEntityNavigationPropertyName**: topic_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: topic_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: topic_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: topic_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: topic_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: topic_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
