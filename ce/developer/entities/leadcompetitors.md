---
title: "LeadCompetitors Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
**DisplayName**: LeadCompetitors<br />
**DisplayCollectionName**: LeadCompetitors<br />
**SchemaName**: LeadCompetitors<br />
**CollectionSchemaName**: <br />
**LogicalName**: leadcompetitors<br />
**LogicalCollectionName**: <br />
**EntitySetName**: leadcompetitorscollection<br />
**PrimaryIdAttribute**: leadcompetitorid<br />
...
**Description**: Unique identifier of the lead competitor.<br />
**DisplayName**: <br />
**LogicalName**: leadcompetitorid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**ReferencedEntityNavigationPropertyName**: leadcompetitors_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: leadcompetitors_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: leadcompetitors_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: leadcompetitors_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: leadcompetitors_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
