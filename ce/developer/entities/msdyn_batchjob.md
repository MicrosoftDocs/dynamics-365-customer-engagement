---
title: "msdyn_batchjob Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
**DisplayName**: Batch Job<br />
**DisplayCollectionName**: Batch Jobs<br />
**SchemaName**: msdyn_batchjob<br />
**CollectionSchemaName**: msdyn_batchjobs<br />
**LogicalName**: msdyn_batchjob<br />
**LogicalCollectionName**: msdyn_batchjobs<br />
**EntitySetName**: msdyn_batchjobs<br />
**PrimaryIdAttribute**: msdyn_batchjobid<br />
...
**DisplayName**: Batch Job<br />
**LogicalName**: msdyn_batchjobid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: <br />
**DisplayName**: Data1<br />
**LogicalName**: msdyn_data1<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: <br />
**DisplayName**: Frequency<br />
**LogicalName**: msdyn_frequency<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
- **Value**: 867380000 **Label**: None
- **Value**: 867380001 **Label**: Training
- **Value**: 867380005 **Label**: Waiting
- **Value**: 867380006 **Label**: Idle
...
**Description**: <br />
**DisplayName**: Last Run Date<br />
**LogicalName**: msdyn_lastrundate<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: DateTime<br />
...
**LogicalName**: msdyn_operationtype<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
**Description**: Status of the Batch Job<br />
...
**Description**: Reason for the status of the Batch Job<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_batchjob_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
