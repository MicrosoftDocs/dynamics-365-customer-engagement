---
title: "UserMapping Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/usermappings<br />See [Create](../webapi/create-entity-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/usermappings(*usermappingid*)<br />See [Delete](../webapi/update-delete-entities-using-web-api.md#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/usermappings(*usermappingid*)<br />See [Retrieve](../webapi/retrieve-entity-using-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/usermappings<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/usermappings(*usermappingid*)<br />See [Update](../webapi/update-delete-entities-using-web-api.md#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|

## Entity Properties

**DisplayName**: User Mapping<br />
**DisplayCollectionName**: User Mappings<br />
**SchemaName**: UserMapping<br />
**CollectionSchemaName**: UserMappings<br />
**LogicalName**: usermapping<br />
**LogicalCollectionName**: usermappings<br />
**EntitySetName**: usermappings<br />
**PrimaryIdAttribute**: usermappingid<br />
...
**Description**: The Claim Type<br />
**DisplayName**: Claim Type<br />
**LogicalName**: claimtype<br />
...
**Description**: The partner application for which this claim mapping is to be used. (exchange or sharepoint)<br />
**DisplayName**: Choose the Partner Application Type<br />
**LogicalName**: partnerapplicationtype<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
**Description**: The user attribute.<br />
**DisplayName**: The System User Attribute<br />
**LogicalName**: systemuserattributename<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Exchange rate for the currency associated with the UserMapping with respect to the base currency.<br />
...
**DisplayName**: UserMapping<br />
**LogicalName**: usermappingid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**ReferencedEntityNavigationPropertyName**: usermapping_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: usermapping_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: usermapping_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: usermapping_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
