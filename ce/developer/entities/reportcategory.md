---
title: "ReportCategory Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/reportcategories<br />See [Create](../webapi/create-entity-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/reportcategories(*reportcategoryid*)<br />See [Delete](../webapi/update-delete-entities-using-web-api.md#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/reportcategories(*reportcategoryid*)<br />See [Retrieve](../webapi/retrieve-entity-using-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
...
**SchemaName**: ReportCategory<br />
**CollectionSchemaName**: ReportCategories<br />
**LogicalName**: reportcategory<br />
**LogicalCollectionName**: reportcategories<br />
**EntitySetName**: reportcategories<br />
**PrimaryIdAttribute**: reportcategoryid<br />
...
**Description**: Category of the report.<br />
**DisplayName**: Category<br />
**LogicalName**: categorycode<br />
...
- **Value**: 1 **Label**: Sales Reports
- **Value**: 2 **Label**: Service Reports
- **Value**: 3 **Label**: Marketing Reports
- **Value**: 4 **Label**: Administrative Reports
...
**Description**: Unique identifier of the report category.<br />
**DisplayName**: Report Category<br />
**LogicalName**: reportcategoryid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Unique identifier of the currency associated with the Report category.<br />
...
**Description**: Unique identifier of the user who created the report category.<br />
...
**Description**: Date and time when the report category record was created.<br />
...
**Description**: Unique identifier of the delegate user who created the report category.<br />
...
**Description**: Exchange rate for the currency associated with the report category with respect to the base currency.<br />
...
**Description**: Unique identifier of the user who last modified the report category.<br />
...
**Description**: Date and time when the report category was last modified.<br />
...
**Description**: Unique identifier of the delegate user who last modified the report category.<br />
...
**Description**: Unique identifier of the user or team who owns the report category.<br />
...
**Description**: Unique identifier of the business unit that owns the report category.<br />
...
**Description**: Unique identifier of the user who owns the report category.<br />
...
**Description**: For internal use only.<br />
**DisplayName**: Report Category<br />
**LogicalName**: reportcategoryidunique<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Uniqueidentifier<br />
...
**Description**: Version number of the report category.<br />
...
**ReferencedEntityNavigationPropertyName**: ReportCategory_SyncErrors<br />
...
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_reportcategory<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: reportcategory_principalobjectattributeaccess<br />
**AssociatedMenuConfiguration**:
