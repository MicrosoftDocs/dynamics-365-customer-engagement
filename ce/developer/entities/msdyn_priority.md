...
**SchemaName**: msdyn_priority<br />
**CollectionSchemaName**: msdyn_priorities<br />
**LogicalName**: msdyn_priority<br />
**LogicalCollectionName**: msdyn_priorities<br />
**EntitySetName**: msdyn_priorities<br />
**PrimaryIdAttribute**: msdyn_priorityid<br />
...
**Description**: Enter the importance level of the priority.<br />
**DisplayName**: Level of Importance<br />
**LogicalName**: msdyn_levelofimportance<br />
...
**Description**: Enter the priority name.<br />
**DisplayName**: Name<br />
...
**Description**: Select the color to be used to visualize the priority on the schedule board.<br />
**DisplayName**: Priority Color<br />
**LogicalName**: msdyn_prioritycolor<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**DisplayName**: Priority<br />
**LogicalName**: msdyn_priorityid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Status of the Priority<br />
...
**Description**: Reason for the status of the Priority<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_priority_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_priority_Annotations<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: msdyn_priority<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_priority_msdyn_resourcerequirement_Priority<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_priority_msdyn_agreementbookingsetup_Priority<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_priority_msdyn_quotebookingsetup_Priority<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_priority_msdyn_workorder_Priority<br />
**AssociatedMenuConfiguration**:
