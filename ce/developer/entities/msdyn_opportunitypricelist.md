...
**DisplayName**: Opportunity Project Price List<br />
**DisplayCollectionName**: Opportunity Project Price Lists<br />
**SchemaName**: msdyn_opportunitypricelist<br />
**CollectionSchemaName**: msdyn_opportunitypricelists<br />
**LogicalName**: msdyn_opportunitypricelist<br />
**LogicalCollectionName**: msdyn_opportunitypricelists<br />
**EntitySetName**: msdyn_opportunitypricelists<br />
**PrimaryIdAttribute**: msdyn_opportunitypricelistid<br />
...
**Description**: Select the opportunity that the price list is associated to.<br />
**DisplayName**: Opportunity<br />
**LogicalName**: msdyn_opportunity<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**DisplayName**: Opportunity Price List<br />
**LogicalName**: msdyn_opportunitypricelistid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Select the price list that is associated to the opportunity.<br />
...
**Description**: Status of the Opportunity Price List<br />
...
**Description**: Reason for the status of the Opportunity Price List<br />
...
**Description**: <br />
**DisplayName**: <br />
**LogicalName**: msdyn_opportunityname<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_opportunitypricelist_Annotations<br />
**AssociatedMenuConfiguration**:
