...
**DisplayName**: Work Order Sub-Status<br />
**DisplayCollectionName**: Work Order Sub-Statuses<br />
**SchemaName**: msdyn_workordersubstatus<br />
**CollectionSchemaName**: msdyn_workordersubstatuses<br />
**LogicalName**: msdyn_workordersubstatus<br />
**LogicalCollectionName**: msdyn_workordersubstatuses<br />
**EntitySetName**: msdyn_workordersubstatuses<br />
**PrimaryIdAttribute**: msdyn_workordersubstatusid<br />
...
**Description**: Specify whether this sub-status should be the default sub-status for this status type.<br />
...
**Description**: Shows the work order status name.<br />
**DisplayName**: Name<br />
...
**DisplayName**: Work Order Sub-status<br />
**LogicalName**: msdyn_workordersubstatusid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Status of the Work Order Sub-status<br />
...
**Description**: Reason for the status of the Work Order Sub-status<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_workordersubstatus_Annotations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_workordersubstatus_msdyn_workorder_Status<br />
**AssociatedMenuConfiguration**:
