...
**DisplayCollectionName**: Social Profiles<br />
**SchemaName**: SocialProfile<br />
**CollectionSchemaName**: SocialProfiles<br />
**LogicalName**: socialprofile<br />
**LogicalCollectionName**: socialprofiles<br />
**EntitySetName**: socialprofiles<br />
**PrimaryIdAttribute**: socialprofileid<br />
**PrimaryNameAttribute**: profilename<br />
...
**Description**: Identifies if the social profile has been blocked.<br />
**DisplayName**: Blocked<br />
**LogicalName**: blocked<br />
...
**Description**: Identifies where the social profile originated from, such as Twitter, or Facebook.<br />
...
**Description**: Shows the customer that this social profile belongs to.<br />
...
**Description**: Select the parent account or parent contact for the contact<br />
...
**Description**: Shows the score that determines the online social influence of the social profile.<br />
...
**Description**: Shows the user or team that is assigned to manage the record. This field is updated every time the record is assigned to a different user.<br />
...
**Description**: Shows the display name of the customer on this social profile.<br />
**DisplayName**: Full Name<br />
**LogicalName**: profilefullname<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Shows the customer that this social profile belongs to.<br />
**DisplayName**: Profile Link<br />
**LogicalName**: profilelink<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**IsValidForUpdate**: False<br />
...
**Description**: Shows the name of the social profile on the corresponding social channel.<br />
**DisplayName**: Profile Name<br />
**LogicalName**: profilename<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Unique Identifier of the social profile name.<br />
**DisplayName**: Social Profile ID<br />
...
**Description**: Status of the Social Profile<br />
...
**Description**: Reason for the status of the Social Profile<br />
...
**Description**: Unique ID of the Profile ID<br />
**DisplayName**: Unique Profile ID<br />
**LogicalName**: uniqueprofileid<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Version number of the social profile.<br />
...
**ReferencingAttribute**: socialprofileid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: socialprofile_cases<br />
...
**ReferencedEntityNavigationPropertyName**: SocialProfile_ProcessSessions<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: SocialProfile_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: SocialProfile_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: postfromprofileid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: Socialprofile_SocialActivities<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: socialprofile_principalobjectattributeaccess<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: SocialProfile_SyncErrors<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: socialprofile_connections2<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: SocialProfile_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: socialprofile_connections1<br />
**AssociatedMenuConfiguration**:
