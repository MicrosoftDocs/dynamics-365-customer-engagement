...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/mailmergetemplates(*mailmergetemplateid*)<br />[Update](../webapi/update-delete-entities-using-web-api.md#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Create|POST [*org URI*]/api/data/v9.0/mailmergetemplates<br />See [Create](../webapi/create-entity-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/mailmergetemplates(*mailmergetemplateid*)<br />See [Delete](../webapi/update-delete-entities-using-web-api.md#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|GrantAccess|<xref href="Microsoft.Dynamics.CRM.GrantAccess?text=GrantAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
|ModifyAccess|<xref href="Microsoft.Dynamics.CRM.ModifyAccess?text=ModifyAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
|Retrieve|GET [*org URI*]/api/data/v9.0/mailmergetemplates(*mailmergetemplateid*)<br />See [Retrieve](../webapi/retrieve-entity-using-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/mailmergetemplates<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
**SchemaName**: MailMergeTemplate<br />
**CollectionSchemaName**: MailMergeTemplates<br />
**LogicalName**: mailmergetemplate<br />
**LogicalCollectionName**: mailmergetemplates<br />
**EntitySetName**: mailmergetemplates<br />
**PrimaryIdAttribute**: mailmergetemplateid<br />
...
**Description**: Body text of the mail merge template.<br />
**DisplayName**: Body<br />
**LogicalName**: body<br />
...
**Description**: Default data fields associated with the mail merge template.<br />
...
**Description**: Description of the mail merge template.<br />
...
**Description**: Version of the Microsoft Office Word XML format used by the template.<br />
**DisplayName**: Document Format<br />
**LogicalName**: documentformat<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
**Description**: File name of the mail merge template.<br />
...
**Description**: Information about whether the mail merge template is personal or is available to all users.<br />
...
**Description**: Language of the mail merge template.<br />
...
**Description**: Unique identifier of the mail merge template.<br />
**DisplayName**: Mail Merge Template<br />
**LogicalName**: mailmergetemplateid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**IsValidForUpdate**: False<br />
...
**Description**: Drop-down list for selecting the type of the mail merge.<br />
**DisplayName**: Mail Merge Type<br />
**LogicalName**: mailmergetype<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
- **Value**: 2 **Label**: Email Message
- **Value**: 3 **Label**: Envelope
- **Value**: 4 **Label**: Labels
...
**Description**: MIME type of the mail merge template.<br />
...
**Description**: Name of the mail merge template.<br />
**DisplayName**: Name<br />
**LogicalName**: name<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**Description**: Unique identifier of the user or team who owns the mail merge template.<br />
...
**Description**: Status of the mail merge template.<br />
...
**Description**: Reason for the status of the mail merge template.<br />
...
**Description**: Type of mail merge template.<br />
**DisplayName**: Associated Entity<br />
...
**Description**: Unique identifier of the currency associated with the mailmergetemplate.<br />
...
**Description**: Unique identifier of the user who created the mail merge template.<br />
...
**Description**: Date and time when the mail merge template was created.<br />
...
**Description**: Unique identifier of the delegate user who created the mailmergetemplate.<br />
...
**Description**: Exchange rate for the currency associated with the mailmergetemplate with respect to the base currency.<br />
...
**Description**: File size of the mail merge template.<br />
...
**Description**: For internal use only.<br />
**DisplayName**: <br />
**LogicalName**: mailmergetemplateidunique<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Uniqueidentifier<br />
...
**Description**: Unique identifier of the user who last modified the mail merge template.<br />
...
**Description**: Date and time when the mail merge template was last modified.<br />
...
**Description**: Unique identifier of the delegate user who last modified the mailmergetemplate.<br />
...
**Description**: Unique identifier of the business unit that owns the mail merge template.<br />
...
**Description**: Unique identifier of the team who owns the mail merge template.<br />
...
**Description**: Unique identifier of the user who owns the mail merge template.<br />
...
**Description**: Parameter Xml.<br />
**DisplayName**: Parameter Xml<br />
**LogicalName**: parameterxml<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Version number of the mail merge template.<br />
...
**ReferencedEntityNavigationPropertyName**: MailMergeTemplate_SyncErrors<br />
...
**ReferencedEntityNavigationPropertyName**: MailMergeTemplate_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_mailmergetemplate<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: mailmergetemplate_principalobjectattributeaccess<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: MailMergeTemplate_ProcessSessions<br />
**AssociatedMenuConfiguration**:
