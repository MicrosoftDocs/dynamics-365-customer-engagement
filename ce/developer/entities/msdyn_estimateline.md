...
**DisplayCollectionName**: Estimate Lines<br />
**SchemaName**: msdyn_estimateline<br />
**CollectionSchemaName**: msdyn_estimatelines<br />
**LogicalName**: msdyn_estimateline<br />
**LogicalCollectionName**: msdyn_estimatelines<br />
**EntitySetName**: msdyn_estimatelines<br />
**PrimaryIdAttribute**: msdyn_estimatelineid<br />
...
**Description**: Shows the customer for the estimate line.<br />
...
**Description**: Shows the amount on the estimate line.<br />
...
**Description**: Shows the calculation method used to determine the amount on the estimate line. <br />
...
**Description**: Shows whether this estimate line is charged to the customer. <br />
...
**Description**: Shows the bookable resource for which estimates are generated.<br />
...
**Description**: Shows the name of the customer contact.<br />
**DisplayName**: Customer<br />
...
**Description**: Select the type of customer.<br />
...
**Description**: Shows the transaction date of the estimate line.<br />
...
**Description**: Shows the name of the estimate line.<br />
...
**Description**: Stores the estimate per day detail lines.<br />
**DisplayName**: Estimate Per Day Lines<br />
**LogicalName**: msdyn_estimateperdaylines<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Memo<br />
...
**Description**: Shows the estimate of the number of resources intended to be staffed for this task.<br />
...
**Description**: Shows the percent for the estimate line.<br />
...
**Description**: Shows the price for this estimate line.<br />
...
**Description**: Shows the price list used in this estimate line.<br />
...
**Description**: Shows the project for this estimate line.<br />
...
**Description**: Enter the estimated quantity of work, cost, and sales.<br />
...
**Description**: Shows the role of this resource on the estimate line.<br />
**DisplayName**: Role<br />
...
**Description**: Select the organizational unit at the time the estimate line was registered of the resource who should perform the work.<br />
...
**Description**: Shows the start date and time for the task for this estimate line.<br />
...
**Description**: Shows the task related to this estimate line.<br />
**DisplayName**: Task<br />
...
**Description**: Select the type of transaction.<br />
...
**Description**: Shows the transaction classification for this estimate line.<br />
...
**Description**: Shows the transaction type for this estimate line.<br />
...
**Description**: Shows the unit of measurement for this estimate line.<br />
**DisplayName**: Unit<br />
...
**Description**: Select the unit of measure for the estimate quantity.<br />
...
**Description**: Status of the Estimate Line<br />
...
**Description**: Reason for the status of the Estimate Line<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_estimateline_Annotations<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: msdyn_estimatelineid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_estimateline_msdyn_fact_estimatelineid<br />
**AssociatedMenuConfiguration**:
