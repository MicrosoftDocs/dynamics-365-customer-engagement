...
**DisplayName**: Integration Job Detail<br />
**DisplayCollectionName**: Integration Job Details<br />
**SchemaName**: msdyn_integrationjobdetail<br />
**CollectionSchemaName**: msdyn_integrationjobdetails<br />
**LogicalName**: msdyn_integrationjobdetail<br />
**LogicalCollectionName**: msdyn_integrationjobdetails<br />
**EntitySetName**: msdyn_integrationjobdetails<br />
**PrimaryIdAttribute**: msdyn_integrationjobdetailid<br />
...
**Description**: The JSON representation of the changes in data<br />
...
**Description**: The full representation of the data in JSON<br />
**DisplayName**: Full JSON<br />
**LogicalName**: msdyn_fulljson<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Memo<br />
...
**DisplayName**: Integration Job Detail<br />
**LogicalName**: msdyn_integrationjobdetailid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: The parent integration job header<br />
**DisplayName**: Integration Job Header<br />
**LogicalName**: msdyn_integrationjobheader<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**Description**: The sequence number of the detail<br />
**DisplayName**: Sequence Number<br />
**LogicalName**: msdyn_sequencenumber<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: ApplicationRequired<br />
**Type**: Integer<br />
...
**Description**: Status of the Integration Job Detail<br />
...
**Description**: Reason for the status of the Integration Job Detail<br />
...
**Description**: <br />
**DisplayName**: <br />
**LogicalName**: msdyn_integrationjobheadername<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_integrationjobdetail_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
