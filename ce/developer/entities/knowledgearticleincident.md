---
title: "KnowledgeArticleIncident Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
**DisplayName**: Knowledge Article Incident<br />
**DisplayCollectionName**: Knowledge Article Incidents<br />
**SchemaName**: KnowledgeArticleIncident<br />
**CollectionSchemaName**: KnowledgeArticleIncidents<br />
**LogicalName**: knowledgearticleincident<br />
**LogicalCollectionName**: knowledgearticleincidents<br />
**EntitySetName**: knowledgearticleincidents<br />
**PrimaryIdAttribute**: knowledgearticleincidentid<br />
**PrimaryNameAttribute**: knowledgearticleidname<br />
...
**Description**: Choose the Incident id for the knowledge article.<br />
...
**Description**: This should be set to Yes when the user emails the article link to a customer. <br />
**DisplayName**: Sent To Customer<br />
**LogicalName**: issenttocustomer<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
...
**Description**: Choose the Knowledge Article.<br />
...
**Description**: Unique identifier of the Knowledge Article for the incident.<br />
**DisplayName**: KnowledgeArticle Incident<br />
**LogicalName**: knowledgearticleincidentid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Knowledge Usage.<br />
**DisplayName**: Knowledge Usage <br />
**LogicalName**: knowledgeusage<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: Picklist<br />
...
**Description**: Status of the Knowledge Article Incident<br />
...
**Description**: Reason for the status of the Knowledge Article Incident<br />
...
**ReferencedEntityNavigationPropertyName**: KnowledgeArticleIncident_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**ReferencedEntityNavigationPropertyName**: knowledgearticleincident_principalobjectattributeaccess<br />
**AssociatedMenuConfiguration**:
