...
**DisplayName**: Project Contract Line Detail<br />
**DisplayCollectionName**: Project Contract Line Details<br />
**SchemaName**: msdyn_orderlinetransaction<br />
**CollectionSchemaName**: msdyn_orderlinetransactions<br />
**LogicalName**: msdyn_orderlinetransaction<br />
**LogicalCollectionName**: msdyn_orderlinetransactions<br />
**EntitySetName**: msdyn_orderlinetransactions<br />
**PrimaryIdAttribute**: msdyn_orderlinetransactionid<br />
...
**Description**: Select the customer who this contract belongs to. <br />
...
**Description**: Enter the amount on the project contract line estimate.<br />
...
**Description**: Select whether this project contract line estimate will be charged to the customer or not. Only chargeable project contract line estimates will add to the invoice total<br />
...
**Description**: Select the customer contact of this Project Contract.<br />
...
**Description**: Type a description of the project contract line estimate<br />
...
**Description**: Enter the document date.<br />
...
**Description**: Enter the end date on the project contract line estimate.<br />
...
**Description**: Shows the project contract line that this estimate line belongs to.<br />
**DisplayName**: Project contract line estimate<br />
**LogicalName**: msdyn_orderlinetransactionid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Foreign key to the detail line that originated this entry. For example, revenue line points to it's related cost line.<br />
...
**Description**: Relevant when amount calculation method on the Project Contract line transactions is "Multiply basis amount by percent"<br />
...
**Description**: Enter the price on the project contract line estimate.<br />
...
**Description**: Select the price list used for defaulting price on this project contract line estimate.<br />
...
**Description**: Select the product on this project contract line estimate.<br />
...
**Description**: Select the name of the project on the project contract estimate line.<br />
...
**Description**: Enter the quantity of the project contract line estimate.<br />
...
**Description**: Select the name of the role that is estimated to perform this work.<br />
**DisplayName**: Role<br />
...
**Description**: Select the project contract that this estimate line is for.<br />
...
**Description**: Shows the project contract line that this project contract line estimate will be mapped to for operating margin calculations.<br />
...
**Description**: Enter the estimate start date of the portion of work that is being estimated on the project contract estimate line.<br />
...
**Description**: Select the name of the work breakdown structure (WBS) task on the project contract line estimate.<br />
**DisplayName**: Task<br />
...
**Description**: Select the transaction category on the project contract line estimate.<br />
...
**Description**: Transaction classification of the Project Contract line transaction<br />
...
**Description**: Transaction type of the Project Contract line transaction<br />
...
**Description**: Select the unit on the project contract line estimate.<br />
**DisplayName**: Unit<br />
...
**Description**: Select the unit schedule of the project contract line estimate.<br />
...
**Description**: Status of the Estimate Details<br />
...
**Description**: Reason for the status of the Estimate Details<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_DuplicateMatchingRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_DuplicateBaseRecord<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_orderlinetransaction_Annotations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_msdyn_orderlinetransaction_msdyn_orderlinetransaction_Origin<br />
**AssociatedMenuConfiguration**:
