...
**SchemaName**: EntitlementContacts<br />
**CollectionSchemaName**: <br />
**LogicalName**: entitlementcontacts<br />
**LogicalCollectionName**: <br />
**EntitySetName**: entitlementcontactscollection<br />
**PrimaryIdAttribute**: entitlementcontactid<br />
...
**Description**: Unique identifier of the contacts for the entitlements.<br />
**DisplayName**: <br />
**LogicalName**: entitlementcontactid<br />
...
**ReferencedEntityNavigationPropertyName**: entitlementcontacts_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementcontacts_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementcontacts_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementcontacts_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: entitlementcontacts_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
