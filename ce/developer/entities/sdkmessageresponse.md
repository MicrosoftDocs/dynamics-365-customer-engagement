...
**DisplayName**: Sdk Message Response<br />
**DisplayCollectionName**: Sdk MessageResponses<br />
**SchemaName**: SdkMessageResponse<br />
**CollectionSchemaName**: SdkMessageResponses<br />
**LogicalName**: sdkmessageresponse<br />
**LogicalCollectionName**: sdkmessageresponses<br />
**EntitySetName**: sdkmessageresponses<br />
**PrimaryIdAttribute**: sdkmessageresponseid<br />
...
**Description**: Unique identifier of the SDK message response entity.<br />
**DisplayName**: <br />
...
**Description**: Unique identifier of the user who created the SDK message response.<br />
**DisplayName**: <br />
...
**Description**: Date and time when the SDK message response was created.<br />
**DisplayName**: <br />
...
**Description**: Unique identifier of the delegate user who created the sdkmessageresponse.<br />
...
**Description**: Customization level of the SDK message response.<br />
**DisplayName**: <br />
...
**Description**: Unique identifier of the user who last modified the SDK message response.<br />
...
**Description**: Date and time when the SDK message response was last modified.<br />
...
**Description**: Unique identifier of the delegate user who last modified the sdkmessageresponse.<br />
...
**Description**: Unique identifier of the organization with which the SDK message response is associated.<br />
**DisplayName**: <br />
...
**Description**: Unique identifier of the message request with which the SDK message response is associated.<br />
**DisplayName**: <br />
...
**Description**: Unique identifier of the SDK message response.<br />
**DisplayName**: <br />
**LogicalName**: sdkmessageresponseidunique<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
**RequiredLevel**: SystemRequired<br />
**Type**: Uniqueidentifier<br />
...
**ReferencingAttribute**: sdkmessageresponseid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: messageresponse_sdkmessageresponsefield<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: False<br />
**ReferencedEntityNavigationPropertyName**: userentityinstancedata_sdkmessageresponse<br />
**AssociatedMenuConfiguration**:
