...
**DisplayName**: Post Configuration<br />
**DisplayCollectionName**: Post Configurations<br />
**SchemaName**: msdyn_PostConfig<br />
**CollectionSchemaName**: msdyn_PostConfigs<br />
**LogicalName**: msdyn_postconfig<br />
**LogicalCollectionName**: msdyn_postconfigs<br />
**EntitySetName**: msdyn_postconfigs<br />
**PrimaryIdAttribute**: msdyn_postconfigid<br />
**PrimaryNameAttribute**: msdyn_entitydisplayname<br />
...
**Description**: Enables or disables the wall on the entity form.<br />
**DisplayName**: Wall Enabled<br />
**LogicalName**: msdyn_configurewall<br />
...
**Description**: Display name of the entity configured by this object.<br />
...
**Description**: Logical name of the entity configured by this object.<br />
...
**Description**: Identifier for the view of records that a user follows.<br />
**DisplayName**: Following View Id<br />
**LogicalName**: msdyn_followingviewid<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Identifier for the view of records that a user follows.<br />
**DisplayName**: Following View Id 2<br />
**LogicalName**: msdyn_followingviewid2<br />
**IsValidForForm**: True<br />
**IsValidForRead**: True<br />
**RequiredLevel**: None<br />
**Type**: String<br />
...
**Description**: Object Type Code of the entity<br />
...
**Description**: Unique identifier of the post configuration for this rule.<br />
**DisplayName**: Post Configuration<br />
**LogicalName**: msdyn_postconfigid<br />
**IsValidForForm**: False<br />
**IsValidForRead**: True<br />
...
**Description**: Information about the success or failure of the configuration.<br />
**DisplayName**: Configuration Status<br />
...
**Description**: Status of the Post Configuration<br />
...
**Description**: Reason for the status of the Post Configuration<br />
...
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_SyncErrors<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_AsyncOperations<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_ProcessSession<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: msdyn_postconfigid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_msdyn_postruleconfig<br />
**AssociatedMenuConfiguration**:
...
**ReferencingAttribute**: msdyn_postconfigurationid<br />
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: msdyn_postconfig_wallsavedquery<br />
**AssociatedMenuConfiguration**:
