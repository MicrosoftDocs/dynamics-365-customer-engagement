---
title: "ContactOrders Entity Reference (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
...
|-|-|-|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/contactorderscollection<br />See [Query Data](../webapi/query-data-web-api.md)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|

## Properties

**DisplayName**: ContactOrders<br />
**DisplayCollectionName**: ContactOrders<br />
**SchemaName**: ContactOrders<br />
**CollectionSchemaName**: <br />
**LogicalName**: contactorders<br />
**LogicalCollectionName**: <br />
**EntitySetName**: contactorderscollection<br />
**PrimaryIdAttribute**: contactorderid<br />
...
**Description**: Unique identifier of the orders for the contact.<br />
**DisplayName**: <br />
**LogicalName**: contactorderid<br />
...
**ReferencedEntityNavigationPropertyName**: contactorders_AsyncOperations<br />
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactorders_MailboxTrackingFolders<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactorders_UserEntityInstanceDatas<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactorders_BulkDeleteFailures<br />
**AssociatedMenuConfiguration**:
...
**IsHierarchical**: False<br />
**IsCustomizable**: True<br />
**ReferencedEntityNavigationPropertyName**: contactorders_PrincipalObjectAttributeAccesses<br />
**AssociatedMenuConfiguration**:
