...
### Avoid using unsupported methods  
 ...
 Use the [Custom Code Validation Tool](http://go.microsoft.com/fwlink/p/?LinkId=518207) to identify code that is using unsupported methods.  
...
### See also  
 [Write Client Application Extensions](extend-client.md)   
 [Work with Customer Engagement data using web resources](work-data-using-web-resources.md)   
