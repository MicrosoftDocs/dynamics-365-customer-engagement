...
description: "The tpopic explains about how to create alternate keys for an entity. Alternate keys can be created programmatically or by using the customizations tools"
ms.custom: ""
ms.date: 10/31/2017
ms.reviewer: ""
