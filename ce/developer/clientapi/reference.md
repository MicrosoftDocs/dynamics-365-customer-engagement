...
Also, while debugging, you may find methods and objects in the Client API model that aren’t documented. Only documented objects and methods are supported.
