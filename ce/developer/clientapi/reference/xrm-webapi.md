...
|                 [execute](xrm-webapi/execute.md)                 |                 [!INCLUDE[xrm-webapi/includes/execute-description.md](xrm-webapi/includes/execute-description.md)] Supported only for the online mode ([Xrm.WebApi.online](xrm-webapi/online.md)).                |
|         [executeMultiple](xrm-webapi/executeMultiple.md)         |         [!INCLUDE[xrm-webapi/includes/executeMultiple-description.md](xrm-webapi/includes/executeMultiple-description.md)] Supported only for the online mode ([Xrm.WebApi.online](xrm-webapi/online.md)).        |
