---
title: "Grids and subgrids in Customer Engagement for Dynamics 365 for Customer Engagement| MicrosoftDocs"
ms.date: 11/10/2017
...
>[!NOTE]
>You can register for the **OnChange**, **OnRecordSelect**, and **OnSave** events using the **Events** tab of the Dynamics 365 for Customer Engagement page that is used to enable editable grids for an entity or a read-only grid.
