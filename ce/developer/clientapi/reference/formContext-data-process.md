...
- [getId](formcontext-data-process/process/getId.md)
- [getName](formcontext-data-process/process/getName.md)
- [getStages](formcontext-data-process/process/getStages.md)
- [isRendered](formcontext-data-process/process/isRendered.md)

## Stage methods 

A stage contains the data for a stage in a business process flow. Use the methods to access properties of the stage.
- [getCategory](formcontext-data-process/stage/getCategory.md)
- [getName](formcontext-data-process/process/getName.md)
- [getStages](formcontext-data-process/process/getStages.md)
- [isRendered](formcontext-data-process/process/isRendered.md)
