...
- **formContext.data.process**.[addOnStageChange](../formcontext-data-process/processmanager/addOnStageChange.md) method to add event handlers for this event.
- **formContext.data.process**.[removeOnStageChange](../formcontext-data-process/processmanager/removeOnStageChange.md) method to remove event handlers for this event. 
