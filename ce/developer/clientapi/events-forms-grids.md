...
Using the following methods to add event handler for events that cannot be associated through UI:
...
|Form [OnSave](reference/events/form-onsave.md)|**formContext.data.entity.addOnSave** and **formContext.data.entity.removeOnSave** methods|
