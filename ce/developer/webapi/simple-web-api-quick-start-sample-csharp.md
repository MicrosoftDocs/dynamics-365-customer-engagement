...
{  
    ...
    ///      https://msdn.microsoft.com/library/dn531010.aspx  
    ///     
    /// The WhoAmI Web API function is documented here:   
    ///    https://msdn.microsoft.com/library/mt607925.aspx  
    /// </remarks>  
