...
Using `$expand` system query option in the navigation properties lets you decide what data from the related entities is returned. More information: [Retrieve related entities with a query](retrieve-related-entities-query.md).
