...
> [!NOTE]
> In this documentation release, the plug-in documentation that is common to all [!INCLUDE[pn_dynamics_365](../includes/pn-dynamics-365.md)] deployment types has been moved to the [Common Data Service for Apps](https://docs.microsoft.com/en-us/powerapps/developer/common-data-service/overview) documentation set. The sub-sections that follow contain only the information specifically related to developing plug-ins for an on-premises or IFD deployment. To learn about plug-in development, start by reading the plug-in [documentation](https://docs.microsoft.com/en-us/powerapps/developer/common-data-service/apply-business-logic-with-code) under CDS for Apps, and then if you are targeting an on-premises/IFD deployment, read the sub-topics that follow this topic.
