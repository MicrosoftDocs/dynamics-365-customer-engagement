...
5.  The [EndpointSwitchRequired](https://docs.microsoft.com/dotnet/api/microsoft.xrm.sdk.client.serviceproxy`1.endpointswitchrequired) event is thrown.  
  
6.  The [EndpointSwitched](https://docs.microsoft.com/dotnet/api/microsoft.xrm.sdk.client.serviceproxy`1.endpointswitched) event is thrown.  
...
-   Write application code to check the <xref:Microsoft.Xrm.Sdk.Client.IEndpointSwitch.EndpointAutoSwitchEnabled> property value to determine whether it is set to **true**. If **true**, consider subscribing to the [EndpointSwitched](https://docs.microsoft.com/dotnet/api/microsoft.xrm.sdk.client.serviceproxy`1.endpointswitched) and [EndpointSwitchRequired](https://docs.microsoft.com/dotnet/api/microsoft.xrm.sdk.client.serviceproxy`1.endpointswitchrequired) notification events.  
