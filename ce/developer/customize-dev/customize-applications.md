...
## In This Section  
 ...
 [Use editable grids in Dynamics 365](use-editable-grids-dynamics-365.md)  
  
## Related Sections  
 [Extend Microsoft Dynamics 365](../extend-dynamics-365-server.md)  
  
 [Supported Extensions for Microsoft Dynamics 365](../supported-extensions.md)  
  
 [The Metadata and Data Models in Microsoft Dynamics 365](../metadata-data-models.md)  
  
 [Extend Microsoft Dynamics 365 on the server](../extend-dynamics-365-server.md)  
  
 [Extend Microsoft Dynamics 365 on the client](../extend-client.md)  
 ...
 [Integrate Microsoft Dynamics 365 with SharePoint](../integration-dev/integrate-sharepoint.md)  
  
 [Integrate Microsoft Dynamics 365 with OneNote](../integration-dev/integrate-onenote.md) 
