...
> For information about working with interactive dashboards using the web client, see [Configure interactive dashboards](../../customize/configure-interactive-dashboards.md).  
