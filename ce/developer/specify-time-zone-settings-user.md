...
description: "Learn about using the UserSettings entity to specify time zone settings for a user in Dynamics 365. The following attributes are exposed for the UserSettings entity related to time zone. All time zone attributes in the UserSettings entity are of Integer data type. "
ms.custom: ""
ms.date: 10/31/2017
ms.reviewer: ""
