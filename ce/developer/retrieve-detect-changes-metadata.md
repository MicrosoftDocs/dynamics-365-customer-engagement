---
title: "Retrieve and detect changes to metadata (Developer Guide for Dynamics 365 for Customer Engagement) | MicrosoftDocs"
...
- Integration tools that have to map Dynamics 365 for Customer Engagement data to external systems  
