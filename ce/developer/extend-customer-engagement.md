---
title: "Extend Dynamics 365 Customer Engagement (Developer Guide for Dynamics 365 Customer Engagement) | MicrosoftDocs"
description: "Understand the different ways you can write code to change how a Dynamics 365 Customer Engagement system works, build your own application using it, or integrate the system with other products."
ms.custom: ""
ms.date: 10/31/2017
ms.reviewer: ""
...
When you develop an application that uses the [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] server, you use Web services to communicate with the underlying xRM platform layer. [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] uses a metadata driven architecture to provide the flexibility to create custom entities and additional system entity attributes and also to make upgrades and enable transportation of solutions easier. This allows for changes in the data structure without requiring any change to code in [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)].  
 ...
 ![Dynamics 365 SDK architecture](media/crm-v5s-architecture.png "Dynamics 365 SDK architecture")  
  
## In This Section  
 [Dynamics 365 application platform - A platform for building extended Dynamics 365 (xRM) applications](building-extended-xrm-applications.md)  
 ...
 [Extend Dynamics 365 on the server](extend-customer-engagement.md)  
