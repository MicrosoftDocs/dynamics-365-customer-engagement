...
This reference includes schema changes introduced when an environment is enabled for Dynamic 365 applications. In cases where a table, column, or relationship is defined by Dataverse, the articles here will link to the Dataverse article that defines the common properties. The article here will only record what is changed.
...
To view information about all tables in your environment, see [Browse tables definitions in your environment](/power-apps/developer/data-platform/browse-your-metadata).
