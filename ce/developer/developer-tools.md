...
## In This Section
 ...
 [Download tools from NuGet](download-tools-nuget.md)<br />
...
## Related Sections  
 ...
 [Write Code for Dynamics 365 Web Services](extend-dynamics-365-server.md)<br />
 [Programming Reference for Dynamics 365](programming-reference.md)<br />
