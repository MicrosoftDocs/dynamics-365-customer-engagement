...
## In This Section  
 ...
 [KBArticleComment Entity](entities/kbarticlecomment.md)  
...
## Related Sections  
 [Knowledge base search control (client-side reference)](clientapi/reference/controls.md#knowledge-base-search-control)  
