---
title: "Write mobile and modern apps (Developer Guide for Dynamics 365 Customer Engagement)| MicrosoftDocs"
description: "Dynamics 365 Customer Engagement provides separate clients for phones and tablets which adapt to system customizations and configurations"
ms.custom: ""
ms.date: 10/31/2017
ms.reviewer: ""
...
|-----|-----|
|Task specific apps|Create rich mobile apps that merge Dynamics 365 data with data from multiple systems, such as ERP, Billing or Help Desk for a very concise mobile experience.|
|Aggregate multiple systems|Create mobile apps with a streamlined user experience which target activities people frequently perform using Dynamics 365.|
|Self-service enablement|Create mobile apps that can be used by your customers and that can feed data back directly to Dynamics 365 to enable scenarios such as event registration or loyalty program apps.|
|Device specific experiences|Create rich mobile apps for Dynamics 365 that leverage the capabilities of modern mobile devices, such as GPS, camera, biometric security, and mobile payments.|
