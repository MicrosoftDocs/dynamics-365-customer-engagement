---
title: "Create and manage custom business apps using code for Dynamics 365 for Customer Engagement | MicrosoftDocs"
...
System administrators and customizers can provide users access to these business apps using security roles; users can access only those apps that they have permission to. More information: [Business apps in Dynamics 365 for Customer Engagement](../basics/business-apps-dynamics-365.md)

In addition to creating custom business apps using the app designer, you can now programmatically create and manage custom business apps in Dynamics 365 for Customer Engagement. 
...
- **Web**:  This is the classic Dynamics 365 for Customer Engagement web browser client..
