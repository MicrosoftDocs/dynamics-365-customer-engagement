...
### [Create early bound entity classes](create-early-bound-entity-classes-code-generation-tool.md)
...
#### [Connect with Microsoft Office 365 and Dynamics 365 (online) Customer Engagement](connect-microsoft-office-365-dynamics-365-online-customer-engagement.md)
##### [Integration with Office 365](online-integration-with-office-365.md)
...
#### [Sample: Authenticate users with Microsoft Dynamics 365 web services](sample-authenticate-users-web-services.md)
## [Use Dynamics 365 web services](use-microsoft-dynamics-365-web-services.md)
### [Use Dynamics 365 Web API](use-microsoft-dynamics-365-web-api.md)
#### [Get started with Dynamics 365 Customer Engagement Web API (C#)](get-started-dynamics-365-web-api-csharp.md)
...
###### [Web API Helper code: Configuration classes](web-api-helper-code-configuration-classes.md)
###### [Web API Helper code: Authentication class](web-api-helper-code-authentication-class.md)
###### [Web API Helper code: CrmHttpResponseException class](web-api-helper-code-crmhttpresponseexception-class.md)
#### [Get started with the Dynamics 365 Customer Engagement Web API (client-side JavaScript)](get-started-web-api-client-side-javascript.md)
#### [Authenticate with the Web API](authenticate-web-api.md)
#### [Web API types and operations](web-api-types-and-operations.md)
#### [Perform operations using the Web API](perform-operations-using-web-api.md)
##### [Compose HTTP requests and handle errors](compose-http-requests-handle-errors.md)
##### [Query Data using the Web API](query-data-using-the-web-api.md)
##### [Retrieve and execute predefined queries](retrieve-and-execute-predefined-queries.md)
##### [Create an entity using the Web API](create-an-entity-using-the-web-api.md)
...
##### [Impersonate another user using the Web API](impersonate-another-user-using-web-api.md)
##### [Perform conditional operations using the Web API](perform-conditional-operations-using-web-api.md)
#### [Web API Versions](web-api-versions.md)
...
### [Use the Microsoft Dynamics 365 Organization service](use-microsoft-dynamics-365-organization-service.md)
#### [Getting started with managed code application development](get-started-managed-code-application-development.md)
##### [Start a managed code project in Visual Studio](start-managed-code-project-visual-studio.md)
#### [Use Microsoft Dynamics 365 services in code](use-microsoft-dynamics-365-services-in-code.md)
##### [Assemblies included in Dynamics 365 Customer Engagement SDK](assemblies-included-sdk.md)
...
#### [Use the Organization Service to read and write data or metadata](use-organization-service-read-write-data-metadata.md)
##### [Organization service methods](organization-service-methods.md)
##### [Use messages (request and response classes) with the Execute method](use-messages-request-and-response-classes-with-the-execute-method.md)
##### [Use ExecuteMultiple to improve performance for bulk data load](use-executemultiple-improve-performance-bulk-data-load.md)
##### [xRM messages in the Organization service](xrm-messages-organization-service.md)
##### [Organization service messages in Dynamics 365 Customer Engagement](organization-service-messages-in-dynamics-365-customer-engagement.md)
##### [Perform specialized operations using Update](perform-specialized-operations-using-update.md)
##### [Organization service entities](organization-service-entities.md)
##### [Sample: Execute multiple requests](sample-execute-multiple-requests.md)
##### [Sample: Execute multiple requests in transaction](sample-execute-multiple-requests-in-transaction.md)
#### [Use the early bound entity classes in code](use-early-bound-entity-classes-code.md)
##### [Use the OrganizationServiceContext class](use-the-organizationservicecontext-class.md)
##### [Use the early-bound entity classes for create, update, and delete](use-early-bound-entity-classes-create-update-delete.md)
##### [Use the early bound entity classes to associate records](use-early-bound-entity-classes-to-associate-records.md)
##### [Mix early and late bound entities](mix-early-and-late-bound-entities.md)
##### [Sample: Use the organization service context](sample-use-the-organization-service-context.md)
##### [Sample: Create, retrieve, update, and delete records (early bound)](sample-create-retrieve-update-and-delete-records-early-bound.md)
##### [Sample: Associate records (early bound)](sample-associate-records-early-bound.md)
##### [Sample: Create and update records with related records (early bound)](sample-create-and-update-records-with-related-records-early-bound.md)
##### [Sample: Assign a record to a new owner](sample-assign-a-record-to-a-new-owner.md)
##### [Sample: Serialize and deserialize an entity Instance](sample-serialize-deserialize-entity-instance.md)
##### [Sample: Initialize a record from an existing record](sample-initialize-record-from-existing-record.md)
##### [Sample: Retrieve license information](sample-retrieve-license-information.md)
#### [Use the late bound entity class in code](use-the-late-bound-entity-class-in-code.md)
...
##### [Sample: Create, retrieve, update, and delete (late bound)](sample-create-retrieve-update-and-delete-late-bound.md)
#### [Retrieve data with queries using SDK assemblies](retrieve-data-queries-sdk-assemblies.md)
...
###### [Order results using entity attributes with LINQ](order-results-using-entity-attributes-linq.md)
...
###### [Sample: Create a LINQ query with late binding](sample-create-linq-query-late-binding.md)
###### [Sample: Complex LINQ queries](sample-complex-linq-queries.md)
###### [Sample: Retrieve multiple with condition operators using LINQ](sample-retrieve-multiple-with-condition-operators-using-linq.md)
...
###### [Fiscal date and older than datetime query operators in FetchXML](fiscal-date-older-datetime-query-operators-fetchxml.md)
...
###### [Sample: Use FetchXML with a paging cookie](sample-use-fetchxml-with-a-paging-cookie.md)
###### [Sample: Convert queries between Fetch and QueryExpression](sample-convert-queries-between-fetch-and-queryexpression.md)
...
###### [Use the ConditionExpression class](use-the-conditionexpression-class.md)
###### [Use the FilterExpression class](use-the-filterexpression-class.md)
...
###### [Sample: Retrieve multiple with the QueryByAttribute class](sample-retrieve-multiple-with-the-querybyattribute-class.md)
###### [Sample: Retrieve multiple with the QueryExpression class](sample-retrieve-multiple-with-the-queryexpression-class.md)
...
##### [Retrieve records for many-to-many relationships using intersect entities](retrieve-records-for-many-to-many-relationships-using-intersect-entities.md)
...
###### [Sample: Retrieve records from an intersect table](sample-retrieve-records-from-an-intersect-table.md)
...
#### [Offline use of services](offline-use-services.md)
#### [Troubleshooting and error handling](troubleshooting-error-handling.md)
##### [Handle exceptions in your code](handle-exceptions-in-your-code.md)
...
##### [Helper code: DeviceIdManager class](helper-code-deviceidmanager-class.md)
...
#### [Subscribe to SDK assembly updates using NuGet](subscribe-sdk-assembly-updates-using-nuget.md)
#### [Impersonate another user](impersonate-another-user.md)
##### [Sample: Impersonate using the ActOnBehalfOf privilege](sample-impersonate-actonbehalfof-privilege.md)
#### [Synchronize Dynamics 365 data with external systems](synchronize-dynamics-365-data-with-external-systems.md)
##### [Use an alternate key to create a record](use-an-alternate-key-to-create-a-record.md)
...
##### [Sample: Insert or update a record using Upsert](sample-insert-or-update-a-record-using-upsert.md)
...
### [Use Discovery service](use-discovery-service.md)
#### [Discover the URL for your organization using the Web API](discover-url-organization-web-api.md)
#### [Discover the URL for your organization using the Organization Service](discover-url-organization-organization-service.md)
##### [Discovery Service methods](discovery-service-methods.md)
...
##### [Sample: Access the Discovery service](sample-access-the-discovery-service.md)
## [Build Windows client applications using the XRM tools](build-windows-client-applications-xrm-tools.md)
### [Use connection strings in XRM tooling to connect](use-connection-strings-xrm-tooling-connect.md)
### [Use CrmServiceClient constructors to connect](use-crmserviceclient-constructors-connect.md)
### [Use PowerShell cmdlets for XRM tooling to connect](use-powershell-cmdlets-xrm-tooling-connect.md)
### [Use XRM tooling to execute actions](use-xrm-tooling-execute-actions.md)
#### [Use XRM tooling to create data](use-xrm-tooling-create-data.md)
#### [Use XRM tooling to retrieve data](use-xrm-tooling-retrieve-data.md)
#### [Use XRM tooling to update data](use-xrm-tooling-update-data.md)
#### [Use XRM tooling to delete data](use-xrm-tooling-delete-data.md)
#### [Use messages with the ExecuteCrmOrganizationRequest method](use-messages-executecrmorganizationrequest-method.md)
### [Use XRM tooling with classes generated using the code-generation tool](use-xrm-tooling-classes-generated-code-generation-tool.md)
### [Use the XRM tooling common login control in your client applications](use-xrm-tooling-common-login-control-client-applications.md)
### [Configure tracing for XRM tooling](configure-tracing-xrm-tooling.md)
...
### [Sample: Windows 8 desktop modern OData app](sample-windows-8-desktop-modern-odata-app.md)
### [Sample: Android Activity Tracker for Dynamics 365 and Web API](sample-android-activity-tracker-web-api.md)
### [Sample: Android Activity Tracker](sample-android-activity-tracker.md)
### [Sample: iOS Activity Tracker for Dynamics 365 and Web API](sample-ios-activity-tracker-web-api.md)
### [Sample: iOS Activity Tracker](sample-ios-activity-tracker.md)
### [Sample: Windows Activity Tracker](sample-windows-activity-tracker.md)
### [Sample: Windows Dynamics CRM to Go](sample-windows-dynamics-365-crm.md)
...
### [Use the Web API with metadata](use-web-api-metadata.md)
...
### [Use the Organization service with metadata](use-organization-service-metadata.md)
...
##### [Create and update an entity to send email activities to records](create-update-entity-emailed.md)
...
##### [Sample: Create and update entity metadata](sample-create-update-entity-metadata.md)
...
##### [Work with attribute metadata](work-attribute-metadata.md)
...
##### [Sample: Work with attribute metadata](sample-work-attribute-metadata.md)
...
##### [Sample: Convert date and time behavior](sample-convert-date-time-behavior.md)
#### [Define alternate keys for an entity](define-alternate-keys-entity.md)
#### [Customize entity relationship metadata](customize-entity-relationship-metadata.md)
##### [Create and retrieve entity relationships](create-retrieve-entity-relationships.md)
...
##### [Sample: Create and retrieve entity relationships](sample-create-retrieve-entity-relationships.md)
...
##### [Sample: Query metadata and detect changes](sample-query-metadata-detect-changes.md)
...
##### [Create a custom workflow activity](create-custom-workflow-activity.md)
##### [Add metadata to a custom workflow activity](add-metadata-custom-workflow-activity.md)
##### [Use the IOrganization web service in a custom workflow activity](use-iorganization-web-service-custom-workflow-activity.md)
##### [Register and use a custom workflow activity assembly](register-use-custom-workflow-activity-assembly.md)
##### [Debug a custom workflow activity](debug-custom-workflow-activity.md)
...
#### [Create web resources and IFrame content for use with the Dynamics 365 for tablets client](create-web-resources-iframe-content-dynamics-365-tablets.md)
...
#### [Image (JPG, PNG, GIF, ICO) web resources](image-jpg-png-gif-ico-web-resources.md)
...
#### [Ribbons available in Microsoft Dynamics 365](customize-dev/ribbons-available-microsoft-dynamics-365.md)
...
#### [Pass Microsoft Dynamics 365 data from a page as a parameter to Ribbon Actions](customize-dev/pass-dynamics-365-data-page-parameter-ribbon-actions.md)
...
### [Create packages for the Dynamics 365 Package Deployer](create-packages-package-deployer.md)
...
### [Sample: Create and retrieve Outlook filters](sample-create-retrieve-outlook-filters.md)
### [Sample: Use Dynamics 365 for Outlook methods](sample-outlook-methods.md)
...
## [Create and manage business apps](create-manage-business-apps-customer-engagement.md)
...
#### [Use Parature knowledge in Dynamics 365](use-parature-knowledge.md)
#### [Sample: Search and retrieve articles](sample-search-retrieve-articles.md)
#### [Sample: Create and associate knowledge base record to incident](sample-create-associate-knowledge-base-record-incident.md)
...
#### [Sample: Promote an email message to Microsoft Dynamics 365](sample-promote-email-message.md)
...
### [Ignore blank values and inactive records](ignore-blank-values-and-inactive-records-in-duplicate-detection.md)
...
### [Sample: Bulk delete records that match common criteria](sample-bulk-delete-records-that-match-common-criteria.md)
...
### [Sample: Export and import a data map](sample-export-and-import-a-data-map.md)
...
### [Create a virtual entity data provider](virtual-entities/create-ve-data-provider.md)
...
## [Web API Reference](webapireference/TOC.md)
...
-->
# [Online Management API for Customer Engagement](online-management-api.md)
## [Get started with Online Management API](online-management-api/get-started-online-management-api.md)
## [Authenticate to use Online Management API](online-management-api/authentication.md)
### [Sample: Authentication helper for Online Management API](online-management-api/sample-authentication-helper.md)
## [Operations supported by Online Management API](online-management-api/operations-supported.md)
## [Quick Start Sample: Retrieve instances in your tenant](online-management-api/sample-quick-start.md)
