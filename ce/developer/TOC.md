...
## [Organization Service 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-general)
## [XRM Tooling 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-xrmtooling)
## [Virtual Entity 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-virtualentity)
## [Workflow 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-workflow)
## [Package Deployer 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-packagedeployer)
## [Outlook Client 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-outlookclient)
## [Deployment Service 9.0](https://docs.microsoft.com/dotnet/api/?view=ce-9-deployment)
