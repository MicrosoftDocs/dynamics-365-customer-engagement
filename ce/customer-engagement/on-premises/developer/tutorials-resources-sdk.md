...
description: "This topic lists the walkthroughs that are included in the SDK, and tells you where to find videos, training, and sample code to get you started with development for Dynamics 365 Customer Engagement (on-premises) (online)."
ms.custom: 
ms.date: 03/29/2019
ms.reviewer: pehecke
...
|                           Category                            |                                                                              Link                                                                               |
|---------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|
|                          Quick Start                          |                                     [Run a Simple Program Using Dynamics 365 Customer Engagement (on-premises) Web Services](simple-program-web-services.md)                                      |
|                        App Development                        |                         [Walkthrough: Register a Dynamics 365 Customer Engagement (on-premises) app with Active Directory](walkthrough-register-app-active-directory.md)                          |
...
- [Dynamics 365 Customer Engagement (on-premises) Development Forum](https://social.microsoft.com/Forums/en-US/home?forum=crmdevelopment)
- [Dynamics 365 Customer Engagement (on-premises) Team Blog](http://blogs.msdn.com/b/crm/)
...
- [Dynamics 365 Customer Engagement (on-premises) Documentation](https://docs.microsoft.com/en-us/dynamics365/)
- [Dynamics 365 Customer Engagement (on-premises) pre-sales information](http://www.microsoft.com/dynamics/default.aspx)
- [Dynamics 365 Customer Engagement (on-premises): Deployment Forum](http://social.microsoft.com/Forums/crmdeployment/home/)
- [Certification Training](https://www.microsoft.com/learning/en-us/dynamics-certification.aspx)
- [Contact Dynamics 365 Customer Engagement (on-premises) Customer Support](http://go.microsoft.com/fwlink/p/?LinkID=394391)
- [Dynamics 365 Customer Engagement (on-premises) on Facebook](https://www.facebook.com/msftdynamics)
- [Dynamics 365 Customer Engagement (on-premises) group on Linkedin](https://www.linkedin.com/groups/21231)
- [Dynamics 365 Customer Engagement (on-premises) on Twitter](https://twitter.com/MSFTDynamics365)
