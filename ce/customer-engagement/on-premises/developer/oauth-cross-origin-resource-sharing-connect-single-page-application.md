...
You can create a Single Page Apps (SPAs) which uses [!INCLUDE[pn_JavaScript](../includes/pn-javascript.md)] to work with Dynamics 365 Customer Engagement (on-premises) data. To provide this, Cross-Origin Resource Sharing (CORS) is enabled so that your SPAs can bypass browser restrictions that normally prevent requests that cross domain boundaries.  
...
3. Set configuration variables in your SPA with information from that registration.  
   ...
   - The URL to your Dynamics 365 Customer Engagement (on-premises) organization  
