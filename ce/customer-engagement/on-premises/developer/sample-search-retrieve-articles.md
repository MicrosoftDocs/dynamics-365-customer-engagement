---
title: "Sample: Search and retrieve articles (Developer Guide for Dynamics 365 for Customer Engagement (on-premises))| MicrosoftDocs"
...
This sample code is for Dynamics 365 for Customer Engagement (on-premises). Download the complete sample from [Sample: Work with Service entities](https://code.msdn.microsoft.com/Service-Samples-f42adf82).
