...
description: "Learn to run a simple program using Dynamics 365 Customer Engagement (on-premises) web services."
ms.custom: 
ms.date: 03/29/2019
ms.reviewer: pehecke
...
### See also  
 ...
 [Sample: Quick Start for Dynamics 365 Customer Engagement (on-premises)](sample-quick-start.md)   
