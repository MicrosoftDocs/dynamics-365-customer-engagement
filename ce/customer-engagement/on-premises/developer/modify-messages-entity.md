...
When you customize system entity or system attribute display names, some messages displayed by [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] will reference the default display names. Edit the default messages to match your customized display names.  
