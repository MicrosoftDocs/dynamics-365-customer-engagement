...
search.app: 
  - D365CE
---
# Use the Dynamics 365 Customer Engagement (on-premises) (on-premises) Discovery services
...
### See also  
 [Use Dynamics 365 Customer Engagement (on-premises) web services](use-microsoft-dynamics-365-web-services.md)<br />
 [Use Dynamics 365 Customer Engagement (on-premises) Web API](webapi/index.md)<br />
 [Use Dynamics 365 Customer Engagement (on-premises) Organization Service](org-service/index.md)<br />
