...
## Delete user data
Your privacy is important to us. You can remove Dynamics 365 Customer Engagement (on-premises) personal data from Microsoft Teams.

The following data is stored with Dynamics 365 Customer Engagement (on-premises) integration with Microsoft Teams.
...
You can [contact support](../admin/contact-technical-support.md) to request data deletion. Run the following Windows PowerShell commands to gather the information needed by Dynamics 365 Customer Engagement (on-premises) support.
...
Record this information to provide to Dynamics 365 Customer Engagement (on-premises) support.
