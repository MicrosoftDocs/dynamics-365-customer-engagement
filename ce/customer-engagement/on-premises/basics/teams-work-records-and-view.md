...
## Open a record or view in Dynamics 365 Customer Engagement (on-premises) apps

It's easy to use Teams to open a record or view in Dynamics 365 Customer Engagement (on-premises) apps. From the Dynamics 365 tab pinned in a Teams channel, select the **Go to website** button to open the record or view in Dynamics 365 Customer Engagement (on-premises) apps.

> [!div class="mx-imgBorder"] 
> ![Open a record in Dynamics 365 Customer Engagement (on-premises) apps](media/teams-open-record-d365.png "Open a record in Dynamics 365 Customer Engagement (on-premises) apps")
...
When there is more than one Microsoft Teams channel connected to a Dynamics 365 Customer Engagement (on-premises) apps record, each of the channels appears as a separate document location in Dynamics. You can switch to a different location by selecting **Document Location** to specify the location of the file.
