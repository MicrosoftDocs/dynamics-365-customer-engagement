...
Easily pin a Dynamics 365 Customer Engagement (on-premises) record or view to a Teams channel using the **Collaborate** option in the Dynamics 365 app. The step-by-step process will help you connect the selected record or view to a Teams channel.

The [basic collaboration experience](teams-collaboration.md) only lets you pin records to a Teams channel from within Teams. The enhanced collaboration experience lets you pin a record or a view of records to a Teams channel while you are working in Dynamics 365 Customer Engagement (on-premises).
...
## Pin a Dynamics 365 Customer Engagement (on-premises) record or view to a Teams channel
...
4. To pin the record to an exising team or a new team, do one of the following:
 ...
 > [!NOTE]
 >  You will only see the next step only if you pin a record and you are the owner of the Teams channel. If you pin a view  of Dynamics 365 Customer Engagement (on-premises) records, then you will not see the next step.
