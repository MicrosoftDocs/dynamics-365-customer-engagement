...
[!INCLUDE[pn_crm_online](../includes/pn-crm-online.md)] offers a number of tools for collaboration. Through integration with other Microsoft collaboration tools, users of Dynamics 365 Customer Engagement (on-premises) apps can work closely with team members, even if they are not also users of the Dynamics 365 Customer Engagement (on-premises) apps.
...
- **[!INCLUDE[pn_onenote](../includes/pn-onenote.md)]** - Access notes stored in [!INCLUDE[pn_onenote](../includes/pn-onenote.md)]. See [Use OneNote in Dynamics 365 Customer Engagement (on-premises) apps](../basics/use-onenote.md).
...
### See Also
 ...
 [Office 365 Groups in Dynamics 365 Customer Engagement (on-premises) apps FAQs](../basics/office-365-groups-dynamics-365-faqs.md)  
