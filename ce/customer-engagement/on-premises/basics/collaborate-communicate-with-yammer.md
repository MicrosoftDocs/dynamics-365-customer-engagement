...
To set up Yammer to work with Dynamics 365 Customer Engagement (on-premises) apps, see [Connect Dynamics 365 Customer Engagement (on-premises) apps to Yammer](../admin/connect-yammer.md).
...
- **Colleagues receive updates on your customer interactions automatically**. When you create a new lead, convert it to an opportunity, close it, and so on, Yammer displays this news in your organization’s newsfeed automatically.  
...
### See also  
 [Connect Dynamics 365 Customer Engagement (on-premises) apps to Yammer](../admin/connect-yammer.md)   
