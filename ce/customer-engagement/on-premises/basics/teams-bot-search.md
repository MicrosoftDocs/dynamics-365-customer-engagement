...
ms.custom: 
description: "Use the bot to interact with Dynamics 365 Customer Engagement (on-premises)."
ms.date: 04/30/2019
ms.reviewer: 
...
The Dynamics 365 app for Teams bot feature allows you search Dynamics 365 Customer Engagement (on-premises) records within Microsoft Teams conversations.
...
## Post
Create a post in Dynamics 365 Customer Engagement (on-premises).
