...
3. Common Data Service and Customer Engagement (on-premises) apps load the information for the specified entity into a web form that is displayed in the browser window.  
