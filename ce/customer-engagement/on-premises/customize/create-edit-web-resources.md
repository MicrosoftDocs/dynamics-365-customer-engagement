...
> [!TIP]
> 
> For an in-depth discussion of web resources, see [Web resources for Customer Engagement apps](../developer/web-resources). For information on web resource dependencies added in [!INCLUDE [pn-crm-9-0-0-online](../includes/pn-crm-9-0-0-online.md)], see [Web resource dependencies](../developer/web-resources).
