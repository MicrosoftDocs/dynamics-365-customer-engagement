1. From your Viva dashboard, select **Open** under **Remote Assist**. From the Teams Field Service **Home** page, select **Launch website** under **Remote Assist support tool**. Or, while in the details of a work order, select **Launch Remote Assist**.
