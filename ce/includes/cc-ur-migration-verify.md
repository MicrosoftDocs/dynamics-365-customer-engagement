After you've successfully migrated the configuration data related to unified routing from the source to target organization, do the following  in your target organization:
