> [!NOTE]
> This tool is available by default on the following MCP servers: [Dynamics 365 Sales](/dynamics365/customer-service/administer/configure-customer-service-mcp-server).
