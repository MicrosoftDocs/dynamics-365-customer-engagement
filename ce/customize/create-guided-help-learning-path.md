---
title: "Create your own guided help (Learning Path) in Dynamics 365 Customer Engagement | MicrosoftDocs"
description: ""
keywords: ""
author: udag
ms.author: udag
...
## How is Learning Path different from customizable Help?  
 Customizable Help allows you to override the default [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] Help and point users in your organization to a different URL for Help. Or you can override the Help for a highly-customized entity so that you can better describe your workflow.  
  
 [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)] lets you add customizable Help that users see in [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] when they open a page, perform an action, or click the Help button ?.  
...
-   Have [!INCLUDE[pn_crm_8_2_0_online](../includes/pn-crm-8-2-0-online.md)] installed. Note that users can view the [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)] content created by Microsoft if they have [!INCLUDE[pn_crm_8_1_0_online_subsequent](../includes/pn-crm-8-1-0-online-subsequent.md)] or later installed, but you must have the [!INCLUDE[pn_crm_8_2_0_online](../includes/pn-crm-8-2-0-online.md)] to author [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)] content.  
...
-   Have opted in for [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)]. This setting is on by default, but can be turned off.  
     ...
     For more information, see [On-off switch for Learning Path (guided help)](On-off%20switch%20for%20Learning%20Path%20\(guided%20help\).md).  
...
-   Be a member of the [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)][!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)] Authors security group.  
 ...
 At this time, these clients support [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)]: web client, interactive service hub, and [!INCLUDE[pn_moca_short](../includes/pn-moca-short.md)] .  
...
1.  Go to the admin portal for your [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] tenant by clicking  the **Navigate to other applications** (waffle) button in the top-left corner of the page when you're signed in to [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)], and then select **Admin**.  
...
## Learning Path and Dynamics 365 security roles  
 ...
 For more information about security roles, see [Security roles and privileges](https://technet.microsoft.com/library/dn531090.aspx).  
...
<a name="MobileApp"></a>   
## Create Learning Path controls for the mobile app  
 You can create [!INCLUDE[pn_learning_path](../includes/pn-learning-path.md)] controls for the[!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] mobile app the same way you create controls for the web client. To do this you must use the mobile app simulator in a web browser so that you have access to the mobile UI for pinning your Learning Path controls. This simulator is to be used only for this purpose.  
...
-   Directly open it by entering a URL in your browser.  
 ...
 For more information about the Interactive Service Hub, see [Interactive service hub – User’s guide](https://go.microsoft.com/fwlink/p/?linkid=846978)  
...
## Localize Learning Path controls  
 ...
 For more information about user language settings in [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)], see [Set personal options - legacy](../basics/set-personal-options-legacy.md).  
...
### See also  
 [On-off switch for Learning Path (guided help)](On-off%20switch%20for%20Learning%20Path%20\(guided%20help\).md)
