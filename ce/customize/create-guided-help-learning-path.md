---
title: "Create your own guided help (Learning Path) (Dynamics 365 for Customer Engagement) | MicrosoftDocs"
description: ""
keywords: ""
ms.date: 10/25/2017
...
> [!NOTE]
> Learning Path is currently not available on Microsoft Dynamics 365 for Customer Engagement Germany. However, it will be made available over time. Please check back for the latest information.
...
## Learning Path and Dynamics 365 for Customer Engagement security roles  
...
-   Select the **training** tile on the site map, and then select **Content Library**.  
     ...
     ![Content Library icon on the Dynamics 365 for Customer Engagement sitemap](../customize/media/lp-sitemap-content-library.png "Content Library icon on the Dynamics 365 for Customer Engagement site map")  
...
4. Enter a name, and select the other settings for the Guided Task. Use this table for reference.  
   ...
   |   **Dynamics 365 for Customer Engagement security role**   |                                                                                                                                                                                                                                                                                                                                                                                                  Select the security role(s) for which you want the Guided Task to be displayed. You can select as many roles as you want. If a user is assigned more than one role, the Guided Task will appear only for the role with the highest precedence, as described earlier in this topic.                                                                                                                                                                                                                                                                                                                                                                                                   |
...
4. Enter a name, and then select the other settings for the Sidebar. Use this table for reference.  
   ...
   | **Dynamics 365 for Customer Engagement  security role** |                                                                                                                                                                                                                  Select the role or roles for which you want the Sidebar to be displayed to users. You can select as many roles as you want. If a user is assigned more than one role, the Sidebar will be displayed only for the role with the highest precedence, as described earlier in this topic.                                                                                                                                                                                                                   |
