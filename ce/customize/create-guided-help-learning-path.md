...
## How is Learning Path different from customizable Help?  
 ...
 <!-- 
 You can use customizable Help or Learning Path, but not both.  
 --> 
...
## Create Learning Path controls for the Interactive Service Hub  
 If your organization uses the Interactive Service Hub, you can also create your own Learning Path controls for the Interactive Service Hub  interface. To create controls, you can display the Interactive Service Hub interface in your browser, and then access the Content Library to create or edit controls just like you would for  the web interface.  
...
-   Directly open it by entering a URL in your browser.  
 ...
 For more information about the Interactive Service Hub, see [Interactive service hub – User guide](../customer-service/interactive-service-hub-users-guide.md)  
-->
...
-   If a sidebar is displayed, click the Learning Path icon on the sidebar.  
  
-   If there is no sidebar displayed, click the **Help** icon in the top-right corner of the page, and then click the Learning Path icon on the sidebar that is displayed.  
...
In-app support administrators can perform the additional task of escalating issues to Microsoft Support. 
