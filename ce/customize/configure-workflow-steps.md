---
title: "Configure workflow steps in Dynamics 365 Customer Engagement | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
|**Custom Step**|Developers can create custom workflow steps that define actions. There are no custom steps available in [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] by default.|  
...
|**Custom Step**|Developers can create custom workflow steps that define conditions. There are no custom steps available in [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] by default.|  
...
### See also  
 [Types of processes](../customize/guide-staff-through-common-tasks-processes.md)   
