---
title: "Use custom controls for data visualizations (Dynamics 365 Customer Engagement) | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
1.  Open a record where you want to add a custom control, such as an Opportunity record.  
  
2.  On the actions toolbar, click **Form** to open the form editor.  
  
3.  In the form editor, double-click the field where you want to add a custom control, or add a new field, such as the **Budget Amount** field.  
  
4.  On the **Field Properties** page, click the **Controls** tab, and then click **Add Control**.  
  
5.  On the Add Control page, select the control that you want, such as the **Linear Slider** control shown here, and then click **Add**.  
...
7.  Click the ![Edit custom control property icon](../customize/media/ccf-pencil-icon.png "Edit custom control property icon") pencil icon next to **Min**, **Max**, and **Step**, set the property option described below, and then click **OK**.  
...
8.  Click **OK**, to close the Field Properties page.  
  
9. To activate the customization, on the entity form click **Save**, and then click **Publish**.  
  
10. Click **Save and Close** to close the form editor.  
