...
With [!INCLUDE [pn-powerapps](../includes/pn-powerapps.md)] and [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)], custom business apps comprises of components such as entities, dashboards, forms, views, charts, and business processes.  
