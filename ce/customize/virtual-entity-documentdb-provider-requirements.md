...
This table indicates the data type mappings for the [!INCLUDE [cc-docdb-api-short](../includes/cc-docdb-api-short.md)] document in the *Orders* collection with [!INCLUDE [pn-powerapps](../includes/pn-powerapps.md)] data types.

|[!INCLUDE [cc-docdb-api-short](../includes/cc-docdb-api-short.md)] Data  | [!INCLUDE [pn-powerapps](../includes/pn-powerapps.md)] Data Type  |
|---------|---------|
|id     |     Primary Key    |
...
> - Attributes that are configured as optional in the [!INCLUDE [cc-docdb-api-short](../includes/cc-docdb-api-short.md)] document and are mapped in [!INCLUDE [pn-powerapps](../includes/pn-powerapps.md)] as **Business Required** will cause a runtime error.
