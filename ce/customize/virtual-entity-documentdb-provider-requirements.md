...
> - Attributes that are missing in the [!INCLUDE [cc-docdb-api-short](../includes/cc-docdb-api-short.md)] document and are mapped in [!INCLUDE [pn-crm-shortest](../includes/pn-crm-shortest.md)] as **Business Required** will cause a runtime error.
