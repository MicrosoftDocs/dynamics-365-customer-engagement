---
title: "Set custom icon for custom Case Origin field in Dynamics 365 Customer Engagement | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
manager: "brycho"
---
# Set custom icon in views for Case Origin field
In [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] you can set a custom icon to display in views where the Case Origin field is visible.  
