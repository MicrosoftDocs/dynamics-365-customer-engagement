...
> [!IMPORTANT]
> The option to add iFrames and web resources support for phones was introduced in the July 2017 update for Dynamics 365 (online).
  
# Known issues  
  
-   You can’t use popups for authentication or other purposes from within iFrames and web resources on Dynamcis 365 for mobile.  
  
-   Authentication for embedded sites isn’t available.  
  
-   Errors and memory leaks in iFrames and web resources can cause Dynamcis 365 for mobile to stop responding, and can cause client side data loss.  
  
-   Some iFrames and web resources can adversely affect application performance.  
  
- [!INCLUDE[pn_MS_Silverlight_full](../includes/pn-ms-silverlight-full.md)] and image web resources aren’t available on Dynamcis 365 for mobile.  
