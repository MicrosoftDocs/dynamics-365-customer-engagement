---
title: "Deploy Microsoft Dynamics 365 for Customer Engagement for Outlook by using Group Policy | MicrosoftDocs"
ms.custom: ""
ms.date: 11/28/2016
ms.reviewer: ""
...
search.app: 
  ...
  - D365Outlook
---
# Deploy Microsoft Dynamics 365 for Customer Engagement for Outlook by using Group Policy
...
## Preparing Dynamics 365 for Customer Engagement for Outlook for a Group Policy deployment  
...
3. Create the Group Policy Object (GPO) and target the application to [!INCLUDE[pn_microsoftcrm](../../includes/pn-microsoftcrm.md)] users. To do this, follow these steps:  
   ...
   3. In the **New GPO** dialog, type a name for the GPO, such as *Microsoft Dynamics 365 for Customer Engagement Users*, and then click **OK**.  
