---
title: "Install Microsoft Dynamics 365 for Customer Engagement for Outlook for desktop virtualization | MicrosoftDocs"
ms.custom: ""
ms.date: 11/28/2016
ms.reviewer: ""
...
search.app: 
  ...
  - D365Outlook
---
# Install Microsoft Dynamics 365 for Customer Engagement for Outlook for desktop virtualization
...
### Deploy Dynamics 365 for Customer Engagement for Outlook to use as a Remote Desktop Services application  
...
3. Run the [!INCLUDE[pn_Configuration_Wizard_long](../../includes/pn-configuration-wizard-long.md)] on the [!INCLUDE[pn_Remote_Desktop_Services](../../includes/pn-remote-desktop-services.md)] server. For instructions, see [Install Dynamics 365 for Customer Engagement for Outlook](install.md).  
...
### Disable the Dynamics 365 for Customer Engagement for Outlook Configuration Wizard  
  
> [!NOTE]
>  The information in this topic applies to [!INCLUDE[pn_crm_for_outlook_short](../../includes/pn-crm-for-outlook-short.md)] deployments that use [!INCLUDE[pn_Remote_Desktop_Services](../../includes/pn-remote-desktop-services.md)]. To remove only the **Get Dynamics 365 for Customer Engagement for Outlook** button for [!INCLUDE[pn_crm_for_outlook_short](../../includes/pn-crm-for-outlook-short.md)] deployments that don’t use [!INCLUDE[pn_Remote_Desktop_Services](../../includes/pn-remote-desktop-services.md)], see the “Set whether users see Dynamics 365 for Customer Engagement for Outlook message” setting in [System Settings dialog box - Outlook tab](../../admin/system-settings-dialog-box-outlook-tab.md).
...
## Support for Citrix XenApp 6.5 and 7.0-7.18 session virtualization for Microsoft Dynamics 365 for Customer Engagement for Outlook on a single XenApp instance  
...
### See Also  
 [Install or upgrade language packs for Microsoft Dynamics 365 for Customer Engagement](https://technet.microsoft.com/library/hh699674.aspx)   
 [Planning and installing Dynamics 365 for Customer Engagement for Outlook for Microsoft Dynamics 365 for Customer Engagement and Dynamics 365 for Customer Engagement Online](planning-installing.md)
