---
title: "How field security affects synchronization between Dynamics 365 for Customer Engagement apps and Dynamics 365 for Outlook | MicrosoftDocs"
ms.custom: 
ms.date: 11/28/2016
ms.reviewer: 
...
search.app: 
  ...
  - D365Outlook
---
# How field security affects synchronization between Dynamics 365 for Customer Engagement apps and Dynamics 365 for Outlook
...
> 2. Change the sync direction so that sync does not attempt to update or write the field during synchronization. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Control field synchronization between Dynamics 365 for Customer Engagement apps and Outlook or Exchange](control-field-synchronization.md)  
...
### Set field level security  
 ...
 ![Job Title field in Microsoft Dynamics 365 for Customer Engagement apps](../media/crm-itpro-jobtitlefield.png "Job Title field in Microsoft Dynamics 365 for Customer Engagement apps")  
...
### Create and configure a field security profile  
 ...
 ![Field Security Profile in Dynamics 365 for Customer Engagement apps](../media/crm-itpro-fieldsecurityprofile.png "Field Security Profile in Dynamics 365 for Customer Engagement apps")  
...
### Set field permissions  
 ...
 ![Edit Field Security form in Dynamics 365 for Customer Engagement apps](../media/crm-itpro-editfieldsecurity.png "Edit Field Security form in Dynamics 365 for Customer Engagement apps")  
...
### What the user sees  
 ...
 ![Contact Rene Valdes form in Dynamics 365 for Customer Engagement apps](../media/crm-itpro-contactrenevaldes.png "Contact Rene Valdes form in Dynamics 365 for Customer Engagement apps")  
 ...
 ![Rene contact with no Job Title in Dynamics 365 for Customer Engagement apps](../media/crm-itpro-contactnojobtitle.png "Rene contact with no Job Title in Dynamics 365 for Customer Engagement apps")  
 ...
 ![Contact with Job Title form in Dynamics 365 for Customer Engagement apps](../media/crm-itpro-contactwithjobtitle.png "Contact with Job Title form in Dynamics 365 for Customer Engagement apps")  
