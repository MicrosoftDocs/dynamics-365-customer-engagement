...
### Automatic email tagging off by default  
 This setting is in the Microsoft Dynamics 365 for Customer Engagement Diagnostics tool included with [!INCLUDE[pn_crm_for_outlook_short](../../includes/pn-crm-for-outlook-short.md)]. Click **Start** > **All Programs** > **Microsoft Dynamics 365 for Customer Engagement** > **Diagnostics** > **Synchronization Troubleshooting** tab.  
...
## Microsoft Dynamics 365 for Customer Engagement (online) with Office 365  
