...
5. Choose **OK** > **OK** to close the open dialog boxes.  
   ...
   Let your users know they can view (not change) the synchronization settings. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Which fields can be synchronized between Dynamics 365 for Customer Engagement and Outlook?](which-fields-synchronized.md)  
