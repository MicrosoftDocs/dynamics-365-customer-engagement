...
- Control whether a specific pair of fields is synchronized:  
  ...
  For more information about controlling field synchronization, see [Control field synchronization between Dynamics 365 apps and Dynamics 365 for Outlook](../admin-guide/control-field-synchronization.md)
