---
title: "Control field synchronization between Dynamics 365 for Customer Engagement apps and Outlook or Exchange | MicrosoftDocs"
ms.custom: 
ms.date: 01/11/2016
ms.reviewer: 
...
search.app: 
  ...
  - D365Outlook
---
# Control field synchronization between Dynamics 365 for Customer Engagement apps and Outlook or Exchange
...
- Control whether a specific pair of fields is synchronized:  
  ...
  For more information about controlling field synchronization, see [Control field synchronization between Dynamics 365 for Customer Engagement apps and Dynamics 365 for Outlook](../admin-guide/control-field-synchronization.md)
...
### See also  
 ...
 [How field security affects synchronization between Dynamics 365 for Customer Engagement apps and Dynamics 365 for Outlook](../admin-guide/field-security-synchronization.md)
