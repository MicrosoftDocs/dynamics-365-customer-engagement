...
## Using the Track button vs. the Set Regarding button  
 ...
 ![Two Tracking and Set Regarding buttons in Dynamics 365 for Customer Engagement](../media/tracking-and-set-regarding-buttons.png "Two Tracking and Set Regarding buttons in Dynamics 365 for Customer Engagement")  
...
- Whether email addresses, names, or distribution lists in an email message are [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] records  
  ...
  ![Tracking Pane with Set Regarding record in Dynamics 365 for Customer Engagement](../media/tracking-pane.png "Tracking Pane with Set Regarding record in Dynamics 365 for Customer Engagement")  
...
|                            Open the record directly in [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)]                             |           ![View in Dynamics 365 for Customer Engagement button image in Dynamics 365 for Customer Engagement](../media/view-crm-button.png "View in Dynamics 365 for Customer Engagement button image in Dynamics 365 for Customer Engagement")            | Email, appointments, contacts, and tasks |
| Add a connection between the record and any [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] record capable of tracking connections |              ![Add Connection button image in Dynamics 365 for Customer Engagement](../media/add-connection-button.png "Add Connection button image in Dynamics 365 for Customer Engagement")               | Email, appointments, contacts, and tasks |
|                Convert the record into a [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] opportunity, lead, or case                |                      ![Convert To button image in Dynamics 365 for Customer Engagement](../media/convert-button.png "Convert To button image in Dynamics 365 for Customer Engagement")                      |      Email, appointments, and tasks      |
...
|                          Insert a [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] Knowledge base article                           |              ![Insert Article button image in Dynamics 365 for Customer Engagement](../media/insert-article-button.png "Insert Article button image in Dynamics 365 for Customer Engagement")               |                  Email                   |
|                              Attach [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] sales literature                               | ![Attach Sales Literature button image in Dynamics 365 for Customer Engagement](../media/attach-sales-literature-button.png "Attach Sales Literature button image in Dynamics 365 for Customer Engagement") |                  Email                   |

> [!TIP]
>  If these buttons aren’t available, it may be that the record marked to be tracked isn’t synchronized yet. This can happen if your organization uses server-side synchronization to synchronize email, appointments, contacts, and tasks, but the synchronization hasn’t happened yet. If the **View in Dynamics 365 for Customer Engagement** button is enabled, the record has been synchronized. You can also use the tracking pane (as described previously) to determine whether the record has been synchronized.  
