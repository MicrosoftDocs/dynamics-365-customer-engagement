...
> - The offline capability in [!INCLUDE[pn_crm_for_outlook_short](../../includes/pn-crm-for-outlook-short.md)] version 9.0 isn't available in [Dynamics 365 Customer Engagement (on-premises), version 9.x](../../customer-engagement/on-premises/overview.md).
