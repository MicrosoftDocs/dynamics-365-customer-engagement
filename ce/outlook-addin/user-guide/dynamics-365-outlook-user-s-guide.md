...
> - The offline capability in [!INCLUDE[pn_crm_for_outlook_short](../../includes/pn-crm-for-outlook-short.md)] version 9.0 won’t be available in Dynamics 365 Customer Engagement (on-premises), version 9.x.
