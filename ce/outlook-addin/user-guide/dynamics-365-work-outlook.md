---
title: "Do your Dynamics 365 for Customer Engagement work in Outlook using Dynamics 365 for Customer Engagement for Outlook | MicrosoftDocs"
ms.custom: ""
ms.date: 01/11/2016
ms.reviewer: ""
...
search.app: 
  ...
  - D365Outlook
---
# Do your Dynamics 365 for Customer Engagement work in Outlook using Dynamics 365 for Customer Engagement for Outlook
...
## What Dynamics 365 for Customer Engagement for Outlook offers  
...
## Explore Dynamics 365 for Customer Engagement for Outlook  
 When you [Install Dynamics 365 for Customer Engagement for Outlook](http://go.microsoft.com/fwlink/p/?LinkID=512584), the software adds several user interface elements to your [!INCLUDE[pn_Outlook_short](../../includes/pn-outlook-short.md)] screen.  

 **Navigation pane**  

 You’ll see a folder for your organization in the navigation pane on the left side of the screen. Under your organization name, you’ll see a list of Dynamics 365 for Customer Engagement folders. Use these folders to navigate to your area and open different record types.  

 ![Dynamics 365 for Customer Engagement for Outlook navigation pane](../media/crm-outlook-navigation-pane.png "Dynamics 365 for Customer Engagement for Outlook navigation pane")  
 ...
 **Ribbon**  
 ...
 ![Dynamics 365 for Customer Engagement highlighted on ribbon in Dynamics 365 for Customer Engagement for Outlook](../media/crm-outlook-ribbon.png "Dynamics 365 for Customer Engagement highlighted on ribbon in Dynamics 365 for Customer Engagement for Outlook")  
 ...
 **Lists, views, and the reading pane**  
 ...
 ![List and reading pane in Dynamics 365 for Customer Engagement for Outlook](../media/crm-outlook-list-and-reading-pane.png "List and reading pane in Dynamics 365 for Customer Engagement for Outlook")  

 You can change the location of the reading pane or turn it off or on. You can also customize what you see in the reading pane. [!INCLUDE[proc_more_information](../../includes/proc-more-information.md)] [Customize the Reading Pane in Dynamics 365 for Customer Engagement for Outlook](customize-reading-pane.md)  

<a name="UnavailableFeatures"></a>   
## What Outlook features are unavailable in Dynamics 365 for Customer Engagement for Outlook?  
...
### See also  
 ...
 [Create a Microsoft Word mail-merge document with Dynamics 365 for Customer Engagement for Outlook](create-word-mail-merge-document.md)   
 [Customize the Reading Pane in Dynamics 365 for Customer Engagement for Outlook](customize-reading-pane.md)   
