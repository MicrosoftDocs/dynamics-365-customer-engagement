...
1. Go to **Options**:  
   ...
   - In the web app: On the nav bar, click **Options** ![Options button for Dynamics 365 for Customer Engagement](../media/optionsbutton.png "Options button for Dynamics 365 for Customer Engagement").  
