---
title: "The Outlook email address should be the same as the Dynamics 365 for Customer Engagement email address | MicrosoftDocs"
ms.custom: ""
ms.date: 01/11/2016
ms.reviewer: ""
...
search.app: 
  ...
  - D365Outlook
---
# The Outlook email address should be the same as the Dynamics 365 for Customer Engagement email address
You’re seeing the following error message:  
  
 **“To track emails and perform synchronization, your Outlook email address should be the same as your email address in Microsoft Dynamics 365 for Customer Engagement.”**  
...
## Change the email address in Dynamics 365 for Customer Engagement to match the Outlook address  
...
## Change the email address in Outlook to match the address in Dynamics 365 for Customer Engagement  
