...
>   
>  Only December 2016 update for Dynamics 365 (8.2) or later organizations are supported for importing with this version of [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]. <!-- To upgrade earlier versions, see [Upgrade from Dynamics 365 Server 2013 or Dynamics Server 2011](upgrade-dynamics-crm-server-2013-or-2011.md). --> 
