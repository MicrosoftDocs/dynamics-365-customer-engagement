...
#### License tab
 ...
 The **License** tab displays a summary of all [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] users that are configured in the deployment. <!-- For information about each of these client access license types, see [Dynamics 365 for Customer Engagement purchase plans](https://go.microsoft.com/fwlink/p/?LinkId=306766).  -->
