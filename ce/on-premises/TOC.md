# [Deploy and operate Dynamics 365 for Customer Engagement for Customer Engagement (on-premises)](deploy-and-operate-dynamics-365-on-premises.md)
## [Planning Dynamics 365 for Customer Engagement for Customer Engagement (on-premises)](planning-your-deployment-of-microsoft-dynamics-365.md)
### [Dynamics 365 for Customer Engagement for Customer Engagement editions and licensing](microsoft-dynamics-365-editions-and-licensing.md)
### [Dynamics 365 for Customer Engagement for Customer Engagement system requirements and required technologies](system-requirements-required-technologies.md)
#### [Hardware requirements for Dynamics 365 for Customer Engagement Server](hardware-requirements.md)
##### [Dynamics 365 for Customer Engagement Server hardware requirements](microsoft-dynamics-365-server-hardware-requirements.md)
##### [SQL Server hardware requirements for Dynamics 365 for Customer Engagement Server](sql-server-hardware-requirements-dynamics-365-server.md)
...
#### [Active Directory and network requirements for Dynamics 365 for Customer Engagement for Customer Engagement](active-directory-network-requirements.md)
#### [Reporting requirements for Dynamics 365 for Customer Engagement for Customer Engagement](microsoft-dynamics-365-reporting-requirements.md)
#### [Language support for Dynamics 365 for Customer Engagement for Customer Engagement](microsoft-dynamics-365-language-support.md)
...
### [Plan your upgrade to Dynamics 365 for Customer Engagement for Customer Engagement Server](plan-your-upgrade-to-microsoft-dynamics-365-server.md)
...
## [Installing Dynamics 365 for Customer Engagement for Customer Engagement (on-premises)](installing-on-premises-dynamics-365.md)
### [Install or upgrade Dynamics 365 for Customer Engagement Server](install-or-upgrade-microsoft-dynamics-365-server.md)
#### [Dynamics 365 for Customer Engagement Server installation](microsoft-dynamics-365-server-installation.md)
##### [Install Dynamics 365 for Customer Engagement Front End Server and Back End Server roles](install-dynamics-365-front-back-end-server-roles.md)
##### [Install Dynamics 365 for Customer Engagement Full Server role on a server without Dynamics 365 for Customer Engagement for Customer Engagement installed](install-full-server-role-on-server.md)
...
### [Install Dynamics 365 for Customer Engagement Reporting Extensions](install-microsoft-dynamics-365-reporting-extensions.md)
...
### [Post-installation and configuration guidelines for Dynamics 365 for Customer Engagement for Customer Engagement](post-installation-configuration-guidelines-dynamics-365.md)
### [Available apps for Dynamics 365 for Customer Engagement for Customer Engagement (on-premises)](available-apps.md)
...
## [Operating Dynamics 365 for Customer Engagement for Customer Engagement (on-premises)](operating-microsoft-dynamics-365.md)
...
#### [Dynamics 365 for Customer Engagement for Customer Engagement deployment properties](microsoft-dynamics-365-deployment-properties.md)
...
### [Update Dynamics 365 for Customer Engagement for Customer Engagement](update-microsoft-dynamics-crm.md)
