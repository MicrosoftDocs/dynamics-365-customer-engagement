...
You don’t have sufficient permissions to access [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps . A [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] system administrator will need to do the following in the [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] application:  
