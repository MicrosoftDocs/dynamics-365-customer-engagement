...
|Dynamics 365 for Customer Engagement on-premises with with SharePoint Online     |  [Configure server-based authentication with Customer Engagement (on-premises) and SharePoint Online](../customer-engagement/on-premises/admin/on-prem-server-based-sharepoint-online.md)      |
