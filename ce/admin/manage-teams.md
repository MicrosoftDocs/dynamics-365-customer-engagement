...
> - **Administrator and Environment Maker experiences**. An Administrator or Environment Maker needs to be aware that the Group team member can be created in an environment when the team member accesses the environment, therefore they might not be able to share and assign security role to the team member.  
