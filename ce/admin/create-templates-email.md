...
8.  Type the text you want to send in this message. Use the Formatting toolbar to edit the text.  
    ...
    > -   There is no spell check built into [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]. There might be third-party solutions available. For more information, visit [Microsoft Dynamics Solution Finder](http://go.microsoft.com/fwlink/p/?LinkId=98752).  
...
### See also  
 [Work with templates](work-templates.md)