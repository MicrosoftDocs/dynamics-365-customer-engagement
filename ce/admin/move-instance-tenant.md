...
> [!IMPORTANT]
> <!-- For versions prior to Dynamics 365 (online) version 9.0,-->When moving individual Dynamics 365 (online) instances from one tenant to another, if that requires a geographical region change, your tenant becomes a multiregional tenant. Regional features are enabled in the Dynamics 365 admin center.
> 
