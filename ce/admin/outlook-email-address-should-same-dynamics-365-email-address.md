---
title: "The Outlook email address should be the same as the Dynamics 365 Customer Engagement email address | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
manager: "brycho"
---
# The Outlook email address should be the same email address
You’re seeing the following error message:  
  
 **“To track emails and perform synchronization, your Outlook email address should be the same as your email address in Dynamics 365.”**  
