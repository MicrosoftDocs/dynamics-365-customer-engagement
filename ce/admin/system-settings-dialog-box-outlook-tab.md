...
|                                                       Send pending Dynamics 365 for Customer Engagement apps email every                                                        |                                         Default: 10 minutes. Sends pending [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] email on the specified interval.                                         |
