...
### Will the standard Dynamics 365 for Customer Engagement Online service level agreements be offered?  
...
### When will ExpressRoute be available in Canada for Dynamics 365 for Customer Engagement Online customers, and through which partners?  
...
### Where can I find more about Microsoft Dynamics 365 for Customer Engagement (online) security, data privacy, and compliance?  
 You can find more information at the  [Microsoft Dynamics 365 for Customer Engagement Trust Center](http://go.microsoft.com/fwlink/p/?LinkID=393409).  
...
### If I am scheduled for an update to CRM Online 2015 Update or CRM Online 2015 Update 1, will Microsoft apply the update at the same time as their migration to the Canada datacenter?  
 You must be updated to [!INCLUDE[pn_crm_online_2015_update](../../includes/pn-crm-online-2015-update.md)] or later prior to migrating to the Canada datacenter.  Customers can schedule their update. For more information, see [Manage Dynamics 365 for Customer Engagement (online) updates](../../admin/manage-updates.md).  
