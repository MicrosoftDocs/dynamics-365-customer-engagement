...
### What prompted Microsoft to undertake this geographic expansion of Dynamics 365 for Customer Engagement (online)?  
...
### What are the future geographic expansion plans for Dynamics 365 for Customer Engagement (online)?  
...
## Dynamics 365 for Customer Engagement (online) service overview  
...
### Will the standard Dynamics 365 for Customer Engagement Online SLA be offered at general availability launch?  
...
### Will Dynamics 365 for Customer Engagement be available on Azure Infrastructure as a Service (IaaS) in Australia?  
...
### Where can I find more about Dynamics 365 for Customer Engagement (online) security, data privacy, and compliance?  
 The [Microsoft Dynamics 365 for Customer Engagement Trust Center](http://go.microsoft.com/fwlink/p/?LinkID=393409) will be updated as needed when the Australia Datacenters launch into general availability.  
  
### What data for Dynamics 365 for Customer Engagement (online) will be in Australia datacenters at general availability?  
...
### Will Dynamics 365 for Customer Engagement (online) be Information Security Registered Assessors Program (IRAP) certified when the datacenters are live in Australia?  
...
### Where can I find out more about the physical infrastructure for Dynamics 365 for Customer Engagement (online)?  
...
### I have applications and data in an existing Microsoft Dynamics 365 for Customer Engagement (online) datacenter. Will I be able to move those resources to the Australia datacenters?  
...
### If I am scheduled for an update to CRM Online 2015 Update or CRM Online 2015 Update 1, will Microsoft apply the update at the same time as their migration to the Australia datacenter?  
 You must be updated to [!INCLUDE[pn_crm_online_2015_update](../../includes/pn-crm-online-2015-update.md)] or later prior to migrating to the Australia datacenter. Customers can schedule their update. For more information, see [Manage Dynamics 365 for Customer Engagement (online) updates](../../admin/manage-updates.md).  
  
### If I have both Office 365 services and Dynamics 365 for Customer Engagement (online), how will migration be handled?  
...
### Can I move Office 365 and Dynamics 365 for Customer Engagement (online) at the same time?  
...
### Will all versions of Dynamics 365 for Customer Engagement Online be available?  
