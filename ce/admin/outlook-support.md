...
## Office  
 For versions of [!INCLUDE[pn_MS_Office](../includes/pn-ms-office.md)] that are supported for [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)], see [Dynamics 365 for Outlook software requirements](../admin/outlook-software-requirements.md).  
  
<a name="BKMK_Windows"></a>   
## Windows  
 For versions of [!INCLUDE[pn_ms_Windows_long](../includes/pn-ms-windows-long.md)]that are supported for [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)], see [Dynamics 365 for Outlook software requirements](../admin/outlook-software-requirements.md).  
  
### See also  
 [Microsoft Dynamics 365 for Outlook hardware requirements](../admin/outlook-hardware-requirements.md)   
 [Dynamics 365 for Outlook](../admin/outlook.md)