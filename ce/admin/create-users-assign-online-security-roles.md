...
>
> When using a security group to manage enabling or disabling users, nested security groups within a selected security group are not supported and ignored.
