...
> [!NOTE]
>  The concept and operation of tenants and instances, though similar, differs between online and on-premises deployments of [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps . This topic is for those administering [!INCLUDE[pn_CRM_Online](../includes/pn-crm-online.md)] deployments.  
