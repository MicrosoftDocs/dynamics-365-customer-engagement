---
title: "Troubleshooting and things to know about Dynamics 365 for Outlook | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
manager: "brycho"
---
# Troubleshooting and things to know about Dynamics 365 for Outlook
...
### Problem when using a proxy auto-config (PAC) file  
 [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)] might have authentication and connection issues when using a proxy PAC file configured in workstation browsers. For resolution, see [Dynamics CRM for Outlook client crashes when using a Proxy PAC file](https://support.microsoft.com/en-us/kb/2664157).  
...
### Automatic email tagging off by default  
 This setting is in the Dynamics 365 Diagnostics tool included with [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)]. Click **Start** > **All Programs** > **Dynamics 365** > **Diagnostics** > **Synchronization Troubleshooting** tab.  
...
## Dynamics 365 (online) with Office 365  
...
## Disable the Dynamics 365 for Outlook notification bar on the Web application  
 By default, if a user does not have [!INCLUDE[pn_crm_for_outlook_short](../includes/pn-crm-for-outlook-short.md)] installed and configured, the Dynamics 365 web application displays a **Get Dynamics 365 for Outlook** button on the notification bar. This button provides a link for users to download and install software features that configure a local [!INCLUDE[pn_ms_SQL_Server_Express_long](../includes/pn-ms-sql-server-express-long.md)] data store. If you do not want users to have this capability, you can remove the button.  
  
### Remove the Get Dynamics 365 for Outlook button from the Dynamics 365 web application  
  
1.  With a security role that has read and write permissions (for example, the System Administrator role), start the Dynamics 365 web application.  
