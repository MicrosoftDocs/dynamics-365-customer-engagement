...
Use the settings on this page to set up email processing in [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps.  
...
|  **Email processing for unapproved users and queues**  |  Select these check boxes if you want to allow email processing only for users and queues whose email addresses have been approved by the Dynamics 365 system and Exchange admins. More information: [Approve email](connect-exchange-online.md#approve-email)<br /><br /> -   Process email only for approved users<br />-   Process email only for approved queues |
