...
>   [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Dynamics 365 for Customer Engagement Developer Guide](../developer/developer-guide.md) 
...
```  
 ...
 To view the online help for the cmdlets, see [Dynamics 365 for Customer Engagement PowerShell Reference](https://technet.microsoft.com/library/dn756318.aspx).  
