---
title: "Control field synchronization between Dynamics 365 Customer Engagement and Dynamics 365 for Outlook | MicrosoftDocs"
ms.custom: ""
ms.date: "2017-08-31"
ms.reviewer: ""
...
manager: "brycho"
---
# Control field synchronization with Dynamics 365 for Outlook
...
5.  Choose **OK** > **OK** to close the open dialog boxes.  
 ...
 Let your users know they can view (not change) the synchronization settings. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [What fields can be synchronized between Dynamics 365 and Dynamics 365 for Outlook?](../admin/what-fields-synchronized-outlook.md)  
...
-   Securing fields: [Add or remove security from a field](http://go.microsoft.com/fwlink/p/?LinkID=512921)  
  
 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [How field security affects synchronization between Dynamics 365 and Dynamics 365 for Outlook](../admin/how-field-security-affects-synchronization-between-outlook.md) and [Security concepts for Microsoft Dynamics 365](../admin/security-concepts.md)  
