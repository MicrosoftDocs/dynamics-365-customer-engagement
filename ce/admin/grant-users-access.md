...
> [!IMPORTANT]
>  Users can’t access [!INCLUDE[pn_crm_online_shortest](../includes/pn-crm-online-shortest.md)] until they’ve been assigned at least one security role. See [Step Two: Assign security roles in Dynamics 365 (online)](../admin/grant-users-access.md#BKMK_StepTwo).  
