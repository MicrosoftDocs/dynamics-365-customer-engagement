...
<!-- 
> [!NOTE]
> This topic describes the process for enabling and viewing activities for a specific set of entities and attributes. For a auditing at a broader entity level with multiple records, consider using auditing with the Office 365. See [Enable and use comprehensive auditing](enable-use-activity-logging.md).
-->
