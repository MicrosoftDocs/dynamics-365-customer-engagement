---
title: "Billing FAQs for Dynamics 365 for Customer Engagement (online) Customer Engagement | MicrosoftDocs"
description: "We’ve put together this list of the most frequently asked billing and subscription management questions for Dynamics 365 for Customer Engagement (online) Customer Engagement"
ms.custom: ""
ms.date: 08/18/2018
ms.reviewer: ""
...
search.app: 
  ...
  - Powerplatform
---
# Billing FAQs for Dynamics 365 for Customer Engagement (online) Customer Engagement
...
## How do I find the correct Dynamics 365 for Customer Engagement (online) billing and subscription support team?  
...
## What billing activities do I need to contact Dynamics 365 for Customer Engagement (online) Billing Support to manage?  
...
## When I renew my subscription, can I change my payment method?  
 During subscription renewal, you can move from credit card to invoice payment, but not from invoice to credit card. Please refer to the **Dynamics 365 for Customer Engagement (online)** tab on the [Billing support](../admin/billing-support.md) page if you wish to change from invoice to credit card payments at subscription renewal time.  
  
## How do I purchase Dynamics 365 for Customer Engagement (online) through Volume Licensing?  
...
## How do I extend my Dynamics 365 for Customer Engagement (online) trial?  
...
## How do I migrate from Dynamics 365 for Customer Engagement (online) to the on-premises version of Dynamics 365 for Customer Engagement?  
...
## How do I cancel my Dynamics 365 for Customer Engagement (online) subscription?  
...
3.  The day that you want your subscription to Dynamics 365 for Customer Engagement (online) terminated.  
...
## How do I reactivate my expired Dynamics 365 for Customer Engagement (online) account?  
 The instructions in this section apply to subscriptions made through [!INCLUDE[pn_CRM_online](../includes/pn-crm-online.md)] as well as through [!INCLUDE[pn_MS_Office_365](../includes/pn-ms-office-365.md)].  
...
## How do I apply for a credit due to a Dynamics 365 for Customer Engagement (online) service outage?  
