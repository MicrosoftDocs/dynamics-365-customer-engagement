...
This member’s privilege inheritance role is applicable to [Owner](manage-teams.md#about-owner-teams) and Azure Active Directory (AAD) [Group Teams](manage-teams.md#about-group-teams). 
