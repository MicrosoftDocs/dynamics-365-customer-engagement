...
### For admins and end users: Sign in at https://portal.office.com  
 ...
 Click the [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] tile to go to the [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] Home page. See [For admins and end users: Select a Dynamics 365 for Customer Engagement apps app from the new app switcher](quickly-navigate-office-365-app-launcher.md).
