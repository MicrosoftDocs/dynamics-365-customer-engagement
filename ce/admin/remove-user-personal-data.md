...
1. The user leaves the company. In this scenario, the user record remains in the tenant’s Active Directory for 30 days before the record is deleted.<br/>
--Or--</br/>
...
- See examples on [updating records](../developer/webapi/update-delete-entities-using-web-api.md) and [Create, retrieve, update and delete records](../developer/org-service/use-entity-class-create-update-delete.md).
