---
title: "Install Dynamics 365 for Outlook for desktop virtualization for Dynamics 365 Customer Engagement | MicrosoftDocs"
ms.custom: ""
ms.date: "2017-08-31"
ms.reviewer: ""
...
manager: "brycho"
---
# Install Dynamics 365 for Outlook for desktop virtualization
...
3.  Run the [!INCLUDE[pn_Configuration_Wizard_long](../includes/pn-configuration-wizard-long.md)] on the [!INCLUDE[pn_Remote_Desktop_Services](../includes/pn-remote-desktop-services.md)] server. For instructions, see [Install Dynamics 365 for Outlook](../admin/install-outlook.md).  
...
## Support for Citrix XenApp 6.5 and 7.0-7.6 session virtualization for Dynamics 365 for Outlook on a single XenApp instance  
...
### See also  
 ...
 <!--[Install or upgrade language packs for Microsoft Dynamics 365](Install%20or%20upgrade%20Language%20Packs.md)   -->
 [Microsoft Dynamics 365 for Outlook Installation Instructions](../admin/planning-installing-outlook.md)