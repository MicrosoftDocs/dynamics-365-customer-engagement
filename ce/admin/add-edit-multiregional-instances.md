...
3.  Proceed through the screens to purchase additional instances.
     ...
     You can choose to add Production or non-Production (Sandbox) instances. For more information, see [Microsoft Dynamics 365 for Customer Engagement apps pricing and licensing](https://go.microsoft.com/fwlink/p/?LinkID=324564).
