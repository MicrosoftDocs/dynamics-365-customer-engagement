---
title: "Change regional and language options for your Dynamics 365 Customer Engagement organization | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
ms.assetid: 9380bb35-0645-4b9c-87b2-ed8db2b08ab7
caps.latest.revision: 13
ms.author: "rdubois"
manager: "brycho"
---
# Change regional and language options for your organization
You can change how [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] displays dates, times, numbers, and currencies. You can also select the language in which [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] displays the user interface and Help.  
...
|**Enable or disable languages**|You can enable or disable available languages in the **Settings** area. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Enable or disable languages](http://go.microsoft.com/fwlink/p/?LinkId=513230)|  
