...
Large [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps  organizations that synchronize their data with external data sources can now enable entities for change tracking. You can export or retrieve a selected set of [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] data, and then keep the external data warehouse in sync.  
