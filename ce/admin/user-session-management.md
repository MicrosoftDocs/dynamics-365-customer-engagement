...
>   - In the same browser session, you go to the Dynamics 365 Administration Center **Instances** tab and open an environment in a new tab by manually adding a new tab and manually entering the environment URL. 
