...
>     **To workaround** the policy bypass and maximum 24 hour user session, open the environment from the **Dynamics 365 Administration Center** **Instances** tab by clicking the **Open** link.
