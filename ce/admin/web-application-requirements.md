...
- [!INCLUDE[tn_Google_Chrome]
    ...
    - Google Chrome (latest publicly-released version) running on [!INCLUDE[tn_Mac_OS_X](../includes/tn-mac-os-x.md)] 10.8 (Mountain Lion), 10.9 (Mavericks), and 10.10 (Yosemite). 
