...
- It is not possible for users to work parallely on task flows and Channel Integration Framework(CIF) panel, because task flows render on top of CIF panel.
