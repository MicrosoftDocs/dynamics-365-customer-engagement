...
## [Try Dynamics 365 for Customer Engagement apps (online)](try-dynamics-365-online.md)
## [About Unified Interface](about-unified-interface.md)
## [Update apps to Unified Interface](updatge-apps-to-unified-interface.md)
...
# [Switch from CRM Online to Dynamics 365 for Customer Engagement apps (online)](switch-dynamics-crm-online-dynamics-365.md)
...
## [Synchronize user information between Dynamics 365 for Customer Engagement apps and Active Directory](synchronize-user-information-active-directory.md)
...
## [Migrate Dynamics 365 for Customer Engagement apps (online) to Dynamics 365 for Customer Engagement apps (on-premises)](migrate-online-onpremises.md)
...
##### [Set up Dynamics 365 for Customer Engagement apps (online) to use SharePoint Online](set-up-dynamics-365-online-to-use-sharepoint-online.md)
...
##### [Configure server-based authentication with Dynamics 365 for Customer Engagement apps (online) and SharePoint on-premises](configure-server-based-authentication-sharepoint-on-premises.md)
...
#### [Connect Dynamics 365 for Customer Engagement apps (online) to Exchange Online](connect-exchange-online.md)
#### [Connect Dynamics 365 for Customer Engagement apps (online) to SharePoint Online](set-up-dynamics-365-online-to-use-sharepoint-online.md)
...
#### [Set up Dynamics 365 for Customer Engagement apps (online) to use Skype or Skype for Business](set-up-skype-or-skype-for-business.md)
...
## [Dynamics 365 for Customer Engagement apps (online) Government - Feature availability](../admin/government/government-feature-availability.md)
