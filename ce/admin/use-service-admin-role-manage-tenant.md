...
|Office 365 user with Dynamics 365 system admin role*|Yes|No|No|Yes|No|Yes|No|Only in [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] admin center|No|  
