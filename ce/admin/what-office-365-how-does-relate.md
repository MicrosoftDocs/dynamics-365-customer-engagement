...
> [!TIP]
>  You should also take a look at the data compilation and visualization possibilities with [Power BI for Office 365](https://powerbi.microsoft.com/). In addition, see the blog post [Dynamics CRM Online in Power Query](https://blogs.msdn.com/b/powerbi/archive/2013/12/19/dynamics-crm-online-in-power-query.aspx) for a presentation on [!INCLUDE[pn_power_bi_for_office_365_short](../includes/pn-power-bi-for-office-365-short.md)] and [!INCLUDE[pn_CRM_Online](../includes/pn-crm-online.md)] apps integration.
