...
-   [Dynamics 365 for Customer Engagement apps pricing](https://go.microsoft.com/fwlink/p/?linkid=733924)  
...
-   [Video: Get familiar with Dynamics 365 for Customer Engagement apps (for admins)](https://go.microsoft.com/fwlink/p/?linkid=837700)  
...
## Compare your options for upgrading or switching plans  
 You can choose to maintain similar functionality you have with CRM Online or take advantage of new features and functionality from [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)]. The licensing changes are as follows.  


|    Existing CRM Online License    |                                                                                                        Recommended Dynamics 365 for Customer Engagement apps License                                                                                                        |
|-----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|            Enterprise             |                                                                                                     Dynamics 365 for Customer Engagement apps Plan                                                                                                      |
|           Professional            |                                Dynamics 365 for Customer Engagement apps Plan, [!INCLUDE[pn_dyn_365_sales](../includes/pn-dyn-365-sales.md)], or [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] for Customer Service                                 |
|               Basic               | [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] for Team Members, [!INCLUDE[pn_dyn_365_sales](../includes/pn-dyn-365-sales.md)], [!INCLUDE[pn_dyn_365_service](../includes/pn-dyn-365-service.md)], or Dynamics 365 for Customer Engagement apps Plan |
|             Essential             |                                                                                       [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] for Team Members                                                                                       |
|       Field Service Add-on        |                                                                 Dynamics 365 for Customer Engagement apps Plan, or [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] for Field Service                                                                  |
| Project Service Automation Add-on |                                                           Dynamics 365 for Customer Engagement apps Plan, or [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] for Project Service Automation                                                           |

> [!IMPORTANT]
>  Existing customers must choose which [!INCLUDE[pn_microsoftcrm](../includes/pn-dynamics-crm.md)] apps licenses meet the needs of their organization.  Simply transitioning existing licenses to the [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)] equivalent may not always be the best course of action.  Review the use rights below to determine the mix of user subscriptions that are suitable for your organization’s needs.  Based on the use rights changes with the launch of [!INCLUDE[pn_dyn_365](../includes/pn-crm-shortest.md)], this may be different than what you have today.  Review the following information for assistance on how to make your best license choices.  
...
### Option 3:  For Professional Users, consider [!INCLUDE[pn_dyn_365_sales](../includes/pn-dyn-365-sales.md)]  
...
### Option 4: For Basic Users, consider [!INCLUDE[pn_dyn_365_service](../includes/pn-dyn-365-service.md)]  
...
### Option 6: For Basic Users, consider Dynamics 365 for Customer Engagement apps for Team Members 
...
### Option 7: For Essential Users, consider Dynamics 365 for Customer Engagement apps for Team Members 
 Choose this option to get access to what you have today in CRM Online plus embedded PowerApps.  

<a name="BKMK_Option8"></a>   
### Option 8: For Project Service Automation Users, consider [!INCLUDE[pn_dyn_365_project_service_auto](../includes/pn-dyn-365-project-service-auto.md)] or Dynamics 365 for Customer Engagement apps Plan  
...
### Option 9: For Field Service Users, consider [!INCLUDE[pn_dyn_365_field_service](../includes/pn-dyn-365-field-service.md)] or Dynamics 365 for Customer Engagement apps Plan   
