...
- People outside of your \[!INCLUDE\[pn_crm_shortest]\(\.\./includes/pn\-crm\-shortest\.md\)\] apps organization, such as your partners.  
...
- Email deployments other than [!INCLUDE[pn_Exchange](../includes/pn-exchange.md)]  
  ...
  If you have been added as an additional recipient, and you want to stop receiving email notifications, please contact your \[!INCLUDE\[pn_crm_shortest]\(\.\./includes/pn\-crm\-shortest\.md\)\] apps admin. If you’re not sure who your \[!INCLUDE\[pn_crm_shortest]\(\.\./includes/pn\-crm\-shortest\.md\)\] apps admin is, see: [Find your Dynamics 365 for Customer Engagement apps administrator or support person](../basics/find-administrator-support.md).  
