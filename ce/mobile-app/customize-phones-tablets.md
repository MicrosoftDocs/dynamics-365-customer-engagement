...
With [!INCLUDE[pn-ms-dyn-365](../includes/pn-ms-dyn-365.md)], you can design once and deploy everywhere. Customizations you make to your [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] system appear in the Dynamics 365 for phones and tablets apps as well as in the web app. Your changes are optimized in the mobile apps so they display properly. Choose one of the following or scroll down to see the types of changes you can make, and how they might display differently in the mobile apps than the web app.  
  
 The latest version of the phone app, [!INCLUDE[pn_Mobile_Express_long](../includes/pn-mobile-express-long.md)], provides the same full-featured experience as the [!INCLUDE[pn-dyn-365-tablets](../includes/pn-dyn-365-tablets.md)] app. It has the same intuitive user interface (adapted for phones), as well as offline capabilities. For information about customizing the previous version of the app, see [Create and edit mobile forms for CRM for phones express](../customize/create-edit-mobile-forms-phones-express.md).  
...
## Home page for Dynamics 365 for phones and tablets  
 When users first open [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] for phones and tablets, they’ll see the home page, which defaults to the **Sales Dashboard**. You can create new dashboards or edit existing ones in the web app and enable them for mobile, and users can choose a different Home dashboard. For more information about creating or changing dashboards, see [Create a dashboard](http://go.microsoft.com/fwlink/p/?LinkId=534640) or [Manage dashboard components](http://go.microsoft.com/fwlink/p/?LinkId=320334).  
...
## Change navigation options for Dynamics 365 for phones and tablets  
 ...
 See [Change application navigation using the SiteMap](http://go.microsoft.com/fwlink/p/?LinkId=320342) for more information.  
...
-   Web resource or iFrame elements in your dashboards won’t display in the mobile apps. Methods that interact with them won’t work, and code configured for event handlers using these for the events called when these items load won’t run. If you’re interested in trying out a preview feature that does display web resource or iFrame elements in [!INCLUDE[pn_moca_short](../includes/pn-moca-short.md)], see [Preview feature: iFrame and web resource support in CRM for tablets](http://go.microsoft.com/fwlink/p/?LinkID=511593).  
...
## Visual controls in Dynamics 365 for phones and tablets  
 Use visual controls in [!INCLUDE[pn_Mobile_Express_short](../includes/pn-mobile-express-short.md)] and tablets to help mobile users enter [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] data faster, and to provide a richer visual experience. This set of custom controls includes sliders, switches, star ratings, video embedding, and a calendar control that you can use to give users a view of their activities in a calendar format instead of a list.  
  
|||  
|-|-|  
|**Control**|**Example**|  
|Linear slider|![Mobile linear slider control](../customize/media/mobile-control-linear-slider.png "Mobile linear slider control")|  
|Option set|![Mobile control option set](../customize/media/mobile-control-option-set.png "Mobile control option set")|  
|Flip switch|![Flip switch mobile control](../customize/media/mobile-control-flip-switch.png "Flip switch mobile control")|  
|Star rating|![Star rating mobile control](../customize/media/mobile-control-star-rating.png "Star rating mobile control")|  
|Radial knob|![Radial knob mobile control](../customize/media/mobile-control-radial-knob.png "Radial knob mobile control")|  
|Multimedia control|![Multimedia mobile control](../customize/media/mobile-control-multimedia-control.png "Multimedia mobile control")|  
|Pen control|![Pen mobile control](../customize/media/mobile-control-pen-control.png "Pen mobile control")|  
|Website preview|![Website preview mobile control](../customize/media/mobile-control.png "Website preview mobile control")|  
|Number input|![Number input mobile control](../customize/media/mobile-control-number-input.png "Number input mobile control")|  
|Auto-complete|![Auto&#45;complete mobile control](../customize/media/mobile-control-auto-complete.png "Auto-complete mobile control")|  
|Input mask|![Input mask mobile control](../customize/media/mobile-control-input-mask.png "Input mask mobile control")|  
|Linear gauge|![Linear gauge mobile control](../customize/media/mobile-control-linear-gauge.png "Linear gauge mobile control")|  
|Bullet graph|![Bullet graph mobile control](../customize/media/mobile-control-bullet-graph.png "Bullet graph mobile control")|  
|Arc knob|![Arc knob mobile control](../customize/media/mobile-control-arc-knob.png "Arc knob mobile control")|  
|Calendar control, phone|![Calendar control, phone, day](../customize/media/mobile-control-calendar-control.png "Calendar control, phone, day")|  
|Calendar control, tablet|![Calendar control with menu open](../customize/media/mobile-control-calendar-control-2.png "Calendar control with menu open")|  
|||  
|||  
 
  
### See also  
 [Video: Visual controls (4:32)](http://go.microsoft.com/fwlink/p/?LinkID=724424)
 ...
 [Create and edit processes](../customize/create-business-process-flow.md)
 
 [Create and business rules](../customize/create-business-rules-based-process-flows.md)
