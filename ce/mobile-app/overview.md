...
> [!Important]
> Dynamics 365 for phones and tablets is [deprecated](/power-platform/important-changes-coming) for online users and replaced by Power Apps. Effective January 2024, Dynamics 365 for phones and tablets (iOS and Android) will only support on-premise users. Online users will need to [migrate to the Power Apps mobile app](dynamics365/mobile-app/migration). The Power Apps mobile app provides updated capabilities, a modern user experience, and fast load times.
