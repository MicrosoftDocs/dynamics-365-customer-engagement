...
> [!NOTE]
> - You can use the web browsers on your phone or tablet but for full functionality and optimized experience we strongly recommend to use the Dynamics 365 for phones and tablets app. For more information, see [Install Dynamics 365 for phones and tablets](install-dynamics-365-for-phones-and-tablets.md).
