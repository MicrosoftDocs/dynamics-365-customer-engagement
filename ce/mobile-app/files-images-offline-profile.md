...
To work with files and images in  offline mode, you must add additional tables and relationships. This should be considered when the profile contains tables where **Date type** is a file or image.
