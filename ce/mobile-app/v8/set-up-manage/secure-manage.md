---
title: "Secure and manage Dynamics 365 for Customer Engagement apps for phones and Dynamics 365 for Customer Engagement apps for tablets | MicrosoftDocs"
ms.custom: ""
ms.date: 01/22/2018
ms.reviewer: ""
...
### Prepare to use [!INCLUDE[pn_dynamics_crm_for_good](../../../includes/pn-dynamics-crm-for-good.md)]  
 Your organization should have services set up with [!INCLUDE[pn_good_technology](../../../includes/pn-good-technology.md)]. Then follow the common directions for configuring [!INCLUDE[pn_moca_short](../../../includes/pn-moca-short.md)] in [Set up Dynamics 365 for Customer Engagement apps for phones and Dynamics 365 for Customer Engagement apps for tablets](set-up.md).  
