...
horizontaltabbed  
 ...
 ![Dynamics 365 for mobile enter search term](../mobile-imports/media/mobile-search-enter-term.png "Dynamics 365 for mobile enter search term")  
  
#### Filter search results  
 To filter results by record type, choose a record type from the **Filter with:** drop-down box.  
  
 ![Dynamics 365 for mobile search filter](../mobile-imports/media/mobile-search-filter.png "Dynamics 365 for mobile search filter")  
...
2.  Drag the column handles that appear above the grid to the width you want.  
 ...
 ![Column resizing handles](../mobile-imports/media/v6-mobile-column-resizing.png "Column resizing handles")  
