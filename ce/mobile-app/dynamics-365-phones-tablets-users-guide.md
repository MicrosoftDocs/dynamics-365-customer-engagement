---
title: "Dynamics 365 for phones and tablets User's Guide | MicrosoftDocs"
ms.custom: ""
ms.date: 12/10/2016
ms.reviewer: ""
...
## Which version am I using?  
 ...
 ![Dynamics 365 Home Screen latest version](../mobile-app/media/dynamics-365-home-screen-latest-version.png "Dynamics 365 Home Screen latest version")  
 ...
 ![Dynamics 365 for Phones and Tablets Home Screen for older version](../mobile-app/media/dynamics-365-for-phones-and-tablets-home-screen-for-older-version.png "Dynamics 365 for Phones and Tablets Home Screen for older version")  
  
 Go to [User's Guide for the previous version](#BKMK_PreviousVersion)  
  
<a name="BKMK_LastestVersion"></a>   
 ...
 **In this section:**  
 ...
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Signing in and signing out](#BKMK_Signin)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Basic navigation](#BKMK_Nav)  
 
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Continuum support](#BKMK_Continuum)
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Favorites and recently used records](#BKMK_PinFavs)    
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Work with records on the dashboard](#BKMK_Dashboards) 
 
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Take notes](#BKMK_Notes)
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Manage accounts, contacts, leads, and opportunities](#BKMK_ManageAccounts)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Track leads through the sales process](#BKMK_TrackLeads)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Manage activities](#BKMK_ManageActivities)    
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Send an email or make a call](#BKMK_SendEmailorCall)    
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Use Cortana voice commands](#BKMK_Cortana)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Troubleshooting](#BKMK_Troubleshooting)    
...
1.  From your Home screen, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis").

    ![Dynamics 365 for phones and tablets main menu screen](media/BasicNavigation_2.png "Dynamics 365 for phones and tablets main menu screen")
...
other tasks from the nav bar. To access more commands, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis").

![Dynamics 365 phones and tablets navigation bar](media/NavigationBar_3.png "Dynamics 365 phones and tablets navigation bar")
...
When you have record open and you need to view another record, tap ![Dynamics 365 for phones and tablets choose record icon](media/ChooseRecordIcon_01.png "Dynamics 365 for phones and tablets choose record icon") to choose
another record.
...
phones, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis") on the command bar and then tap **Export to Excel**.
...
![Dynamics 365 for phones and tablets access favorites](media/FavoritesAndRecentlyUsedRecords_13.png "Dynamics 365 for phones access favorites")

To pin a record as a favorite, from the list of **Recently Used**, tap the pin.
This will pin and move the recorded to **Favorites**.

![Dynamics 365 for phones and tablets pin favorites](media/PinFavoritesAndRecentRecords_14.png "Dynamics 365 for phones and tablets pin favorites")
...
3.  Select from the contacts that appear and then **Add** at the bottom. If it’s
  ...
  ![Dynamics 365 for phones and tablets add stakeholder](media/AddStakeholder_17.png "Dynamics 365 for phones and tablets add stakeholder")
...
-   From the charts Home page grid, you can expand the chart or view the data in
    ...
    -   When chart is rendered on the Dashboard page, the buttons are slightly
        ...
        -   Or, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis") and then choose an  action: **Refresh**, **View
...
![Dynamics 365 for phones and tablets process bar](media/ProcessBar_21.png "Dynamics 365 for phones and tablets process bar")
...
-   To add an activity, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis") at the top of your **My Activities** feed and select an activity to add.

  ![Dynamics 365 for phones and tablets manage activities](media/ManageActivites_22.png "Dynamics 365 for phones and tablets manage activities")

-   To mark an activity complete, open the activity and on the command bar tap
    **Mark Complete**.

<a name="BKMK_SendEmailorCall"></a>
 ...
 **In this section:**  
 ...
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Signing in and signing out](#BKMK_oldSignin)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Basic navigation](#BMMK_oldNav)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Pin your favorites](#BKMK_OLDPinFavs)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Work with records on the dashboard](#BKMK_OLDDashboards)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Personalize your workplace](#BKMK_oldWorkplace)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Take notes](#BKMK_oldNotes)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Scan barcodes](#BKMK_oldBarCodes)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Manage accounts, contacts, leads, and opportunities](#BKMK_oldmanageACLO)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Track your progress with charts](#BKMK_oldCharts)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Track customer service cases](#BKMK_oldServiceCases)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Track leads through the sales process](#BKMK_OLDTrackLeads)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Manage activities](#BKMK_OLDManageActivities)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Create a communication card](#BKMK_OldCreateComCard)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Send an email or make a call](#BKMK_OLDEmailOrCall)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Manage work orders, agreements, customer assets, and time off requests](#BKMK_OldFieldService)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Work offline](#BKMK_OldWorkOffline)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Use Cortana voice commands](#BKMK_OLDCortana)  
  
 ![Down arrow button](../mobile-app/media/down-arrow.png "Down arrow button") [Use your browser for non-mobile features](#BKMK_OLDUseBrowser)  
  
<a name="BKMK_oldSignin"></a>   
### Signing in and signing out  
...
1.  Open your app, enter your [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] web address, and tap ![Dynamics Dynamics 365 for phones and tablets continue sign](../mobile-app/media/mobile-signin-arrow.png "Dynamics Dynamics 365 for phones and tablets continue sign").  
  
 ![Enter URL to sign into Dynamics 365 for phones and tablets](../mobile-app/media/mobile-signin-enter-url.png "Enter URL to sign into Dynamics 365 for phones and tablets")  
...
1.  From your Home page, tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis").  
...
### Basic navigation  
 ...
 ![Dynamics 365 for phones and tablets nav bar](../mobile-app/media/mobile-phone-navigation-bar.png "Dynamics 365 for phones and tablets nav bar")  
  
#### The command bar  
 You can add a new record, change views, or do other tasks from the command bar.  
  
 Just tap ![Dynamics 365 ellipsis](../mobile-app/media/mobile-ellipsis.png "Dynamics 365 ellipsis") on the bottom right-hand corner of the page.  
  
 You can also press and hold an item to display the command bar.  
  
 ![Dynamics 365 for mobile command bar](../mobile-app/media/mobile-command-bar-phone.PNG "Dynamics 365 for mobile command bar")  
...
#### The Home page: your dashboards  
 ...
 ![Home screen in the Dynamics 365 mobile app](../mobile-app/media/mobile-home-cent.png "Home screen in the Dynamics 365 mobile app")  
...
#### Search and sort  
 ...
 ![Dynamics Dynamics 365 for phones and tablets search](../mobile-app/media/mobile-start-search.png "Dynamics Dynamics 365 for phones and tablets search")  
 ...
 ![Dynamics 365 for mobile enter search term](../mobile-app/media/mobile-search-enter-term.png "Dynamics 365 for mobile enter search term")  
  
##### Filter search results  
 To filter results by record type, choose a record type from the **Filter with:** drop-down box.  
  
 ![Dynamics 365 for mobile search filter](../mobile-app/media/mobile-search-filter.png "Dynamics 365 for mobile search filter")  
...
2.  Drag the column handles that appear above the grid to the width you want.  
 ...
 ![Column resizing handles](../mobile-app/media/v6-mobile-column-resizing.png "Column resizing handles")  
...
#### Navigation on Android devices  
 ...
 ![Dynamics 365 for Android scroll button](../mobile-app/media/v6-mobile-android-scrollbutton.png "Dynamics 365 for Android scroll button")  
...
### Pin your favorites  
 ...
 ![Dynamics 365 for mobile pin tile](../mobile-app/media/mobile-pin-tile.png "Dynamics 365 for mobile pin tile")  
...
#### Create a communication card  
 ...
 ![Dynamics 365 for mobile create communication card](../mobile-app/media/mobile-create-comm-card.png "Dynamics 365 for mobile create communication card")  
  
<a name="BKMK_OLDDashboards"></a>   
### Work with records on the dashboard  
...
### Personalize your workplace  
 ...
 ![Workspace for mobile](../mobile-app/media/workspace-mobile.png "Workspace for mobile")  
  
<a name="BKMK_oldNotes"></a>   
### Take notes  
 ...
 ![Device integration](../mobile-app/media/device-integration.PNG "Device integration")  
  
<a name="BKMK_oldBarCodes"></a>   
### Scan barcodes  
 ...
 ![Barcode scanning in Dynamics 365 for phones and tablets](../mobile-app/media/barcode-icon-mobile.PNG "Barcode scanning in Dynamics 365 for phones and tablets")  
  
<a name="BKMK_oldmanageACLO"></a>   
### Manage accounts, contacts, leads, and opportunities  
...
4.  Select a role for the contact.  
 ...
 ![Stakeholders and sales team lists](../mobile-app/media/stakeholders-and-sales-team-lists.gif "Stakeholders and sales team lists")  
  
<a name="BKMK_oldCharts"></a>   
### Track your progress with charts  
 ...
 ![Chart data in Dynamics 365 for tablets](../mobile-app/media/mobile-chart-data.png "Chart data in Dynamics 365 for tablets")  
...
1.  On the command bar, tap **Select View**.  
 ...
 ![Dynamics 365 for tablets chart Select View command](../mobile-app/media/select-view-button.gif "Dynamics 365 for tablets chart Select View command")  
  
2.  Select the view you want.  
  
 ![Available charts in Dynamics 365 for tablets](../mobile-app/media/edit-report.gif "Available charts in Dynamics 365 for tablets")  
...
### Track leads through the sales process  
 ...
 ![Process bar in Dynamics 365 mobile app](../mobile-app/media/process-bar-dynamics-365-mobile-app.png "Process bar in Dynamics 365 mobile app")  
...
<a name="BKMK_OLDManageActivities"></a>   
### Manage activities  
...
-   To see a subset of your activities:  
 ...
 ![Dynamics 365 for phones and tablets activity feed](../mobile-app/media/mobile-activity-feed.png "Dynamics 365 for phones and tablets activity feed")  
  
<a name="BKMK_OldCreateComCard"></a>   
### Create a communication card  
 Communication cards provide a quick way to email or call your contact just by tapping the email address or phone number on the card. Communication cards appear on contact forms, but you can also create a communication card from a contact in the Pinned Tiles section of your Home screen by expanding the pinned tile.  
...
### Send an email or make a call  
 ...
 ![Dynamics 365 for phones and tablets communication card](../mobile-app/media/mobile-communication-card.png "Dynamics 365 for phones and tablets communication card")  
...
1.  From the menu, tap **Draft Records**.  
 ...
 ![Dynamics Dynamics 365 for phones save offline drafts](../mobile-app/media/mobile-offline-save-drafts.png "Dynamics Dynamics 365 for phones save offline drafts")  
...
#### Reconnect to go back online  
 ...
 ![Offline indicator: tap to reconnect](../mobile-app/media/mobile-offline-indicator.png "Offline indicator: tap to reconnect")  
