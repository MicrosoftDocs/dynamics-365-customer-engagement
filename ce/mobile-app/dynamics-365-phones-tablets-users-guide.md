...
> - You can use web browsers on your tablet to run your model-driven apps, but for full functionality and optimized experience we strongly recommend that you use the Dynamics 365 tablets app. Using the web browser on your phone to run your model-driven apps isn't supported; you must use the Dynamics 365 for phones app. More information: [What's supported](support-phones-tablets.md).
