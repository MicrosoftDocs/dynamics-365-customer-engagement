...
> [!IMPORTANT]
> - The option to sig in using your email address only supported for version 9.x (Common Data Service) when signing in using the mobile app on an iOS and Android device.
