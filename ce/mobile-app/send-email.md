...
1. You can create emails from home page grid or by using quick create. 
    ...
    1. **Home page grid**: On the home page, select Activities, select the **More** button ![More button](media/email_more_commands.png "more commands button") > **Email**.
    
       > [!div class="mx-imgBorder"]
       > ![Compose new email](media/create-email-1.png "Compose new email")

    1. **Quick create**: On the command bar, select the **More** button ![More button](media/email_more_commands.png "more commands button") > **Quick Create Menu** > **Activities** > **Email**. 
...
4. To use a template for the email body, select the **More** button ![More button](media/email_more_commands.png "more commands button") and select **Insert Template**. Select or search a template from the available templates, and select **Apply template**. 
