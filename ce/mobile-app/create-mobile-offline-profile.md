---
title: "Create a mobile offline profile in Dynamics 365 for phones and tablets | MicrosoftDocs"
ms.custom: ""
ms.date: "2016-11-01"
ms.reviewer: ""
...
applies_to: 
  - "Dynamics 365 (online)"
  - "Dynamics CRM Online"
ms.assetid: 6f2d24d8-63ce-4d4d-a6d3-0ac3f6d3dbde
caps.latest.revision: 6
ms.author: "mkaur"
manager: "brycho"
---
# Create a mobile offline profile to determine what data will be available while offline
...
### See also  
[Add users to a profile](add-users-mobile-offline-profile.md)
