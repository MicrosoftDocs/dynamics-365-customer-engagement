...
1. Depending on which screen you're one, do one of the following to sign out of the mobile app:
   ...
   - If your signed in and using an app, select the site map ![Site map icon](media/d365_mobile_sitemap_icon.png "Site map icon"), > the profile icon ![Profile icon](media/d365_profile_icon.png "Site map icon"), > **Sign out**.
