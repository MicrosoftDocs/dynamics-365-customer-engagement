...
## Step 1: Create the basic hosted controls  
 Create the following three types of hosted control so that the application can connect to an instance of the Dataverse platform: Connection Manager, Global Manager, and Panel Type.  
