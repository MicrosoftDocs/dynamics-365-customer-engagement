...
2. In the **Import From Dynamics 365 for Customer Engagement** dialog box, enter the [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] server name and your credentials.  
