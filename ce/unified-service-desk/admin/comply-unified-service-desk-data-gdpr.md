...
manager: "sakudes"
---
# Comply Unified Service Desk data under GDPR

With the data definitions and stages outlined in the GDPR, let us look at data contained in Unified Service Desk and see how they relate.
...
A custom listener lets you target the log output to files, the event log, or other sources.
...
Unified Service Desk Client application telemetry data is maintained in Microsoft Dynamics 365. The category of telemetry that are collected are as follows:
