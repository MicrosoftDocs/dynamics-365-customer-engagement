...
description: "Understand how the audit log files, diagnostic log files, and telemetry data contained in Unified Service Desk comply with General Data Protection Regulation (GDPR)."
ms.date: 04/24/2018
ms.topic: article
author: mh-jaya
ms.author: v-jmh
