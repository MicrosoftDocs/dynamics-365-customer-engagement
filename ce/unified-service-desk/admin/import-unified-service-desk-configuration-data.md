...
7. Double-click the **PackageTemplate.cs** file to update the package name and description. For detailed information about this, see [Create packages for the Dynamics 365 for Customer Engagement apps Package Deployer](https://msdn.microsoft.com/library/dn688182.aspx) in the [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] SDK help.  
