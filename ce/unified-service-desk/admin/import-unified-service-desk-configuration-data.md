...
3. On the **Login** screen, provide authentication details to connect to your Dataverse platform server from where you want to export data. If you have multiple organizations on the Dataverse platform server, and want to select the organization from where to export the data, select the **Always display list of available orgs** check box. Click **Login**.  
  
4. If you have multiple organizations, and you selected the **Always display list of available orgs** check box, the next screen lets you choose the organization that you want to connect to. Select the Dataverse platform organization to connect to.  
...
- Install the template (CRMSDKTemplates.vsix) from the Dataverse platform SDK package that you extracted in the previous step. The file is available under the SDK\Templates folder.  
...
7. Double-click the **PackageTemplate.cs** file to update the package name and description. For detailed information about this, see [Create packages for the Package deployer](https://msdn.microsoft.com/library/dn688182.aspx) in the Dataverse platform SDK help.  
...
11. You will be prompted to specify the credentials of the target the Dataverse platform server. Specify the details, and proceed.  
