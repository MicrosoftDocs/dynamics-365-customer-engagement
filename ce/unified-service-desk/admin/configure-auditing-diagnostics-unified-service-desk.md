...
This topic discusses how you can configure agent auditing and diagnostics using the **Audit & Diagnostics Settings** area in [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)].
