...
- By using an Audit & Diagnostics Settings record that is created and managed in the [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] area of the Microsoft Dataverse platform.  
...
|         Microsoft.Xrm.Tooling.Connector.CrmServiceClient          |                                     Log source for all the Dataverse platform data-level interactions. This source will report all interactions with the Dataverse platform, exceptions and timings.                                      |
|             Microsoft.Xrm.Tooling.WebResourceUtility              |                                                                                           Log source for requests for Web Resource data via the Dataverse platform interface link.                                                                                            |
