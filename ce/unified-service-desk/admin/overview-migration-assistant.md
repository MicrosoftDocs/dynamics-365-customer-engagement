...
- Events and actions that are only supported in the legacy web client to the corresponding events and actions in Unified Interface App.
...
- Configurations from the legacy web client to Unified Interface App.
