...
>  
> - The sample application installs sample data for entities like Account, Contact, Cases, and so on.
>
> - The sample application reactivates already resolved cases and sets up the **Customer Satisfaction**" and **Average Handling Time**  to random value and closes them.
>
