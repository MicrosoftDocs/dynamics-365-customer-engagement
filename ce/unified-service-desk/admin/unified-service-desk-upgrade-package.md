...
- Upgrade the existing [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] solutions in the specified the Dataverse platform organization to the latest version without affecting the existing configuration data.  
  
- Configure a new [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] environment without any sample configuration in the Dataverse platform organization where no [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] solution is currently deployed.  
...
- Customizations for the Dataverse platform Unified Interface package
