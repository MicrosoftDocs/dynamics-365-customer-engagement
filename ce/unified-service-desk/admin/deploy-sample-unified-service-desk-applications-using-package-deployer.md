...
8. The next screen displays detailed information about the selected package and the things that will be installed on your Common Data Service platform instance. Review the information, and choose **Next**.  

9. The **Ready to Install** screen displays the package selected for deployment and name of the Common Data Service platform organization where it will be deployed to. Review the information, and choose **Next**.
...
## Remove a sample Unified Service Desk package  
 When you deploy a sample [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] package in the Common Data Service platform organization, the following three managed solutions are created:
