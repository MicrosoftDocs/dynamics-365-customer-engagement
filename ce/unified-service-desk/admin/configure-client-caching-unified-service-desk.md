...
description: "Learn how to configure and enable client caching."
author: mh-jaya
ms.author: v-jmh
manager: shujoshi
ms.date: 08/23/2017
...
This topic provides an overview of client caching, and also discusses how you can configure and enable client caching in Unified Service Desk.
