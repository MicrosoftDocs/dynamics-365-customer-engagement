...
5.  On the **New Option** page, type the option name and corresponding value. Some options are available in the **Global Options** list. Additional global options for [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] that aren't displayed in the list and must be entered by the administrator are described in this table.  
    ...
    |`TotalRecordCountLimit`|This is the total number of record that [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] client application loads for any [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] entities that you have configured and deployed in [!INCLUDE[pn_crm_shortest](../../includes/pn-crm-shortest.md)] instance. The default value is 5000. </br>**Note:** You must not change the default value unless the Microsoft CRM SQL Database administrator requests you to change the value.|
...
## See also  
 ...
 [Performance enhancement of CRM entity page loading and faster inline navigation](../admin/performance-enhancement-CRM-entity-page-loading-faster-inline-navigation.md)
