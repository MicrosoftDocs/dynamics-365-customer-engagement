...
- **Empower agents with unified access to customer information**: [!INCLUDE[pn_unified_service_desk](../../includes/pn-unified-service-desk.md)] provides agents with a single service interface for accessing customer information in the Dataverse platform, which helps them deliver fast and accurate customer service.  
...
- **Centrally configure and manage from within the Dataverse platform**: You can centrally configure and manage your agent applications by using the familiar interface of the Dataverse platform.  
