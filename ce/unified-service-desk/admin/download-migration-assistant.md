...
- Ensure your environment has an model-driven app such the Customer Service Hub app built of the Microsoft Dataverse platform. To learn more, see [What are model-driven apps?](https://docs.microsoft.com/powerapps/maker/model-driven-apps/model-driven-app-overview)
