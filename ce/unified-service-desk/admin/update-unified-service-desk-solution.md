...
2. Run the **PackageDeployer** executable file. For more information about how to deploy the package, see [Deploy a Unified Service Desk package using Package Deployer](deploy-sample-unified-service-desk-applications-using-package-deployer.md?view=dynamics-usd-4.2#deploy-a-sample-unified-service-desk-package-using-package-deployer).
