From this release, Unified Service Desk supports the Apps built using Unified Interface framework.
...
Unified Service Desk supports the apps built using Unified Interface framework. That is, you can host a Unified Interface Page to load a URL or page from Dynamics 365 apps, which is built based on the Unified Interface framework.
