...
|        u        |                                                                                        This key is used to URL Encode (also called Percent Encode) the replacement parameter.<br /><br /> For example, consider the replacement parameter in the following URL: http://mysite?something=`[[opportunity.name]u]`.<br /><br /> The following string is returned: http://mysite?something=My%20Opportunity.                                                                                        |
