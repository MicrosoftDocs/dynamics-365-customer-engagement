...
| [Unified Service Desk New Environment sample package](../../unified-service-desk/admin/unified-service-desk-new-environment-package.md)  | Updated information about the Customizations for the Common Data Service platform Unified Interface package.  |
| [Unified Service Desk Unified Interface sample package](../../unified-service-desk/admin/unified-service-desk-dynamics-365-unified-interface-package.md)  | Updated information about the Customizations for the Common Data Service platform Unified Interface package.  |
| [Unified Service Desk Upgrade sample package](../../unified-service-desk/admin/unified-service-desk-upgrade-package.md)  | Updated information about the Customizations for the Common Data Service platform Unified Interface package.  |
