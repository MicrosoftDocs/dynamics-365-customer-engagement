---
title: "Unified Interface Settings (Dynamics 365 Customer Engagement apps) | MicrosoftDocs"
...
4. Select **Unified Interface Settings** under **Advance Settings** in the site map.

5. Select **+ New** to create a new record in the **Active Unified Interface Settings** page, .

6. Specify the following in the **New Unified Interface Settings** page.
...
3. select **Add Existing Configuration** in the **Configuration** tab.<br>
  > [!Note]
...
4. Specify the name of the configuration, and choose search icon in the **Lookup Records** pane.<br> The configuration appears, choose the configuration and then choose **Add**.<br>
...
1. Select **Configuration** in the site map.

2. Select **+ New** to create a configuration record.

3. Specify the required details for the fields in the **New Configuration** page.
