...
4. Select a record in the **Active Audit & Diagnostics Settings** page.
...
4. Select the **Diagnostics Settings** tab to see the **Performance Data Collection** section.

5. Type the keyboard shortcut in the format _key1+key2+key3_ for the **On-Demand Begin Shortcut** and **On-Demand End Shortcut** fields. For example, **Ctrl+Alt+Q** for On-Demand Begin Shortcut and **Ctrl+Alt+P** for On-Demand End Shortcut.
