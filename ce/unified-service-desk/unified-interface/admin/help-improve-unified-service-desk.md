...
6. Select **HelpImproveUSD** in the **Global Options** list on the New Option page. 
  
7. Enter `FALSE` in the **Value** box.
...
> 1. In the sitemap, choose **Options** under **Advance Settings**.
> 2. Select **HelpImproveUSD** checkbox.
> 3. Select **Deactivate** in the toolbar.
> 
> [!Note]
