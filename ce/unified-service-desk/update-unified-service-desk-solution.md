...
1.  [Download the Unified Service Desk package file](http://go.microsoft.com/fwlink/p/?LinkID=623561) (CRM2016-8.x.x-USD-PackageDeployer.exe), and save it on your computer.  
...
6.  Go to **Settings** > **Solutions**. [(How do I get there?)](http://go.microsoft.com/fwlink/p/?LinkId=525636)  
...
11. Repeat steps 7-10 for the DynamicsUnifiedServiceDesk_1_0_managed.zip file to update the **DynamicsUnifiedServiceDesk** solution in your [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] instance.  
     ...
     For detailed information about updating solutions in [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)], see [Import, update, and export solutions](https://technet.microsoft.com/library/dn531198.aspx#BKMK_ImportUpgradExportSolutions).  
