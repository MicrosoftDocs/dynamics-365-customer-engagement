...
2. To display the account records from your the Common Data Service platform instance, click the down arrow next to the **Search** button in the toolbar, and then click **Account**.  
