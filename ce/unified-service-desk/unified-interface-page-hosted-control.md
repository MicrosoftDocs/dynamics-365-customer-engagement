...
<br />
To add multiple headers, the value of this parameter should be <code>header=$Multiline(<headers separated by newline>)</code>. Example: `
<code>header=$Multiline(accessToken;dummyAccessToken==<br />
<br />
