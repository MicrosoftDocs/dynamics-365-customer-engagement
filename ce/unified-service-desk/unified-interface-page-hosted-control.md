...
<br />
To add multiple headers, the value of this parameter should be <code>header=$Multiline(<<p>headers separated by newline</p>>)</code>. Example: <code>header=$Multiline(accessToken;dummyAccessToken==<br />
<br />
