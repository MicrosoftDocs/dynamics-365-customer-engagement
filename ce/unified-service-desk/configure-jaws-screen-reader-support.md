...
description: "Learn about JAWS screen reader for Windows screen reader for speech output in the Unified Service Desk client. All the Unified Service Desk controls and custom controls that are part of the Microsoft Dynamics 365 for Customer Engagement Web Client package  are JAWS compliant."
ms.custom: 
  - dyn365-a11y
  - dyn365-USD
keywords: "Dynamics 365 for Customer Engagement Unified Service Desk; Unified Service Desk; JAWS Screen Reader; Windows Screen Reader"
ms.date: 08/23/2017
ms.reviewer: ""
...
[!INCLUDE[pn-unified-service-desk](../includes/pn-unified-service-desk.md)] supports [!INCLUDE[pn-jaws](../includes/pn-jaws.md)] version 18 for Windows screen reader for speech output in the [!INCLUDE[pn-unified-service-desk](../includes/pn-unified-service-desk.md)] client. All the [!INCLUDE[pn-unified-service-desk](../includes/pn-unified-service-desk.md)] controls and custom controls that are part of the Microsoft Dynamics 365 for Customer Engagement Web Client package  are JAWS compliant. For the custom controls that you develop as part of the solution package, you need to define the necessary properties to make the controls JAWS compliant.
