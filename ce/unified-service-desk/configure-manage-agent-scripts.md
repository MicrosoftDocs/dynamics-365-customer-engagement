...
4. Click **NEW** on the command bar, and then specify the following information in the **New Agent Script Task** page:  
   ...
   |   **Category**   |                                                                                                                                                                                                                                                                                     Specify a category name to group, filter, or sort agent script tasks Microsoft Dynamics 365 for Customer Engagement while managing agent script tasks.<br /><br /> The category value is not used by agents in the client application.                                                                                                                                                                                                                                                                                      |
