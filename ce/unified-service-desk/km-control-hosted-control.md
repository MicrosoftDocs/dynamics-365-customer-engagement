...
<a name="Associate"></a>   
### Associate  
 Associates a knowledge base record in the Microsoft Dataverse platform with the parent entity record in **KM Control**.  
