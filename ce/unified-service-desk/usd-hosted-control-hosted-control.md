...
> [!NOTE]
> If you try to access a dialog box of a desktop application that is encapsulated in Unified Service Desk, the dialog box will open as an independent window outside the Unified Service Desk framework.
