...
description: "The Connection Manager hosted control type manages connections to the Microsoft Dataverse platform, and makes it available to the rest of the agent application."
author: v-sailab
ms.author: v-sailab
manager: shujoshi
ms.date: 12/31/2019
...
The **Connection Manager** hosted control type manages connections to the Microsoft Dataverse platform, and makes it available to the rest of the agent application. An instance of this hosted control is required by [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)], and only a single instance of this hosted control type must exist in your agent application.  
