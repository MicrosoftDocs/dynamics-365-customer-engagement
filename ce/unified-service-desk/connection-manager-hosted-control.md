...
description: "The Connection Manager hosted control type manages connections to the Dynamics 365 for Customer Engagement apps server, and makes it available to the rest of the agent application."
ms.custom: 
  - dyn365-USD
ms.date: 08/23/2017
ms.reviewer: ""
...
The **Connection Manager** hosted control type manages connections to the Dynamics 365 for Customer Engagement apps server, and makes it available to the rest of the agent application. An instance of this hosted control is required by [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)], and only a single instance of this hosted control type must exist in your agent application.  
