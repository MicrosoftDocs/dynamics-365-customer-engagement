...
## [Call center challenges and how Unified Service Desk can help](call-center-challenges-how-unified-service-desk-can-help.md)
## [Sample Unified Service desk applications](sample-unified-service-desk-applications.md)
### [Unified Service Desk New Environment sample package](unified-service-desk-new-environment-package.md)
### [Unified Service Desk Interactive Service Hub sample package](unified-service-desk-interactive-service-hub-package.md)
### [Unified Service Desk Dynamics 365 Web Client sample package](unified-service-desk-dynamics-365-web-client-package.md)
...
## [Install the Unified Service Desk client](install-upgrade-unified-service-desk-client.md)
## [Deploy sample Unified Service Desk applications using Package Deployer](deploy-sample-unified-service-desk-applications-using-package-deployer.md)
## [Upgrade Unified Service Desk](upgrade-unified-service-desk-solution.md)

# [Connect to a Dynamics 365 instance using the Unified Service Desk client](connect-dynamics-365-instance-using-unified-service-desk-client.md)
# [Update Unified Service Desk solution](update-unified-service-desk-solution.md)
...
# [Administer and manage Unified Service Desk](administer-manage-unified-service-desk.md)
## [Manage Options for Unified Service Desk](manage-options-unified-service-desk.md)
### [Configure client caching in Unified Service Desk](configure-client-caching-unified-service-desk.md)
### [Help improve Unified Service Desk](help-improve-unified-service-desk.md)
## [Configure auditing and diagnostics in Unified Service Desk](configure-auditing-diagnostics-unified-service-desk.md)
## [Distribute custom hosted controls using Customization Files](distribute-custom-hosted-controls-using-customization-files.md)
## [Security in Unified Service Desk](security-unified-service-desk.md)
### [Manage access using Unified Service Desk security roles](manage-access-using-unified-service-desk-security-roles.md)
### [Manage access using Unified Service Desk configuration](manage-access-using-unified-service-desk-configuration.md)
## [Migrate your Unified Service Desk configuration to another Customer Engagement instance](migrate-unified-service-desk-configuration-dynamics-365-server.md)
### [Import Unified Service Desk configuration data](import-unified-service-desk-configuration-data.md)
### [Export Unified Service Desk configuration data](export-unified-service-desk-configuration-data.md)
...
### [Hosted control types, actions, and events](.md)
### [View predefined actions and events for a hosted control](.md)
### [View embedded help for actions and events](.md)
### [Use replacement parameters to configure Unified Service Desk](.md)
### [Panels, panel types, and panel layouts in Unified Service Desk](.md)
### [Toolbars in Unified Service Desk](.md)
### [Use window navigation rules in Unified Service Desk](.md)
### [Session management in Unified Service Desk](.md)
### [Guide customer interactions with agent scripts](.md)
### [Execute scripts using scriptlets in Unified Service Desk](.md)
### [Search data using entity searches in Unified Service Desk](.md)
### [Use Dynamics 365 or Parature knowledge for effective customer engagement](.md)
...
# [Troubleshoot Unified Service Desk](troubleshoot-unified-service-desk.md)
## [Configure client diagnostic logging in Unified Service Desk](configure-client-diagnostic-logging-unified-service-desk.md)
