...
- **[!INCLUDE[pn_user_interface_integration](../includes/pn-user-interface-integration.md)] for [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]**: This solution contains the underlying entities required by the [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)] configuration entities.  
 ...
 [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)] comes with four sample applications. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Sample Unified Service Desk applications](../unified-service-desk/sample-unified-service-desk-applications.md)  
...
### See also  
 [Call center challenges and how Unified Service Desk can help?](../unified-service-desk/call-center-challenges-how-unified-service-desk-can-help.md)  
