...
Displays the Common Data Service platform lookup information dialog box so you can select an entity from a list.  
...
This action is used to inject the Common Data Service platform SDK JavaScript into the model-driven app form.  
