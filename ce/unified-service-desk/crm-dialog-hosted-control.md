...
description: "Learn about using the CRM Dialog hosted control type to work with Dynamics 365 for Customer Engagement dialogs. You can call the StartDialog action on your CRM Dialog hosted control to start a Dynamics 365 for Customer Engagement dialog within Unified Service Desk."
ms.custom: 
  - dyn365-USD
ms.date: 08/23/2017
ms.reviewer: ""
...
Use the **CRM Dialog** hosted control type to work with Dynamics 365 for Customer Engagement dialogs. You can call the **StartDialog** action on your CRM Dialog hosted control to start a Dynamics 365 for Customer Engagement dialog within [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)].  
...
## Create a CRM Dialog hosted control  
 ...
 ![Dynamics 365 for Customer Engagement dialog hosted control](../unified-service-desk/media/crm-itpro-usd-crmdialoghostedcontrol.PNG "Dynamics 365 for Customer Engagement dialog hosted control")  
...
| Parameter |                                                                                      Description                                                                                       |
|-----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|   Name    |                        The name of the dialog as seen in the **Settings** > **Process** section of [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)].                        |
