---
title: "Interactive Service Hub Page (Hosted Control) in Unified Service Desk for Dynamics 365 for Customer Engagement| MicrosoftDocs"
...
> [!NOTE]
>  The **Interactive Service Hub Page** type of hosted control supports all the UII actions supported by the **Dynamics 365 for Customer Engagement Page** type of hosted control. However, some UII actions are not available when you first create and save an instance of the **Interactive Service Hub Page** type hosted control. Any subsequent update to the hosted control instance adds the missing UII actions.  
...
### See also  
 ...
 [Dynamics 365 for Customer Engagement Page (Hosted Control)](../unified-service-desk/crm-page-hosted-control.md)
