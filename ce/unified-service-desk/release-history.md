...
| [Use the window.IsUSD property to invoke a Unified Service Desk event](chrome-process.md#use-the-windowisusd-property-to-invoke-unified-service-desk-event) | Updated information about window.IsUSD property <br><br> New section in [Use Chrome process to host web applications in Unified Service Desk](chrome-process.md).  |
