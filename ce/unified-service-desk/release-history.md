...
| [Edit a PDF in Chrome Process](chrome-process.md#edit-pdf-in-chrome-process) | Added information about editing PDFs. |
...
| [Use the window.IsUSD property to invoke a Unified Service Desk event](chrome-process.md#use-windowisusd-property-to-invoke-unified-service-desk-event) | Updated information about window.IsUSD property <br><br> New section in [Use Chrome process to host web applications in Unified Service Desk](chrome-process.md).  |
