...
This release includes a version change to Newtonsoft JSON from xxx to 13.0.2, and some security and accessibility fixes. There are no content-specific changes in this release.
