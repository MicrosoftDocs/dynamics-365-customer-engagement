...
-   Configurations for integrating [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)] with knowledge management  
 ...
 For more information on how to set up and administer [!INCLUDE[pn_unified_service_desk](../includes/pn-unified-service-desk.md)], see the [TechNet:Administration Guide for Unified Service Desk](https://technet.microsoft.com/library/dn499779.aspx).  
...
### See also  
 [Administration Guide for Unified Service Desk](https://technet.microsoft.com/library/dn499779.aspx)