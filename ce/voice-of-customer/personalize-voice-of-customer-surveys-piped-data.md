...
3.  Select the field you want to add. For example, if you want to display the customer's name, select **Customer**.  
 ...
 [  ![Left arrow icon](media/crm-ua-icons-arrowleftbluecircled.png "Left arrow icon")](design-your-survey.aspx) [Design your survey](design-your-survey.aspx)  
  
 [Routing rules](create-a-response-routing-rule-in-a-survey.aspx) [  ![Right arrow icon](media/crm-ua-icons-arrowrightbluecircled.png "Right arrow icon")](create-a-response-routing-rule-in-a-survey.aspx)  
