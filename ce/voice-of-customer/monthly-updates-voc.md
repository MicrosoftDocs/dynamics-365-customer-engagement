...
- **Validate Voice of the Survey solution for any issues**: You can now validate the status for your Voice of Customer solution. Validation allows you to check whether:
...
- **Validate a survey for any issues**: You can now validate a survey for any issues in its configuration.

- **Design interactive surveys by using answer tag**: You can now personalize a question based on the answer to the previous question by using an answer tag. The answer tag stores the response in a tag that can be replaced in subsequent questions and answers in the survey at run time.
