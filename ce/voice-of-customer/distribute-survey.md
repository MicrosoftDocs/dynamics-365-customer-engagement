...
- **Anonymous**: For these surveys, Dynamics 365 for Customer Engagement doesn't know who the respondents are. You can distribute a link to the survey using email, the social sites [!INCLUDE[tn-twitter](../includes/tn-twitter.md)] or [!INCLUDE[tn-facebook](../includes/tn-facebook.md)], or other webpages. These types of surveys are best suited for lead creation or information-gathering where the identity of the respondent is not important.

- **Non-anonymous**: You send survey invitation links to specific contacts, accounts, or leads in Dynamics 365 for Customer Engagement. You can personalize the invitation links using the customer name, product name, agent name, and so on.
...
Dynamics 365 for Customer Engagement doesn't associate responses with a customer record in Dynamics 365 for Customer Engagement. If you want to create a lead from an anonymous response, set **Create Lead For Anonymous Responses** to **Yes**. [!INCLUDE[proc-more-information](../includes/proc-more-information.md)] [Create a lead from a survey response](design-advanced-survey.md#create-a-lead-from-a-survey-response)  

## Distribute a survey to non-anonymous respondents

For non-anonymous surveys, the link you send to respondents is specific and unique for each customer. Dynamics 365 for Customer Engagement generates the URLs for you to use when you create a survey invitation or embed the survey snippet in an email.
...
4. Under **Invitations and Actions**, copy the value from the **Email Snippet** field and send it to your respondents through Dynamics 365 for Customer Engagement email.
...
You can [create an email template](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/admin/create-templates-email) with the survey snippet and use it to send emails to Dynamics 365 for Customer Engagement contacts.  

You can [send direct email](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/basics/send-bulk-email-customers) to a contact in Dynamics 365 for Customer Engagement by selecting the survey email template from the email template list.  
...
You can also select an email template when you create an email in Dynamics 365 for Customer Engagement:
...
You can create a survey activity or survey invitation to create personalized invitation links that are distributed by using a non&ndash;Dynamics 365 for Customer Engagement email program. These personalized invitation links have the following advantages:
...
> [!NOTE]
> If you send email by using Dynamics 365 for Customer Engagement, a survey activity is created automatically for the respondent.

## Personalize survey invitations

If you want to personalize your survey invitation in a Dynamics 365 for Customer Engagement email, make sure your survey snippet contains piped data, and then add a vertical bar (|) (also called a pipe), plus the parameters after the GUID, in your email invitation. The syntax to insert piped data in a survey snippet is:
