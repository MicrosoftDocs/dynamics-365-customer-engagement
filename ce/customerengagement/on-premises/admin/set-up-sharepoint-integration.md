...
- Users can perform [!INCLUDE[pn_SharePoint_short](../includes/pn-sharepoint-short.md)] actions from the Customer Engagement (on-premises) command bar.  
  
### See also

[Configure Azure app for SharePoint online access](on-prem-server-configure-azure-app-with-sharepoint-access.md)  <br />
