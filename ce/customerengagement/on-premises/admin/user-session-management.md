...
1. Select and run `MicrosoftDynamics365SDK.exe` to extract the download and create an SDK folder on your Dynamics 365 for Customer Engagement server.
