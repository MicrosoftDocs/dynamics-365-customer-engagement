...
|    **Searchable**     |                                                                                                                                                                                                                                                                                                                                                                                                 When a field is searchable it appears in Advanced Find and is available for filtering records when customizing views. Use this when there are fields for the entity that you don’t use. Setting this to **No** reduces the number of filtering options shown to people using Advanced Find. The **Searchable** property does not affect the columns available for display.                                                                                                                                                                                                                                                                                                                                                                                                 |
