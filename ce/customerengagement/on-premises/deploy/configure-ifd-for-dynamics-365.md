...
> [!NOTE]
> When IFD is enabled, you can’t access the sitemap designer of a UCI modeldriven App using an intranet URL, such as https://internalurl.contoso.com/orgname. You must use the external URL that has been configured for IFD.
