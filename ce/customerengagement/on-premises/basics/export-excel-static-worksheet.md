...
[!INCLUDE [applies-to-unified-interface](../includes/applies-to-unified-interface.md)] [Export to an Excel static worksheet](/powerapps/user/export-excel-static-worksheet)
