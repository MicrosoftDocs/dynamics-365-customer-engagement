---
title: "Basics guide to Dynamics 365 Customer Engagement (on-premises)"
keywords: sales; service; marketing
description: "This guide contains the basics you need to know to navigate the system, enter data, effectively use dashboards, charts, and reports, get support, and more."
ms.custom: 
ms.date: 05/05/2020
ms.reviewer: 
ms.prod: d365ce-op
...
[!INCLUDE [applies-to-unified-interface](../includes/applies-to-unified-interface.md)] [Use model-driven apps in Power Apps](/powerapps/user/use-model-driven-apps)
...
Dynamics 365 Customer Engagement (on-premises) is not just for using in a web browser on your computer — you
can also use it on your phone, on your [!INCLUDE[tn_android](../includes/tn-android.md)] tablet, or on your [!INCLUDE[tn_apple_ipad](../includes/tn-apple-ipad.md)]. This guide covers using the system in your web browser, to keep it as short
as possible and because the mobile apps work almost the same as on the web.

Download the app from the online store for your phone or tablet (search for "Dynamics 365" to find the app). You may need to check with the person who manages your system day-to-day, to make sure you have the security permissions required to use the app. To learn more, see [Get started with Dynamics 365 for phones](/mobile-app/set-up-dynamics-365-for-phones-and-dynamics-365-for-tablets). You can also do your work from within [!INCLUDE[pn_outlook_short](../includes/pn-outlook-short.md)], if you want. Check with your system administrator for details, or see [Dynamics 365 App for Outlook User's Guide](/outlook-app/dynamics-365-app-outlook-user-s-guide).
...
may have added in extra features or may have customized the system to match your industry and the way you do things.
