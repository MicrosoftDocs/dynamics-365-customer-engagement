...
> [!NOTE]
> - As of November 2019, Office Groups with MIP (Microsoft Information Protection) sensitivity labels can’t be created from dynamics. You have to create outside of Dynamics, see [Learn more about creating new group with Sensitivity Label](https://docs.microsoft.com/en-us/microsoft-365/compliance/sensitivity-labels-teams-groups-sites#apply-a-sensitivity-label-to-a-new-group), and then add the link from dynamics by following above steps to Join a group.
