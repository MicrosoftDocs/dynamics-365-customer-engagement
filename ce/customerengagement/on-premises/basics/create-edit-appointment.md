...
> [!NOTE]
> Recurring appointments are not supported when you are using the Dynamics 365 App for Outlook, Dynamics 365 for phones app, and when running the web client on your mobile phone web browser. 
