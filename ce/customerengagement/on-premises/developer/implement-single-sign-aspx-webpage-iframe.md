...
### Background information  
 For more information about how to configure a relying party, see the following topic: [Secure Azure Web Role ASP.NET Web Application Using Access Control Service v2.0](https://learn.microsoft.com/en-us/archive/technet-wiki/2590.secure-azure-web-role-asp-net-web-application-using-access-control-service-v2-0)  
