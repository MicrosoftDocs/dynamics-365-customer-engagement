...
Creates the appointment instance using the [BookRequest](/dotnet/api/microsoft.crm.sdk.messages.bookrequest?view=dynamics-general-ce-9&preserve-view=true) message and verifies that the appointment has been scheduled or not.
