...
The following is the schema definition for an import/export customization file from [!INCLUDE[pn_dynamics_crm](../../includes/pn-dynamics-crm.md)]. Note that this file includes the following schemas:  
