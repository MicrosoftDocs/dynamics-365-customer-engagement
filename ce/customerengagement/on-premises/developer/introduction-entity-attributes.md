...
| <xref:Microsoft.Xrm.Sdk.Metadata.MultiSelectPicklistAttributeMetadata> | MultiSelectPicklistType |                                                                                                                                                                                                                                                                                                                                                                                                                                                      **Note:** Multi-select picklist attributes were added with the Dynamics 365 Customer Engagement Version 9.0. <br />More information [Multi-Select Picklist attributes](multi-select-picklist.md). <br />Within the customization tools in the application these attributes are called **Multi-Select Option Set** fields.                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
