---
title: "Invoice entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/invoices(*invoiceid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
...
|Create|POST [*org URI*]/api/data/v9.0/invoices<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/invoices(*invoiceid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|Retrieve|GET [*org URI*]/api/data/v9.0/invoices(*invoiceid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/invoices<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|SetState|PATCH [*org URI*]/api/data/v9.0/invoices(*invoiceid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/invoices(*invoiceid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [Invoice_ActivityPointers](activitypointer.md#BKMK_Invoice_ActivityPointers) many-to-one relationship for the [activitypointer](activitypointer.md) entity.
...
Same as the [Invoice_SyncErrors](syncerror.md#BKMK_Invoice_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) entity.
...
Same as the [invoice_activity_parties](activityparty.md#BKMK_invoice_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) entity.
...
Same as the [Invoice_AsyncOperations](asyncoperation.md#BKMK_Invoice_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) entity.
...
Same as the [Invoice_MailboxTrackingFolder](mailboxtrackingfolder.md#BKMK_Invoice_MailboxTrackingFolder) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) entity.
...
Same as the [Invoice_ProcessSessions](processsession.md#BKMK_Invoice_ProcessSessions) many-to-one relationship for the [processsession](processsession.md) entity.
...
Same as the [Invoice_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Invoice_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) entity.
...
Same as the [invoice_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_invoice_principalobjectattributeaccess) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) entity.
...
Same as the [Invoice_Appointments](appointment.md#BKMK_Invoice_Appointments) many-to-one relationship for the [appointment](appointment.md) entity.
...
Same as the [Invoice_Emails](email.md#BKMK_Invoice_Emails) many-to-one relationship for the [email](email.md) entity.
...
Same as the [Invoice_Faxes](fax.md#BKMK_Invoice_Faxes) many-to-one relationship for the [fax](fax.md) entity.
...
Same as the [Invoice_Letters](letter.md#BKMK_Invoice_Letters) many-to-one relationship for the [letter](letter.md) entity.
...
Same as the [Invoice_Phonecalls](phonecall.md#BKMK_Invoice_Phonecalls) many-to-one relationship for the [phonecall](phonecall.md) entity.
...
Same as the [Invoice_Tasks](task.md#BKMK_Invoice_Tasks) many-to-one relationship for the [task](task.md) entity.
...
Same as the [Invoice_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_Invoice_RecurringAppointmentMasters) many-to-one relationship for the [recurringappointmentmaster](recurringappointmentmaster.md) entity.
...
Same as the [Invoice_SocialActivities](socialactivity.md#BKMK_Invoice_SocialActivities) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [invoice_connections1](connection.md#BKMK_invoice_connections1) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [invoice_connections2](connection.md#BKMK_invoice_connections2) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [Invoice_Annotation](annotation.md#BKMK_Invoice_Annotation) many-to-one relationship for the [annotation](annotation.md) entity.
...
Same as the [Invoice_ServiceAppointments](serviceappointment.md#BKMK_Invoice_ServiceAppointments) many-to-one relationship for the [serviceappointment](serviceappointment.md) entity.
...
Same as the [invoice_details](invoicedetail.md#BKMK_invoice_details) many-to-one relationship for the [invoicedetail](invoicedetail.md) entity.
...
Same as the [slakpiinstance_invoice](slakpiinstance.md#BKMK_slakpiinstance_invoice) many-to-one relationship for the [slakpiinstance](slakpiinstance.md) entity.
...
See the [lk_invoicebase_createdby](systemuser.md#BKMK_lk_invoicebase_createdby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_invoice_createdonbehalfby"></a> lk_invoice_createdonbehalfby

**Added by**: System Solution Solution

See the [lk_invoice_createdonbehalfby](systemuser.md#BKMK_lk_invoice_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_invoicebase_modifiedby"></a> lk_invoicebase_modifiedby

**Added by**: System Solution Solution

See the [lk_invoicebase_modifiedby](systemuser.md#BKMK_lk_invoicebase_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_invoice_modifiedonbehalfby"></a> lk_invoice_modifiedonbehalfby

**Added by**: System Solution Solution

See the [lk_invoice_modifiedonbehalfby](systemuser.md#BKMK_lk_invoice_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_system_user_invoices"></a> system_user_invoices

**Added by**: System Solution Solution

See the [system_user_invoices](systemuser.md#BKMK_system_user_invoices) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_team_invoices"></a> team_invoices

**Added by**: System Solution Solution

See the [team_invoices](team.md#BKMK_team_invoices) one-to-many relationship for the [team](team.md) entity.

### <a name="BKMK_business_unit_invoices"></a> business_unit_invoices

**Added by**: System Solution Solution

See the [business_unit_invoices](businessunit.md#BKMK_business_unit_invoices) one-to-many relationship for the [businessunit](businessunit.md) entity.

### <a name="BKMK_processstage_invoices"></a> processstage_invoices

**Added by**: System Solution Solution

See the [processstage_invoices](processstage.md#BKMK_processstage_invoices) one-to-many relationship for the [processstage](processstage.md) entity.

### <a name="BKMK_transactioncurrency_invoice"></a> transactioncurrency_invoice

**Added by**: System Solution Solution

See the [transactioncurrency_invoice](transactioncurrency.md#BKMK_transactioncurrency_invoice) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) entity.

### <a name="BKMK_invoice_customer_accounts"></a> invoice_customer_accounts

**Added by**: System Solution Solution

See the [invoice_customer_accounts](account.md#BKMK_invoice_customer_accounts) one-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_invoice_customer_contacts"></a> invoice_customer_contacts

**Added by**: System Solution Solution

See the [invoice_customer_contacts](contact.md#BKMK_invoice_customer_contacts) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_opportunity_invoices"></a> opportunity_invoices

See the [opportunity_invoices](opportunity.md#BKMK_opportunity_invoices) one-to-many relationship for the [opportunity](opportunity.md) entity.

### <a name="BKMK_price_level_invoices"></a> price_level_invoices

**Added by**: Product Management Solution

See the [price_level_invoices](pricelevel.md#BKMK_price_level_invoices) one-to-many relationship for the [pricelevel](pricelevel.md) entity.

### <a name="BKMK_order_invoices"></a> order_invoices

See the [order_invoices](salesorder.md#BKMK_order_invoices) one-to-many relationship for the [salesorder](salesorder.md) entity.

### <a name="BKMK_sla_invoice"></a> sla_invoice

**Added by**: System Solution Solution

See the [sla_invoice](sla.md#BKMK_sla_invoice) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_manualsla_invoice"></a> manualsla_invoice

**Added by**: System Solution Solution

See the [manualsla_invoice](sla.md#BKMK_manualsla_invoice) one-to-many relationship for the [sla](sla.md) entity.
<a name="manytomany"></a>
