---
title: "Plug-in Type (PluginType)  entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
description: "Includes schema information and supported messages for the Plug-in Type (PluginType)  entity."
ms.date: 08/29/2022
ms.topic: "reference"
...
# Plug-in Type (PluginType)  entity reference
...
|-|-|-|
|Create|POST [*org URI*]/api/data/v9.0/plugintypes<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/plugintypes(*plugintypeid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/plugintypes(*plugintypeid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/plugintypes<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/plugintypes(*plugintypeid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [plugin_type_service](service.md#BKMK_plugin_type_service) many-to-one relationship for the [service](service.md) entity.
...
Same as the [plugintype_sdkmessageprocessingstep](sdkmessageprocessingstep.md#BKMK_plugintype_sdkmessageprocessingstep) many-to-one relationship for the [sdkmessageprocessingstep](sdkmessageprocessingstep.md) entity.
...
Same as the [plugintype_plugintypestatistic](plugintypestatistic.md#BKMK_plugintype_plugintypestatistic) many-to-one relationship for the [plugintypestatistic](plugintypestatistic.md) entity.
...
Same as the [plugintypeid_sdkmessageprocessingstep](sdkmessageprocessingstep.md#BKMK_plugintypeid_sdkmessageprocessingstep) many-to-one relationship for the [sdkmessageprocessingstep](sdkmessageprocessingstep.md) entity.
...
See the [pluginassembly_plugintype](pluginassembly.md#BKMK_pluginassembly_plugintype) one-to-many relationship for the [pluginassembly](pluginassembly.md) entity.

### <a name="BKMK_lk_plugintype_createdonbehalfby"></a> lk_plugintype_createdonbehalfby

See the [lk_plugintype_createdonbehalfby](systemuser.md#BKMK_lk_plugintype_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_organization_plugintype"></a> organization_plugintype

See the [organization_plugintype](organization.md#BKMK_organization_plugintype) one-to-many relationship for the [organization](organization.md) entity.

### <a name="BKMK_modifiedby_plugintype"></a> modifiedby_plugintype

See the [modifiedby_plugintype](systemuser.md#BKMK_modifiedby_plugintype) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_createdby_plugintype"></a> createdby_plugintype

See the [createdby_plugintype](systemuser.md#BKMK_createdby_plugintype) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_plugintype_modifiedonbehalfby"></a> lk_plugintype_modifiedonbehalfby

See the [lk_plugintype_modifiedonbehalfby](systemuser.md#BKMK_lk_plugintype_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.
