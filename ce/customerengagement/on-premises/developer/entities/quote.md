---
title: "Quote entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/quotes(*quoteid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
|Associate|[Associate and disassociate entities](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.AssociateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Associate*>|
...
|Create|POST [*org URI*]/api/data/v9.0/quotes<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/quotes(*quoteid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Disassociate|[Associate and disassociate entities](/power-apps/developer/data-platform/webapi/associate-disassociate-entities-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.DisassociateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Disassociate*>|
...
|Retrieve|GET [*org URI*]/api/data/v9.0/quotes(*quoteid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/quotes<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|SetState|PATCH [*org URI*]/api/data/v9.0/quotes(*quoteid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/quotes(*quoteid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [Quote_ActivityPointers](activitypointer.md#BKMK_Quote_ActivityPointers) many-to-one relationship for the [activitypointer](activitypointer.md) entity.
...
Same as the [Quote_SyncErrors](syncerror.md#BKMK_Quote_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) entity.
...
Same as the [quote_activity_parties](activityparty.md#BKMK_quote_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) entity.
...
Same as the [Quote_DuplicateMatchingRecord](duplicaterecord.md#BKMK_Quote_DuplicateMatchingRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Quote_DuplicateBaseRecord](duplicaterecord.md#BKMK_Quote_DuplicateBaseRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Quote_SharepointDocumentLocation](sharepointdocumentlocation.md#BKMK_Quote_SharepointDocumentLocation) many-to-one relationship for the [sharepointdocumentlocation](sharepointdocumentlocation.md) entity.
...
Same as the [Quote_AsyncOperations](asyncoperation.md#BKMK_Quote_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) entity.
...
Same as the [Quote_MailboxTrackingFolder](mailboxtrackingfolder.md#BKMK_Quote_MailboxTrackingFolder) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) entity.
...
Same as the [Quote_ProcessSessions](processsession.md#BKMK_Quote_ProcessSessions) many-to-one relationship for the [processsession](processsession.md) entity.
...
Same as the [Quote_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Quote_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) entity.
...
Same as the [quote_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_quote_principalobjectattributeaccess) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) entity.
...
Same as the [Quote_Appointments](appointment.md#BKMK_Quote_Appointments) many-to-one relationship for the [appointment](appointment.md) entity.
...
Same as the [Quote_Emails](email.md#BKMK_Quote_Emails) many-to-one relationship for the [email](email.md) entity.
...
Same as the [Quote_Faxes](fax.md#BKMK_Quote_Faxes) many-to-one relationship for the [fax](fax.md) entity.
...
Same as the [Quote_Letters](letter.md#BKMK_Quote_Letters) many-to-one relationship for the [letter](letter.md) entity.
...
Same as the [Quote_Phonecalls](phonecall.md#BKMK_Quote_Phonecalls) many-to-one relationship for the [phonecall](phonecall.md) entity.
...
Same as the [Quote_Tasks](task.md#BKMK_Quote_Tasks) many-to-one relationship for the [task](task.md) entity.
...
Same as the [Quote_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_Quote_RecurringAppointmentMasters) many-to-one relationship for the [recurringappointmentmaster](recurringappointmentmaster.md) entity.
...
Same as the [Quote_SocialActivities](socialactivity.md#BKMK_Quote_SocialActivities) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [quote_connections1](connection.md#BKMK_quote_connections1) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [quote_connections2](connection.md#BKMK_quote_connections2) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [Quote_Annotation](annotation.md#BKMK_Quote_Annotation) many-to-one relationship for the [annotation](annotation.md) entity.
...
Same as the [Quote_ServiceAppointments](serviceappointment.md#BKMK_Quote_ServiceAppointments) many-to-one relationship for the [serviceappointment](serviceappointment.md) entity.
...
Same as the [quote_QuoteCloses](quoteclose.md#BKMK_quote_QuoteCloses) many-to-one relationship for the [quoteclose](quoteclose.md) entity.
...
Same as the [lk_opportunitysalesprocess_quoteid](opportunitysalesprocess.md#BKMK_lk_opportunitysalesprocess_quoteid) many-to-one relationship for the [opportunitysalesprocess](opportunitysalesprocess.md) entity.
...
Same as the [quote_details](quotedetail.md#BKMK_quote_details) many-to-one relationship for the [quotedetail](quotedetail.md) entity.
...
Same as the [quote_orders](salesorder.md#BKMK_quote_orders) many-to-one relationship for the [salesorder](salesorder.md) entity.
...
Same as the [Quote_QuoteClose](quoteclose.md#BKMK_Quote_QuoteClose) many-to-one relationship for the [quoteclose](quoteclose.md) entity.
...
Same as the [slakpiinstance_quote](slakpiinstance.md#BKMK_slakpiinstance_quote) many-to-one relationship for the [slakpiinstance](slakpiinstance.md) entity.
...
See the [lk_quotebase_createdby](systemuser.md#BKMK_lk_quotebase_createdby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_quote_createdonbehalfby"></a> lk_quote_createdonbehalfby

**Added by**: System Solution Solution

See the [lk_quote_createdonbehalfby](systemuser.md#BKMK_lk_quote_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_quotebase_modifiedby"></a> lk_quotebase_modifiedby

**Added by**: System Solution Solution

See the [lk_quotebase_modifiedby](systemuser.md#BKMK_lk_quotebase_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_quote_modifiedonbehalfby"></a> lk_quote_modifiedonbehalfby

**Added by**: System Solution Solution

See the [lk_quote_modifiedonbehalfby](systemuser.md#BKMK_lk_quote_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_system_user_quotes"></a> system_user_quotes

**Added by**: System Solution Solution

See the [system_user_quotes](systemuser.md#BKMK_system_user_quotes) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_team_quotes"></a> team_quotes

**Added by**: System Solution Solution

See the [team_quotes](team.md#BKMK_team_quotes) one-to-many relationship for the [team](team.md) entity.

### <a name="BKMK_business_unit_quotes"></a> business_unit_quotes

**Added by**: System Solution Solution

See the [business_unit_quotes](businessunit.md#BKMK_business_unit_quotes) one-to-many relationship for the [businessunit](businessunit.md) entity.

### <a name="BKMK_processstage_quotes"></a> processstage_quotes

**Added by**: System Solution Solution

See the [processstage_quotes](processstage.md#BKMK_processstage_quotes) one-to-many relationship for the [processstage](processstage.md) entity.

### <a name="BKMK_transactioncurrency_quote"></a> transactioncurrency_quote

**Added by**: System Solution Solution

See the [transactioncurrency_quote](transactioncurrency.md#BKMK_transactioncurrency_quote) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) entity.

### <a name="BKMK_quote_customer_accounts"></a> quote_customer_accounts

**Added by**: System Solution Solution

See the [quote_customer_accounts](account.md#BKMK_quote_customer_accounts) one-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_quote_customer_contacts"></a> quote_customer_contacts

**Added by**: System Solution Solution

See the [quote_customer_contacts](contact.md#BKMK_quote_customer_contacts) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_opportunity_quotes"></a> opportunity_quotes

See the [opportunity_quotes](opportunity.md#BKMK_opportunity_quotes) one-to-many relationship for the [opportunity](opportunity.md) entity.

### <a name="BKMK_price_level_quotes"></a> price_level_quotes

**Added by**: Product Management Solution

See the [price_level_quotes](pricelevel.md#BKMK_price_level_quotes) one-to-many relationship for the [pricelevel](pricelevel.md) entity.

### <a name="BKMK_manualsla_quote"></a> manualsla_quote

**Added by**: System Solution Solution

See the [manualsla_quote](sla.md#BKMK_manualsla_quote) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_sla_quote"></a> sla_quote

**Added by**: System Solution Solution

See the [sla_quote](sla.md#BKMK_sla_quote) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_campaign_quotes"></a> campaign_quotes

**Added by**: Marketing Solution

See the [campaign_quotes](campaign.md#BKMK_campaign_quotes) one-to-many relationship for the [campaign](campaign.md) entity.
<a name="manytomany"></a>
