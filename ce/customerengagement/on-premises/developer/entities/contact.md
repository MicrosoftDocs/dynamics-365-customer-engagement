---
title: "Contact entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/contacts(*contactid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
...
|Create|POST [*org URI*]/api/data/v9.0/contacts<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/contacts(*contactid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|msdyn_GDPROptoutContact| |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|Retrieve|GET [*org URI*]/api/data/v9.0/contacts(*contactid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/contacts<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|SetState|PATCH [*org URI*]/api/data/v9.0/contacts(*contactid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/contacts(*contactid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [contact_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_contact_principalobjectattributeaccess) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) entity.
...
Same as the [lead_customer_contacts](lead.md#BKMK_lead_customer_contacts) many-to-one relationship for the [lead](lead.md) entity.
...
Same as the [lead_parent_contact](lead.md#BKMK_lead_parent_contact) many-to-one relationship for the [lead](lead.md) entity.
...
Same as the [contact_bookableresource_ContactId](bookableresource.md#BKMK_contact_bookableresource_ContactId) many-to-one relationship for the [bookableresource](bookableresource.md) entity.
...
Same as the [contact_BulkOperations](bulkoperation.md#BKMK_contact_BulkOperations) many-to-one relationship for the [bulkoperation](bulkoperation.md) entity.
...
Same as the [contact_CampaignResponses](campaignresponse.md#BKMK_contact_CampaignResponses) many-to-one relationship for the [campaignresponse](campaignresponse.md) entity.
...
Same as the [CreatedContact_BulkOperationLogs](bulkoperationlog.md#BKMK_CreatedContact_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) entity.
...
Same as the [SourceContact_BulkOperationLogs](bulkoperationlog.md#BKMK_SourceContact_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) entity.
...
Same as the [Contact_ServiceAppointments](serviceappointment.md#BKMK_Contact_ServiceAppointments) many-to-one relationship for the [serviceappointment](serviceappointment.md) entity.
...
Same as the [contact_as_responsible_contact](incident.md#BKMK_contact_as_responsible_contact) many-to-one relationship for the [incident](incident.md) entity.
...
Same as the [contractlineitem_customer_contacts](contractdetail.md#BKMK_contractlineitem_customer_contacts) many-to-one relationship for the [contractdetail](contractdetail.md) entity.
...
Same as the [contract_billingcustomer_contacts](contract.md#BKMK_contract_billingcustomer_contacts) many-to-one relationship for the [contract](contract.md) entity.
...
Same as the [contract_customer_contacts](contract.md#BKMK_contract_customer_contacts) many-to-one relationship for the [contract](contract.md) entity.
...
Same as the [incident_customer_contacts](incident.md#BKMK_incident_customer_contacts) many-to-one relationship for the [incident](incident.md) entity.
...
Same as the [contact_as_primary_contact](incident.md#BKMK_contact_as_primary_contact) many-to-one relationship for the [incident](incident.md) entity.
...
Same as the [contact_entitlement_ContactId](entitlement.md#BKMK_contact_entitlement_ContactId) many-to-one relationship for the [entitlement](entitlement.md) entity.
...
Same as the [contact_entitlement_Customer](entitlement.md#BKMK_contact_entitlement_Customer) many-to-one relationship for the [entitlement](entitlement.md) entity.
...
Same as the [invoice_customer_contacts](invoice.md#BKMK_invoice_customer_contacts) many-to-one relationship for the [invoice](invoice.md) entity.
...
Same as the [opportunity_customer_contacts](opportunity.md#BKMK_opportunity_customer_contacts) many-to-one relationship for the [opportunity](opportunity.md) entity.
...
Same as the [order_customer_contacts](salesorder.md#BKMK_order_customer_contacts) many-to-one relationship for the [salesorder](salesorder.md) entity.
...
Same as the [quote_customer_contacts](quote.md#BKMK_quote_customer_contacts) many-to-one relationship for the [quote](quote.md) entity.
...
Same as the [opportunity_parent_contact](opportunity.md#BKMK_opportunity_parent_contact) many-to-one relationship for the [opportunity](opportunity.md) entity.
...
Same as the [slakpiinstance_contact](slakpiinstance.md#BKMK_slakpiinstance_contact) many-to-one relationship for the [slakpiinstance](slakpiinstance.md) entity.
...
Same as the [socialactivity_postauthoraccount_contacts](socialactivity.md#BKMK_socialactivity_postauthoraccount_contacts) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [Contact_Email_EmailSender](email.md#BKMK_Contact_Email_EmailSender) many-to-one relationship for the [email](email.md) entity.
...
Same as the [Contact_Tasks](task.md#BKMK_Contact_Tasks) many-to-one relationship for the [task](task.md) entity.
...
Same as the [contact_PostFollows](postfollow.md#BKMK_contact_PostFollows) many-to-one relationship for the [postfollow](postfollow.md) entity.
...
Same as the [Contact_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_Contact_RecurringAppointmentMasters) many-to-one relationship for the [recurringappointmentmaster](recurringappointmentmaster.md) entity.
...
Same as the [contact_master_contact](contact.md#BKMK_contact_master_contact) many-to-one relationship for the [contact](contact.md) entity.
...
Same as the [lk_contact_feedback_createdby](feedback.md#BKMK_lk_contact_feedback_createdby) many-to-one relationship for the [feedback](feedback.md) entity.
...
Same as the [contact_actioncard](actioncard.md#BKMK_contact_actioncard) many-to-one relationship for the [actioncard](actioncard.md) entity.
...
Same as the [contact_connections2](connection.md#BKMK_contact_connections2) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [Contact_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Contact_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) entity.
...
Same as the [contact_activity_parties](activityparty.md#BKMK_contact_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) entity.
...
Same as the [Contact_DuplicateBaseRecord](duplicaterecord.md#BKMK_Contact_DuplicateBaseRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Contact_Annotation](annotation.md#BKMK_Contact_Annotation) many-to-one relationship for the [annotation](annotation.md) entity.
...
Same as the [Contact_SocialActivities](socialactivity.md#BKMK_Contact_SocialActivities) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [Contact_ActivityPointers](activitypointer.md#BKMK_Contact_ActivityPointers) many-to-one relationship for the [activitypointer](activitypointer.md) entity.
...
Same as the [Contact_MailboxTrackingFolder](mailboxtrackingfolder.md#BKMK_Contact_MailboxTrackingFolder) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) entity.
...
Same as the [account_primary_contact](account.md#BKMK_account_primary_contact) many-to-one relationship for the [account](account.md) entity.
...
Same as the [Socialprofile_customer_contacts](socialprofile.md#BKMK_Socialprofile_customer_contacts) many-to-one relationship for the [socialprofile](socialprofile.md) entity.
...
Same as the [socialactivity_postauthor_contacts](socialactivity.md#BKMK_socialactivity_postauthor_contacts) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [lk_contact_feedback_createdonbehalfby](feedback.md#BKMK_lk_contact_feedback_createdonbehalfby) many-to-one relationship for the [feedback](feedback.md) entity.
...
Same as the [Contact_Emails](email.md#BKMK_Contact_Emails) many-to-one relationship for the [email](email.md) entity.
...
Same as the [Contact_Appointments](appointment.md#BKMK_Contact_Appointments) many-to-one relationship for the [appointment](appointment.md) entity.
...
Same as the [Contact_Feedback](feedback.md#BKMK_Contact_Feedback) many-to-one relationship for the [feedback](feedback.md) entity.
...
Same as the [Contact_ProcessSessions](processsession.md#BKMK_Contact_ProcessSessions) many-to-one relationship for the [processsession](processsession.md) entity.
...
Same as the [Contact_AsyncOperations](asyncoperation.md#BKMK_Contact_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) entity.
...
Same as the [contact_connections1](connection.md#BKMK_contact_connections1) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [Contact_CustomerAddress](customeraddress.md#BKMK_Contact_CustomerAddress) many-to-one relationship for the [customeraddress](customeraddress.md) entity.
...
Same as the [Contact_Phonecalls](phonecall.md#BKMK_Contact_Phonecalls) many-to-one relationship for the [phonecall](phonecall.md) entity.
...
Same as the [contact_customer_contacts](contact.md#BKMK_contact_customer_contacts) many-to-one relationship for the [contact](contact.md) entity.
...
Same as the [Contact_SyncErrors](syncerror.md#BKMK_Contact_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) entity.
...
Same as the [Contact_DuplicateMatchingRecord](duplicaterecord.md#BKMK_Contact_DuplicateMatchingRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Contact_Faxes](fax.md#BKMK_Contact_Faxes) many-to-one relationship for the [fax](fax.md) entity.
...
Same as the [Contact_Letters](letter.md#BKMK_Contact_Letters) many-to-one relationship for the [letter](letter.md) entity.
...
See the [contact_originating_lead](lead.md#BKMK_contact_originating_lead) one-to-many relationship for the [lead](lead.md) entity.

### <a name="BKMK_price_level_contacts"></a> price_level_contacts

**Added by**: Product Management Solution

See the [price_level_contacts](pricelevel.md#BKMK_price_level_contacts) one-to-many relationship for the [pricelevel](pricelevel.md) entity.

### <a name="BKMK_equipment_contacts"></a> equipment_contacts

**Added by**: Service Solution

See the [equipment_contacts](equipment.md#BKMK_equipment_contacts) one-to-many relationship for the [equipment](equipment.md) entity.

### <a name="BKMK_service_contacts"></a> service_contacts

**Added by**: Service Solution

See the [service_contacts](service.md#BKMK_service_contacts) one-to-many relationship for the [service](service.md) entity.

### <a name="BKMK_transactioncurrency_contact"></a> transactioncurrency_contact

See the [transactioncurrency_contact](transactioncurrency.md#BKMK_transactioncurrency_contact) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) entity.

### <a name="BKMK_contact_master_contact"></a> contact_master_contact

See the [contact_master_contact](contact.md#BKMK_contact_master_contact) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_lk_contactbase_createdby"></a> lk_contactbase_createdby

See the [lk_contactbase_createdby](systemuser.md#BKMK_lk_contactbase_createdby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_contact_createdonbehalfby"></a> lk_contact_createdonbehalfby

See the [lk_contact_createdonbehalfby](systemuser.md#BKMK_lk_contact_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_team_contacts"></a> team_contacts

See the [team_contacts](team.md#BKMK_team_contacts) one-to-many relationship for the [team](team.md) entity.

### <a name="BKMK_manualsla_contact"></a> manualsla_contact

See the [manualsla_contact](sla.md#BKMK_manualsla_contact) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_system_user_contacts"></a> system_user_contacts

See the [system_user_contacts](systemuser.md#BKMK_system_user_contacts) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_contactbase_modifiedby"></a> lk_contactbase_modifiedby

See the [lk_contactbase_modifiedby](systemuser.md#BKMK_lk_contactbase_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_sla_contact"></a> sla_contact

See the [sla_contact](sla.md#BKMK_sla_contact) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_contact_customer_accounts"></a> contact_customer_accounts

See the [contact_customer_accounts](account.md#BKMK_contact_customer_accounts) one-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_lk_contact_modifiedonbehalfby"></a> lk_contact_modifiedonbehalfby

See the [lk_contact_modifiedonbehalfby](systemuser.md#BKMK_lk_contact_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_processstage_contact"></a> processstage_contact

See the [processstage_contact](processstage.md#BKMK_processstage_contact) one-to-many relationship for the [processstage](processstage.md) entity.

### <a name="BKMK_contact_owning_user"></a> contact_owning_user

See the [contact_owning_user](systemuser.md#BKMK_contact_owning_user) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_contact_customer_contacts"></a> contact_customer_contacts

See the [contact_customer_contacts](contact.md#BKMK_contact_customer_contacts) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_business_unit_contacts"></a> business_unit_contacts

See the [business_unit_contacts](businessunit.md#BKMK_business_unit_contacts) one-to-many relationship for the [businessunit](businessunit.md) entity.
<a name="manytomany"></a>
...
See the [listcontact_association](list.md#BKMK_listcontact_association) many-to-many relationship for the [list](list.md) entity.
...
See the [contactinvoices_association](invoice.md#BKMK_contactinvoices_association) many-to-many relationship for the [invoice](invoice.md) entity.

### <a name="BKMK_contactorders_association"></a> contactorders_association

See the [contactorders_association](salesorder.md#BKMK_contactorders_association) many-to-many relationship for the [salesorder](salesorder.md) entity.

### <a name="BKMK_contactquotes_association"></a> contactquotes_association

See the [contactquotes_association](quote.md#BKMK_contactquotes_association) many-to-many relationship for the [quote](quote.md) entity.
