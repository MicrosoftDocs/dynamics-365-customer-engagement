---
title: "Order Product (SalesOrderDetail)  entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
description: "Includes schema information and supported messages for the Order Product (SalesOrderDetail)  entity."
ms.date: 08/29/2022
ms.topic: "reference"
...
# Order Product (SalesOrderDetail)  entity reference
...
|Create|POST [*org URI*]/api/data/v9.0/salesorderdetails<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/salesorderdetails(*salesorderdetailid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
|Retrieve|GET [*org URI*]/api/data/v9.0/salesorderdetails(*salesorderdetailid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/salesorderdetails<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.0/salesorderdetails(*salesorderdetailid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [SalesOrderDetail_SyncErrors](syncerror.md#BKMK_SalesOrderDetail_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) entity.
...
Same as the [SalesOrderDetail_AsyncOperations](asyncoperation.md#BKMK_SalesOrderDetail_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) entity.
...
Same as the [salesorderdetail_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_salesorderdetail_MailboxTrackingFolders) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) entity.
...
Same as the [SalesOrderDetail_ProcessSessions](processsession.md#BKMK_SalesOrderDetail_ProcessSessions) many-to-one relationship for the [processsession](processsession.md) entity.
...
Same as the [SalesOrderDetail_BulkDeleteFailures](bulkdeletefailure.md#BKMK_SalesOrderDetail_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) entity.
...
Same as the [salesorderdetail_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_salesorderdetail_principalobjectattributeaccess) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) entity.
...
Same as the [SalesOrderDetail_Dynamicpropertyinstance](dynamicpropertyinstance.md#BKMK_SalesOrderDetail_Dynamicpropertyinstance) many-to-one relationship for the [dynamicpropertyinstance](dynamicpropertyinstance.md) entity.
...
Same as the [salesorderdetail_parent_salesorderdetail](salesorderdetail.md#BKMK_salesorderdetail_parent_salesorderdetail) many-to-one relationship for the [salesorderdetail](salesorderdetail.md) entity.
...
Same as the [msdyn_salesorderdetail_invoicedetail](invoicedetail.md#BKMK_msdyn_salesorderdetail_invoicedetail) many-to-one relationship for the [invoicedetail](invoicedetail.md) entity.
...
Same as the [salesorderdetail_parentref_salesorderdetail](salesorderdetail.md#BKMK_salesorderdetail_parentref_salesorderdetail) many-to-one relationship for the [salesorderdetail](salesorderdetail.md) entity.
...
See the [lk_salesorderdetailbase_createdby](systemuser.md#BKMK_lk_salesorderdetailbase_createdby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_salesorderdetail_createdonbehalfby"></a> lk_salesorderdetail_createdonbehalfby

**Added by**: System Solution Solution

See the [lk_salesorderdetail_createdonbehalfby](systemuser.md#BKMK_lk_salesorderdetail_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_salesorderdetailbase_modifiedby"></a> lk_salesorderdetailbase_modifiedby

**Added by**: System Solution Solution

See the [lk_salesorderdetailbase_modifiedby](systemuser.md#BKMK_lk_salesorderdetailbase_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_salesorderdetail_modifiedonbehalfby"></a> lk_salesorderdetail_modifiedonbehalfby

**Added by**: System Solution Solution

See the [lk_salesorderdetail_modifiedonbehalfby](systemuser.md#BKMK_lk_salesorderdetail_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_user_salesorderdetail"></a> user_salesorderdetail

**Added by**: System Solution Solution

See the [user_salesorderdetail](systemuser.md#BKMK_user_salesorderdetail) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_team_salesorderdetail"></a> team_salesorderdetail

**Added by**: System Solution Solution

See the [team_salesorderdetail](team.md#BKMK_team_salesorderdetail) one-to-many relationship for the [team](team.md) entity.

### <a name="BKMK_transactioncurrency_salesorderdetail"></a> transactioncurrency_salesorderdetail

**Added by**: System Solution Solution

See the [transactioncurrency_salesorderdetail](transactioncurrency.md#BKMK_transactioncurrency_salesorderdetail) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) entity.

### <a name="BKMK_product_order_details"></a> product_order_details

**Added by**: Product Management Solution

See the [product_order_details](product.md#BKMK_product_order_details) one-to-many relationship for the [product](product.md) entity.

### <a name="BKMK_order_details"></a> order_details

See the [order_details](salesorder.md#BKMK_order_details) one-to-many relationship for the [salesorder](salesorder.md) entity.

### <a name="BKMK_salesorderdetail_parent_salesorderdetail"></a> salesorderdetail_parent_salesorderdetail

See the [salesorderdetail_parent_salesorderdetail](salesorderdetail.md#BKMK_salesorderdetail_parent_salesorderdetail) one-to-many relationship for the [salesorderdetail](salesorderdetail.md) entity.

### <a name="BKMK_system_user_salesorderdetail"></a> system_user_salesorderdetail

**Added by**: System Solution Solution

See the [system_user_salesorderdetail](systemuser.md#BKMK_system_user_salesorderdetail) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_unit_of_measurement_order_details"></a> unit_of_measurement_order_details

**Added by**: Product Management Solution

See the [unit_of_measurement_order_details](uom.md#BKMK_unit_of_measurement_order_details) one-to-many relationship for the [uom](uom.md) entity.

### <a name="BKMK_productAssociation_salesorder_details"></a> productAssociation_salesorder_details

**Added by**: Product Management Solution

See the [productAssociation_salesorder_details](productassociation.md#BKMK_productAssociation_salesorder_details) one-to-many relationship for the [productassociation](productassociation.md) entity.

### <a name="BKMK_msdyn_quotedetail_salesorderdetail"></a> msdyn_quotedetail_salesorderdetail

See the [msdyn_quotedetail_salesorderdetail](quotedetail.md#BKMK_msdyn_quotedetail_salesorderdetail) one-to-many relationship for the [quotedetail](quotedetail.md) entity.

### <a name="BKMK_salesorderdetail_parentref_salesorderdetail"></a> salesorderdetail_parentref_salesorderdetail

See the [salesorderdetail_parentref_salesorderdetail](salesorderdetail.md#BKMK_salesorderdetail_parentref_salesorderdetail) one-to-many relationship for the [salesorderdetail](salesorderdetail.md) entity.
