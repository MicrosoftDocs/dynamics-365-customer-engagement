---
title: "Lead entity reference (Dynamics 365 Customer Engagement) | Microsoft Docs"
...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.0/leads(*leadid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
...
|Create|POST [*org URI*]/api/data/v9.0/leads<br />See [Create](/power-apps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.0/leads(*leadid*)<br />See [Delete](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|Retrieve|GET [*org URI*]/api/data/v9.0/leads(*leadid*)<br />See [Retrieve](/power-apps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.0/leads<br />See [Query Data](/power-apps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|RetrievePrincipalAccess|<xref href="Microsoft.Dynamics.CRM.RetrievePrincipalAccess?text=RetrievePrincipalAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
|RetrieveSharedPrincipalsAndAccess|<xref href="Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?text=RetrieveSharedPrincipalsAndAccess Function" />|<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
|RevokeAccess|<xref href="Microsoft.Dynamics.CRM.RevokeAccess?text=RevokeAccess Action" />|<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
|SetState|PATCH [*org URI*]/api/data/v9.0/leads(*leadid*)<br />[Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.0/leads(*leadid*)<br />See [Update](/power-apps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
Same as the [Lead_ActivityPointers](activitypointer.md#BKMK_Lead_ActivityPointers) many-to-one relationship for the [activitypointer](activitypointer.md) entity.
...
Same as the [Lead_SyncErrors](syncerror.md#BKMK_Lead_SyncErrors) many-to-one relationship for the [syncerror](syncerror.md) entity.
...
Same as the [lead_activity_parties](activityparty.md#BKMK_lead_activity_parties) many-to-one relationship for the [activityparty](activityparty.md) entity.
...
Same as the [Lead_DuplicateMatchingRecord](duplicaterecord.md#BKMK_Lead_DuplicateMatchingRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Lead_DuplicateBaseRecord](duplicaterecord.md#BKMK_Lead_DuplicateBaseRecord) many-to-one relationship for the [duplicaterecord](duplicaterecord.md) entity.
...
Same as the [Lead_SharepointDocumentLocation](sharepointdocumentlocation.md#BKMK_Lead_SharepointDocumentLocation) many-to-one relationship for the [sharepointdocumentlocation](sharepointdocumentlocation.md) entity.
...
Same as the [Lead_AsyncOperations](asyncoperation.md#BKMK_Lead_AsyncOperations) many-to-one relationship for the [asyncoperation](asyncoperation.md) entity.
...
Same as the [Lead_MailboxTrackingFolder](mailboxtrackingfolder.md#BKMK_Lead_MailboxTrackingFolder) many-to-one relationship for the [mailboxtrackingfolder](mailboxtrackingfolder.md) entity.
...
Same as the [Lead_ProcessSessions](processsession.md#BKMK_Lead_ProcessSessions) many-to-one relationship for the [processsession](processsession.md) entity.
...
Same as the [Lead_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Lead_BulkDeleteFailures) many-to-one relationship for the [bulkdeletefailure](bulkdeletefailure.md) entity.
...
Same as the [lead_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_lead_principalobjectattributeaccess) many-to-one relationship for the [principalobjectattributeaccess](principalobjectattributeaccess.md) entity.
...
Same as the [Lead_Appointments](appointment.md#BKMK_Lead_Appointments) many-to-one relationship for the [appointment](appointment.md) entity.
...
Same as the [Lead_Emails](email.md#BKMK_Lead_Emails) many-to-one relationship for the [email](email.md) entity.
...
Same as the [Lead_Faxes](fax.md#BKMK_Lead_Faxes) many-to-one relationship for the [fax](fax.md) entity.
...
Same as the [Lead_Letters](letter.md#BKMK_Lead_Letters) many-to-one relationship for the [letter](letter.md) entity.
...
Same as the [Lead_Phonecalls](phonecall.md#BKMK_Lead_Phonecalls) many-to-one relationship for the [phonecall](phonecall.md) entity.
...
Same as the [Lead_Tasks](task.md#BKMK_Lead_Tasks) many-to-one relationship for the [task](task.md) entity.
...
Same as the [Lead_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_Lead_RecurringAppointmentMasters) many-to-one relationship for the [recurringappointmentmaster](recurringappointmentmaster.md) entity.
...
Same as the [Lead_SocialActivities](socialactivity.md#BKMK_Lead_SocialActivities) many-to-one relationship for the [socialactivity](socialactivity.md) entity.
...
Same as the [lead_connections1](connection.md#BKMK_lead_connections1) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [lead_connections2](connection.md#BKMK_lead_connections2) many-to-one relationship for the [connection](connection.md) entity.
...
Same as the [Lead_Annotation](annotation.md#BKMK_Lead_Annotation) many-to-one relationship for the [annotation](annotation.md) entity.
...
Same as the [Lead_actioncard](actioncard.md#BKMK_Lead_actioncard) many-to-one relationship for the [actioncard](actioncard.md) entity.
...
Same as the [Lead_Email_EmailSender](email.md#BKMK_Lead_Email_EmailSender) many-to-one relationship for the [email](email.md) entity.
...
Same as the [lead_addresses](leadaddress.md#BKMK_lead_addresses) many-to-one relationship for the [leadaddress](leadaddress.md) entity.
...
Same as the [lead_PostFollows](postfollow.md#BKMK_lead_PostFollows) many-to-one relationship for the [postfollow](postfollow.md) entity.
...
Same as the [lead_master_lead](lead.md#BKMK_lead_master_lead) many-to-one relationship for the [lead](lead.md) entity.
...
Same as the [slakpiinstance_lead](slakpiinstance.md#BKMK_slakpiinstance_lead) many-to-one relationship for the [slakpiinstance](slakpiinstance.md) entity.
...
Same as the [account_originating_lead](account.md#BKMK_account_originating_lead) many-to-one relationship for the [account](account.md) entity.
...
Same as the [contact_originating_lead](contact.md#BKMK_contact_originating_lead) many-to-one relationship for the [contact](contact.md) entity.
...
Same as the [lead_BulkOperations](bulkoperation.md#BKMK_lead_BulkOperations) many-to-one relationship for the [bulkoperation](bulkoperation.md) entity.
...
Same as the [lead_CampaignResponses](campaignresponse.md#BKMK_lead_CampaignResponses) many-to-one relationship for the [campaignresponse](campaignresponse.md) entity.
...
Same as the [CreatedLead_BulkOperationLogs](bulkoperationlog.md#BKMK_CreatedLead_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) entity.
...
Same as the [SourceLead_BulkOperationLogs](bulkoperationlog.md#BKMK_SourceLead_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) entity.
...
Same as the [lead_IncidentResolutions](incidentresolution.md#BKMK_lead_IncidentResolutions) many-to-one relationship for the [incidentresolution](incidentresolution.md) entity.
...
Same as the [Lead_ServiceAppointments](serviceappointment.md#BKMK_Lead_ServiceAppointments) many-to-one relationship for the [serviceappointment](serviceappointment.md) entity.
...
Same as the [lead_OpportunityCloses](opportunityclose.md#BKMK_lead_OpportunityCloses) many-to-one relationship for the [opportunityclose](opportunityclose.md) entity.
...
Same as the [lead_OrderCloses](orderclose.md#BKMK_lead_OrderCloses) many-to-one relationship for the [orderclose](orderclose.md) entity.
...
Same as the [lead_QuoteCloses](quoteclose.md#BKMK_lead_QuoteCloses) many-to-one relationship for the [quoteclose](quoteclose.md) entity.
...
Same as the [opportunity_originating_lead](opportunity.md#BKMK_opportunity_originating_lead) many-to-one relationship for the [opportunity](opportunity.md) entity.
...
Same as the [lk_leadtoopportunitysalesprocess_leadid](leadtoopportunitysalesprocess.md#BKMK_lk_leadtoopportunitysalesprocess_leadid) many-to-one relationship for the [leadtoopportunitysalesprocess](leadtoopportunitysalesprocess.md) entity.
...
See the [lk_leadbase_createdby](systemuser.md#BKMK_lk_leadbase_createdby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_lead_createdonbehalfby"></a> lk_lead_createdonbehalfby

**Added by**: System Solution Solution

See the [lk_lead_createdonbehalfby](systemuser.md#BKMK_lk_lead_createdonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_leadbase_modifiedby"></a> lk_leadbase_modifiedby

**Added by**: System Solution Solution

See the [lk_leadbase_modifiedby](systemuser.md#BKMK_lk_leadbase_modifiedby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lk_lead_modifiedonbehalfby"></a> lk_lead_modifiedonbehalfby

**Added by**: System Solution Solution

See the [lk_lead_modifiedonbehalfby](systemuser.md#BKMK_lk_lead_modifiedonbehalfby) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lead_owning_user"></a> lead_owning_user

**Added by**: System Solution Solution

See the [lead_owning_user](systemuser.md#BKMK_lead_owning_user) one-to-many relationship for the [systemuser](systemuser.md) entity.

### <a name="BKMK_lead_owning_team"></a> lead_owning_team

**Added by**: System Solution Solution

See the [lead_owning_team](team.md#BKMK_lead_owning_team) one-to-many relationship for the [team](team.md) entity.

### <a name="BKMK_business_unit_leads"></a> business_unit_leads

**Added by**: System Solution Solution

See the [business_unit_leads](businessunit.md#BKMK_business_unit_leads) one-to-many relationship for the [businessunit](businessunit.md) entity.

### <a name="BKMK_processstage_lead"></a> processstage_lead

**Added by**: System Solution Solution

See the [processstage_lead](processstage.md#BKMK_processstage_lead) one-to-many relationship for the [processstage](processstage.md) entity.

### <a name="BKMK_transactioncurrency_lead"></a> transactioncurrency_lead

**Added by**: System Solution Solution

See the [transactioncurrency_lead](transactioncurrency.md#BKMK_transactioncurrency_lead) one-to-many relationship for the [transactioncurrency](transactioncurrency.md) entity.

### <a name="BKMK_lead_customer_accounts"></a> lead_customer_accounts

**Added by**: System Solution Solution

See the [lead_customer_accounts](account.md#BKMK_lead_customer_accounts) one-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_lead_customer_contacts"></a> lead_customer_contacts

**Added by**: System Solution Solution

See the [lead_customer_contacts](contact.md#BKMK_lead_customer_contacts) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_manualsla_lead"></a> manualsla_lead

**Added by**: System Solution Solution

See the [manualsla_lead](sla.md#BKMK_manualsla_lead) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_sla_lead"></a> sla_lead

**Added by**: System Solution Solution

See the [sla_lead](sla.md#BKMK_sla_lead) one-to-many relationship for the [sla](sla.md) entity.

### <a name="BKMK_lead_master_lead"></a> lead_master_lead

See the [lead_master_lead](lead.md#BKMK_lead_master_lead) one-to-many relationship for the [lead](lead.md) entity.

### <a name="BKMK_lead_parent_account"></a> lead_parent_account

**Added by**: System Solution Solution

See the [lead_parent_account](account.md#BKMK_lead_parent_account) one-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_lead_parent_contact"></a> lead_parent_contact

**Added by**: System Solution Solution

See the [lead_parent_contact](contact.md#BKMK_lead_parent_contact) one-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_campaign_leads"></a> campaign_leads

**Added by**: Marketing Solution

See the [campaign_leads](campaign.md#BKMK_campaign_leads) one-to-many relationship for the [campaign](campaign.md) entity.

### <a name="BKMK_CampaignResponse_Lead"></a> CampaignResponse_Lead

**Added by**: Marketing Solution

See the [CampaignResponse_Lead](campaignresponse.md#BKMK_CampaignResponse_Lead) one-to-many relationship for the [campaignresponse](campaignresponse.md) entity.

### <a name="BKMK_OriginatingCase_Lead"></a> OriginatingCase_Lead

**Added by**: Service Solution

See the [OriginatingCase_Lead](incident.md#BKMK_OriginatingCase_Lead) one-to-many relationship for the [incident](incident.md) entity.

### <a name="BKMK_lead_qualifying_opportunity"></a> lead_qualifying_opportunity

**Added by**: Sales Solution

See the [lead_qualifying_opportunity](opportunity.md#BKMK_lead_qualifying_opportunity) one-to-many relationship for the [opportunity](opportunity.md) entity.
<a name="manytomany"></a>
...
See the [accountleads_association](account.md#BKMK_accountleads_association) many-to-many relationship for the [account](account.md) entity.

### <a name="BKMK_contactleads_association"></a> contactleads_association

See the [contactleads_association](contact.md#BKMK_contactleads_association) many-to-many relationship for the [contact](contact.md) entity.

### <a name="BKMK_listlead_association"></a> listlead_association

See the [listlead_association](list.md#BKMK_listlead_association) many-to-many relationship for the [list](list.md) entity.
