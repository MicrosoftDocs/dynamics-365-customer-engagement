...
description: Learn how to purchase Dynamics 365 Field Service licenses and assign them to users.
ms.date: 05/07/2026
ms.topic: how-to
author: jshotts
...
Try out Dynamics 365 Field Service before purchasing a subscription with [a free 30-day trial](trial-signup.md). You don't need administrator privileges to sign up for the trial.
...
For feature comparisons and pricing information, see [Field Service pricing](https://dynamics.microsoft.com/field-service/pricing/). For detailed licensing information, see [Dynamics 365 licensing guide](https://go.microsoft.com/fwlink/?LinkId=866544).
...
1. Under **Billing**, select **Licenses**. Search for and buy Dynamics 365 Field Service licenses for each user.

## Add users and assign licenses

After buying licenses, add users and assign licenses to individual users or a group of users. Admins can manage security roles for licensed users to give them access to apps.
...
The Field Service license also includes Dynamics 365 Guides and Dynamics 365 Remote Assist at no extra cost. You don't need to take any action to assign the new licenses to existing users. However, the system doesn't install the applications automatically. For more information about installing the mixed reality apps, see [Collaborate in mixed reality with Field Service and Remote Assist](remote-assist-hololens.md) and [Integrate Guides with Field Service](mixed-reality-guides-integration.md).
