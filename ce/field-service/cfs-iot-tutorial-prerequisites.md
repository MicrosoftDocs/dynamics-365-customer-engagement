...
![Azure IoT Central with payment plan and template selected](../field-service/media/Azure-IoT-Central-create-app-dialog.png "Azure IoT Central with payment plan and template selected")  
