...
![Azure IoT Central with payment plan and template selected](Azure-IoT-Central-create-app-dialog.png "Azure IoT Central with payment plan and template selected")  
