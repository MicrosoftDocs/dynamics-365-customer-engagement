...
You need to do 4 things before you take the tutorial to connect IoT Central to Connected Field Service (CFS) using Microsoft Flow:
...
2. **Provision a Dynamics 365 for Field Service tenant with system administrator credentials** 
...
3. **Install the Dynamics 365 Connected Field Service add-on**  
...
4. **Install Connected Field Service sample data**    
