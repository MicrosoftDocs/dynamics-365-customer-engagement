...
Dynamics 365 Field Service adds a travel charge item as a work order product if you set a travel charge type for a [service account](accounts.md), *not* a billing account. The system adds the travel charge after you schedule the work order and when the status of the generated booking changes.

The *unit amount* of the **Travel Charge Item** is the value of the travel charge that an admin sets for the service account. The price list, list price, and travel charge determine the *unit amount price* of the travel charge item. However, the *quantity* of the **Travel Charge Item** is based on the **travel charge type** that you set for the service account.
