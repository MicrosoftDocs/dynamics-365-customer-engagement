...
- General availability in asking the Dynamics 365 Field Service Plugin for Microsoft Copilot for [key work order information](flw-m365-chat.md). In public preview, frontline workers can ask Microsoft Copilot to [search through lengthy product manuals](flw-m365-chat.md#ask-for-instructions-for-a-work-order) and find relevant answers to questions.
