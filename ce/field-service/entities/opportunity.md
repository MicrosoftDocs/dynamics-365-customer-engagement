...
- [msa_partneroppid](#BKMK_msa_partneroppid)
...
### <a name="BKMK_msa_partneroppid"></a> msa_partneroppid
...
|Property|Value|
|---|---|
|Description|**The Journey action id in which the opportunity is created.**|
...
|Property|Value|
|---|---|
|Description|**The journey id in which the opportunity is created**|
...
One-To-Many Relationship: [contact msa_contact_opportunity](contact.md#BKMK_msa_contact_opportunity)
...
|ReferencingEntityNavigationPropertyName|`msa_partneroppid`|
|IsHierarchical||
...
One-To-Many Relationship: [account msa_partner_opportunity](account.md#BKMK_msa_partner_opportunity)
...
One-To-Many Relationship: [msdynmkt_journey msdynmkt_opportunity_JourneyId_msdynmkt_journey](msdynmkt_journey.md#BKMK_msdynmkt_opportunity_JourneyId_msdynmkt_journey)
...
|ReferencingEntityNavigationPropertyName|`msdynmkt_JourneyId_Opportunity`|
|IsHierarchical||
...
Many-To-One Relationship: [msdyn_salespremiumdemo msdyn_opportunity_msdyn_salespremiumdemo_opportunity](msdyn_salespremiumdemo.md#BKMK_msdyn_opportunity_msdyn_salespremiumdemo_opportunity)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_salespremiumdemo`|
|ReferencingAttribute|`msdyn_opportunity`|
|ReferencedEntityNavigationPropertyName|`msdyn_opportunity_msdyn_salespremiumdemo_opportunity`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [msdyncrm_leadtoopportunity msdyncrm_opportunity_msdyncrm_leadtoopportunity](msdyncrm_leadtoopportunity.md#BKMK_msdyncrm_opportunity_msdyncrm_leadtoopportunity)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_leadtoopportunity`|
|ReferencingAttribute|`msdyncrm_opportunityid`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_opportunity_msdyncrm_leadtoopportunity`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseLabel`<br />Group: `Details`<br />Label: opportunity<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [adx_alertsubscription opportunity_adx_alertsubscriptions](adx_alertsubscription.md#BKMK_opportunity_adx_alertsubscriptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_alertsubscription`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`opportunity_adx_alertsubscriptions`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [li_inmail opportunity_li_inmails](li_inmail.md#BKMK_opportunity_li_inmails)

|Property|Value|
|---|---|
|ReferencingEntity|`li_inmail`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`opportunity_li_inmails`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RollupByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|

### <a name="BKMK_opportunity_li_messages"></a> opportunity_li_messages

Many-To-One Relationship: [li_message opportunity_li_messages](li_message.md#BKMK_opportunity_li_messages)

|Property|Value|
|---|---|
|ReferencingEntity|`li_message`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`opportunity_li_messages`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RollupByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|

### <a name="BKMK_opportunity_li_pointdrivepresentationvieweds"></a> opportunity_li_pointdrivepresentationvieweds

Many-To-One Relationship: [li_pointdrivepresentationviewed opportunity_li_pointdrivepresentationvieweds](li_pointdrivepresentationviewed.md#BKMK_opportunity_li_pointdrivepresentationvieweds)

|Property|Value|
|---|---|
|ReferencingEntity|`li_pointdrivepresentationviewed`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`opportunity_li_pointdrivepresentationvieweds`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RollupByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|
