---
title: "IoT Device Command Definition (msdyn_iotdevicecommanddefinition) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the IoT Device Command Definition (msdyn_iotdevicecommanddefinition) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
The following table lists the messages for the IoT Device Command Definition (msdyn_iotdevicecommanddefinition) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_iotdevicecommanddefinitions<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_iotdevicecommanddefinitions<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_iotdevicecommanddefinitions(*msdyn_iotdevicecommanddefinitionid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the IoT Device Command Definition (msdyn_iotdevicecommanddefinition) table.
...
The following table lists selected properties for the IoT Device Command Definition (msdyn_iotdevicecommanddefinition) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_iotdevicecommanddefinition_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_iotdevicecommanddefinition_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_iotdevicecommanddefinition](businessunit.md#BKMK_business_unit_msdyn_iotdevicecommanddefinition)
...
One-To-Many Relationship: [systemuser lk_msdyn_iotdevicecommanddefinition_createdby](systemuser.md#BKMK_lk_msdyn_iotdevicecommanddefinition_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_iotdevicecommanddefinition_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_iotdevicecommanddefinition_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_iotdevicecommanddefinition_modifiedby](systemuser.md#BKMK_lk_msdyn_iotdevicecommanddefinition_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_iotdevicecommanddefinition_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_iotdevicecommanddefinition_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_iotdevicecommanddefinition](owner.md#BKMK_owner_msdyn_iotdevicecommanddefinition)
...
One-To-Many Relationship: [team team_msdyn_iotdevicecommanddefinition](team.md#BKMK_team_msdyn_iotdevicecommanddefinition)
...
One-To-Many Relationship: [systemuser user_msdyn_iotdevicecommanddefinition](systemuser.md#BKMK_user_msdyn_iotdevicecommanddefinition)
...
Many-To-One Relationship: [asyncoperation msdyn_iotdevicecommanddefinition_AsyncOperations](asyncoperation.md#BKMK_msdyn_iotdevicecommanddefinition_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_iotdevicecommanddefinition_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_iotdevicecommanddefinition_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_iotdevicecommanddefinition_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_iotdevicecommanddefinition_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_iotdevicecommanddefinition_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_iotdevicecommanddefinition_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_iotdevicecommanddefinition_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_iotdevicecommanddefinition_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_iotdevicecommanddefinition_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_iotdevicecommanddefinition_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_iotdevicecommanddefinition_ProcessSession](processsession.md#BKMK_msdyn_iotdevicecommanddefinition_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_iotdevicecommanddefinition_SyncErrors](syncerror.md#BKMK_msdyn_iotdevicecommanddefinition_SyncErrors)
...
Many-To-One Relationship: [msdyn_iotdevicecommand msdyn_msdyn_iotdevicecommanddefinition_msdyn_iotdevicecommand_Command](msdyn_iotdevicecommand.md#BKMK_msdyn_msdyn_iotdevicecommanddefinition_msdyn_iotdevicecommand_Command)
...
See [msdyn_iotdevicecategory msdyn_iotdevicecategorycommands Many-To-Many Relationship](msdyn_iotdevicecategory.md#BKMK_msdyn_iotdevicecategorycommands)
...
See [msdyn_iotpropertydefinition msdyn_iotdevicecommandparameters Many-To-Many Relationship](msdyn_iotpropertydefinition.md#BKMK_msdyn_iotdevicecommandparameters)
