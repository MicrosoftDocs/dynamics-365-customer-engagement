...
# Microsoft Teams account (msdyn_octeamschannelconfig) table/entity reference
...
The following table lists the events for the Microsoft Teams account (msdyn_octeamschannelconfig) table.
