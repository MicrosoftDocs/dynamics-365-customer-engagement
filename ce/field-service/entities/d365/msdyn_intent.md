...
The following table lists the events for the Intent (msdyn_Intent) table.
...
- [msdyn_IntentText](#BKMK_msdyn_IntentText)
...
### <a name="BKMK_msdyn_IntentText"></a> msdyn_IntentText
...
|Property|Value|
|---|---|
|Description|**Intent object item Polymorphic Lookup Attribute**|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_intentsources`|
...
|---|---|
|100000000|**PVA**|
|100000001|**EmailAssist**|
|100000002|**AnswerAssist**|
|100000003|**UR**|
|100000004|**AgentAssist**|
...
One-To-Many Relationship: [incident msdyn_intent_case](incident.md#BKMK_msdyn_intent_case)
