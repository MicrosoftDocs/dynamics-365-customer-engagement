...
# Case Suggestions Data Souce (msdyn_casesuggestionsdatasource) table/entity reference
...
The following table lists the events for the Case Suggestions Data Souce (msdyn_casesuggestionsdatasource) table.
