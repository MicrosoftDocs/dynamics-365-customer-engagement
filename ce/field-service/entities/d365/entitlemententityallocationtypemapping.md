---
title: "Entitlement Entity Allocation Type Mapping (EntitlementEntityAllocationTypeMapping) table/entity reference (Microsoft Dynamics 365)"
description: "Includes schema information and supported messages for the Entitlement Entity Allocation Type Mapping (EntitlementEntityAllocationTypeMapping) table/entity with Microsoft Dynamics 365."
ms.date: 08.01.2024
...
The following table lists the messages for the Entitlement Entity Allocation Type Mapping (EntitlementEntityAllocationTypeMapping) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /entitlemententityallocationtypemappings<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /entitlemententityallocationtypemappings<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /entitlemententityallocationtypemappings(*entitlemententityallocationtypemappingid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Entitlement Entity Allocation Type Mapping (EntitlementEntityAllocationTypeMapping) table.
...
The following table lists selected properties for the Entitlement Entity Allocation Type Mapping (EntitlementEntityAllocationTypeMapping) table.
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`allocationtype`|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`EntitlementEntityAllocationTypeMapping_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`entitlemententityallocationtypemapping_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_entitlemententityallocationtypemapping](businessunit.md#BKMK_business_unit_entitlemententityallocationtypemapping)
...
One-To-Many Relationship: [systemuser lk_entitlemententityallocationtypemapping_createdby](systemuser.md#BKMK_lk_entitlemententityallocationtypemapping_createdby)
...
One-To-Many Relationship: [systemuser lk_entitlemententityallocationtypemapping_createdonbehalfby](systemuser.md#BKMK_lk_entitlemententityallocationtypemapping_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_entitlemententityallocationtypemapping_modifiedby](systemuser.md#BKMK_lk_entitlemententityallocationtypemapping_modifiedby)
...
One-To-Many Relationship: [systemuser lk_entitlemententityallocationtypemapping_modifiedonbehalfby](systemuser.md#BKMK_lk_entitlemententityallocationtypemapping_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_entitlemententityallocationtypemapping](owner.md#BKMK_owner_entitlemententityallocationtypemapping)
...
One-To-Many Relationship: [team team_entitlemententityallocationtypemapping](team.md#BKMK_team_entitlemententityallocationtypemapping)
...
One-To-Many Relationship: [systemuser user_entitlemententityallocationtypemapping](systemuser.md#BKMK_user_entitlemententityallocationtypemapping)
...
Many-To-One Relationship: [asyncoperation entitlemententityallocationtypemapping_AsyncOperations](asyncoperation.md#BKMK_entitlemententityallocationtypemapping_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure entitlemententityallocationtypemapping_BulkDeleteFailures](bulkdeletefailure.md#BKMK_entitlemententityallocationtypemapping_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord entitlemententityallocationtypemapping_DuplicateBaseRecord](duplicaterecord.md#BKMK_entitlemententityallocationtypemapping_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord entitlemententityallocationtypemapping_DuplicateMatchingRecord](duplicaterecord.md#BKMK_entitlemententityallocationtypemapping_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder entitlemententityallocationtypemapping_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_entitlemententityallocationtypemapping_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess entitlemententityallocationtypemapping_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_entitlemententityallocationtypemapping_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession entitlemententityallocationtypemapping_ProcessSession](processsession.md#BKMK_entitlemententityallocationtypemapping_ProcessSession)
...
Many-To-One Relationship: [syncerror entitlemententityallocationtypemapping_SyncErrors](syncerror.md#BKMK_entitlemententityallocationtypemapping_SyncErrors)
