---
title: "New Process (NewProcess) table/entity reference (Microsoft Dynamics 365)"
description: "Includes schema information and supported messages for the New Process (NewProcess) table/entity with Microsoft Dynamics 365."
ms.date: 08.01.2024
...
> [!NOTE]
> The Microsoft Dynamics 365 New Process (NewProcess) table extends the [Microsoft Dataverse New Process (NewProcess) table](/power-apps/developer/data-platform/reference/entities/newprocess).
