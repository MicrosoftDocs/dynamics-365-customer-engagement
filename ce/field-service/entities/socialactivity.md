...
> [!NOTE]
> The Microsoft Dynamics 365 Field Service Social Activity (SocialActivity) table extends the [Microsoft Dataverse Social Activity (SocialActivity) table](/power-apps/developer/data-platform/reference/entities/socialactivity).
...
- [adx_poll_SocialActivities](#BKMK_adx_poll_SocialActivities)
...
- [adx_redirect_SocialActivities](#BKMK_adx_redirect_SocialActivities)
...
- [msdyncrm_migration_SocialActivities](#BKMK_msdyncrm_migration_SocialActivities)
...
One-To-Many Relationship: [adx_ad adx_ad_SocialActivities](adx_ad.md#BKMK_adx_ad_SocialActivities)
...
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_ad_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_adplacement_SocialActivities"></a> adx_adplacement_SocialActivities

One-To-Many Relationship: [adx_adplacement adx_adplacement_SocialActivities](adx_adplacement.md#BKMK_adx_adplacement_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_adplacement_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_casedeflection_SocialActivities"></a> adx_casedeflection_SocialActivities

One-To-Many Relationship: [adx_casedeflection adx_casedeflection_SocialActivities](adx_casedeflection.md#BKMK_adx_casedeflection_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_casedeflection_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_communityforumaccesspermission_SocialActivities"></a> adx_communityforumaccesspermission_SocialActivities

One-To-Many Relationship: [adx_communityforumaccesspermission adx_communityforumaccesspermission_SocialActivities](adx_communityforumaccesspermission.md#BKMK_adx_communityforumaccesspermission_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_communityforumaccesspermission_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_communityforumalert_SocialActivities"></a> adx_communityforumalert_SocialActivities

One-To-Many Relationship: [adx_communityforumalert adx_communityforumalert_SocialActivities](adx_communityforumalert.md#BKMK_adx_communityforumalert_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_communityforumalert_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_contentaccesslevel_SocialActivities"></a> adx_contentaccesslevel_SocialActivities

One-To-Many Relationship: [adx_contentaccesslevel adx_contentaccesslevel_SocialActivities](adx_contentaccesslevel.md#BKMK_adx_contentaccesslevel_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_contentaccesslevel_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_poll_SocialActivities"></a> adx_poll_SocialActivities

One-To-Many Relationship: [adx_poll adx_poll_SocialActivities](adx_poll.md#BKMK_adx_poll_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_poll_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_polloption_SocialActivities"></a> adx_polloption_SocialActivities

One-To-Many Relationship: [adx_polloption adx_polloption_SocialActivities](adx_polloption.md#BKMK_adx_polloption_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_polloption_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_pollplacement_SocialActivities"></a> adx_pollplacement_SocialActivities

One-To-Many Relationship: [adx_pollplacement adx_pollplacement_SocialActivities](adx_pollplacement.md#BKMK_adx_pollplacement_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_pollplacement_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_pollsubmission_SocialActivities"></a> adx_pollsubmission_SocialActivities

One-To-Many Relationship: [adx_pollsubmission adx_pollsubmission_SocialActivities](adx_pollsubmission.md#BKMK_adx_pollsubmission_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_pollsubmission_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_publishingstatetransitionrule_SocialActivities"></a> adx_publishingstatetransitionrule_SocialActivities

One-To-Many Relationship: [adx_publishingstatetransitionrule adx_publishingstatetransitionrule_SocialActivities](adx_publishingstatetransitionrule.md#BKMK_adx_publishingstatetransitionrule_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_publishingstatetransitionrule_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_redirect_SocialActivities"></a> adx_redirect_SocialActivities

One-To-Many Relationship: [adx_redirect adx_redirect_SocialActivities](adx_redirect.md#BKMK_adx_redirect_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_redirect_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_shortcut_SocialActivities"></a> adx_shortcut_SocialActivities

One-To-Many Relationship: [adx_shortcut adx_shortcut_SocialActivities](adx_shortcut.md#BKMK_adx_shortcut_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_shortcut_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_webpage_SocialActivities"></a> adx_webpage_SocialActivities

One-To-Many Relationship: [adx_webpage adx_webpage_SocialActivities](adx_webpage.md#BKMK_adx_webpage_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_webpage_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_adx_website_SocialActivities"></a> adx_website_SocialActivities

One-To-Many Relationship: [adx_website adx_website_SocialActivities](adx_website.md#BKMK_adx_website_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_adx_website_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_contentsettings msdyncrm_contentsettings_SocialActivities](msdyncrm_contentsettings.md#BKMK_msdyncrm_contentsettings_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_contentsettings_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_customerjourney_SocialActivities"></a> msdyncrm_customerjourney_SocialActivities

One-To-Many Relationship: [msdyncrm_customerjourney msdyncrm_customerjourney_SocialActivities](msdyncrm_customerjourney.md#BKMK_msdyncrm_customerjourney_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_customerjourney_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_leadscoremodel_SocialActivities"></a> msdyncrm_leadscoremodel_SocialActivities

One-To-Many Relationship: [msdyncrm_leadscoremodel msdyncrm_leadscoremodel_SocialActivities](msdyncrm_leadscoremodel.md#BKMK_msdyncrm_leadscoremodel_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_leadscoremodel_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinaccount_SocialActivities"></a> msdyncrm_linkedinaccount_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinaccount msdyncrm_linkedinaccount_SocialActivities](msdyncrm_linkedinaccount.md#BKMK_msdyncrm_linkedinaccount_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinaccount_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinactivity_SocialActivities"></a> msdyncrm_linkedinactivity_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinactivity msdyncrm_linkedinactivity_SocialActivities](msdyncrm_linkedinactivity.md#BKMK_msdyncrm_linkedinactivity_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinactivity_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinfieldmapping_SocialActivities"></a> msdyncrm_linkedinfieldmapping_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinfieldmapping msdyncrm_linkedinfieldmapping_SocialActivities](msdyncrm_linkedinfieldmapping.md#BKMK_msdyncrm_linkedinfieldmapping_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinfieldmapping_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinform_SocialActivities"></a> msdyncrm_linkedinform_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinform msdyncrm_linkedinform_SocialActivities](msdyncrm_linkedinform.md#BKMK_msdyncrm_linkedinform_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinform_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinformanswer_SocialActivities"></a> msdyncrm_linkedinformanswer_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinformanswer msdyncrm_linkedinformanswer_SocialActivities](msdyncrm_linkedinformanswer.md#BKMK_msdyncrm_linkedinformanswer_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformanswer_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinformquestion_SocialActivities"></a> msdyncrm_linkedinformquestion_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinformquestion msdyncrm_linkedinformquestion_SocialActivities](msdyncrm_linkedinformquestion.md#BKMK_msdyncrm_linkedinformquestion_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformquestion_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinformsubmission_SocialActivities"></a> msdyncrm_linkedinformsubmission_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinformsubmission msdyncrm_linkedinformsubmission_SocialActivities](msdyncrm_linkedinformsubmission.md#BKMK_msdyncrm_linkedinformsubmission_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformsubmission_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinleadmatchingstrategy_SocialActivities"></a> msdyncrm_linkedinleadmatchingstrategy_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinleadmatchingstrategy msdyncrm_linkedinleadmatchingstrategy_SocialActivities](msdyncrm_linkedinleadmatchingstrategy.md#BKMK_msdyncrm_linkedinleadmatchingstrategy_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinuserprofile_SocialActivities"></a> msdyncrm_linkedinuserprofile_SocialActivities

One-To-Many Relationship: [msdyncrm_linkedinuserprofile msdyncrm_linkedinuserprofile_SocialActivities](msdyncrm_linkedinuserprofile.md#BKMK_msdyncrm_linkedinuserprofile_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinuserprofile_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_marketingdynamiccontentmetadata msdyncrm_marketingdynamiccontentmetadata_SocialActivities](msdyncrm_marketingdynamiccontentmetadata.md#BKMK_msdyncrm_marketingdynamiccontentmetadata_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_marketingemaildynamiccontentmetadata msdyncrm_marketingemaildynamiccontentmetadata_SocialActivities](msdyncrm_marketingemaildynamiccontentmetadata.md#BKMK_msdyncrm_marketingemaildynamiccontentmetadata_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_marketingemailtestsend_SocialActivities"></a> msdyncrm_marketingemailtestsend_SocialActivities

One-To-Many Relationship: [msdyncrm_marketingemailtestsend msdyncrm_marketingemailtestsend_SocialActivities](msdyncrm_marketingemailtestsend.md#BKMK_msdyncrm_marketingemailtestsend_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingemailtestsend_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_migration_SocialActivities"></a> msdyncrm_migration_SocialActivities

One-To-Many Relationship: [msdyncrm_migration msdyncrm_migration_SocialActivities](msdyncrm_migration.md#BKMK_msdyncrm_migration_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_migration_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_uicconfig_SocialActivities"></a> msdyncrm_uicconfig_SocialActivities

One-To-Many Relationship: [msdyncrm_uicconfig msdyncrm_uicconfig_SocialActivities](msdyncrm_uicconfig.md#BKMK_msdyncrm_uicconfig_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_uicconfig_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_checkin_SocialActivities"></a> msevtmgt_checkin_SocialActivities

One-To-Many Relationship: [msevtmgt_checkin msevtmgt_checkin_SocialActivities](msevtmgt_checkin.md#BKMK_msevtmgt_checkin_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_checkin_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_event_SocialActivities"></a> msevtmgt_event_SocialActivities

One-To-Many Relationship: [msevtmgt_event msevtmgt_event_SocialActivities](msevtmgt_event.md#BKMK_msevtmgt_event_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_event_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchase_SocialActivities"></a> msevtmgt_eventpurchase_SocialActivities

One-To-Many Relationship: [msevtmgt_eventpurchase msevtmgt_eventpurchase_SocialActivities](msevtmgt_eventpurchase.md#BKMK_msevtmgt_eventpurchase_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchase_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchaseattendee_SocialActivities"></a> msevtmgt_eventpurchaseattendee_SocialActivities

One-To-Many Relationship: [msevtmgt_eventpurchaseattendee msevtmgt_eventpurchaseattendee_SocialActivities](msevtmgt_eventpurchaseattendee.md#BKMK_msevtmgt_eventpurchaseattendee_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchaseattendee_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchasepass_SocialActivities"></a> msevtmgt_eventpurchasepass_SocialActivities

One-To-Many Relationship: [msevtmgt_eventpurchasepass msevtmgt_eventpurchasepass_SocialActivities](msevtmgt_eventpurchasepass.md#BKMK_msevtmgt_eventpurchasepass_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchasepass_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventregistration_SocialActivities"></a> msevtmgt_eventregistration_SocialActivities

One-To-Many Relationship: [msevtmgt_eventregistration msevtmgt_eventregistration_SocialActivities](msevtmgt_eventregistration.md#BKMK_msevtmgt_eventregistration_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventregistration_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotel_SocialActivities"></a> msevtmgt_hotel_SocialActivities

One-To-Many Relationship: [msevtmgt_hotel msevtmgt_hotel_SocialActivities](msevtmgt_hotel.md#BKMK_msevtmgt_hotel_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotel_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotelroomallocation_SocialActivities"></a> msevtmgt_hotelroomallocation_SocialActivities

One-To-Many Relationship: [msevtmgt_hotelroomallocation msevtmgt_hotelroomallocation_SocialActivities](msevtmgt_hotelroomallocation.md#BKMK_msevtmgt_hotelroomallocation_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotelroomallocation_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotelroomreservation_SocialActivities"></a> msevtmgt_hotelroomreservation_SocialActivities

One-To-Many Relationship: [msevtmgt_hotelroomreservation msevtmgt_hotelroomreservation_SocialActivities](msevtmgt_hotelroomreservation.md#BKMK_msevtmgt_hotelroomreservation_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotelroomreservation_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_layout_SocialActivities"></a> msevtmgt_layout_SocialActivities

One-To-Many Relationship: [msevtmgt_layout msevtmgt_layout_SocialActivities](msevtmgt_layout.md#BKMK_msevtmgt_layout_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_layout_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_room_SocialActivities"></a> msevtmgt_room_SocialActivities

One-To-Many Relationship: [msevtmgt_room msevtmgt_room_SocialActivities](msevtmgt_room.md#BKMK_msevtmgt_room_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_room_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_session_SocialActivities"></a> msevtmgt_session_SocialActivities

One-To-Many Relationship: [msevtmgt_session msevtmgt_session_SocialActivities](msevtmgt_session.md#BKMK_msevtmgt_session_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_session_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sessionregistration_SocialActivities"></a> msevtmgt_sessionregistration_SocialActivities

One-To-Many Relationship: [msevtmgt_sessionregistration msevtmgt_sessionregistration_SocialActivities](msevtmgt_sessionregistration.md#BKMK_msevtmgt_sessionregistration_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sessionregistration_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sessiontrack_SocialActivities"></a> msevtmgt_sessiontrack_SocialActivities

One-To-Many Relationship: [msevtmgt_sessiontrack msevtmgt_sessiontrack_SocialActivities](msevtmgt_sessiontrack.md#BKMK_msevtmgt_sessiontrack_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sessiontrack_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_speaker_SocialActivities"></a> msevtmgt_speaker_SocialActivities

One-To-Many Relationship: [msevtmgt_speaker msevtmgt_speaker_SocialActivities](msevtmgt_speaker.md#BKMK_msevtmgt_speaker_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_speaker_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_speakerengagement_SocialActivities"></a> msevtmgt_speakerengagement_SocialActivities

One-To-Many Relationship: [msevtmgt_speakerengagement msevtmgt_speakerengagement_SocialActivities](msevtmgt_speakerengagement.md#BKMK_msevtmgt_speakerengagement_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_speakerengagement_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sponsorablearticle_SocialActivities"></a> msevtmgt_sponsorablearticle_SocialActivities

One-To-Many Relationship: [msevtmgt_sponsorablearticle msevtmgt_sponsorablearticle_SocialActivities](msevtmgt_sponsorablearticle.md#BKMK_msevtmgt_sponsorablearticle_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sponsorablearticle_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sponsorship_SocialActivities"></a> msevtmgt_sponsorship_SocialActivities

One-To-Many Relationship: [msevtmgt_sponsorship msevtmgt_sponsorship_SocialActivities](msevtmgt_sponsorship.md#BKMK_msevtmgt_sponsorship_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sponsorship_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_venue_SocialActivities"></a> msevtmgt_venue_SocialActivities

One-To-Many Relationship: [msevtmgt_venue msevtmgt_venue_SocialActivities](msevtmgt_venue.md#BKMK_msevtmgt_venue_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_venue_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_webinarconfiguration_SocialActivities"></a> msevtmgt_webinarconfiguration_SocialActivities

One-To-Many Relationship: [msevtmgt_webinarconfiguration msevtmgt_webinarconfiguration_SocialActivities](msevtmgt_webinarconfiguration.md#BKMK_msevtmgt_webinarconfiguration_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_webinarconfiguration_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msevtmgt_webinarprovider_SocialActivities"></a> msevtmgt_webinarprovider_SocialActivities

One-To-Many Relationship: [msevtmgt_webinarprovider msevtmgt_webinarprovider_SocialActivities](msevtmgt_webinarprovider.md#BKMK_msevtmgt_webinarprovider_SocialActivities)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_webinarprovider_socialactivity`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
