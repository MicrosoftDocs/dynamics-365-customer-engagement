...
# LINE account (msdyn_oclinechannelconfig) table/entity reference
...
The following table lists the events for the LINE account (msdyn_oclinechannelconfig) table.
