...
The following table lists the messages for the Profile Album (msdyn_PostAlbum) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_postalbums(*msdyn_postalbumid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_postalbums<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_postalbums(*msdyn_postalbumid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_postalbums(*msdyn_postalbumid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_postalbums<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_postalbums(*msdyn_postalbumid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_postalbums(*msdyn_postalbumid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_postalbums(*msdyn_postalbumid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Profile Album (msdyn_PostAlbum) table.
...
The following table lists selected properties for the Profile Album (msdyn_PostAlbum) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_postalbum_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_postalbum_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_postalbum](businessunit.md#BKMK_business_unit_msdyn_postalbum)
...
One-To-Many Relationship: [systemuser lk_msdyn_postalbum_createdby](systemuser.md#BKMK_lk_msdyn_postalbum_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_postalbum_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_postalbum_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_postalbum_modifiedby](systemuser.md#BKMK_lk_msdyn_postalbum_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_postalbum_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_postalbum_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_postalbum](owner.md#BKMK_owner_msdyn_postalbum)
...
One-To-Many Relationship: [team team_msdyn_postalbum](team.md#BKMK_team_msdyn_postalbum)
...
One-To-Many Relationship: [systemuser user_msdyn_postalbum](systemuser.md#BKMK_user_msdyn_postalbum)
...
Many-To-One Relationship: [activitypointer msdyn_postalbum_ActivityPointers](activitypointer.md#BKMK_msdyn_postalbum_ActivityPointers)
...
Many-To-One Relationship: [adx_alertsubscription msdyn_postalbum_adx_alertsubscriptions](adx_alertsubscription.md#BKMK_msdyn_postalbum_adx_alertsubscriptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_alertsubscription`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_adx_alertsubscriptions`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [adx_inviteredemption msdyn_postalbum_adx_inviteredemptions](adx_inviteredemption.md#BKMK_msdyn_postalbum_adx_inviteredemptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_inviteredemption`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_adx_inviteredemptions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_adx_portalcomments"></a> msdyn_postalbum_adx_portalcomments

Many-To-One Relationship: [adx_portalcomment msdyn_postalbum_adx_portalcomments](adx_portalcomment.md#BKMK_msdyn_postalbum_adx_portalcomments)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_portalcomment`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_adx_portalcomments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_Annotations"></a> msdyn_postalbum_Annotations

Many-To-One Relationship: [annotation msdyn_postalbum_Annotations](annotation.md#BKMK_msdyn_postalbum_Annotations)
...
Many-To-One Relationship: [appointment msdyn_postalbum_Appointments](appointment.md#BKMK_msdyn_postalbum_Appointments)
...
Many-To-One Relationship: [asyncoperation msdyn_postalbum_AsyncOperations](asyncoperation.md#BKMK_msdyn_postalbum_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_postalbum_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_postalbum_BulkDeleteFailures)
...
Many-To-One Relationship: [chat msdyn_postalbum_chats](chat.md#BKMK_msdyn_postalbum_chats)

|Property|Value|
|---|---|
|ReferencingEntity|`chat`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_chats`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_connections1"></a> msdyn_postalbum_connections1

Many-To-One Relationship: [connection msdyn_postalbum_connections1](connection.md#BKMK_msdyn_postalbum_connections1)
...
Many-To-One Relationship: [connection msdyn_postalbum_connections2](connection.md#BKMK_msdyn_postalbum_connections2)
...
Many-To-One Relationship: [duplicaterecord msdyn_postalbum_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_postalbum_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_postalbum_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_postalbum_DuplicateMatchingRecord)
...
Many-To-One Relationship: [email msdyn_postalbum_Emails](email.md#BKMK_msdyn_postalbum_Emails)
...
Many-To-One Relationship: [fax msdyn_postalbum_Faxes](fax.md#BKMK_msdyn_postalbum_Faxes)
...
Many-To-One Relationship: [letter msdyn_postalbum_Letters](letter.md#BKMK_msdyn_postalbum_Letters)
...
Many-To-One Relationship: [li_inmail msdyn_postalbum_li_inmails](li_inmail.md#BKMK_msdyn_postalbum_li_inmails)

|Property|Value|
|---|---|
|ReferencingEntity|`li_inmail`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_li_inmails`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_li_messages"></a> msdyn_postalbum_li_messages

Many-To-One Relationship: [li_message msdyn_postalbum_li_messages](li_message.md#BKMK_msdyn_postalbum_li_messages)

|Property|Value|
|---|---|
|ReferencingEntity|`li_message`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_li_messages`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_li_pointdrivepresentationvieweds"></a> msdyn_postalbum_li_pointdrivepresentationvieweds

Many-To-One Relationship: [li_pointdrivepresentationviewed msdyn_postalbum_li_pointdrivepresentationvieweds](li_pointdrivepresentationviewed.md#BKMK_msdyn_postalbum_li_pointdrivepresentationvieweds)

|Property|Value|
|---|---|
|ReferencingEntity|`li_pointdrivepresentationviewed`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_li_pointdrivepresentationvieweds`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_MailboxTrackingFolders"></a> msdyn_postalbum_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder msdyn_postalbum_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_postalbum_MailboxTrackingFolders)
...
Many-To-One Relationship: [msdyn_copilottranscript msdyn_postalbum_msdyn_copilottranscripts](msdyn_copilottranscript.md#BKMK_msdyn_postalbum_msdyn_copilottranscripts)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_copilottranscript`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_msdyn_copilottranscripts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_msdyn_ocliveworkitems"></a> msdyn_postalbum_msdyn_ocliveworkitems

Many-To-One Relationship: [msdyn_ocliveworkitem msdyn_postalbum_msdyn_ocliveworkitems](msdyn_ocliveworkitem.md#BKMK_msdyn_postalbum_msdyn_ocliveworkitems)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocliveworkitem`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_msdyn_ocliveworkitems`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [msdyn_ocsession msdyn_postalbum_msdyn_ocsessions](msdyn_ocsession.md#BKMK_msdyn_postalbum_msdyn_ocsessions)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_msdyn_ocsessions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [msfp_alert msdyn_postalbum_msfp_alerts](msfp_alert.md#BKMK_msdyn_postalbum_msfp_alerts)

|Property|Value|
|---|---|
|ReferencingEntity|`msfp_alert`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_postalbum_msfp_alerts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_postalbum_msfp_surveyinvites"></a> msdyn_postalbum_msfp_surveyinvites

Many-To-One Relationship: [msfp_surveyinvite msdyn_postalbum_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_postalbum_msfp_surveyinvites)
...
Many-To-One Relationship: [msfp_surveyresponse msdyn_postalbum_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_postalbum_msfp_surveyresponses)
...
Many-To-One Relationship: [phonecall msdyn_postalbum_PhoneCalls](phonecall.md#BKMK_msdyn_postalbum_PhoneCalls)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_postalbum_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_postalbum_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_postalbum_ProcessSession](processsession.md#BKMK_msdyn_postalbum_ProcessSession)
...
Many-To-One Relationship: [recurringappointmentmaster msdyn_postalbum_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_msdyn_postalbum_RecurringAppointmentMasters)
...
Many-To-One Relationship: [serviceappointment msdyn_postalbum_ServiceAppointments](serviceappointment.md#BKMK_msdyn_postalbum_ServiceAppointments)
...
Many-To-One Relationship: [socialactivity msdyn_postalbum_SocialActivities](socialactivity.md#BKMK_msdyn_postalbum_SocialActivities)
...
Many-To-One Relationship: [syncerror msdyn_postalbum_SyncErrors](syncerror.md#BKMK_msdyn_postalbum_SyncErrors)
...
Many-To-One Relationship: [task msdyn_postalbum_Tasks](task.md#BKMK_msdyn_postalbum_Tasks)
