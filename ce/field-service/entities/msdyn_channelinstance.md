---
title: "Channel Instance (msdyn_ChannelInstance) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Channel Instance (msdyn_ChannelInstance) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
|RequiredLevel|None|
|Type|Lookup|
|Targets|msdynmkt_byoacschannelinstance, msdynmkt_infobipchannelinstance, msdynmkt_linkmobilitychannelinstance, msdynmkt_mobileappchannelinstance, msdynmkt_mocksmsproviderchannelinstance, msdynmkt_telesignchannelinstance, msdynmkt_twiliochannelinstance, msdynmkt_vibeschannelinstance, msdyn_defextendedchannelinstance|
...
One-To-Many Relationship: [msdynmkt_mobileappchannelinstance msdyn_ChannelInstance_extendedentityid_msdynmkt_mobileappchannelinstance](msdynmkt_mobileappchannelinstance.md#BKMK_msdyn_ChannelInstance_extendedentityid_msdynmkt_mobileappchannelinstance)
...
|ReferencingAttribute|`msdyn_extendedentityid`|
|ReferencingEntityNavigationPropertyName|`msdyn_extendedentityid_msdynmkt_mobileappchannelinstance`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
Many-To-One Relationship: [msdynmkt_customchannelmessage msdynmkt_msdyn_ChannelInstance_msdynmkt_customchannelmessage](msdynmkt_customchannelmessage.md#BKMK_msdynmkt_msdyn_ChannelInstance_msdynmkt_customchannelmessage)

|Property|Value|
|---|---|
|ReferencingEntity|`msdynmkt_customchannelmessage`|
|ReferencingAttribute|`msdynmkt_channelinstanceid`|
|ReferencedEntityNavigationPropertyName|`msdynmkt_msdyn_ChannelInstance_msdynmkt_customchannelmessage`|
|IsCustomizable|`False`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
