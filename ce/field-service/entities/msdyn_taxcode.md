---
title: "Tax Code (msdyn_taxcode) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Tax Code (msdyn_taxcode) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
# Tax Code (msdyn_taxcode) table/entity reference
...
The following table lists the messages for the Tax Code (msdyn_taxcode) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_taxcodes<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_taxcodes<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_taxcodes(*msdyn_taxcodeid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Tax Code (msdyn_taxcode) table.
...
The following table lists selected properties for the Tax Code (msdyn_taxcode) table.
...
|Type|Boolean|
|GlobalChoiceName|`msdyn_taxcode_msdyn_actastaxgroup`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|ApplicationRequired|
|Type|Boolean|
|GlobalChoiceName|`msdyn_taxcode_msdyn_agreementtaxable`|
|DefaultValue|True|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|ApplicationRequired|
|Type|Boolean|
|GlobalChoiceName|`msdyn_taxcode_msdyn_productstaxable`|
|DefaultValue|True|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|ApplicationRequired|
|Type|Boolean|
|GlobalChoiceName|`msdyn_taxcode_msdyn_servicestaxable`|
|DefaultValue|True|
|True Label|Yes|
|False Label|No|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_taxcode_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_taxcode_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_taxcode](businessunit.md#BKMK_business_unit_msdyn_taxcode)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcode_createdby](systemuser.md#BKMK_lk_msdyn_taxcode_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcode_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_taxcode_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcode_modifiedby](systemuser.md#BKMK_lk_msdyn_taxcode_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcode_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_taxcode_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_taxcode](owner.md#BKMK_owner_msdyn_taxcode)
...
One-To-Many Relationship: [team team_msdyn_taxcode](team.md#BKMK_team_msdyn_taxcode)
...
One-To-Many Relationship: [systemuser user_msdyn_taxcode](systemuser.md#BKMK_user_msdyn_taxcode)
...
Many-To-One Relationship: [account msdyn_msdyn_taxcode_account_SalesTaxCode](account.md#BKMK_msdyn_msdyn_taxcode_account_SalesTaxCode)
...
Many-To-One Relationship: [msdyn_actual msdyn_msdyn_taxcode_msdyn_actual_TaxCode](msdyn_actual.md#BKMK_msdyn_msdyn_taxcode_msdyn_actual_TaxCode)
...
Many-To-One Relationship: [msdyn_agreement msdyn_msdyn_taxcode_msdyn_agreement_SalesTaxCode](msdyn_agreement.md#BKMK_msdyn_msdyn_taxcode_msdyn_agreement_SalesTaxCode)
...
Many-To-One Relationship: [msdyn_purchaseorderbill msdyn_msdyn_taxcode_msdyn_purchaseorderbill_TaxCode](msdyn_purchaseorderbill.md#BKMK_msdyn_msdyn_taxcode_msdyn_purchaseorderbill_TaxCode)
...
Many-To-One Relationship: [msdyn_rma msdyn_msdyn_taxcode_msdyn_rma_TaxCode](msdyn_rma.md#BKMK_msdyn_msdyn_taxcode_msdyn_rma_TaxCode)
...
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseLabel`<br />Group: `Details`<br />Label: Tax Code<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_msdyn_taxcode_msdyn_rtv_TaxCode"></a> msdyn_msdyn_taxcode_msdyn_rtv_TaxCode

Many-To-One Relationship: [msdyn_rtv msdyn_msdyn_taxcode_msdyn_rtv_TaxCode](msdyn_rtv.md#BKMK_msdyn_msdyn_taxcode_msdyn_rtv_TaxCode)
...
Many-To-One Relationship: [msdyn_taxcodedetail msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode](msdyn_taxcodedetail.md#BKMK_msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode)
...
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: Tax Code Groups<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode"></a> msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode

Many-To-One Relationship: [msdyn_taxcodedetail msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode](msdyn_taxcodedetail.md#BKMK_msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode)
...
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseLabel`<br />Group: `Details`<br />Label: Tax Code Items<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_msdyn_taxcode_msdyn_workorder_TaxCode"></a> msdyn_msdyn_taxcode_msdyn_workorder_TaxCode

Many-To-One Relationship: [msdyn_workorder msdyn_msdyn_taxcode_msdyn_workorder_TaxCode](msdyn_workorder.md#BKMK_msdyn_msdyn_taxcode_msdyn_workorder_TaxCode)
...
Many-To-One Relationship: [quotedetail msdyn_msdyn_taxcode_quotedetail_SalesTaxCode](quotedetail.md#BKMK_msdyn_msdyn_taxcode_quotedetail_SalesTaxCode)
...
Many-To-One Relationship: [annotation msdyn_taxcode_Annotations](annotation.md#BKMK_msdyn_taxcode_Annotations)
...
Many-To-One Relationship: [asyncoperation msdyn_taxcode_AsyncOperations](asyncoperation.md#BKMK_msdyn_taxcode_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_taxcode_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_taxcode_BulkDeleteFailures)
...
Many-To-One Relationship: [connection msdyn_taxcode_connections1](connection.md#BKMK_msdyn_taxcode_connections1)
...
Many-To-One Relationship: [connection msdyn_taxcode_connections2](connection.md#BKMK_msdyn_taxcode_connections2)
...
Many-To-One Relationship: [duplicaterecord msdyn_taxcode_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_taxcode_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_taxcode_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_taxcode_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_taxcode_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_taxcode_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_taxcode_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_taxcode_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_taxcode_ProcessSession](processsession.md#BKMK_msdyn_taxcode_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_taxcode_SyncErrors](syncerror.md#BKMK_msdyn_taxcode_SyncErrors)
