---
title: "Org level settings for Sales Copilot apps (msdyn_salescopilotorgsettings) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Org level settings for Sales Copilot apps (msdyn_salescopilotorgsettings) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
The following table lists the events for the Org level settings for Sales Copilot apps (msdyn_salescopilotorgsettings) table.
