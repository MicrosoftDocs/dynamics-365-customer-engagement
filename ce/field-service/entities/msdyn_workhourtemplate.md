---
title: "Work Template (msdyn_workhourtemplate) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Work Template (msdyn_workhourtemplate) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
The following table lists the messages for the Work Template (msdyn_workhourtemplate) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_workhourtemplates<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_workhourtemplates<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_workhourtemplates(*msdyn_workhourtemplateid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Work Template (msdyn_workhourtemplate) table.
...
The following table lists selected properties for the Work Template (msdyn_workhourtemplate) table.

|Property|Value|
| --- | --- |
| **DisplayName** | **Work Template** |
| **DisplayCollectionName** | **Work Templates** |
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_workhourtemplate_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_workhourtemplate_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_workhourtemplate](businessunit.md#BKMK_business_unit_msdyn_workhourtemplate)
...
One-To-Many Relationship: [systemuser lk_msdyn_workhourtemplate_createdby](systemuser.md#BKMK_lk_msdyn_workhourtemplate_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workhourtemplate_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_workhourtemplate_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workhourtemplate_modifiedby](systemuser.md#BKMK_lk_msdyn_workhourtemplate_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workhourtemplate_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_workhourtemplate_modifiedonbehalfby)
...
One-To-Many Relationship: [bookableresource msdyn_bookableresource_msdyn_workhourtemplate_bookableresourceid](bookableresource.md#BKMK_msdyn_bookableresource_msdyn_workhourtemplate_bookableresourceid)
...
One-To-Many Relationship: [owner owner_msdyn_workhourtemplate](owner.md#BKMK_owner_msdyn_workhourtemplate)
...
One-To-Many Relationship: [team team_msdyn_workhourtemplate](team.md#BKMK_team_msdyn_workhourtemplate)
...
One-To-Many Relationship: [systemuser user_msdyn_workhourtemplate](systemuser.md#BKMK_user_msdyn_workhourtemplate)
...
Many-To-One Relationship: [account msdyn_msdyn_workhourtemplate_account_workhourtemplate](account.md#BKMK_msdyn_msdyn_workhourtemplate_account_workhourtemplate)

|Property|Value|
|---|---|
|ReferencingEntity|`account`|
|ReferencingAttribute|`msdyn_workhourtemplate`|
|ReferencedEntityNavigationPropertyName|`msdyn_msdyn_workhourtemplate_account_workhourtemplate`|
...
Many-To-One Relationship: [msdyn_workorder msdyn_msdyn_workhourtemplate_msdyn_workorder_workhourtemplate](msdyn_workorder.md#BKMK_msdyn_msdyn_workhourtemplate_msdyn_workorder_workhourtemplate)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_workorder`|
|ReferencingAttribute|`msdyn_workhourtemplate`|
|ReferencedEntityNavigationPropertyName|`msdyn_msdyn_workhourtemplate_msdyn_workorder_workhourtemplate`|
|IsCustomizable|`False`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workhourtemplate_AsyncOperations"></a> msdyn_workhourtemplate_AsyncOperations

Many-To-One Relationship: [asyncoperation msdyn_workhourtemplate_AsyncOperations](asyncoperation.md#BKMK_msdyn_workhourtemplate_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_workhourtemplate_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_workhourtemplate_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_workhourtemplate_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_workhourtemplate_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_workhourtemplate_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_workhourtemplate_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_workhourtemplate_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_workhourtemplate_MailboxTrackingFolders)
...
Many-To-One Relationship: [msdyn_resourcerequirement msdyn_workhourtemplate_msdyn_resourcerequirement_workhourtemplate](msdyn_resourcerequirement.md#BKMK_msdyn_workhourtemplate_msdyn_resourcerequirement_workhourtemplate)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_workhourtemplate_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_workhourtemplate_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_workhourtemplate_ProcessSession](processsession.md#BKMK_msdyn_workhourtemplate_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_workhourtemplate_SyncErrors](syncerror.md#BKMK_msdyn_workhourtemplate_SyncErrors)
