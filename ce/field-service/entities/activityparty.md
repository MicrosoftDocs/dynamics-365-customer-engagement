...
One-To-Many Relationship: [adx_alertsubscription adx_alertsubscription_activity_parties](adx_alertsubscription.md#BKMK_adx_alertsubscription_activity_parties)
...
|ReferencingEntityNavigationPropertyName|`activityid_adx_alertsubscription_activityparty`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
...
One-To-Many Relationship: [li_inmail li_inmail_activity_parties](li_inmail.md#BKMK_li_inmail_activity_parties)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`activityid`|
|ReferencingEntityNavigationPropertyName|`activityid_li_inmail_activityparty`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_li_message_activity_parties"></a> li_message_activity_parties

One-To-Many Relationship: [li_message li_message_activity_parties](li_message.md#BKMK_li_message_activity_parties)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`activityid`|
|ReferencingEntityNavigationPropertyName|`activityid_li_message_activityparty`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_li_pointdrivepresentationviewed_activity_parties"></a> li_pointdrivepresentationviewed_activity_parties

One-To-Many Relationship: [li_pointdrivepresentationviewed li_pointdrivepresentationviewed_activity_parties](li_pointdrivepresentationviewed.md#BKMK_li_pointdrivepresentationviewed_activity_parties)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`activityid`|
|ReferencingEntityNavigationPropertyName|`activityid_li_pointdrivepresentationviewed_activityparty`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `NoCascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
