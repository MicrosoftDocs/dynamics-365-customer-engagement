...
# Workflow Action Status (msdyn_workflowactionstatus) table/entity reference

PA Workflows action processing status

## Messages

The following table lists the messages for the Workflow Action Status (msdyn_workflowactionstatus) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Create`<br />Event: True |`POST` /msdyn_workflowactionstatuses<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_workflowactionstatuses(*msdyn_workflowactionstatusid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
| `IsValidStateTransition`<br />Event: False |<xref:Microsoft.Dynamics.CRM.IsValidStateTransition?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
| `Retrieve`<br />Event: True |`GET` /msdyn_workflowactionstatuses(*msdyn_workflowactionstatusid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_workflowactionstatuses<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `SetState`<br />Event: True |`PATCH` /msdyn_workflowactionstatuses(*msdyn_workflowactionstatusid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_workflowactionstatuses(*msdyn_workflowactionstatusid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_workflowactionstatuses(*msdyn_workflowactionstatusid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|

## Properties

The following table lists selected properties for the Workflow Action Status (msdyn_workflowactionstatus) table.
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_workflowactionstatus_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_workflowactionstatus_statuscode`|
...
One-To-Many Relationship: [systemuser lk_msdyn_workflowactionstatus_createdby](systemuser.md#BKMK_lk_msdyn_workflowactionstatus_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workflowactionstatus_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_workflowactionstatus_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workflowactionstatus_modifiedby](systemuser.md#BKMK_lk_msdyn_workflowactionstatus_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workflowactionstatus_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_workflowactionstatus_modifiedonbehalfby)
...
One-To-Many Relationship: [organization organization_msdyn_workflowactionstatus](organization.md#BKMK_organization_msdyn_workflowactionstatus)
...
Many-To-One Relationship: [asyncoperation msdyn_workflowactionstatus_AsyncOperations](asyncoperation.md#BKMK_msdyn_workflowactionstatus_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_workflowactionstatus_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_workflowactionstatus_BulkDeleteFailures)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_workflowactionstatus_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_workflowactionstatus_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_workflowactionstatus_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_workflowactionstatus_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_workflowactionstatus_ProcessSession](processsession.md#BKMK_msdyn_workflowactionstatus_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_workflowactionstatus_SyncErrors](syncerror.md#BKMK_msdyn_workflowactionstatus_SyncErrors)
...
<xref:Microsoft.Dynamics.CRM.msdyn_workflowactionstatus?displayProperty=fullName>
