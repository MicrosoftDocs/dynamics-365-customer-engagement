---
title: "Chatbot subcomponent (botcomponent) table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the Chatbot subcomponent (botcomponent) table/entity with Microsoft Dataverse."
ms.date: 08.01.2024
...
The following table lists the messages for the Chatbot subcomponent (botcomponent) table.
...
The following table lists selected properties for the Chatbot subcomponent (botcomponent) table.
