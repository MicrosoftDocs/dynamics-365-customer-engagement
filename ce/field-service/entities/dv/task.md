---
title: "Task table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the Task table/entity with Microsoft Dataverse."
ms.date: 08.01.2024
...
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /tasks(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /tasks<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `Delete`<br />Event: True |`DELETE` /tasks(*activityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
| `GrantAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.GrantAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
| `ModifyAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.ModifyAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
| `Retrieve`<br />Event: True |`GET` /tasks(*activityid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /tasks<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /tasks(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /tasks(*activityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `Upsert`<br />Event: False |`PATCH` /tasks(*activityid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|

## Properties

The following table lists selected properties for the Task table.
...
|Value|Details|
|---|---|
|0|Label: **Open**<br />DefaultStatus: 2<br />InvariantName: `Open`|
|1|Label: **Completed**<br />DefaultStatus: 5<br />InvariantName: `Completed`|
|2|Label: **Canceled**<br />DefaultStatus: 6<br />InvariantName: `Canceled`|
...
|Value|Details|
|---|---|
|2|Label: **Not Started**<br />State:0<br />TransitionData: None|
|3|Label: **In Progress**<br />State:0<br />TransitionData: None|
|4|Label: **Waiting on someone else**<br />State:0<br />TransitionData: None|
|5|Label: **Completed**<br />State:1<br />TransitionData: None|
|6|Label: **Canceled**<br />State:2<br />TransitionData: None|
|7|Label: **Deferred**<br />State:0<br />TransitionData: None|
...
One-To-Many Relationship: [account Account_Tasks](account.md#BKMK_Account_Tasks)
...
One-To-Many Relationship: [activitypointer activity_pointer_task](activitypointer.md#BKMK_activity_pointer_task)
...
One-To-Many Relationship: [adx_invitation adx_invitation_Tasks](adx_invitation.md#BKMK_adx_invitation_Tasks)
...
One-To-Many Relationship: [businessunit business_unit_task_activities](businessunit.md#BKMK_business_unit_task_activities)
...
One-To-Many Relationship: [contact Contact_Tasks](contact.md#BKMK_Contact_Tasks)
...
One-To-Many Relationship: [knowledgearticle KnowledgeArticle_Tasks](knowledgearticle.md#BKMK_KnowledgeArticle_Tasks)
...
One-To-Many Relationship: [knowledgebaserecord KnowledgeBaseRecord_Tasks](knowledgebaserecord.md#BKMK_KnowledgeBaseRecord_Tasks)
...
One-To-Many Relationship: [systemuser lk_task_createdby](systemuser.md#BKMK_lk_task_createdby)
...
One-To-Many Relationship: [systemuser lk_task_createdonbehalfby](systemuser.md#BKMK_lk_task_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_task_modifiedby](systemuser.md#BKMK_lk_task_modifiedby)
...
One-To-Many Relationship: [systemuser lk_task_modifiedonbehalfby](systemuser.md#BKMK_lk_task_modifiedonbehalfby)
...
One-To-Many Relationship: [sla manualsla_task](sla.md#BKMK_manualsla_task)
...
One-To-Many Relationship: [mspp_adplacement mspp_adplacement_Tasks](mspp_adplacement.md#BKMK_mspp_adplacement_Tasks)
...
One-To-Many Relationship: [mspp_pollplacement mspp_pollplacement_Tasks](mspp_pollplacement.md#BKMK_mspp_pollplacement_Tasks)
...
One-To-Many Relationship: [mspp_publishingstatetransitionrule mspp_publishingstatetransitionrule_Tasks](mspp_publishingstatetransitionrule.md#BKMK_mspp_publishingstatetransitionrule_Tasks)
...
One-To-Many Relationship: [mspp_redirect mspp_redirect_Tasks](mspp_redirect.md#BKMK_mspp_redirect_Tasks)
...
One-To-Many Relationship: [mspp_shortcut mspp_shortcut_Tasks](mspp_shortcut.md#BKMK_mspp_shortcut_Tasks)
...
One-To-Many Relationship: [mspp_website mspp_website_Tasks](mspp_website.md#BKMK_mspp_website_Tasks)
...
One-To-Many Relationship: [owner owner_tasks](owner.md#BKMK_owner_tasks)
...
One-To-Many Relationship: [processstage processstage_tasks](processstage.md#BKMK_processstage_tasks)
...
One-To-Many Relationship: [sla sla_task](sla.md#BKMK_sla_task)
...
One-To-Many Relationship: [team team_task](team.md#BKMK_team_task)
...
One-To-Many Relationship: [transactioncurrency TransactionCurrency_Task](transactioncurrency.md#BKMK_TransactionCurrency_Task)
...
One-To-Many Relationship: [systemuser user_task](systemuser.md#BKMK_user_task)
...
Many-To-One Relationship: [slakpiinstance slakpiinstance_task](slakpiinstance.md#BKMK_slakpiinstance_task)
...
Many-To-One Relationship: [actioncard task_actioncard](actioncard.md#BKMK_task_actioncard)
...
Many-To-One Relationship: [activityparty task_activity_parties](activityparty.md#BKMK_task_activity_parties)
...
Many-To-One Relationship: [annotation Task_Annotation](annotation.md#BKMK_Task_Annotation)
...
Many-To-One Relationship: [asyncoperation Task_AsyncOperations](asyncoperation.md#BKMK_Task_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure Task_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Task_BulkDeleteFailures)
...
Many-To-One Relationship: [connection task_connections1](connection.md#BKMK_task_connections1)
...
Many-To-One Relationship: [connection task_connections2](connection.md#BKMK_task_connections2)
...
Many-To-One Relationship: [duplicaterecord Task_DuplicateBaseRecord](duplicaterecord.md#BKMK_Task_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord Task_DuplicateMatchingRecord](duplicaterecord.md#BKMK_Task_DuplicateMatchingRecord)
...
Many-To-One Relationship: [postfollow task_PostFollows](postfollow.md#BKMK_task_PostFollows)
...
Many-To-One Relationship: [postregarding task_PostRegardings](postregarding.md#BKMK_task_PostRegardings)
...
Many-To-One Relationship: [principalobjectattributeaccess task_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_task_principalobjectattributeaccess)
...
Many-To-One Relationship: [processsession Task_ProcessSessions](processsession.md#BKMK_Task_ProcessSessions)
...
Many-To-One Relationship: [queueitem Task_QueueItem](queueitem.md#BKMK_Task_QueueItem)
...
Many-To-One Relationship: [syncerror Task_SyncErrors](syncerror.md#BKMK_Task_SyncErrors)
