---
title: "Portal Comment (adx_portalcomment) table/entity reference (Microsoft Dataverse)"
description: "Includes schema information and supported messages for the Portal Comment (adx_portalcomment) table/entity with Microsoft Dataverse."
ms.date: 08.01.2024
...
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /adx_portalcomments(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /adx_portalcomments<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /adx_portalcomments(*activityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `Retrieve`<br />Event: True |`GET` /adx_portalcomments(*activityid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /adx_portalcomments<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /adx_portalcomments(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /adx_portalcomments(*activityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /adx_portalcomments(*activityid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Portal Comment (adx_portalcomment) table.
...
The following table lists selected properties for the Portal Comment (adx_portalcomment) table.
...
|Type|Picklist|
|DefaultFormValue|1|
|GlobalChoiceName|`adx_portalcomment_directioncode`|
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`adx_portalcomment_isbilled`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`adx_portalcomment_ismapiprivate`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`adx_portalcomment_isworkflowcreated`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`adx_portalcomment_leftvoicemail`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|Picklist|
|DefaultFormValue|1|
|GlobalChoiceName|`adx_portalcomment_prioritycode`|
...
|Type|State|
|DefaultFormValue|0|
|GlobalChoiceName|`adx_portalcomment_statecode`|
...
|Type|Status|
|DefaultFormValue|-1|
|GlobalChoiceName|`adx_portalcomment_statuscode`|
...
|2|Label: **Sent**<br />State:1<br />TransitionData: None|
|3|Label: **Received**<br />State:1<br />TransitionData: None|
|4|Label: **Canceled**<br />State:2<br />TransitionData: None|
|5|Label: **Scheduled**<br />State:3<br />TransitionData: None|
...
|Type|Picklist|
|DefaultFormValue|0|
|GlobalChoiceName|`adx_portalcomment_instancetypecode`|
...
One-To-Many Relationship: [account account_adx_portalcomments](account.md#BKMK_account_adx_portalcomments)
...
One-To-Many Relationship: [activitypointer activity_pointer_adx_portalcomment](activitypointer.md#BKMK_activity_pointer_adx_portalcomment)
...
One-To-Many Relationship: [adx_invitation adx_invitation_adx_portalcomments](adx_invitation.md#BKMK_adx_invitation_adx_portalcomments)
...
One-To-Many Relationship: [businessunit adx_portalcomment_businessunit_owningbusinessunit](businessunit.md#BKMK_adx_portalcomment_businessunit_owningbusinessunit)
...
One-To-Many Relationship: [mailbox adx_portalcomment_mailbox_sendermailboxid](mailbox.md#BKMK_adx_portalcomment_mailbox_sendermailboxid)
...
One-To-Many Relationship: [owner adx_portalcomment_owner_ownerid](owner.md#BKMK_adx_portalcomment_owner_ownerid)
...
One-To-Many Relationship: [sla adx_portalcomment_sla_slaid](sla.md#BKMK_adx_portalcomment_sla_slaid)
...
One-To-Many Relationship: [sla adx_portalcomment_sla_slainvokedid](sla.md#BKMK_adx_portalcomment_sla_slainvokedid)
...
One-To-Many Relationship: [systemuser adx_portalcomment_systemuser_createdby](systemuser.md#BKMK_adx_portalcomment_systemuser_createdby)
...
One-To-Many Relationship: [systemuser adx_portalcomment_systemuser_createdonbehalfby](systemuser.md#BKMK_adx_portalcomment_systemuser_createdonbehalfby)
...
One-To-Many Relationship: [systemuser adx_portalcomment_systemuser_modifiedby](systemuser.md#BKMK_adx_portalcomment_systemuser_modifiedby)
...
One-To-Many Relationship: [systemuser adx_portalcomment_systemuser_modifiedonbehalfby](systemuser.md#BKMK_adx_portalcomment_systemuser_modifiedonbehalfby)
...
One-To-Many Relationship: [systemuser adx_portalcomment_systemuser_owninguser](systemuser.md#BKMK_adx_portalcomment_systemuser_owninguser)
...
One-To-Many Relationship: [team adx_portalcomment_team_owningteam](team.md#BKMK_adx_portalcomment_team_owningteam)
...
One-To-Many Relationship: [transactioncurrency adx_portalcomment_transactioncurrency_transactioncurrencyid](transactioncurrency.md#BKMK_adx_portalcomment_transactioncurrency_transactioncurrencyid)
...
One-To-Many Relationship: [contact contact_adx_portalcomments](contact.md#BKMK_contact_adx_portalcomments)
...
One-To-Many Relationship: [interactionforemail interactionforemail_adx_portalcomments](interactionforemail.md#BKMK_interactionforemail_adx_portalcomments)
...
One-To-Many Relationship: [knowledgearticle knowledgearticle_adx_portalcomments](knowledgearticle.md#BKMK_knowledgearticle_adx_portalcomments)
...
One-To-Many Relationship: [knowledgebaserecord knowledgebaserecord_adx_portalcomments](knowledgebaserecord.md#BKMK_knowledgebaserecord_adx_portalcomments)
...
One-To-Many Relationship: [mspp_adplacement mspp_adplacement_adx_portalcomments](mspp_adplacement.md#BKMK_mspp_adplacement_adx_portalcomments)
...
One-To-Many Relationship: [mspp_pollplacement mspp_pollplacement_adx_portalcomments](mspp_pollplacement.md#BKMK_mspp_pollplacement_adx_portalcomments)
...
One-To-Many Relationship: [mspp_publishingstatetransitionrule mspp_publishingstatetransitionrule_adx_portalcomments](mspp_publishingstatetransitionrule.md#BKMK_mspp_publishingstatetransitionrule_adx_portalcomments)
...
One-To-Many Relationship: [mspp_redirect mspp_redirect_adx_portalcomments](mspp_redirect.md#BKMK_mspp_redirect_adx_portalcomments)
...
One-To-Many Relationship: [mspp_shortcut mspp_shortcut_adx_portalcomments](mspp_shortcut.md#BKMK_mspp_shortcut_adx_portalcomments)
...
One-To-Many Relationship: [mspp_website mspp_website_adx_portalcomments](mspp_website.md#BKMK_mspp_website_adx_portalcomments)
...
One-To-Many Relationship: [processstage processstage_adx_portalcomment](processstage.md#BKMK_processstage_adx_portalcomment)
...
Many-To-One Relationship: [actioncard adx_portalcomment_ActionCards](actioncard.md#BKMK_adx_portalcomment_ActionCards)
...
Many-To-One Relationship: [activityparty adx_portalcomment_activity_parties](activityparty.md#BKMK_adx_portalcomment_activity_parties)
...
Many-To-One Relationship: [annotation adx_portalcomment_Annotations](annotation.md#BKMK_adx_portalcomment_Annotations)
...
Many-To-One Relationship: [asyncoperation adx_portalcomment_AsyncOperations](asyncoperation.md#BKMK_adx_portalcomment_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure adx_portalcomment_BulkDeleteFailures](bulkdeletefailure.md#BKMK_adx_portalcomment_BulkDeleteFailures)
...
Many-To-One Relationship: [mailboxtrackingfolder adx_portalcomment_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_adx_portalcomment_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess adx_portalcomment_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_adx_portalcomment_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession adx_portalcomment_ProcessSession](processsession.md#BKMK_adx_portalcomment_ProcessSession)
...
Many-To-One Relationship: [queueitem adx_portalcomment_QueueItems](queueitem.md#BKMK_adx_portalcomment_QueueItems)
...
Many-To-One Relationship: [sharepointdocumentlocation adx_portalcomment_SharePointDocumentLocations](sharepointdocumentlocation.md#BKMK_adx_portalcomment_SharePointDocumentLocations)
...
Many-To-One Relationship: [syncerror adx_portalcomment_SyncErrors](syncerror.md#BKMK_adx_portalcomment_SyncErrors)
