...
| `CreateFlowCredentialApplication`<br />Event: False |**CreateFlowCredentialApplication action** |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
