...
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /letters(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /letters<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `Delete`<br />Event: True |`DELETE` /letters(*activityid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
...
| `SetState`<br />Event: True |`PATCH` /letters(*activityid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /letters(*activityid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `Upsert`<br />Event: False |`PATCH` /letters(*activityid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|

## Properties

The following table lists selected properties for the Letter table.
...
|4|Label: **Sent**<br />State:1<br />TransitionData: None|
...
One-To-Many Relationship: [account Account_Letters](account.md#BKMK_Account_Letters)
...
One-To-Many Relationship: [activitypointer activity_pointer_letter](activitypointer.md#BKMK_activity_pointer_letter)
...
One-To-Many Relationship: [adx_invitation adx_invitation_Letters](adx_invitation.md#BKMK_adx_invitation_Letters)
...
One-To-Many Relationship: [businessunit business_unit_letter_activities](businessunit.md#BKMK_business_unit_letter_activities)
...
One-To-Many Relationship: [contact Contact_Letters](contact.md#BKMK_Contact_Letters)
...
One-To-Many Relationship: [knowledgearticle KnowledgeArticle_Letters](knowledgearticle.md#BKMK_KnowledgeArticle_Letters)
...
One-To-Many Relationship: [knowledgebaserecord KnowledgeBaseRecord_Letters](knowledgebaserecord.md#BKMK_KnowledgeBaseRecord_Letters)
...
One-To-Many Relationship: [systemuser lk_letter_createdby](systemuser.md#BKMK_lk_letter_createdby)
...
One-To-Many Relationship: [systemuser lk_letter_createdonbehalfby](systemuser.md#BKMK_lk_letter_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_letter_modifiedby](systemuser.md#BKMK_lk_letter_modifiedby)
...
One-To-Many Relationship: [systemuser lk_letter_modifiedonbehalfby](systemuser.md#BKMK_lk_letter_modifiedonbehalfby)
...
One-To-Many Relationship: [sla manualsla_letter](sla.md#BKMK_manualsla_letter)
...
One-To-Many Relationship: [mspp_adplacement mspp_adplacement_Letters](mspp_adplacement.md#BKMK_mspp_adplacement_Letters)
...
One-To-Many Relationship: [mspp_pollplacement mspp_pollplacement_Letters](mspp_pollplacement.md#BKMK_mspp_pollplacement_Letters)
...
One-To-Many Relationship: [mspp_publishingstatetransitionrule mspp_publishingstatetransitionrule_Letters](mspp_publishingstatetransitionrule.md#BKMK_mspp_publishingstatetransitionrule_Letters)
...
One-To-Many Relationship: [mspp_redirect mspp_redirect_Letters](mspp_redirect.md#BKMK_mspp_redirect_Letters)
...
One-To-Many Relationship: [mspp_shortcut mspp_shortcut_Letters](mspp_shortcut.md#BKMK_mspp_shortcut_Letters)
...
One-To-Many Relationship: [mspp_website mspp_website_Letters](mspp_website.md#BKMK_mspp_website_Letters)
...
One-To-Many Relationship: [owner owner_letters](owner.md#BKMK_owner_letters)
...
One-To-Many Relationship: [processstage processstage_letters](processstage.md#BKMK_processstage_letters)
...
One-To-Many Relationship: [sla sla_letter](sla.md#BKMK_sla_letter)
...
One-To-Many Relationship: [team team_letter](team.md#BKMK_team_letter)
...
One-To-Many Relationship: [transactioncurrency TransactionCurrency_Letter](transactioncurrency.md#BKMK_TransactionCurrency_Letter)
...
One-To-Many Relationship: [systemuser user_letter](systemuser.md#BKMK_user_letter)
...
Many-To-One Relationship: [actioncard letter_actioncard](actioncard.md#BKMK_letter_actioncard)
...
Many-To-One Relationship: [activityparty letter_activity_parties](activityparty.md#BKMK_letter_activity_parties)
...
Many-To-One Relationship: [annotation Letter_Annotation](annotation.md#BKMK_Letter_Annotation)
...
Many-To-One Relationship: [asyncoperation Letter_AsyncOperations](asyncoperation.md#BKMK_Letter_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure Letter_BulkDeleteFailures](bulkdeletefailure.md#BKMK_Letter_BulkDeleteFailures)
...
Many-To-One Relationship: [connection letter_connections1](connection.md#BKMK_letter_connections1)
...
Many-To-One Relationship: [connection letter_connections2](connection.md#BKMK_letter_connections2)
...
Many-To-One Relationship: [duplicaterecord Letter_DuplicateBaseRecord](duplicaterecord.md#BKMK_Letter_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord Letter_DuplicateMatchingRecord](duplicaterecord.md#BKMK_Letter_DuplicateMatchingRecord)
...
Many-To-One Relationship: [principalobjectattributeaccess letter_principalobjectattributeaccess](principalobjectattributeaccess.md#BKMK_letter_principalobjectattributeaccess)
...
Many-To-One Relationship: [processsession Letter_ProcessSessions](processsession.md#BKMK_Letter_ProcessSessions)
...
Many-To-One Relationship: [queueitem Letter_QueueItem](queueitem.md#BKMK_Letter_QueueItem)
...
Many-To-One Relationship: [syncerror Letter_SyncErrors](syncerror.md#BKMK_Letter_SyncErrors)
...
Many-To-One Relationship: [slakpiinstance slakpiinstance_letter](slakpiinstance.md#BKMK_slakpiinstance_letter)
