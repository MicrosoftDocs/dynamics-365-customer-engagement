---
title: "Twitter Engagement Context (msdyn_twitterengagementctx) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Twitter Engagement Context (msdyn_twitterengagementctx) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
# Twitter Engagement Context (msdyn_twitterengagementctx) table/entity reference
...
The following table lists the events for the Twitter Engagement Context (msdyn_twitterengagementctx) table.
