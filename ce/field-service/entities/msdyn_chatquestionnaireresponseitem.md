---
title: "Survey Response Value (msdyn_chatquestionnaireresponseitem) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Survey Response Value (msdyn_chatquestionnaireresponseitem) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
# Survey Response Value (msdyn_chatquestionnaireresponseitem) table/entity reference
...
The following table lists the events for the Survey Response Value (msdyn_chatquestionnaireresponseitem) table.
