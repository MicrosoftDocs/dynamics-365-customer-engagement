...
One-To-Many Relationship: [adx_alertsubscription CampaignResponse_adx_alertsubscriptions](adx_alertsubscription.md#BKMK_CampaignResponse_adx_alertsubscriptions)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`originatingactivityid`|
|ReferencingEntityNavigationPropertyName|`originatingactivityid_adx_alertsubscription_campaignresponse`|
|IsHierarchical||
...
One-To-Many Relationship: [li_inmail CampaignResponse_li_inmails](li_inmail.md#BKMK_CampaignResponse_li_inmails)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`originatingactivityid`|
|ReferencingEntityNavigationPropertyName|`originatingactivityid_li_inmail_campaignresponse`|
|IsHierarchical||
|CascadeConfiguration|Archive: `Cascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_CampaignResponse_li_messages"></a> CampaignResponse_li_messages

One-To-Many Relationship: [li_message CampaignResponse_li_messages](li_message.md#BKMK_CampaignResponse_li_messages)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`originatingactivityid`|
|ReferencingEntityNavigationPropertyName|`originatingactivityid_li_message_campaignresponse`|
|IsHierarchical||
|CascadeConfiguration|Archive: `Cascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_CampaignResponse_li_pointdrivepresentationvieweds"></a> CampaignResponse_li_pointdrivepresentationvieweds

One-To-Many Relationship: [li_pointdrivepresentationviewed CampaignResponse_li_pointdrivepresentationvieweds](li_pointdrivepresentationviewed.md#BKMK_CampaignResponse_li_pointdrivepresentationvieweds)
...
|ReferencedAttribute|`activityid`|
|ReferencingAttribute|`originatingactivityid`|
|ReferencingEntityNavigationPropertyName|`originatingactivityid_li_pointdrivepresentationviewed_campaignresponse`|
|IsHierarchical||
|CascadeConfiguration|Archive: `Cascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
