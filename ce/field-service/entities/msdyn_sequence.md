---
title: "Sequence (msdyn_sequence) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Sequence (msdyn_sequence) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
Many-To-One Relationship: [msdyn_salespremiumdemo msdyn_msdyn_sequence_msdyn_salespremiumdemo_sequence](msdyn_salespremiumdemo.md#BKMK_msdyn_msdyn_sequence_msdyn_salespremiumdemo_sequence)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_salespremiumdemo`|
|ReferencingAttribute|`msdyn_sequence`|
|ReferencedEntityNavigationPropertyName|`msdyn_msdyn_sequence_msdyn_salespremiumdemo_sequence`|
|IsCustomizable|`True`|
