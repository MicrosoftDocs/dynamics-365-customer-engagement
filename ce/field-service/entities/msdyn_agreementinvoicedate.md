...
The following table lists the events for the Agreement Invoice Date (msdyn_agreementinvoicedate) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_agreementinvoicedate](businessunit.md#BKMK_business_unit_msdyn_agreementinvoicedate)
...
One-To-Many Relationship: [systemuser lk_msdyn_agreementinvoicedate_createdby](systemuser.md#BKMK_lk_msdyn_agreementinvoicedate_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_agreementinvoicedate_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_agreementinvoicedate_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_agreementinvoicedate_modifiedby](systemuser.md#BKMK_lk_msdyn_agreementinvoicedate_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_agreementinvoicedate_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_agreementinvoicedate_modifiedonbehalfby)
...
One-To-Many Relationship: [invoice msdyn_invoice_msdyn_agreementinvoicedate_Invoice](invoice.md#BKMK_msdyn_invoice_msdyn_agreementinvoicedate_Invoice)
...
One-To-Many Relationship: [owner owner_msdyn_agreementinvoicedate](owner.md#BKMK_owner_msdyn_agreementinvoicedate)
...
One-To-Many Relationship: [team team_msdyn_agreementinvoicedate](team.md#BKMK_team_msdyn_agreementinvoicedate)
...
One-To-Many Relationship: [systemuser user_msdyn_agreementinvoicedate](systemuser.md#BKMK_user_msdyn_agreementinvoicedate)
...
Many-To-One Relationship: [activitypointer msdyn_agreementinvoicedate_ActivityPointers](activitypointer.md#BKMK_msdyn_agreementinvoicedate_ActivityPointers)
...
Many-To-One Relationship: [adx_alertsubscription msdyn_agreementinvoicedate_adx_alertsubscriptions](adx_alertsubscription.md#BKMK_msdyn_agreementinvoicedate_adx_alertsubscriptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_alertsubscription`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_adx_alertsubscriptions`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [adx_inviteredemption msdyn_agreementinvoicedate_adx_inviteredemptions](adx_inviteredemption.md#BKMK_msdyn_agreementinvoicedate_adx_inviteredemptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_inviteredemption`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_adx_inviteredemptions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_adx_portalcomments"></a> msdyn_agreementinvoicedate_adx_portalcomments

Many-To-One Relationship: [adx_portalcomment msdyn_agreementinvoicedate_adx_portalcomments](adx_portalcomment.md#BKMK_msdyn_agreementinvoicedate_adx_portalcomments)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_portalcomment`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_adx_portalcomments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_Annotations"></a> msdyn_agreementinvoicedate_Annotations

Many-To-One Relationship: [annotation msdyn_agreementinvoicedate_Annotations](annotation.md#BKMK_msdyn_agreementinvoicedate_Annotations)
...
Many-To-One Relationship: [appointment msdyn_agreementinvoicedate_Appointments](appointment.md#BKMK_msdyn_agreementinvoicedate_Appointments)
...
Many-To-One Relationship: [asyncoperation msdyn_agreementinvoicedate_AsyncOperations](asyncoperation.md#BKMK_msdyn_agreementinvoicedate_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_agreementinvoicedate_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_agreementinvoicedate_BulkDeleteFailures)
...
Many-To-One Relationship: [chat msdyn_agreementinvoicedate_chats](chat.md#BKMK_msdyn_agreementinvoicedate_chats)

|Property|Value|
|---|---|
|ReferencingEntity|`chat`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_chats`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_connections1"></a> msdyn_agreementinvoicedate_connections1

Many-To-One Relationship: [connection msdyn_agreementinvoicedate_connections1](connection.md#BKMK_msdyn_agreementinvoicedate_connections1)
...
Many-To-One Relationship: [connection msdyn_agreementinvoicedate_connections2](connection.md#BKMK_msdyn_agreementinvoicedate_connections2)
...
Many-To-One Relationship: [duplicaterecord msdyn_agreementinvoicedate_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_agreementinvoicedate_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_agreementinvoicedate_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_agreementinvoicedate_DuplicateMatchingRecord)
...
Many-To-One Relationship: [email msdyn_agreementinvoicedate_Emails](email.md#BKMK_msdyn_agreementinvoicedate_Emails)
...
Many-To-One Relationship: [fax msdyn_agreementinvoicedate_Faxes](fax.md#BKMK_msdyn_agreementinvoicedate_Faxes)
...
Many-To-One Relationship: [letter msdyn_agreementinvoicedate_Letters](letter.md#BKMK_msdyn_agreementinvoicedate_Letters)
...
Many-To-One Relationship: [li_inmail msdyn_agreementinvoicedate_li_inmails](li_inmail.md#BKMK_msdyn_agreementinvoicedate_li_inmails)

|Property|Value|
|---|---|
|ReferencingEntity|`li_inmail`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_li_inmails`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_li_messages"></a> msdyn_agreementinvoicedate_li_messages

Many-To-One Relationship: [li_message msdyn_agreementinvoicedate_li_messages](li_message.md#BKMK_msdyn_agreementinvoicedate_li_messages)

|Property|Value|
|---|---|
|ReferencingEntity|`li_message`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_li_messages`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [li_pointdrivepresentationviewed msdyn_agreementinvoicedate_li_pointdrivepresentationvieweds](li_pointdrivepresentationviewed.md#BKMK_msdyn_agreementinvoicedate_li_pointdrivepresentationvieweds)

|Property|Value|
|---|---|
|ReferencingEntity|`li_pointdrivepresentationviewed`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_li_pointdrivepresentationvieweds`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_MailboxTrackingFolders"></a> msdyn_agreementinvoicedate_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder msdyn_agreementinvoicedate_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_agreementinvoicedate_MailboxTrackingFolders)
...
Many-To-One Relationship: [msdyn_copilottranscript msdyn_agreementinvoicedate_msdyn_copilottranscripts](msdyn_copilottranscript.md#BKMK_msdyn_agreementinvoicedate_msdyn_copilottranscripts)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_copilottranscript`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msdyn_copilottranscripts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msdyn_ocliveworkitems"></a> msdyn_agreementinvoicedate_msdyn_ocliveworkitems

Many-To-One Relationship: [msdyn_ocliveworkitem msdyn_agreementinvoicedate_msdyn_ocliveworkitems](msdyn_ocliveworkitem.md#BKMK_msdyn_agreementinvoicedate_msdyn_ocliveworkitems)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocliveworkitem`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msdyn_ocliveworkitems`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msdyn_ocoutboundmessages"></a> msdyn_agreementinvoicedate_msdyn_ocoutboundmessages

Many-To-One Relationship: [msdyn_ocoutboundmessage msdyn_agreementinvoicedate_msdyn_ocoutboundmessages](msdyn_ocoutboundmessage.md#BKMK_msdyn_agreementinvoicedate_msdyn_ocoutboundmessages)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocoutboundmessage`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msdyn_ocoutboundmessages`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msdyn_ocsessions"></a> msdyn_agreementinvoicedate_msdyn_ocsessions

Many-To-One Relationship: [msdyn_ocsession msdyn_agreementinvoicedate_msdyn_ocsessions](msdyn_ocsession.md#BKMK_msdyn_agreementinvoicedate_msdyn_ocsessions)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msdyn_ocsessions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msdyn_ocvoicemails"></a> msdyn_agreementinvoicedate_msdyn_ocvoicemails

Many-To-One Relationship: [msdyn_ocvoicemail msdyn_agreementinvoicedate_msdyn_ocvoicemails](msdyn_ocvoicemail.md#BKMK_msdyn_agreementinvoicedate_msdyn_ocvoicemails)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocvoicemail`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msdyn_ocvoicemails`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msfp_alerts"></a> msdyn_agreementinvoicedate_msfp_alerts

Many-To-One Relationship: [msfp_alert msdyn_agreementinvoicedate_msfp_alerts](msfp_alert.md#BKMK_msdyn_agreementinvoicedate_msfp_alerts)

|Property|Value|
|---|---|
|ReferencingEntity|`msfp_alert`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_agreementinvoicedate_msfp_alerts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_agreementinvoicedate_msfp_surveyinvites"></a> msdyn_agreementinvoicedate_msfp_surveyinvites

Many-To-One Relationship: [msfp_surveyinvite msdyn_agreementinvoicedate_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_agreementinvoicedate_msfp_surveyinvites)
...
Many-To-One Relationship: [msfp_surveyresponse msdyn_agreementinvoicedate_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_agreementinvoicedate_msfp_surveyresponses)
...
Many-To-One Relationship: [phonecall msdyn_agreementinvoicedate_PhoneCalls](phonecall.md#BKMK_msdyn_agreementinvoicedate_PhoneCalls)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_agreementinvoicedate_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_agreementinvoicedate_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_agreementinvoicedate_ProcessSession](processsession.md#BKMK_msdyn_agreementinvoicedate_ProcessSession)
...
Many-To-One Relationship: [queueitem msdyn_agreementinvoicedate_QueueItems](queueitem.md#BKMK_msdyn_agreementinvoicedate_QueueItems)
...
Many-To-One Relationship: [recurringappointmentmaster msdyn_agreementinvoicedate_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_msdyn_agreementinvoicedate_RecurringAppointmentMasters)
...
Many-To-One Relationship: [serviceappointment msdyn_agreementinvoicedate_ServiceAppointments](serviceappointment.md#BKMK_msdyn_agreementinvoicedate_ServiceAppointments)
...
Many-To-One Relationship: [sharepointdocumentlocation msdyn_agreementinvoicedate_SharePointDocumentLocations](sharepointdocumentlocation.md#BKMK_msdyn_agreementinvoicedate_SharePointDocumentLocations)
...
Many-To-One Relationship: [socialactivity msdyn_agreementinvoicedate_SocialActivities](socialactivity.md#BKMK_msdyn_agreementinvoicedate_SocialActivities)
...
Many-To-One Relationship: [syncerror msdyn_agreementinvoicedate_SyncErrors](syncerror.md#BKMK_msdyn_agreementinvoicedate_SyncErrors)
...
Many-To-One Relationship: [task msdyn_agreementinvoicedate_Tasks](task.md#BKMK_msdyn_agreementinvoicedate_Tasks)
