---
title: "IoT Alert to Case Process (msdyn_iottocaseprocess) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the IoT Alert to Case Process (msdyn_iottocaseprocess) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
The following table lists the events for the IoT Alert to Case Process (msdyn_iottocaseprocess) table.
