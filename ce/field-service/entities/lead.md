...
- [msdyncrm_degree](#BKMK_msdyncrm_degree)
...
### <a name="BKMK_msdyncrm_degree"></a> msdyncrm_degree
...
### <a name="BKMK_msdyncrm_latestsubmissiondate"></a> msdyncrm_latestsubmissiondate
...
### <a name="BKMK_msdyncrm_leadsourcetype"></a> msdyncrm_leadsourcetype
...
### <a name="BKMK_msdyncrm_Profileid"></a> msdyncrm_Profileid
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyncrm_lead_msdyncrm_salesready`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
### <a name="BKMK_msdyncrm_scores"></a> msdyncrm_scores
...
### <a name="BKMK_msdyncrm_TeleProspectAccepted"></a> msdyncrm_TeleProspectAccepted
...
### <a name="BKMK_msdynmkt_issalesreadysetmanually"></a> msdynmkt_issalesreadysetmanually
...
|823270000|Label: **Marketing Qualified**<br />State:0<br />TransitionData: None|
...
- [msdyncrm_linkedinsubmissioncount](#BKMK_msdyncrm_linkedinsubmissioncount)
- [msdyncrm_linkedinsubmissioncount_Date](#BKMK_msdyncrm_linkedinsubmissioncount_Date)
- [msdyncrm_linkedinsubmissioncount_State](#BKMK_msdyncrm_linkedinsubmissioncount_State)
...
### <a name="BKMK_msdyncrm_linkedinsubmissioncount"></a> msdyncrm_linkedinsubmissioncount
...
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyncrm_linkedinsubmissioncount`|
|RequiredLevel|None|
|Type|Integer|
|MaxValue|2147483647|
|MinValue|-2147483648|

### <a name="BKMK_msdyncrm_linkedinsubmissioncount_Date"></a> msdyncrm_linkedinsubmissioncount_Date

|Property|Value|
|---|---|
|Description|**Last Updated time of rollup field LinkedIn Form Submissions.**|
|DisplayName|**LinkedIn Form Submissions (Last Updated On)**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyncrm_linkedinsubmissioncount_date`|
|RequiredLevel|None|
|Type|DateTime|
|CanChangeDateTimeBehavior|True|
|DateTimeBehavior|UserLocal|
...
### <a name="BKMK_msdyncrm_linkedinsubmissioncount_State"></a> msdyncrm_linkedinsubmissioncount_State

|Property|Value|
|---|---|
|Description|**State of rollup field LinkedIn Form Submissions.**|
|DisplayName|**LinkedIn Form Submissions (State)**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyncrm_linkedinsubmissioncount_state`|
|RequiredLevel|None|
|Type|Integer|
|MaxValue|2147483647|
|MinValue|-2147483648|
...
One-To-Many Relationship: [msdyncrm_customerjourney msdyncrm_msdyncrm_customerjourney_lead_customerjourneyid](msdyncrm_customerjourney.md#BKMK_msdyncrm_msdyncrm_customerjourney_lead_customerjourneyid)
...
One-To-Many Relationship: [msdyncrm_linkedincampaign msdyncrm_msdyncrm_linkedincampaign_lead_LinkedInCampaign](msdyncrm_linkedincampaign.md#BKMK_msdyncrm_msdyncrm_linkedincampaign_lead_LinkedInCampaign)
...
One-To-Many Relationship: [msdyncrm_linkedinform msdyncrm_msdyncrm_linkedinform_lead_sourceform](msdyncrm_linkedinform.md#BKMK_msdyncrm_msdyncrm_linkedinform_lead_sourceform)
...
|ReferencingEntityNavigationPropertyName|`msdyncrm_sourceform`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyncrm_msdyncrm_marketingemail_lead_emailid"></a> msdyncrm_msdyncrm_marketingemail_lead_emailid

One-To-Many Relationship: [msdyncrm_marketingemail msdyncrm_msdyncrm_marketingemail_lead_emailid](msdyncrm_marketingemail.md#BKMK_msdyncrm_msdyncrm_marketingemail_lead_emailid)
...
One-To-Many Relationship: [msdyncrm_marketingform msdyncrm_msdyncrm_marketingform_lead_marketingformid](msdyncrm_marketingform.md#BKMK_msdyncrm_msdyncrm_marketingform_lead_marketingformid)
...
One-To-Many Relationship: [msdyncrm_marketingpage msdyncrm_msdyncrm_marketingpage_lead_marketingpageid](msdyncrm_marketingpage.md#BKMK_msdyncrm_msdyncrm_marketingpage_lead_marketingpageid)
...
One-To-Many Relationship: [msdynmkt_email msdynmkt_msdynmkt_email_lead_emailid](msdynmkt_email.md#BKMK_msdynmkt_msdynmkt_email_lead_emailid)
...
One-To-Many Relationship: [msdynmkt_journey msdynmkt_msdynmkt_journey_lead_customerjourneyid](msdynmkt_journey.md#BKMK_msdynmkt_msdynmkt_journey_lead_customerjourneyid)
...
One-To-Many Relationship: [msdynmkt_marketingform msdynmkt_msdynmkt_marketingform_lead_marketingformid](msdynmkt_marketingform.md#BKMK_msdynmkt_msdynmkt_marketingform_lead_marketingformid)
...
One-To-Many Relationship: [msevtmgt_event msevtmgt_event_lead_originatingeventid](msevtmgt_event.md#BKMK_msevtmgt_event_lead_originatingeventid)
...
Many-To-One Relationship: [adx_alertsubscription lead_adx_alertsubscriptions](adx_alertsubscription.md#BKMK_lead_adx_alertsubscriptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_alertsubscription`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`lead_adx_alertsubscriptions`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [li_inmail lead_li_inmails](li_inmail.md#BKMK_lead_li_inmails)

|Property|Value|
|---|---|
|ReferencingEntity|`li_inmail`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`lead_li_inmails`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RetrieveByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|

### <a name="BKMK_lead_li_messages"></a> lead_li_messages

Many-To-One Relationship: [li_message lead_li_messages](li_message.md#BKMK_lead_li_messages)

|Property|Value|
|---|---|
|ReferencingEntity|`li_message`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`lead_li_messages`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RetrieveByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|

### <a name="BKMK_lead_li_pointdrivepresentationvieweds"></a> lead_li_pointdrivepresentationvieweds

Many-To-One Relationship: [li_pointdrivepresentationviewed lead_li_pointdrivepresentationvieweds](li_pointdrivepresentationviewed.md#BKMK_lead_li_pointdrivepresentationvieweds)

|Property|Value|
|---|---|
|ReferencingEntity|`li_pointdrivepresentationviewed`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`lead_li_pointdrivepresentationvieweds`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: `CRMActivity.RetrieveByParty`<br />ViewId: `00000000-0000-0000-00aa-000010001903`|
...
Many-To-One Relationship: [msdyn_salespremiumdemo msdyn_lead_msdyn_salespremiumdemo_lead](msdyn_salespremiumdemo.md#BKMK_msdyn_lead_msdyn_salespremiumdemo_lead)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_salespremiumdemo`|
|ReferencingAttribute|`msdyn_lead`|
|ReferencedEntityNavigationPropertyName|`msdyn_lead_msdyn_salespremiumdemo_lead`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [msdyn_playbookinstance msdyn_playbookinstance_lead](msdyn_playbookinstance.md#BKMK_msdyn_playbookinstance_lead)
...
Many-To-One Relationship: [msdyncrm_marketingformsubmission msdyncrm_lead_marketingformsubmission_matched](msdyncrm_marketingformsubmission.md#BKMK_msdyncrm_lead_marketingformsubmission_matched)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_marketingformsubmission`|
|ReferencingAttribute|`msdyncrm_matchedleadid`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_marketingformsubmission_matched`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyncrm_lead_msdyncrm_geopin"></a> msdyncrm_lead_msdyncrm_geopin

Many-To-One Relationship: [msdyncrm_geopin msdyncrm_lead_msdyncrm_geopin](msdyncrm_geopin.md#BKMK_msdyncrm_lead_msdyncrm_geopin)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_geopin`|
|ReferencingAttribute|`msdyncrm_leadgeopinsid`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_msdyncrm_geopin`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyncrm_lead_msdyncrm_leadscore"></a> msdyncrm_lead_msdyncrm_leadscore

Many-To-One Relationship: [msdyncrm_leadscore msdyncrm_lead_msdyncrm_leadscore](msdyncrm_leadscore.md#BKMK_msdyncrm_lead_msdyncrm_leadscore)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_leadscore`|
|ReferencingAttribute|`msdyncrm_leadid`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_msdyncrm_leadscore`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyncrm_lead_msdyncrm_leadscore_v2"></a> msdyncrm_lead_msdyncrm_leadscore_v2

Many-To-One Relationship: [msdyncrm_leadscore_v2 msdyncrm_lead_msdyncrm_leadscore_v2](msdyncrm_leadscore_v2.md#BKMK_msdyncrm_lead_msdyncrm_leadscore_v2)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_leadscore_v2`|
|ReferencingAttribute|`msdyncrm_lead`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_msdyncrm_leadscore_v2_Lead`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyncrm_lead_msdyncrm_leadtoopportunity"></a> msdyncrm_lead_msdyncrm_leadtoopportunity

Many-To-One Relationship: [msdyncrm_leadtoopportunity msdyncrm_lead_msdyncrm_leadtoopportunity](msdyncrm_leadtoopportunity.md#BKMK_msdyncrm_lead_msdyncrm_leadtoopportunity)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_leadtoopportunity`|
|ReferencingAttribute|`bpf_leadid`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_msdyncrm_leadtoopportunity`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseLabel`<br />Group: `Details`<br />Label: Lead<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyncrm_lead_msdyncrm_linkedinformsubmission_Lead"></a> msdyncrm_lead_msdyncrm_linkedinformsubmission_Lead

Many-To-One Relationship: [msdyncrm_linkedinformsubmission msdyncrm_lead_msdyncrm_linkedinformsubmission_Lead](msdyncrm_linkedinformsubmission.md#BKMK_msdyncrm_lead_msdyncrm_linkedinformsubmission_Lead)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyncrm_linkedinformsubmission`|
|ReferencingAttribute|`msdyncrm_lead`|
|ReferencedEntityNavigationPropertyName|`msdyncrm_lead_msdyncrm_linkedinformsubmission_Lead`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
