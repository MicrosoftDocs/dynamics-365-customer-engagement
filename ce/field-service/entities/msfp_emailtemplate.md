---
title: "Customer Voice survey email template (msfp_emailtemplate) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Customer Voice survey email template (msfp_emailtemplate) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
The following table lists the events for the Customer Voice survey email template (msfp_emailtemplate) table.
