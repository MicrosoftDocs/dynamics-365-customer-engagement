---
title: "Post Regarding (PostRegarding) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Post Regarding (PostRegarding) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
> [!NOTE]
> The Microsoft Dynamics 365 Field Service Post Regarding (PostRegarding) table extends the [Microsoft Dataverse Post Regarding (PostRegarding) table](/power-apps/developer/data-platform/reference/entities/postregarding).
