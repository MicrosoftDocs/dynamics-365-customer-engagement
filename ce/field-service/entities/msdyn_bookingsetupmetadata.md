...
- [msdyn_defaultschedulingmethod](#BKMK_msdyn_defaultschedulingmethod)
...
### <a name="BKMK_msdyn_defaultschedulingmethod"></a> msdyn_defaultschedulingmethod

|Property|Value|
|---|---|
|Description|**Select the default Scheduling Method when creating Resource Requirement for the associated entity.**|
|DisplayName|**Default Scheduling Method**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_defaultschedulingmethod`|
|RequiredLevel|ApplicationRequired|
|Type|Picklist|
|DefaultFormValue|192350001|
|GlobalChoiceName|`msdyn_schedulingmethod`|

#### msdyn_defaultschedulingmethod Choices/Options
