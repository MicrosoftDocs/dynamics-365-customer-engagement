...
# Apple messages for business account (msdyn_ocapplebusinessaccount) table/entity reference
...
The following table lists the events for the Apple messages for business account (msdyn_ocapplebusinessaccount) table.
