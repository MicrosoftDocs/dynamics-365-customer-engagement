---
title: "Phone Call Engagement Context (msdyn_ocphonecallengagementctx) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Phone Call Engagement Context (msdyn_ocphonecallengagementctx) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
# Phone Call Engagement Context (msdyn_ocphonecallengagementctx) table/entity reference
...
The following table lists the events for the Phone Call Engagement Context (msdyn_ocphonecallengagementctx) table.
