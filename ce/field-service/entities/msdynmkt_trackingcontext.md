---
title: "TrackingContext (msdynmkt_trackingcontext) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the TrackingContext (msdynmkt_trackingcontext) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
Many-To-One Relationship: [msdynmkt_smssubmission msdynmkt_msdynmkt_trackingcontext_msdynmkt_smssubmission](msdynmkt_smssubmission.md#BKMK_msdynmkt_msdynmkt_trackingcontext_msdynmkt_smssubmission)

|Property|Value|
|---|---|
|ReferencingEntity|`msdynmkt_smssubmission`|
|ReferencingAttribute|`msdynmkt_trackingcontextid`|
|ReferencedEntityNavigationPropertyName|`msdynmkt_msdynmkt_trackingcontext_msdynmkt_smssubmission`|
