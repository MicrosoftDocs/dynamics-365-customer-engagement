...
- [msdyn_ReasonNotScheduled](#BKMK_msdyn_ReasonNotScheduled)
...
### <a name="BKMK_msdyn_ReasonNotScheduled"></a> msdyn_ReasonNotScheduled

|Property|Value|
|---|---|
|Description|**Shows why this Resource Requirement isn’t scheduled by the resource scheduling optimization.**|
|DisplayName|**Reason Not Scheduled**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_reasonnotscheduled`|
|RequiredLevel|None|
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_reasonnotscheduled`|

#### msdyn_ReasonNotScheduled Choices/Options

|Value|Label|
|---|---|
|192350000|**None**|
|192350002|**Latitude Longitude Invalid**|
|192350004|**Estimated Duration Less Than Or Equal To 0**|
|192350005|**Work Location Not Onsite or Location Agnostic (Deprecated)**|
|192350006|**Optimization is not enabled for this requirement**|
|192350007|**Templates cannot be scheduled**|
|192350008|**Requirement belongs to a Requirement Group**|
|192350009|**Unsupported resource type**|
|192350010|**Requirement Status is not 'Active'**|
...
|Property|Value|
|---|---|
|Description|**Whether this resource requirement should be included in the routing optimization or should be scheduled manually.**|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_schedulingmethod`|
...
Many-To-One Relationship: [msdyn_optimizationrequestbooking msdyn_msdyn_resourcerequirement_msdyn_optimizationrequestbooking_ResourceRequirement](msdyn_optimizationrequestbooking.md#BKMK_msdyn_msdyn_resourcerequirement_msdyn_optimizationrequestbooking_ResourceRequirement)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_optimizationrequestbooking`|
|ReferencingAttribute|`msdyn_resourcerequirement`|
|ReferencedEntityNavigationPropertyName|`msdyn_msdyn_resourcerequirement_msdyn_optimizationrequestbooking_ResourceRequirement`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `UseCollectionName`<br />Group: `Details`<br />Label: Resource Requirement processed by RSO.<br />MenuId: null<br />Order: 10000<br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
