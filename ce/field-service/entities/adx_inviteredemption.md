...
### <a name="BKMK_adx_poll_adx_inviteredemptions"></a> adx_poll_adx_inviteredemptions
...
One-To-Many Relationship: [msdyncrm_contentsettings msdyncrm_contentsettings_adx_inviteredemptions](msdyncrm_contentsettings.md#BKMK_msdyncrm_contentsettings_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_contentsettings_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_customerjourney_adx_inviteredemptions"></a> msdyncrm_customerjourney_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_customerjourney msdyncrm_customerjourney_adx_inviteredemptions](msdyncrm_customerjourney.md#BKMK_msdyncrm_customerjourney_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_customerjourney_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_leadscoremodel_adx_inviteredemptions"></a> msdyncrm_leadscoremodel_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_leadscoremodel msdyncrm_leadscoremodel_adx_inviteredemptions](msdyncrm_leadscoremodel.md#BKMK_msdyncrm_leadscoremodel_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_leadscoremodel_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinaccount_adx_inviteredemptions"></a> msdyncrm_linkedinaccount_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinaccount msdyncrm_linkedinaccount_adx_inviteredemptions](msdyncrm_linkedinaccount.md#BKMK_msdyncrm_linkedinaccount_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinaccount_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinactivity_adx_inviteredemptions"></a> msdyncrm_linkedinactivity_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinactivity msdyncrm_linkedinactivity_adx_inviteredemptions](msdyncrm_linkedinactivity.md#BKMK_msdyncrm_linkedinactivity_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinactivity_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinfieldmapping_adx_inviteredemptions"></a> msdyncrm_linkedinfieldmapping_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinfieldmapping msdyncrm_linkedinfieldmapping_adx_inviteredemptions](msdyncrm_linkedinfieldmapping.md#BKMK_msdyncrm_linkedinfieldmapping_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinfieldmapping_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinform_adx_inviteredemptions"></a> msdyncrm_linkedinform_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinform msdyncrm_linkedinform_adx_inviteredemptions](msdyncrm_linkedinform.md#BKMK_msdyncrm_linkedinform_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinform_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinformanswer_adx_inviteredemptions"></a> msdyncrm_linkedinformanswer_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinformanswer msdyncrm_linkedinformanswer_adx_inviteredemptions](msdyncrm_linkedinformanswer.md#BKMK_msdyncrm_linkedinformanswer_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformanswer_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinformquestion_adx_inviteredemptions"></a> msdyncrm_linkedinformquestion_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinformquestion msdyncrm_linkedinformquestion_adx_inviteredemptions](msdyncrm_linkedinformquestion.md#BKMK_msdyncrm_linkedinformquestion_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformquestion_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_linkedinformsubmission msdyncrm_linkedinformsubmission_adx_inviteredemptions](msdyncrm_linkedinformsubmission.md#BKMK_msdyncrm_linkedinformsubmission_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinformsubmission_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinleadmatchingstrategy_adx_inviteredemptions"></a> msdyncrm_linkedinleadmatchingstrategy_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinleadmatchingstrategy msdyncrm_linkedinleadmatchingstrategy_adx_inviteredemptions](msdyncrm_linkedinleadmatchingstrategy.md#BKMK_msdyncrm_linkedinleadmatchingstrategy_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_linkedinuserprofile_adx_inviteredemptions"></a> msdyncrm_linkedinuserprofile_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_linkedinuserprofile msdyncrm_linkedinuserprofile_adx_inviteredemptions](msdyncrm_linkedinuserprofile.md#BKMK_msdyncrm_linkedinuserprofile_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_linkedinuserprofile_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_marketingdynamiccontentmetadata msdyncrm_marketingdynamiccontentmetadata_adx_inviteredemptions](msdyncrm_marketingdynamiccontentmetadata.md#BKMK_msdyncrm_marketingdynamiccontentmetadata_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_marketingemaildynamiccontentmetadata msdyncrm_marketingemaildynamiccontentmetadata_adx_inviteredemptions](msdyncrm_marketingemaildynamiccontentmetadata.md#BKMK_msdyncrm_marketingemaildynamiccontentmetadata_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|
...
One-To-Many Relationship: [msdyncrm_marketingemailtestsend msdyncrm_marketingemailtestsend_adx_inviteredemptions](msdyncrm_marketingemailtestsend.md#BKMK_msdyncrm_marketingemailtestsend_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_marketingemailtestsend_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_migration_adx_inviteredemptions"></a> msdyncrm_migration_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_migration msdyncrm_migration_adx_inviteredemptions](msdyncrm_migration.md#BKMK_msdyncrm_migration_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_migration_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msdyncrm_uicconfig_adx_inviteredemptions"></a> msdyncrm_uicconfig_adx_inviteredemptions

One-To-Many Relationship: [msdyncrm_uicconfig msdyncrm_uicconfig_adx_inviteredemptions](msdyncrm_uicconfig.md#BKMK_msdyncrm_uicconfig_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msdyncrm_uicconfig_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_checkin_adx_inviteredemptions"></a> msevtmgt_checkin_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_checkin msevtmgt_checkin_adx_inviteredemptions](msevtmgt_checkin.md#BKMK_msevtmgt_checkin_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_checkin_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_event_adx_inviteredemptions"></a> msevtmgt_event_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_event msevtmgt_event_adx_inviteredemptions](msevtmgt_event.md#BKMK_msevtmgt_event_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_event_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchase_adx_inviteredemptions"></a> msevtmgt_eventpurchase_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_eventpurchase msevtmgt_eventpurchase_adx_inviteredemptions](msevtmgt_eventpurchase.md#BKMK_msevtmgt_eventpurchase_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchase_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchaseattendee_adx_inviteredemptions"></a> msevtmgt_eventpurchaseattendee_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_eventpurchaseattendee msevtmgt_eventpurchaseattendee_adx_inviteredemptions](msevtmgt_eventpurchaseattendee.md#BKMK_msevtmgt_eventpurchaseattendee_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchaseattendee_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventpurchasepass_adx_inviteredemptions"></a> msevtmgt_eventpurchasepass_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_eventpurchasepass msevtmgt_eventpurchasepass_adx_inviteredemptions](msevtmgt_eventpurchasepass.md#BKMK_msevtmgt_eventpurchasepass_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventpurchasepass_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_eventregistration_adx_inviteredemptions"></a> msevtmgt_eventregistration_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_eventregistration msevtmgt_eventregistration_adx_inviteredemptions](msevtmgt_eventregistration.md#BKMK_msevtmgt_eventregistration_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_eventregistration_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotel_adx_inviteredemptions"></a> msevtmgt_hotel_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_hotel msevtmgt_hotel_adx_inviteredemptions](msevtmgt_hotel.md#BKMK_msevtmgt_hotel_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotel_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotelroomallocation_adx_inviteredemptions"></a> msevtmgt_hotelroomallocation_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_hotelroomallocation msevtmgt_hotelroomallocation_adx_inviteredemptions](msevtmgt_hotelroomallocation.md#BKMK_msevtmgt_hotelroomallocation_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotelroomallocation_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_hotelroomreservation_adx_inviteredemptions"></a> msevtmgt_hotelroomreservation_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_hotelroomreservation msevtmgt_hotelroomreservation_adx_inviteredemptions](msevtmgt_hotelroomreservation.md#BKMK_msevtmgt_hotelroomreservation_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_hotelroomreservation_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_layout_adx_inviteredemptions"></a> msevtmgt_layout_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_layout msevtmgt_layout_adx_inviteredemptions](msevtmgt_layout.md#BKMK_msevtmgt_layout_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_layout_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_room_adx_inviteredemptions"></a> msevtmgt_room_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_room msevtmgt_room_adx_inviteredemptions](msevtmgt_room.md#BKMK_msevtmgt_room_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_room_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_session_adx_inviteredemptions"></a> msevtmgt_session_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_session msevtmgt_session_adx_inviteredemptions](msevtmgt_session.md#BKMK_msevtmgt_session_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_session_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sessionregistration_adx_inviteredemptions"></a> msevtmgt_sessionregistration_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_sessionregistration msevtmgt_sessionregistration_adx_inviteredemptions](msevtmgt_sessionregistration.md#BKMK_msevtmgt_sessionregistration_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sessionregistration_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sessiontrack_adx_inviteredemptions"></a> msevtmgt_sessiontrack_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_sessiontrack msevtmgt_sessiontrack_adx_inviteredemptions](msevtmgt_sessiontrack.md#BKMK_msevtmgt_sessiontrack_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sessiontrack_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_speaker_adx_inviteredemptions"></a> msevtmgt_speaker_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_speaker msevtmgt_speaker_adx_inviteredemptions](msevtmgt_speaker.md#BKMK_msevtmgt_speaker_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_speaker_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_speakerengagement_adx_inviteredemptions"></a> msevtmgt_speakerengagement_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_speakerengagement msevtmgt_speakerengagement_adx_inviteredemptions](msevtmgt_speakerengagement.md#BKMK_msevtmgt_speakerengagement_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_speakerengagement_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sponsorablearticle_adx_inviteredemptions"></a> msevtmgt_sponsorablearticle_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_sponsorablearticle msevtmgt_sponsorablearticle_adx_inviteredemptions](msevtmgt_sponsorablearticle.md#BKMK_msevtmgt_sponsorablearticle_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sponsorablearticle_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_sponsorship_adx_inviteredemptions"></a> msevtmgt_sponsorship_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_sponsorship msevtmgt_sponsorship_adx_inviteredemptions](msevtmgt_sponsorship.md#BKMK_msevtmgt_sponsorship_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_sponsorship_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_venue_adx_inviteredemptions"></a> msevtmgt_venue_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_venue msevtmgt_venue_adx_inviteredemptions](msevtmgt_venue.md#BKMK_msevtmgt_venue_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_venue_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `Cascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `Cascade`<br />RollupView: `NoCascade`<br />Share: `Cascade`<br />Unshare: `Cascade`|

### <a name="BKMK_msevtmgt_webinarconfiguration_adx_inviteredemptions"></a> msevtmgt_webinarconfiguration_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_webinarconfiguration msevtmgt_webinarconfiguration_adx_inviteredemptions](msevtmgt_webinarconfiguration.md#BKMK_msevtmgt_webinarconfiguration_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_webinarconfiguration_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msevtmgt_webinarprovider_adx_inviteredemptions"></a> msevtmgt_webinarprovider_adx_inviteredemptions

One-To-Many Relationship: [msevtmgt_webinarprovider msevtmgt_webinarprovider_adx_inviteredemptions](msevtmgt_webinarprovider.md#BKMK_msevtmgt_webinarprovider_adx_inviteredemptions)
...
|ReferencingAttribute|`regardingobjectid`|
|ReferencingEntityNavigationPropertyName|`regardingobjectid_msevtmgt_webinarprovider_adx_inviteredemption`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `Cascade`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|
