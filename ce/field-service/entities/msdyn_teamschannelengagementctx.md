---
title: "Teams Engagement Context (msdyn_teamschannelengagementctx) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Teams Engagement Context (msdyn_teamschannelengagementctx) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 07.24.2024
...
# Teams Engagement Context (msdyn_teamschannelengagementctx) table/entity reference
...
The following table lists the events for the Teams Engagement Context (msdyn_teamschannelengagementctx) table.
