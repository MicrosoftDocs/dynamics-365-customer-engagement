...
This applies to all customers using any version of Field Service Mobile. As an example, you may be using Field Service Mobile version 9 and want to upgrade to version 11+, which requires a new project template or you may simply being using Field Service Mobile 11.1 and want to upgrade to 11.3 and utulize a new mobiel project. 
