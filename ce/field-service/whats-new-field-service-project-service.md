FS_SettingsOnBSM-2.gif - screenshot of the max resources field 
FS_NoOtherRow_5.gif - screenshot of the other row (which has been removed)
FS_DragSummary.gif - screenshot of the 3 selected rows after being drag-selected
FS_DetailsPanelTake2Final.gif - screenshot of popped-out details pane
FS_Zoom.gif - screenshot of the ZOOM OUT menu on right-click---
