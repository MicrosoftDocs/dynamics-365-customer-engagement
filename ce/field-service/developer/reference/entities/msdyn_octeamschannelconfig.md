---
title: "Microsoft Teams account (msdyn_octeamschannelconfig) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Microsoft Teams account (msdyn_octeamschannelconfig) table/entity with Microsoft Dynamics 365 Field Service."
...
# Microsoft Teams account (msdyn_octeamschannelconfig) table/entity reference (Microsoft Dynamics 365 Field Service)
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_octeamschannelconfig_msdyn_enabletranslationproviderfields`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_octeamschannelconfig_msdyn_translationprovider`|
...
One-To-Many Relationship: [msdyn_channelinstancesecret msdyn_msdyn_channelinstancesecret_msdyn_octeamschannelconfig_translationproviderapikey](msdyn_channelinstancesecret.md#BKMK_msdyn_msdyn_channelinstancesecret_msdyn_octeamschannelconfig_translationproviderapikey)
