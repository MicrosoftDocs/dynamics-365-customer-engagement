---
title: "Facebook Page (msdyn_ocfbpage) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Facebook Page (msdyn_ocfbpage) table/entity with Microsoft Dynamics 365 Field Service."
...
# Facebook Page (msdyn_ocfbpage) table/entity reference (Microsoft Dynamics 365 Field Service)
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_ocfbpage_msdyn_enabletranslationproviderfields`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_ocfbpage_msdyn_translationprovider`|
...
One-To-Many Relationship: [msdyn_channelinstancesecret msdyn_msdyn_channelinstancesecret_msdyn_ocfbpage_translationproviderapikey](msdyn_channelinstancesecret.md#BKMK_msdyn_msdyn_channelinstancesecret_msdyn_ocfbpage_translationproviderapikey)
