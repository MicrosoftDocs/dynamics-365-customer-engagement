...
# Custom messaging account (msdyn_ocbotchannelregistration) table/entity reference (Microsoft Dynamics 365 Field Service)

Bot channel registration used for channel integration

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Custom messaging account (msdyn_ocbotchannelregistration) table extends the [Microsoft Dynamics 365 Custom messaging account (msdyn_ocbotchannelregistration) table](/dynamics365/developer/reference/entities/msdyn_ocbotchannelregistration).
