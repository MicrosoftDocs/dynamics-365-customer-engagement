---
title: "Authentication Settings (msdyn_authenticationsettings) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Authentication Settings (msdyn_authenticationsettings) table/entity with Microsoft Dynamics 365 Field Service."
...
# Authentication Settings (msdyn_authenticationsettings) table/entity reference (Microsoft Dynamics 365 Field Service)

Stores the settings for user authentication

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Authentication Settings (msdyn_authenticationsettings) table extends the [Microsoft Dynamics 365 Authentication Settings (msdyn_authenticationsettings) table](/dynamics365/developer/reference/entities/msdyn_authenticationsettings).
...
- [msdyn_publickeyurlenvvar](#BKMK_msdyn_publickeyurlenvvar)
...
### <a name="BKMK_msdyn_publickeyurlenvvar"></a> msdyn_publickeyurlenvvar

|Property|Value|
|---|---|
|Description|**Schema name of the Environment Variable that supplies the Public Key URL for this environment. When set, the runtime resolves the URL from this Environment Variable instead of the static Public key URL.**|
|DisplayName|**Public Key URL - Environment Variable**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_publickeyurlenvvar`|
|RequiredLevel|None|
|Type|String|
|Format|Text|
|FormatName|Text|
