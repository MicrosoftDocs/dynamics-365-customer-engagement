...
# Read Tracker (msdyn_readtracker) table/entity reference (Microsoft Dynamics 365 Field Service)

Keeps track of the records read by an user in the system

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Read Tracker (msdyn_readtracker) table extends the [Microsoft Dynamics 365 Read Tracker (msdyn_readtracker) table](/dynamics365/developer/reference/entities/msdyn_readtracker).
