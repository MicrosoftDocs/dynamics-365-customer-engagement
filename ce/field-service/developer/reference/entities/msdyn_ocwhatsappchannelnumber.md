---
title: "WhatsApp number (msdyn_ocwhatsappchannelnumber) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the WhatsApp number (msdyn_ocwhatsappchannelnumber) table/entity with Microsoft Dynamics 365 Field Service."
...
# WhatsApp number (msdyn_ocwhatsappchannelnumber) table/entity reference (Microsoft Dynamics 365 Field Service)
...
- [msdyn_DisplayNameReviewStatus](#BKMK_msdyn_DisplayNameReviewStatus)
...
- [msdyn_PhoneNumberDisplayName](#BKMK_msdyn_PhoneNumberDisplayName)
...
### <a name="BKMK_msdyn_DisplayNameReviewStatus"></a> msdyn_DisplayNameReviewStatus

|Property|Value|
|---|---|
|Description|**Meta review status for the phone number display name**|
|DisplayName|**Display name review status**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_displaynamereviewstatus`|
|RequiredLevel|None|
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_ocwhatsappchannelnumber_msdyn_displaynamereviewstatus`|

#### msdyn_DisplayNameReviewStatus Choices/Options
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_ocwhatsappchannelnumber_msdyn_enabletranslationproviderfields`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
### <a name="BKMK_msdyn_PhoneNumberDisplayName"></a> msdyn_PhoneNumberDisplayName

|Property|Value|
|---|---|
|Description|**Business display name for the WhatsApp phone number, managed by Meta**|
|DisplayName|**Phone number display name**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_phonenumberdisplayname`|
|RequiredLevel|None|
|Type|String|
|Format|Text|
|FormatName|Text|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_ocwhatsappchannelnumber_msdyn_translationprovider`|
...
One-To-Many Relationship: [msdyn_channelinstancesecret msdyn_msdyn_channelinstancesecret_msdyn_ocwhatsappchannelnumber_translationproviderapikey](msdyn_channelinstancesecret.md#BKMK_msdyn_msdyn_channelinstancesecret_msdyn_ocwhatsappchannelnumber_translationproviderapikey)
