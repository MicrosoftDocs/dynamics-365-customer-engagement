---
title: "LINE account (msdyn_oclinechannelconfig) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the LINE account (msdyn_oclinechannelconfig) table/entity with Microsoft Dynamics 365 Field Service."
...
# LINE account (msdyn_oclinechannelconfig) table/entity reference (Microsoft Dynamics 365 Field Service)
...
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_oclinechannelconfig_msdyn_enabletranslationproviderfields`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|Picklist|
|DefaultFormValue|-1|
|GlobalChoiceName|`msdyn_oclinechannelconfig_msdyn_translationprovider`|
...
One-To-Many Relationship: [msdyn_channelinstancesecret msdyn_msdyn_channelinstancesecret_msdyn_oclinechannelconfig_translationproviderapikey](msdyn_channelinstancesecret.md#BKMK_msdyn_msdyn_channelinstancesecret_msdyn_oclinechannelconfig_translationproviderapikey)
