...
# Social Profile (SocialProfile) table/entity reference (Microsoft Dynamics 365 Field Service)
...
> [!NOTE]
> The Microsoft Dynamics 365 Field Service Social Profile (SocialProfile) table extends the [Microsoft Dynamics 365 Social Profile (SocialProfile) table](/dynamics365/developer/reference/entities/socialprofile).
