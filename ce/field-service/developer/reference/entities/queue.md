...
# Queue table/entity reference (Microsoft Dynamics 365 Field Service)

A list of records that require action, such as accounts, activities, and cases.

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Queue table extends the [Microsoft Dynamics 365 Queue table](/dynamics365/developer/reference/entities/queue).
