...
# Operating Hour (msdyn_operatinghour) table/entity reference (Microsoft Dynamics 365 Field Service)

Stores all the operating hours that are configured for an organization.

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Operating Hour (msdyn_operatinghour) table extends the [Microsoft Dynamics 365 Operating Hour (msdyn_operatinghour) table](/dynamics365/developer/reference/entities/msdyn_operatinghour).
