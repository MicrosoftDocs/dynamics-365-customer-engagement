...
# Work Stream (msdyn_liveworkstream) table/entity reference (Microsoft Dynamics 365 Field Service)

Stores information about the properties of work items that are generated by a unique channel endpoint

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Work Stream (msdyn_liveworkstream) table extends the [Microsoft Dynamics 365 Work Stream (msdyn_liveworkstream) table](/dynamics365/developer/reference/entities/msdyn_liveworkstream).
...
- [msdyn_botplatform](#BKMK_msdyn_botplatform)
...
- [msdyn_notificationtemplate_ai_consult](#BKMK_msdyn_notificationtemplate_ai_consult)
...
### <a name="BKMK_msdyn_botplatform"></a> msdyn_botplatform

|Property|Value|
|---|---|
|Description|**The bot platform used by the work stream**|
|DisplayName|**Bot platform**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_botplatform`|
|RequiredLevel|None|
|Type|Picklist|
|DefaultFormValue|192350000|
|GlobalChoiceName|`msdyn_liveworkstream_msdyn_botplatform`|

#### msdyn_botplatform Choices/Options

|Value|Label|
|---|---|
|192350000|**ContactCenter**|
|192350001|**CCAI**|
...
### <a name="BKMK_msdyn_notificationtemplate_ai_consult"></a> msdyn_notificationtemplate_ai_consult

|Property|Value|
|---|---|
|Description|**AI-initiated consult notification template scenario**|
|DisplayName|**AI Consult**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_notificationtemplate_ai_consult`|
|RequiredLevel|None|
|Type|String|
|Format|Text|
|FormatName|Text|
