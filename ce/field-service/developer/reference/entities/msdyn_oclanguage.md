...
# Language (msdyn_oclanguage) table/entity reference (Microsoft Dynamics 365 Field Service)



> [!NOTE]
> The Microsoft Dynamics 365 Field Service Language (msdyn_oclanguage) table extends the [Microsoft Dynamics 365 Language (msdyn_oclanguage) table](/dynamics365/developer/reference/entities/msdyn_oclanguage).
