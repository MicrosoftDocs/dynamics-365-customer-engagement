---
title: "Google's Business Messages agent account (msdyn_ocgooglebusinessmessagesagentaccount) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Google's Business Messages agent account (msdyn_ocgooglebusinessmessagesagentaccount) table/entity with Microsoft Dynamics 365 Field Service."
...
# Google's Business Messages agent account (msdyn_ocgooglebusinessmessagesagentaccount) table/entity reference (Microsoft Dynamics 365 Field Service)
