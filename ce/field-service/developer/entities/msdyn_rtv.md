...
The following table lists the events for the RTV (msdyn_rtv) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_rtv](businessunit.md#BKMK_business_unit_msdyn_rtv)
...
One-To-Many Relationship: [systemuser lk_msdyn_rtv_createdby](systemuser.md#BKMK_lk_msdyn_rtv_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_rtv_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_rtv_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_rtv_modifiedby](systemuser.md#BKMK_lk_msdyn_rtv_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_rtv_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_rtv_modifiedonbehalfby)
...
One-To-Many Relationship: [systemuser msdyn_systemuser_msdyn_rtv_ApprovedDeclinedBy](systemuser.md#BKMK_msdyn_systemuser_msdyn_rtv_ApprovedDeclinedBy)
...
|ReferencingEntityNavigationPropertyName|`msdyn_approveddeclinedby`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_msdyn_systemuser_msdyn_rtv_ReturnedBy"></a> msdyn_systemuser_msdyn_rtv_ReturnedBy

One-To-Many Relationship: [systemuser msdyn_systemuser_msdyn_rtv_ReturnedBy](systemuser.md#BKMK_msdyn_systemuser_msdyn_rtv_ReturnedBy)
...
|ReferencingEntityNavigationPropertyName|`msdyn_returnedby`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_owner_msdyn_rtv"></a> owner_msdyn_rtv

One-To-Many Relationship: [owner owner_msdyn_rtv](owner.md#BKMK_owner_msdyn_rtv)
...
One-To-Many Relationship: [team team_msdyn_rtv](team.md#BKMK_team_msdyn_rtv)
...
One-To-Many Relationship: [transactioncurrency TransactionCurrency_msdyn_rtv](transactioncurrency.md#BKMK_TransactionCurrency_msdyn_rtv)
...
One-To-Many Relationship: [systemuser user_msdyn_rtv](systemuser.md#BKMK_user_msdyn_rtv)
...
Many-To-One Relationship: [activitypointer msdyn_rtv_ActivityPointers](activitypointer.md#BKMK_msdyn_rtv_ActivityPointers)
...
Many-To-One Relationship: [adx_inviteredemption msdyn_rtv_adx_inviteredemptions](adx_inviteredemption.md#BKMK_msdyn_rtv_adx_inviteredemptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_inviteredemption`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_adx_inviteredemptions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_adx_portalcomments"></a> msdyn_rtv_adx_portalcomments

Many-To-One Relationship: [adx_portalcomment msdyn_rtv_adx_portalcomments](adx_portalcomment.md#BKMK_msdyn_rtv_adx_portalcomments)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_portalcomment`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_adx_portalcomments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_Annotations"></a> msdyn_rtv_Annotations

Many-To-One Relationship: [annotation msdyn_rtv_Annotations](annotation.md#BKMK_msdyn_rtv_Annotations)
...
Many-To-One Relationship: [appointment msdyn_rtv_Appointments](appointment.md#BKMK_msdyn_rtv_Appointments)
...
Many-To-One Relationship: [asyncoperation msdyn_rtv_AsyncOperations](asyncoperation.md#BKMK_msdyn_rtv_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_rtv_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_rtv_BulkDeleteFailures)
...
Many-To-One Relationship: [chat msdyn_rtv_chats](chat.md#BKMK_msdyn_rtv_chats)

|Property|Value|
|---|---|
|ReferencingEntity|`chat`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_chats`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_connections1"></a> msdyn_rtv_connections1

Many-To-One Relationship: [connection msdyn_rtv_connections1](connection.md#BKMK_msdyn_rtv_connections1)
...
Many-To-One Relationship: [connection msdyn_rtv_connections2](connection.md#BKMK_msdyn_rtv_connections2)
...
Many-To-One Relationship: [duplicaterecord msdyn_rtv_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_rtv_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_rtv_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_rtv_DuplicateMatchingRecord)
...
Many-To-One Relationship: [email msdyn_rtv_Emails](email.md#BKMK_msdyn_rtv_Emails)
...
Many-To-One Relationship: [fax msdyn_rtv_Faxes](fax.md#BKMK_msdyn_rtv_Faxes)
...
Many-To-One Relationship: [letter msdyn_rtv_Letters](letter.md#BKMK_msdyn_rtv_Letters)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_rtv_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_rtv_MailboxTrackingFolders)
...
Many-To-One Relationship: [msdyn_copilottranscript msdyn_rtv_msdyn_copilottranscripts](msdyn_copilottranscript.md#BKMK_msdyn_rtv_msdyn_copilottranscripts)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_copilottranscript`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_msdyn_copilottranscripts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_msdyn_ocliveworkitems"></a> msdyn_rtv_msdyn_ocliveworkitems

Many-To-One Relationship: [msdyn_ocliveworkitem msdyn_rtv_msdyn_ocliveworkitems](msdyn_ocliveworkitem.md#BKMK_msdyn_rtv_msdyn_ocliveworkitems)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocliveworkitem`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_msdyn_ocliveworkitems`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_msdyn_ocsessions"></a> msdyn_rtv_msdyn_ocsessions

Many-To-One Relationship: [msdyn_ocsession msdyn_rtv_msdyn_ocsessions](msdyn_ocsession.md#BKMK_msdyn_rtv_msdyn_ocsessions)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_msdyn_ocsessions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_msfp_alerts"></a> msdyn_rtv_msfp_alerts

Many-To-One Relationship: [msfp_alert msdyn_rtv_msfp_alerts](msfp_alert.md#BKMK_msdyn_rtv_msfp_alerts)

|Property|Value|
|---|---|
|ReferencingEntity|`msfp_alert`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_rtv_msfp_alerts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_rtv_msfp_surveyinvites"></a> msdyn_rtv_msfp_surveyinvites

Many-To-One Relationship: [msfp_surveyinvite msdyn_rtv_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_rtv_msfp_surveyinvites)
...
Many-To-One Relationship: [msfp_surveyresponse msdyn_rtv_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_rtv_msfp_surveyresponses)
...
Many-To-One Relationship: [phonecall msdyn_rtv_PhoneCalls](phonecall.md#BKMK_msdyn_rtv_PhoneCalls)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_rtv_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_rtv_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_rtv_ProcessSession](processsession.md#BKMK_msdyn_rtv_ProcessSession)
...
Many-To-One Relationship: [recurringappointmentmaster msdyn_rtv_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_msdyn_rtv_RecurringAppointmentMasters)
...
Many-To-One Relationship: [serviceappointment msdyn_rtv_ServiceAppointments](serviceappointment.md#BKMK_msdyn_rtv_ServiceAppointments)
...
Many-To-One Relationship: [sharepointdocumentlocation msdyn_rtv_SharePointDocumentLocations](sharepointdocumentlocation.md#BKMK_msdyn_rtv_SharePointDocumentLocations)
...
Many-To-One Relationship: [socialactivity msdyn_rtv_SocialActivities](socialactivity.md#BKMK_msdyn_rtv_SocialActivities)
...
Many-To-One Relationship: [syncerror msdyn_rtv_SyncErrors](syncerror.md#BKMK_msdyn_rtv_SyncErrors)
...
Many-To-One Relationship: [task msdyn_rtv_Tasks](task.md#BKMK_msdyn_rtv_Tasks)
