...
# Email table/entity reference (Microsoft Dynamics 365 Field Service)

Activity that is delivered using email protocols.

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Email table extends the [Microsoft Dynamics 365 Email table](/dynamics365/developer/entities/email).
