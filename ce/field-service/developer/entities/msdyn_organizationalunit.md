---
title: "Organizational Unit (msdyn_organizationalunit) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Organizational Unit (msdyn_organizationalunit) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 08/26/2024
...
# Organizational Unit (msdyn_organizationalunit) table/entity reference (Microsoft Dynamics 365 Field Service)
...
The following table lists the events for the Organizational Unit (msdyn_organizationalunit) table.
