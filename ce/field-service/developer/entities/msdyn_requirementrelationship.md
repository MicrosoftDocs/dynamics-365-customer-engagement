---
title: "Requirement Relationship (msdyn_requirementrelationship) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Requirement Relationship (msdyn_requirementrelationship) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 08/26/2024
...
# Requirement Relationship (msdyn_requirementrelationship) table/entity reference (Microsoft Dynamics 365 Field Service)
...
The following table lists the events for the Requirement Relationship (msdyn_requirementrelationship) table.
