...
# Appointment table/entity reference (Microsoft Dynamics 365 Field Service)

Commitment representing a time interval with start/end times and duration.

> [!NOTE]
> The Microsoft Dynamics 365 Field Service Appointment table extends the [Microsoft Dynamics 365 Appointment table](/dynamics365/developer/entities/appointment).
