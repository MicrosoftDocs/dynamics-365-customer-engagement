...
The following table lists the events for the Time Entry (msdyn_timeentry) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_timeentry](businessunit.md#BKMK_business_unit_msdyn_timeentry)
...
One-To-Many Relationship: [systemuser lk_msdyn_timeentry_createdby](systemuser.md#BKMK_lk_msdyn_timeentry_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_timeentry_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_timeentry_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_timeentry_modifiedby](systemuser.md#BKMK_lk_msdyn_timeentry_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_timeentry_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_timeentry_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_timeentry](owner.md#BKMK_owner_msdyn_timeentry)
...
One-To-Many Relationship: [processstage processstage_msdyn_timeentry](processstage.md#BKMK_processstage_msdyn_timeentry)
...
One-To-Many Relationship: [team team_msdyn_timeentry](team.md#BKMK_team_msdyn_timeentry)
...
One-To-Many Relationship: [systemuser user_msdyn_timeentry](systemuser.md#BKMK_user_msdyn_timeentry)
...
Many-To-One Relationship: [annotation msdyn_timeentry_Annotations](annotation.md#BKMK_msdyn_timeentry_Annotations)
...
Many-To-One Relationship: [asyncoperation msdyn_timeentry_AsyncOperations](asyncoperation.md#BKMK_msdyn_timeentry_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_timeentry_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_timeentry_BulkDeleteFailures)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_timeentry_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_timeentry_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_timeentry_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_timeentry_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_timeentry_ProcessSession](processsession.md#BKMK_msdyn_timeentry_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_timeentry_SyncErrors](syncerror.md#BKMK_msdyn_timeentry_SyncErrors)
