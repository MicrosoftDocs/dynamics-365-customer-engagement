...
The following table lists the events for the Work Order Incident (msdyn_workorderincident) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_workorderincident](businessunit.md#BKMK_business_unit_msdyn_workorderincident)
...
One-To-Many Relationship: [systemuser lk_msdyn_workorderincident_createdby](systemuser.md#BKMK_lk_msdyn_workorderincident_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workorderincident_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_workorderincident_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workorderincident_modifiedby](systemuser.md#BKMK_lk_msdyn_workorderincident_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_workorderincident_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_workorderincident_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_workorderincident](owner.md#BKMK_owner_msdyn_workorderincident)
...
One-To-Many Relationship: [team team_msdyn_workorderincident](team.md#BKMK_team_msdyn_workorderincident)
...
One-To-Many Relationship: [systemuser user_msdyn_workorderincident](systemuser.md#BKMK_user_msdyn_workorderincident)
...
Many-To-One Relationship: [msdyn_workordercharacteristic msdyn_msdyn_workorderincident_msdyn_workordercharacteristic_WorkOrderIncident](msdyn_workordercharacteristic.md#BKMK_msdyn_msdyn_workorderincident_msdyn_workordercharacteristic_WorkOrderIncident)
...
Many-To-One Relationship: [activitypointer msdyn_workorderincident_ActivityPointers](activitypointer.md#BKMK_msdyn_workorderincident_ActivityPointers)
...
Many-To-One Relationship: [adx_inviteredemption msdyn_workorderincident_adx_inviteredemptions](adx_inviteredemption.md#BKMK_msdyn_workorderincident_adx_inviteredemptions)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_inviteredemption`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_adx_inviteredemptions`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [adx_portalcomment msdyn_workorderincident_adx_portalcomments](adx_portalcomment.md#BKMK_msdyn_workorderincident_adx_portalcomments)

|Property|Value|
|---|---|
|ReferencingEntity|`adx_portalcomment`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_adx_portalcomments`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_Annotations"></a> msdyn_workorderincident_Annotations

Many-To-One Relationship: [annotation msdyn_workorderincident_Annotations](annotation.md#BKMK_msdyn_workorderincident_Annotations)
...
Many-To-One Relationship: [appointment msdyn_workorderincident_Appointments](appointment.md#BKMK_msdyn_workorderincident_Appointments)
...
Many-To-One Relationship: [asyncoperation msdyn_workorderincident_AsyncOperations](asyncoperation.md#BKMK_msdyn_workorderincident_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_workorderincident_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_workorderincident_BulkDeleteFailures)
...
Many-To-One Relationship: [chat msdyn_workorderincident_chats](chat.md#BKMK_msdyn_workorderincident_chats)

|Property|Value|
|---|---|
|ReferencingEntity|`chat`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_chats`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_connections1"></a> msdyn_workorderincident_connections1

Many-To-One Relationship: [connection msdyn_workorderincident_connections1](connection.md#BKMK_msdyn_workorderincident_connections1)
...
Many-To-One Relationship: [connection msdyn_workorderincident_connections2](connection.md#BKMK_msdyn_workorderincident_connections2)
...
Many-To-One Relationship: [duplicaterecord msdyn_workorderincident_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_workorderincident_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_workorderincident_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_workorderincident_DuplicateMatchingRecord)
...
Many-To-One Relationship: [email msdyn_workorderincident_Emails](email.md#BKMK_msdyn_workorderincident_Emails)
...
Many-To-One Relationship: [fax msdyn_workorderincident_Faxes](fax.md#BKMK_msdyn_workorderincident_Faxes)
...
Many-To-One Relationship: [letter msdyn_workorderincident_Letters](letter.md#BKMK_msdyn_workorderincident_Letters)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_workorderincident_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_workorderincident_MailboxTrackingFolders)
...
Many-To-One Relationship: [msdyn_copilottranscript msdyn_workorderincident_msdyn_copilottranscripts](msdyn_copilottranscript.md#BKMK_msdyn_workorderincident_msdyn_copilottranscripts)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_copilottranscript`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_msdyn_copilottranscripts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_msdyn_ocliveworkitems"></a> msdyn_workorderincident_msdyn_ocliveworkitems

Many-To-One Relationship: [msdyn_ocliveworkitem msdyn_workorderincident_msdyn_ocliveworkitems](msdyn_ocliveworkitem.md#BKMK_msdyn_workorderincident_msdyn_ocliveworkitems)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocliveworkitem`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_msdyn_ocliveworkitems`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_msdyn_ocsessions"></a> msdyn_workorderincident_msdyn_ocsessions

Many-To-One Relationship: [msdyn_ocsession msdyn_workorderincident_msdyn_ocsessions](msdyn_ocsession.md#BKMK_msdyn_workorderincident_msdyn_ocsessions)

|Property|Value|
|---|---|
|ReferencingEntity|`msdyn_ocsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_msdyn_ocsessions`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_msfp_alerts"></a> msdyn_workorderincident_msfp_alerts

Many-To-One Relationship: [msfp_alert msdyn_workorderincident_msfp_alerts](msfp_alert.md#BKMK_msdyn_workorderincident_msfp_alerts)

|Property|Value|
|---|---|
|ReferencingEntity|`msfp_alert`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_workorderincident_msfp_alerts`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_workorderincident_msfp_surveyinvites"></a> msdyn_workorderincident_msfp_surveyinvites

Many-To-One Relationship: [msfp_surveyinvite msdyn_workorderincident_msfp_surveyinvites](msfp_surveyinvite.md#BKMK_msdyn_workorderincident_msfp_surveyinvites)
...
Many-To-One Relationship: [msfp_surveyresponse msdyn_workorderincident_msfp_surveyresponses](msfp_surveyresponse.md#BKMK_msdyn_workorderincident_msfp_surveyresponses)
...
Many-To-One Relationship: [phonecall msdyn_workorderincident_PhoneCalls](phonecall.md#BKMK_msdyn_workorderincident_PhoneCalls)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_workorderincident_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_workorderincident_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_workorderincident_ProcessSession](processsession.md#BKMK_msdyn_workorderincident_ProcessSession)
...
Many-To-One Relationship: [queueitem msdyn_workorderincident_QueueItems](queueitem.md#BKMK_msdyn_workorderincident_QueueItems)
...
Many-To-One Relationship: [recurringappointmentmaster msdyn_workorderincident_RecurringAppointmentMasters](recurringappointmentmaster.md#BKMK_msdyn_workorderincident_RecurringAppointmentMasters)
...
Many-To-One Relationship: [serviceappointment msdyn_workorderincident_ServiceAppointments](serviceappointment.md#BKMK_msdyn_workorderincident_ServiceAppointments)
...
Many-To-One Relationship: [sharepointdocumentlocation msdyn_workorderincident_SharePointDocumentLocations](sharepointdocumentlocation.md#BKMK_msdyn_workorderincident_SharePointDocumentLocations)
...
Many-To-One Relationship: [socialactivity msdyn_workorderincident_SocialActivities](socialactivity.md#BKMK_msdyn_workorderincident_SocialActivities)
...
Many-To-One Relationship: [syncerror msdyn_workorderincident_SyncErrors](syncerror.md#BKMK_msdyn_workorderincident_SyncErrors)
...
Many-To-One Relationship: [task msdyn_workorderincident_Tasks](task.md#BKMK_msdyn_workorderincident_Tasks)
