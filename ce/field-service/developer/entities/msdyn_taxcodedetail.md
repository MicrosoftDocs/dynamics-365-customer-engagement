---
title: "Tax Code Detail (msdyn_taxcodedetail) table/entity reference (Microsoft Dynamics 365 Field Service)"
description: "Includes schema information and supported messages for the Tax Code Detail (msdyn_taxcodedetail) table/entity with Microsoft Dynamics 365 Field Service."
ms.date: 08/21/2024
...
The following table lists the messages for the Tax Code Detail (msdyn_taxcodedetail) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_taxcodedetails<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
| `GrantAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.GrantAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
| `IsValidStateTransition`<br />Event: False |<xref:Microsoft.Dynamics.CRM.IsValidStateTransition?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
| `ModifyAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.ModifyAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
| `Retrieve`<br />Event: True |`GET` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_taxcodedetails<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_taxcodedetails(*msdyn_taxcodedetailid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Tax Code Detail (msdyn_taxcodedetail) table.
...
The following table lists selected properties for the Tax Code Detail (msdyn_taxcodedetail) table.
...
|RequiredLevel|ApplicationRequired|
|Type|Boolean|
|GlobalChoiceName|`msdyn_taxcodedetail_msdyn_taxontax`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_taxcodedetail_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_taxcodedetail_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_taxcodedetail](businessunit.md#BKMK_business_unit_msdyn_taxcodedetail)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcodedetail_createdby](systemuser.md#BKMK_lk_msdyn_taxcodedetail_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcodedetail_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_taxcodedetail_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcodedetail_modifiedby](systemuser.md#BKMK_lk_msdyn_taxcodedetail_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_taxcodedetail_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_taxcodedetail_modifiedonbehalfby)
...
One-To-Many Relationship: [msdyn_taxcode msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode](msdyn_taxcode.md#BKMK_msdyn_msdyn_taxcode_msdyn_taxcodedetail_ParentTaxCode)
...
|ReferencingEntityNavigationPropertyName|`msdyn_parenttaxcode`|
|IsHierarchical||
...
One-To-Many Relationship: [msdyn_taxcode msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode](msdyn_taxcode.md#BKMK_msdyn_msdyn_taxcode_msdyn_taxcodedetail_TaxCode)
...
One-To-Many Relationship: [owner owner_msdyn_taxcodedetail](owner.md#BKMK_owner_msdyn_taxcodedetail)
...
One-To-Many Relationship: [team team_msdyn_taxcodedetail](team.md#BKMK_team_msdyn_taxcodedetail)
...
One-To-Many Relationship: [systemuser user_msdyn_taxcodedetail](systemuser.md#BKMK_user_msdyn_taxcodedetail)
...
Many-To-One Relationship: [annotation msdyn_taxcodedetail_Annotations](annotation.md#BKMK_msdyn_taxcodedetail_Annotations)
...
Many-To-One Relationship: [asyncoperation msdyn_taxcodedetail_AsyncOperations](asyncoperation.md#BKMK_msdyn_taxcodedetail_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_taxcodedetail_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_taxcodedetail_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_taxcodedetail_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_taxcodedetail_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_taxcodedetail_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_taxcodedetail_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_taxcodedetail_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_taxcodedetail_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_taxcodedetail_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_taxcodedetail_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_taxcodedetail_ProcessSession](processsession.md#BKMK_msdyn_taxcodedetail_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_taxcodedetail_SyncErrors](syncerror.md#BKMK_msdyn_taxcodedetail_SyncErrors)
