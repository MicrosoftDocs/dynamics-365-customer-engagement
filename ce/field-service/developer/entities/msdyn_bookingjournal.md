...
The following table lists the events for the Booking Journal (msdyn_bookingjournal) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_bookingjournal](businessunit.md#BKMK_business_unit_msdyn_bookingjournal)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookingjournal_createdby](systemuser.md#BKMK_lk_msdyn_bookingjournal_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookingjournal_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_bookingjournal_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookingjournal_modifiedby](systemuser.md#BKMK_lk_msdyn_bookingjournal_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookingjournal_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_bookingjournal_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_bookingjournal](owner.md#BKMK_owner_msdyn_bookingjournal)
...
One-To-Many Relationship: [team team_msdyn_bookingjournal](team.md#BKMK_team_msdyn_bookingjournal)
...
One-To-Many Relationship: [transactioncurrency TransactionCurrency_msdyn_bookingjournal](transactioncurrency.md#BKMK_TransactionCurrency_msdyn_bookingjournal)
...
One-To-Many Relationship: [systemuser user_msdyn_bookingjournal](systemuser.md#BKMK_user_msdyn_bookingjournal)
...
Many-To-One Relationship: [annotation msdyn_bookingjournal_Annotations](annotation.md#BKMK_msdyn_bookingjournal_Annotations)
...
Many-To-One Relationship: [asyncoperation msdyn_bookingjournal_AsyncOperations](asyncoperation.md#BKMK_msdyn_bookingjournal_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_bookingjournal_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_bookingjournal_BulkDeleteFailures)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_bookingjournal_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_bookingjournal_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_bookingjournal_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_bookingjournal_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_bookingjournal_ProcessSession](processsession.md#BKMK_msdyn_bookingjournal_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_bookingjournal_SyncErrors](syncerror.md#BKMK_msdyn_bookingjournal_SyncErrors)
