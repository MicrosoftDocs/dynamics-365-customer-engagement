...
> [!Note]
> In Field Service version 8.8.10.44+ the Bing Maps API key is hidden, as this is a Microsoft internal key that is not meant to be exposed to external parties.   
