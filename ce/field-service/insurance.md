...
In Dynamics 365 Field Service, insurance is an entity that relates to accounts and defines the policy holder, insurance carrier, policy number, and the start and end date of the insurance contract.
...
1. Select **New** to create an insurance record and enter the information for the insurance policy.
1. Save the record.
