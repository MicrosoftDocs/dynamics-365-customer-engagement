...
For more information, see this video: [Video symbol](../field-service/media/video-icon.png "Video symbol") [Work Orders: Record log total estimated duration, first arrived on, completed on](https://youtu.be/8sISJXS48fQ)
