...
| Closed-Posted | -- | No booking status can change the work order system status to **Closed-Posted**. If there are any bookings in a incomplete or non-canceled status, changing the system status to **Closed-Posted** will update those bookings to a **Canceled**. |
