...
> [!NOTE]
> Notes in the timeline are associated with the booking and currently don't show on the parent work order timeline. Notes taken in Timeline are stored in the `annotation` table.
