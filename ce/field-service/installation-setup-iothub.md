...
- Dynamics 365 for Customer Engagement System Administrator credentials. For users with Office 365 global administrator access, they must be assigned the ‘System Administrator’ security role within the Dynamics 365 for Customer Engagement organization.
...
## Privacy notice  
 ...
 - [Connected Field Service Device Readings (Preview)](/cfs-visualizations-iot-hub.md) uses [Azure Time Series Insight (Preview)](https://docs.microsoft.com/en-us/azure/time-series-insights/) to store, process and query IoT devices measurements from IoT Hub.
