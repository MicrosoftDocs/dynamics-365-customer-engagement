...
Agreements commonly use a service account because recurring service is often tied to an account, site, or customer location. If your organization uses a work order type that doesn't require **Service Account**, validate the agreement and booking setup before you generate recurring work orders. Make sure generated work orders include the required location, billing, price list, territory, and service context for your process. Learn more in [Configure service account requirements for work orders](configure-service-account-requirements-work-orders.md).
