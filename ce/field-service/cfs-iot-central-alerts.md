...
[intsructions go here!]

Configure rule in IoT Central and enable Flow template "Create CFS alerts from IoT Central", see incoming alerts in Connected Field Service.   
