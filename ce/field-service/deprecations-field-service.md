...
Beginning with the Field Service 9.3 release, the **Install Finance and Operations** toggle is no longer available in environments where the finance and operations integration is not already installed or configured. Environments that already have the integration enabled will retain access and can continue until the feature deprecation.
