...
:::image type="content" source="media/cfs-device-readings-hover-history.png" alt-text="Screenshot of the a device history chart with callouts on the main controls.":::
...
Device readings and summary tiles are viewable on the mobile app when you're connected to the internet. For more information, see [Connected Field Service on Field Service (Dynamics 365) mobile app](./cfs-mobile-powerapp.md#view-summary-tiles-and-device-readings)  
