...
> [!NOTE]
> To learn how to customize the work order form for the mobile app, go to [Edit the booking and work order form](/dynamics365/guidance/resources/fs-mobile-change-work-order-booking-form).
