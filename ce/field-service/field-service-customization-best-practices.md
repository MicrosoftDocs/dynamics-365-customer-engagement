...
Customizing the mobile app can also affect performance. For more information, see this article: [Performance considerations when customizing the mobile app](mobile/improve-mobile-performance.md)
