...
Customizing the mobile app can also affect performance.  Learn more in [Performance considerations when customizing the mobile app](mobile/improve-mobile-performance.md)
