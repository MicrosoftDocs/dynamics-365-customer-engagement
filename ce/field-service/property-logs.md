...
1. Select **Related** > **Property Log**. Then select **New Property Log**.
...
1. Select **Save and Close**.
    ...
    :::image type="content" source="media/assets-properties-log.svg" alt-text="Screenshot of the Property Log for a customer asset.":::
