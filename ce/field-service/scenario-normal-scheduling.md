...
When you select a resource and time slot, the system creates a **Bookable Resource Booking** record that tracks the following information:
...
Each status change creates a booking timestamp. When the booking is complete, the system generates [booking journals](booking-timestamps.md) for travel, working hours, overtime, and other related activities.
