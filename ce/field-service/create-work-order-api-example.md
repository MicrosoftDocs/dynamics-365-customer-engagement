...
- Existing records for the lookup fields used by your work order process:
  ...
  - **Price List** (`pricelevel` entity), if your process requires it
...
Use this pattern only when the selected work order type allows work orders without a service account.
...
When you omit the service account, include the location, billing, contact, and service context required by your process through the appropriate work order fields or related records.
