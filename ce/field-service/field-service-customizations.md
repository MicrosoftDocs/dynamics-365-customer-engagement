...
| Area | Documentations |
| --- | --- |
|   | [Create, edit, or configure forms using the form designer](https://docs.microsoft.com/powerapps/maker/model-driven-apps/create-and-edit-forms) |
|   | [Work order user interface settings](https://docs.microsoft.com/dynamics365/field-service/create-work-order#work-order-user-interface-settings)  |
|   | [Enabled scheduling for an entity](https://docs.microsoft.com/dynamics365/field-service/schedule-new-entity)  |
|   | [Customize Resource matching logic with custom fields](https://docs.microsoft.com/dynamics365/common-scheduler/developer/understanding-and-customizing-resource-matching-in-urs)  |
|   |  [Set up booking rules for customers to extend business logic](https://docs.microsoft.com/dynamics365/field-service/set-up-booking-rules) |
