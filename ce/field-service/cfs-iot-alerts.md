...
For a guided walkthrough, see the following video: [Connected Field Service: IoT Alerts](https://youtu.be/tkBSLhKNfmQ).
...
1. Select **Query** in the left pane, then select **IoTStream**.
   ...
   :::image type="content" source="./media/cfs-iot-alert-stream-analytics2.png" alt-text="Screenshot of the query and IoT stream options in the menu.":::
...
1. Open your solution that contains the Connected Field Service.

1. Select **Objects**, select **Processes**.
