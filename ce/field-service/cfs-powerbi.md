...
The predefined report for Connected Field Service shows information about IoT alerts in your system. At a glance, you can see who is affected by IoT alerts and when.
...
Some of the charts on the dashboard have other views associated with them. Choose other views from the dropdown to adapt the chart to meet your needs. To create your own dashboard with your adapted charts, select **Save as** in the command bar.
