...
- **Completed**: View a summary of the work, including the resolution and the number of products and services the technician used. If the work order isn't posted, you can review the information and then post it or [print a service report](mobile/mobile-powerapp-reporting.md). If the work order has been posted, you can print the service report and view or print the invoice.
