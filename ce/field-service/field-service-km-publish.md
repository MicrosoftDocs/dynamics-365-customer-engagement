...
description: Learn how to schedule and publish knowledge articles in Dynamics 365 Field Service. 
author: jshotts
...
After the content in the article is complete, you can publish the article to make it available to your technicians. You can publish the article immediately or schedule it for a later time.
...
1. Enter the following information:
   ...
   - **Expiration Date**: Select a date and time when you want the published article to expire, if any. Expired articles are no longer available in searches. If you’ve set an expiration date, select the state and status the knowledge article should be set to after it expires.
