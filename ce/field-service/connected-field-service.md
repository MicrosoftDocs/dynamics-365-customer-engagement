...
> [!IMPORTANT]
> The [device readings chart](cfs-visualizations-iot-hub.md) relies on Azure Time Series Insights. Initially planned for 2025, [the Time Series Insights service gets retired on July 7, 2024](https://azure.microsoft.com/updates/we-re-retiring-azure-time-series-insights-on-7-july-2024-transition-to-azure-data-explorer). The device readings chart is no longer available after July 7, 2024.
