---
title: "Overview of Field Service Integrations | MicrosoftDocs"
...
Microsoft Dynamics 365 Field Service provides various integration to empower you manage end to end business process easily and efficiently. 

Integrate with Supply Chain Management
While Dynamics 365 Field Service includes basic inventory capabilities for managing technician truck stock, tracking asset service history, requesting purchase orders, and documenting returns; many field service organizations still integrate Field Service with their Enterprise Resource Planning (ERP) systems. Organizations using the Microsoft Dynamics 365 stack will find it easy to integrate Dynamics 365 Field Service and Dynamics 365 Supply Chain Management systems.
Leveraging Common Data Model and Common Data Service in Dynamics 365, you can set up a synchronous two-way integration, check this doc Integrate Dynamics 365 Field Service and Supply Chain Management | Microsoft Docs to learn more  
Integrate with  Remote Assist 
If your organization uses Dynamics 365 Field Service to manage field service work orders, your first-line workers using Dynamics 365 Remote Assist on HoloLens can see their Field Service bookings and quickly call the remote collaborator listed in the booking's Support Contact field. Check this doc Collaborate in mixed reality with Field Service, Dynamics 365 Remote Assist, and HoloLens | Microsoft Docs to learn more 
...
https://docs.microsoft.com/en-us/dynamics365/field-service/supply-chain-field-service-integration

https://docs.microsoft.com/en-us/dynamics365/field-service/remote-assist-hololens

https://docs.microsoft.com/en-us/dynamics365/field-service/mixed-reality-guides-integration
