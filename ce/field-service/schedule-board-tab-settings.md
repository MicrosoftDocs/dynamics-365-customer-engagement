...
> [!div class="mx-imgBorder"]
> ![Screenshot of the schedule board with the page count highlighted](./media/schedule-board-tab-settings-requirement-page-count.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of the schedule board with non-working hour blocks highlighted](./media/schedule-board-tab-settings-nonworking-hours-color.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of the vertical line on the schedule board](./media/schedule-board-tab-settings-current-timeline-color.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of an alert view](./media/schedule-board-tab-settings-booking-alerts-view.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of the alert fields](./media/schedule-board-tab-settings-booking-alerts-template.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of the schedule board filter layout](./media/schedule-board-tab-settings-filter-layout.png)
...
> [!div class="mx-imgBorder"]
> ![Screenshot of the fields displayed in the resource detail cell](./media/schedule-board-tab-settings-resource-cell-template.png)
