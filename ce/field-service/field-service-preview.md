...
Here is an example of the all the PowerShell commands we will run and you can follow with the steps below. It is recommended to copy and past the following in a note that you can edit with your specific information for username, password, org ID and more.
