...
The Settings entity is not an entity that exists in the Dataverse, however, it is a collection of all the below attributes that helps the Schedule Assistant API filter results. Thus, the @odata.type for this entity should be Microsoft.Dynamics.CRM.expando.
