...
This setting with also control whether the *Date Window Start/End* fields are visible on the work order. If the Agreement is set to populate *Date Window Start/End* these fields will be visible on the work order; otherwise, they are hidden by default.|
