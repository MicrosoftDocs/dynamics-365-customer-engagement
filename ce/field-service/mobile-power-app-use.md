...
Before using the mobile app, a system administator must [install and set up the Field Service (Dynamics 365) mobile app](mobile-power-app-get-started.md) along with users and security roles.
...
### Recents and pins
Use the Recent button option in the main menu to quickly naviagte to recently viewed records like work orders, assets, time entries, and more. You also have the option to "pin" important records for easy access. 


> [!div class="mx-imgBorder"]
> ![Screenshot of ](./media/mobile-2020-menu-pin.png)
