...
The Resource Scheduling Health Diagnostics Tool helps admins identify and resolve issues in Dynamics 365 Field Service, Project Operations, or Customer Service environments. Use the Resource Scheduling Health Diagnostics Tool to:
...
1. Select **Health Diagnostics** in the top bar.
...
1. Select **Run Diagnostics**.
   ...
   The tool runs diagnostics on your environment and displays the results in the **Diagnostic details** section.
...
> [!NOTE]
> If you don't see any diagnostic details from the following table when you run the Health Diagnostics Tool, your environment doesn't have any issues to resolve.
