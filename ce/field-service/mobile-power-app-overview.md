...
| [Offline by default](mobile-power-app-system-offline-sync.md#understanding-offline-vs-online-capabilities) | Technician | Yes |  The app is offline by default, so the technician is always ready. |
