...
> [!NOTE]
> Inspections without work orders won't work offline. Default functionality for inspections, like the export to PDF are only available on work oder service tasks.
