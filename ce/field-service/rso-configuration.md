...
1. Go to **Settings** > **Security** > **Field Security Profiles**, open **Field Service – Administrator**, and add **Resource Scheduling Optimization** to the field security profile.
  ...
  For dispatchers who want to interact with Resource Scheduling Optimization:
   ...
   1. Grant **RSO Dispatcher** a security role.
   1. Select **Save**.
...
2. Configure booking setup metadata for the entity. Set **Default Scheduling Method** to **Optimize**. For example, you can enable it for the work order entity’s booking setup metadata. Every new work order and related resource requirement will be configured to optimize automatically.
