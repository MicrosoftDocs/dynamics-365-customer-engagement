...
> [!Note] 
> Technicians must be sharing their location from their Field Service mobile application to provide estimated travel time and display their near-real time location on the portal. Latency between the Technicians real-world location and location represented on the portal map may increase when in limited network areas or if there is disruption of the connection to the Technicians mobile device.
> 
