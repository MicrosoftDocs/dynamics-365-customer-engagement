...
From a property template, you can also associate assets, [asset categories](asset-categories.md), functional locations, or location categories. By associating a template with a category, all records in that category use the property template.
