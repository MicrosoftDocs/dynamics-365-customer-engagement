---
title: Create, review, and publish knowledge articles
...
A knowledge article can include product documentation, solutions to common issues, answers to frequently asked questions, and more.
...
1. On the **Content** tab, in the **Article Content** section, fill in the following details:  
...
1. Change the **Status Reason** to **Needs review**. Optionally, **Assign** the article to the reviewer.
...
1. Confirm and then select **Save & Close**.

## Publish a knowledge article

After you complete the content in the article, publish the article to make it available to your technicians. You can publish the article immediately or schedule it for a later time.

1. Open the article.

1. On the command bar, select **More commands** (**&vellip;**) > **Publish**.

1. Enter the following information:
   - **Publish**: Select whether you want to publish the knowledge article now or in the future. To schedule the article for future publishing, in the **Publish On** field, select a date and time.
   - **Published Status**: Select the status the article holds once published. By default, **Published** is selected.
