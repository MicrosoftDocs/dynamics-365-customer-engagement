...
1. Set the **Tracking Times** by date for when you want the system to track location data. The start time must be set to occur before the end timeg. For 24 hours, select 12:00 am to 11:59 pm.
