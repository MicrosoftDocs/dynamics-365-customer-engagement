...
1. Review the **Data for offline use**. For each table:
   ...
   - Select the rows or filters, relationships, files, and images to make available offline. Learn more: [Apply filters](/power-apps/mobile/setup-mobile-offline#add-a-table-to-an-offline-profile-and-apply-filters).
     ...
     **Advanced option**: To boost offline performance of large datasets, power users can review and manually edit Fetch XML for your offline filters. Select **Edit filter** to adjust filters through [FetchXML editor](/power-apps/mobile/fetchxml-editor).
