...
## Dynamics 365 Sales, Spring 2018 

-  **Sales admin settings**: With Dynamics 365 Sales, Spring 2018, all the sales settings are now available in the Sales Hub app. An administrator doesn't have to use the web application to configure price lists, units, product catalog, and goal settings right from the Sales Hub app. 
