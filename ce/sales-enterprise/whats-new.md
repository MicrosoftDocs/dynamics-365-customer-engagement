...
-  **Sales and admin settings**: With [!INCLUDE[pn-crm-9-0-2-online](../includes/pn-crm-9-0-2-online.md)], an administrator can now configure all the sales settings like price lists, units, product catalog and goal settings right from the Sales Hub app. 

-  **View hierarchical data**: In the Sales Hub app, you can see how info is related or grouped by viewing accounts, products, or users in hierarchical charts. You can click a tile in the chart to get the full details and then navigate to the info you’re interested in. [!INCLUDE[proc-more-information](../includes/proc-more-information.md)] [See relationships in a hierarchical view](../basics/hierarchical-relationship.md)
