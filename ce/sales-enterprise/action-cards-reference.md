...
- Uses [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] data. 
...
|<a name="PostMeetingFollowup"></a>**Post-meeting follow-up**<br/> ![Action card for recent meeting](media/ActionCard_RecentMeeting.png "Action card for recent meeting")|- **Description**<br />     Tells you that a meeting that you organized (where you are the record owner) has recently ended, giving you an easy opportunity to document the meeting in [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)].<br />- **Features**<br />     Identifies the meeting.<br />     Provides text explaining why the card was generated.<br />- **Actions**<br />     Add notes to the meeting record.<br />     Open the meeting record.|  
...
## Email cards from Exchange  
 ...
 When you receive an email, [!INCLUDE[pn_Exchange](../includes/pn-exchange.md)] and [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] work together to scan the body of the email looking for certain words or phrases that suggest that the email is related to your [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] work.  
...
> [!IMPORTANT]
> - These cards only available if you are using [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] with [!INCLUDE[pn_Microsoft_Exchange_Online](../includes/pn-microsoft-exchange-online.md)] as your email server. 
...
> [!NOTE]
> - These cards are only available for [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)]. 
> - These cards use [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] data.
...
|||
|-|-|
|<a name="RecentMeeting"></a>**Recent meeting**<br/>![Action card for recent meeting](media/ActionCard_RecentMeeting.png "Action card for recent meeting")|- **Description**<br/>Tells you that a meeting that you organized (where you are the record owner) has recently ended, giving you an easy opportunity to document the meeting in ]. The card is displayed for 30 minutes after the scheduled end of the meeting, and then removed.<br />- **Features**<br />Identifies the meeting.<br /> Provides text explaining why the card was generated.<br />- **Actions**<br /> Add notes to the meeting record.<br /> Open the meeting record.|
