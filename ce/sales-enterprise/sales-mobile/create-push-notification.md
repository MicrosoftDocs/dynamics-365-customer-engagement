...
Push notifications help to engage app users and help them prioritize key tasks. The Dynamics 365 Sales mobile app (preview) supports push notifications that can be created by using the **Send push notification V2** action with the following details:
