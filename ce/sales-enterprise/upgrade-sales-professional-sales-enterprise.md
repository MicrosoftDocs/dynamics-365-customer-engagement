---
title: "Upgrade from Dynamics 365 for Customer Engagement for Sales Professional to Dynamics 365 for Customer Engagement for Sales Enterprise (Dynamics 365 for Customer Engagement for Sales) | MicrosoftDocs"
description: "Follow the steps in this topic to upgrade from Dynamics 365 for Customer Engagement for Sales Professional to Dynamics 365 for Customer Engagement for Sales Enterprise."
keywords: "Dynamics 365 for Customer Engagement for Sales, Professional, Enterprise, Upgrade"
ms.date: 06/22/2018
ms.service: 
  - "dynamics-365-sales"
ms.custom: 
...
# Move from Dynamics 365 for Customer Engagement for Sales Professional to Dynamics 365 for Customer Engagement for Sales Enterprise
...
## Purchase Dynamics 365 for Customer Engagement for Sales Enterprise Edition subscription
...
3. Select **Add subscriptions**.
   ...
   ![Dynamics 365 for Customer Engagement for Sales Enterprise Edition tile on Purchase Services page](media/purchase-services-page.png "Dynamics 365 for Customer Engagement for Sales Enterprise Edition tile on Purchase Services page")
...
4. In the **[!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] Enterprise Edition** tile, move your mouse over the Ellipses icon and select **Buy Now**, and then follow the steps to purchase new licenses. 
   ...
   ![Buy Dynamics 365 for Customer Engagement for Sales Enterprise Edition plan](media/buy-sales-enterprise.png "Buy Dynamics 365 for Customer Engagement for Sales Enterprise Edition plan")
...
## Install Dynamics 365 for Customer Engagement for Sales Enterprise solution
...
3.	On the **Manage your solutions** page, select **Dynamics 365 for Customer Engagement for Sales Application**, and on the tile, select **Install**.
...
## Delete the Dynamics 365 for Customer Engagement for Sales Professional solution
