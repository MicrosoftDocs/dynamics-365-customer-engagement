...
As a Dynamics 365 administrator, you install the ZoomInfo app for administrators to configure export and mapping settings, and sellers to search for and export ZoomInfo data to Dynamics 365 Sales workflows.   

## Prerequisites    
Before you start, be sure you have met the following prerequisite:    
...
## Install the app     
1.	Go to [Microsoft AppSource portal](https://appsource.microsoft.com/) and search for the **ZoomInfo** app.    
...
5.	Sign in to the [Power Apps portal](https://make.preview.powerapps.com/) and choose your organization in which you want to install the ZoomInfo app.   
...
9.	Upon successful completion, the ZoomInfo app appears in Dynamics 365 apps page.
