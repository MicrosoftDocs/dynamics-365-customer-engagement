...
> [!IMPORTANT]
> The features Relationship assistant, Email engagement, and Auto capture are not available for legacy CRM licence. To use these features, acquire D365 licence.  
