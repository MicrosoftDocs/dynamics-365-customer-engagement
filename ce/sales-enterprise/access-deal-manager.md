...
description: "Sellers access the deal manager workspace to get better visibility into their pipelines."
ms.date: 06/30/2021
ms.topic: article
author: lavanyakr01
ms.author: lavanyakr
...
To access the deal manager workspace, select **Deal manager (preview)** in the Sales Hub site map.  
