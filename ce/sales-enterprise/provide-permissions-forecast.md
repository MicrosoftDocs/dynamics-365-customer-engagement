...
2.	In the **Additional security roles** section, select one of the following option to provide permissions to view the forecast to users who aren't part of the hierarchy.
	...
	| Specific security roles | This option allows you to specify security roles when you want to give access to a few external users to view only data or to adjust the data in the forecast. |
