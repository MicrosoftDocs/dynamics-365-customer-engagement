...
>[!NOTE]
>You can also upload the data to the simple columns using the msdyn_ForecastApi action. To learn more, see [msdyn_ForecastApi](../sales-enterprise/developer/reference/custom-actions/msdyn_ForecastApi.md).
