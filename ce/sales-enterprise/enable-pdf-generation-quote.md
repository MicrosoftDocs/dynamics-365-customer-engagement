---
title: "Enable generation of PDF from quotes (Dynamics 365 for Sales) | MicrosoftDocs"
...
To allow your users to generate PDFs directly from quote, you must enable PDF generation.

1.	At the bottom of the site map, select the Change area icon ![Icon to change the work area](media/change-area-icon.png "Icon to change the work area")  and select **App Settings**.

2.	Under **Sales Administration**, select **PDF generation**.

3.	In the **Generate PDF file** page, set **Select whether PDF files can be created, saved, and emailed based on Dynamics 365 for Sales entity records** to **Yes**.
