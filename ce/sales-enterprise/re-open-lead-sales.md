---
title: "Reopen a lead (Dynamics 365 for Customer Engagement for Sales) | MicrosoftDocs"
...
1.  On the list of leads, select the down arrow, and then select the **Closed Leads** view.  
    ...
    ![Shows closed leads in Dynamics 365 for Customer Engagement](../sales-enterprise/media/close-sales-lead.png "Shows closed leads in Dynamics 365 for Customer Engagement")  
  
2.  Select the lead you want to reopen, and then select **Reactivate Lead**.  
  
    ![Shows reactivating a lead in Dynamics 365 for Customer Engagement](../sales-enterprise/media/sales-lead-reactivate.png "Shows reactivating a lead in Dynamics 365 for Customer Engagement")  
