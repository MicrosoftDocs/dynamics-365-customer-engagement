...
3.	In the **Forecast category** drop-down list, select one of the following, and then select **Save**:
    ...
    - **Won.** When an opportunity is successful and closed as won, change the category as **Won**.
    
    - **Lost.** When an opportunity is unsuccessful and closed as lost, change the category as **lost**.
