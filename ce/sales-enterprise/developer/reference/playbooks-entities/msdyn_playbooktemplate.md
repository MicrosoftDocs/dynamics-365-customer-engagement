...
|msdyn_estimatedduration|Estimated duration (days)|Edm.Int32|Enter the estimated duration in days to indicate the time it may take to complete the Playbook template once launched|
...
|msdyn_trackprogress|Track progress|Edm.Boolean|Select whether or not to track the progress of the playbook by creating the activities under a playbook which is in turn related to the record type the playbook applies to|
