...
- Create and update operations on OQOI entities triggerring updates on parent OQOI entities.
-	Retrieving details of OQOI entities internally triggers price calculation service, which subsequently triggers Custom Plug-ins created by customers. 
