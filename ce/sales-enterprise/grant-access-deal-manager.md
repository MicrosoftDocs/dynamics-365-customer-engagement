...
description: "As an administrator, grant access to the deal manager to specific security roles or to all security roles."
ms.date: 07/15/2021
ms.topic: article
author: lavanyakr01
ms.author: lavanyakr
...
By default, deal manager is enabled only for the administrators. As an administrator, you can grant access to specific security roles or to all security roles in your organization.  
