...
We're introducing a new suite of features called  *Relationship Insights*, which continuously analyzes the vast collection of customer-interaction data already stored in your [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] and [!INCLUDE[pn_Microsoft_Exchange](../includes/pn-microsoft-exchange.md)] systems, to help you better understand your business relationships, evaluate your activities in relation to previous successes, and choose the best path forward.  
...
## Find and track relevant messages from your Exchange server with auto capture  
 [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] can now analyze your email messages directly in [!INCLUDE[pn_Microsoft_Exchange](../includes/pn-microsoft-exchange.md)] to find all messages that might be relevant to your work in [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)]. The system looks for messages to or from relevant email addresses, and presents you with the relevant messages right in [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)]. With just one click, you can track any of the suggested messages in [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)], which makes them available to your sales team and also for use by other Relationship Insights features.  
