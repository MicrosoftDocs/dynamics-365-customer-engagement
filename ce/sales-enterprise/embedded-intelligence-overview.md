...
## The relationship assistant automatically shows you the right information at the right time  
 ...
 [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Relationship assistant](../admin/../sales-enterprise/relationship-assistant.md), [Action cards reference](../admin/action-cards-reference.md)  
