...
To go to the this new area of app settings, at the bottom of the site map, select the **Change area** ![Change area](media/change-area-icon.png "Change area") icon, and then select **App Settings**.
