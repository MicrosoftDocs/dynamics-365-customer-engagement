...
|3     |Editable grid         |Lets you view a list of opportunities and edit records inline. Select any linked column, such as Name, Potential Customer, or Contact, to view and edit quick details in the side panel. You can personalize the grid; add, remove, resize, hide, rearrange, sort, and group columns on-the-fly. See [Personalize deal manager (Preview)](personalize-deal-manager.md#personalize-the-grid). You can also save the personalization in a view so that you can switch to it at anytime. See [Create a view](personalize-deal-manager.md#create-a-view).  
