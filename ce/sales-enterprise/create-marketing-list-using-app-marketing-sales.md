...
2.  In the **Manage Members** dialog box, select one of the following options, and then click **Continue**.  
  ...
  > [!NOTE]
  > You can add up to 120,000 members to a static marketing list in one add operation. If you need to add more than 120,000 members to a static marketing list then you should split those members into multiple add operations. One way to do this is by using the [Advanced Find](#add_using_advanced_find) dialog to create queries that return less than 120,000 members. Alternatively, depending on your scenario you can also consider using a dynamic marketing list instead of static list.
