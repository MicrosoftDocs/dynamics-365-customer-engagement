...
The elements listed in the message are needed to populate the Members List which is included in the default view. If your custom form does not display the members list then the message can be
