---
title: "Report writing environment using SQL Server Data Tools in Dynamics 365 Customer Engagement | MicrosoftDocs"
ms.custom: ""
ms.date: 08/31/2017
ms.reviewer: ""
...
This topic describes what’s needed to author [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] reports.  
  
 You must have the required development tools and appropriate privileges in [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] to write and publish a report. Also, you should be familiar with:  
...
-   To write Fetch-based reports, the [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]FetchXML language. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [MSDN: Build queries with FetchXML](https://msdn.microsoft.com/library/gg328332.aspx)  
  
## Required tools  
 The following are required to write a custom report for [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]:  
...
## Required privileges  
 To deploy custom reports to [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)], you must have a [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] account and a security role assigned to you that includes the **PublishReport** privilege. By default, the System Customizer and System Administrator security roles include these privileges.  
  
## Report development process  
 The following lists the steps for developing custom [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] reports. You may have to repeat some steps while you develop a report:  
...
2.  Create a custom report or use an existing report to modify using [!INCLUDE[pn_sql_server_data_tools](../includes/pn-sql-server-data-tools.md)] in [!INCLUDE[pn_Visual_Studio](../includes/pn-visual-studio.md)].  
    ...
    -   Download an existing [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] report definition language (.rdl) file. You can do this in the [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] web application. More information: [Modify a report (RDL) file](https://technet.microsoft.com/library/dn531075.aspx#bkmk_ModifyRDL)  
...
8.  Deploy the report to the reporting server by using [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)]. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Publish Reports](../analytics/publish-reports.md)  
