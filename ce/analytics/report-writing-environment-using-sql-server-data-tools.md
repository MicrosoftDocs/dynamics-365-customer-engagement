...
- To write Fetch-based reports, the FetchXML language. FetchXML is a proprietary query language that is used in [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)]. 
