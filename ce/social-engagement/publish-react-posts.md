...
3. At the bottom of the post, select **Share** ![Facebook share button in Social Engagement](media/share-on-facebook-icon.png "Facebook share button in Social Engagement").  

4. Select the check box for the  social profile that you want to share this post with.  

5. Type your message in the text field.  

6. Select **Share** ![Facebook share button in Social Engagement](media/share-on-facebook-icon.png "Facebook share button in Social Engagement").  

<a name="commentReply"></a>   
### Reply to a conversation  
 Reply to questions, requests, and feedback on [!INCLUDE[tn_facebook](../includes/tn-facebook.md)] pages directly from within [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)].  
...
3. At the bottom of the post, select **Comment** ![Facebook comment button in Social Engagement](media/facebook-comment-icon.png "Facebook comment button in Social Engagement").  
...
7. To publish the message on behalf of the selected social profile, select **Comment** ![Facebook comment button in Social Engagement](media/facebook-comment-icon.png "Facebook comment button in Social Engagement").  
