...
[!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Flag social profiles in search rules as “owned”](#ownedProfiles), [Share social profiles with other users](#shareProfile) and [Configure a custom tag to promote posts](#promotePost)  
  
<a name="ownedProfiles"></a>   
