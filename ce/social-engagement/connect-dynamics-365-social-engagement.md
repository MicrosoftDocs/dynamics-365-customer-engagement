...
<!--note from editor: I think this should be an Important, not a Warning. I tried to find the MSWG topic about it, but it's gone now. So I will say at least it used to be that the MS guideline was that warnings were used for severe issues like data loss or bodily harm to the user. So, using that for a support restriction seems too harsh to me. I recommend an Important instead. -->
