...
To automatically turn a Social Activity into another record type in [!include[](../includes/pn-dynamics-crm.md)], an administrator or customizer needs to confiure the Record Creation and Update Rule feature in [!include[](../includes/pn-dynamics-crm.md)]. 

In [!INCLUDE[MSE](../includes/pn-social-engagement-short.md)], users can select whether they want to [create a case or lead entity](link-posts-to-dynamics-365.md) in the connected [!include[](../includes/pn-dynamics-crm.md)] instance.
...
In [!include[](../includes/pn-dynamics-crm.md)], a Social Activity entity gets created, containing the information if the target record is a `lead` or an `incident`. 

When you create an Automatic Record Creation rule, the system will convert social activities created from [!INCLUDE[MSE](../includes/pn-social-engagement-short.md)] to the corresponding entities in [!include[](../includes/pn-dynamics-crm.md)].

## Create a rule to automatically turn social actitivites into lead or case records

1. Sign in to [!include[](../includes/pn-dynamics-crm.md)] with your system administrator credentials.
