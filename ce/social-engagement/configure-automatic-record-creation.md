...
In Social Engagement, users can select whether they want to [create a case or lead entity](link-posts-to-dynamics-365.md) in the connected Dynamics 365 instance. 
![Open drop-down menu with Case and Lead option for creating a record in Customer Engagement from within Social Engagement.](media/select-entity-mse.png "Open drop-down menu with Case and Lead option for creating a record in Customer Engagement from within Social Engagement.")
In Customer Engagement, a Social Activity entity gets created, containing the information if the target record is a `lead` or an `incident`. 
...
Social activity entities created from Social Engagement now automatically create the configured record type in Customer Engagement. 
