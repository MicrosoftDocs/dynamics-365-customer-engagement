...
For example, if your browser is set to Hawaii–Aleutian time zone (UTC-10)  then your Quota section would include the posts from the last ten hours of the previous month _in your time zone_.
- You deleted search topics this month. Posts that were already acquired by the now deleted search topic will still count against your monthly quota shown in Search Setup Quota section. They will not appear in the Analytics posts number because they do not match any of your current search topics.
