...
Review these steps and decide which are relevant for your business scenario.
...
2. [Add tags, automatically and manually](#use-intelligence-to-boost-productivity), learn how automated intention analysis can help triage incoming posts. Let [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] do some work for you.

3. [Save time on repetitive tasks](#create-support-cases-or-sales-leads-in-dynamics-365-from-social-posts). Create new case records in [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] directly from a post within [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)].
...
1. [Define a new tag](../social-engagement/tags.md#add-custom-tags).

2. [Automate the tagging of posts](../social-engagement/tags.md#promote-custom-tags-to-auto-tags).

3. Get [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] to [find the intentions in posts](../social-engagement/tags.md#how-intention-analysis-works).
...
1. [Assign posts](../social-engagement/work-with-posts.md#assign-a-post-to-other-users-in-analytics-and-social-center) to other users.

2. [Share streams](../social-engagement/social-center.md#share-a-stream) with other users.

3. [Add labels](../social-engagement/work-with-posts.md#add-a-label-to-a-post-in-analytics-or-social-center) to posts.
