...
- Get [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] to [find the intentions in posts](../social-engagement/tags.md#how-intention-analysis-works) to enable quick triage of large number of posts. For example, you can route support requests to your service reps.  
...
4. [Create a case from a post](../social-engagement/create-dynamics-365-record-from-social-post.md#convert-a-social-engagement-post-to-a-social-activity) in [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)].
