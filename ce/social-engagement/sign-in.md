...
To sign in to [!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)], you'll need to be assigned a user license. Your organization's Office 365 administrator assigns user licenses when setting up Social Engagement. For more information about assigning licenses to users, see [Manage user licenses](manage-licenses.md).  
  
## Sign in to [!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)] from a dedicated sign-in page
...
## Sign in to [!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)] from Office 365
...
## Sign in to [!INCLUDE[pn_netbreeze_long](../includes/pn-social-engagement-long.md)] by using the app URL  
