...
## Sign in to Social Engagement from the Office 365 admin center  
 Sign in to the [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] online service from the [!INCLUDE[pn_office_365_admin_center](../includes/pn-office-365-admin-center.md)].  
  
1.  In your browser, open [https://portal.office.com](https://portal.office.com).  
  
2.  Sign in with your [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] credentials, for example, user@contoso.onmicrosoft.com.  
  
3.  From the [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] app launcher, click **Social Engagement**.  
  
     You'll be redirected to your organization's [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] solution.  
...
> [!TIP]
>  If you don’t see a shortcut to [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] on the [!INCLUDE[pn_Office_365](../includes/pn-office-365.md)] nav bar, verify that a [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] license is assigned to you.  
  
<a name="SignInWithURL"></a>   
## Sign in to Social Engagement by using the app URL  
 We recommend saving the URL for your [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)] solution to your browser's favorites, and getting to know the app URL. You'll need this URL each time you want to  sign in to [!INCLUDE[pn_netbreeze_short](../includes/pn-netbreeze-short.md)].  
