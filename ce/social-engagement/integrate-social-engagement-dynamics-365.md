...
# Integrate [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] with Dynamics 365 for Customer Engagement
...
## Connect Dynamics 365 for Customer Engagement (online) to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] for Social Insights
...
### Connect Dynamics 365 for Customer Engagement (online) to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)]

1. In Dynamics 365 for Customer Engagement, select **Settings** > **Administration** > **[!INCLUDE [pn-social-engagement-long](../includes/pn-social-engagement-long.md)] Configuration**.
...
## Connect Dynamics 365 for Customer Engagement on-premises to [!INCLUDE[pn_netbreeze_short](../includes/pn-social-engagement-short.md)] for Social Insights
...
When working with an app built for the [Unified Interface in Dynamics 365 for Customer Engagement](https://docs.microsoft.com/dynamics365/customer-engagement/admin/about-unified-interface), you can change the way that Social Insights is shown to meet your needs. 
...
## Set up search topics from within Dynamics 365 for Customer Engagement  
...
This action deletes all existing data in Dynamics 365 for Customer Engagement for the search topics, search topic categories, and visuals for Social Insights.
