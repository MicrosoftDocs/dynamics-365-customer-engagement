...
New Dynamics 365 customers are encouraged to sign up to try the Dynamics 365 AI for Market Insights public preview. More details about pricing and licensing for Dynamics 365 AI for Market Insights will be available closer to General Availability release. 

###	Will Dynamics 365 Market Insights be available to government entities? 
As in the case with Microsoft Social Engagement, government entities will not be able to use Dynamics 365 AI for Market Insights without additional approval.
...
### What is the difference in capabilities between Microsoft Social Engagement and Dynamics 365 AI for Market Insights?

Dynamics 365 AI for Market Insights will focus more on enabling businesses with AI-powered social and web insights and will have combined capabilities and insights from Microsoft Social Engagement and Bing Search. The public preview release of Market Insights currently contains the original capabilities of Microsoft Social Engagement on the same UI, along with new features such as age and demographics insights from Bing search. For more details, see the [Comparison guide](comparison-mse-mi.md).

![Market Insights app ecosystem](../media/app-ecosystem-ai4mi.png)
 
###	What is the international availability of Dynamics 365 AI for Market Insights?

Dynamics 365 AI for Market Insights public preview is available in the countries and regions set forth in the Availability Guide, which will continue to be updated as more countries/regions and languages are added. To access Dynamics 365 AI for Market Insights public preview for the countries and regions listed above, please visit the [Dynamics 365 AI for Market Insights site](https://dynamics.microsoft.com/ai/market-insights/) for your country or region.

###	Can customers access the Dynamics 365 AI for Market Insights public preview if they are located outside of the countries or regions set forth in the Availability Guide?

Unfortunately, Dynamics 365 AI for Market Insights is only available in the countries/regions and languages set forth in the [Availability Guide](https://aka.ms/dynamics_365_international_availability_deck). 

## Resources
- [Comparison guide - Microsoft Social Engagement vs. Dynamics 365 AI for Market Insights](comparison-mse-mi.md)
