...
Effective January 16, 2019, Microsoft Social Engagement (MSE) will no longer be included as part of any Dynamics 365 license entitlement for new customers. Current customers with license entitlements to Microsoft Social Engagement will continue to be able to access the service, and add any additional social post capacity as needed, until the earlier of the expiration of your subscription or January 16, 2020. Effective January 16, 2020, Microsoft Social Engagement will be discontinued for all Dynamics 365 customers.
...
With the discontinuation of Microsoft Social Engagement, new prospects and existing Microsoft Social Engagement customers are being requested to try the public preview of [Dynamics 365 Market Insights](https://dynamics.microsoft.com/ai/market-insights/). The public preview is planned for release in the [countries and languages listed in the Availability Guide](https://aka.ms/dynamics_365_international_availability_deck). 
...
###	Will Dynamics 365 Market Insights be available to Government? 
Similar to Microsoft Social Engagement, government entities will not be able to use Dynamics 365 Market Insights without additional approval.
...
The transition to Dynamics 365 Market Insights is intended to be a seamless experience for current Microsoft Social Engagement customers. When MSE customers sign into Market Insights, their data and configurations from MSE should be accessible and available in Market Insights. However, please note that the user interface for Market Insights may be subject to change in the future. 
...
- **Social Selling**: Empower your sales people to sell more by leveraging social media. Sales teams can gather intelligence, source new leads, and build credibility. Source high-quality leads to identify and act on buying signals, then create new leads based on social posts.

Please refer to the [Release Notes](https://dynamics.microsoft.com/business-applications/release/) for information about additional capabilities planned to be released in future.
...
Dynamics 365 Market Insights public preview is available in the countries set forth in the Availability Guide, which will continue to be updated as more countries and languages are added. To access Dynamics 365 Market Insights public preview for the countries listed above, please visit the [Dynamics 365 Market Insights site](https://dynamics.microsoft.com/ai/market-insights/) for your country.

###	Can customers access Dynamics 365 Market Insights public preview if they are located outside of the countries set forth in the Availability Guide?

Unfortunately, Dynamics 365 Market Insights is only available in the countries and languages set forth in the [Availability Guide](https://aka.ms/dynamics_365_international_availability_deck). 
