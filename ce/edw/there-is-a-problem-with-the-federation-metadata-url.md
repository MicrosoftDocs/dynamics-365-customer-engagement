...
For more information about the certificate requirements for claims-based authentication, see [Certificate selection and requirements](http://go.microsoft.com/fwlink/p/?LinkId=306059).
