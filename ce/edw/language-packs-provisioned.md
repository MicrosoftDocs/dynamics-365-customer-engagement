...
2.  Upgrade the Language Packs to corresponding [!INCLUDE[pn_microsoftcrm](../includes/pn-microsoftcrm.md)] Language Packs.  [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Install and enable a Language Pack](../on-premises/install-and-enable-a-language-pack.md)  
