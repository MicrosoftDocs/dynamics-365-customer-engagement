...
-   The specified computer has [!INCLUDE[pn_reporting_services_short](../includes/pn-reporting-services-short.md)] installed and the version is supported. See [Microsoft Dynamics 365 reporting requirements](../on-premises/microsoft-dynamics-365-reporting-requirements.md). 
