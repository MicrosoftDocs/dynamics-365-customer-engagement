...
## Cause
 ...
 For more information about base and exensionbase table merge, see [Run the base and extension table merge as a separate operation](http://go.microsoft.com/fwlink/p/?LinkId=309240).
