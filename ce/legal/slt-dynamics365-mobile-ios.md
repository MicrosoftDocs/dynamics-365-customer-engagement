...
# MICROSOFT SOFTWARE LICENSE TERMS<br>MICROSOFT DYNAMICS 365 FOR iOS
...
>   on iOS-based devices that you own or control for your use solely with
...
>   help documentation and the privacy statement at
>   [https://aka.ms/privac](https://aka.ms/privacy)y. Your use of the software
...
**5. LEGAL COMPLIANCE.** You represent and warrant that (a) you are not located
...
**11. PRODUCT CLAIMS AND INTELLECTUAL PROPERTY RIGHTS.** Microsoft, not Apple,
...
**14. LIMITATION ON AND EXCLUSION OF REMEDIES AND DAMAGES. IF YOU HAVE ANY BASIS
