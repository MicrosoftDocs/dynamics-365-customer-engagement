...
1.	On the Schedule grid for a task, click the resource icon in the resource cell.
 ...
 > [!div class="mx-imgBorder"] > ![Screenshot of assigning resources to a task on Schedule grid](media/FAQ-Resources-to-Tasks-1.png)

2.	Type a name to serve as the placeholder resource’s name, for example “Program Manager.”

> [!div class="mx-imgBorder"] > ![Screenshot of adding a placeholder resource's name](media/FAQ-Resources-to-Tasks-2.png)
 
3.	Click Create.

4.	On the Quick Create Project Team Member field to the right of the screen, set the role for the generic resource.

> [!div class="mx-imgBorder"] > ![Screenshot of Quick Create Project Team Member field](media/FAQ-Resources-to-Tasks-3.png)
...
> [!div class="mx-imgBorder"] > ![Screenshot of resource selector](media/FAQ-Resources-to-Tasks-4.png)
...
> [!div class="mx-imgBorder"] > ![Screenshot of generating resource requirement](media/FAQ-Resources-to-Tasks-5.png)
...
> [!div class="mx-imgBorder"] > ![Screenshot of booking generic resource](media/FAQ-Resources-to-Tasks-6.png)
...
> [!div class="mx-imgBorder"] > ![Screenshot of fulfilling generic resource requirement](media/FAQ-Resources-to-Tasks-7.png)
...
> [!div class="mx-imgBorder"] > ![Screenshot of adding a named resource](media/FAQ-Resources-to-Tasks-8.png)
