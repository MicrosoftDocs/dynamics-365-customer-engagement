...
description: This topic provides information about project management settings in Dynamics 365 Project Service Automation.
author: ruhercul
manager: kfend
...
Use the following settings to access the project planning features in Microsoft Dynamics 365 Project Service Automation (PSA).
