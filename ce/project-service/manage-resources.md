...
description: This topic provides information about how you can manage resources by using Microsoft Dynamics 365 Project Service Automation (PSA).
author: ruhercul
manager: kfend
...
Microsoft Dynamics 365 Project Service Automation (PSA) includes a resource manager dashboard that provides a visual overview of resource demand and utilization throughout the organization. You can use the charts on this dashboard to visualize the following information:
