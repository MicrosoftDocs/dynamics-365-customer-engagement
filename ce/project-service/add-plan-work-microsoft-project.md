...
1.  From the download center you can, download your the add-in for your supported version of Project Service, either  [V2.X](https://go.microsoft.com/fwlink/?linkid=828268) or [V3.4+](https://www.microsoft.com/en-us/download/details.aspx?id=57956).  
