...
This topic lists the features and fixes that are new or changed for Project Service Automation V3, Update Release 21. This version has a build number of V 3.10.32.40 and is generally available through a self-update in June 2020.
