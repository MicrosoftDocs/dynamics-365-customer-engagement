...
description: This topic provides information about how to create time entries in Microsoft Dynamics 365 Project Service Automation (PSA).
author: rumant
manager: kfend
...
In previous versions of Microsoft Dynamics 365 Project Service Automation (PSA), time entries were entered on a weekly basis. In version 3 and later of PSA, time entries are entered on a daily basis. However, after a few time entries have been created, you can bulk create or copy them.
