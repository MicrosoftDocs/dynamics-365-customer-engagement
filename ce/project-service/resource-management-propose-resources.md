...
description: This topic provides information about how to propose project resources in Dynamics 365 Project Service Automation (PSA).
author: ruhercul
manager: kfend
...
Because Microsoft Dynamics 365 Project Service Automation (PSA) uses the Universal Resource Scheduling engine, if you also have Microsoft Dynamics 365 Field Service installed, you can view the details of resource bookings for projects, work orders, and any other entities that you've extended scheduling to.
