...
description: This topic provides information about organizational units in Dynamics 365 Project Service Automation (PSA).
author: rumant
manager: kfend
...
In Microsoft Dynamics 365 Project Service Automation (PSA), an organizational unit is a distinct group or division in a professional services company that employs billable resources that have cost rates.
