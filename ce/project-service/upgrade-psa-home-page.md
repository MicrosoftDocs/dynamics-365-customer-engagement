...
1. Access the Dynamics Insider Portal here, http://experience.dynamics.com/insider and sign in with your Insider credentials.
...
6. Microsoft will receive the details that you provide and will, within a few days, enable the install or upgrade of the latest versions of Field and Project Service on the instance that you provided. After the install or upgrade is enabled, you will receive a confirmation email from Microsoft.
...
To ensure a successful install experience, make sure that the identified instance meets all the prerequisites listed on the **Insider Program** page.
