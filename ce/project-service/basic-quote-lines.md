...
description: This topic provides information about quotes and quote lines in Dynamics 365 Project Service Automation (PSA).
author: rumant
manager: kfend
...
In Microsoft Dynamics 365 Project Service Automation (PSA), there are two types of quotes: project quotes and sales quotes. The two types differ in the following ways:
