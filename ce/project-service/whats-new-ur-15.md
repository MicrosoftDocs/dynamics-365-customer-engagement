...
- Project Management
  ...
  - Fixed: The dropdown for **Use in Tracking View** does not expand based on the width of the options.
...
- Sales
  ...
  - Fixed: Code inside **PluginDomain.ExecuteInTryCatchBlock(..)** hides origin of the exception.
  - Fixed: Error when getting an error message in **Project lookup** in **Quote Line** form when more than 1000 projects.
  - Fixed: **Estimates** grid for labor estimates and expense estimates does not show the correct currency symbol.
  - Fixed: Org where PS upgraded from UR14 to UR15 - **Schedule** tab showing as blank on **Project** form.
