...
Please Note: Batch invoicing in PSA only runs for those Project Contract lines that Invoice Schedules configured. A PSA Project contract line with a Fixed Price Billing Method will need to have Milestones configured and a PSA Project contract line with a Time and Material Billing Method will need a date based invoice schedule setup. Instructions for setting up invoicing frequencies is explained here in the context of a project - based PSA quote line. The same applies to a project-based PSA contract line. 
https://docs.microsoft.com/en-us/dynamics365/project-service/basic-quote-lines#invoice-schedule     
