---
title: Estimates
description: This topic provides information about estimates for Dynamics 365 Project Service Automation (PSA). 
author: rumant
manager: kfend
...
On a project-based quote, you can use the Quote line detail entity in Microsoft Dynamics 365 Project Service Automation (PSA) to estimate the work that is required to deliver a project. You can then share that estimate with the customer.
