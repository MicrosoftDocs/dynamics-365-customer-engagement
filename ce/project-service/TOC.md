...
## [How to soft book resources](FAQ-soft-book.md)
## [How to use the utilization view](FAQ-utilization-view.md)
## [Allocation methods](FAQ-allocation-methods.md)
## [Book projects from the schedule board](FAQ-project-booking-schedule-board.md)
## [Assign resources to tasks](FAQ-assign-resources-to-tasks.md)
## [Book resources and assign tasks](FAQ-bookings-and-assignments.md)
## [Troubleshoot expense cost actuals](FAQ-zero-price-expense-cost-actuals.md)
## [Troubleshooting expense sales actuals](FAQ-zero-price-expense-sales-actuals.md)
## [Troubleshooting time cost actuals](FAQ-zero-price-time-cost-actuals.md)
## [Troubleshooting expense sales actuals](FAQ-zero-price-time-sales-actuals.md)

## FAQ for earlier versions (app version 2.x and 1.x)
### [Assign resources to tasks](FAQ-assign-resources-to-tasks-in-web-app.md)
### [How to soft book resources](FAQ-soft-book-in-web-app.md)
