...
#### [Steps 1-4: Create custom fields and entities in the Power Apps platform](PD-Common-steps.md)
#### [Steps 5-7: Add custom fields to price setup and transactional entities of Project Service](PD-field-references-PS.md)
#### [Step 8: Set up custom fields as pricing dimensions](PD-SetupPD.md)
#### [Step 9: Update plug-in attributes to include newly created pricing dimensions](PD-Using-PRT.md)
