...
This topic lists the features and fixes that are new or changed for PSA V3, Update Release 20. This version has a build number of V 3.10.31.23 and is generally available through a self-update in June 2020.
