...
description: This topic provides information about product-based quote lines in Dynamics 365 Project Service Automation (PSA).
author: rumant
manager: kfend
...
Microsoft Dynamics 365 Project Service Automation (PSA) uses the capabilities of the Microsoft Dynamics 365 product catalog to create product-based quote lines. Product-based quote lines can be "write-in" lines, or they can be items from the product catalog.
