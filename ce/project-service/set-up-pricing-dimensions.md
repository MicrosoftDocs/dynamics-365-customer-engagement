...
1. Created as a field in the Role Price AND Role Price markup entities (as shown in [Add custom fields to price setup and transactional entities](field-references.md)
