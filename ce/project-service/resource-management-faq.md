...
**User** and **Contact** are the resource types that Microsoft Dynamics 365 Project Service Automation (PSA) supports. Although you can create other types of resources (for example, **Equipment** and **Group**), no end-to-end use case is supported for them in PSA.
