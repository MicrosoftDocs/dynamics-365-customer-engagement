...
description: This topic provides information about the solution changes for Time and Expense in Microsoft Dynamics 365 Project Service Automation 3.x.
author: makk
manager: kfend
ms.custom:
...
In Microsoft Dynamics 365 Project Service Automation (PSA) version 3.0, the Time and Expense views have been updated so that they take advantage of the new platform framework for custom controls.
