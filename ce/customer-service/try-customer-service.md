---  
title: "Get started with a free trial – Customer Service |MicrosoftDocs"
...
1. Go to the [Try Dynamics 365 Customer Service](https://dynamics.microsoft.com/get-started/free-trial/?appname=customerservice) and select the **Get started** button.
2. Follow the onscreen guidance to enter your email and contact information. The trial will take a few moments to set up, then you will be ready to start using Customer Service.
