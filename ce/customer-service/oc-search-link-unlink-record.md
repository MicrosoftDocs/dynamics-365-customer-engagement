...
2. In the search box, specify the record or attribute details based on your search requirements, and then select **Search** ![Relevance Search icon](media/oceh-oc-search-icon.png "Relevance Search icon").
