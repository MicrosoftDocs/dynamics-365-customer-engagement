...
**Custom experiences**: Some organizations might need highly customized experiences from a user endpoint perspective might be needed. For example, an organization that wants to create a highly customized app that embeds the Omnichannel for Customer Service messaging capabilities might need to go beyond the standard canvas approach.
