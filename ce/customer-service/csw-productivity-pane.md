...
You can use the arrow to set the mode of the productivity pane.

![Smart assist mode](media/csw-smart-assist-mode.png "View of the Smart assist mode where you can expand or collapse the pane")
