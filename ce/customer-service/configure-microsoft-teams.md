...
- An app is created and configured in **Teams** > **App Studio**. More information: [Build your first Teams app using C#](https://docs.microsoft.com/microsoftteams/platform/get-started/get-started-dotnet-app-studio?tabs=AS).
