...
> [!NOTE]
> If there is an active layer over msdynce_KnowledgeManagementFeatures for the knowledge article interactive experience form, you will not be able to view the quick form publish dialog. You must delete the active layer for package updates to take effect. More information: [Removed an unmanaged layer](/powerapps/maker/data-platform/solution-layers#remove-an-unmanaged-layer).
