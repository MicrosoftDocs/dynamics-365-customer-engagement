...
1. On the knowledge article form, select the **View suggested keywords and description (preview)** link.<!--note from editor: In the image, can you highlight the link with a red box? I think it would be helpful.-->
