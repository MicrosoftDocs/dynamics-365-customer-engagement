...
You can set up a search provider either on the Customer Service Hub or on the Customer Service admin center (preview) app. Depending on your app, perform the following steps:
