...
> [!NOTE]
> With the October'18 release, entitlement templates in service management are available in the Customer Service Hub based on the Unified Interface experience. We recommend that you create and manage entitlement templates using the new experience.
