...
- The Customer Service Hub app is available to use on a desktop browser and on a mobile device.  [!include[](../includes/proc-more-information.md)] [User guide for Customer Service Hub](user-guide-customer-service-hub.md)
