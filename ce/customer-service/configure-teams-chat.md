...
1. Under **Collaboration**, select **Embedded chat using Teams**.

1. Toggle **Turn on Microsoft Teams chats inside Dynamics 365 (preview)** and **Use record title as the default chat name for linked chats** to **Yes**.
