...
This installation lets end users do the following tasks:
   -	Browse, search, filter, and sort idea lists
   -	Post new ideas
   -	Autosuggest existing ideas to prevent duplicates
   ...
   -	Moderate capabilities, like viewing and hiding flagged content
