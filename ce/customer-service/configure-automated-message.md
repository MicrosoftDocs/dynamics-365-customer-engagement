...
|-----------------|------------|-----------------|
| Greeting Message for Async Channels and Voice | The automated message played for the customer as soon as the call connects <br>**Note**<br> If the bot is enabled, ensure that automated greeting message and the bot message are different. | You can set it up to be played as the first message that the customer should hear when they call the digital contact center. |
