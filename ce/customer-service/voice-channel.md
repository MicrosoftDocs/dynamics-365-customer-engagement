...
> [!VIDEO https://www.microsoft.com/en-us/videoplayer/embed/RE4G43k]

## Why choose the voice channel

### Native

The voice channel is built, owned, and operated completely by Microsoft. This means it is an all-in-one customer service solution without fragmentation or manual data integration, and a faster time to value by enabling a quick and easy deployment of a voice channel for your business. In addition, the voice channel is built on Microsoft Azure Communication Services with the scalability and reliability of the calling platform that powers Microsoft Teams worldwide today.
...
Agents receive incoming voice calls the same way they receive other customer requests from channels like SMS and social channels.
