...
For information on timeline record configuration, [Configure activity record types](customer-service-hub-user-guide-timeline-admin#configure-activity-record-types.md). 
