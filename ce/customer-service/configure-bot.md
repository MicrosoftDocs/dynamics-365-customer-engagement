...
For more information about configuring your Azure bot to enable calling and SMS services, see [Configure Azure bots for voice](voice-channel-azure-bot-service.md).
