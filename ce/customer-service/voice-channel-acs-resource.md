...
> - While the system allows multiple instances of Omnichannel for Customer Service to connect with one Azure Communication Services resource, we recommend that you must map only one Omnichannel for Customer Service instance to one Azure Communication Services resource for trouble-free and optimal performance.
