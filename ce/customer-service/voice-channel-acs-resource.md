...
description: "Get an overview about connecting to Azure Communication Services. The topic also includes procedures to sync from Azure and disconnect from Azure Communication Services."
ms.date: 03/10/2022
