...
| Updates to routed record | Number of actions per minute like resolve a case, queue transfer, agent transfer, queue item delete that can be done for routed records. | 25 updates per minute. | Yes. |
