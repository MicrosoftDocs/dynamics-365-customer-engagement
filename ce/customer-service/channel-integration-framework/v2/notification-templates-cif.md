...
To create or manage a notification template, go to the app profile manager. For more information, see [Manage notification templates](../app-profile-manager/notification-templates.md#manage-templates) in the app profile manager documentation.
