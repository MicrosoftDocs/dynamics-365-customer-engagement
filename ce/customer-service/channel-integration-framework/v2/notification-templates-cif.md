...
4.	Specify the following on the **New Notification Template** page.
    ...
    | General | Auto-assign work items | Set to **Yes** to automatically assign the incoming conversation. | The default value is **No**. <br> **Note:**<br><ul><li> This setting is in preview. </li><li>Use the auto-assign setting only if you have the related routing and assignment logic configured.</li></ul> |
