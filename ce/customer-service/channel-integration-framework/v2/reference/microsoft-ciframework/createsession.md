...
Creates a new session based on the session template name and returns the unique identifier of the session that was created. This method supports session templates of the type **Generic**.  
