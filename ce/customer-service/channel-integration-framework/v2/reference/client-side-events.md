...
| [onPresenceChange​](reference/events/onPresenceChange​.md) | Invoked when the presence or availability state of the agent has changed either manually or programmatically. |
