...
To create or manage an application tab template, go to the app profile manager. For more information, see [Create an application tab template](../../../app-profile-manager/application-tab-templates.md#create-an-application-tab-template) in the app profile manager documentation.
