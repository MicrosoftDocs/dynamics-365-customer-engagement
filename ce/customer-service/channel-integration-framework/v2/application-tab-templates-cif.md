...
To create or manage an application tab template, go to the app profile manager. For more information, see [Manage application tab templates](../app-profile-manager/application-tab-templates.md) in the app profile manager documentation.
