...
The application type is used to display entity view that defines how a list of records for a specific entity is displayed in the model-driven app. The parameters available for the entity view application type are as follows: 
