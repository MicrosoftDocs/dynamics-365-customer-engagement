...
2. Enter the following details:
   ...
   3. On the **Callback information** page, copy the values in the **IP allowlist** and **Server address (URL)** boxes. You'll update the copied information in the WeChat account.
