...
keywords: Knowledge base forms; Customer service; Interactive service hub; Customer Service Hub; Dynamics 365
author: anjgupta
ms.author: anjgup
manager: sakudes
ms.date: 09/15/2017
...
---
# Add the Knowledge Base Search control to forms (Customer Service)
    ...
    2.  In the **Filter Data** section:  
        ...
        1.  In the **Filter search results by** drop-down list, select the set of article states that you want [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] to search in.  
            ...
            -   If you’re using the [!INCLUDE[pn_parature](../includes/pn-parature.md)] knowledgebase, you can choose from all articles, all draft articles, or all published articles.  
               ...
               > [!IMPORTANT]
               > Usage of [!INCLUDE[pn_parature](../includes/pn-parature.md)] knowledgebase as the knowledge base solution for [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] has been deprecated. For more information, see [Important changes coming](https://docs.microsoft.com/en-us/dynamics365/get-started/whats-new/customer-engagement/important-changes-coming)
        ...
        3.  If you want users to see search results only for articles in a specific language, in the **Set Default Language** drop-down list, select a default language.  
            ...
            > [!NOTE]
            >  This option is available only when you're using the native [!INCLUDE[pn_dynamics_crm](../includes/pn-dynamics-crm.md)] knowledge management solution.  
...
## Add the search control to a reference panel in an interactive form  
 You can add the Knowledge Base search control to any section of the Main - Interactive experience form. Main - Interactive experience forms are used in the Customer Service hub.  The Knowledge Base Search control is already added by default to the reference panel of the Case form of type Main - Interactive experience. When you add the Knowledge Base Search control to a reference panel, it appears as a vertical tab at runtime.  
  
> [!IMPORTANT]
>  The Customer Service hub does not support [!INCLUDE[pn_parature](../includes/pn-parature.md)] knowledge base, so make sure to choose the native [!INCLUDE[pn_crm_shortest](../includes/pn-crm-shortest.md)] knowledge solution so users can search for records in the Customer Service hub. 
 ...
 ![Set properties for Knowledge Base Search control](../admin/media/set-kb-control-properties.png "Set properties for Knowledge Base Search control")  
    ...
    3.  In the **Additional Options** section:  
        ...
        6.  In the **Actions** drop-down list, select whether you want to make all default actions available to CSRs or only selected ones. If you choose **Show Selected Actions**, select the actions you would like to show.  
            ...
            > [!NOTE]
            >  Although, the Pop out option is available for selection in the drop-down list, it isn’t supported at runtime in the Customer Service hub.  
