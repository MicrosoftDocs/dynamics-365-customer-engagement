...
|---------|---------|
|Reference name     |**Required**: The unique name for the tab that's used when referencing it in scripts. The name must follow these rules:<ul><li>Can't be left empty</li><li>Must be a unique name</li><li>Must start with a letter only</li><li>Must contain only alphanumeric characters and underscores</li><li>Can't be greater than 100 characters</li></ul> |
|Label        |**Required**: The localizable label for the tab visible to users. The label must follow these rules:<ul><li>Can't be left empty</li><li>Must be a unique name</li><li>Must start with a letter only</li><li>Must contain only alphanumeric characters and underscores</li><li>Can't be greater than 100 characters</li></ul> |
...
4. In the solution explorer, choose the entity you want to add the search control to, and under **Communication & Collaboration**, make sure the **Knowledge Management** check box is selected.  
   ...
   Selectthe  **Save** icon to save the setting for the entity.
