...
4.	Select the entity name, select the **Forms** tab, and then open the form where you want to add the knowledge control. Click **+Component** to add a new component, select **Related Data**, and then **Knowledge Search**. To add the control, create a section and then add a knowledge search control within it.
