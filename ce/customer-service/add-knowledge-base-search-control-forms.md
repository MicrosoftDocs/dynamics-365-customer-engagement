...
4.	Select the entity name, select the **Forms** tab, and then open the form where you want to add the knowledge control. To find the knowledge search control that you want to add, go to **Component**, then **Related Data**, then **Knowledge Search**. To add the control, create a section and then add a knowledge search control within it.
