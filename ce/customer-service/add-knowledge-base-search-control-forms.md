...
1. Sign in to the Dynamics 365 application and select **Settings** > **Advanced Settings**.

2. Select **Customizations** from the drop-down, and then select **Customize the System**.
