...
You can call a customer by using the phone dialer on the Active Conversation(formerly Customer Summary) page or the **Launch dialer** button on the menu. More information: [Call a customer](voice-channel-call-customer.md)
