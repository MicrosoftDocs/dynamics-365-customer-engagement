...
> [!NOTE]
> You can create SLAs only in the environments that have customer engagement apps, such as Customer Service and Sales Hub as SLA is available as a default solution in these apps.
