...
Enable the enhanced **Quick case form** and **Full case form**  options, if you want your agents to see the enhanced quick case form and full case form, while creating a new case in the Customer Service workspace."
...
> [!NOTE]
> If the enhanced case forms have a higher form order than the default case form, agents might see the enhanced case forms even when you haven't enabled the enhanced case experience. If you'd like agents to see the default experience, set the form order of the enhanced form lower than that of the default form. More information: [Set the form order](/power-apps/maker/model-driven-apps/control-access-forms#set-the-form-order)
