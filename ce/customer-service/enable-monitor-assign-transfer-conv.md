...
2. To enable the supervisors to perform the following actions, set the corresponding toggles to **Yes**:
    ...
    - **Force Close**: End conversations that take place on messaging and voice channels. More information: [Monitor, assign, transfer, and forcibly end conversations](monitor-conversations.md#end-conversations-forcibly)
