...
To access this dashboard, your organization admin must first enable it. For more information, see [Configure Knowledge search insights](enable-knowledge-search-analytics.md).
