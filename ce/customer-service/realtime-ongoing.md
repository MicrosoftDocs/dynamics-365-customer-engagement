...
| Handle time |  Time the agent spent actively with a customer across all channels. This includes hold time (if applicable), wrap time (if applicable), talk time (if applicable), and active time. |
