...
If you can't view the reports, contact your system administrator. For more information, go to [View the Omnichannel real-time analytics reports on customized Customer Service workspace](enable-realtime-analytics-dashboard-administrator.md#view-the-omnichannel-real-time-analytics-reports-on-customized-customer-service-workspace)
