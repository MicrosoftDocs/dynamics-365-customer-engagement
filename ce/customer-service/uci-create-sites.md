...
description: How to use sites to manage your service locations in Dynamics 365 Customer Service.
ms.date: 04/04/2022
ms.topic: article
author: lalexms
ms.author: laalexan
...
You can also create a site in Dynamics 365 Customer Engagement (on-premises) 9.1 also. More information: [New features in Dynamics 365 Customer Engagement (on-premises)](../customerengagement/on-premises/whats-new?view=op-9-1#support-for-site-entity-in-unified-interface)
