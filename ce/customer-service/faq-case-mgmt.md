...
Responsible Contact Id is a deprecated field. With the recent platform enhancements, deprecated attributes will no longer be  populated when a form loads in a new tab. More information: [ResponsibleContactId lookup attribute is deprecated](deprecations-customer-service.md#eresponsiblecontactid-lookup-attribute-is-deprecated)