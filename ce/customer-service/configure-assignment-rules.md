...
> [!NOTE]
> The **Available capacity** attribute that's listed in the condition refers to unit-based capacity. If you want to define a condition on available capacity of users, then use the **Available capacity** attribute only as suggested in the example. Use the "is greater than" operator to ensure that available capacity is more than the required capacity.
