...
> [!NOTE]
> To be able to use markdown in your custom messaging channels, your administrator must enable the markdown settings under **Agent experience** the Omnichannel admin center. More information: [Enable formatted messages](asynchronous-channels.md#enable-formatted-messages)
