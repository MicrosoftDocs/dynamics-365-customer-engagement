...
Depending on the settings enabled for you, you'll see the **Enhanced Active Conversation - Recent Case**  or **Default Active Conversation - Recent Case**, that are explained as follows:
   ...
   > [!NOTE]
   > Even if the **Enhanced Active conversation form** is enabled, you’ll see the default Recent cases layout if your administrator has set the **Disable the recent cases control for Open conversation** option to **Yes** in Power Apps.
