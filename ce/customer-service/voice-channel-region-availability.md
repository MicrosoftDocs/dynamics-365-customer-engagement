...
- The purchase of numbers (preview) in United Kingdom and Denmark. You can purchase the United Kingdom and Denmark numbers only if you have a billing address in the respective country. After you purchase the numbers through the Azure portal, you can sync with Omnichannel for Customer Service through the [sync option](voice-channel-acs-resource.md#sync-from-azure).
