...
| Block size per assignment cycle | Maximum number of unassigned conversations or work items picked per assignment cycle per queue | <ul><li> 100 digital messaging or voice conversations<sup>5</sup></li><li>10,000 records-related work items prioritized and assigned in batches of 500 with a block size 2,000. </li></ul>   |  Yes. |
