...
Copilot is available in Customer Service workspace, Customer Service Hub, Omnichannel for Customer Service, and [custom apps](../administer/copilot-powerapps-settings.md).
