...
> [!NOTE]
> Verify your administrator has allowed users in your organization to have read/write data permissions in Omnichannel Engagement Hub. To learn more, see [Set up Omnichannel for Customer Service](../administer/omnichannel-provision-license.md#set-up-omnichannel-for-customer-service-).  
