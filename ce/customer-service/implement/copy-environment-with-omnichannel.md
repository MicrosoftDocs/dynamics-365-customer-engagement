...
- **Minimal copy**. Only schemas and customizations are copied. The source data isn't copied. You can create the channels and workstreams in the target environment, and no corrections are needed.
