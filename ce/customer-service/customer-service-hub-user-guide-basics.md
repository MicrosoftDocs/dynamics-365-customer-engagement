...
>
> If you add more than one field with real text editor, clicking **Knowledge Base Search** will always insert the knowledge article into the first field in the form by default.
