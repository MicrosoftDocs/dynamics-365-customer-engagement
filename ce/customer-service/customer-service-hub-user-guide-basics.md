...
>
> If you add more than one field with rich text editor and then select **Insert Knowledge Article**, the knowledge article gets inserted into the first field in the form by default.
