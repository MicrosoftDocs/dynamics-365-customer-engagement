...
If the search results in more than one account, contact, or case, the record isn't linked to the conversation. More information: [View Active Conversation for an incoming engagement request](oc-view-customer-summary-incoming-conversation-request.md)
