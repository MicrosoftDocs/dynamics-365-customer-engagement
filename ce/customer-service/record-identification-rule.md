...
> [!NOTE]
> The record search identifies records that have an active status code for contacts or accounts; if you use custom status code, the record identification won't work.
