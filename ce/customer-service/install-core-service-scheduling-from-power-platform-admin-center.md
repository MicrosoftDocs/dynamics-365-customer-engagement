---
title: Install Core Service Scheduling from the Power Platform admin center (Dynamics 365 Customer Service) | MicrosoftDocs
...
# Install Core Service Scheduling from the Power Platform admin center
