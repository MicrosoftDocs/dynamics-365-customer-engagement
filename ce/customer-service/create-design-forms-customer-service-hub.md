...
You can see the forms for each entity in their list of forms in the solution explorer in the **Customization** area. You can identify the form by the form type and display name. For example, the form type for Case and Case for Interactive experience is **Main** . 
...
|**Card Form**|These forms are used in the interactive dashboards to show the entity data in the streams of interactive dashboards. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)][Create and edit card forms](../customize/create-edit-quick-create-forms.md) 
