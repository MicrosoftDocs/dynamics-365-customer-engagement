...
1. Set the **Setting environment value** option to **No**. In the **Setting app value** section, the Customer Service Hub and Customer Service workspace apps are displayed.
