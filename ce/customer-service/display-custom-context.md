...
To display the context variables in the [Conversation Summary Control of conversations](oc-customer-summary.md#view-conversation-summary) for Copilot Studio and Azure bots, use the `isDisplayable` property in the body of [setContextProvider](developer/reference/methods/setContextProvider.md) method.
