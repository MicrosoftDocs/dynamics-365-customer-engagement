...
2. As a Power BI admin, open the link: [https://aka.ms/cs-insights](https://aka.ms/cs-insights)
...
### Step 3: Connect Dynamics 365 organization to Customer Service Analytics app
 ...
 1. On the Dynamics 365 Customer Service Analytics app configuration options page, select **Connect**. 
...
5. Enter your Dynamics 365 organization credentials and select **Enter**. 
...
<!--from editor: Subhed says add users "to" the configuration, but the next sentence says add users "in" the configuration. Which way should it be? -->
