...
# Create bookmarks to save personalized view of reports
...
1. In Customer Service workspace or Omnichannel for Customer Service, select the plus sign (+) and then select **Customer Service historical analytics** or **Omnichannel historical analytics**.
...
1. To modify a bookmark view, select the bookmark, modify the filters to your requirement, and then select **Update bookmark** in the **Bookmarks** dropdown list.
