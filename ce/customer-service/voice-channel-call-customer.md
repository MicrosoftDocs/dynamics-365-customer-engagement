...
To be able to call customers, your administrator must configure outbound calling and set up outbound profiles. For more information, see [Outbound calling](voice-channel-outbound-calling.md).

## Call a customer

You can call customers on their contact numbers via the Omnichannel Agent dashboard.
