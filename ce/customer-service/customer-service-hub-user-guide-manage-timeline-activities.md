...
## See and manage related records in the Related section  
 The **Related** section (also known as Reference panel) in a case record provides you with quick access to important information related to the selected case that would help you resolve the case. For more information, see [Related section](implement/customer-service-hub-user-guide-basics.md#related-section).
...
Search for relevant knowledge articles to quickly resolve a case. For more information, see [Search for knowledge articles in the Customer Service Hub](use/search-knowledge-articles-csh.md).
