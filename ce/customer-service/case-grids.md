...
|Subject   | Shows the subject associated with the case. You can edit this column by double-clicking it. All the available options that can be selected are listed. A hierarchical view isn't supported. Sorting and filtering are supported. | The subject associated with the case appears as a text. |
