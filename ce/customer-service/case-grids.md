...
|Subject   | Shows the subject associated with the case. You can edit the Subject column by double-clicking it. All the available options you can select are listed. A hierarchical view isn't available. You can sort and filter the data. | The subject associated with the case appears as a text. |
