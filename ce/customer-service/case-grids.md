...
The following table explains the enhancements that you find in the **Enhanced Active Cases** view columns, when the **Power Apps grid control** is enabled, compared with other grids, such as the **Read Only Grid**.
