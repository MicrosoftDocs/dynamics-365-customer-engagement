...
> [!NOTE]
> Enabling the **Enhanced Active Cases** view would alter the **modifiedon** and **modifiedby** fields on the case entity. It is recommended to avoid using these fields for reporting.
