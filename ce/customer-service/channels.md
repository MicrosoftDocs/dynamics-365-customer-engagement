...
If you want to help your customers using your Line of Business (in-house) messaging channels, you can use the [Direct Line](bring-your-own-channel.md) Bot Framework method.
