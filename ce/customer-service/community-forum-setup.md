...
14.	(Skip this step if your forum is public.) If your forum is private, i.e. accessible to "by-invitation" members only, you'll need to add those individuals as contacts. Select **+ New Forum Member**, select **Member** in **Role**, then search for existing contact in **Contact** or add a new contact information in **Contact Email**, **Contact First Name**, and **Contact Last Name**. Repeat this step to add all by-invitation members.
