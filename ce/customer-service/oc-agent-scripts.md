...
For example, if the administrator has configured in the Active Conversation (formerly Customer Summary), then you can view the agent script in the Active Conversation form.
