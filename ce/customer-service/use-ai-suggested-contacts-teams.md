...
1. Select **New connected chat**. The following options appear:
   ...
   - If the AI-suggested contacts functionality is enabled, a **Resolved similar cases** section is displayed in the dropdown list.
        ...
        > - If the administrator hasn't enabled **Join chat** feature, a message is displayed that only chat participants can see this conversation. See: [Configure the ability for users to join chats](configure-teams-chat.md#configure-the-ability-for-users-to-join-chats)
