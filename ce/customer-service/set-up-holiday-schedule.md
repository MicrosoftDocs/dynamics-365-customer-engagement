...
> [!NOTE]
> With the October'18 release, holiday schedule in service management is available in the Customer Service Hub based on Unified Interface experience. We recommend that you create and manage holiday schedules using the new experience.
