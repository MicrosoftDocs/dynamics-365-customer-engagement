...
- Ensure that the Channel URL field in Dynamics 365 Channel Integration Framework 2.0 points to the correct URL. More information: [Configure a third-party channel provider](configure-channel-provider.md#configure-a-third-party-channel-provider)
