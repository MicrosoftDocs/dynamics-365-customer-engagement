...
This is an intended functionality. Business hours are defined by your organization while scheduling working days and holidays. SLA warning and failure time adhere to those settings and is calculated based on the defined hours.
