...
- If you're a bot author or developer, you must download the latest middleware NuGet package. More information: [Enable bot context NuGet package](#enable-bot-context.md#install-the-bot-sdk-in-your-project) 
