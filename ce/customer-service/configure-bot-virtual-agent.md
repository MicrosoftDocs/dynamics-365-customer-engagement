...
- Product licenses - Omnichannel for Customer Service includes the license for Power Virtual Agents. More information, see [Dynamics 365 Licensing Guide (PDF)](https://go.microsoft.com/fwlink/p/?LinkId=866544). To get Omnichannel trial, see [Try channels in Omnichannel for Customer Service](try-channels.md).
