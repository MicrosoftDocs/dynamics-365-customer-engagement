---
title: Set the capacity required for a service or resource in Dynamics 365 Customer Service)
...
# Set the capacity for a service or resource in Customer Service
...
8.  In the **Weekly Schedule** dialog box, click the work hours link for the schedule you want to edit.  
     ...
     If working hours have not been set previously, the link is displayed as "Set Working Hours." You must set up a schedule for a user, facility, or equipment before you can continue. More information: [Set work hours for a resource](../use/set-work-hours-resource.md)  
