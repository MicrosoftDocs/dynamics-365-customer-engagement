...
|----------|------------------|-----------------|
| **Incoming customer email** | 1. A case is created and is routed to the AI mailbox.<br>2. The case resolution process is triggered. Based on the email content, the AI agent follows one of the following paths:<br>   • Can't identify customer's intent<br>   • Identifies case intent, but requires additional information<br>   • Identifies the case intent and determines that the information is sufficient to resolve the case. | 1. A case is created and is routed to the service representative's mailbox.<br>2. The case resolution process is triggered. Based on the email content, the AI agent follows one of the following paths:<br>   • Can't identify customer's intent<br>   • Identifies case intent, but requires additional information<br>   • Identifies the case intent and determines that the information is sufficient to resolve the case. |
