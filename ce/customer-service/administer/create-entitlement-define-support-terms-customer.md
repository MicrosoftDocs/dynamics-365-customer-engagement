...
> [!NOTE]
> With the latest release of Dynamics 365 Customer Service app, entitlements available in the Customer Service admin center. We recommend that you create and manage entitlements using the new experience.
