...
- TCreate the agent in the Dynamics 365 Contact Center admin center and then navigate to Copilot Studio to finish the configuration. Learn more at [add a agent](/dynamics365/customer-service/administer/manage-your-agents?context=/dynamics365/contact-center/context/administer-context).
