...
- Choose the rules in the web client that need to be migrated.
...
The following updates or edits to a rule or item made in the web client aren't considered if:
  ...
  - The rule is edited in the web client after it is successfully migrated to Unified Interface. For the edits to be visible in Unified Interface, you must delete the successfully migrated rule or item in Unified Interface and migrate it again from the web client.
