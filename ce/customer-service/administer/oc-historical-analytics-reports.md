...
1. Switch the **Enable Omnichannel historical analytics report** toggle to **On** to enable the reports or set the toggle to **No** to disable the reports.
...
The metrics are available in the dashboard after 24 hours of enabling it. In the Omnichannel historical analytics report, use the dashboard filter to go to the **Voicemail** dashboard.
...
In the Omnichannel historical analytics report, use the dashboard filter to go to the **Proactive Outbound** dashboard. 
