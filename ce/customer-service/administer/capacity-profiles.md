...
> - An agent's available capacity can be negative if the agent manually picks a work item or is force assigned a conversation that exceeds the available capacity. This is applicable for both capacity profiles and unit-based capacity.
