---
title: Uninstall solutions
description: Perform the steps mentioned in this article to remove solutions.
ms.date: 06/14/2024
ms.topic: how-to
author: neeranelli
ms.author: nenellim
...
When you turn off channels in your organization, the omnichannel solution isn't removed. If you want to remove omnichannel solutions from your organization, you must use the same order as mentioned in the following table.

## Prerequisite

You must have [turned off the channels](omnichannel-provision-channels.md#turn-off-channels).
...
If your organization is using the **Customer Service Hub** app, then you must uninstall the app from the channel configuration in the **Channel Integration Framework** app.
