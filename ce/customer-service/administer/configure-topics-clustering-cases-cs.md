...
> [!NOTE]
> As of August 31, 2025, the legacy AI topic clustering for cases in Dynamics 365 Customer Service and Dynamics 365 Contact Center was deprecated and removed, and users are no longer able to use it in Dynamics 365 Customer Service and Dynamics 365 Contact Center.
...
> [!NOTE]
> While topic discovery isn't prevented and is still possible in languages that aren't listed, there might be a difference in the user experience for users who use topics in unsupported languages.
