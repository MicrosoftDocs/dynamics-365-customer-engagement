...
> [!NOTE]
> - For information about the languages supported by automated system messages for localization, see [International availability of Omnichannel for Customer Service](../implement/international-availability#language-availability.md).
