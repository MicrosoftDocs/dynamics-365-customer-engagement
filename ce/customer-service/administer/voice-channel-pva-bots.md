...
- Enable speech recognition using constrained grammar for alphanumeric strings like tracking and account numbers and list-based input like addresses and department names. Learn more in [Use external speech grammars](/microsoft-copilot-studio/voice-external-grammars).
