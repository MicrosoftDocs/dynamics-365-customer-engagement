...
| Voice-only variables **<sup>2</sup>**  | Activity.From.Name                        | Use this context variable for the customer's phone number in the Telephony activity. Assign this variable to a global variable in the **Conversation Start** topic. Learn more in [Configure context variables for Copilot Studio agent](#configure-context-variables-for-copilot-studio-agent).
