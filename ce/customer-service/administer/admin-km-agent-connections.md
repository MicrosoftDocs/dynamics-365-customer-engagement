...
Use the following steps to set up connection references for Customer Knowledge Management Agent. Use the same steps to configure connection references for other AI agents.
