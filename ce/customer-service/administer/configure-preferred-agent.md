...
You can add multiple preferred agents to contact records at a time using the [createRecord](/power-apps/developer/model-driven-apps/clientapi/reference/xrm-webapi/createrecord) call to update the preferred agent entities,  [Preferred Agent (msdyn_preferredagent)](../../developer/entities/msdyn_preferredagent.md) and [Preferred Agent Customer Identity (msdyn_preferredagentcustomeridentity)](../../developer/entities/msdyn_preferredagentcustomeridentity.md).
