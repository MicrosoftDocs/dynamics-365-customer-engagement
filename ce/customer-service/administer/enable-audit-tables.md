...
View administrative logs for Customer Service using auditing solutions in the Microsoft Purview compliance portal.
...
| Organization | Configure a search control for knowledge searches. |
...
| msdyn_datainsightsandanalyticsfeature, msdyn_occhannelconfiguration, msdyn_agentresourceforecasting | Forecast the agents needed for conversations. |
...
| msdyn_iotsettings | Set up settings for IoT. |
