...
|----------|------------|----------|------------|
| My work items | Shows all work items the agent can take action on. Actionable items can include assigned conversations, assigned cases, and emails with the agent listed in the **To**, **Cc**, or **Bcc** field, or listed as the owner, and voicemails assigned to the agent. | Case, Conversation<sup>1</sup>, Email, Voicemail<sup>1</sup> | Case:<br><ul><li>Work items assigned to me</li></ul>Conversation:<ul><li>Assigned</li></ul>Email:<ul><li>Emails assigned to me</li><li>Emails sent to me</li></ul>Voicemail:<ul><li>Assigned</li></ul> |
