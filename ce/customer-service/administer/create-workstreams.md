...
- **Block capacity for wrap up**: Select one of the options as follows. These settings are applicable to transfer scenarios also if [wrap up after transfer is enabled](enable-transfer-consult.md#enable-wrap-up-time-for-transfer).
