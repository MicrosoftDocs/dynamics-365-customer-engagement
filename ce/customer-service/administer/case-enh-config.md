...
>     - The enhanced case form displays [customer details](../use/oc-customer-summary.md#view-customer-details) and [recent cases](../use/oc-customer-summary.md#view-recent-cases) on the customer details pane. When you switch to any other form from the enhanced case form, the pane isn't automatically refreshed or closed. You will need to close it manually. 
