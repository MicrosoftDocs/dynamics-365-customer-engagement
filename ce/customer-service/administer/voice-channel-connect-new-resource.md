...
You need to specify the values of **Application (client) ID** and **Directory (tenant) ID** in Customer Service admin center. Perform the following steps to get these values:
...
1. Select the value of the **Application (client) ID** field, and then select the **Copy to clipboard** button. 

1. Select the value of the **Directory (tenant) ID** field, select the **Copy to clipboard** button.
...
1. Select **Get started**. The **Connect to Azure Communication Services** dialog opens. You can select **Create new resource** or **Use existing resource**.
   ...
   In the Manage Azure Communication Services page, specify the following values:
   ...
   **Azure configurations**  
   ...
   - Select **Tools** in **Keys**. On the **Keys**, copy **Connection string** in **Primary key**. You c which you  as the value of **Connection string** in Customer Service admin center. 
