...
1. Specify the following in the **New Notification** page.
    ...
    | General | Countdown (seconds) |Provide a duration in seconds; after this duration elapses, the notification disappears. | 120. <br><br> **Note:** <br> - This is the default value. You can change the duration as per your requirement. <br> - If the countdown setting is less than 5 seconds, the desktop notification does not appear.|
