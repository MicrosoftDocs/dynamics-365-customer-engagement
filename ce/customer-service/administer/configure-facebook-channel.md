...
1. Enter the following details:
   ...
   1. Select **Add**, and in the **Add Facebook Page** pane, enter the following details:
      ...
      - **Page ID:** ID of the Facebook page. To get the page ID, go to your Facebook page, select **Account** or your profile photo in the top-right corner, select **See all profiles**, and then select **See all pages** in the left-side menu. Select **Transparency and privacy** and the copy the value in the **Page ID** field.
