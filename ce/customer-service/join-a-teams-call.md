...
Join a Teams call is a new way for you to have effective conversations with your customers. During an active conversation, you can quickly move your call or chat to Microsoft Teams, where you can share your screen, connect on video, and co-browse to offer more personalized support to your customer. 

If you already have Teams, you don't need any additional investements to use Join a Teams call. Your customers don’t need a Teams license or previous experience using Teams.
...
2.	Next to the customer's name, select either of the following options:
    ...
    - Email icon: Auto-sends an email that contains a Teams meeting link to the email address in the customer record.

    After the link is sent, the productivity pane displays a confirmation message and prompt for you to join the meeting, along with a timestemp of the meeting duration.

3. Select **Join call**. The link opens in a browser window, where you're prompted to open the Teams app if it's installed or continue your conversation with the customer in the web browser. If you disconnect from the meeting during the scheduled time, you can rejoin it again using the same link in the productivity pane. When the end time passes, you can create a new link and reinvite the customer.
...
1. Do one of the following options:
   - Search for the customer record: On the active conversation page go to **Customer** > **Search for a customer** > type the name of the customer, and then select **Enter**. If the cusotmer has a record, it'll be displayed and then you can select it.
...
[Use Teams chat in Customer Service](use-teams-chat)
