...
To view ARC and/or SLAs rules that did not successfully complete migration, you can select **Incomplete** in the **Migration status** section. This displays a list of all rules that did not pass, including:  
