...
1. On the **Features** page, do the following:
   ...
   b. Select the **Number type**, whether **Toll-free** or **Geographic**. For more information, see [Number types and features](/azure/communication-services/concepts/telephony/plan-solution.md#azure-subscriptions-eligibility)
