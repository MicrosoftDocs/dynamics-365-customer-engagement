...
1. On the **Features** page, do the following:
   ...
   b. Select the **Number type**, whether **Toll-free** or **Geographic**. For more information, see [Number types and features](https://docs.microsoft.com/azure/communication-services/concepts/telephony/plan-solution#azure-subscriptions-eligibility)
