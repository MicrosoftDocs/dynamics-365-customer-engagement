...
So, after time calculation, the failure duration will be the day after the next day at 14:00 (2 PM). This is calculated by considering the remaining hours for the day are 5PM – 10AM = 7 hours, which leaves 5 hours for the next day (calculated as failure duration - hours consumed today). The next day doesn't get calculated as it's a holiday. So, the failure duration will be day after the next day: 9 AM + 5 hours= 14:00 (2 PM).
...
- Do a update on the Case to put it to a Paused state.
