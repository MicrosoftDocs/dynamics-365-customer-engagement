...
1. Follow the instructions in [Create a bot user](configure-bot#create-a-bot-user) to create a bot user.

2. Follow the instructions in [Add a bot user to the queues](configure-bot#add-a-bot-user-to-the-queues) to create three queues and add users as follows:
