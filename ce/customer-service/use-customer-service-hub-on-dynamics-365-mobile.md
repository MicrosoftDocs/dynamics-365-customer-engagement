...
description: Use Dynamics 365 Customer Service Hub app on mobile devices like phones and tablets
...
For more information on how to use the Dynamics 365 mobile app, see [Mobile Basics Guide](../mobile-app/dynamics-365-phones-tablets-users-guide.md).
