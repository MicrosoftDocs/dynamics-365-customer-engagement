...
# Omnichannel Metrics - Dimensions

The out-of-box Omnichannel historical and real-time analytics reports provides you with various metrics that you can use to view and analyze different activities within your contact center. This article describes the various other metrics in the data model that aren't directly exposed in the out-of-box reports.

Learn about the facts and dimensions of the metrics and understand how you can use the metrics to suit your needs. More information: [Understand out-of-the-box data model](customize-reports.md#understand-out-of-the-box-data-model)
...
## Dimensions
Here are the various dimensions that are provided for Omnichannel historical and real-time reports. For facts, go to: 
