...
An example for the IsDisplay variable is as follows:

"{\"isDisplayable\":\"true\"," +"\"Value\":\"context variable value as string\"}"

The "Value" mentioned in the example can be a string, number or a boolean.
