...
> [!NOTE]
> If secure settings aren't configured for external contacts, recording and transcription continue, if they are enabled through workstream settings, after consult or bridged transfer to external contacts.
