...
- **Hold**: Put the customer on hold; the customer hears the hold music. You can keep only one caller on hold at a time. If your administrator has enabled the **Allow automatic pause and resume when agents hole and un-hold the customer** option, the recording and transcription of the call are paused when you put the customer on hold and resume when you un-hold the customer. If the option is disabled, you must manually pause and resume the recording and transcription.
