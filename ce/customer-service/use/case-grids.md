...
To create a copy of the **Enhanced Active Cases** view and customize it to add a new column, complete the following steps:
...
1. Enter a new name for the view. This action saves it as a copy of the **Enhanced Active Cases** view.
...
1. Select the column, and then select **Close**. After you add a new column, it appears in the **Edit columns** dialog.
