...
Each time the out-of-the-box data model updates because of newer release versions, the data model that's deployed to the managed workspace also updates to ensure that your organization gets the latest updates, which include newer metrics, updates to logic of existing metrics, and bug fixes.  
