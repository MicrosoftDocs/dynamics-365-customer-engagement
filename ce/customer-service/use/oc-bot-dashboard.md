...
## [Copilot Studio bot dashboard](#tab/copilotstudiodashboard)
 ...
 | Conversations escalated | The total number of conversations that were escalated to a human agent or an external number. |
 | Bot escalation rate | The percentage of conversations that were escalated by a bot to a human agent.|
 | Avg. escalation time (min) | The average time, in minutes, that a customer interacts with a bot before the conversation is escalated to a human agent or an external number. | 
 | Conversations deflected| The total number of conversations that were resolved by the bot without having to escalate it to a human agent. |
 ...
 | Bot sessions escalated | The number of bot sessions that are escalated to a human agent or an external number.|
 | Escalated session rate | The percentage of total bot sessions that were escalated by the bot to a human agent or an external phone number within the specified time period.| 
 ...
 | Escalation rate | The percentage of engaged bot sessions that are escalated by the bot. An escalated session is an engaged session that is escalated to a human agent or an external phone number. | 
...
## [Dashboard for all bots ](#tab/allbots)
 ...
 | Bot escalation rate | The percentage of conversations that were escalated by a bot to a human agent or an external phone number. |
 | Bot escalation time (min) | The time in minutes for which a customer interacted with a bot before the conversation was escalated to a human agent or an external phone number. |
