...
- The agent is assigned the [Omnichannel agent or Omnichannel supervisor role](../implement/add-users-assign-roles.md). If custom roles are used, [persona mapping](../administer/role-persona-mapping.md) must be configured.
