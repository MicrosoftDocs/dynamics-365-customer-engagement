...
If your administrator has configured knowledge filter personalization settings, as a customer service representative, you can select the filters you want to use.
