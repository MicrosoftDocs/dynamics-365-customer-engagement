...
The **Agents insights** report consists of metrics from an agent’s standpoint. The report shows agent metrics across all channels or channel-wise agent performance. Supervisors can select the **All** tab to view agent performance across all channels, or select the **Live chat**, **Digital messaging**, or **Voice** tabs to view the agent performance for the corresponding channel.
...
**Need screenshot here for Agent dashboard**
...
**Need screenshot here for Agent details**
