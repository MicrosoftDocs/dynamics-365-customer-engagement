...
> For more information on adding timer control for Unified Interface SLA-enabled entites, see [Add a timer control for SLA-enabled entities](add-timer-control-case-form-track-time-against-sla.md#add-a-timer-control-for-sla-enabled-entities).
