...
manager: shujoshi
---
# Configure AI-generated conversation summary
...
The summary generation feature uses a natural language generation model,so that admins can enable the feature by setting the toggle without the need for extra model training.  the AI model generates summaries from full conversation transcripts with up to 7000 characters. If a transcript contains more than 7000 characters, the first 7,000 characters are considered from the beginning to generate the summary. The summary is generated based as follows:
