...
|msdyn_InsertTrainingRecords|<xref href="Microsoft.Dynamics.CRM.msdyn_InsertTrainingRecords?text=msdyn_InsertTrainingRecords Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
