...
|msdyn_GetCaseSuggestionsForConversation|<xref href="Microsoft.Dynamics.CRM.msdyn_GetCaseSuggestionsForConversation?text=msdyn_GetCaseSuggestionsForConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Crm.Sdk.OrganizationRequest> setting the required parameters for the message. |
