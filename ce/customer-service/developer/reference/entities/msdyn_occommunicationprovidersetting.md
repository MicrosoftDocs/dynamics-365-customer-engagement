...
|msdyn_TelephonyResourceDeprovisionAction|Microsoft.Dynamics.CRM.msdyn_TelephonyResourceDeprovisionAction|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|msdyn_TelephonyResourceProvisionAction|Microsoft.Dynamics.CRM.msdyn_TelephonyResourceProvisionAction| Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
