...
|msdyn_TelephonyVoiceChannelProvisionAction|<xref href="Microsoft.Dynamics.CRM.msdyn_TelephonyVoiceChannelProvisionAction?text=msdyn_TelephonyVoiceChannelProvisionAction Action" />|Type generated by CrmSvcUtil.exe or use `<xref:Microsoft.Xrm.Sdk.OrganizationRequest>` setting the required parameters for the message. |
