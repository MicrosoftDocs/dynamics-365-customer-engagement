...
|`availableNextTime` |    DateTime      |    The time (UTC) until when the queue will be available next if queue is outside operating hours​.  |
|`availableUntilTime` |    DateTime      |    The time (UTC) until when the queue will be available.                       |
