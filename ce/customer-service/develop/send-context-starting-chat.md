...
> [!IMPORTANT]
>
> - For authenticated chat, you can also pass context in the JSON Web Token (JWT). More information: [Send authentication tokens](send-auth-token-starting-chat.md)
