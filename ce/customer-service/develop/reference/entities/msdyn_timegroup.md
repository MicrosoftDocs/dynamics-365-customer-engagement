---
title: "Fulfillment Preference (msdyn_timegroup) table/entity reference (Microsoft Dynamics 365 Customer Service)"
description: "Includes schema information and supported messages for the Fulfillment Preference (msdyn_timegroup) table/entity with Microsoft Dynamics 365 Customer Service."
...
Many-To-One Relationship: [phonecall msdyn_timegroup_PhoneCalls](phonecall.md#BKMK_msdyn_timegroup_PhoneCalls)
...
Many-To-One Relationship: [queueitem msdyn_timegroup_QueueItems](queueitem.md#BKMK_msdyn_timegroup_QueueItems)
