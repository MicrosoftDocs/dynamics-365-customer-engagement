---
title: "Channel instance secret (msdyn_channelinstancesecret) table/entity reference (Microsoft Dynamics 365 Customer Service)"
description: "Includes schema information and supported messages for the Channel instance secret (msdyn_channelinstancesecret) table/entity with Microsoft Dynamics 365 Customer Service."
...
# Channel instance secret (msdyn_channelinstancesecret) table/entity reference (Microsoft Dynamics 365 Customer Service)
...
One-To-Many Relationship: [businessunit business_unit_msdyn_channelinstancesecret](businessunit.md#BKMK_business_unit_msdyn_channelinstancesecret)
...
One-To-Many Relationship: [systemuser lk_msdyn_channelinstancesecret_createdby](systemuser.md#BKMK_lk_msdyn_channelinstancesecret_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_channelinstancesecret_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_channelinstancesecret_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_channelinstancesecret_modifiedby](systemuser.md#BKMK_lk_msdyn_channelinstancesecret_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_channelinstancesecret_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_channelinstancesecret_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_channelinstancesecret](owner.md#BKMK_owner_msdyn_channelinstancesecret)
...
One-To-Many Relationship: [team team_msdyn_channelinstancesecret](team.md#BKMK_team_msdyn_channelinstancesecret)
...
One-To-Many Relationship: [systemuser user_msdyn_channelinstancesecret](systemuser.md#BKMK_user_msdyn_channelinstancesecret)
...
- [msdyn_channelinstancesecret_SyncErrors](#BKMK_msdyn_channelinstancesecret_SyncErrors)
...
Many-To-One Relationship: [asyncoperation msdyn_channelinstancesecret_AsyncOperations](asyncoperation.md#BKMK_msdyn_channelinstancesecret_AsyncOperations)

|Property|Value|
|---|---|
|ReferencingEntity|`asyncoperation`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_AsyncOperations`|
|IsCustomizable|`True`|
...
Many-To-One Relationship: [bulkdeletefailure msdyn_channelinstancesecret_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_channelinstancesecret_BulkDeleteFailures)

|Property|Value|
|---|---|
|ReferencingEntity|`bulkdeletefailure`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_BulkDeleteFailures`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_channelinstancesecret_DuplicateBaseRecord"></a> msdyn_channelinstancesecret_DuplicateBaseRecord

Many-To-One Relationship: [duplicaterecord msdyn_channelinstancesecret_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_channelinstancesecret_DuplicateBaseRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`baserecordid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_DuplicateBaseRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_channelinstancesecret_DuplicateMatchingRecord"></a> msdyn_channelinstancesecret_DuplicateMatchingRecord

Many-To-One Relationship: [duplicaterecord msdyn_channelinstancesecret_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_channelinstancesecret_DuplicateMatchingRecord)

|Property|Value|
|---|---|
|ReferencingEntity|`duplicaterecord`|
|ReferencingAttribute|`duplicaterecordid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_DuplicateMatchingRecord`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_channelinstancesecret_MailboxTrackingFolders"></a> msdyn_channelinstancesecret_MailboxTrackingFolders

Many-To-One Relationship: [mailboxtrackingfolder msdyn_channelinstancesecret_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_channelinstancesecret_MailboxTrackingFolders)

|Property|Value|
|---|---|
|ReferencingEntity|`mailboxtrackingfolder`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_MailboxTrackingFolders`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_channelinstancesecret_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_channelinstancesecret_PrincipalObjectAttributeAccesses)

|Property|Value|
|---|---|
|ReferencingEntity|`principalobjectattributeaccess`|
|ReferencingAttribute|`objectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_PrincipalObjectAttributeAccesses`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_channelinstancesecret_ProcessSession"></a> msdyn_channelinstancesecret_ProcessSession

Many-To-One Relationship: [processsession msdyn_channelinstancesecret_ProcessSession](processsession.md#BKMK_msdyn_channelinstancesecret_ProcessSession)

|Property|Value|
|---|---|
|ReferencingEntity|`processsession`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_ProcessSession`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|

### <a name="BKMK_msdyn_channelinstancesecret_SyncErrors"></a> msdyn_channelinstancesecret_SyncErrors

Many-To-One Relationship: [syncerror msdyn_channelinstancesecret_SyncErrors](syncerror.md#BKMK_msdyn_channelinstancesecret_SyncErrors)

|Property|Value|
|---|---|
|ReferencingEntity|`syncerror`|
|ReferencingAttribute|`regardingobjectid`|
|ReferencedEntityNavigationPropertyName|`msdyn_channelinstancesecret_SyncErrors`|
|IsCustomizable|`True`|
|AssociatedMenuConfiguration|AvailableOffline: True<br />Behavior: `DoNotDisplay`<br />Group: `Details`<br />Label: <br />MenuId: null<br />Order: <br />QueryApi: null<br />ViewId: `00000000-0000-0000-0000-000000000000`|
