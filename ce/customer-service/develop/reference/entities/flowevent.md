...
> [!NOTE]
> The Microsoft Dynamics 365 Customer Service Flow Event (flowevent) table extends the [Microsoft Dataverse Flow Event (flowevent) table](/power-apps/developer/data-platform/reference/entities/flowevent).
