...
> [!NOTE]
> The Microsoft Dynamics 365 Customer Service Teams chat (chat) table extends the [Microsoft Dataverse Teams chat (chat) table](/power-apps/developer/data-platform/reference/entities/chat).
