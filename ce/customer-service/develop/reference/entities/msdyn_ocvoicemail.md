---
title: "Voicemail (msdyn_ocvoicemail) table/entity reference (Microsoft Dynamics 365 Customer Service)"
description: "Includes schema information and supported messages for the Voicemail (msdyn_ocvoicemail) table/entity with Microsoft Dynamics 365 Customer Service."
...
# Voicemail (msdyn_ocvoicemail) table/entity reference (Microsoft Dynamics 365 Customer Service)
...
| **DisplayCollectionName** | **Voicemails** |
...
- [msdyn_hascontent](#BKMK_msdyn_hascontent)
...
### <a name="BKMK_msdyn_hascontent"></a> msdyn_hascontent

|Property|Value|
|---|---|
|Description|**The voicemail has content**|
|DisplayName|**HasContent**|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|`msdyn_hascontent`|
|RequiredLevel|None|
|Type|Boolean|
|GlobalChoiceName|`msdyn_ocvoicemail_msdyn_hascontent`|
|DefaultValue|False|
|True Label|Yes|
|False Label|No|
