...
|msdyn_OverrideAgentCalendarWithShift|<xref href="Microsoft.Dynamics.CRM.msdyn_OverrideAgentCalendarWithShift?text=msdyn_OverrideAgentCalendarWithShift Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
