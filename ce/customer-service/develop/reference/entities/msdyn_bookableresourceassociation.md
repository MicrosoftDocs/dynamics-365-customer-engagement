---
title: "Bookable Resource Association (msdyn_bookableresourceassociation) table/entity reference (Microsoft Dynamics 365 Customer Service)"
description: "Includes schema information and supported messages for the Bookable Resource Association (msdyn_bookableresourceassociation) table/entity with Microsoft Dynamics 365 Customer Service."
ms.date: 08/26/2024
...
# Bookable Resource Association (msdyn_bookableresourceassociation) table/entity reference (Microsoft Dynamics 365 Customer Service)



## Messages

The following table lists the messages for the Bookable Resource Association (msdyn_bookableresourceassociation) table.
Messages represent operations that can be performed on the table. They may also be events.

| Name <br />Is Event? |Web API Operation |SDK for .NET |
| ---- | ----- |----- |
| `Assign`<br />Event: True |`PATCH` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `ownerid` property. |<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
| `Create`<br />Event: True |`POST` /msdyn_bookableresourceassociations<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api) |[Create records](/power-apps/developer/data-platform/org-service/entity-operations-create#basic-create)|
| `CreateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
| `Delete`<br />Event: True |`DELETE` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete) |[Delete records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-delete)|
| `DeleteMultiple`<br />Event: True | |[Learn to use messages with the SDK for .NET](/power-apps/developer/data-platform/org-service/use-messages)|
| `GrantAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.GrantAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.GrantAccessRequest>|
| `IsValidStateTransition`<br />Event: False |<xref:Microsoft.Dynamics.CRM.IsValidStateTransition?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.IsValidStateTransitionRequest>|
| `ModifyAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.ModifyAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.ModifyAccessRequest>|
| `Retrieve`<br />Event: True |`GET` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api) |[Retrieve records](/power-apps/developer/data-platform/org-service/entity-operations-retrieve)|
| `RetrieveMultiple`<br />Event: True |`GET` /msdyn_bookableresourceassociations<br />See [Query data](/power-apps/developer/data-platform/webapi/query-data-web-api) |[Query data](/power-apps/developer/data-platform/org-service/entity-operations-query-data)|
| `RetrievePrincipalAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrievePrincipalAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrievePrincipalAccessRequest>|
| `RetrieveSharedPrincipalsAndAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RetrieveSharedPrincipalsAndAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RetrieveSharedPrincipalsAndAccessRequest>|
| `RevokeAccess`<br />Event: True |<xref:Microsoft.Dynamics.CRM.RevokeAccess?displayProperty=nameWithType /> |<xref:Microsoft.Crm.Sdk.Messages.RevokeAccessRequest>|
| `SetState`<br />Event: True |`PATCH` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) the `statecode` and `statuscode` properties. |<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
| `Update`<br />Event: True |`PATCH` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) |[Update records](/power-apps/developer/data-platform/org-service/entity-operations-update-delete#basic-update)|
| `UpdateMultiple`<br />Event: True |<xref:Microsoft.Dynamics.CRM.UpdateMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpdateMultipleRequest>|
| `Upsert`<br />Event: False |`PATCH` /msdyn_bookableresourceassociations(*msdyn_bookableresourceassociationid*)<br />See [Upsert a table row](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#upsert-a-table-row) |<xref:Microsoft.Xrm.Sdk.Messages.UpsertRequest>|
| `UpsertMultiple`<br />Event: False |<xref:Microsoft.Dynamics.CRM.UpsertMultiple?displayProperty=nameWithType /> |<xref:Microsoft.Xrm.Sdk.Messages.UpsertMultipleRequest>|


## Events

The following table lists the events for the Bookable Resource Association (msdyn_bookableresourceassociation) table.
...
The following table lists selected properties for the Bookable Resource Association (msdyn_bookableresourceassociation) table.
...
|GlobalChoiceName|`msdyn_bookableresourceassociation_msdyn_type`|
...
|Type|State|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_bookableresourceassociation_statecode`|
...
|Type|Status|
|DefaultFormValue||
|GlobalChoiceName|`msdyn_bookableresourceassociation_statuscode`|
...
One-To-Many Relationship: [businessunit business_unit_msdyn_bookableresourceassociation](businessunit.md#BKMK_business_unit_msdyn_bookableresourceassociation)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookableresourceassociation_createdby](systemuser.md#BKMK_lk_msdyn_bookableresourceassociation_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookableresourceassociation_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_bookableresourceassociation_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookableresourceassociation_modifiedby](systemuser.md#BKMK_lk_msdyn_bookableresourceassociation_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_bookableresourceassociation_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_bookableresourceassociation_modifiedonbehalfby)
...
One-To-Many Relationship: [bookableresource msdyn_bookableresource_msdyn_bookableresourceassociation_Resource1](bookableresource.md#BKMK_msdyn_bookableresource_msdyn_bookableresourceassociation_Resource1)
...
|ReferencingEntityNavigationPropertyName|`msdyn_Resource1`|
|IsHierarchical||
...
One-To-Many Relationship: [bookableresource msdyn_bookableresource_msdyn_bookableresourceassociation_Resource2](bookableresource.md#BKMK_msdyn_bookableresource_msdyn_bookableresourceassociation_Resource2)
...
|ReferencingEntityNavigationPropertyName|`msdyn_Resource2`|
|IsHierarchical||
|CascadeConfiguration|Archive: `NoCascade`<br />Assign: `NoCascade`<br />Delete: `RemoveLink`<br />Merge: `NoCascade`<br />Reparent: `NoCascade`<br />RollupView: `NoCascade`<br />Share: `NoCascade`<br />Unshare: `NoCascade`|

### <a name="BKMK_owner_msdyn_bookableresourceassociation"></a> owner_msdyn_bookableresourceassociation

One-To-Many Relationship: [owner owner_msdyn_bookableresourceassociation](owner.md#BKMK_owner_msdyn_bookableresourceassociation)
...
One-To-Many Relationship: [team team_msdyn_bookableresourceassociation](team.md#BKMK_team_msdyn_bookableresourceassociation)
...
One-To-Many Relationship: [systemuser user_msdyn_bookableresourceassociation](systemuser.md#BKMK_user_msdyn_bookableresourceassociation)
...
Many-To-One Relationship: [asyncoperation msdyn_bookableresourceassociation_AsyncOperations](asyncoperation.md#BKMK_msdyn_bookableresourceassociation_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_bookableresourceassociation_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_bookableresourceassociation_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_bookableresourceassociation_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_bookableresourceassociation_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_bookableresourceassociation_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_bookableresourceassociation_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_bookableresourceassociation_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_bookableresourceassociation_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_bookableresourceassociation_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_bookableresourceassociation_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_bookableresourceassociation_ProcessSession](processsession.md#BKMK_msdyn_bookableresourceassociation_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_bookableresourceassociation_SyncErrors](syncerror.md#BKMK_msdyn_bookableresourceassociation_SyncErrors)
