...
|CCaaS_AcceptConversation|"Microsoft.Dynamics.CRM.CCaaS_AcceptConversation|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AgentEndConversation|Microsoft.Dynamics.CRM.CCaaS_AgentEndConversation|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AssignConversation|Microsoft.Dynamics.CRM.CCaaS_AssignConversation|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_CloseConsult| Microsoft.Dynamics.CRM.CCaaS_CloseConsult|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_ConversationTimeout|Microsoft.Dynamics.CRM.CCaaS_ConversationTimeout |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndSecondaryChannel|Microsoft.Dynamics.CRM.CCaaS_EndSecondaryChannel?text=CCaaS_EndSecondaryChannel|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndSession|Microsoft.Dynamics.CRM.CCaaS_EndSession?text=CCaaS_EndSession Action Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_ForceCloseConversation| Microsoft.Dynamics.CRM.CCaaS_ForceCloseConversation?text=CCaaS_ForceCloseConversation Action|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_GetAgentsForConsultAndTransfer| Microsoft.Dynamics.CRM.CCaaS_GetAgentsForConsultAndTransfer?text=CCaaS_GetAgentsForConsultAndTransfer Function|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_GetClientLWIContext| Microsoft.Dynamics.CRM.CCaaS_GetClientLWIContext?text=CCaaS_GetClientLWIContext Function |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentConsult| Microsoft.Dynamics.CRM.CCaaS_InitiateAgentConsult?text=CCaaS_InitiateAgentConsult Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentConsultExternal| Microsoft.Dynamics.CRM.CCaaS_InitiateAgentConsultExternal?text=CCaaS_InitiateAgentConsultExternal Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentTransfer| Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransfer?text=CCaaS_InitiateAgentTransfer Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentTransferBySupervisor| Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransferBySupervisor?text=CCaaS_InitiateAgentTransferBySupervisor Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentTransferExternal| Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransferExternal?text=CCaaS_InitiateAgentTransferExternal Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateQueueAssignment| Microsoft.Dynamics.CRM.CCaaS_InitiateQueueAssignment?text=CCaaS_InitiateQueueAssignment Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateQueueTransfer| Microsoft.Dynamics.CRM.CCaaS_InitiateQueueTransfer?text=CCaaS_InitiateQueueTransfer Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_JoinConversation| Microsoft.Dynamics.CRM.CCaaS_JoinConversation?text=CCaaS_JoinConversation Action |Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_LeavePublicConsult| Microsoft.Dynamics.CRM.CCaaS_LeavePublicConsult?text=CCaaS_LeavePublicConsult Action|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
