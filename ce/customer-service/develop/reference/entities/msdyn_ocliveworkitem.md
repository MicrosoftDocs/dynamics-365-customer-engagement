...
|CCaaS_GetClientLWIContext|<xref href="Microsoft.Dynamics.CRM.CCaaS_GetClientLWIContext?text=CCaaS_GetClientLWIContext Function" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
...
|CCaaS_InitiateAgentConsultExternal|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentConsultExternal?text=CCaaS_InitiateAgentConsultExternal Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
...
|CCaaS_InitiateAgentTransferExternal|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransferExternal?text=CCaaS_InitiateAgentTransferExternal Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
