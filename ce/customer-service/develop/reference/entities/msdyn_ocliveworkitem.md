...
|CCaaS_AcceptCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_AcceptCall?text=CCaaS_AcceptCall Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_AcceptConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AcceptConversation?text=CCaaS_AcceptConversation Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequestsetting the required parameters for the message. |
|CCaaS_AcceptPhoneCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_AcceptPhoneCall?text=CCaaS_AcceptPhoneCall Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_AgentEndConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AgentEndConversation?text=CCaaS_AgentEndConversation Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_AssignConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AssignConversation?text=CCaaS_AssignConversation Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_CloseConsult|<xref href="Microsoft.Dynamics.CRM.CCaaS_CloseConsult?text=CCaaS_CloseConsult Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_ConversationTimeout|<xref href="Microsoft.Dynamics.CRM.CCaaS_ConversationTimeout?text=CCaaS_ConversationTimeout Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_EndCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndCall?text=CCaaS_EndCall Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
