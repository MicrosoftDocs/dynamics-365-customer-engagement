...
|BulkRetain| Microsoft.Dynamics.CRM.BulkRetain?text=BulkRetain Action |<xref:Microsoft.Crm.Sdk.Messages.BulkRetainRequest>|
|CCaaS_AcceptCall| Microsoft.Dynamics.CRM.CCaaS_AcceptCall?text=CCaaS_AcceptCall Action|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AcceptConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AcceptConversation?text=CCaaS_AcceptConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AcceptPhoneCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_AcceptPhoneCall?text=CCaaS_AcceptPhoneCall Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AgentEndConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AgentEndConversation?text=CCaaS_AgentEndConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_AssignConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_AssignConversation?text=CCaaS_AssignConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_CloseConsult|<xref href="Microsoft.Dynamics.CRM.CCaaS_CloseConsult?text=CCaaS_CloseConsult Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_ConversationTimeout|<xref href="Microsoft.Dynamics.CRM.CCaaS_ConversationTimeout?text=CCaaS_ConversationTimeout Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndCall?text=CCaaS_EndCall Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndPhoneCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndPhoneCall?text=CCaaS_EndPhoneCall Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndSecondaryChannel|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndSecondaryChannel?text=CCaaS_EndSecondaryChannel Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_EndSession|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndSession?text=CCaaS_EndSession Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_ForceCloseConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_ForceCloseConversation?text=CCaaS_ForceCloseConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_GetAgentsForConsultAndTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_GetAgentsForConsultAndTransfer?text=CCaaS_GetAgentsForConsultAndTransfer Function" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_HoldCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_HoldCall?text=CCaaS_HoldCall Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentConsult|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentConsult?text=CCaaS_InitiateAgentConsult Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransfer?text=CCaaS_InitiateAgentTransfer Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateAgentTransferBySupervisor|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransferBySupervisor?text=CCaaS_InitiateAgentTransferBySupervisor Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateQueueAssignment|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateQueueAssignment?text=CCaaS_InitiateQueueAssignment Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateQueueTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateQueueTransfer?text=CCaaS_InitiateQueueTransfer Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_JoinConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_JoinConversation?text=CCaaS_JoinConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_LeavePublicConsult|<xref href="Microsoft.Dynamics.CRM.CCaaS_LeavePublicConsult?text=CCaaS_LeavePublicConsult Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_MonitorConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_MonitorConversation?text=CCaaS_MonitorConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_PauseRecordingAndTranscription|<xref href="Microsoft.Dynamics.CRM.CCaaS_PauseRecordingAndTranscription?text=CCaaS_PauseRecordingAndTranscription Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_PickConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_PickConversation?text=CCaaS_PickConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_RaiseSecondaryChannelEvent|<xref href="Microsoft.Dynamics.CRM.CCaaS_RaiseSecondaryChannelEvent?text=CCaaS_RaiseSecondaryChannelEvent Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_RejectConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_RejectConversation?text=CCaaS_RejectConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_RejoinConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_RejoinConversation?text=CCaaS_RejoinConversation Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_ResumeRecordingAndTranscription|<xref href="Microsoft.Dynamics.CRM.CCaaS_ResumeRecordingAndTranscription?text=CCaaS_ResumeRecordingAndTranscription Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_StartRecordingAndTranscription|<xref href="Microsoft.Dynamics.CRM.CCaaS_StartRecordingAndTranscription?text=CCaaS_StartRecordingAndTranscription Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_StartSecondaryChannel|<xref href="Microsoft.Dynamics.CRM.CCaaS_StartSecondaryChannel?text=CCaaS_StartSecondaryChannel Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_StartTranscription|<xref href="Microsoft.Dynamics.CRM.CCaaS_StartTranscription?text=CCaaS_StartTranscription Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_StopTranscription|<xref href="Microsoft.Dynamics.CRM.CCaaS_StopTranscription?text=CCaaS_StopTranscription Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_UnholdCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_UnholdCall?text=CCaaS_UnholdCall Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
...
|Value|Label|
|-----|-----|
|19241000|Microsoft Teams|Connect with customers via Teams channel option|
|192300000|WhatsApp|Connect with customers via WhatsApp channel option|
|192310000|LINE|Connect with customers via LINE channel option|
|192320000|WeChat|Connect with customers via WeChat channel option|
|192330000|Facebook|Connect with customers via Facebook channel option|
|192340000|SMS|Connect with customers via SMS channel option|
|192350000|Entity Records||
|192350001|Twitter||
|192350002|Custom|Connect with customers via Custom channel option|
|192360000|Live chat|Connect with customers via Live chat channel option|
|192370000|Voice|Connect with customers via Voice channel option|
|192380000|Video|Connect with customers via Video channel option|
|192390000|Co-browse|Connect with customers via Co-browse channel option|
|192400000|Screen sharing|Connect with customers via Screen sharing channel option|
|192440000|Voice call|Connect with customers via voice call channel option|
|192450000|Apple Messages for Business|Connect with customers via Apple Messages for Business channel option|
|192450001|Google's Business Messages|Connect with customers via Google's Business Messages channel option|
...
**Added by**: msdyn_OCIntelligence Solution
...
#### msdyn_isabandoned Choices/Options
...
> [!NOTE]
> This field was enabled in 2023. All conversations prior to 2023 will have the value of this field set to Null.
...
#### msdyn_isagentsession Choices/Options
...
|RequiredLevel|None|
|Targets|email,incident,msdyn_ocvoicemail,task|
|Type|Lookup|
...
|RequiredLevel|None|
|Targets|account,adx_invitation,bookableresourcebooking,bookableresourcebookingheader,bulkoperation,campaign,campaignactivity,contact,contract,entitlement,entitlementtemplate,incident,interactionforemail,invoice,knowledgearticle,knowledgebaserecord,lead,msdyn_bookingalertstatus,msdyn_bookingrule,msdyn_customerasset,msdyn_playbookinstance,msdyn_postalbum,msdyn_resourceterritory,msdyn_salessuggestion,msdyn_swarm,msdyn_systemuserschedulersetting,msdyn_timegroup,msdyn_timegroupdetail,mspp_adplacement,mspp_pollplacement,mspp_publishingstatetransitionrule,mspp_redirect,mspp_shortcut,mspp_website,new_dm,opportunity,quote,salesorder,site|
|Type|Lookup|
