...
|CCaaS_EndSecondaryChannel|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndSecondaryChannel?text=CCaaS_EndSecondaryChannel Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_EndSession|<xref href="Microsoft.Dynamics.CRM.CCaaS_EndSession?text=CCaaS_EndSession Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_ForceCloseConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_ForceCloseConversation?text=CCaaS_ForceCloseConversation Action" />|Type generated by CrmSvcUtil.exe or use <Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_GetAgentsForConsultAndTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_GetAgentsForConsultAndTransfer?text=CCaaS_GetAgentsForConsultAndTransfer Function" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_HoldCall|<xref href="Microsoft.Dynamics.CRM.CCaaS_HoldCall?text=CCaaS_HoldCall Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_InitiateAgentConsult|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentConsult?text=CCaaS_InitiateAgentConsult Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_InitiateAgentTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransfer?text=CCaaS_InitiateAgentTransfer Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_InitiateAgentTransferBySupervisor|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateAgentTransferBySupervisor?text=CCaaS_InitiateAgentTransferBySupervisor Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_InitiateQueueAssignment|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateQueueAssignment?text=CCaaS_InitiateQueueAssignment Action" />|Type generated by CrmSvcUtil.exe or useMicrosoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message. |
|CCaaS_InitiateQueueTransfer|<xref href="Microsoft.Dynamics.CRM.CCaaS_InitiateQueueTransfer?text=CCaaS_InitiateQueueTransfer Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
|CCaaS_JoinConversation|<xref href="Microsoft.Dynamics.CRM.CCaaS_JoinConversation?text=CCaaS_JoinConversation Action" />|Type generated by CrmSvcUtil.exe or use Microsoft.Xrm.Sdk.OrganizationRequest setting the required parameters for the message. |
