---
title: "Requirement Characteristic (msdyn_requirementcharacteristic) table/entity reference (Microsoft Dynamics 365 Customer Service)"
description: "Includes schema information and supported messages for the Requirement Characteristic (msdyn_requirementcharacteristic) table/entity with Microsoft Dynamics 365 Customer Service."
ms.date: 08/26/2024
...
The following table lists the events for the Requirement Characteristic (msdyn_requirementcharacteristic) table.
...
One-To-Many Relationship: [businessunit business_unit_msdyn_requirementcharacteristic](businessunit.md#BKMK_business_unit_msdyn_requirementcharacteristic)
...
One-To-Many Relationship: [systemuser lk_msdyn_requirementcharacteristic_createdby](systemuser.md#BKMK_lk_msdyn_requirementcharacteristic_createdby)
...
One-To-Many Relationship: [systemuser lk_msdyn_requirementcharacteristic_createdonbehalfby](systemuser.md#BKMK_lk_msdyn_requirementcharacteristic_createdonbehalfby)
...
One-To-Many Relationship: [systemuser lk_msdyn_requirementcharacteristic_modifiedby](systemuser.md#BKMK_lk_msdyn_requirementcharacteristic_modifiedby)
...
One-To-Many Relationship: [systemuser lk_msdyn_requirementcharacteristic_modifiedonbehalfby](systemuser.md#BKMK_lk_msdyn_requirementcharacteristic_modifiedonbehalfby)
...
One-To-Many Relationship: [owner owner_msdyn_requirementcharacteristic](owner.md#BKMK_owner_msdyn_requirementcharacteristic)
...
One-To-Many Relationship: [team team_msdyn_requirementcharacteristic](team.md#BKMK_team_msdyn_requirementcharacteristic)
...
One-To-Many Relationship: [systemuser user_msdyn_requirementcharacteristic](systemuser.md#BKMK_user_msdyn_requirementcharacteristic)
...
Many-To-One Relationship: [annotation msdyn_requirementcharacteristic_Annotations](annotation.md#BKMK_msdyn_requirementcharacteristic_Annotations)
...
Many-To-One Relationship: [asyncoperation msdyn_requirementcharacteristic_AsyncOperations](asyncoperation.md#BKMK_msdyn_requirementcharacteristic_AsyncOperations)
...
Many-To-One Relationship: [bulkdeletefailure msdyn_requirementcharacteristic_BulkDeleteFailures](bulkdeletefailure.md#BKMK_msdyn_requirementcharacteristic_BulkDeleteFailures)
...
Many-To-One Relationship: [duplicaterecord msdyn_requirementcharacteristic_DuplicateBaseRecord](duplicaterecord.md#BKMK_msdyn_requirementcharacteristic_DuplicateBaseRecord)
...
Many-To-One Relationship: [duplicaterecord msdyn_requirementcharacteristic_DuplicateMatchingRecord](duplicaterecord.md#BKMK_msdyn_requirementcharacteristic_DuplicateMatchingRecord)
...
Many-To-One Relationship: [mailboxtrackingfolder msdyn_requirementcharacteristic_MailboxTrackingFolders](mailboxtrackingfolder.md#BKMK_msdyn_requirementcharacteristic_MailboxTrackingFolders)
...
Many-To-One Relationship: [principalobjectattributeaccess msdyn_requirementcharacteristic_PrincipalObjectAttributeAccesses](principalobjectattributeaccess.md#BKMK_msdyn_requirementcharacteristic_PrincipalObjectAttributeAccesses)
...
Many-To-One Relationship: [processsession msdyn_requirementcharacteristic_ProcessSession](processsession.md#BKMK_msdyn_requirementcharacteristic_ProcessSession)
...
Many-To-One Relationship: [syncerror msdyn_requirementcharacteristic_SyncErrors](syncerror.md#BKMK_msdyn_requirementcharacteristic_SyncErrors)
