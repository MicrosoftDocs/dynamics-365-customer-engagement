...
> [!NOTE]
> The Microsoft Dynamics 365 Customer Service Data Map (ImportMap) table extends the [Microsoft Dynamics 365 Data Map (ImportMap) table](/dynamics365/developer/entities/importmap).
