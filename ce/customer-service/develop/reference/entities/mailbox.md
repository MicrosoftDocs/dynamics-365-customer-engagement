...
> [!NOTE]
> The Microsoft Dynamics 365 Customer Service Mailbox table extends the [Microsoft Dataverse Mailbox table](/power-apps/developer/data-platform/reference/entities/mailbox).
