...
For Copilot Studio bots, see [Configure bot context in Copilot Studio bots](../administer/enable-bot-context-pva.md).

## Next steps

[Configure bot context in Azure bots](enable-bot-context-azure.md)  
[Configure bot context in Copilot Studio bots](../administer/enable-bot-context-pva.md)  
