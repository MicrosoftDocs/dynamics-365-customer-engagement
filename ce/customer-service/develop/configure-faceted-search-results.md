...
1. In the site map of Portal Management, go to **Content** area and select **Web Templates**. You can sign in to Portal Management from multiple locations. Learn more in [Portal Management app overview](/power-pages/configure/portal-management-app.md).
