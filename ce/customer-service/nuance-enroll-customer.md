---
title: Enroll customer in biometric authentication using Nuance Gatekeeper 
...
If the agent has flagged a conversation as suspicious, the fraud detection analyst analyzes the suspicious signal and adds the caller’s voice to the suspected fraudsters watch list.
