...
| Google's Business Messages | Image | Image will have preview. Audio, video, document only receive link<br><br>. Allowed file extentions: .jpg, .jpeg, .png, .amr, .mp4, .pdf, .docx, .txt, .gif, .xlsx |
