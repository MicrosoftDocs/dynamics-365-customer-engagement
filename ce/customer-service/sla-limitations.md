...
- Avoid using the **modifiedOn** field in the target entity field as part of **Applicable**/**Success** conditions of SLA items or from the **Applicable From** field of SLA KPI. Changes to the **modifiedOn** field in the target entity might not initiate SLAs and might result in incorrect updates to SLA KPI instances.
