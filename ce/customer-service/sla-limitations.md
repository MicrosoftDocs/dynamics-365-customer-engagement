...
- For expired SLAs, you won’t get the SLA success date even if the success criteria defined on the SLA Item are met as there's no field on the SLA KPI Instance that is populated with the date of the action.
