...
Based on your business requirement, sometimes, you might need to update case descriptions or other information after the cases have been resolved or canceled. For example, your case records contain data or information that you want to update for business compliance, and you want to remove such information. In Customer Service Hub, you can't update any details for cases if the status is resolved or canceled. However, you can update the case details and other relevant information only by configuring and running flows in Power Automate or use an API.
