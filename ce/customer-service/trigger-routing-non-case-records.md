...
You can trigger routing for non-case records such as email messages programmatically, using the [IPlugin](../dotnet/api/microsoft.xrm.sdk.iplugin.md?view=dynamics-general-ce-9) interface.
