...
> [!NOTE]
> This article is targeted for Dynamics 365 for Customer Engagement apps version 9.0 and later releases
...
In the scenarios mentioned, `window.top` refers to the window owned by an application context external to Dynamics 365 for Customer Engagement. Due to the differing origins, the browser presents the user with a cross-origin security error.
