...
#### [Sign in to Omnichannel for Customer Service app](agent/agent-oc/oceh-sign-dynamics-365-customer-service-hub.md)
#### [Introduction to the agent interface](agent/agent-oc/oceh-introduction-agent-interface-omni-channel-engagement-hub.md)
#### [Manage sessions](agent/agent-oc/oceh-manage-sessions.md)
#### [Manage applications](agent/agent-oc/oceh-manage-applications.md)
#### [View agent dashboard and work items](agent/agent-oc/oceh-omni-channel-agent-dashboard.md)
#### [Create a record](agent/agent-oc/oceh-create-record.md)
#### [Search, link, and unlink a record](agent/agent-oc/oceh-search-link-unlink-record.md)
#### [Understand conversation states](agent/agent-oc/oceh-conversation-state.md)
#### [View communication panel](agent/agent-oc/oceh-conversation-control.md)
#### [Monitor real-time customer satisfaction levels](agent/agent-oc/oceh-monitor-real-time-customer-sentiment-sessions.md)
#### [Manage presence status](agent/agent-oc/oceh-set-user-presence-status.md)
#### [View notifications](agent/agent-oc/oceh-notifications-screen-pops.md)
#### [View customer summary](agent/agent-oc/oceh-customer-360-overview-of-the-existing-challenges.md)
#### [Search for and share knowledge articles](agent/agent-oc/oceh-search-knowledge-articles.md)
#### [Take notes specific to conversation](agent/agent-oc/oceh-take-notes.md)
#### [View conversation and session activity types in the Customer Engagement apps](agent/agent-oc/oceh-view-conversations-sessions-dynamics-365-apps.md)
#### [View customer summary for an incoming conversation request](agent/agent-oc/oceh-view-customer-360-incoming-conversation-request.md)
