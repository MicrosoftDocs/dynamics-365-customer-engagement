...
#### [Set user presence](agent/agent-oceh/oceh-set-user-presence-status.md)
...
#### [Search for and share knowledge articles](agent/agent-oceh/oceh-search-knowledge-articles.md)
#### [Take notes specific to conversation](agent/agent-oceh/oceh-take-notes.md)
#### [View conversations and sessions in Dynamics 365 for Customer Engagement apps](agent/agent-oceh/oceh-view-conversations-sessions-dynamics-365-apps.md)
