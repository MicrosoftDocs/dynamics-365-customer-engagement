...
You can configure your chat widget to display either full name, first name, last name, or nick name of an agent to the customers. If you would like to hide your agent’s identity and anonymize, choose to display the nick name. The values for the names are retrieved from the users created in Omni-channel Engagement Hub.
...
3. Open the chat widget in which you need to configure agent display name.
...
6.	In the **Display agent name** field, select one of the following:
    ...
    - **Nick name**: Nick name of the agent. If a nick name is not available, full name is displayed to the customers.
