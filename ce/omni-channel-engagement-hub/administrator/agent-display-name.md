...
You can configure your chat widget to display either full name, first name, last name, or nickname of an agent to the customers. If you would like to hide your agent’s identity and anonymize, choose to display the nickname. The values for the names are retrieved from the users created in Omni-channel Engagement Hub.
...
6. In the **Display agent name** field, select one of the following:
    ...
    - **Nick name**: Nickname of the agent. If a nickname is not available, the full name is displayed to the customers.
