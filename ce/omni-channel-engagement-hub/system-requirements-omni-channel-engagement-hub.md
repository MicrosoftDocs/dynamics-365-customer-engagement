...
> [!NOTE]
> Since Omni-channel Engagement Hub is in preview, your organization and tenant's region must be NAM. You might not be able to use Omni-channel Engagement Hub - Preview when the organization or tenant's region is not NAM.
