...
- **My dashboard:** provides information about the work items that you are handling such as your active work items, items available for you to pick, and closed work items. More information: [Introduction to the agent interface in Omni-channel Engagement Hub](../agent/agent-usd/introduction-agent-dashboard.md).   
