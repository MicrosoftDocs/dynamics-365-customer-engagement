---
title: "Omni-channel Engagement Hub sitemap in Customer Service Hub application | MicrosoftDocs"
...
- **Dashboards**
  ...
  When you sign in to the application, you see a dashboard that gives you easy-to-read information about the tasks you are working. There are several dashboards tailored for your role. To see the other dashboards, select the drop-down list next to **My Dashbaord**. Also, you can see any dashboard as your default view using the **Set As Default** option in the command bar. By default, you see **My Dashbaord**, which displays information about the tasks that you work on. As an agent, when you sign in to the application. The dashboard displays the following forms:
