...
View KPI data for contact, lead, and opportunity by using system views, and export the data to an Excel file. The system stores the KPI data in the following entities:
...
> [!NOTE]
> This feature applies only to the [Relationship Analytics](relationship-analytics.md) feature.

## View KPI data

To view the data, use the system views for these entities or create your own views.
...
1. Select **Results** to view the data.
...
After you view the results, you can export data to Microsoft Excel, if required. Select the export to Excel option from the command bar.
