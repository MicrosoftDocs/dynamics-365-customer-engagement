...
|---------|-------------|--------|--------|
| [Administer and configure Dynamics 365 for Sales Professional](/training/modules/administer-configure-d365-sales-professional/) | Connect with SharePoint, import data, manage users, and work with other activities in Dynamics 365 for Sales Professional. | Free, self-paced online learning path | 1.5 hours |
