...
Select **See full summary** to view the complete summary of the record. Summaries appear in a pop-up window for [opportunities](#summarize-an-opportunity) and [accounts](#summarize-an-account). For [leads](#summarize-a-lead), the information opens in a research page.
