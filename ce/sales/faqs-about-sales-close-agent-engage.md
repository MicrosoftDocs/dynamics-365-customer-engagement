...
## What are capabilities of the Sales Close Agent?  
...
The Sales Close Agent is intended to be used by sales organizations looking for a cost-efficient approach to fully automating sales.  
...
The Sales Close Agent has a configuration experience that allows an admin to personalize the agent to work for a specific sales team:  
