...
The Sales Close Agent (Research and Engage types) uses the capacity assigned to your tenant to process records and communicate with customers. You can set up either prepaid capacity or pay-as-you-go capacity for the agent. Use the following resources to learn more about setting up capacity and monitoring usage:
