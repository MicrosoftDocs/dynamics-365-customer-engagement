...
## How does the Sales Close Agents help you?
...
### Sales Close Agent - Research mode  
...
- **Sales Close Agent - Engage**
    ...
    | Role | Action |
    |------|--------|
    | Administrator | [Set up and configure the Sales Close Agent](configure-sales-close-agent.md)<br>[Start the agent](start-sales-close-agent.md)<br>[Manage the agent](manage-sales-close-agent.md)<br>[How the Sales Close Agent - Engage works](how-sales-close-agent-engage-mode-works.md) |
