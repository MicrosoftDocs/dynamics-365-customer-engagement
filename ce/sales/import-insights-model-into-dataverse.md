---
title: Import insights model into Dataverse
...
# Import insights model into Dataverse (preview)

[!INCLUDE [cc-beta-prerelease-disclaimer](../includes/cc-beta-prerelease-disclaimer.md)]

Before you enable the seller insights feature, you must import your custom insights model into Dataverse to display insights. For Dynamics 365 Sales to effectively process your data, you must map your custom attributes with the `msdyn_salessuggestion` entity in Dataverse. 
...
1.	Import your mapped attribute schema into Dataverse for Dynamics 365 Sales to access your data and show the insights. More information: [Import mapped schema into Dataverse](#import-mapped-schema-into-dataverse).

## Understand the msdyn_salessuggestion entity

The `msdyn_salessuggestion` entity helps you in importing your custom insights data into Dynamics 365 Sales. The custom attributes in your data may differ based on the requirements of each organization. To ensure consistency, you must map your custom attributes within the attributes in the `msdyn_salessuggestion` entity.
...
| Expiry date | `msdyn_expirydate` | DateTime | Expiry date of insight. |
| Suggested date | `msdyn_suggesteddate` | DateTime | Due date of insight. |
| Feedback reason | `msdyn_feedbackreason` | String | Capture reason given by seller for positive or negative disposition as **Others**. |

## Import mapped schema into Dataverse
