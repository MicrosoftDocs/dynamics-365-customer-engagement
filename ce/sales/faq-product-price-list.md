...
> [!NOTE]
>
> - In Unified Interface, the behavior of the grid columns **Price Per Unit** and **Quantity** as editable or non-editable is independent of the view that you select.
...
Certain restrictions exist on inline editing, based on the type of product in the Products subgrid for opportunity, quote, order, and invoice:
...
To set the default **Pricing** value to **Override Price** on the opportunity, quote, order, or invoice product form, follow these steps:
...
There's no direct relationship between business units and opportunity products. The owning business unit for opportunity products automatically inherits from the parent opportunity. So, you can't update the owning business unit at the opportunity product level.
...
The **Prices Locked** (**ispricelocked**) setting controls whether you can change the prices specified on the **Order** or **Invoice** form.
