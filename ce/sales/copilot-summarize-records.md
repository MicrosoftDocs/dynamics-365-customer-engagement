...
By default, the summary insight banner is available for opportunities, leads, and accounts. To add the summary insight banner to custom entities, contact your administrator to [configure the summary insight banner](/power-apps/user/record-summaries). If your administrator enables Microsoft 365 Copilot for your organization, you see the summary generated by Sales agent in Microsoft 365 Copilot in the banner for account and opportunity records. Learn more in [View insights from Sales agent in the record summary insight banner](sales-agent-banner-summary.md).
...
>[!NOTE]
>You can use the Copilot side pane to summarize the lead record. Open [Copilot in a side pane](use-sales-copilot.md#open-copilot), and then ask to summarize the lead.
...
>[!NOTE]
>You can use the Copilot side pane to summarize the account record. Open [Copilot in a side pane](use-sales-copilot.md#open-copilot), and then ask to summarize the account.
...
>[!NOTE]
>You can use the Copilot side pane to summarize the opportunity record. Open [Copilot in a side pane](use-sales-copilot.md#open-copilot), and then ask to summarize the opportunity.
...
If the Sales Opportunity Agent is configured for your organization, you can view the research insights for the opportunity. The insights provide a comprehensive overview of the opportunity, including risk mitigation, key insights and signals, and deeper insights on various aspects of the opportunity, such as stakeholders, pain points, needs, and opportunity health. Learn more in [Opportunity research page](use-sales-opportunity-agent.md#opportunity-research-page).
