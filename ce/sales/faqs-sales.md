...
### What is the difference between Power Platform duplicate detection and Dynamics 365 Sales duplicate detection of leads?
...
The Dynamics 365 Sales duplicate detection of leads is an AI model that uses rules based on fuzzy logic and matchcode. When enabled, fuzzy logic and matchcode are generated and compared against all leads in the organization to identify duplicates.     
The fuzzy logic is applied for the following rules:   
-	Similar lead name and company name 
-	Similar lead name and the same email domain  
The matchcode is applied for the following rules:    
- Email address 
-	Phone number
