...
The Dynamics 365 Sales duplicate detection of leads is an AI model that uses rules based on fuzzy logic and matchcode. When enabled, fuzzy logic and matchcode are generated for each lead and compared against other leads in the organization to identify duplicates.   
