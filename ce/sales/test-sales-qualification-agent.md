...
Before you set up and activate the agent for your production scenario, you can test the agent for a limited set of leads and evaluate its accuracy and performance.
