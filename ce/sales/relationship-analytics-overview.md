...
| 8 |Email sent/received ratio   | Compares the number of emails sent and received by the seller and customer. **Emails sent/received ratio by them** is the ratio of emails sent by the customer to emails sent by the seller. A high customer sent/received ratio means the customer is more active and interested in the conversation. A low customer sent/received ratio means the customer is less responsive and may need more attention or follow-up. <br> **Emails sent/received ratio by us** is the ratio of emails sent by the seller to emails sent by the customer. A high seller sent/received ratio means the seller is more proactive and helpful in the conversation. A low seller sent/received ratio means the seller is less engaged and may need to improve their communication skills or offer more value.       | Account, Contact, Lead, Opportunity    |
