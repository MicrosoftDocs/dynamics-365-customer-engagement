...
Basic relationship insights are generated out-of-the-box using emails and appointments sent and received in Dynamics 365. The system uses the seller-customer interaction history to calculate KPIs and understand who knows whom. [Learn how to view relationship analytics and KPIs](relationship-analytics.md#view-relationship-analytics-and-kpis).
...
| 4 |Email engagement   | Summarizes how your customer has interacted with the followed emails that your team has sent to them. Unfollowed emails aren't included, so you must enable and use the email engagement feature to see any information here. [!INCLUDE[proc_more_information](../includes/proc-more-information.md)] [Use email engagement to view message interactions](email-engagement.md).    |Account, Contact, Lead, Opportunity    |
...
Enhanced relationship insights are available with the Sales Premium license. Your administrator must [set up enhanced relationship intelligence](enable-ri.md), and can include Exchange data to generate insights based on emails and meeting information in both Exchange and Dynamics 365.

[Learn how to view relationship analytics and KPIs](relationship-analytics.md#view-relationship-analytics-and-kpis).
...
| 10 |Similar won deals (**not shown in the screenshot**)  | Shows the list of similar opportunities that have been closed as won. The columns display the number of activities, time spent, response time, and the response ratio for each opportunity. You can select and open an opportunity to view what has worked better in a deal that was closed as won, and implement these observations in the current deal to help close it as well. The list is refreshed every seven days. [Learn how similar won deals are identified](faqs-sales-insights.md#similar-won-deals-fields).    |  Opportunity  |
