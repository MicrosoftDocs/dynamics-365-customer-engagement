...
Select **Add model** to [create a model](configure-predictive-lead-scoring.md#create-a-scoring-model) for a line of business that might use different leads than your first model. The **Add model** command is disabled when you reach the maximum limit of 10 models (both published and unpublished).
