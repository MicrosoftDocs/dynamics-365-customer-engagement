...
The Sales Qualification Agent uses the language specified in the [agent settings](sales-qualification-agent-general-settings.md) to generate research insights and outreach emails. If the agent's language differs from your preferred language in Dynamics 365 Sales, you'll notice the following on the **Lead Research** page and in the outreach emails generated by the agent:
...
**Outreach emails:**
- The email body is generated in the agent's language. 
