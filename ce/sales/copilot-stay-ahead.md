...
>[!IMPORTANT]
>Effective September 2025, the **Show emails that need follow up** prompt in Copilot in Dynamics 365 Sales will be discontinued region-wise. More information: [Emails that need follow-ups in Copilot in Dynamics 365 Sales](deprecations-sales.md#emails-that-need-follow-ups-in-copilot-in-dynamics-365-sales).
