...
<a name="copilot-connect-outlook"></a>
## Connect to or disconnect from Outlook

Copilot uses your Outlook to gather data from your sales contacts (external) and shows upcoming meetings and schedules. If you haven't provided access for Copilot to use your Outlook, you'll see a prompt requesting this access when you try to prepare for meetings. Proceed to grant the access.

To disconnect from Outlook after granting access, select **Change preference** in the response for the meeting preparation prompt and select **Disconnect**.

:::image type="content" source="media/disconnect-outlook.png" alt-text="Screenshot of the response to the meeting preparation prompt in the Copilot side pane, with the Change preference option.":::
