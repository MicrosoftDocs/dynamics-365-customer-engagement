...
>[!NOTE]
>- To know in which region the Who knows whom feature available, see [In which region are the features available?](faqs-sales-insights.md#in-which-region-are-the-features-available).
