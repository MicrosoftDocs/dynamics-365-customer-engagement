...
> [!NOTE]
> From the version 9.2.24124.0010, composing and sending email using Copilot side pane feature is not supported and is removed in a phased manner. You can use the [Copilot email assist](enable-copilot-email-assist.md) feature to compose and [send emails through the rich text editor](/power-apps/maker/model-driven-apps/use-copilot-email-assist).  
