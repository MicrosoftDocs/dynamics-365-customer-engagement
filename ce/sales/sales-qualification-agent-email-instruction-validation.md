...
1. Under **Outreach emails**, specify whether you want the agent to generate emails from scratch or use an existing email template:
    - **AI-personalization**: Select this option to either use the default prompt for personalized outreach emails or to create your own custom instructions. The agent uses generative AI to create personalized email content based on the instructions. Learn more in the [Personalize outreach emails generated by the Sales Qualification Agent](sales-qualification-agent-email-personalization.md) article.
