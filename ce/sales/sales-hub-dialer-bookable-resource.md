...
1. In the Sales Hub app, go to **Sales Hub Dialer settings** > **Users**.
1. Select the **Omnichannel** tab, and then go to **Skill Configuration**.
1. Select **Create new bookable resource**.
1. Select the user and provide a name.
