...
> [!NOTE]
> Sales Premium features are supported only in specific languages. For more information, see [What languages are supported?](faq-region-language.md#which-languages-are-supported-for-sales-premium-features).  
