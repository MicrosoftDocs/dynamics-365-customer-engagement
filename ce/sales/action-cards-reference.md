...
description: List of default upcoming meetings, reminders, and insights cards, and how you can use them to stay updated with your work.
author: udaykirang
ms.author: udag
...
|-------------|------|-------------|
|<a name="MeetingToday"></a>**Meeting today** <br/>  ![Insight card for meeting today](media/ActionCard_MeetingToday.png "Insight card for meeting today")<br>**Meeting today (Exchange)**<br>![Insight card for meeting today exchange](media/ActionCard_MeetingTodayExchange.png "Insight card for meeting today exchange") | Standard |**Description**:<br>Tells that you have a meeting scheduled for today. <br>The **Meeting Today** card is derived from your appointments in the Dynamics 365 Sales organization. <br>The **Meeting Today (Exchange)** card is derived from your **Exchange** server.<br>**Features**:<br>Shows the meeting title, with a link to the meeting record. Shows the meeting description, location, start time, and key participants. Open the detailed view to see the regarded entity and a collection of closely related insight cards, including relevant people, companies, opportunities, nearby customers, news, and more.<br>**Actions**: <br>Open Appointment<br>Email Attendees|
...
| [Relationship analytics](#RelationshipAnalytics) | [Contact is no longer with the company](#ContactMovedToNewOrg) | [Today's top people](#TodaysTopPeople) | 
|[Today's top records](#TodaysTopRecords) | [Upcoming flight](#UpcomingFlight) |
