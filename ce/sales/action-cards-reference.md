...
| <a name="RecentMeeting"></a>**Recent meeting** <br />![Insight card for a recent meeting](media/ActionCard_RecentMeeting.png "Insight card for recent meeting") | Standard | **Description**:<br> Tells you that a meeting you organized (where you are the record owner) has recently ended, giving you an easy opportunity to document the meeting in Dynamics 365 Sales. The card is displayed for 30 minutes after the scheduled end of the meeting, and then removed.<br>**Features**:<br>Identifies the meeting.<br>**Actions**:<br>Take Notes (Only for recent meeting)<br>Open Appointment |
