...
> [!NOTE]
> The research insights are refreshed based on the refresh frequency configured by your admin and when specific fields in the opportunity record are updated. Learn more in [How often does the Sales Opportunity Agent refresh research data?](opportunity-research-agent-faqs#how-often-does-the-sales-opportunity-agent-refresh-research-data).
