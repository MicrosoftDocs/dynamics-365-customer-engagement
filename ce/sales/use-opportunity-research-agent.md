...
1. Select **See full research**.  
   ...
   If your admin has enabled Microsoft 365 Services for the agent and you haven't granted consent yet, you'll see a prompt asking for permission to let the agent access your emails for research purposes. Once you grant consent, the agent analyzes up to 100 recent emails from your inbox to gather insights about the opportunity. Note that this consent can't be revoked after it's granted. The agent continues to process emails every six hours to keep the research insights up to date.
