...
If the insights are in a different language than your preferred language in Dynamics 365 Sales, it's possible that the agent's language is different from your preferred language. In this case, the section headings and labels on the Opportunity research page are shown in your preferred language, while the insights generated by the agent are shown in the agent's language.
