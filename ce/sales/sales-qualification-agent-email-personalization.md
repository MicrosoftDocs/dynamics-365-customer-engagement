...
When you provide custom guidance, the agent prioritizes your custom instructions, account research, and value proposition to drive personalization.
...
1. Select an example outreach scenario from the **Prompt** drop-down and edit the instructions. 
   The scenario name changes to **Custom** in the drop-down. Learn how to [structure your instructions for effective personalization](#structure-your-instructions-for-effective-personalization).
