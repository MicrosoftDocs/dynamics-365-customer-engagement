...
## Default email personalization instructions

The default email instructions are designed to create effective cold outreach emails. If you choose not to personalize, the agent continues to generate emails using the default instructions.

The default instructions include the following prompts for the agent:
...
1. In the **Prompt** drop-down, select an example prompt to use as a starting point or select **Custom** to create your own instructions from scratch. 
...
1. Enter your personalization instructions in natural language. Learn how to structure your instructions in the following sections and some examples in the [Example email guidance](#example-email-guidance) section. 
