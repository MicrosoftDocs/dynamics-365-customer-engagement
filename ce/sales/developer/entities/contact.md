---
title: "Contact table/entity reference (Dynamics 365 Sales) | Microsoft Docs"
...
Same as the [contact_master_contact](contact.md#BKMK_contact_master_contact) many-to-one relationship for the [contact](contact.md) table/entity.
...
Same as the [account_primary_contact](account.md#BKMK_account_primary_contact) many-to-one relationship for the [account](account.md) table/entity.
...
Same as the [contact_customer_contacts](contact.md#BKMK_contact_customer_contacts) many-to-one relationship for the [contact](contact.md) table/entity.
...
Same as the [lead_customer_contacts](lead.md#BKMK_lead_customer_contacts) many-to-one relationship for the [lead](lead.md) table/entity.
...
Same as the [lead_parent_contact](lead.md#BKMK_lead_parent_contact) many-to-one relationship for the [lead](lead.md) table/entity.
...
Same as the [contact_BulkOperations](bulkoperation.md#BKMK_contact_BulkOperations) many-to-one relationship for the [bulkoperation](bulkoperation.md) table/entity.
...
Same as the [contact_CampaignResponses](campaignresponse.md#BKMK_contact_CampaignResponses) many-to-one relationship for the [campaignresponse](campaignresponse.md) table/entity.
...
Same as the [CreatedContact_BulkOperationLogs](bulkoperationlog.md#BKMK_CreatedContact_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) table/entity.
...
Same as the [SourceContact_BulkOperationLogs](bulkoperationlog.md#BKMK_SourceContact_BulkOperationLogs) many-to-one relationship for the [bulkoperationlog](bulkoperationlog.md) table/entity.
...
Same as the [invoice_customer_contacts](invoice.md#BKMK_invoice_customer_contacts) many-to-one relationship for the [invoice](invoice.md) table/entity.
...
Same as the [opportunity_customer_contacts](opportunity.md#BKMK_opportunity_customer_contacts) many-to-one relationship for the [opportunity](opportunity.md) table/entity.
...
Same as the [order_customer_contacts](salesorder.md#BKMK_order_customer_contacts) many-to-one relationship for the [salesorder](salesorder.md) table/entity.
...
Same as the [quote_customer_contacts](quote.md#BKMK_quote_customer_contacts) many-to-one relationship for the [quote](quote.md) table/entity.
...
Same as the [opportunity_parent_contact](opportunity.md#BKMK_opportunity_parent_contact) many-to-one relationship for the [opportunity](opportunity.md) table/entity.
...
Same as the [msdyn_playbookinstance_contact](msdyn_playbookinstance.md#BKMK_msdyn_playbookinstance_contact) many-to-one relationship for the [msdyn_playbookinstance](msdyn_playbookinstance.md) table/entity.
...
See the [contact_master_contact](contact.md#BKMK_contact_master_contact) one-to-many relationship for the [contact](contact.md) table/entity.

### <a name="BKMK_contact_customer_accounts"></a> contact_customer_accounts

See the [contact_customer_accounts](account.md#BKMK_contact_customer_accounts) one-to-many relationship for the [account](account.md) table/entity.

### <a name="BKMK_contact_customer_contacts"></a> contact_customer_contacts

See the [contact_customer_contacts](contact.md#BKMK_contact_customer_contacts) one-to-many relationship for the [contact](contact.md) table/entity.

### <a name="BKMK_contact_originating_lead"></a> contact_originating_lead

**Added by**: Lead Management Solution

See the [contact_originating_lead](lead.md#BKMK_contact_originating_lead) one-to-many relationship for the [lead](lead.md) table/entity.

### <a name="BKMK_price_level_contacts"></a> price_level_contacts

**Added by**: Product Management Solution

See the [price_level_contacts](pricelevel.md#BKMK_price_level_contacts) one-to-many relationship for the [pricelevel](pricelevel.md) table/entity.
<a name="manytomany"></a>
...
See the [listcontact_association](list.md#BKMK_listcontact_association) many-to-many relationship for the [list](list.md) table/entity.
...
See the [contactinvoices_association](invoice.md#BKMK_contactinvoices_association) many-to-many relationship for the [invoice](invoice.md) table/entity.

### <a name="BKMK_contactorders_association"></a> contactorders_association

See the [contactorders_association](salesorder.md#BKMK_contactorders_association) many-to-many relationship for the [salesorder](salesorder.md) table/entity.
