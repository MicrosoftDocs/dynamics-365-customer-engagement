...
|-|-|-|
|Assign|PATCH [*org URI*]/api/data/v9.2/invoices(*invoiceid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
...
|Create|POST [*org URI*]/api/data/v9.2/invoices<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.2/invoices(*invoiceid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|msdyn_ProjectServiceGenerateRetainerFromDraftInvoice|<xref href="Microsoft.Dynamics.CRM.msdyn_ProjectServiceGenerateRetainerFromDraftInvoice?text=msdyn_ProjectServiceGenerateRetainerFromDraftInvoice Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|Retrieve|GET [*org URI*]/api/data/v9.2/invoices(*invoiceid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.2/invoices<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|SetState|PATCH [*org URI*]/api/data/v9.2/invoices(*invoiceid*)<br />[Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH [*org URI*]/api/data/v9.2/invoices(*invoiceid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
- [msdyn_ProjectContractSplitBillingRule](#BKMK_msdyn_ProjectContractSplitBillingRule)
...
#### msdyn_HasCorrections Choices/Options
...
### <a name="BKMK_msdyn_ProjectContractSplitBillingRule"></a> msdyn_ProjectContractSplitBillingRule

**Added by**: Project Operations Solution

|Property|Value|
|--------|-----|
|Description|Unique Identifier of the Project Contract header customer associated with this Invoice header|
|DisplayName|Project Contract Customer|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_projectcontractsplitbillingrule|
|RequiredLevel|None|
|Targets|msdyn_projectcontractsplitbillingrule|
|Type|Lookup|
...
#### msdyn_projectinvoicestatus Choices/Options
...
- [msdyn_ProjectContractSplitBillingRuleName](#BKMK_msdyn_ProjectContractSplitBillingRuleName)
...
### <a name="BKMK_msdyn_ProjectContractSplitBillingRuleName"></a> msdyn_ProjectContractSplitBillingRuleName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_projectcontractsplitbillingrulename|
|MaxLength|300|
|RequiredLevel|None|
|Type|String|
