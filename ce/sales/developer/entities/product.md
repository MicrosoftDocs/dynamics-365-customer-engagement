...
- [msdyn_CompanyId](#BKMK_msdyn_CompanyId)
- [msdyn_FieldServiceProductType](#BKMK_msdyn_FieldServiceProductType)
- [msdyn_gdproptout](#BKMK_msdyn_gdproptout)
- [msdyn_IsCatchWeight](#BKMK_msdyn_IsCatchWeight)
- [msdyn_isstockedproduct](#BKMK_msdyn_isstockedproduct)
- [msdyn_ItemNumber](#BKMK_msdyn_ItemNumber)
- [msdyn_productcolor](#BKMK_msdyn_productcolor)
- [msdyn_productconfiguration](#BKMK_msdyn_productconfiguration)
- [msdyn_productnumber](#BKMK_msdyn_productnumber)
- [msdyn_productsize](#BKMK_msdyn_productsize)
- [msdyn_productstyle](#BKMK_msdyn_productstyle)
- [msdyn_SharedProductDetailId](#BKMK_msdyn_SharedProductDetailId)
...
### <a name="BKMK_msdyn_CompanyId"></a> msdyn_CompanyId

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Company associated with Product.|
|DisplayName|Company|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_companyid|
|RequiredLevel|None|
|Targets|cdm_company|
|Type|Lookup|
...
|690970002|Service||
|690970013|Not available|This value is used for integration purposes when the product type is not available.|
...
### <a name="BKMK_msdyn_IsCatchWeight"></a> msdyn_IsCatchWeight

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|This product Catch Weight enabled|
|DisplayName|Is Catch Weight|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_iscatchweight|
|RequiredLevel|None|
|Type|Boolean|

#### msdyn_IsCatchWeight Choices/Options
...
### <a name="BKMK_msdyn_isstockedproduct"></a> msdyn_isstockedproduct

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Is the Product stocked or not?|
|DisplayName|Is Stocked Product|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_isstockedproduct|
|RequiredLevel|None|
|Type|Boolean|

#### msdyn_isstockedproduct Choices/Options
...
### <a name="BKMK_msdyn_ItemNumber"></a> msdyn_ItemNumber
...
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_itemnumber|
|MaxLength|20|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_productcolor"></a> msdyn_productcolor

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Product Color associated with Product.|
|DisplayName|Product Color|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_productcolor|
|RequiredLevel|None|
|Targets|msdyn_productcolor|
|Type|Lookup|


### <a name="BKMK_msdyn_productconfiguration"></a> msdyn_productconfiguration

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Product Configuration associated with Product.|
|DisplayName|Product Configuration|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_productconfiguration|
|RequiredLevel|None|
|Targets|msdyn_productconfiguration|
|Type|Lookup|


### <a name="BKMK_msdyn_productnumber"></a> msdyn_productnumber

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Display Product Number|
|DisplayName|Product Number|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_productnumber|
|MaxLength|70|
|RequiredLevel|ApplicationRequired|
|Type|String|


### <a name="BKMK_msdyn_productsize"></a> msdyn_productsize

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Product Size associated with Product.|
|DisplayName|Product Size|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_productsize|
|RequiredLevel|None|
|Targets|msdyn_productsize|
|Type|Lookup|


### <a name="BKMK_msdyn_productstyle"></a> msdyn_productstyle

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Product Style associated with Product.|
|DisplayName|Product Style|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_productstyle|
|RequiredLevel|None|
|Targets|msdyn_productstyle|
|Type|Lookup|


### <a name="BKMK_msdyn_SharedProductDetailId"></a> msdyn_SharedProductDetailId

**Added by**: Dynamics 365 Supply Chain Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Shared Product Detail associated with Product.|
|DisplayName|Shared Product Detail|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_sharedproductdetailid|
|RequiredLevel|None|
|Targets|msdyn_sharedproductdetail|
|Type|Lookup|
...
- [msdyn_CompanyIdName](#BKMK_msdyn_CompanyIdName)
- [msdyn_productcolorName](#BKMK_msdyn_productcolorName)
- [msdyn_productconfigurationName](#BKMK_msdyn_productconfigurationName)
- [msdyn_productsizeName](#BKMK_msdyn_productsizeName)
- [msdyn_productstyleName](#BKMK_msdyn_productstyleName)
- [msdyn_SharedProductDetailIdName](#BKMK_msdyn_SharedProductDetailIdName)
...
### <a name="BKMK_msdyn_CompanyIdName"></a> msdyn_CompanyIdName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_companyidname|
|MaxLength|20|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_productcolorName"></a> msdyn_productcolorName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_productcolorname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_productconfigurationName"></a> msdyn_productconfigurationName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_productconfigurationname|
|MaxLength|50|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_productsizeName"></a> msdyn_productsizeName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_productsizename|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_productstyleName"></a> msdyn_productstyleName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_productstylename|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_SharedProductDetailIdName"></a> msdyn_SharedProductDetailIdName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_sharedproductdetailidname|
|MaxLength|20|
|RequiredLevel|None|
|Type|String|
