...
- [msdyn_creditlimitismandatory](#BKMK_msdyn_creditlimitismandatory)
- [msdyn_creditrating](#BKMK_msdyn_creditrating)
- [msdyn_customergroupid](#BKMK_msdyn_customergroupid)
- [msdyn_customerpaymentmethod](#BKMK_msdyn_customerpaymentmethod)
- [msdyn_defaultvendorpaymentmethodname](#BKMK_msdyn_defaultvendorpaymentmethodname)
- [msdyn_emailaddress1description](#BKMK_msdyn_emailaddress1description)
- [msdyn_faxdescription](#BKMK_msdyn_faxdescription)
- [msdyn_faxextension](#BKMK_msdyn_faxextension)
- [msdyn_gdproptout](#BKMK_msdyn_gdproptout)
- [msdyn_IdentificationNumber](#BKMK_msdyn_IdentificationNumber)
- [msdyn_invoiceaddress](#BKMK_msdyn_invoiceaddress)
- [msdyn_invoicevendoraccount](#BKMK_msdyn_invoicevendoraccount)
- [msdyn_language](#BKMK_msdyn_language)
- [msdyn_mappedvendoraccount](#BKMK_msdyn_mappedvendoraccount)
- [msdyn_onetimecustomer](#BKMK_msdyn_onetimecustomer)
- [msdyn_onholdstatus](#BKMK_msdyn_onholdstatus)
- [msdyn_partycountry](#BKMK_msdyn_partycountry)
- [msdyn_partynumber](#BKMK_msdyn_partynumber)
- [msdyn_partystateprovince](#BKMK_msdyn_partystateprovince)
- [msdyn_paymentday](#BKMK_msdyn_paymentday)
- [msdyn_paymentschedule](#BKMK_msdyn_paymentschedule)
- [msdyn_paymentterm](#BKMK_msdyn_paymentterm)
- [msdyn_paymenttermsbasedays](#BKMK_msdyn_paymenttermsbasedays)
- [msdyn_primaryfacebookdescription](#BKMK_msdyn_primaryfacebookdescription)
- [msdyn_primaryfacebookid](#BKMK_msdyn_primaryfacebookid)
- [msdyn_primarylinkedindescrption](#BKMK_msdyn_primarylinkedindescrption)
- [msdyn_primarylinkedinid](#BKMK_msdyn_primarylinkedinid)
- [msdyn_PrimaryTimeZone](#BKMK_msdyn_PrimaryTimeZone)
- [msdyn_primarytwitteriddescription](#BKMK_msdyn_primarytwitteriddescription)
- [msdyn_salesaccelerationinsightid](#BKMK_msdyn_salesaccelerationinsightid)
- [msdyn_salestaxgroup](#BKMK_msdyn_salestaxgroup)
- [msdyn_segmentid](#BKMK_msdyn_segmentid)
- [msdyn_TaxExempt](#BKMK_msdyn_TaxExempt)
- [msdyn_TaxExemptNumber](#BKMK_msdyn_TaxExemptNumber)
- [msdyn_telephone1description](#BKMK_msdyn_telephone1description)
- [msdyn_telephone1extension](#BKMK_msdyn_telephone1extension)
- [msdyn_vendor](#BKMK_msdyn_vendor)
- [msdyn_vendorcreatedbyworkflow](#BKMK_msdyn_vendorcreatedbyworkflow)
- [msdyn_vendorgroup](#BKMK_msdyn_vendorgroup)
- [msdyn_vendorknownasname](#BKMK_msdyn_vendorknownasname)
- [msdyn_vendororganizationname](#BKMK_msdyn_vendororganizationname)
- [msdyn_websiteurldescription](#BKMK_msdyn_websiteurldescription)
- [Name](#BKMK_Name)
...
**Added by**: Dynamics 365 Finance Extended Solution
...
### <a name="BKMK_msdyn_creditlimitismandatory"></a> msdyn_creditlimitismandatory

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Credit Limit Is Mandatory value for the Account. This column maps to the CreditLimitIsManadatory column on the CustCustomerV3Entity in F&O.|
|DisplayName|Credit Limit Is Mandatory|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_creditlimitismandatory|
|RequiredLevel|None|
|Type|Boolean|

#### msdyn_creditlimitismandatory Choices/Options
...
### <a name="BKMK_msdyn_creditrating"></a> msdyn_creditrating

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Credit Rating value for the Account. This column maps to the CreditRating column on the CustCustomerV3Entity in F&O.|
|DisplayName|Credit Rating|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_creditrating|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_customergroupid"></a> msdyn_customergroupid

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The group that the current account is associated with. This column maps to the CustomerGroupId column from the CustCustomerV3Entity in F&O.|
|DisplayName|Customer Group Id|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_customergroupid|
|RequiredLevel|None|
|Targets|msdyn_customergroup|
|Type|Lookup|


### <a name="BKMK_msdyn_customerpaymentmethod"></a> msdyn_customerpaymentmethod

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Customer Payment Method associated to the Account. This column maps to the PaymentMethod column on the CustCustomerV3Entity in F&O.|
|DisplayName|Customer Payment Method|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_customerpaymentmethod|
|RequiredLevel|None|
|Targets|msdyn_customerpaymentmethod|
|Type|Lookup|


### <a name="BKMK_msdyn_defaultvendorpaymentmethodname"></a> msdyn_defaultvendorpaymentmethodname
...
|DisplayName|Methods of Payment|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_defaultvendorpaymentmethodname|
|RequiredLevel|None|
|Targets|msdyn_vendorpaymentmethod|
|Type|Lookup|


### <a name="BKMK_msdyn_emailaddress1description"></a> msdyn_emailaddress1description

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Email Address 1 value for the account. This column maps to the PrimaryContactEmailDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Email Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_emailaddress1description|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_faxdescription"></a> msdyn_faxdescription

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Fax number for the account. This column maps to the PrimaryContactFaxDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Fax Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_faxdescription|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_faxextension"></a> msdyn_faxextension

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Fax Extension associated with the Fax number on the Account table. This column maps to the PrimaryContactFaxExtension column on the CustCustomerV3Entity in F&O.|
|DisplayName|Fax Extension|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_faxextension|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|
...
### <a name="BKMK_msdyn_IdentificationNumber"></a> msdyn_IdentificationNumber

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Identification Number for government identification for the Account. This column maps to the IdentificationNumber column on the CustCustomerv3Entity in F&O.|
|DisplayName|Identification Number|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_identificationnumber|
|MaxLength|50|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_invoiceaddress"></a> msdyn_invoiceaddress

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Indicates whether an invoice is sent to the Order Account or Invoice Account. This column maps to the InvoiceAddress column on the CustCustomerV3Entity in F&O.|
|DisplayName|Invoice Address|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_invoiceaddress|
|RequiredLevel|None|
|Type|Picklist|

#### msdyn_invoiceaddress Choices/Options

|Value|Label|Description|
|-----|-----|--------|
|806380000|Invoice Account||
|806380001|Order Account||



### <a name="BKMK_msdyn_invoicevendoraccount"></a> msdyn_invoicevendoraccount

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Invoice account of the vendor|
|DisplayName|Invoice Vendor Account|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_invoicevendoraccount|
|RequiredLevel|None|
|Targets|msdyn_vendor|
|Type|Lookup|
...
|Property|Value|
|--------|-----|
|Description|Default language of vendor|
...
### <a name="BKMK_msdyn_mappedvendoraccount"></a> msdyn_mappedvendoraccount

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Linked vendor account in Vendors table. This column maps vendors in both vendors and Accounts tables in the scenario where vendors need to be created in Accounts table also.|
|DisplayName|Linked Vendor Account|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_mappedvendoraccount|
|RequiredLevel|None|
|Targets|msdyn_vendor|
|Type|Lookup|


### <a name="BKMK_msdyn_onetimecustomer"></a> msdyn_onetimecustomer

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Defines if the Account is a One Time Customer. This column maps to the IsOneTimeCustomer column on the CustCustomerv3Entity in F&O.|
|DisplayName|Is One Time Customer|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_onetimecustomer|
|RequiredLevel|None|
|Type|Boolean|

#### msdyn_onetimecustomer Choices/Options
...
### <a name="BKMK_msdyn_onholdstatus"></a> msdyn_onholdstatus

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The On Hold Status for the Account. This column maps to the OnHoldStatus column on the CustCustomerv3Entity in F&O.|
|DisplayName|On Hold Status|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_onholdstatus|
|RequiredLevel|None|
|Type|Picklist|

#### msdyn_onholdstatus Choices/Options
...
### <a name="BKMK_msdyn_partycountry"></a> msdyn_partycountry

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Party Country value used for government identification for the Account table. This column maps to the PartyCountry column on the CustCustomerv3Entity in F&O.|
|DisplayName|Party Country|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_partycountry|
|MaxLength|80|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_partynumber"></a> msdyn_partynumber

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Party number for the Account|
|DisplayName|Party Number|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_partynumber|
|MaxLength|40|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_partystateprovince"></a> msdyn_partystateprovince

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Party State/Province used for government identification on the Account. This column maps to the PartyState column on the CustCustomerv3Entity in F&O.|
|DisplayName|Party State/Province|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_partystateprovince|
|MaxLength|50|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_paymentday"></a> msdyn_paymentday

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Payment Day table associated with the Account. This column maps to the PaymentDay column in the CustCustomerV3Entity in F&O.|
|DisplayName|Payment Day|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_paymentday|
|RequiredLevel|None|
|Targets|msdyn_paymentday|
|Type|Lookup|


### <a name="BKMK_msdyn_paymentschedule"></a> msdyn_paymentschedule

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Payment Schedule associated with the Account. This column maps to the PaymentSchedule column in the CustCustomerV3Entity in F&O.|
|DisplayName|Payment Schedule|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_paymentschedule|
|RequiredLevel|None|
|Targets|msdyn_paymentschedule|
|Type|Lookup|
...
|Property|Value|
|--------|-----|
|Description|The Payment Term associated to the Account. This column maps to the PaymentTerms column on the CustCustomerV3Entity in F&O.|
...
### <a name="BKMK_msdyn_paymenttermsbasedays"></a> msdyn_paymenttermsbasedays

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Payment Terms Base Days for the Account. This column maps to the PaymentTermsBaseDays column in the CustCustomerV3Entity in F&O.|
|DisplayName|Payment Terms Base Days|
|Format|None|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_paymenttermsbasedays|
|MaxValue|2147483647|
|MinValue|0|
|RequiredLevel|None|
|Type|Integer|
...
### <a name="BKMK_msdyn_primaryfacebookdescription"></a> msdyn_primaryfacebookdescription

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Primary Facebook ID for the account. This column maps to the PrimaryContactFacebookDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Primary Facebook Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_primaryfacebookdescription|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_primaryfacebookid"></a> msdyn_primaryfacebookid

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Primary Facebook ID for the Account. This column maps to the PrimaryContactFacebook column on the CustCustomerV3Entity in F&O.|
|DisplayName|Primary Facebook ID|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_primaryfacebookid|
|MaxLength|255|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_primarylinkedindescrption"></a> msdyn_primarylinkedindescrption

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Primary LinkedIn value for the account. This column maps to the PrimaryContactLinkedInDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Primary LinkedIn Descrption|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_primarylinkedindescrption|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_primarylinkedinid"></a> msdyn_primarylinkedinid

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Primary LinkedIn ID for the Account. This column maps to the PrimaryContactLinkedIn column on the CustCustomerV3Entity in F&O.|
|DisplayName|Primary LinkedIn ID|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_primarylinkedinid|
|MaxLength|250|
|RequiredLevel|None|
|Type|String|
...
**Added by**: Asset Common Solution
...
### <a name="BKMK_msdyn_primarytwitteriddescription"></a> msdyn_primarytwitteriddescription

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Primary Twitter ID for the account. This column maps to the PrimaryContactTwitterDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Primary Twitter ID Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_primarytwitteriddescription|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|
...
### <a name="BKMK_msdyn_salestaxgroup"></a> msdyn_salestaxgroup

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Unique identifier for Tax Group associated with Account.|
|DisplayName|Sales Tax Group|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_salestaxgroup|
|RequiredLevel|None|
|Targets|msdyn_taxgroup|
|Type|Lookup|
...
### <a name="BKMK_msdyn_telephone1description"></a> msdyn_telephone1description

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Telephone 1 value for the account. This column maps to the PrimaryContactPhoneDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Phone Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_telephone1description|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_telephone1extension"></a> msdyn_telephone1extension

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The Telephone 1 Extension for the account. This column maps to the PrimaryContactPhoneExtension in the CustCustomerV3Entity in F&O.|
|DisplayName|Phone Extension|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_telephone1extension|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|
...
|Property|Value|
|--------|-----|
|Description|Vendor associated with the Account. This column maps to the VendorAccount column in the CustCustomerV3Entity in F&O.|
|DisplayName|Vendor|
|IsValidForForm|True|
|IsValidForRead|True|
...
### <a name="BKMK_msdyn_vendorcreatedbyworkflow"></a> msdyn_vendorcreatedbyworkflow

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Indicates if the vendor is created through the workflow|
|DisplayName|Vendor Created By Workflow|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_vendorcreatedbyworkflow|
|RequiredLevel|None|
|Type|Boolean|

#### msdyn_vendorcreatedbyworkflow Choices/Options
...
### <a name="BKMK_msdyn_vendorgroup"></a> msdyn_vendorgroup
...
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_vendorgroup|
|RequiredLevel|None|
|Targets|msdyn_vendorgroup|
|Type|Lookup|


### <a name="BKMK_msdyn_vendorknownasname"></a> msdyn_vendorknownasname

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|Vendor Known As Name|
|DisplayName|Vendor Known As|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_vendorknownasname|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_vendororganizationname"></a> msdyn_vendororganizationname
...
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_vendororganizationname|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_websiteurldescription"></a> msdyn_websiteurldescription

**Added by**: Dynamics 365 Finance Extended Solution

|Property|Value|
|--------|-----|
|Description|The description for the Website URL for the account. This column maps to the PrimaryContactURLDescription in the CustCustomerV3Entity in F&O.|
|DisplayName|Website Description|
|FormatName|Text|
|IsLocalizable|False|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_websiteurldescription|
|MaxLength|60|
|RequiredLevel|None|
|Type|String|
...
- [msdyn_customergroupidName](#BKMK_msdyn_customergroupidName)
- [msdyn_customerpaymentmethodName](#BKMK_msdyn_customerpaymentmethodName)
- [msdyn_defaultvendorpaymentmethodnameName](#BKMK_msdyn_defaultvendorpaymentmethodnameName)
- [msdyn_invoicevendoraccountName](#BKMK_msdyn_invoicevendoraccountName)
- [msdyn_mappedvendoraccountName](#BKMK_msdyn_mappedvendoraccountName)
- [msdyn_paymentdayName](#BKMK_msdyn_paymentdayName)
- [msdyn_paymentscheduleName](#BKMK_msdyn_paymentscheduleName)
...
- [msdyn_salestaxgroupName](#BKMK_msdyn_salestaxgroupName)
- [msdyn_segmentidName](#BKMK_msdyn_segmentidName)
- [msdyn_vendorgroupName](#BKMK_msdyn_vendorgroupName)
...
### <a name="BKMK_msdyn_customergroupidName"></a> msdyn_customergroupidName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_customergroupidname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_customerpaymentmethodName"></a> msdyn_customerpaymentmethodName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_customerpaymentmethodname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_defaultvendorpaymentmethodnameName"></a> msdyn_defaultvendorpaymentmethodnameName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_defaultvendorpaymentmethodnamename|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_invoicevendoraccountName"></a> msdyn_invoicevendoraccountName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_invoicevendoraccountname|
|MaxLength|20|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_mappedvendoraccountName"></a> msdyn_mappedvendoraccountName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_mappedvendoraccountname|
|MaxLength|20|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_paymentdayName"></a> msdyn_paymentdayName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_paymentdayname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|


### <a name="BKMK_msdyn_paymentscheduleName"></a> msdyn_paymentscheduleName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_paymentschedulename|
|MaxLength|30|
|RequiredLevel|None|
|Type|String|
...
### <a name="BKMK_msdyn_salestaxgroupName"></a> msdyn_salestaxgroupName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_salestaxgroupname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|
...
### <a name="BKMK_msdyn_vendorgroupName"></a> msdyn_vendorgroupName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_vendorgroupname|
|MaxLength|10|
|RequiredLevel|None|
|Type|String|
...
- [msdyn_account_contact_AccountNumber](#BKMK_msdyn_account_contact_AccountNumber)
- [msdyn_account_quote_InvoiceCustomer](#BKMK_msdyn_account_quote_InvoiceCustomer)
- [msdyn_account_quote_InvoiceCustomerId](#BKMK_msdyn_account_quote_InvoiceCustomerId)
...
### <a name="BKMK_msdyn_account_contact_AccountNumber"></a> msdyn_account_contact_AccountNumber

**Added by**: Dynamics 365 Finance Extended Solution

Same as the [msdyn_account_contact_AccountNumber](contact.md#BKMK_msdyn_account_contact_AccountNumber) many-to-one relationship for the [contact](contact.md) table/entity.

|Property|Value|
|--------|-----|
|ReferencingEntity|contact|
|ReferencingAttribute|msdyn_accountnumber|
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_account_contact_AccountNumber|
...
### <a name="BKMK_msdyn_account_quote_InvoiceCustomer"></a> msdyn_account_quote_InvoiceCustomer

**Added by**: Dynamics 365 Supply Chain Extended Solution

Same as the [msdyn_account_quote_InvoiceCustomer](quote.md#BKMK_msdyn_account_quote_InvoiceCustomer) many-to-one relationship for the [quote](quote.md) table/entity.

|Property|Value|
|--------|-----|
|ReferencingEntity|quote|
|ReferencingAttribute|msdyn_invoicecustomer|
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_account_quote_InvoiceCustomer|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: 10000|
|CascadeConfiguration|Assign: NoCascade<br />Delete: RemoveLink<br />Merge: Cascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|


### <a name="BKMK_msdyn_account_quote_InvoiceCustomerId"></a> msdyn_account_quote_InvoiceCustomerId

**Added by**: Dynamics 365 Supply Chain Extended Solution

Same as the [msdyn_account_quote_InvoiceCustomerId](quote.md#BKMK_msdyn_account_quote_InvoiceCustomerId) many-to-one relationship for the [quote](quote.md) table/entity.

|Property|Value|
|--------|-----|
|ReferencingEntity|quote|
|ReferencingAttribute|msdyn_invoicecustomerid|
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_account_quote_InvoiceCustomerId|
|AssociatedMenuConfiguration|Behavior: UseCollectionName<br />Group: Details<br />Label: <br />Order: 10000|
|CascadeConfiguration|Assign: NoCascade<br />Delete: Restrict<br />Merge: Cascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
Same as the [msdyn_account_salesorder_InvoiceCustomer](salesorder.md#BKMK_msdyn_account_salesorder_InvoiceCustomer) many-to-one relationship for the [salesorder](salesorder.md) table/entity.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_account_salesorder_InvoiceCustomer|
|AssociatedMenuConfiguration|Behavior: DoNotDisplay<br />Group: Details<br />Label: <br />Order: 10000|
|CascadeConfiguration|Assign: NoCascade<br />Delete: Restrict<br />Merge: Cascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
Same as the [msdyn_account_salesorder_InvoiceCustomerId](salesorder.md#BKMK_msdyn_account_salesorder_InvoiceCustomerId) many-to-one relationship for the [salesorder](salesorder.md) table/entity.
...
|IsHierarchical|False|
|IsCustomizable|True|
|ReferencedEntityNavigationPropertyName|msdyn_account_salesorder_InvoiceCustomerId|
|AssociatedMenuConfiguration|Behavior: UseCollectionName<br />Group: Details<br />Label: <br />Order: 10000|
|CascadeConfiguration|Assign: NoCascade<br />Delete: Restrict<br />Merge: Cascade<br />Reparent: NoCascade<br />Share: NoCascade<br />Unshare: NoCascade|
...
See the [msdyn_msdyn_segment_account](msdyn_segment.md#BKMK_msdyn_msdyn_segment_account) one-to-many relationship for the [msdyn_segment](msdyn_segment.md) table/entity.
<a name="manytomany"></a>
