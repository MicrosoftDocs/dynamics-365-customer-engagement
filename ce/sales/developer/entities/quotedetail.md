---
title: "Quote Line (QuoteDetail)  table/entity reference (Dynamics 365 Sales) | Microsoft Docs"
description: "Includes schema information and supported messages for the Quote Line (QuoteDetail)  table/entity."
ms.date: 12/26/2022
...
|Create|POST [*org URI*]/api/data/v9.2/quotedetails<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|Delete|DELETE [*org URI*]/api/data/v9.2/quotedetails(*quotedetailid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|msdyn_ProjectServiceAssociateQuoteLineToProjectTask|<xref href="Microsoft.Dynamics.CRM.msdyn_ProjectServiceAssociateQuoteLineToProjectTask?text=msdyn_ProjectServiceAssociateQuoteLineToProjectTask Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_ProjectServiceDisassociateQuoteLineFromProjectTask|<xref href="Microsoft.Dynamics.CRM.msdyn_ProjectServiceDisassociateQuoteLineFromProjectTask?text=msdyn_ProjectServiceDisassociateQuoteLineFromProjectTask Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_UpdateQuoteLineResourceCategory|<xref href="Microsoft.Dynamics.CRM.msdyn_UpdateQuoteLineResourceCategory?text=msdyn_UpdateQuoteLineResourceCategory Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_UpdateQuoteLineTransactionCategory|<xref href="Microsoft.Dynamics.CRM.msdyn_UpdateQuoteLineTransactionCategory?text=msdyn_UpdateQuoteLineTransactionCategory Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|Retrieve|GET [*org URI*]/api/data/v9.2/quotedetails(*quotedetailid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.2/quotedetails<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.2/quotedetails(*quotedetailid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
|Property|Value|
|--------|-----|
|Description|Tasks on the project that will be included on this Quote line.|
