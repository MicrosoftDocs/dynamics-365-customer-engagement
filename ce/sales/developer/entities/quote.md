...
|msdyn_CloseQuoteAsLost|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_CloseQuoteAsWon|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_CreateQuoteSpecificPriceList|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_GetProjectsForQuote|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_UpdateQuoteLineDetailPrices|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
#### msdyn_feasible Choices/Options
...
|Property|Value|
|--------|-----|
|Description|Select whether the project contract is for an item-based or a work-based sale.|
|DisplayName|Type|
|IsValidForForm|True|
|IsValidForRead|True|
...
#### msdyn_Competitive Choices/Options
...
#### msdyn_EstimatedBudget Choices/Options
...
#### msdyn_EstimatedSchedule Choices/Options
...
#### msdyn_Profitability Choices/Options
...
Same as the [bpf_quote_OpportunitySalesProcess](opportunitysalesprocess.md#BKMK_bpf_quote_OpportunitySalesProcess) many-to-one relationship for the [opportunitysalesprocess](opportunitysalesprocess.md) table/entity.
