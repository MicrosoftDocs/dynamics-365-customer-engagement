---
title: "Order Line (SalesOrderDetail)  table/entity reference (Dynamics 365 Sales) | Microsoft Docs"
description: "Includes schema information and supported messages for the Order Line (SalesOrderDetail)  table/entity."
ms.date: 12/26/2022
...
|Create|POST [*org URI*]/api/data/v9.2/salesorderdetails<br />See [Create](/powerapps/developer/common-data-service/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|CreateMultiple||<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
|Delete|DELETE [*org URI*]/api/data/v9.2/salesorderdetails(*salesorderdetailid*)<br />See [Delete](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|msdyn_ProjectServiceAssociateContractLineToProjectTask|<xref href="Microsoft.Dynamics.CRM.msdyn_ProjectServiceAssociateContractLineToProjectTask?text=msdyn_ProjectServiceAssociateContractLineToProjectTask Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_ProjectServiceDisassociateContractLineFromProjectTask|<xref href="Microsoft.Dynamics.CRM.msdyn_ProjectServiceDisassociateContractLineFromProjectTask?text=msdyn_ProjectServiceDisassociateContractLineFromProjectTask Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_UpdateOrderLineResourceCategory|<xref href="Microsoft.Dynamics.CRM.msdyn_UpdateOrderLineResourceCategory?text=msdyn_UpdateOrderLineResourceCategory Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|msdyn_UpdateOrderLineTransactionCategory|<xref href="Microsoft.Dynamics.CRM.msdyn_UpdateOrderLineTransactionCategory?text=msdyn_UpdateOrderLineTransactionCategory Action" />|Type generated by CrmSvcUtil.exe or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
|Retrieve|GET [*org URI*]/api/data/v9.2/salesorderdetails(*salesorderdetailid*)<br />See [Retrieve](/powerapps/developer/common-data-service/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET [*org URI*]/api/data/v9.2/salesorderdetails<br />See [Query Data](/powerapps/developer/common-data-service/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
|Update|PATCH [*org URI*]/api/data/v9.2/salesorderdetails(*salesorderdetailid*)<br />See [Update](/powerapps/developer/common-data-service/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
- [msdyn_CostType](#BKMK_msdyn_CostType)
- [msdyn_includedtasks](#BKMK_msdyn_includedtasks)
...
- [msdyn_NottoexceedStatus](#BKMK_msdyn_NottoexceedStatus)
- [msdyn_Project](#BKMK_msdyn_Project)
- [msdyn_SubcontractLine](#BKMK_msdyn_SubcontractLine)
...
|192350003|Canceled|Canceled billing status of transactions.|
...
### <a name="BKMK_msdyn_CostType"></a> msdyn_CostType

**Added by**: Project Operations Solution

|Property|Value|
|--------|-----|
|Description|Identifies if the cost is incurred using internal resources or externally via a subcontract.|
|DisplayName|Cost Type|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_costtype|
|RequiredLevel|None|
|Type|Picklist|

#### msdyn_CostType Choices/Options

|Value|Label|Description|
|-----|-----|--------|
|192350000|Internal|Cost incurred by an internal party such as an Employee.|
|192350001|External|Cost incurred by an external party such as a Vendor or a subcontractor.|



### <a name="BKMK_msdyn_includedtasks"></a> msdyn_includedtasks

**Added by**: Project Operations Solution

|Property|Value|
|--------|-----|
|Description|Tasks on the project that will be included on this Project contract line.|
|DisplayName|Included Tasks|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_includedtasks|
|RequiredLevel|None|
|Type|Picklist|

#### msdyn_includedtasks Choices/Options

|Value|Label|Description|
|-----|-----|--------|
|192350000|All project tasks|All tasks on the project will be included.|
|192350001|Selected project tasks only|A selection of tasks in the Project will be included.|
...
#### msdyn_IncludeExpense Choices/Options
...
#### msdyn_IncludeFee Choices/Options
...
#### msdyn_IncludeMaterial Choices/Options
...
#### msdyn_IncludeTime Choices/Options
...
### <a name="BKMK_msdyn_NottoexceedStatus"></a> msdyn_NottoexceedStatus

**Added by**: Project Operations Solution

|Property|Value|
|--------|-----|
|Description|Validation status of this actual against the Not-to-exceed limits setup on the Contract|
|DisplayName|Not-to-exceed Status|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_nottoexceedstatus|
|RequiredLevel|None|
|Type|Picklist|

#### msdyn_NottoexceedStatus Choices/Options

|Value|Label|Description|
|-----|-----|--------|
|192350000|Not Applicable|Status when not-to-exceed limits are not applicable for this line|
|192350001|Not Evaluated|Status when not-to-exceed limits have not been evaluated on this line|
|192350002|Committed|Status when the amount on the line was committed or reserved against the available not-to-exceed limit|
|192350003|Failed|Status when the amount on the line could not be reserved against the available not-to-exceed limit|
|192350004|Spent|Status when the amount on the line has already consumed against the not-to-exceed limit|
...
### <a name="BKMK_msdyn_SubcontractLine"></a> msdyn_SubcontractLine

**Added by**: Project Operations Solution

|Property|Value|
|--------|-----|
|Description|Reference to the Subcontract Line that is linked to this Contract line.|
|DisplayName|Subcontract Line|
|IsValidForForm|True|
|IsValidForRead|True|
|LogicalName|msdyn_subcontractline|
|RequiredLevel|None|
|Targets|msdyn_subcontractline|
|Type|Lookup|
...
- [msdyn_SubcontractLineName](#BKMK_msdyn_SubcontractLineName)
...
### <a name="BKMK_msdyn_SubcontractLineName"></a> msdyn_SubcontractLineName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_subcontractlinename|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|
