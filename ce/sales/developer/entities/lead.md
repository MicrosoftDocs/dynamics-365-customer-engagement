---
title: "Lead table/entity reference"
...
|-|-|-|
|Assign|PATCH /leads(*leadid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `ownerid` property.|<xref:Microsoft.Crm.Sdk.Messages.AssignRequest>|
...
|Create|POST /leads<br />See [Create](/powerapps/developer/data-platform/webapi/create-entity-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.CreateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Create*>|
|CreateMultiple|<xref:Microsoft.Dynamics.CRM.CreateMultiple?displayProperty=nameWithType />|<xref:Microsoft.Xrm.Sdk.Messages.CreateMultipleRequest>|
|Delete|DELETE /leads(*leadid*)<br />See [Delete](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-delete)|<xref:Microsoft.Xrm.Sdk.Messages.DeleteRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Delete*>|
...
|msdyn_GDPROptoutLead||Type generated by Power Platform CLI [pac modelbuilder build](/power-platform/developer/cli/reference/modelbuilder#pac-modelbuilder-build) command or use <xref:Microsoft.Xrm.Sdk.OrganizationRequest> setting the required parameters for the message.|
...
|Retrieve|GET /leads(*leadid*)<br />See [Retrieve](/powerapps/developer/data-platform/webapi/retrieve-entity-using-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Retrieve*>|
|RetrieveMultiple|GET /leads<br />See [Query Data](/powerapps/developer/data-platform/webapi/query-data-web-api)|<xref:Microsoft.Xrm.Sdk.Messages.RetrieveMultipleRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.RetrieveMultiple*>|
...
|SetState|PATCH /leads(*leadid*)<br />[Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update) `statecode` and `statuscode` properties.|<xref:Microsoft.Crm.Sdk.Messages.SetStateRequest>|
|Update|PATCH /leads(*leadid*)<br />See [Update](/powerapps/developer/data-platform/webapi/update-delete-entities-using-web-api#basic-update)|<xref:Microsoft.Xrm.Sdk.Messages.UpdateRequest> or <br /><xref:Microsoft.Xrm.Sdk.IOrganizationService.Update*>|
...
|Property|Value|
|--------|-----|
|Description|Unique identifier for Company associated with Lead.|
|DisplayName|Company|
|IsValidForForm|True|
|IsValidForRead|True|
...
|Property|Value|
|--------|-----|
|Description|Whether the lead is for an Item-based Lead or a different type of Lead|
|DisplayName|Type|
|IsValidForForm|True|
|IsValidForRead|True|
...
- [msdyn_leadkpiidName](#BKMK_msdyn_leadkpiidName)
...
### <a name="BKMK_msdyn_leadkpiidName"></a> msdyn_leadkpiidName
...
|IsValidForForm|False|
|IsValidForRead|True|
|LogicalName|msdyn_leadkpiidname|
|MaxLength|100|
|RequiredLevel|None|
|Type|String|
...
Same as the [msdyn_lead_msdyn_salesroutingrun_targetobject](msdyn_salesroutingrun.md#BKMK_msdyn_lead_msdyn_salesroutingrun_targetobject) many-to-one relationship for the [msdyn_salesroutingrun](msdyn_salesroutingrun.md) table/entity.
...
See the [msdyn_msdyn_predictivescore_lead](msdyn_predictivescore.md#BKMK_msdyn_msdyn_predictivescore_lead) one-to-many relationship for the [msdyn_predictivescore](msdyn_predictivescore.md) table/entity.

### <a name="BKMK_msdyn_msdyn_segment_lead"></a> msdyn_msdyn_segment_lead

**Added by**: Segment solution Solution

See the [msdyn_msdyn_segment_lead](msdyn_segment.md#BKMK_msdyn_msdyn_segment_lead) one-to-many relationship for the [msdyn_segment](msdyn_segment.md) table/entity.
<a name="manytomany"></a>
