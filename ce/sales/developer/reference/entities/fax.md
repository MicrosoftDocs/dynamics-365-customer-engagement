...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Fax table extends the [Microsoft Dataverse Fax table](/power-apps/developer/data-platform/reference/entities/fax).
...
One-To-Many Relationship: [sample_bankaccount sample_bankaccount_Faxes](sample_bankaccount.md#BKMK_sample_bankaccount_Faxes)
