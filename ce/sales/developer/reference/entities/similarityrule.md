...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Similarity Rule (SimilarityRule) table extends the [Microsoft Dynamics 365 Similarity Rule (SimilarityRule) table](/dynamics365/developer/entities/similarityrule).
