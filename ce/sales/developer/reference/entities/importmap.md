...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Data Map (ImportMap) table extends the [Microsoft Dynamics 365 Data Map (ImportMap) table](/dynamics365/developer/entities/importmap).
