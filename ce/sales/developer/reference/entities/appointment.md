...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Appointment table extends the [Microsoft Dataverse Appointment table](/power-apps/developer/data-platform/reference/entities/appointment).
...
One-To-Many Relationship: [sample_bankaccount sample_bankaccount_Appointments](sample_bankaccount.md#BKMK_sample_bankaccount_Appointments)
