---
title: "Playbook Callable Context (msdyn_callablecontext) table/entity reference (Microsoft Dynamics 365 Sales)"
...
# Playbook Callable Context (msdyn_callablecontext) table/entity reference (Microsoft Dynamics 365 Sales)



> [!NOTE]
> The Microsoft Dynamics 365 Sales Playbook Callable Context (msdyn_callablecontext) table extends the [Microsoft Dynamics 365 Playbook Callable Context (msdyn_callablecontext) table](/dynamics365/developer/entities/msdyn_callablecontext).
