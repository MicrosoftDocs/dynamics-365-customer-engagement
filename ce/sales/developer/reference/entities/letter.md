...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Letter table extends the [Microsoft Dataverse Letter table](/power-apps/developer/data-platform/reference/entities/letter).
...
One-To-Many Relationship: [sample_bankaccount sample_bankaccount_Letters](sample_bankaccount.md#BKMK_sample_bankaccount_Letters)
