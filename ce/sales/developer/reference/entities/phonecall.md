...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Phone Call (PhoneCall) table extends the [Microsoft Dataverse Phone Call (PhoneCall) table](/power-apps/developer/data-platform/reference/entities/phonecall).
...
One-To-Many Relationship: [sample_bankaccount sample_bankaccount_PhoneCalls](sample_bankaccount.md#BKMK_sample_bankaccount_PhoneCalls)
