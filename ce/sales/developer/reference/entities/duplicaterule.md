...
> [!NOTE]
> The Microsoft Dynamics 365 Sales Duplicate Detection Rule (DuplicateRule) table extends the [Microsoft Dynamics 365 Duplicate Detection Rule (DuplicateRule) table](/dynamics365/developer/entities/duplicaterule).
