---
title: Add products to a bundle (Sample)
...
> [!NOTE]
> You can add or delete products only when the bundle is in draft or retired state. To add or delete products in a bundle that is in active or under revision state, clone the product bundle. This action creates a new bundle with a new ID in draft state. You can then add or delete products in the new bundle.
...
Displays an option to delete all the data that the sample created. The deletion is optional in case you want to examine the data that the sample created. You can manually delete the data to achieve the same results.  
