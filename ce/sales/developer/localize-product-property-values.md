...
### Monitor the progress of field translation import jobs  
 The system job tables contains the following views to monitor the progress of field translation import jobs:  
...
| **Warning**: An invalid Table name was found in worksheet {0}, Line {1}, Column A. | There is no valid table in the system using a name in the worksheet.<br /><br /> Processing of other rows will continue. |
