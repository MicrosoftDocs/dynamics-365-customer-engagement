...
Before you start, make sure you have a license to use the ZoomInfo app.

## Install the app

As a Dynamics 365 administrator, install the ZoomInfo app so administrators can configure export and mapping settings, and sellers can search for and export ZoomInfo data to Dynamics 365 Sales workflows.
...
1. Sign in with the email address of the account you want to use when acquiring apps on Marketplace.  
    ZoomInfo sends a solution package for installation.  
...
1. Select the package and then select **Install**.  
    >[!NOTE]
    >Installation of the solution package can take up to 15 minutes to complete.  
1. When the installation finishes, the ZoomInfo app appears on the Dynamics 365 apps page.
