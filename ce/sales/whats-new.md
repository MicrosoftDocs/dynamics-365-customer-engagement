...
|---------|---------|---------|---------|---------|---------|
|Copilot     | Opportunity summary       | Use the AI-generated opportunity summaries to get a quick and comprehensive view of the opportunity, without reading through the history of the opportunity.        |  [Documentation](use-sales-copilot.md#summarize-an-opportunity-or-a-lead)       |Enabled by admins         |  Public preview       |
|Copilot     | Lead summary        | Get AI-generated lead summaries that are enriched with data from CRM, Bing news and LinkedIn.        | [Documentation](use-sales-copilot.md#lead-enrichment-with-sales-copilot)         | Enabled by admins         | Public preview         |
