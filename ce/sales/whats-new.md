...
| Copilot | Natural language chat for data-related questions| Ask Copilot questions related to sales data in natural language.  | [Documentation](use-sales-copilot#chat-with-copilot-in-natural-language) | By default | GA |
| Copilot | Natural language chat using sales-specific terminology | Ask Copilot questions related to sales-specific terminology in natural language | [Documentation](use-sales-copilot#chat-with-copilot-in-natural-language) | By default | GA |
