...
The Sales Opportunity Agent uses the language specified in the [agent settings](configure-opportunity-research-agent.md) to generate research insights. If the agent's language differs from your preferred language in Dynamics 365 Sales, you'll notice the following on the **Opportunity Research** page and in the **Summary** banner on the opportunity form:
...
The agent processes only those opportunities that meet the selection criteria defined by your admin in the Sales Opportunity Agent settings page. Learn more in [Configure selection criteria for opportunities](configure-sales-close-agent-research-selection-criteria.md).
...
The agent pauses when the admin turns it off. You see the following message in the banner: "Sales Opportunity Agent paused, data may be outdated and actions might be disabled." Contact your admin to [start the agent](start-sales-close-agent-research.md). 
