...
The Sales Close Agent - Research uses the language specified in the [agent settings](configure-opportunity-research-agent.md) to generate research insights. If the agent's language differs from your preferred language in Dynamics 365 Sales, you'll notice the following on the **Opportunity Research** page and in the **Summary** banner on the opportunity form:
