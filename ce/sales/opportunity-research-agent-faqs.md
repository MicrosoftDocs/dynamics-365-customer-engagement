...
The following screenshot illustrates this behavior, where the agent's language is set to German, and the user's preferred language is set to English.
:::image type="content" source="media/sales-close-agent-language-mismatch.png" alt-text="Screenshot showing the Opportunity Research page with section headings in English and insights in German." caption="Opportunity Research page with section headings in English and insights in German.":::
