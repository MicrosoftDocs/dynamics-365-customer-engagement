...
Configure the campaign behavior through the in-app marketing settings. For example, you can specify whether you want to create a campaign response automatically when a customer responds to a campaign email. 
...
2. In the Sales Hub app, go to the Change Area and select **App Settings**.
