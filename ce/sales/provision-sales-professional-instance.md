...
The Sales Professional app is a streamlined version of Dynamics 365 Sales, designed for small and medium-sized businesses that need essential sales force automation capabilities without the complexity of the full Dynamics 365 Sales application. This app is only supported with a specific Dynamics 365 Sales license. Learn more about licensing requirements in [Dynamics 365 Sales licensing guide](https://go.microsoft.com/fwlink/?linkid=2152923).
