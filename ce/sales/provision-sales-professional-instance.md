...
6. Enter or review the following, and then select **Save**.
   ...
   |Enable Dynamics 365 apps | Select **Yes**. If this is set to **No**, a Microsoft Dataverse environment will be created and you won't be able to install Sales Professional on this environment. |
