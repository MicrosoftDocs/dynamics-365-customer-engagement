...
Email validation runs immediately on the primary email address in lead records that are less than 180 days old. Subsequenly, the validation runs once in every 6 hours. A red envelope icon indicates an invalid email address. New primary email addresses added later are checked automatically.
