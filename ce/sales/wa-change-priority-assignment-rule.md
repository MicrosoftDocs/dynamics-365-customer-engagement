...
The priority of the rule is determined by its position in the list. When a record match the conditions of multiple rules, the rule with the highest priority is applied. You can view the priority of the rule in the **Priority** column.
