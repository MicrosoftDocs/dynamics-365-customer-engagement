...
When you open Copilot in Dynamics 365 Sales, Copilot doesn't respond, and you might see a message stating that Copilot is unable to connect and to try again later. There could be several reasons why Copilot isn't working as expected. One of the reason could be that your organization has [Data policies](/power-platform/admin/prevent-data-loss?tabs=new) which are blocking the following connectors.  
