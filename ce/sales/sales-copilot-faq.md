...
Copilot matches leads with contacts based on the lead's email address. The matches are ordered based last updated date of the contact record. If you want Copilot to use other fields for matching, you can work with your administrator to [configure the Dataverse search fields](/power-platform/admin/configure-relevance-search-organization).
