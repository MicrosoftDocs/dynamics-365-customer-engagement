...
Your Microsoft 365 admin needs to provide consent to let Dynamics 365 collect, store, and use Microsoft 365 data. This article describes the different consent types required by Dynamics 365 to generate insights. For more information about the insights generated, see [Insights generated from Microsoft 365 data](insights-from-m365.md).
...
The following table lists the consent types and list of Dynamics 365 applications that use the shared Microsoft 365 data. The list of applications is subject to change.
