...
2. Select **Settings** > **Org settings** > **Dynamics 365 Applications**.    
    ...
    > [!IMPORTANT]
    > If you've already provided consent in the **Dynamics 365 Sales Insights – Analytics** page, the consent will be valid until September 2022. After when, you must provide the consent in the new form as shown in the preceding screenshot. However, we recommend that you provide the consent as soon as you can.  
