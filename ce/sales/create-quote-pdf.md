...
> [!IMPORTANT]
> The Export to PDF functionality leverages a Word feature that does not generate a fully accessible PDF. If the generated PDF is not sufficient,
> 
> 1. Generate a Word template with [Use Word templates to create standardized documents](/power-platform/admin/using-word-templates-dynamics-365)
> 1. Open the Word document
> 1. Click File > Export > Create PDF/XPS Document
> 
> The Create PDF/XPS Document generates a more accessible PDF.
