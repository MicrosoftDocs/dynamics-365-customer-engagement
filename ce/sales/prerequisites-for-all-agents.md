...
To set up and use the built-in sales agents such as the Sales Qualification Agent, Sales Close Agent, and Data Enrichment, make sure you meet certain common prerequisites. Some agents may require additional prerequisites, which are covered in their respective agent setup articles.

## Verify prerequisites

You must be tenant administrator to set up the prerequisites.
...
- [Set up and configure AI-powered Data Enrichment (preview)](data-enrichment-agent-configure.md)