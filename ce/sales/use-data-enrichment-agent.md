...
- By selecting the suggestions in the **Suggested actions** carousel. This option allows you to see all available data enrichment suggestions for a record type in one place. For more information, see [View Data Enrichment suggestions for all your records](#view-data-enrichment-suggestions-for-all-your-records).
...
### View Data Enrichment suggestions for all your records

The **Suggested actions** carousel provides a quick view of the next best actions available for your records, including the suggestions generated by Data Enrichment. The carousel surfaces suggestions for all eligible records that you own, so you can easily access and review them. This option eliminates the need to open each record individually to check for suggestions.
...
1. Switch to the read-only grid view by selecting **Read Only Grid** from the top of the list. 
