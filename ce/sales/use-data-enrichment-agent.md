...
> [!IMPORTANT]
> Your admin must have enabled the **Recommended action** connected skill for Data Enrichment to display suggestions in the carousel. Learn more in [Enable connected skills](data-enrichment-agent-edit-settings.md#enable-connected-skills).
