...
1. Expand the **Summary** component and select the **Data Enrichment Suggestions** button if it's available. 
   The **Data Enrichment** pane opens, showing you the suggestions generated by the agent based on its analysis of your emails.
1. In the **Suggestions** tab, hover over the information icon next to each suggestion to see details about the source of the suggestion. 
...
1. Open your opportunity record in the Sales Hub app.
   Wait for the **Summary** component to load. If data enrichment suggestions are available for the record, you see the **Data Enrichment Suggestions** button when you expand the **Summary** component. 
1. Select **Data Enrichment suggestions**. 
