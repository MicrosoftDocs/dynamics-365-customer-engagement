...
1. Select the stacked cards.
   The list of opportunities with suggestions appears in the **Opportunities with pending enrichment** view.
1. Select an opportunity from the list to open the Data Enrichment pane and review the suggestions for that opportunity.
