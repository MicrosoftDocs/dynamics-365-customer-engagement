---
title: "Track a marketing campaign response by using in-app marketing | MicrosoftDocs"
...
searchScope: 
  ...
  - Sales
---
# Track a marketing campaign response by using in-app marketing

Record the replies you get from potential customers in response to a specific marketing campaign to make sure your team can act on the responses. Measure the success of specific campaign activities based on cutomer response rates. You can manually create campaign responses or have [!INCLUDE[pn-dyn-365-sales](../includes/pn-dyn-365-sales.md)] generate them automatically.  
