...
1. **Analyze recent changes**: The agent scans emails exchanged between sellers and customers to gather context about selected opportunities. It looks for deal signals, competitive context, and customer background information that can help enrich the opportunity records.
