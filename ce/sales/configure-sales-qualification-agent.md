...
- (Optional but recommended) 
    - You turned on Copilot in Dynamics 365 Sales to allow your sellers to get a 360-degree view of the lead and their company. Learn more in [Turn on and set up Copilot in Dynamics 365 Sales](enable-setup-copilot.md) and [Get information from Copilot](copilot-get-information.md).
 
    - You configured server-side synchronization to allow the sellers send emails generated by the agent. Learn more in [Set up email by integrating with Exchange](configure-email.md).
