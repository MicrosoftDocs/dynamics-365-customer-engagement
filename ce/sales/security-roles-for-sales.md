...
| Sales Professional Manager | Users who manage a team of sellers and are responsible for the team's performance. They are also responsible for creating and managing product SKUs, price lists, and unit groups.  | Sales Professional | Access to product, account and contact management. |
| Sales Professional app access | Users who need to access the Sales Professional app. For example, if you would like sellers to access the app, assign this role in addition to the Sales Professional Person role to your sellers.  | Sales Professional | Access to the Sales Professional App. |
