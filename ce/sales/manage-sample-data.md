...
> [!NOTE]
> - The sample data is added for basic Dynamics 365 Sales record types. More information: [Record types updated with sample data](#record-types-updated-with-sample-data)  
