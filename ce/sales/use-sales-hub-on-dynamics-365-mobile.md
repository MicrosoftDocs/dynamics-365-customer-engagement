...
3. Use the site map to get to your work area, create a new record, search, or do other tasks. To access the site map, tap **Menu** (![Site map icon](media/MenuButton.png "Site map icon")) at the top-left of the screen.
