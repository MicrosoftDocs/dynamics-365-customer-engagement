...
| Based on this, the agent pulls the right products from Dynamics 365 and proposes them to the customer.                                                                   | `read_query`                                      | Dataverse MCP server and custom connector      |
