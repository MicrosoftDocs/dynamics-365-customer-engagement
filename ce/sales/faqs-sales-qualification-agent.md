...
- Drafts an initial outreach email to the lead based on a fixed email template or personalization instructions as defined by the sales team. Sellers can review and send the draft email.
...
- **Initial outreach email**: Sellers can review the draft outreach email generated by the agent based on a fixed email template or personalization instructions. Sellers can then edit the email if needed before sending it to the lead.
