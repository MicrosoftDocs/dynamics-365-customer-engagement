...
Just like with subgrids, adding notes to your managed forms on the portal is easy&mdash;just add the notes control to the Dynamics 365 for Customer Engagement form through the out-of-the-box Dynamics 365 for Customer Engagement form designer and you're done. You can configure the behavior of the notes control by using metadata.
...
If you created a custom form in Dynamics 365 for Customer Engagement and added the notes section to it, be sure to select **Notes** as the default tab you want to be visible.
