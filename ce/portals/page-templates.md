...
When creating a new web page for the site, whether through front-side publishing or through the Dynamics 365 for Customer Engagement interface, you must select a page template which will present the page's content to users of the portal.
...
|Entity Name   |The Dynamics 365 for Customer Engagement page entity type that this template expects to render. This will be use by the front-side editing system to present only appropriate template choices to content authors.<br>Usually, this will be Web Page (adx_webpage), but may be another portal entity, such as Forum, Forum Thread, Blog, or Blog Post.   |
