...
When creating a new web page for the site, whether through front-side publishing or through the [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] interface, you must select a page template which will present the page's content to users of the portal.
...
|Entity Name   |The [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] page entity type that this template expects to render. This will be use by the front-side editing system to present only appropriate template choices to content authors.<br>Usually, this will be Web Page (adx_webpage), but may be another portal entity, such as Forum, Forum Thread, Blog, or Blog Post.   |
