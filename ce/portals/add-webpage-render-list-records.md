...
```
[//]: # (What does "each cell that is for the attribute..." mean? Should it be something like "each cell that displays the value of the accountnumber attribute..."?)
...
[//]: # (In the Entity Form note, what does "it will be ignored" refer to? If there is no entity form, there would be nothing to ignore. This query applies to all similar instances of "it will be ignored" in similar contexts.)
| Name               | Description                          |
|--------------------|--------------------------------------|
| **Basic Settings**     |                                                                                                                                                                       |
...
[//]: # (Edit from "pinpoints" to "pushpins" okay? Bing Maps talks about "pushpin icons.")
