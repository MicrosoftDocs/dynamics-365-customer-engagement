...
description: "Instructions to add a model-driven app chart to a webpage in the portal."
ms.custom: 
  - dyn365-portal
ms.date: 12/03/2018
...
# Add a model-driven app chart to a webpage in portal
...
![Model-driven app chart example](media/dynamics365-chart-example.png "Model-driven app chart example")
...
4.	Select **More Commands**, and then select **Export Chart**.
    ...
    ![Export a model-driven app chart](media/export-dynamics365-chart.png "Export a model-driven app chart")

5. Open the XML file of the exported chart in a text editor.
6. Copy the value of the \<visualizationid\> tag.

    ![Get chartid for a model-driven app chart](media/dynamics365-chart-chartid.png "Get the chart ID for a model-driven app chart")
...
The following model-driven app chart types are currently not supported in Dynamics 365 Portals:
- Doughnut
- Tag

The following table lists the model-driven app charts that are currently not supported in Dynamics 365 Portals.
