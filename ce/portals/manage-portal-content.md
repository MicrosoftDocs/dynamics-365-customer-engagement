...
-   Create links to internal or external pages to help users find the right information. [!INCLUDE[proc-more-information](../includes/proc-more-information.md)] [Manage web links in [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] or on portals](manage-web-links.md)  
