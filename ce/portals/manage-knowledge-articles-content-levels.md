...
3.  Change **Default Access Level** from **No** to **Yes** if it should be the default.
...
1.  Select the Contact you wish to edit.

2.  Under the **Details** tab, find the **Content Access Levels** section.
