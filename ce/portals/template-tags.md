...
Includes the contents of one template in another, by name. In Dynamics 365 for Customer Engagement portals, the source of this other template will generally be a [web template](store-content-web-templates.md). This allows for the reuse of common template fragments in multiple places.  
...
In Dynamics 365 for Customer Engagement portals, the parent template name provided to the tag will generally refer to the name of a [web template](store-content-web-templates.md).  
