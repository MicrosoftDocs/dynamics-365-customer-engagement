...
2. Select the name of the portal you want to enable maintenance mode for, and then select **Manage**.
...
2. Select the name of the portal for which you want to disable maintenance mode, and then select **Manage**.
...
4. Modify the settings as required, and select **Update**. For example, you might choose to display the default page if you've selected to display the custom page earlier.

5. To disable maintenance mode, select **Disable**. While maintenance mode is being updated or disabled, the portal restarts and is unavailable for a few minutes.
