...
[//]: # (I'm not sure "main form of the entity form record" makes sense, but we can't just drop a whole topic title into a sentence when it makes the sentence ungrammatical. In this case, it seemed best to move the link out of the paragraph altogether.)
To add subgrid metadata to an entity form, go to **Entity Form Metadata** by using either the top drop-down list or the subgrid on the main form of the entity form record that you are working with. [!include[](../includes/proc-more-information.md)] [Define entity forms and custom logic within the Dynamics 365 portal](entity-forms-custom-logic.md)
...
Enabling a **Create action** renders a button above the subgrid that, when selected, opens a dialog box with an [entity form](entity-forms-custom-logic.md) that allows a user to create a new record.  
...
|-----------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Basic Settings**    |                                                                                                                                                                                                                                                             |
| Entity Form           | Specifies the [entity forms and custom logic](entity-forms-custom-logic.md) that will be used to create the new record. The drop-down list includes all entity forms that are configured for the subgrid's entity type.<br>**Note**: If the subgrid's entity type has no entity forms, the drop-down list will appear empty. If no entity form is supplied for the Create action it will be ignored, and the button will not be rendered on the subgrid's entity form.                                |
| **Advanced Settings** |                                                                                                                                                                                                                                                             |
...
[//]: # (In the View note, what does "it will be ignored" refer to? If there is no view supplied for the Associate action, there would be nothing to ignore. This query applies to all similar instances of "it will be ignored" in similar contexts.)
| Name                  | Description                                                                                                                                                                                                                |
|-----------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Basic Settings**    |                                                                                                                                                                                                                            |
...
|---------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Basic Settings**                    |                                                                                                                                                                                                                                                                                                              |
| Entity Form                           | Specifies the [entity form](entity-forms-custom-logic.md) that will be used to edit the selected record. The drop-down list will include all entity forms that are configured for the subgrid's entity type.<br>**Note**: If the subgrid's entity type has no entity forms, the drop-down list will appear empty. If no entity form is supplied for the Edit action, it will be ignored, and the button will not be rendered in the subgrid.                                                                                                 |
| **Advanced Settings**                 |                                                                                                                                                                                                                                                                                                              |
