...
Use the polls capability of [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] portals to ask your audience about topics of interest and let them give single answers or multiple-choice responses. Either way, their responses are instantly stored and associated with the applicable [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] Contact record for immediate review or aggregate reporting. You can use polls as simple market research tools and, if you refresh or rotate the polls dynamically, you'll keep your website looking current and topical.
