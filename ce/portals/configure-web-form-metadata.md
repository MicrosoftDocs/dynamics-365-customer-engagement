...
The Web Form Metadata contains additional behavior modification logic to augment or override the functionality of form fields that is otherwise not possible with Dynamics 365 for Customer Engagement's native entity form editing capabilities.
...
|         Label          | Replaces the default label assigned to the attribute on the entity with the text specified in this input. For each language pack installed and enabled for the Dynamics 365 for Customer Engagement organization a field will be available to enter the message in the associated language. |
...
|         Name         |                                                                                                                                                                                                                                                                Description                                                                                                                                                                                                                                                                 |
|----------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Ignore Default Value |                                                                              Ignores the default value of the specified attribute field. Useful for attributes that are Two Option fields that are rendered as Yes and No radio buttons. Because Dynamics 365 for Customer Engagement automatically assigns a value of yes or no by default, this option makes it possible to display Yes/No questions without a predefined response.                                                                               |
...
For each language pack installed and enabled for the Dynamics 365 for Customer Engagement organization, a field will be available to enter the message in the associated language.
...
|     Name     |                                                                                                                                                   Description                                                                                                                                                    |
|--------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Section Name |                                                                                           The name of the section on the entity's form in Dynamics 365 for Customer Engagement to be modified.                                                                                            |
|    Label     | Replaces the default label assigned to the section on the entity with the text specified in this input. For each language pack installed and enabled for the Dynamics 365 for Customer Engagement organization a field will be available to enter the message in the associated language. |
...
|   Name   |                                                                                                                                                 Description                                                                                                                                                  |
|----------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Tab Name |                                                                                           The name of the tab on the entity's form in Dynamics 365 for Customer Engagement to be modified.                                                                                            |
|  Label   | Replaces the default label assigned to the tab on the entity with the text specified in this input. For each language pack installed and enabled for the Dynamics 365 for Customer Engagement organization a field will be available to enter the message in the associated language. |
