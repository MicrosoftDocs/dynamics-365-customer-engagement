...
[//]: # (Is it "the" or "a" Facebook App? Or maybe it should be "the Facebook App portal"?)
### [Authenticate the Facebook App](authenticate-facebook-app.md)
...
[//]: # (SELF: Use a token in this heading? I believe the product name is "Dynamics 365 for Project Service Automation")
### [Integrate Project Service Automation](integrate-project-service-automation.md)
[//]: # (SELF: There's a simple "Field Service" token, maybe there's a full, formal one?)
...
[//]: # (Note to self: Still not clear about "front-side editing engine" versus "content engine.")
...
[//]: # (SELF: "Crowdsource" isn't used in the topic text.)
