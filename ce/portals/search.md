...
In Dynamics 365 for Customer Engagement Portal, you can search for records across multiple entities by using portal’s global search functionality. You can also search within records of entity lists using entity list search functionality. 
...
Global search of Dynamics 365 for Customer Engagement Portal allows you to search for records across multiple entities. It also allows you to search across multiple columns and configure what columns of an entity would be searchable.
...
The following sections detail how global search works in Dynamics 365 for Customer Engagement Portal and describe the various configuration options available.
...
Search index updates in Dynamics 365 for Customer Engagement Portal happen automatically like the cache invalidation. Keep these important things in mind, though:
...
- It is advisable to rebuild the full index manually after performing a bulk data migration or bulk updates to Dynamics 365 for Customer Engagement records within a short span of time. For details, see [Rebuild full search index](#rebuild-full-search-index).
...
- A website record, associated to your portal, is changed in a Dynamics 365 for Customer Engagement organization.
