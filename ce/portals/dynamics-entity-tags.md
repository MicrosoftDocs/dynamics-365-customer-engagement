...
> [!NOTE]
> For the tag to work, you must [enable Power BI integration](set-up-power-bi-integration.md) from PowerApps Portals admin center. If the Power BI integration is not enabled, dashboard or report will not be displayed.
