...
Adds a Dynamics 365 for Customer Engagement chart to a web page. The chart tag can be added in the Copy field on a Web Page or in the Source field on a Web Template. For steps to add a Dynamics 365 for Customer Engagement chart to a web page, see [Add a Dynamics 365 for Customer Engagement chart to a web page in portal](add-chart.md).
...
A Dynamics 365 for Customer Engagement integer language code to select the entity list localized labels to be loaded. If no language\_code is provided, the default language of the portal application Dynamics 365 for Customer Engagement connection will be used.
...
Loads a given Dynamics 365 for Customer Engagement view, by name or ID. The properties of the view ߝ view column metadata, paginated result records, etc. can then be accessed using an [entityview object](liquid-objects.md#entityview) that will be available within the tag block.  
...
Provide **either** id **or** logical\_name with name to select the Dynamics 365 for Customer Engagement view to load. If neither is provided, and the entityview tag is nested within an entitylist tag, the default view of the enclosing entitylist will be loaded.
...
The Dynamics 365 for Customer Engagement entity logical name of the view to be loaded. Must be used in combination with name.
...
The Dynamics 365 for Customer Engagement name of the view to be loaded. Must be used in combination with logical\_name.
...
A Dynamics 365 for Customer Engagement integer language code to select the entity view localized labels (column header labels, etc.) to be loaded. If no language\_code is provided, the default language of the portal application Dynamics 365 for Customer Engagement connection will be used.
...
The Dynamics 365 for Customer Engagement entity logical names to which matching results will be restricted, as a comma-delimited string. If not provided, all matching entities will be returned.
...
Fully renders a Dynamics 365 for Customer Engagement-configured [entity forms](entity-forms-custom-logic.md), by name or ID.  
