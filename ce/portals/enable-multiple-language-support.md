...
To enable multiple languages for a portal, follow these steps after signing in to Dynamics 365 for Customer Engagement:

1. [Enable languages in a Dynamics 365 for Customer Engagement organization.](https://technet.microsoft.com/library/dn832148.aspx)  
...
The table below shows all the languages currently available out of the box. This list can be found in Dynamics 365 for Customer Engagement by going to **Portals** &gt; **Content** &gt; **Portal Languages**. The Portal Display Name of a language can be changed after selecting the language to change from this page. Note that the list now includes East Asian languages (Japanese, Chinese, and Korean).
