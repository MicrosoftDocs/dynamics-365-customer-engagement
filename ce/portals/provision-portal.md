...
5.  In the **Portal URL** field, enter the subdomain name you want for your portal. You can only use alphanumeric characters or hyphens (-); other characters are not permitted.
    ...
    > - To link your portal to a custom domain, see [link your Portals to a custom domain](manage-portal.md#link-your-dynamics-365-portals-to-a-custom-domain).
...
6.  In the **Dynamics 365 Instance** drop-down list, select the instance you want to link the portal to. This requires System Administrator or System Customizer role in the instance you pick to select it.
    ...
    > [!NOTE]
    > You can also select an instance that uses Common Data Service to provision a Common Data Service starter portal. More information: [Common Data Service starter portal](cds-portal.md)
...
The Portalsapp allows you to configure and manage your online platform to communicate and collaborate with customers. 

When you install Portals version 9.0 and higher, the Portalsapp, built on the Unified Interface framework, is created out-of-the-box.

### Open Portalsapp

1.	Sign in to Portals.
2.	Open the URL `<organization URL>/apps` or go to **Settings** > **My Apps**. 
3.	Select the Portalsapp.
