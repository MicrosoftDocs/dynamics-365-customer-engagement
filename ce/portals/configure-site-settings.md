...
The sample portals that are provided with the installation of [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)] portals contain [several configurable site settings](https://community.adxstudio.com/products/adxstudio-portals/documentation/end-users-guide/content-management/settings-templates/site-settings/site-settings/) for various styles used to modify many visual elements within the site such as background style, text color, and layout width.
