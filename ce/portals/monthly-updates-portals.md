---
title: "Monthly updates in Portals | MicrosoftDocs"
description: "Learn about what's new in the latest release of Portals."
...
Welcome to Portals. Here's a list of recently added features. For more information updates for Portals to date, see [portal capabilities for Microsoft Dynamics 365 Releases](https://support.microsoft.com/en-us/help/3181191).

## Portals version 9.1.4 for the model-driven apps in Dynamics 365

Portals version 9.1.4 for the model-driven apps in Dynamics 365 brings these new updates and features:
...
## Portals version 9.1.1 for the model-driven apps in Dynamics 365

Portals version 9.1.1 for the model-driven apps in Dynamics 365 brings these new updates and features:
...
## Portals version 9.0.10 for the model-driven apps in Dynamics 365

Portals version 9.0.10 for the model-driven apps in Dynamics 365 brings these new updates and features:

- **Migrate Portals configuration**: You can now migrate your Portals configuration from development to testing or the production environments. Migration involves exporting the existing configuration from the source Dynamics 365 instance, and then importing it into the target Dynamics 365 instance. To migrate configuration data, you need to use the Configuration Migration tool and a portal-specific configuration schema file. More information: [Migrate Portals configuration](migrate-portal-configuration.md)
...
## Portals version 9.0.6 for the model-driven apps in Dynamics 365

Portals version 9.0.6 for the model-driven apps in Dynamics 365 has brought the following latest updates and features:

- **Dynamics 365 Portals app**: The Dynamics 365 Portals app provides a new experience to configure and manage your online platform to communicate and collaborate with customers. When you install Portals version 9.0 and higher, the Dynamics 365 Portals app, built on the Unified Interface framework, is created out-of-the-box.
...
## Portals version 8.4.1 for the model-driven apps in Dynamics 365

Portals version 8.4.1 for the model-driven apps in Dynamics 365 brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
## Portals version 8.4 for the model-driven apps in Dynamics 365

Portals version 8.4 for the model-driven apps in Dynamics 365 brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
- **Renew portal authentication key**: A portal connects to Common Data Service organization using Azure active directory application. To do this, it requires an authentication key connected to Azure Active Directory application. This key is added when you provision your portal and it must be renewed every two years. This version of portal brings in the capability for administrators to be notified about key expiration and renew this key from Portal Admin Center. More information: [Renew portal authentication key](connect-with-dynamics.md)
...
## Portals version 8.3 for the model-driven apps in Dynamics 365

Portals version 8.3 for the model-driven apps in Dynamics 365 has many new updates and features:
...
The December 2016 update has brought many new features to Portals. These updates allow for better interactions among companies, partners, and customers, and make the experience of navigating the portal faster and easier. Some of the major updates include:
