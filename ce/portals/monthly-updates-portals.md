...
# What's new in portal capabilities for Microsoft Dynamics 365

Welcome to portal capabilities for Microsoft Dynamics 365. Here's a list of recently added features. For more information updates for Dynamics 365 Portals to date, see [portal capabilities for Microsoft Dynamics 365 Releases](https://support.microsoft.com/en-us/help/3181191).

## Portal capabilities version 9.1.4 for the model-driven apps in Dynamics 365

Portal capabilities version 9.1.4 for the model-driven apps in Dynamics 365 brings these new updates and features:
...
## Portal capabilities version 9.1.1 for the model-driven apps in Dynamics 365

Portal capabilities version 9.1.1 for the model-driven apps in Dynamics 365 brings these new updates and features:
...
## Portal capabilities version 9.0.10 for the model-driven apps in Dynamics 365

Portal capabilities version 9.0.10 for the model-driven apps in Dynamics 365 brings these new updates and features:
...
## Portal capabilities version 9.0.6 for the model-driven apps in Dynamics 365

Portal capabilities version 9.0.6 for the model-driven apps in Dynamics 365 has brought the following latest updates and features:
...
## Portal capabilities version 8.4.1 for the model-driven apps in Dynamics 365

Portal capabilities version 8.4.1 for the model-driven apps in Dynamics 365 brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
## Portal capabilities version 8.4 for the model-driven apps in Dynamics 365

Portal capabilities version 8.4 for the model-driven apps in Dynamics 365 brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
## Portal capabilities version 8.3 for the model-driven apps in Dynamics 365

Portal capabilities version 8.3 for the model-driven apps in Dynamics 365 has many new updates and features:
