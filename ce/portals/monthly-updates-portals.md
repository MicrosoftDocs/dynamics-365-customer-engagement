...
## Portal capabilities version 9.0.6 for Dynamics 365 for Customer Engagement
...
## Portal capabilities version 8.4.1 for Dynamics 365 for Customer Engagement
...
## Portal capabilities version 8.4 for Dynamics 365 for Customer Engagement
...
## Portal capabilities version 8.3 for Dynamics 365 for Customer Engagement
...
- **Portal interaction tracking (preview)**: Use this preview feature to track a customer's interaction with your portal and funnel it to [!include[](../includes/pn-customerinsight-full.md)]. This will be helpful for plotting a 360-degree view of the user’s journey on your portal before and after a case is created. This also helps you to understand the real issue, avoid asking the user for the same information over again, and enable you to respond with relevant information.
  ...
  > [!NOTE]
  > The preview for this feature has ended. For more information on Microsoft Dynamics 365 for Customer Insights preview, click [here](https://docs.microsoft.com/dynamics365/customer-engagement/customer-insights/preview-retire).
