...
Welcome to portal capabilities for Dynamics 365 for Customer Engagement apps. Here's a list of recently added features. For more information about portal capability updates for Dynamics 365 for Customer Engagement apps to date, see [portal capabilities for Microsoft Dynamics 365 for Customer Engagement Releases](https://support.microsoft.com/en-us/help/3181191).

## Portal capabilities version 9.1.4 for Dynamics 365 for Customer Engagement apps

Portal capabilities version 9.1.4 for Dynamics 365 for Customer Engagement apps brings these new updates and features:
...
- **Common Data Service starter portal (preview)**: As a portal administrator, you can now configure your portal to connect to the Common Data Service environment and allow your users to interact with it. This feature brings in the ability to connect a portal to a Common Data Service environment that does not have any Dynamics 365 for Customer Engagement apps (Sales, Service, or Marketing) preinstalled. More information: [Common Data Service starter portal](cds-portal.md)

## Portal capabilities version 9.1.1 for Dynamics 365 for Customer Engagement apps

Portal capabilities version 9.1.1 for Dynamics 365 for Customer Engagement apps brings these new updates and features:
...
Portal capabilities version 9.0.10 for Dynamics 365 for Customer Engagement apps brings these new updates and features:

- **Migrate Dynamics 365 for Customer Engagement Portal configuration**: You can now migrate your Dynamics 365 for Customer Engagement Portal configuration from development to testing or the production environments. Migration involves exporting the existing configuration from the source Dynamics 365 for Customer Engagement instance, and then importing it into the target Dynamics 365 for Customer Engagement instance. To migrate configuration data, you need to use the Configuration Migration tool and a portal-specific configuration schema file. More information: [Migrate Dynamics 365 for Customer Engagement Portal configuration](migrate-portal-configuration.md)
...
- **Manage SharePoint documents**: Dynamics 365 for Customer Engagement Portal now supports uploading and displaying documents to and from SharePoint directly on an entity form or web form in a portal. This allows portal users to view, download, add, and delete documents from a portal. Portal users can also create folders to organize their documents. More information: [Manage SharePoint documents](manage-sharepoint-documents.md)

- **New portal content editor (preview)**: In this preview, a new and simplified portal editor is available for Dynamics 365 for Customer Engagement Portal customizers to reduce the learning curve on Dynamics 365 for Customer Engagement Portal customization and increase a customizer's productivity. More information: [Get started with the new portal content editor](portal-new-content-editor.md)
...
Portal capabilities version 9.0.6 for Dynamics 365 for Customer Engagement apps has brought the following latest updates and features:
...
Portal capabilities version 8.4.1 for Dynamics 365 for Customer Engagement apps brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
Portal capabilities version 8.4 for Dynamics 365 for Customer Engagement apps brings in a bunch of bug fixes, as well as performance improvements, along with the following features:
...
- **Renew portal authentication key**: A portal connects to Dynamics 365 for Customer Engagement organization using Azure active directory application. To do this, it requires an authentication key connected to Azure Active Directory application. This key is added when you provision your portal and it must be renewed every two years. This version of portal brings in the capability for administrators to be notified about key expiration and renew this key from Portal Admin Center. More information: [Renew portal authentication key](connect-with-dynamics.md)
...
Portal capabilities version 8.3 for Dynamics 365 for Customer Engagement apps has many new updates and features:
...
- **Source code availability for portals**: A one-time release of portal capabilities code is released to the Microsoft Download Center under MIT license for developers to download. This feature enables portals to be deployed to Dynamics 365 for Customer Engagement on-premises or online environments, and allows developers to customize the code to suit their specific business needs.
...
- **Allowing non-global administrators to provision a portal**: You can now provision a portal if you are assigned to the System Administrator role of the CRM organization selected for the portal. You can now also manage an existing portal, if you have any of the following roles:
  - Dynamics 365 for Customer Engagement Service Administrator
...
The December 2016 update has brought many new features to the portal capabilities of Dynamics 365 for Customer Engagement apps. These updates allow for better interactions among companies, partners, and customers, and make the experience of navigating the portal faster and easier. Some of the major updates include:
