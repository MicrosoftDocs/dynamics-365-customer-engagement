...
4.	On the **Login** screen, provide authentication details to connect to your instance from where you want to export data. If you have multiple organizations on the instance and want to select the organization from where to export the data, select the **Display list of available organizations** check box, and then select **Login**.

    > [!div class=mx-imgBorder]
    ![Provide authentication details to connect to your  instance from where you want to export data](media/export-config-login.png "Provide authentication details to connect to your instance from where you want to export data")
