...
> - The minimum solution version of Dynamics 365 for Customer Engagement Portal supported by schema files for configuration migration is 8.4.0.275. However, we recommend that you use the latest solution version.
...
4.	On the **Login** screen, provide authentication details to connect to your Dynamics 365 for Customer Engagement instance from where you want to export data. If you have multiple organizations on the Dynamics 365 for Customer Engagement instance and want to select the organization from where to export the data, select the **Display list of available organizations** check box, and then select **Login**.
...
5.	If you have multiple organizations, and you had selected the **Display list of available organizations** check box in the previous step, the next screen allows you to choose the organization that you want to connect to. Select a Dynamics 365 for Customer Engagement organization to connect to. 
...
3.	If you have multiple organizations, and you had selected the **Display list of available organizations** check box in the previous step, the next screen allows you to choose the organization that you want to connect to. Select a Dynamics 365 for Customer Engagement organization to connect to. 
