...
After the storage account is running, portals require certain global settings that tell the application how to locate your storage account. From [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)], go to **Portals** > **Site Settings**, and add a new setting named **FileStorage/CloudStorageAccount**.
...
From [!INCLUDE[pn-dynamics-crm](../includes/pn-dynamics-crm.md)], go to **Portals** > **Site Settings**, and add a new setting named FileStorage/CloudStorageContainerName, using the name of your container as the value.
