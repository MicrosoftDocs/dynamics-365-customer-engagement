...
The entitylist object is used within the [PowerApps entity tags](dynamics-entity-tags.md). It provides access to all the attributes of a given entity list.  
...
The searchindex object is used within the [PowerApps entity tags](dynamics-entity-tags.md), and provides access to the results of a query.  
