...
Learn how to configure portals and customize [!INCLUDE[pn-microsoftcrm](../includes/pn-microsoftcrm.md)]. Dynamics 365 Portals offer powerful customization options to:
...
- [Get Dynamics 365 data on the Portal](walkthrough-get-data-on-portal.md)
