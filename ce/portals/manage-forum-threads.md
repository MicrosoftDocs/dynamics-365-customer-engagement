...
## Manage forum threads in QWE Portals

You can create, edit, and delete forum threads in QWE Portals.

> [!Note]
> Although you can create forum threads in QWE Portals, we recommend you do this from the portal content editor, where the process is less involved and ensures the thread is correctly associated with the original forum post.
...
## Manage forum thread types in QWE Portals
