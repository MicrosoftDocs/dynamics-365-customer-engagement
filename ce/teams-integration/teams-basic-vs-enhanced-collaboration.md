...
Basic Collaboration Experience needs to be enabled to share documents between a connected Microsoft Teams channel and your customr engagement apps record. To learn how to turn on Basic or Enhanced collaboration, see [Install and setup Microsoft Teams integration](teams-install-app.md).
