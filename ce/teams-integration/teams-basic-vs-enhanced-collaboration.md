...
|**Enhanced Collaboration Experience**    | <ul><li>You need Office 365 tenant admin permissions to enable this feature. </li><br/>  <li>When you choose the **Collaborate** option on a record or view page, a set-up wizard in Common Data Service will guide you through the connection process between a model-driven app record or view with Microsoft Teams collaboration.</li><br/> <li>You can manually pin a model-driven app record from within the Microsoft Teams app and have the option to add recommended members if you are the team owner.</li><br/>  </ul>  
