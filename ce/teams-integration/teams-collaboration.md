...
From a team channel, you can connect a Dynamics 365 apps record or view to collaborate on customer accounts,  opportunities, and so on as follows. 
...
2. Select the **Dynamics 365** icon to pin a Dynamics 365 apps record to a channel.
...
- **Entity Selection**
   ...
   > ![Search for entity](media/teams-add-channel-pin-record2.png "Search for entity")
    ...
    Once you complete the above steps, you'll see a notification of a successful connection and the Dynamics 365   apps record appears in the menu bar. You can interact with the record as if you were using the Dynamics 365     apps. Those with Write permissions can edit the record. Changes will be synchronized with the Dynamics 365  apps.
...
- **View Selection**
   ...
   Once you complete the above steps, you'll see the Dynamics 365 app entity view in the new added tab.
