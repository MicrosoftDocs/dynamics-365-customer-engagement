...
- **Access all your recent Dynamics 365 chats**: The list pages, such as the Opportunities list page, display all of the user's recent chats that are linked to Dynamics 365 records.
