...
Additionally, sellers can use Conversation Intelligence capabilities (if enabled by their administrators) during the meeting to focus on customer conversations while the solution takes care of capturing action items and surfacing valuable business insights in real-time.
...
- Dynamics 365 Customer Service: [Enable Microsoft Teams meeting integration](../customer-service/configure-teams-meetings.md)
