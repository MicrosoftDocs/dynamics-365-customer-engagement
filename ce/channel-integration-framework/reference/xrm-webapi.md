---
title: "Xrm.WebApi (JavaScript API Reference) for Channel Integration Framework (CIF) in Dynamics 365 | MicrosoftDocs"
description: ""
keywords: ""
ms.date: 10/01/2018
ms.service:
...
ms.assetid: 88AF58E3-2A00-453C-99B1-97D6954F7374
author: kabala123
ms.author: kabala
manager: shujoshi
---

# Xrm.WebApi (JavaScript API Reference)

Provides methods to use Web API to create and manage records and execute Web API actions and functions in Customer Engagement.
