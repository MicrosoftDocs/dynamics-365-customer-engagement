...
9. Select **Create** to create the Azure app service, and save the app service URL for future use.
   ...
   ![Select Create to publish app on Azure.](../../../customer-service/channel-integration-framework/media/publish-app-azure.PNG "Select Create to publish app on Azure")<br />
