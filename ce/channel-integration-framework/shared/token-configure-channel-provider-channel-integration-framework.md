...
2. Select the dropdown button on the Dynamics 365 and select **Channel Integration Framework**.
  ...
  ![Dynamics 365 dropdown button to find Channel Integration Framework.](../../customer-service/channel-integration-framework/media/cif-app-navigation.png "Dynamics 365 drop-down button to find Channel Integration Framework")
