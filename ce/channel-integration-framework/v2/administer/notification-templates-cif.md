...
- The agent is working on another tab of the browser.
 ...
 > ![Desktop notification.](../../../customer-service/channel-integration-framework/media/desktop-notification.png "Desktop notification")
...
Also, as an administrator, you can set the browser notification permission by using group policy.
 ...
 > [!div class=mx-imgBorder]
 > ![Allow desktop notifications.](../../../customer-service/channel-integration-framework/media/allow-desktop-notification.png "Allow desktop notifications")
