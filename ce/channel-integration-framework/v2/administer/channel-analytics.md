...
![Enable channel analytics using user interface.](../../../customer-service/channel-integration-framework/media/enable-channel-analytics.PNG "Enable channel analytics")
