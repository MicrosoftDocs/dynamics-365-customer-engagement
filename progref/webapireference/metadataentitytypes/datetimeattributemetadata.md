---
title: "DateTimeAttributeMetadata EntityType| MicrosoftDocs"
ms.date: "2017-07-10"
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: 5f46cd45-d647-4f20-84d0-dc771552c5d8
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
---
...
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/datetimeattributemetadata.md](./descriptions/datetimeattributemetadata.md)]</td></tr>
<tr><td><b>Base Type:</b></td><td>[AttributeMetadata EntityType](attributemetadata.md)</td></tr>
<tr><td><b>Primary Key:</b></td><td>MetadataId</td></tr>
</table>
 
 The DateTimeAttributeMetadata EntityType:
* Has no single-valued navigation properties.
* Has no collection-valued navigation properties.
* Is not explicitly used by any operations but may be referenced using [AttributeMetadata EntityType](attributemetadata.md).
...
|CanChangeDateTimeBehavior|[BooleanManagedProperty ComplexType](../complextypes/BooleanManagedProperty.md)|Whether the date and time behavior can be changed for the attribute. |
...
|DateTimeBehavior|[DateTimeBehavior ComplexType](../complextypes/DateTimeBehavior.md)|The behavior of the DateTime attribute.|
...
|Format|[DateTimeFormat EnumType](../enumtypes/DateTimeFormat.md)|The date/time display format.|
|FormulaDefinition|Edm.String|The formula definition for calculated and rollup attributes.|
...
|ImeMode|[ImeMode EnumType](../enumtypes/ImeMode.md)|The input method editor (IME) mode for the attribute.|
...
|MaxSupportedValue|Edm.DateTimeOffset|The maximum supported value for this attribute.|
|MetadataId|Edm.Guid|A unique identifier for the metadata item.<br />Inherited from [MetadataBase EntityType](metadatabase.md).|
|MinSupportedValue|Edm.DateTimeOffset|The minimum supported value for this attribute.|
...
|SourceTypeMask|Edm.Int32|A bitmask value that describes the sources of data used in a calculated attribute or whether the data sources are invalid.|
