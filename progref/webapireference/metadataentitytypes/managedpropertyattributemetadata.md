---
title: "ManagedPropertyAttributeMetadata EntityType| MicrosoftDocs"
ms.date: 07/10/2017
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: e778b4ed-8296-4f92-92b7-22ae66c3e3f0
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
---
...
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/managedpropertyattributemetadata.md](./descriptions/managedpropertyattributemetadata.md)]</td></tr>
...
<tr><td><b>Primary Key:</b></td><td>MetadataId</td></tr>
 ...
 The ManagedPropertyAttributeMetadata EntityType:
...
|ManagedPropertyLogicalName|Edm.String|For internal use only.|
|MetadataId|Edm.Guid|A unique identifier for the metadata item.<br />Inherited from [MetadataBase EntityType](metadatabase.md).|
|ParentAttributeName|Edm.String|For internal use only.|
|ParentComponentType|Edm.Int32|For internal use only.|
...
|ValueAttributeTypeCode|[AttributeTypeCode EnumType](../enumtypes/AttributeTypeCode.md)|For internal use only.|
