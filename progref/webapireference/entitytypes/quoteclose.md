---
title: "Microsoft Dynamics 365 Customer Engagement quoteclose EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: 688ef1e9-8943-4068-af63-437a2c1ae17b
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API quoteclose entitytype."
---
...
The quoteclose entitytype has no functions or actions bound to it.
...
|activityid|Edm.Guid|**Display Name**: Quote Close<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|actualend|Edm.DateTimeOffset|**Display Name**: Closed Date<br />**Description**: Actual end time of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|category|Edm.String|**Display Name**: Category<br />**Description**: Category of the quote close activity.<br />|
...
|quotenumber|Edm.String|**Display Name**: Quote Number<br />**Description**: Quote number.<br />|
|revision|Edm.Int32|**Display Name**: Revision<br />**Description**: Quote revision number.<br />|
...
|_quoteid_value|quoteid<br />|Unique identifier of the quote with which the quote close activity is associated.|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_quote_close|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_quoteclose|[systemuser EntityType](systemuser.md)|lk_quoteclose_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_quoteclose|[systemuser EntityType](systemuser.md)|lk_quoteclose_createdonbehalfby|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_quoteclose|[systemuser EntityType](systemuser.md)|lk_quoteclose_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_quoteclose|[systemuser EntityType](systemuser.md)|lk_quoteclose_modifiedonbehalfby|
|ownerid|[principal EntityType](principal.md)|owner_activitypointers|
|ownerid_quoteclose|[principal EntityType](principal.md)|quoteclose_owner_ownerid|
|owningbusinessunit|[businessunit EntityType](businessunit.md)|business_unit_activitypointer|
|owningbusinessunit_quoteclose|[businessunit EntityType](businessunit.md)|business_unit_quote_close_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_quoteclose|[team EntityType](team.md)|team_quoteclose|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_quoteclose|[systemuser EntityType](systemuser.md)|user_quoteclose|
|quoteid|[quote EntityType](quote.md)|Quote_QuoteClose|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_quoteclose|[account EntityType](account.md)|account_QuoteCloses|
...
|regardingobjectid_bookableresourcebooking_quoteclose|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_QuoteCloses|
...
|regardingobjectid_bookableresourcebookingheader_quoteclose|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_QuoteCloses|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_quoteclose|[bulkoperation EntityType](bulkoperation.md)|bulkoperation_QuoteCloses|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_quoteclose|[campaign EntityType](campaign.md)|campaign_QuoteCloses|
|regardingobjectid_campaignactivity|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_ActivityPointers|
|regardingobjectid_campaignactivity_quoteclose|[campaignactivity EntityType](campaignactivity.md)|campaignactivity_QuoteCloses|
...
|regardingobjectid_entitlement_quoteclose|[entitlement EntityType](entitlement.md)|entitlement_QuoteCloses|
...
|regardingobjectid_entitlementtemplate_quoteclose|[entitlementtemplate EntityType](entitlementtemplate.md)|entitlementtemplate_QuoteCloses|
|regardingobjectid_incident|[incident EntityType](incident.md)|Incident_ActivityPointers|
|regardingobjectid_incident_quoteclose|[incident EntityType](incident.md)|incident_QuoteCloses|
...
|regardingobjectid_knowledgearticle_quoteclose|[knowledgearticle EntityType](knowledgearticle.md)|knowledgearticle_QuoteCloses|
...
|regardingobjectid_knowledgebaserecord_quoteclose|[knowledgebaserecord EntityType](knowledgebaserecord.md)|knowledgebaserecord_QuoteCloses|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_quoteclose|[lead EntityType](lead.md)|lead_QuoteCloses|
...
|regardingobjectid_new_interactionforemail_quoteclose|[interactionforemail EntityType](interactionforemail.md)|interactionforemail_QuoteCloses|
|regardingobjectid_opportunity|[opportunity EntityType](opportunity.md)|Opportunity_ActivityPointers|
|regardingobjectid_opportunity_quoteclose|[opportunity EntityType](opportunity.md)|opportunity_QuoteCloses|
|regardingobjectid_quote|[quote EntityType](quote.md)|Quote_ActivityPointers|
|regardingobjectid_quote_quoteclose|[quote EntityType](quote.md)|quote_QuoteCloses|
...
|regardingobjectid_site_quoteclose|[site EntityType](site.md)|site_QuoteCloses|
|sendermailboxid|[mailbox EntityType](mailbox.md)|activitypointer_sendermailboxid_mailbox|
|sendermailboxid_quoteclose|[mailbox EntityType](mailbox.md)|quoteclose_mailbox_sendermailboxid|
|serviceid|[service EntityType](service.md)|service_activity_pointers|
|serviceid_quoteclose|[service EntityType](service.md)|service_quoteclose|
|sla_activitypointer_sla|[sla EntityType](sla.md)|manualsla_activitypointer|
|sla_activitypointer_sla_quoteclose|[sla EntityType](sla.md)|quoteclose_sla_slaid|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_activitypointer_sla_quoteclose|[sla EntityType](sla.md)|quoteclose_sla_slainvokedid|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_quoteclose|[transactioncurrency EntityType](transactioncurrency.md)|quoteclose_transactioncurrency_transactioncurrencyid|
...
|CampaignResponse_QuoteCloses|[campaignresponse EntityType](campaignresponse.md)|originatingactivityid_quoteclose_campaignresponse|  
|CreatedActivity_BulkOperationLogs|[bulkoperationlog EntityType](bulkoperationlog.md)|createdobjectid_activitypointer|  
|quoteclose_activity_parties|[activityparty EntityType](activityparty.md)|activityid_quoteclose|  
|QuoteClose_Annotation|[annotation EntityType](annotation.md)|objectid_quoteclose|  
|QuoteClose_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_quoteclose|  
|QuoteClose_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_quoteclose|  
|QuoteClose_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_quoteclose_syncerror|  
|slakpiinstance_activitypointer|[slakpiinstance EntityType](slakpiinstance.md)|regarding_activitypointer|  

## Operations
The following operations can be used with the quoteclose entity type.
...
## Solutions
The following solutions include the quoteclose entity type.
...
[!INCLUDE[./remarks/quoteclose.md](./remarks/quoteclose.md)]
