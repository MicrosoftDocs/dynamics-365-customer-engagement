---
title: "Microsoft Dynamics 365 Customer Engagement appointment EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
...
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API appointment entitytype."
---
# appointment EntityType
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/appointment.md](./descriptions/appointment.md)]</td></tr>
<tr><td><b>Entity Set path:</b></td><td>[!include[current-web-api-base-uri.md](../../includes/current-web-api-base-uri.md)]appointments </td></tr>
<tr><td><b>Base Type:</b></td><td>[activitypointer EntityType](activitypointer.md)</td></tr>
<tr><td><b>Display Name:</b></td><td>Appointment</td></tr>
...
|activityid|Edm.Guid|**Display Name**: Appointment<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|attachmenterrors|Edm.Int32|**Display Name**: AttachmentErrors<br />**Description**: Select the error code to identify issues with the outlook item recipients or attachments, such as blocked attachments.<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>0</td><td>None</td></tr><tr><td>1</td><td>The appointment was saved as a Microsoft Dynamics 365 appointment record, but not all the attachments could be saved with it. An attachment cannot be saved if it is blocked or if its file type is invalid.</td></tr><tbody></table>|
|category|Edm.String|**Display Name**: Category<br />**Description**: Type a category to identify the appointment type, such as sales demo, prospect call, or service call, to tie the appointment to a business group or function.<br />|
...
|globalobjectid|Edm.String|**Display Name**: Outlook Appointment<br />**Description**: Shows the ID of the appointment in Microsoft Office Outlook. The ID is used to synchronize the appointment between Microsoft Dynamics 365 and the correct Exchange account.<br />|
...
|isalldayevent|Edm.Boolean|**Display Name**: All Day Event<br />**Description**: Select whether the appointment is an all-day event to make sure that the required resources are scheduled for the full day.<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>1</td><td>Yes</td></tr><tr><td>0</td><td>No</td></tr><tbody></table>|
...
|location|Edm.String|**Display Name**: Location<br />**Description**: Type the location where the appointment will take place, such as a conference room or customer office.<br />|
|modifiedfieldsmask|Edm.String|**Display Name**: Modified Fields Mask<br />**Description**: For internal use only. <br />Read-only<br />|
...
|originalstartdate|Edm.DateTimeOffset|**Display Name**: Original Start Date<br />**Description**: The original start date of the appointment.<br />Read-only<br />|
|outlookownerapptid|Edm.Int32|**Display Name**: Outlook Appointment Owner<br />**Description**: Unique identifier of the Microsoft Office Outlook appointment owner that correlates to the PR_OWNER_APPT_ID MAPI property.<br />|
...
|scheduleddurationminutes|Edm.Int32|**Display Name**: Duration<br />**Description**: Scheduled duration of the activity, specified in minutes.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|subcategory|Edm.String|**Display Name**: Sub-Category<br />**Description**: Type a subcategory to identify the appointment type and relate the activity to a specific product, sales region, business group, or other function.<br />|
...
|_msdyncrm_associatedcustomerjourneyiteration_value|msdyncrm_associatedcustomerjourneyiteration_Appointment<br />|Customer Journey Iteration|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_appointment|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_appointment|[systemuser EntityType](systemuser.md)|lk_appointment_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_appointment|[systemuser EntityType](systemuser.md)|lk_appointment_createdonbehalfby|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_appointment|[systemuser EntityType](systemuser.md)|lk_appointment_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_appointment|[systemuser EntityType](systemuser.md)|lk_appointment_modifiedonbehalfby|
|msdyncrm_associatedcustomerjourneyiteration_Appointment|[msdyncrm_customerjourneyiteration EntityType](msdyncrm_customerjourneyiteration.md)|msdyncrm_msdyncrm_customerjourneyiteration_appointment|
...
|owningbusinessunit_appointment|[businessunit EntityType](businessunit.md)|business_unit_appointment_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_appointment|[team EntityType](team.md)|team_appointment|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_appointment|[systemuser EntityType](systemuser.md)|user_appointment|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_appointment|[account EntityType](account.md)|Account_Appointments|
|regardingobjectid_adx_ad|[adx_ad EntityType](adx_ad.md)|adx_ad_ActivityPointers|
|regardingobjectid_adx_ad_appointment|[adx_ad EntityType](adx_ad.md)|adx_ad_Appointments|
|regardingobjectid_adx_adplacement|[adx_adplacement EntityType](adx_adplacement.md)|adx_adplacement_ActivityPointers|
|regardingobjectid_adx_adplacement_appointment|[adx_adplacement EntityType](adx_adplacement.md)|adx_adplacement_Appointments|
|regardingobjectid_adx_invitation|[adx_invitation EntityType](adx_invitation.md)|adx_invitation_ActivityPointers|
|regardingobjectid_adx_invitation_appointment|[adx_invitation EntityType](adx_invitation.md)|adx_invitation_Appointments|
|regardingobjectid_adx_poll|[adx_poll EntityType](adx_poll.md)|adx_poll_ActivityPointers|
|regardingobjectid_adx_poll_appointment|[adx_poll EntityType](adx_poll.md)|adx_poll_Appointments|
|regardingobjectid_adx_polloption|[adx_polloption EntityType](adx_polloption.md)|adx_polloption_ActivityPointers|
|regardingobjectid_adx_polloption_appointment|[adx_polloption EntityType](adx_polloption.md)|adx_polloption_Appointments|
|regardingobjectid_adx_pollplacement|[adx_pollplacement EntityType](adx_pollplacement.md)|adx_pollplacement_ActivityPointers|
|regardingobjectid_adx_pollplacement_appointment|[adx_pollplacement EntityType](adx_pollplacement.md)|adx_pollplacement_Appointments|
...
|regardingobjectid_adx_pollsubmission_appointment|[adx_pollsubmission EntityType](adx_pollsubmission.md)|adx_pollsubmission_Appointments|
...
|regardingobjectid_adx_publishingstatetransitionrule_appointment|[adx_publishingstatetransitionrule EntityType](adx_publishingstatetransitionrule.md)|adx_publishingstatetransitionrule_Appointments|
|regardingobjectid_adx_redirect|[adx_redirect EntityType](adx_redirect.md)|adx_redirect_ActivityPointers|
|regardingobjectid_adx_redirect_appointment|[adx_redirect EntityType](adx_redirect.md)|adx_redirect_Appointments|
|regardingobjectid_adx_shortcut|[adx_shortcut EntityType](adx_shortcut.md)|adx_shortcut_ActivityPointers|
|regardingobjectid_adx_shortcut_appointment|[adx_shortcut EntityType](adx_shortcut.md)|adx_shortcut_Appointments|
|regardingobjectid_adx_webpage|[adx_webpage EntityType](adx_webpage.md)|adx_webpage_ActivityPointers|
|regardingobjectid_adx_webpage_appointment|[adx_webpage EntityType](adx_webpage.md)|adx_webpage_Appointments|
|regardingobjectid_adx_website|[adx_website EntityType](adx_website.md)|adx_website_ActivityPointers|
|regardingobjectid_adx_website_appointment|[adx_website EntityType](adx_website.md)|adx_website_Appointments|
...
|regardingobjectid_bookableresourcebooking_appointment|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_Appointments|
...
|regardingobjectid_bookableresourcebookingheader_appointment|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_Appointments|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_appointment|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_Appointment|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_appointment|[campaign EntityType](campaign.md)|Campaign_Appointments|
|regardingobjectid_campaignactivity|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_ActivityPointers|
|regardingobjectid_campaignactivity_appointment|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_Appointments|
|regardingobjectid_contact|[contact EntityType](contact.md)|Contact_ActivityPointers|
|regardingobjectid_contact_appointment|[contact EntityType](contact.md)|Contact_Appointments|
|regardingobjectid_contract|[contract EntityType](contract.md)|Contract_ActivityPointers|
|regardingobjectid_contract_appointment|[contract EntityType](contract.md)|Contract_Appointments|
|regardingobjectid_entitlement|[entitlement EntityType](entitlement.md)|entitlement_ActivityPointers|
|regardingobjectid_entitlement_appointment|[entitlement EntityType](entitlement.md)|entitlement_Appointments|
...
|regardingobjectid_entitlementtemplate_appointment|[entitlementtemplate EntityType](entitlementtemplate.md)|entitlementtemplate_Appointments|
|regardingobjectid_incident|[incident EntityType](incident.md)|Incident_ActivityPointers|
|regardingobjectid_incident_appointment|[incident EntityType](incident.md)|Incident_Appointments|
|regardingobjectid_invoice|[invoice EntityType](invoice.md)|Invoice_ActivityPointers|
|regardingobjectid_invoice_appointment|[invoice EntityType](invoice.md)|Invoice_Appointments|
|regardingobjectid_knowledgearticle|[knowledgearticle EntityType](knowledgearticle.md)|KnowledgeArticle_ActivityPointers|
|regardingobjectid_knowledgearticle_appointment|[knowledgearticle EntityType](knowledgearticle.md)|KnowledgeArticle_Appointments|
...
|regardingobjectid_knowledgebaserecord_appointment|[knowledgebaserecord EntityType](knowledgebaserecord.md)|KnowledgeBaseRecord_Appointments|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_appointment|[lead EntityType](lead.md)|Lead_Appointments|
|regardingobjectid_msdyn_agreement|[msdyn_agreement EntityType](msdyn_agreement.md)|msdyn_agreement_ActivityPointers|
|regardingobjectid_msdyn_agreement_appointment|[msdyn_agreement EntityType](msdyn_agreement.md)|msdyn_agreement_Appointments|
...
|regardingobjectid_msdyn_agreementbookingdate_appointment|[msdyn_agreementbookingdate EntityType](msdyn_agreementbookingdate.md)|msdyn_agreementbookingdate_Appointments|
...
|regardingobjectid_msdyn_agreementbookingincident_appointment|[msdyn_agreementbookingincident EntityType](msdyn_agreementbookingincident.md)|msdyn_agreementbookingincident_Appointments|
...
|regardingobjectid_msdyn_agreementbookingproduct_appointment|[msdyn_agreementbookingproduct EntityType](msdyn_agreementbookingproduct.md)|msdyn_agreementbookingproduct_Appointments|
...
|regardingobjectid_msdyn_agreementbookingservice_appointment|[msdyn_agreementbookingservice EntityType](msdyn_agreementbookingservice.md)|msdyn_agreementbookingservice_Appointments|
...
|regardingobjectid_msdyn_agreementbookingservicetask_appointment|[msdyn_agreementbookingservicetask EntityType](msdyn_agreementbookingservicetask.md)|msdyn_agreementbookingservicetask_Appointments|
...
|regardingobjectid_msdyn_agreementbookingsetup_appointment|[msdyn_agreementbookingsetup EntityType](msdyn_agreementbookingsetup.md)|msdyn_agreementbookingsetup_Appointments|
...
|regardingobjectid_msdyn_agreementinvoicedate_appointment|[msdyn_agreementinvoicedate EntityType](msdyn_agreementinvoicedate.md)|msdyn_agreementinvoicedate_Appointments|
...
|regardingobjectid_msdyn_agreementinvoiceproduct_appointment|[msdyn_agreementinvoiceproduct EntityType](msdyn_agreementinvoiceproduct.md)|msdyn_agreementinvoiceproduct_Appointments|
...
|regardingobjectid_msdyn_agreementinvoicesetup_appointment|[msdyn_agreementinvoicesetup EntityType](msdyn_agreementinvoicesetup.md)|msdyn_agreementinvoicesetup_Appointments|
...
|regardingobjectid_msdyn_bookingalertstatus_appointment|[msdyn_bookingalertstatus EntityType](msdyn_bookingalertstatus.md)|msdyn_bookingalertstatus_Appointments|
|regardingobjectid_msdyn_bookingrule|[msdyn_bookingrule EntityType](msdyn_bookingrule.md)|msdyn_bookingrule_ActivityPointers|
|regardingobjectid_msdyn_bookingrule_appointment|[msdyn_bookingrule EntityType](msdyn_bookingrule.md)|msdyn_bookingrule_Appointments|
...
|regardingobjectid_msdyn_bookingtimestamp_appointment|[msdyn_bookingtimestamp EntityType](msdyn_bookingtimestamp.md)|msdyn_bookingtimestamp_Appointments|
...
|regardingobjectid_msdyn_customerasset_appointment|[msdyn_customerasset EntityType](msdyn_customerasset.md)|msdyn_customerasset_Appointments|
...
|regardingobjectid_msdyn_fieldservicesetting_appointment|[msdyn_fieldservicesetting EntityType](msdyn_fieldservicesetting.md)|msdyn_fieldservicesetting_Appointments|
...
|regardingobjectid_msdyn_incidenttypecharacteristic_appointment|[msdyn_incidenttypecharacteristic EntityType](msdyn_incidenttypecharacteristic.md)|msdyn_incidenttypecharacteristic_Appointments|
...
|regardingobjectid_msdyn_incidenttypeproduct_appointment|[msdyn_incidenttypeproduct EntityType](msdyn_incidenttypeproduct.md)|msdyn_incidenttypeproduct_Appointments|
...
|regardingobjectid_msdyn_incidenttypeservice_appointment|[msdyn_incidenttypeservice EntityType](msdyn_incidenttypeservice.md)|msdyn_incidenttypeservice_Appointments|
...
|regardingobjectid_msdyn_inventoryadjustment_appointment|[msdyn_inventoryadjustment EntityType](msdyn_inventoryadjustment.md)|msdyn_inventoryadjustment_Appointments|
...
|regardingobjectid_msdyn_inventoryadjustmentproduct_appointment|[msdyn_inventoryadjustmentproduct EntityType](msdyn_inventoryadjustmentproduct.md)|msdyn_inventoryadjustmentproduct_Appointments|
...
|regardingobjectid_msdyn_inventoryjournal_appointment|[msdyn_inventoryjournal EntityType](msdyn_inventoryjournal.md)|msdyn_inventoryjournal_Appointments|
...
|regardingobjectid_msdyn_inventorytransfer_appointment|[msdyn_inventorytransfer EntityType](msdyn_inventorytransfer.md)|msdyn_inventorytransfer_Appointments|
|regardingobjectid_msdyn_payment|[msdyn_payment EntityType](msdyn_payment.md)|msdyn_payment_ActivityPointers|
|regardingobjectid_msdyn_payment_appointment|[msdyn_payment EntityType](msdyn_payment.md)|msdyn_payment_Appointments|
...
|regardingobjectid_msdyn_paymentdetail_appointment|[msdyn_paymentdetail EntityType](msdyn_paymentdetail.md)|msdyn_paymentdetail_Appointments|
...
|regardingobjectid_msdyn_paymentmethod_appointment|[msdyn_paymentmethod EntityType](msdyn_paymentmethod.md)|msdyn_paymentmethod_Appointments|
|regardingobjectid_msdyn_paymentterm|[msdyn_paymentterm EntityType](msdyn_paymentterm.md)|msdyn_paymentterm_ActivityPointers|
|regardingobjectid_msdyn_paymentterm_appointment|[msdyn_paymentterm EntityType](msdyn_paymentterm.md)|msdyn_paymentterm_Appointments|
|regardingobjectid_msdyn_postalcode|[msdyn_postalcode EntityType](msdyn_postalcode.md)|msdyn_postalcode_ActivityPointers|
|regardingobjectid_msdyn_postalcode_appointment|[msdyn_postalcode EntityType](msdyn_postalcode.md)|msdyn_postalcode_Appointments|
...
|regardingobjectid_msdyn_processnotes_appointment|[msdyn_processnotes EntityType](msdyn_processnotes.md)|msdyn_processnotes_Appointments|
...
|regardingobjectid_msdyn_productinventory_appointment|[msdyn_productinventory EntityType](msdyn_productinventory.md)|msdyn_productinventory_Appointments|
|regardingobjectid_msdyn_projectteam|[msdyn_projectteam EntityType](msdyn_projectteam.md)|msdyn_projectteam_ActivityPointers|
|regardingobjectid_msdyn_projectteam_appointment|[msdyn_projectteam EntityType](msdyn_projectteam.md)|msdyn_projectteam_Appointments|
...
|regardingobjectid_msdyn_purchaseorder_appointment|[msdyn_purchaseorder EntityType](msdyn_purchaseorder.md)|msdyn_purchaseorder_Appointments|
...
|regardingobjectid_msdyn_purchaseorderbill_appointment|[msdyn_purchaseorderbill EntityType](msdyn_purchaseorderbill.md)|msdyn_purchaseorderbill_Appointments|
...
|regardingobjectid_msdyn_purchaseorderproduct_appointment|[msdyn_purchaseorderproduct EntityType](msdyn_purchaseorderproduct.md)|msdyn_purchaseorderproduct_Appointments|
...
|regardingobjectid_msdyn_purchaseorderreceipt_appointment|[msdyn_purchaseorderreceipt EntityType](msdyn_purchaseorderreceipt.md)|msdyn_purchaseorderreceipt_Appointments|
...
|regardingobjectid_msdyn_purchaseorderreceiptproduct_appointment|[msdyn_purchaseorderreceiptproduct EntityType](msdyn_purchaseorderreceiptproduct.md)|msdyn_purchaseorderreceiptproduct_Appointments|
...
|regardingobjectid_msdyn_purchaseordersubstatus_appointment|[msdyn_purchaseordersubstatus EntityType](msdyn_purchaseordersubstatus.md)|msdyn_purchaseordersubstatus_Appointments|
|regardingobjectid_msdyn_question|[msdyn_question EntityType](msdyn_question.md)|msdyn_question_ActivityPointers|
|regardingobjectid_msdyn_question_appointment|[msdyn_question EntityType](msdyn_question.md)|msdyn_question_Appointments|
...
|regardingobjectid_msdyn_quotebookingincident_appointment|[msdyn_quotebookingincident EntityType](msdyn_quotebookingincident.md)|msdyn_quotebookingincident_Appointments|
...
|regardingobjectid_msdyn_quotebookingproduct_appointment|[msdyn_quotebookingproduct EntityType](msdyn_quotebookingproduct.md)|msdyn_quotebookingproduct_Appointments|
...
|regardingobjectid_msdyn_quotebookingservice_appointment|[msdyn_quotebookingservice EntityType](msdyn_quotebookingservice.md)|msdyn_quotebookingservice_Appointments|
...
|regardingobjectid_msdyn_quotebookingservicetask_appointment|[msdyn_quotebookingservicetask EntityType](msdyn_quotebookingservicetask.md)|msdyn_quotebookingservicetask_Appointments|
...
|regardingobjectid_msdyn_resourceterritory_appointment|[msdyn_resourceterritory EntityType](msdyn_resourceterritory.md)|msdyn_resourceterritory_Appointments|
...
|regardingobjectid_msdyn_responseaction_appointment|[msdyn_responseaction EntityType](msdyn_responseaction.md)|msdyn_responseaction_Appointments|
|regardingobjectid_msdyn_rma|[msdyn_rma EntityType](msdyn_rma.md)|msdyn_rma_ActivityPointers|
|regardingobjectid_msdyn_rma_appointment|[msdyn_rma EntityType](msdyn_rma.md)|msdyn_rma_Appointments|
|regardingobjectid_msdyn_rmaproduct|[msdyn_rmaproduct EntityType](msdyn_rmaproduct.md)|msdyn_rmaproduct_ActivityPointers|
|regardingobjectid_msdyn_rmaproduct_appointment|[msdyn_rmaproduct EntityType](msdyn_rmaproduct.md)|msdyn_rmaproduct_Appointments|
|regardingobjectid_msdyn_rmareceipt|[msdyn_rmareceipt EntityType](msdyn_rmareceipt.md)|msdyn_rmareceipt_ActivityPointers|
|regardingobjectid_msdyn_rmareceipt_appointment|[msdyn_rmareceipt EntityType](msdyn_rmareceipt.md)|msdyn_rmareceipt_Appointments|
...
|regardingobjectid_msdyn_rmareceiptproduct_appointment|[msdyn_rmareceiptproduct EntityType](msdyn_rmareceiptproduct.md)|msdyn_rmareceiptproduct_Appointments|
...
|regardingobjectid_msdyn_rmasubstatus_appointment|[msdyn_rmasubstatus EntityType](msdyn_rmasubstatus.md)|msdyn_rmasubstatus_Appointments|
|regardingobjectid_msdyn_rtv|[msdyn_rtv EntityType](msdyn_rtv.md)|msdyn_rtv_ActivityPointers|
|regardingobjectid_msdyn_rtv_appointment|[msdyn_rtv EntityType](msdyn_rtv.md)|msdyn_rtv_Appointments|
|regardingobjectid_msdyn_rtvproduct|[msdyn_rtvproduct EntityType](msdyn_rtvproduct.md)|msdyn_rtvproduct_ActivityPointers|
|regardingobjectid_msdyn_rtvproduct_appointment|[msdyn_rtvproduct EntityType](msdyn_rtvproduct.md)|msdyn_rtvproduct_Appointments|
...
|regardingobjectid_msdyn_rtvsubstatus_appointment|[msdyn_rtvsubstatus EntityType](msdyn_rtvsubstatus.md)|msdyn_rtvsubstatus_Appointments|
|regardingobjectid_msdyn_shipvia|[msdyn_shipvia EntityType](msdyn_shipvia.md)|msdyn_shipvia_ActivityPointers|
|regardingobjectid_msdyn_shipvia_appointment|[msdyn_shipvia EntityType](msdyn_shipvia.md)|msdyn_shipvia_Appointments|
|regardingobjectid_msdyn_survey|[msdyn_survey EntityType](msdyn_survey.md)|msdyn_survey_ActivityPointers|
|regardingobjectid_msdyn_survey_appointment|[msdyn_survey EntityType](msdyn_survey.md)|msdyn_survey_Appointments|
...
|regardingobjectid_msdyn_surveyresponse_appointment|[msdyn_surveyresponse EntityType](msdyn_surveyresponse.md)|msdyn_surveyresponse_Appointments|
...
|regardingobjectid_msdyn_systemuserschedulersetting_appointment|[msdyn_systemuserschedulersetting EntityType](msdyn_systemuserschedulersetting.md)|msdyn_systemuserschedulersetting_Appointments|
|regardingobjectid_msdyn_timegroup|[msdyn_timegroup EntityType](msdyn_timegroup.md)|msdyn_timegroup_ActivityPointers|
|regardingobjectid_msdyn_timegroup_appointment|[msdyn_timegroup EntityType](msdyn_timegroup.md)|msdyn_timegroup_Appointments|
...
|regardingobjectid_msdyn_timegroupdetail_appointment|[msdyn_timegroupdetail EntityType](msdyn_timegroupdetail.md)|msdyn_timegroupdetail_Appointments|
...
|regardingobjectid_msdyn_timeoffrequest_appointment|[msdyn_timeoffrequest EntityType](msdyn_timeoffrequest.md)|msdyn_timeoffrequest_Appointments|
|regardingobjectid_msdyn_warehouse|[msdyn_warehouse EntityType](msdyn_warehouse.md)|msdyn_warehouse_ActivityPointers|
|regardingobjectid_msdyn_warehouse_appointment|[msdyn_warehouse EntityType](msdyn_warehouse.md)|msdyn_warehouse_Appointments|
|regardingobjectid_msdyn_workorder|[msdyn_workorder EntityType](msdyn_workorder.md)|msdyn_workorder_ActivityPointers|
|regardingobjectid_msdyn_workorder_appointment|[msdyn_workorder EntityType](msdyn_workorder.md)|msdyn_workorder_Appointments|
...
|regardingobjectid_msdyn_workordercharacteristic_appointment|[msdyn_workordercharacteristic EntityType](msdyn_workordercharacteristic.md)|msdyn_workordercharacteristic_Appointments|
...
|regardingobjectid_msdyn_workorderincident_appointment|[msdyn_workorderincident EntityType](msdyn_workorderincident.md)|msdyn_workorderincident_Appointments|
...
|regardingobjectid_msdyn_workorderproduct_appointment|[msdyn_workorderproduct EntityType](msdyn_workorderproduct.md)|msdyn_workorderproduct_Appointments|
...
|regardingobjectid_msdyn_workorderresourcerestriction_appointment|[msdyn_workorderresourcerestriction EntityType](msdyn_workorderresourcerestriction.md)|msdyn_workorderresourcerestriction_Appointments|
...
|regardingobjectid_msdyn_workorderservice_appointment|[msdyn_workorderservice EntityType](msdyn_workorderservice.md)|msdyn_workorderservice_Appointments|
...
|regardingobjectid_msdyn_workorderservicetask_appointment|[msdyn_workorderservicetask EntityType](msdyn_workorderservicetask.md)|msdyn_workorderservicetask_Appointments|
...
|regardingobjectid_msdyncrm_contentsettings_appointment|[msdyncrm_contentsettings EntityType](msdyncrm_contentsettings.md)|msdyncrm_contentsettings_Appointments|
...
|regardingobjectid_msdyncrm_customerjourney_appointment|[msdyncrm_customerjourney EntityType](msdyncrm_customerjourney.md)|msdyncrm_customerjourney_Appointments|
...
|regardingobjectid_msdyncrm_leadscoremodel_appointment|[msdyncrm_leadscoremodel EntityType](msdyncrm_leadscoremodel.md)|msdyncrm_leadscoremodel_Appointments|
...
|regardingobjectid_msdyncrm_linkedinaccount_appointment|[msdyncrm_linkedinaccount EntityType](msdyncrm_linkedinaccount.md)|msdyncrm_linkedinaccount_Appointments|
...
|regardingobjectid_msdyncrm_linkedinactivity_appointment|[msdyncrm_linkedinactivity EntityType](msdyncrm_linkedinactivity.md)|msdyncrm_linkedinactivity_Appointments|
...
|regardingobjectid_msdyncrm_linkedinfieldmapping_appointment|[msdyncrm_linkedinfieldmapping EntityType](msdyncrm_linkedinfieldmapping.md)|msdyncrm_linkedinfieldmapping_Appointments|
...
|regardingobjectid_msdyncrm_linkedinform_appointment|[msdyncrm_linkedinform EntityType](msdyncrm_linkedinform.md)|msdyncrm_linkedinform_Appointments|
...
|regardingobjectid_msdyncrm_linkedinformanswer_appointment|[msdyncrm_linkedinformanswer EntityType](msdyncrm_linkedinformanswer.md)|msdyncrm_linkedinformanswer_Appointments|
...
|regardingobjectid_msdyncrm_linkedinformquestion_appointment|[msdyncrm_linkedinformquestion EntityType](msdyncrm_linkedinformquestion.md)|msdyncrm_linkedinformquestion_Appointments|
...
|regardingobjectid_msdyncrm_linkedinformsubmission_appointment|[msdyncrm_linkedinformsubmission EntityType](msdyncrm_linkedinformsubmission.md)|msdyncrm_linkedinformsubmission_Appointments|
...
|regardingobjectid_msdyncrm_linkedinleadmatchingstrategy_appointment|[msdyncrm_linkedinleadmatchingstrategy EntityType](msdyncrm_linkedinleadmatchingstrategy.md)|msdyncrm_linkedinleadmatchingstrategy_Appointments|
...
|regardingobjectid_msdyncrm_linkedinuserprofile_appointment|[msdyncrm_linkedinuserprofile EntityType](msdyncrm_linkedinuserprofile.md)|msdyncrm_linkedinuserprofile_Appointments|
...
|regardingobjectid_msdyncrm_marketingdynamiccontentmetadata_appointment|[msdyncrm_marketingdynamiccontentmetadata EntityType](msdyncrm_marketingdynamiccontentmetadata.md)|msdyncrm_marketingdynamiccontentmetadata_Appointments|
...
|regardingobjectid_msdyncrm_marketingemaildynamiccontentmetadata_appointment|[msdyncrm_marketingemaildynamiccontentmetadata EntityType](msdyncrm_marketingemaildynamiccontentmetadata.md)|msdyncrm_marketingemaildynamiccontentmetadata_Appointments|
...
|regardingobjectid_msdyncrm_marketingemailtestsend_appointment|[msdyncrm_marketingemailtestsend EntityType](msdyncrm_marketingemailtestsend.md)|msdyncrm_marketingemailtestsend_Appointments|
...
|regardingobjectid_msdyncrm_uicconfig_appointment|[msdyncrm_uicconfig EntityType](msdyncrm_uicconfig.md)|msdyncrm_uicconfig_Appointments|
|regardingobjectid_msevtmgt_checkin|[msevtmgt_checkin EntityType](msevtmgt_checkin.md)|msevtmgt_checkin_ActivityPointers|
|regardingobjectid_msevtmgt_checkin_appointment|[msevtmgt_checkin EntityType](msevtmgt_checkin.md)|msevtmgt_checkin_Appointments|
|regardingobjectid_msevtmgt_event|[msevtmgt_event EntityType](msevtmgt_event.md)|msevtmgt_event_ActivityPointers|
|regardingobjectid_msevtmgt_event_appointment|[msevtmgt_event EntityType](msevtmgt_event.md)|msevtmgt_event_Appointments|
...
|regardingobjectid_msevtmgt_eventpurchase_appointment|[msevtmgt_eventpurchase EntityType](msevtmgt_eventpurchase.md)|msevtmgt_eventpurchase_Appointments|
...
|regardingobjectid_msevtmgt_eventpurchaseattendee_appointment|[msevtmgt_eventpurchaseattendee EntityType](msevtmgt_eventpurchaseattendee.md)|msevtmgt_eventpurchaseattendee_Appointments|
...
|regardingobjectid_msevtmgt_eventpurchasepass_appointment|[msevtmgt_eventpurchasepass EntityType](msevtmgt_eventpurchasepass.md)|msevtmgt_eventpurchasepass_Appointments|
...
|regardingobjectid_msevtmgt_eventregistration_appointment|[msevtmgt_eventregistration EntityType](msevtmgt_eventregistration.md)|msevtmgt_eventregistration_Appointments|
|regardingobjectid_msevtmgt_hotel|[msevtmgt_hotel EntityType](msevtmgt_hotel.md)|msevtmgt_hotel_ActivityPointers|
|regardingobjectid_msevtmgt_hotel_appointment|[msevtmgt_hotel EntityType](msevtmgt_hotel.md)|msevtmgt_hotel_Appointments|
...
|regardingobjectid_msevtmgt_hotelroomallocation_appointment|[msevtmgt_hotelroomallocation EntityType](msevtmgt_hotelroomallocation.md)|msevtmgt_hotelroomallocation_Appointments|
...
|regardingobjectid_msevtmgt_hotelroomreservation_appointment|[msevtmgt_hotelroomreservation EntityType](msevtmgt_hotelroomreservation.md)|msevtmgt_hotelroomreservation_Appointments|
|regardingobjectid_msevtmgt_layout|[msevtmgt_layout EntityType](msevtmgt_layout.md)|msevtmgt_layout_ActivityPointers|
|regardingobjectid_msevtmgt_layout_appointment|[msevtmgt_layout EntityType](msevtmgt_layout.md)|msevtmgt_layout_Appointments|
|regardingobjectid_msevtmgt_room|[msevtmgt_room EntityType](msevtmgt_room.md)|msevtmgt_room_ActivityPointers|
|regardingobjectid_msevtmgt_room_appointment|[msevtmgt_room EntityType](msevtmgt_room.md)|msevtmgt_room_Appointments|
|regardingobjectid_msevtmgt_session|[msevtmgt_session EntityType](msevtmgt_session.md)|msevtmgt_session_ActivityPointers|
|regardingobjectid_msevtmgt_session_appointment|[msevtmgt_session EntityType](msevtmgt_session.md)|msevtmgt_session_Appointments|
...
|regardingobjectid_msevtmgt_sessionregistration_appointment|[msevtmgt_sessionregistration EntityType](msevtmgt_sessionregistration.md)|msevtmgt_sessionregistration_Appointments|
...
|regardingobjectid_msevtmgt_sessiontrack_appointment|[msevtmgt_sessiontrack EntityType](msevtmgt_sessiontrack.md)|msevtmgt_sessiontrack_Appointments|
|regardingobjectid_msevtmgt_speaker|[msevtmgt_speaker EntityType](msevtmgt_speaker.md)|msevtmgt_speaker_ActivityPointers|
|regardingobjectid_msevtmgt_speaker_appointment|[msevtmgt_speaker EntityType](msevtmgt_speaker.md)|msevtmgt_speaker_Appointments|
...
|regardingobjectid_msevtmgt_speakerengagement_appointment|[msevtmgt_speakerengagement EntityType](msevtmgt_speakerengagement.md)|msevtmgt_speakerengagement_Appointments|
...
|regardingobjectid_msevtmgt_sponsorablearticle_appointment|[msevtmgt_sponsorablearticle EntityType](msevtmgt_sponsorablearticle.md)|msevtmgt_sponsorablearticle_Appointments|
...
|regardingobjectid_msevtmgt_sponsorship_appointment|[msevtmgt_sponsorship EntityType](msevtmgt_sponsorship.md)|msevtmgt_sponsorship_Appointments|
|regardingobjectid_msevtmgt_venue|[msevtmgt_venue EntityType](msevtmgt_venue.md)|msevtmgt_venue_ActivityPointers|
|regardingobjectid_msevtmgt_venue_appointment|[msevtmgt_venue EntityType](msevtmgt_venue.md)|msevtmgt_venue_Appointments|
...
|regardingobjectid_msevtmgt_webinarconfiguration_appointment|[msevtmgt_webinarconfiguration EntityType](msevtmgt_webinarconfiguration.md)|msevtmgt_webinarconfiguration_Appointments|
...
|regardingobjectid_msevtmgt_webinarprovider_appointment|[msevtmgt_webinarprovider EntityType](msevtmgt_webinarprovider.md)|msevtmgt_webinarprovider_Appointments|
...
|regardingobjectid_opportunity_appointment|[opportunity EntityType](opportunity.md)|Opportunity_Appointments|
|regardingobjectid_quote|[quote EntityType](quote.md)|Quote_ActivityPointers|
|regardingobjectid_quote_appointment|[quote EntityType](quote.md)|Quote_Appointments|
|regardingobjectid_salesorder|[salesorder EntityType](salesorder.md)|SalesOrder_ActivityPointers|
|regardingobjectid_salesorder_appointment|[salesorder EntityType](salesorder.md)|SalesOrder_Appointments|
|regardingobjectid_site|[site EntityType](site.md)|site_ActivityPointers|
|regardingobjectid_site_appointment|[site EntityType](site.md)|site_Appointments|
|sendermailboxid|[mailbox EntityType](mailbox.md)|activitypointer_sendermailboxid_mailbox|
|seriesid_recurringappointmentmaster|[recurringappointmentmaster EntityType](recurringappointmentmaster.md)|recurringappointmentmaster_appointment|
|serviceid|[service EntityType](service.md)|service_activity_pointers|
|serviceid_appointment|[service EntityType](service.md)|service_appointments|
|sla_activitypointer_sla|[sla EntityType](sla.md)|manualsla_activitypointer|
|sla_appointment_sla|[sla EntityType](sla.md)|manualsla_appointment|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_appointment_sla|[sla EntityType](sla.md)|sla_appointment|
|stageid_processstage|[processstage EntityType](processstage.md)|processstage_appointments|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_appointment|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_Appointment|
...
|appointment_actioncard|[actioncard EntityType](actioncard.md)|regardingobjectid_appointment_actioncard|  
|appointment_activity_mime_attachment|[activitymimeattachment EntityType](activitymimeattachment.md)|objectid_appointment|  
|appointment_activity_parties|[activityparty EntityType](activityparty.md)|activityid_appointment|  
|Appointment_Annotation|[annotation EntityType](annotation.md)|objectid_appointment|  
|Appointment_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_appointment|  
|Appointment_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_appointment|  
|appointment_campaignresponse|[campaignresponse EntityType](campaignresponse.md)|originatingactivityid_appointment|  
|appointment_connections1|[connection EntityType](connection.md)|record1id_appointment|  
|appointment_connections2|[connection EntityType](connection.md)|record2id_appointment|  
|Appointment_DuplicateBaseRecord|[duplicaterecord EntityType](duplicaterecord.md)|baserecordid_appointment|  
|Appointment_DuplicateMatchingRecord|[duplicaterecord EntityType](duplicaterecord.md)|duplicaterecordid_appointment|  
|appointment_PostFollows|[postfollow EntityType](postfollow.md)|regardingobjectid_appointment|  
|appointment_PostRegardings|[postregarding EntityType](postregarding.md)|regardingobjectid_appointment|  
|Appointment_QueueItem|[queueitem EntityType](queueitem.md)|objectid_appointment|  
|Appointment_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_appointment_syncerror|  
...
|slakpiinstance_appointment|[slakpiinstance EntityType](slakpiinstance.md)|regarding_appointment|  

## Operations
The following operations can be used with the appointment entity type.


|Name|Binding|Description|  
|----|-------|-----------|  
|[AddRecurrence Action](../actions/addrecurrence.md)|Entity|[!INCLUDE[../actions/descriptions/addrecurrence.md](../actions/descriptions/addrecurrence.md)]|  
|[Book Action](../actions/book.md)|Not Bound|[!INCLUDE[../actions/descriptions/book.md](../actions/descriptions/book.md)]|  
|[CreateException Action](../actions/createexception.md)|Not Bound|[!INCLUDE[../actions/descriptions/createexception.md](../actions/descriptions/createexception.md)]|  
...
## Solutions
The following solutions include the appointment entity type.
...
[!INCLUDE[./remarks/appointment.md](./remarks/appointment.md)]
