---
title: "Microsoft Dynamics 365 Customer Engagement campaignactivity EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: a582f179-b748-4195-acc4-9dc6a55b3239
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API campaignactivity entitytype."
---
# campaignactivity EntityType
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/campaignactivity.md](./descriptions/campaignactivity.md)]</td></tr>
<tr><td><b>Entity Set path:</b></td><td>[!include[current-web-api-base-uri.md](../../includes/current-web-api-base-uri.md)]campaignactivities </td></tr>
<tr><td><b>Base Type:</b></td><td>[activitypointer EntityType](activitypointer.md)</td></tr>
<tr><td><b>Display Name:</b></td><td>Campaign Activity</td></tr>
...
|activityid|Edm.Guid|**Display Name**: Campaign Activity<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|actualcost|Edm.Decimal|**Display Name**: Actual Cost<br />**Description**: Type the actual cost of the campaign activity. The value entered is rolled up to the related campaign in the total cost calculations.<br />|
|actualcost_base|Edm.Decimal|**Display Name**: Actual Cost (Base)<br />**Description**: Value of the Actual Cost in base currency.<br />Read-only<br />|
...
|budgetedcost|Edm.Decimal|**Display Name**: Budget Allocated<br />**Description**: Type the allocated budget of the campaign activity for estimated versus actual cost reporting.<br />|
...
|category|Edm.String|**Display Name**: Category<br />**Description**: Type a category to identify the campaign activity type, such as new business development or customer retention, to tie the campaign activity to a business group or function.<br />|
|channeltypecode|Edm.Int32|**Display Name**: Channel<br />**Description**: Select how communications for this activity will be sent, such as phone, letter, fax, or email.<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>1</td><td>Phone</td></tr><tr><td>2</td><td>Appointment</td></tr><tr><td>3</td><td>Letter</td></tr><tr><td>4</td><td>Letter via Mail Merge</td></tr><tr><td>5</td><td>Fax</td></tr><tr><td>6</td><td>Fax via Mail Merge</td></tr><tr><td>7</td><td>Email</td></tr><tr><td>8</td><td>Email via Mail Merge</td></tr><tr><td>9</td><td>Other</td></tr><tbody></table>|
...
|excludeifcontactedinxdays|Edm.Int32|**Display Name**: No. of Days<br />**Description**: Type the minimum number of days that must be passed before a marketing list member can be contacted in a campaign again. The campaign activity will not be applied to members contacted within the specified time period.<br />|
|ignoreinactivelistmembers|Edm.Boolean|**Display Name**: Ignore Inactive Marketing List Members<br />**Description**: Select whether inactive marketing list members will be excluded from the campaign activity distribution.<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>1</td><td>Yes</td></tr><tr><td>0</td><td>No</td></tr><tbody></table>|
...
|statuscode|Edm.Int32|**Display Name**: Status Reason<br />**Description**: Reason for the status of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>1</td><td>Proposed</td></tr><tr><td>0</td><td>In Progress</td></tr><tr><td>2</td><td>Closed</td></tr><tr><td>3</td><td>Canceled</td></tr><tr><td>4</td><td>Pending</td></tr><tr><td>5</td><td>System Aborted</td></tr><tr><td>6</td><td>Completed</td></tr><tbody></table>|
|subcategory|Edm.String|**Display Name**: Sub-Category<br />**Description**: Type a subcategory to identify the campaign activity type and relate the activity to a specific product, sales region, business group, or other function.<br />|
...
|typecode|Edm.Int32|**Display Name**: Type<br />**Description**: Select the type of campaign activity to indicate the purpose of the activity.<br />**Default Options**:<br /><table><thead><td>**Value**</td><td>**Label**</td></thead><tbody><tr><td>1</td><td>Research</td></tr><tr><td>2</td><td>Content Preparation</td></tr><tr><td>3</td><td>Target Marketing List Creation</td></tr><tr><td>4</td><td>Lead Qualification</td></tr><tr><td>5</td><td>Content Distribution</td></tr><tr><td>6</td><td>Direct Initial Contact</td></tr><tr><td>7</td><td>Direct Follow-Up Contact</td></tr><tr><td>8</td><td>Reminder Distribution</td></tr><tbody></table>|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_campaignactivity|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_campaignactivity|[systemuser EntityType](systemuser.md)|lk_campaignactivity_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_campaignactivity|[systemuser EntityType](systemuser.md)|lk_campaignactivity_createdonbehalfby|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_campaignactivity|[systemuser EntityType](systemuser.md)|lk_campaignactivity_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_campaignactivity|[systemuser EntityType](systemuser.md)|lk_campaignactivity_modifiedonbehalfby|
|ownerid|[principal EntityType](principal.md)|owner_activitypointers|
|ownerid_campaignactivity|[principal EntityType](principal.md)|campaignactivity_owner_ownerid|
|owningbusinessunit|[businessunit EntityType](businessunit.md)|business_unit_activitypointer|
|owningbusinessunit_campaignactivity|[businessunit EntityType](businessunit.md)|business_unit_campaignactivity_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_campaignactivity|[team EntityType](team.md)|team_campaignactivity|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_campaignactivity|[systemuser EntityType](systemuser.md)|user_campaignactivity|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_campaignactivity|[account EntityType](account.md)|account_CampaignActivities|
...
|regardingobjectid_bookableresourcebooking_campaignactivity|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_CampaignActivities|
...
|regardingobjectid_bookableresourcebookingheader_campaignactivity|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_CampaignActivities|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_campaignactivity|[bulkoperation EntityType](bulkoperation.md)|bulkoperation_CampaignActivities|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_campaignactivity|[campaign EntityType](campaign.md)|Campaign_CampaignActivities|
...
|regardingobjectid_knowledgearticle_campaignactivity|[knowledgearticle EntityType](knowledgearticle.md)|knowledgearticle_CampaignActivities|
...
|regardingobjectid_knowledgebaserecord_campaignactivity|[knowledgebaserecord EntityType](knowledgebaserecord.md)|knowledgebaserecord_CampaignActivities|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_campaignactivity|[lead EntityType](lead.md)|lead_CampaignActivities|
...
|regardingobjectid_new_interactionforemail_campaignactivity|[interactionforemail EntityType](interactionforemail.md)|interactionforemail_CampaignActivities|
...
|sendermailboxid_campaignactivity|[mailbox EntityType](mailbox.md)|campaignactivity_mailbox_sendermailboxid|
...
|sla_activitypointer_sla_campaignactivity|[sla EntityType](sla.md)|campaignactivity_sla_slaid|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_activitypointer_sla_campaignactivity|[sla EntityType](sla.md)|campaignactivity_sla_slainvokedid|
|stageid_processstage|[processstage EntityType](processstage.md)|processstage_campaignactivities|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_campaignactivity|[transactioncurrency EntityType](transactioncurrency.md)|transactioncurrency_campaignactivity|
...
|campaignactivity_activity_parties|[activityparty EntityType](activityparty.md)|activityid_campaignactivity|  
|campaignactivity_activityparties|[activityparty EntityType](activityparty.md)|partyid_campaignactivity|  
|CampaignActivity_ActivityPointers|[activitypointer EntityType](activitypointer.md)|regardingobjectid_campaignactivity|  
|campaignactivity_adx_alertsubscriptions|[adx_alertsubscription EntityType](adx_alertsubscription.md)|regardingobjectid_campaignactivity_adx_alertsubscription|  
|campaignactivity_adx_inviteredemptions|[adx_inviteredemption EntityType](adx_inviteredemption.md)|regardingobjectid_campaignactivity_adx_inviteredemption|  
|campaignactivity_adx_portalcomments|[adx_portalcomment EntityType](adx_portalcomment.md)|regardingobjectid_campaignactivity_adx_portalcomment|  
|CampaignActivity_Annotation|[annotation EntityType](annotation.md)|objectid_campaignactivity|  
|CampaignActivity_Appointments|[appointment EntityType](appointment.md)|regardingobjectid_campaignactivity_appointment|  
|CampaignActivity_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_campaignactivity|  
|CampaignActivity_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_campaignactivity|  
|CampaignActivity_BulkOperations|[bulkoperation EntityType](bulkoperation.md)|regardingobjectid_campaignactivity_bulkoperation|  
|campaignactivity_CampaignResponses|[campaignresponse EntityType](campaignresponse.md)|regardingobjectid_campaignactivity_campaignresponse|  
|campaignactivity_connections1|[connection EntityType](connection.md)|record1id_campaignactivity|  
|campaignactivity_connections2|[connection EntityType](connection.md)|record2id_campaignactivity|  
|CampaignActivity_Emails|[email EntityType](email.md)|regardingobjectid_campaignactivity_email|  
|CampaignActivity_Faxes|[fax EntityType](fax.md)|regardingobjectid_campaignactivity_fax|  
|campaignactivity_IncidentResolutions|[incidentresolution EntityType](incidentresolution.md)|regardingobjectid_campaignactivity_incidentresolution|  
|CampaignActivity_Letters|[letter EntityType](letter.md)|regardingobjectid_campaignactivity_letter|  
|campaignactivity_msdyn_approvals|[msdyn_approval EntityType](msdyn_approval.md)|regardingobjectid_campaignactivity_msdyn_approval|  
|campaignactivity_msdyn_bookingalerts|[msdyn_bookingalert EntityType](msdyn_bookingalert.md)|regardingobjectid_campaignactivity_msdyn_bookingalert|  
|campaignactivity_msdyn_surveyinvites|[msdyn_surveyinvite EntityType](msdyn_surveyinvite.md)|regardingobjectid_campaignactivity_msdyn_surveyinvite|  
|campaignactivity_OpportunityCloses|[opportunityclose EntityType](opportunityclose.md)|regardingobjectid_campaignactivity_opportunityclose|  
|campaignactivity_OrderCloses|[orderclose EntityType](orderclose.md)|regardingobjectid_campaignactivity_orderclose|  
|CampaignActivity_Phonecalls|[phonecall EntityType](phonecall.md)|regardingobjectid_campaignactivity_phonecall|  
|CampaignActivity_QueueItem|[queueitem EntityType](queueitem.md)|objectid_campaignactivity|  
|campaignactivity_QuoteCloses|[quoteclose EntityType](quoteclose.md)|regardingobjectid_campaignactivity_quoteclose|  
|CampaignActivity_RecurringAppointmentMasters|[recurringappointmentmaster EntityType](recurringappointmentmaster.md)|regardingobjectid_campaignactivity_recurringappointmentmaster|  
|campaignactivity_ServiceAppointments|[serviceappointment EntityType](serviceappointment.md)|regardingobjectid_campaignactivity_serviceappointment|  
|campaignactivity_SocialActivities|[socialactivity EntityType](socialactivity.md)|regardingobjectid_campaignactivity_socialactivity|  
|CampaignActivity_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_campaignactivity_syncerror|  
|CampaignActivity_Tasks|[task EntityType](task.md)|regardingobjectid_campaignactivity_task|  
|campaignactivitylist_association|[list EntityType](list.md)|campaignactivitylist_association|  
|campaignactivitysalesliterature_association|[salesliterature EntityType](salesliterature.md)|campaignactivitysalesliterature_association|  
...
## Operations
The following operations can be used with the campaignactivity entity type.


|Name|Binding|Description|  
|----|-------|-----------|  
|[AddItemCampaign Action](../actions/additemcampaign.md)|Not Bound|[!INCLUDE[../actions/descriptions/additemcampaign.md](../actions/descriptions/additemcampaign.md)]|  
...
|[DistributeCampaignActivity Action](../actions/distributecampaignactivity.md)|Entity|[!INCLUDE[../actions/descriptions/distributecampaignactivity.md](../actions/descriptions/distributecampaignactivity.md)]|  
...
## Solutions
The following solutions include the campaignactivity entity type.
...
[!INCLUDE[./remarks/campaignactivity.md](./remarks/campaignactivity.md)]
