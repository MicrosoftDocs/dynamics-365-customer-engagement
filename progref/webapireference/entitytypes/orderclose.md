---
title: "Microsoft Dynamics 365 Customer Engagement orderclose EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
...
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API orderclose entitytype."
---
# orderclose EntityType
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/orderclose.md](./descriptions/orderclose.md)]</td></tr>
<tr><td><b>Entity Set path:</b></td><td>[!include[current-web-api-base-uri.md](../includes/current-web-api-base-uri.md)]ordercloses </td></tr>
<tr><td><b>Base Type:</b></td><td>[activitypointer EntityType](activitypointer.md)</td></tr>
<tr><td><b>Display Name:</b></td><td>Order Close</td></tr>
<tr><td><b>Primary Key:</b></td><td>activityid</td></tr>
<tr><td><b>Primary Name Attribute:</b></td><td>subject</td></tr>
<tr><td><b>Operations supported:</b></td><td>POST,GET,PATCH,DELETE</td></tr>
</table>
  
The orderclose entitytype has no functions or actions bound to it.
...
|activityid|Edm.Guid|**Display Name**: Order Close<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|category|Edm.String|**Display Name**: Category<br />**Description**: Category of the order close activity.<br />|
...
|ordernumber|Edm.String|**Display Name**: Order Number<br />**Description**: Order number.<br />|
...
|revision|Edm.Int32|**Display Name**: Revision<br />**Description**: Order revision number.<br />|
...
|subcategory|Edm.String|**Display Name**: Sub-Category<br />**Description**: Subcategory of the order close activity.<br />|
...
|_salesorderid_value|salesorderid<br />|Unique identifier of the order with which the order close activity is associated.|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_order_close|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_orderclose|[systemuser EntityType](systemuser.md)|lk_orderclose_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_orderclose|[systemuser EntityType](systemuser.md)|lk_orderclose_createdonbehalfby|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_orderclose|[systemuser EntityType](systemuser.md)|lk_orderclose_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_orderclose|[systemuser EntityType](systemuser.md)|lk_orderclose_modifiedonbehalfby|
|ownerid|[principal EntityType](principal.md)|owner_activitypointers|
|ownerid_orderclose|[principal EntityType](principal.md)|orderclose_owner_ownerid|
|owningbusinessunit|[businessunit EntityType](businessunit.md)|business_unit_activitypointer|
|owningbusinessunit_orderclose|[businessunit EntityType](businessunit.md)|business_unit_order_close_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_orderclose|[team EntityType](team.md)|team_orderclose|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_orderclose|[systemuser EntityType](systemuser.md)|user_orderclose|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_orderclose|[account EntityType](account.md)|account_OrderCloses|
...
|regardingobjectid_bookableresourcebooking_orderclose|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_OrderCloses|
...
|regardingobjectid_bookableresourcebookingheader_orderclose|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_OrderCloses|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_orderclose|[bulkoperation EntityType](bulkoperation.md)|bulkoperation_OrderCloses|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_orderclose|[campaign EntityType](campaign.md)|campaign_OrderCloses|
|regardingobjectid_campaignactivity|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_ActivityPointers|
|regardingobjectid_campaignactivity_orderclose|[campaignactivity EntityType](campaignactivity.md)|campaignactivity_OrderCloses|
...
|regardingobjectid_entitlement_orderclose|[entitlement EntityType](entitlement.md)|entitlement_OrderCloses|
...
|regardingobjectid_entitlementtemplate_orderclose|[entitlementtemplate EntityType](entitlementtemplate.md)|entitlementtemplate_OrderCloses|
|regardingobjectid_incident|[incident EntityType](incident.md)|Incident_ActivityPointers|
|regardingobjectid_incident_orderclose|[incident EntityType](incident.md)|incident_OrderCloses|
...
|regardingobjectid_knowledgearticle_orderclose|[knowledgearticle EntityType](knowledgearticle.md)|knowledgearticle_OrderCloses|
...
|regardingobjectid_knowledgebaserecord_orderclose|[knowledgebaserecord EntityType](knowledgebaserecord.md)|knowledgebaserecord_OrderCloses|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_orderclose|[lead EntityType](lead.md)|lead_OrderCloses|
...
|regardingobjectid_new_interactionforemail_orderclose|[interactionforemail EntityType](interactionforemail.md)|interactionforemail_OrderCloses|
|regardingobjectid_opportunity|[opportunity EntityType](opportunity.md)|Opportunity_ActivityPointers|
|regardingobjectid_opportunity_orderclose|[opportunity EntityType](opportunity.md)|opportunity_OrderCloses|
...
|regardingobjectid_site_orderclose|[site EntityType](site.md)|site_OrderCloses|
|salesorderid|[salesorder EntityType](salesorder.md)|SalesOrder_OrderClose|
|sendermailboxid|[mailbox EntityType](mailbox.md)|activitypointer_sendermailboxid_mailbox|
|sendermailboxid_orderclose|[mailbox EntityType](mailbox.md)|orderclose_mailbox_sendermailboxid|
|serviceid|[service EntityType](service.md)|service_activity_pointers|
|serviceid_orderclose|[service EntityType](service.md)|service_orderclose|
|sla_activitypointer_sla|[sla EntityType](sla.md)|manualsla_activitypointer|
|sla_activitypointer_sla_orderclose|[sla EntityType](sla.md)|orderclose_sla_slaid|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_activitypointer_sla_orderclose|[sla EntityType](sla.md)|orderclose_sla_slainvokedid|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_orderclose|[transactioncurrency EntityType](transactioncurrency.md)|orderclose_transactioncurrency_transactioncurrencyid|
...
|CampaignResponse_OrderCloses|[campaignresponse EntityType](campaignresponse.md)|originatingactivityid_orderclose_campaignresponse|  
|CreatedActivity_BulkOperationLogs|[bulkoperationlog EntityType](bulkoperationlog.md)|createdobjectid_activitypointer|  
|orderclose_activity_parties|[activityparty EntityType](activityparty.md)|activityid_orderclose|  
|OrderClose_Annotation|[annotation EntityType](annotation.md)|objectid_orderclose|  
|OrderClose_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_orderclose|  
|OrderClose_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_orderclose|  
|OrderClose_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_orderclose_syncerror|  
|slakpiinstance_activitypointer|[slakpiinstance EntityType](slakpiinstance.md)|regarding_activitypointer|  

## Operations
The following operations can be used with the orderclose entity type.
...
## Solutions
The following solutions include the orderclose entity type.
...
[!INCLUDE[./remarks/orderclose.md](./remarks/orderclose.md)]
