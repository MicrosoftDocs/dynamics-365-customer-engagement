---
title: "Microsoft Dynamics 365 Customer Engagement opportunityclose EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: 279bed26-60c4-43a7-aa60-d7d30781f1cf
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API opportunityclose entitytype."
---
...
The opportunityclose entitytype has no functions or actions bound to it.
...
|activityid|Edm.Guid|**Display Name**: Opportunity Close<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|actualend|Edm.DateTimeOffset|**Display Name**: Closed On<br />**Description**: Actual end time of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
|actualrevenue|Edm.Decimal|**Display Name**: Actual Revenue<br />**Description**: Actual revenue generated for the opportunity.<br />|
|actualrevenue_base|Edm.Decimal|**Display Name**: Actual Revenue (Base)<br />**Description**: Value of the Actual Revenue in base currency.<br />Read-only<br />|
...
|category|Edm.String|**Display Name**: Category<br />**Description**: Category of the opportunity close activity.<br />|
...
|subcategory|Edm.String|**Display Name**: Sub-Category<br />**Description**: Subcategory of the opportunity close activity.<br />|
...
|----|---------------------------------|-----------|  
|_competitorid_value|competitorid<br />|Unique identifier of the competitor with which the opportunity close activity is associated.|
...
|_opportunityid_value|opportunityid<br />|Unique identifier of the opportunity closed.|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_opportunity_close|
|competitorid|[competitor EntityType](competitor.md)|competitor_opportunity_activities|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_opportunityclose|[systemuser EntityType](systemuser.md)|lk_opportunityclose_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_opportunityclose|[systemuser EntityType](systemuser.md)|lk_opportunityclose_createdonbehalfby|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_opportunityclose|[systemuser EntityType](systemuser.md)|lk_opportunityclose_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_opportunityclose|[systemuser EntityType](systemuser.md)|lk_opportunityclose_modifiedonbehalfby|
|opportunityid|[opportunity EntityType](opportunity.md)|Opportunity_OpportunityClose|
|ownerid|[principal EntityType](principal.md)|owner_activitypointers|
|ownerid_opportunityclose|[principal EntityType](principal.md)|opportunityclose_owner_ownerid|
|owningbusinessunit|[businessunit EntityType](businessunit.md)|business_unit_activitypointer|
|owningbusinessunit_opportunityclose|[businessunit EntityType](businessunit.md)|business_unit_opportunity_close_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_opportunityclose|[team EntityType](team.md)|team_opportunityclose|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_opportunityclose|[systemuser EntityType](systemuser.md)|user_opportunityclose|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_opportunityclose|[account EntityType](account.md)|account_OpportunityCloses|
...
|regardingobjectid_bookableresourcebooking_opportunityclose|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_OpportunityCloses|
...
|regardingobjectid_bookableresourcebookingheader_opportunityclose|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_OpportunityCloses|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_opportunityclose|[bulkoperation EntityType](bulkoperation.md)|bulkoperation_OpportunityCloses|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_opportunityclose|[campaign EntityType](campaign.md)|campaign_OpportunityCloses|
|regardingobjectid_campaignactivity|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_ActivityPointers|
|regardingobjectid_campaignactivity_opportunityclose|[campaignactivity EntityType](campaignactivity.md)|campaignactivity_OpportunityCloses|
...
|regardingobjectid_entitlement_opportunityclose|[entitlement EntityType](entitlement.md)|entitlement_OpportunityCloses|
...
|regardingobjectid_entitlementtemplate_opportunityclose|[entitlementtemplate EntityType](entitlementtemplate.md)|entitlementtemplate_OpportunityCloses|
|regardingobjectid_incident|[incident EntityType](incident.md)|Incident_ActivityPointers|
|regardingobjectid_incident_opportunityclose|[incident EntityType](incident.md)|incident_OpportunityCloses|
...
|regardingobjectid_knowledgearticle_opportunityclose|[knowledgearticle EntityType](knowledgearticle.md)|knowledgearticle_OpportunityCloses|
...
|regardingobjectid_knowledgebaserecord_opportunityclose|[knowledgebaserecord EntityType](knowledgebaserecord.md)|knowledgebaserecord_OpportunityCloses|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_opportunityclose|[lead EntityType](lead.md)|lead_OpportunityCloses|
...
|regardingobjectid_new_interactionforemail_opportunityclose|[interactionforemail EntityType](interactionforemail.md)|interactionforemail_OpportunityCloses|
|regardingobjectid_opportunity|[opportunity EntityType](opportunity.md)|Opportunity_ActivityPointers|
|regardingobjectid_opportunity_opportunityclose|[opportunity EntityType](opportunity.md)|opportunity_OpportunityCloses|
...
|regardingobjectid_site_opportunityclose|[site EntityType](site.md)|site_OpportunityCloses|
|sendermailboxid|[mailbox EntityType](mailbox.md)|activitypointer_sendermailboxid_mailbox|
|sendermailboxid_opportunityclose|[mailbox EntityType](mailbox.md)|opportunityclose_mailbox_sendermailboxid|
|serviceid|[service EntityType](service.md)|service_activity_pointers|
|serviceid_opportunityclose|[service EntityType](service.md)|service_opportunityclose|
|sla_activitypointer_sla|[sla EntityType](sla.md)|manualsla_activitypointer|
|sla_activitypointer_sla_opportunityclose|[sla EntityType](sla.md)|opportunityclose_sla_slaid|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_activitypointer_sla_opportunityclose|[sla EntityType](sla.md)|opportunityclose_sla_slainvokedid|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_opportunityclose|[transactioncurrency EntityType](transactioncurrency.md)|transactioncurrency_opportunityclose|
...
|CampaignResponse_OpportunityCloses|[campaignresponse EntityType](campaignresponse.md)|originatingactivityid_opportunityclose_campaignresponse|  
|CreatedActivity_BulkOperationLogs|[bulkoperationlog EntityType](bulkoperationlog.md)|createdobjectid_activitypointer|  
|opportunityclose_activity_parties|[activityparty EntityType](activityparty.md)|activityid_opportunityclose|  
|OpportunityClose_Annotation|[annotation EntityType](annotation.md)|objectid_opportunityclose|  
|OpportunityClose_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_opportunityclose|  
|OpportunityClose_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_opportunityclose|  
|OpportunityClose_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_opportunityclose_syncerror|  
...
[!INCLUDE[./remarks/opportunityclose.md](./remarks/opportunityclose.md)]
