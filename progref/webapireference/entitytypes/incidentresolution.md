---
title: "Microsoft Dynamics 365 Customer Engagement incidentresolution EntityType Reference | MicrosoftDocs"
ms.date: "2017-07-10"
ms.service: "crm-online"
ms.topic: "reference"
applies_to: 
  - "Dynamics 365 (online)"
ms.assetid: 1960a7ac-93cb-4a1f-8228-65618696dfbb
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
meta-description: "Reference information about the Web API incidentresolution entitytype."
---
# incidentresolution EntityType
<table>
<tr><td><b>Description:</b></td><td>[!INCLUDE[./descriptions/incidentresolution.md](./descriptions/incidentresolution.md)]</td></tr>
<tr><td><b>Entity Set path:</b></td><td>[!include[current-web-api-base-uri.md](../../includes/current-web-api-base-uri.md)]incidentresolutions </td></tr>
<tr><td><b>Base Type:</b></td><td>[activitypointer EntityType](activitypointer.md)</td></tr>
<tr><td><b>Display Name:</b></td><td>Case Resolution</td></tr>
<tr><td><b>Primary Key:</b></td><td>activityid</td></tr>
<tr><td><b>Primary Name Attribute:</b></td><td>subject</td></tr>
<tr><td><b>Operations supported:</b></td><td>POST,GET,PATCH,DELETE</td></tr>
</table>
  
The incidentresolution entitytype has no functions or actions bound to it.
...
|activityid|Edm.Guid|**Display Name**: Case Resolution<br />**Description**: Unique identifier of the activity.<br />**Inherited from**: [activitypointer EntityType](activitypointer.md)<br />|
...
|category|Edm.String|**Display Name**: Category<br />**Description**: Category for the case resolution activity.<br />|
...
|subcategory|Edm.String|**Display Name**: Sub-Category<br />**Description**: Subcategory of the case resolution activity.<br />|
...
|timespent|Edm.Int32|**Display Name**: Time Spent<br />**Description**: Time spent on the case resolution activity.<br />|
...
|_incidentid_value||Unique identifier of the case.|
...
|Name|Type|Partner|  
|----|----|-------|  
|activityid_activitypointer|[activitypointer EntityType](activitypointer.md)|activity_pointer_incident_resolution|
|createdby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdby|
|createdby_incidentresolution|[systemuser EntityType](systemuser.md)|lk_incidentresolution_createdby|
|createdonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_createdonbehalfby|
|createdonbehalfby_incidentresolution|[systemuser EntityType](systemuser.md)|lk_incidentresolution_createdonbehalfby|
|incidentid|[incident EntityType](incident.md)|Incident_IncidentResolutions|
|modifiedby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedby|
|modifiedby_incidentresolution|[systemuser EntityType](systemuser.md)|lk_incidentresolution_modifiedby|
|modifiedonbehalfby|[systemuser EntityType](systemuser.md)|lk_activitypointer_modifiedonbehalfby|
|modifiedonbehalfby_incidentresolution|[systemuser EntityType](systemuser.md)|lk_incidentresolution_modifiedonbehalfby|
|ownerid|[principal EntityType](principal.md)|owner_activitypointers|
|ownerid_incidentresolution|[principal EntityType](principal.md)|incidentresolution_owner_ownerid|
|owningbusinessunit|[businessunit EntityType](businessunit.md)|business_unit_activitypointer|
|owningbusinessunit_incidentresolution|[businessunit EntityType](businessunit.md)|business_unit_incident_resolution_activities|
|owningteam|[team EntityType](team.md)|team_activity|
|owningteam_incidentresolution|[team EntityType](team.md)|team_incidentresolution|
|owninguser|[systemuser EntityType](systemuser.md)|user_activity|
|owninguser_incidentresolution|[systemuser EntityType](systemuser.md)|user_incidentresolution|
|regardingobjectid_account|[account EntityType](account.md)|Account_ActivityPointers|
|regardingobjectid_account_incidentresolution|[account EntityType](account.md)|account_IncidentResolutions|
...
|regardingobjectid_bookableresourcebooking_incidentresolution|[bookableresourcebooking EntityType](bookableresourcebooking.md)|bookableresourcebooking_IncidentResolutions|
...
|regardingobjectid_bookableresourcebookingheader_incidentresolution|[bookableresourcebookingheader EntityType](bookableresourcebookingheader.md)|bookableresourcebookingheader_IncidentResolutions|
|regardingobjectid_bulkoperation|[bulkoperation EntityType](bulkoperation.md)|BulkOperation_ActivityPointers|
|regardingobjectid_bulkoperation_incidentresolution|[bulkoperation EntityType](bulkoperation.md)|bulkoperation_IncidentResolutions|
|regardingobjectid_campaign|[campaign EntityType](campaign.md)|Campaign_ActivityPointers|
|regardingobjectid_campaign_incidentresolution|[campaign EntityType](campaign.md)|campaign_IncidentResolutions|
|regardingobjectid_campaignactivity|[campaignactivity EntityType](campaignactivity.md)|CampaignActivity_ActivityPointers|
|regardingobjectid_campaignactivity_incidentresolution|[campaignactivity EntityType](campaignactivity.md)|campaignactivity_IncidentResolutions|
...
|regardingobjectid_entitlement_incidentresolution|[entitlement EntityType](entitlement.md)|entitlement_IncidentResolutions|
...
|regardingobjectid_entitlementtemplate_incidentresolution|[entitlementtemplate EntityType](entitlementtemplate.md)|entitlementtemplate_IncidentResolutions|
...
|regardingobjectid_knowledgearticle_incidentresolution|[knowledgearticle EntityType](knowledgearticle.md)|knowledgearticle_IncidentResolutions|
...
|regardingobjectid_knowledgebaserecord_incidentresolution|[knowledgebaserecord EntityType](knowledgebaserecord.md)|knowledgebaserecord_IncidentResolutions|
|regardingobjectid_lead|[lead EntityType](lead.md)|Lead_ActivityPointers|
|regardingobjectid_lead_incidentresolution|[lead EntityType](lead.md)|lead_IncidentResolutions|
...
|regardingobjectid_new_interactionforemail_incidentresolution|[interactionforemail EntityType](interactionforemail.md)|interactionforemail_IncidentResolutions|
...
|sendermailboxid_incidentresolution|[mailbox EntityType](mailbox.md)|incidentresolution_mailbox_sendermailboxid|
|serviceid|[service EntityType](service.md)|service_activity_pointers|
|serviceid_incidentresolution|[service EntityType](service.md)|service_incidentresolutions|
|sla_activitypointer_sla|[sla EntityType](sla.md)|manualsla_activitypointer|
|sla_activitypointer_sla_incidentresolution|[sla EntityType](sla.md)|incidentresolution_sla_slaid|
|slainvokedid_activitypointer_sla|[sla EntityType](sla.md)|sla_activitypointer|
|slainvokedid_activitypointer_sla_incidentresolution|[sla EntityType](sla.md)|incidentresolution_sla_slainvokedid|
|transactioncurrencyid|[transactioncurrency EntityType](transactioncurrency.md)|TransactionCurrency_ActivityPointer|
|transactioncurrencyid_incidentresolution|[transactioncurrency EntityType](transactioncurrency.md)|incidentresolution_transactioncurrency_transactioncurrencyid|
...
|CampaignResponse_IncidentResolutions|[campaignresponse EntityType](campaignresponse.md)|originatingactivityid_incidentresolution_campaignresponse|  
|CreatedActivity_BulkOperationLogs|[bulkoperationlog EntityType](bulkoperationlog.md)|createdobjectid_activitypointer|  
|incidentresolution_activity_parties|[activityparty EntityType](activityparty.md)|activityid_incidentresolution|  
|IncidentResolution_Annotation|[annotation EntityType](annotation.md)|objectid_incidentresolution|  
|IncidentResolution_AsyncOperations|[asyncoperation EntityType](asyncoperation.md)|regardingobjectid_incidentresolution|  
|IncidentResolution_BulkDeleteFailures|[bulkdeletefailure EntityType](bulkdeletefailure.md)|regardingobjectid_incidentresolution|  
|IncidentResolution_SyncErrors|[syncerror EntityType](syncerror.md)|regardingobjectid_incidentresolution_syncerror|  
|slakpiinstance_activitypointer|[slakpiinstance EntityType](slakpiinstance.md)|regarding_activitypointer|  

## Operations
The following operations can be used with the incidentresolution entity type.
...
## Solutions
The following solutions include the incidentresolution entity type.
...
[!INCLUDE[./remarks/incidentresolution.md](./remarks/incidentresolution.md)]
