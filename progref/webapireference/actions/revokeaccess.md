---
title: "RevokeAccess Action| MicrosoftDocs"
ms.date: 07/10/2017
ms.service: "crm-online"
ms.topic: "reference"
applies_to:
  - "Dynamics 365 (online)"
ms.assetid: 362a2d8f-b543-4994-b87c-6ede3ca5e7f6
author: "jimdaly"
ms.author: "jdaly"
manager: "jdaly"
---
# RevokeAccess Action
[!INCLUDE[./descriptions/revokeaccess.md](./descriptions/revokeaccess.md)]

The RevokeAccess action:
...
|----------|-----------------|----------|-----------------|-----------------|  
|Target|[crmbaseentity EntityType](../entitytypes/crmbaseentity.md)|false|true|The target record for which you want to revoke access. |
|Revokee|[crmbaseentity EntityType](../entitytypes/crmbaseentity.md)|false|true|A security principal (team or user) whose access you want to revoke. |



## Entities
Use the RevokeAccess action with the following entity types:
...
[!INCLUDE[./remarks/revokeaccess.md](./remarks/revokeaccess.md)]
