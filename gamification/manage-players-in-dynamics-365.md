...
ms.tgt_pltfrm: ""
ms.topic: "article"
ms.assetid: cd089c37-54d4-4d23-bf53-95ae459ef83b
...
## Match players in CRM  
 ...
 In the **Active Players** list, click the player you want to match to a CRM user account.  
  
 In the **General** section of the player information, click **User** and lookup the CRM user to match with this player.