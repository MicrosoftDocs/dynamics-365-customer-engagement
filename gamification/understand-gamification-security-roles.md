...
Administrators assign licenses to users to grant them permissions for certain applications. To enable [!INCLUDE[pn_azure_active_directory](../gamification/includes/pn-azure-active-directory-md.md)] users for [!INCLUDE[pn_gamification](../gamification/includes/pn-gamification-md.md)], they need to have a [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)] license assigned. The first user to have a KPI Manager security role assigned by a system admin in [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)] is required to set up the connection between [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)] and [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)]. The same user automatically becomes the first Commissioner in [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)].  
  
## Available security roles  
 The permissions in games are exclusively granted by the security roles in [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)]. For a description of the available security roles, review the [Gamification Glossary](http://msdn.microsoft.com/en-us/10c6a538-985a-4ea2-b8d9-4efc67f7363f).  
...
|[View the leaderboard](http://msdn.microsoft.com/en-us/088b9a63-9cda-4e45-80b6-5482ac81147b)|Yes|Yes|Yes|  
 ...
 No* = Managing the [!INCLUDE[pn_gamification_solution](../gamification/includes/pn-gamification-solution-md.md)] is regulated by [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)] permissions and requires a KPI Manager security role in [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)].  If you are looking for information about the KPI Manager security role in [!INCLUDE[pn_crm_online_subsequent](../gamification/includes/pn-crm-online-subsequent-md.md)], see [Configure KPIs in Dynamics 365](http://msdn.microsoft.com/en-us/b0c9af15-5cdf-4f8b-838c-49bf5dd50b6b) and [Manage Gamification in Microsoft Dynamics 365](http://msdn.microsoft.com/en-us/cff88aa0-01a3-4cd7-adcf-8d4b8dec9f20).  
