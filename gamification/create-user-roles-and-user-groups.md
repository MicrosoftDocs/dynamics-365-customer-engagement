...
User roles and groups let a Commissioner manage large groups of individuals in [!INCLUDE[pn_gamification](includes/pn-gamification-md.md)] efficiently. You'll need user roles if not all players compete on the same KPIs. User roles are used like employee roles in [!INCLUDE[pn_crm_shortest](includes/pn-crm-shortest-md.md)]. They have no influence on the users' permissions in [!INCLUDE[pn_crm_shortest](includes/pn-crm-shortest-md.md)].  
...
2.  Choose if you want to create roles manually or in batch by using the [!INCLUDE[pn_Excel_short](includes/pn-excel-short-md.md)] template.  
...
2.  Choose if you want to create groups manually or in batch by using the [!INCLUDE[pn_Excel_short](includes/pn-excel-short-md.md)] template.  
