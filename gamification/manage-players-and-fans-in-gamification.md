...
When you set up a new game, you need to define which users are  players and which are fans in the upcoming [!INCLUDE[pn_gamification](../gamification/includes/pn-gamification-md.md)] game.  
  
 **Players** are competing participants in your game who get points for achieving defined KPIs.  
  
 **Fans** are people who aren’t players in an active game—for example executives,  managers or receptionists—that participate in a [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)] game by drafting a team. If your CEO gets involved in the game, drafts a team, and is personally looking after player stats, that’s quite an incentive to deliver the best results!  
  
<a name="registerPlayersFans"></a>   
## Import users from [!INCLUDE[pn_azure_active_directory](../gamification/includes/pn-azure-active-directory-md.md)]  
 Users from [!INCLUDE[pn_CRM_Online](../gamification/includes/pn-crm-online-md.md)] are available automatically in [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)]. Commissioners can import additional users from [!INCLUDE[pn_azure_active_directory](../gamification/includes/pn-azure-active-directory-md.md)] which don't have a [!INCLUDE[pn_CRM_Online](../gamification/includes/pn-crm-online-md.md)] license assigned.  
  
#### Import users from [!INCLUDE[pn_microsoftcrm](../gamification/includes/pn-microsoftcrm-md.md)]  
  
1.  In [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)], go to **Users**.  
...
3.  Select the check box for the users you want to import to [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)].  
...
4.  To start the import process, click **Import Selected Users**.  
 ...
 Imported users now show in [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)] when you navigate to the **Users** page.  
