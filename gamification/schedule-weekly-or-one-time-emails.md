...
1.  In [!INCLUDE[pn_gamification_subsequent](../gamification/includes/pn-gamification-subsequent-md.md)], go to **Games** > **Emails**.  
  
2.  Click the **Schedule New Email**![Add button in Gamification](../gamification/media/add-button-gamification.png "Add button in Gamification") button.  
